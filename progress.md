...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,339 pass / 0 fail | [3,298 / 2,276 (144.9%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Keep ODF/ODT ship-ready while continuing broader Pandoc input closures | odf-compact-manifest-custom-attributes-6ae1fcc |
...
Current-main counters are reconciled through the ODF compact manifest custom attributes slice rebased on `6ae1fcc83`: 3,339 PHP passes, 0 failures, and 3,298 mapped upstream cases out of the accepted 2,276-row static upstream inventory. Rows below summarize the recently landed closure-wave evidence; they are factual evidence counters, not global ship-ready claims. This refresh was checked with `jq empty`, `git diff --check`, syntax checks for `OpenDocumentPackage.php` and `OpenDocumentPackageTest.php`, focused `OpenDocumentPackageTest.php` (`1` file, `1181` assertions, `0` failures), focused ODF/ODT gate (`4` files, `5942` assertions, `0` failures), and full `lanes/pandoc/tests` (`45` files, `75148` assertions, `0` failures).
...
| Local passing numerator | `lane-status.json` reports 3,339 PHP passes / 0 failures, and `UPSTREAM_TEST_MANIFEST.json` reports 3,298 mapped upstream cases. | PHP lane remains green. |
| Percent | 3,298 / 2,276 = 144.9%; percentages above 100% reflect local PHP slices being more granular than upstream inventory rows. | High coverage, but not global ship-ready. |
...
| Verification | `jq empty lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json`, `git diff --check`, syntax checks for `OpenDocumentPackage.php` and `OpenDocumentPackageTest.php`, focused `OpenDocumentPackageTest.php`, focused ODF/ODT gate, and `php tools/run-tests.php lanes/pandoc/tests` passed. | Focused package: 1 file, 1,181 assertions, 0 failures. Focused ODF/ODT gate: 4 files, 5,942 assertions, 0 failures. Full: 45 files, 75,148 assertions, 0 failures. |
...
status, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json lanes/pandoc/notes/pandoc-odf-compact-manifest-custom-attributes-20260613T0207Z.md lanes/pandoc/src/OpenDocumentPackage.php lanes/pandoc/tests/OpenDocumentPackageTest.php`,
`php -l lanes/pandoc/src/OpenDocumentPackage.php`,
`php -l lanes/pandoc/tests/OpenDocumentPackageTest.php`,
`php tools/run-tests.php lanes/pandoc/tests/OpenDocumentPackageTest.php`
(`1` file, `1181` assertions, `0` failures), `php tools/run-tests.php lanes/pandoc/tests/OdfReaderTest.php lanes/pandoc/tests/OdtReaderTest.php lanes/pandoc/tests/OpenDocumentReaderTest.php lanes/pandoc/tests/OpenDocumentPackageTest.php`
(`4` files, `5942` assertions, `0` failures), and `php tools/run-tests.php lanes/pandoc/tests`
(`45` files, `75148` assertions, `0` failures after final rebase onto base `6ae1fcc83`).
