...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,629 pass / 0 fail | [3,667 / 2,276 (161.1%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue bounded JSON/native-AST constructor coverage after single-wrapped payload-list normalization | pandoc-json-native-single-wrapped-constructor-list-payloads |
