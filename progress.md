...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,336 pass / 0 fail | [3,295 / 2,276 (144.8%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Keep PDF/Typst bounded to no-engine provenance; implement real Typst reader/output only behind separate engine policy | typst-package-source-policy-d1cb8cab |
