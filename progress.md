...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,326 pass / 0 fail | [3,285 / 2,276 (144.3%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue full XML/JATS/BITS reader parity after capability diagnostics | xml-jats-bits-direct-reader-capability-7bc8d592 |
...
Current-main counters are reconciled through the XML/JATS/BITS direct reader capability slice rebased on `7bc8d59244`: 3,326 PHP passes, 0 failures, and 3,285 mapped upstream cases out of the accepted 2,276-row static upstream inventory. Rows below summarize the recently landed closure-wave evidence; they are factual evidence counters, not global ship-ready claims. This refresh was checked with `jq empty`, `git diff --check`, syntax checks for the touched registry/XML files, focused `PandocFormatRegistryTest.php` (`1` file, `1168` assertions, `0` failures), focused `XmlHtmlDomTest.php` (`1` file, `1843` assertions, `0` failures), and full `lanes/pandoc/tests` (`45` files, `74698` assertions, `0` failures).
...
| Verification | `jq empty lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json`, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json lanes/pandoc/src/PandocFormatRegistry.php lanes/pandoc/src/XmlHtmlDom.php lanes/pandoc/tests/PandocFormatRegistryTest.php lanes/pandoc/tests/XmlHtmlDomTest.php`, syntax checks for `PandocFormatRegistry.php`, `XmlHtmlDom.php`, `PandocFormatRegistryTest.php`, and `XmlHtmlDomTest.php`, focused `PandocFormatRegistryTest.php`, focused `XmlHtmlDomTest.php`, and `php tools/run-tests.php lanes/pandoc/tests` passed. | 45 test files, 74,698 assertions, 0 failures. |
...
status, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json lanes/pandoc/src/PandocFormatRegistry.php lanes/pandoc/src/XmlHtmlDom.php lanes/pandoc/tests/PandocFormatRegistryTest.php lanes/pandoc/tests/XmlHtmlDomTest.php`,
...
(`1` file, `1168` assertions, `0` failures),
`php tools/run-tests.php lanes/pandoc/tests/XmlHtmlDomTest.php`
(`1` file, `1843` assertions, `0` failures), and `php tools/run-tests.php lanes/pandoc/tests`
(`45` files, `74698` assertions, `0` failures on current main `7bc8d59244`).
