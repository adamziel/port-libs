...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,322 pass / 0 fail | [3,281 / 2,276 (144.2%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue bounded EPUB3, DOCX/OpenXML, shared ZIP/OPC, JSON/native, citation, XML/HTML5 DOM, PDF/Typst, table geometry, or text-reader slices | pandoc-epub-nav-ncx-label-provenance-20260613T024437Z |
...
| EPUB/EPUB3 | `epub` | partial | 62 | 9 | Direct manifest suffix diagnostics, skipped spine-entry reporting, XHTML definition-list handoff, and compact nav/NCX label provenance are covered; finish broader EPUB package reader parity. |
...
Current-main counters are reconciled through `pandoc-epub-nav-ncx-label-provenance-20260613T024437Z` on base `d1e41a7720`: 3,322 PHP passes, 0 failures, and 3,281 mapped upstream cases out of the accepted 2,276-row static upstream inventory. Rows below summarize the recently landed closure-wave evidence; they are factual evidence counters, not global ship-ready claims. This refresh was checked with `jq empty`, `git diff --check`, syntax checks for the touched EPUB package reader files, focused `EpubPackageReaderTest.php` (`1` file, `235` assertions, `0` failures), and full `lanes/pandoc/tests` (`45` files, `74535` assertions, `0` failures).
...
| EPUB direct package reader | Landed manifest suffix diagnostics, skipped spine-entry reports, XHTML definition-list handoff, and compact nav/NCX label provenance | 9 EPUB package rows | 62 EPUB evidence cases; latest focused run 235 assertions | Partial | Broader direct EPUB package reader structural/content parity and upstream runner parity. |
| EPUB3 package reader labels | Landed compact EPUB XHTML nav and NCX navPoint label provenance after the direct manifest/spine diagnostics | 9 EPUB rows | 1 new mapped slice, 22 focused assertions | Partial | Broader structural/content package-reader parity and full upstream runner comparison remain. |
...
### EPUB3 Package Closure Update (2026-06-13)

| Surface | Evidence | Verdict |
| --- | --- | --- |
| EPUB3 package reader | Upstream denominator 9; local passing evidence 61; mapped evidence 677.8% of the static denominator. | Partial, not shippable. |
| Latest closed gap | Compact `EpubPackageReader` entries now preserve `labelProvenance` for EPUB XHTML nav links/spans and NCX `navLabel` text sources, including source element, normalized text, language/direction, raw attributes, `epub:type` tokens, and image-label alt/title/path contributors. | Covered by one focused native PHP test with 22 new assertions. |
...
(`45` files, `74535` assertions, `0` failures on current main `d1e41a7720`).
