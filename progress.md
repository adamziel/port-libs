...
| ODF/ODT package reader | Landed compact raw ZIP name provenance, compact manifest custom file-entry attributes, and rich package sidecar byte-exposure ordering for Basic scripts, RDF metadata, missing media, and unsupported-compression media while preserving ship-ready closure | 20 ODF/ODT rows | 53 ODF/ODT cases; latest focused ODT package run 1,241 assertions | Ship-ready | 0 critical ODF/ODT gaps for native PHP ODT import. |
