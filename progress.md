...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,625 pass / 0 fail | [3,637 / 2,276 (159.8%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue bounded JSON/native-AST hardening after wrapped integer table helper constructor completeness | pandoc-json-native-wrapped-integer-table-helpers |
