...
| Verification | `jq empty lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json`, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json lanes/pandoc/src/WordPressBlockWriter.php lanes/pandoc/tests/MarkdownReaderTest.php lanes/pandoc/tests/DocxReaderTest.php`, syntax checks for the touched WordPress/DOCX/Markdown files, focused `MarkdownReaderTest.php` plus `DocxReaderTest.php`, and `php tools/run-tests.php lanes/pandoc/tests` passed. | 45 test files, 74,349 assertions, 0 failures. |
...
status, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json lanes/pandoc/src/WordPressBlockWriter.php lanes/pandoc/tests/MarkdownReaderTest.php lanes/pandoc/tests/DocxReaderTest.php`,
`php -l lanes/pandoc/src/WordPressBlockWriter.php`,
`php -l lanes/pandoc/tests/MarkdownReaderTest.php`,
`php -l lanes/pandoc/tests/DocxReaderTest.php`,
`php tools/run-tests.php lanes/pandoc/tests/MarkdownReaderTest.php lanes/pandoc/tests/DocxReaderTest.php`
(`2` files, `11750` assertions, `0` failures), and `php tools/run-tests.php lanes/pandoc/tests`
(`45` files, `74349` assertions, `0` failures on current main `a9ce0ba74f`).
