...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,445 pass / 0 fail | [3,394 / 2,276 (149.1%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue direct EPUB package-reader structural/content parity after nav document section diagnostics | epub-nav-document-section-diagnostics |
