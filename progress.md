...
| HTML/XML/JATS DOM | HTML/XML/JATS fixture files plus DOM mapped cases | 274 | 29 | 944.8% |
| JSON/native AST | `.native` expected artifacts and JSON/native mapped cases | 44 | 252 | 17.5% |
| DOCX/OpenXML | `docxOpenXmlCoreCases` and DOCX/OpenXML mapped cases | 91 | 35 | 260.0% |
| EPUB/EPUB3 | `epub3PackageCoreCases` and EPUB mapped cases | 58 | 9 | 644.4% |
| ODF/ODT/OpenDocument | `odfOpenDocumentCoreCases` and ODF/ODT mapped cases | 71 | 16 | 443.8% |
| Shared ZIP/OPC package | ZIP, OPC, and archive-compression upstream case counters | 106 | 67 | 158.2% |
| CSL/BibTeX/BibLaTeX/csljson citations | citation/BibTeX/CSL mapped cases and upstream citation counters | 76 | 8 | 950.0% |
