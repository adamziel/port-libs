...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,355 pass / 0 fail | [3,315 / 2,276 (145.7%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue citation/bibliography parity after CSL affix review | citation-csl-affix-review-eb56c4b |
...
Current-main counters are reconciled through the CSL citation affix review slice rebased on `eb56c4b88`: 3,355 PHP passes, 0 failures, and 3,315 mapped upstream cases out of the accepted 2,276-row static upstream inventory. Rows below summarize the recently landed closure-wave evidence; they are factual evidence counters, not global ship-ready claims. This refresh was checked with `jq empty`, `git diff --check`, syntax checks for `CitationCslProcessor.php` and `CitationCslProcessorTest.php`, focused `CitationCslProcessorTest.php` (`1` file, `5321` assertions, `0` failures), and full `lanes/pandoc/tests` (`46` files, `75562` assertions, `0` failures).
...
status, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json lanes/pandoc/src/CitationCslProcessor.php lanes/pandoc/tests/CitationCslProcessorTest.php lanes/pandoc/notes/pandoc-citation-csl-affix-review-current-base-20260613T0209Z.md`,
`php -l lanes/pandoc/src/CitationCslProcessor.php`,
`php -l lanes/pandoc/tests/CitationCslProcessorTest.php`,
`php tools/run-tests.php lanes/pandoc/tests/CitationCslProcessorTest.php`
(`1` file, `5321` assertions, `0` failures), and `php tools/run-tests.php lanes/pandoc/tests`
(`46` files, `75562` assertions, `0` failures after final rebase onto base `eb56c4b88`).
