...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 6,245 pass / 0 fail | [6,235 / 2,276 (273.9%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue bounded Markdown figure-caption and metadata/raw/extension parity while keeping phpFail at zero | pandoc-markdown-figure-caption-surge |
