...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,319 pass / 0 fail | [3,278 / 2,276 (144.0%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue Markdown/LaTeX inline parity after writer attribute handoff | pandoc-inline-attribute-writer-handoff-4487923aa2 |
...
Current-main counters are reconciled through `4487923aa2`: 3,319 PHP passes, 0 failures, and 3,278 mapped upstream cases out of the accepted 2,276-row static upstream inventory. Rows below summarize the recently landed closure-wave evidence; they are factual evidence counters, not global ship-ready claims. This refresh was checked with `jq empty`, `git diff --check`, syntax checks for the touched writer files, focused `MarkdownReaderTest.php` plus `LatexWriterTest.php` (`2` files, `6665` assertions, `0` failures), and full `lanes/pandoc/tests` (`45` files, `74485` assertions, `0` failures).
...
| Verification | `jq empty lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json`, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json lanes/pandoc/src/LatexWriter.php lanes/pandoc/src/WordPressBlockWriter.php lanes/pandoc/tests/LatexWriterTest.php lanes/pandoc/tests/MarkdownReaderTest.php`, syntax checks for the touched writer/test files, focused `MarkdownReaderTest.php` plus `LatexWriterTest.php`, and `php tools/run-tests.php lanes/pandoc/tests` passed. | 45 test files, 74,485 assertions, 0 failures. |
...
status, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json lanes/pandoc/src/LatexWriter.php lanes/pandoc/src/WordPressBlockWriter.php lanes/pandoc/tests/LatexWriterTest.php lanes/pandoc/tests/MarkdownReaderTest.php`,
...
`php tools/run-tests.php lanes/pandoc/tests/MarkdownReaderTest.php lanes/pandoc/tests/LatexWriterTest.php`
(`2` files, `6665` assertions, `0` failures), and `php tools/run-tests.php lanes/pandoc/tests`
