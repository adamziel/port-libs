...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 17,158 pass / 0 fail | [3,882 / 2,276 (170.6%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | DOCX/OpenXML content-type base summary and aFChunk external-target policy remain native-PHP-only | pending |
...
| --- | --- | --- | ---: | ---: | --- |
| ODF/ODT/OpenDocument | `odt` | ship-ready | 100 | 20 | 0 critical gaps |
