...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage, active closures | 96.0% | 3,292 pass / 0 fail | [3,252 / 2,276 (142.9%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Finish HTML5/XML/JATS/BITS direct readers | xml-html-jats-front-matter-review-f4d0e410e4 |
...
and XML/HTML/JATS front-matter slices.
...
| Verification | `jq empty lanes/pandoc/lane-status.json lanes/pandoc/UPSTREAM_TEST_MANIFEST.json`, `git diff --check -- progress.md PANDOC_STATUS.md lanes/pandoc/lane-status.json`, and `php tools/run-tests.php lanes/pandoc/tests` passed. | 44 test files, 73,902 assertions, 0 failures. |
...
lanes/pandoc/tests` (`44` files, `73902` assertions, `0` failures on current
...
### XML/HTML5/JATS DOM Ship-Readiness Slice - 2026-06-12
