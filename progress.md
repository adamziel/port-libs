...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,661 pass / 0 fail | [3,698 / 2,276 (162.5%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue non-critical ODF/ODT package hardening only when new fixtures expose gaps; otherwise focus broader Pandoc input blockers | odf-manifest-encryption-method-summary |
