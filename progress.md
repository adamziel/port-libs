...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,578 pass / 0 fail | [3,502 / 2,276 (153.9%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue bounded ODF/ODT package-reader provenance after compact manifest collision coverage | odf-manifest-attribute-collisions |
...
| ODF/ODT/OpenDocument | `odt` | ship-ready | 55 | 20 | 0 critical gaps for native PHP ODT import; compact raw ZIP name provenance, compact manifest custom attribute collision provenance, sidecar package byte-exposure ordering, and handoff ordering across missing package parts plus unsupported-compression byte blocks are covered. Continue only non-critical hardening slices as discovered. |
