...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,664 pass / 0 fail | [3,701 / 2,276 (162.6%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue non-critical ODF/ODT package hardening only when new fixtures expose gaps; otherwise focus broader Pandoc input blockers | pandoc-odt-mimetype-local-header |
