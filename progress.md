...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,627 pass / 0 fail | [3,649 / 2,276 (160.3%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue bounded JSON/native-AST constructor coverage after legacy table width variants | pandoc-json-native-legacy-table-width-constructor-variants |
