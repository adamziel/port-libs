...
| [LightningCSS](lanes/lightningcss/lane-status.json) | Active | PHP green, upstream gap | 99.8% | 9,354 pass / 0 fail | [2,464 / 3,532 (69.8%)](lanes/lightningcss/UPSTREAM_TEST_MANIFEST.json) | 1,068 | Full upstream runner closure is partial: bounded Rust media test and... | pending lightni... |
...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 17,160 pass / 0 fail | [3,884 / 2,276 (170.7%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | DOCX/OpenXML content-type base summary and aFChunk external-target policy remain native-PHP-only | pending |
