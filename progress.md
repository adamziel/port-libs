...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 3,620 pass / 0 fail | [3,628 / 2,276 (159.4%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | Continue bounded ODF/ODT package-reader hardening after preferred-view-mode review | odf-preferred-view-mode-review |
...
| ODF/ODT/OpenDocument | `odt` | ship-ready | 73 | 20 | 0 critical gaps for native PHP ODT import; compact raw ZIP name provenance, compact manifest custom attribute collision provenance, manifest media-family classification, preferred-view-mode token diagnostics, sidecar package byte-exposure ordering, and handoff ordering across missing package parts plus unsupported-compression byte blocks are covered. Continue only non-critical hardening slices as discovered. |
