...
| [pandoc](lanes/pandoc/lane-status.json) | Backlog | High coverage | 96.0% | 17,160 pass / 0 fail | [3,885 / 2,276 (170.7%)](lanes/pandoc/UPSTREAM_TEST_MANIFEST.json) | 0 | DOCX/OpenXML content-type base summary and aFChunk external-target policy remain native-PHP-only | pending |
