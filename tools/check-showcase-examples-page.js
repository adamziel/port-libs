...
assert(js.includes("const playgroundPluginBuild = 'pdf-image-placement-repair-20260714';"), 'Expected the own-file importer to use the current Playground plugin build.');
