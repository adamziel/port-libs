...
Options:
  ...
  --require-static-executable-native-ast-parity
                                  ...
                                  native AST snapshot validates all checked-in pairs.
    ...
    return [
        ...
        'staticCurrentEvidence' => [
            ...
            'checkedInReviewMetadata' => [
                ...
                'speakerNotesFixtureCount' => $staticReviewMetadata['speakerNotesFixtureCount'] ?? 0,
                'speakerNoteCount' => $staticReviewMetadata['speakerNoteCount'] ?? 0,
                'commentFixtureCount' => $staticReviewMetadata['commentFixtureCount'] ?? 0,
                'commentAuthorCount' => $staticReviewMetadata['commentAuthorCount'] ?? 0,
                'commentCount' => $staticReviewMetadata['commentCount'] ?? 0,
