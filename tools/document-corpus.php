...
function organicSeedUrls(): array
{
    return [
        ...
        ...pythonMarkdownCommonMarkXSeedUrls(['abbreviations', 'admonition', 'api', 'definition_lists', 'fenced_code_blocks', 'index', 'legacy_attrs', 'legacy_em', 'md_in_html', 'meta_data', 'nl2br', 'toc', 'wikilinks', 'sane_lists']),
