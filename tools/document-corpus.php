...
function organicSeedUrls(): array
{
    return [
        ...
        seed('https://raw.githubusercontent.com/citation-style-language/schema/master/csl-data.json', 'json', 'github-raw', 'citation-style-language/schema', 'CSL data JSON schema'),
        seed('https://raw.githubusercontent.com/HL7/fhir/master/source/patient-example.xml', 'xml', 'github-raw', 'HL7/fhir', 'FHIR patient XML example'),
        ...
        seed('https://raw.githubusercontent.com/Homebrew/brew/master/Library/Homebrew/dev-cmd/tap-new.ronn', 'markdown', 'github-raw', 'Homebrew/brew', 'Homebrew ronn Markdown'),
    ];
}
...
function githubDiscoveryRepos(): array
{
    return [
        ...
        ['repo' => 'nodejs/node', 'ref' => 'main', 'formats' => ['gfm', 'markdown', 'json']],
        ['repo' => 'django/django', 'ref' => 'main', 'formats' => ['rst', 'markdown', 'json']],
        ['repo' => 'rust-lang/rust', 'ref' => 'master', 'formats' => ['markdown', 'json']],
        ['repo' => 'WordPress/gutenberg', 'ref' => 'trunk', 'formats' => ['gfm', 'markdown', 'json']],
        ['repo' => 'plotly/datasets', 'ref' => 'master', 'formats' => ['csv', 'tsv', 'json', 'xlsx']],
        ['repo' => 'datasets/covid-19', 'ref' => 'main', 'formats' => ['csv', 'json']],
        ...
        ['repo' => 'citation-style-language/schema', 'ref' => 'master', 'formats' => ['json']],
        ['repo' => 'HL7/fhir', 'ref' => 'master', 'formats' => ['xml', 'json']],
        ['repo' => 'ipython/ipython-in-depth', 'ref' => 'master', 'formats' => ['ipynb']],
        ['repo' => 'jupyter/notebook', 'ref' => 'main', 'formats' => ['ipynb', 'markdown', 'json']],
