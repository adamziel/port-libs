...
slices=(
  ...
  "ls-refs:gitoxide-protocol-v2-ls-refs-advertisement-parity"
  "attrs-pathspec:gitoxide-attributes-pathspec-match-parity"
  "pack-delta:gitoxide-pack-delta-resolution-parity"
  "loose-object:gitoxide-loose-object-integrity-parity"
  "packed-refs:gitoxide-packed-refs-peeling-parity"
  "reflog:gitoxide-reflog-append-parse-parity"
  "index-cache:gitoxide-index-checkout-cache-tree-parity"
  "commit-gpgsig:gitoxide-commit-signature-gpgsig-parity"
