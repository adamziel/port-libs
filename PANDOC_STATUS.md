...
Last reconciled: 2026-06-13 UTC after XML/HTML object association provenance on base `a9ce0ba74f`, following Markdown fenced Div escaped-attribute preservation.
...
| XML/HTML object associations | Standalone objects now preserve form-owner metadata, image-map `usemap` provenance, and `typemustmatch` boolean serialization; focused `XmlHtmlDomTest.php` passed 1,859 assertions. | Bounded standalone object slice covered; HTML/XML/JATS DOM remains partial. |
