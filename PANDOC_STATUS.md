...
Last reconciled: 2026-06-13 UTC after wiki/roff/man text markup reader ship-gate accounting on base `4c296642da`.
...
| External validators | No Pandoc binary, wiki renderer, roff renderer, office suite, TeX/Typst engine, browser engine, Node tooling, online service, live provider test, or external validator was used for this reconciliation. | Policy satisfied. |
