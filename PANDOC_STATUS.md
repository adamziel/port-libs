...
Last reconciled: 2026-06-13 UTC after roff/manual unsupported reason taxonomy on base `52a27eda2b`, following Typst package source-class policy provenance.
...
| Format registry/text readers | The 20 wiki/roff/man/text markup reader input tokens now have executable unsupported ship-gate accounting plus stable roff/manual unsupported reason taxonomy, reason-code, family-bucket, direction, and reader/writer capability diagnostics in `PandocFormatRegistryTest.php`. | Explicitly unsupported; first native reader implementation still required. |
