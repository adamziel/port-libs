...
Last reconciled: 2026-06-13 UTC after IPYNB attachment manifest diagnostics on base `52a27eda2b`, following Typst package source-class policy provenance.
...
| IPYNB/notebook diagnostics | `IpynbReaderTest.php`: 71 assertions, 0 failures; 2 local IPYNB cases now cover bounded cells, rich output metadata, nbformat metadata, and attachment manifest/collision diagnostics without payload bytes. | IPYNB remains partial; broader notebook media/rich-output/writer parity remains. |
