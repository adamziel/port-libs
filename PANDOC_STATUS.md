...
Last reconciled: 2026-06-13 UTC after text markup unsupported diagnostics on base `3a4bf7596e`, following PDF/Typst package dependency conflict policy and the closure-wave matrix refresh.
...
| External validators | No Pandoc binary, wiki renderer, roff tool, JSON filter, Cabal/Haskell runner, office suite, TeX/Typst engine, browser engine, Node tooling, online service, live provider test, or external validator was used for this reconciliation. | Policy satisfied. |
