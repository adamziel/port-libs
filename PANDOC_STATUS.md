...
Last reconciled: 2026-06-13 UTC after DOCX/OpenXML subdocument diagnostics on base `ef28458d1b`, following definition-list term-group coverage.
...
| Local passing numerator | `lanes/pandoc/lane-status.json` reports 3,323 PHP passes / 0 failures. `lanes/pandoc/UPSTREAM_TEST_MANIFEST.json` reports 3,282 mapped upstream cases. | PHP lane remains green. |
