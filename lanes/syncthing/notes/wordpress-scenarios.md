...
winner ordering, and tombstone construction.
...
Port protocol FileInfo equivalence, index update message fixtures, or block
comparison behavior from focused upstream tests.
