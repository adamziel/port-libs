...
Map single-file `MoveFile` / `CopyFile` provider boundaries such as same-object no-op, case-insensitive two-step moves, and failed partial-copy cleanup.
