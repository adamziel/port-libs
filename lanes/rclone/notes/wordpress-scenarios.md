...
Map provider-specific server-side copy edges around the `RemoveExisting` callers, starting with same-remote case-fold guards and pre-created destination object behavior.
