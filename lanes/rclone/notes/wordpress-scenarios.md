...
Continue the focused fstest provider contract slice with copy/move/check metadata-set or chunked-copy behavior that does not require live remotes, or validate provider-ID duplicate-directory merge against live-provider fixture evidence.
