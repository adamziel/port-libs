...
Map delete-before empty-directory pruning and backup-dir interactions, or add the upstream matchListings out-of-order guard as an explicit diagnostic error.
