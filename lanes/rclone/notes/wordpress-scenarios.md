...
Continue the focused fstest provider contract slice with chunked upload/copy behavior that does not require live remotes, or validate provider-ID duplicate-directory merge against live-provider fixture evidence.
