...
Implement live-provider duplicate-directory discovery by ID/ParentID and list-mode reporting, or start a focused fstest copy/move/check contract slice without live remotes.
