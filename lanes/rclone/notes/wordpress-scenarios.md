...
Map rclone `--ignore-case-sync` for case-sensitive providers, then compare its no-rename behavior with the new `--fix-case` case-insensitive provider slice.
