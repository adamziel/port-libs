...
Map another provider-specific server-side copy edge, such as OneDrive remoteItem/shared metadata fields, SharePoint/documentLibrary cross-drive gates, or Dropbox Paper export format selection beyond html/markdown.
