...
Map duplicate-directory merge behavior against `fs/operations/dedupe.go`, or start a focused fstest copy/move/check contract slice without live remotes.
