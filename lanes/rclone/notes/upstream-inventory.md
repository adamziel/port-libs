...
- Required root `php tools/run-tests.php` on 2026-05-22 after the refresh-times slice first found 1 unrelated esbuild fixture failure, then passed after a concurrent esbuild fixture update: 109 test files, 7,887 assertions, 0 failures in the current shared dirty worktree.
