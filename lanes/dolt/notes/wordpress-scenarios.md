...
Next best slice: map broader `dolt_patch()` revision/table edge cases such as branch/tag resolution failures and staged/worktree materialization beyond same-ref no-op rows.
