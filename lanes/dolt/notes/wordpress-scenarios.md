...
Next best slice: map another bounded Dolt CLI/system-table behavior, such as a focused `dolt diff --summary` CLI text boundary or more `dolt log` pager/output argument behavior, against upstream BATS evidence.
