...
Next best slice: map SQL merge abort/rollback cleanup visibility after unresolved conflicts as one focused merge behavior, with a WordPress smoke path.
