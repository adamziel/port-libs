...
Next best slice: map root-object conflict resolution/clearing or schema-conflict table mutation semantics as one focused merge behavior, with a WordPress smoke path.
