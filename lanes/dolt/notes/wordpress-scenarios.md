...
Next best slice: map schema-conflict table mutation semantics or post-resolution mixed data/constraint state as one focused merge behavior, with a WordPress smoke path.
