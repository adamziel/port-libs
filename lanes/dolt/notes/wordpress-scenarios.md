...
Map the broader multi-branch `dolt log --graph` cases from upstream `log.bats`, including dense merge fan-in and default multi-line graph formatting.
