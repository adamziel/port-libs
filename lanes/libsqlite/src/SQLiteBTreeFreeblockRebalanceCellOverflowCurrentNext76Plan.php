...
final class SQLiteBTreeFreeblockRebalanceCellOverflowCurrentNext76Plan
{
    /**
    ...
    public static function tableDeleteRebalanceThenReplaceOverflow(
        ...
        if ($replacementOverflowPayload === '') {
            throw new \InvalidArgumentException('SQLite freeblock rebalance current/next76 replacement requires overflow payload bytes');
        }
        ...
        if ($rebalancePlan->obsoleteOverflowPageNumbers === []) {
            throw new \InvalidArgumentException('SQLite freeblock rebalance current/next76 requires obsolete overflow pages from the deleted cell');
        }
        ...
        if ($firstOverflowPage === null) {
            throw new \InvalidArgumentException('SQLite freeblock rebalance current/next76 did not allocate a replacement overflow page');
        }
    ...
    public function toArray(): array
    {
        ...
        return [
            'action' => 'btree-freeblock-rebalance-cell-overflow-current-next76',
