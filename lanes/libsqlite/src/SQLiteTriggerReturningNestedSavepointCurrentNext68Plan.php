...
final class SQLiteTriggerReturningNestedSavepointCurrentNext68Plan
{
    /**
    ...
    public static function apply(
        ...
        foreach ($attemptRows as $index => $old) {
            ...
            } catch (SQLiteTriggerReturningNestedSavepointCurrentNext68Signal $signal) {
    ...
    private static function fireTriggers(string $timing, string $event, array $old, array $next, array $triggers, int $ordinal): array
    {
        ...
        foreach ($triggers as $trigger) {
            ...
            if ($action === 'raise') {
                ...
                throw new SQLiteTriggerReturningNestedSavepointCurrentNext68Signal((string) ($trigger['reason'] ?? 'trigger-raise'));
            }
            if ($action === 'set-new') {
...
final class SQLiteTriggerReturningNestedSavepointCurrentNext68Signal extends \RuntimeException
{
