...
final class SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext289Plan
{
    /**
    ...
    public static function execute(
        ...
        $attemptWindow = self::windowRows(self::flattenReturning($attemptReturning), $rowIdColumn);
        $retryWindow = self::windowRows(self::flattenReturning($retryReturning), $rowIdColumn);
