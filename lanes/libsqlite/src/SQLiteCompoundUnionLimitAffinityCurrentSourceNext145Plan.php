...
final class SQLiteCompoundUnionLimitAffinityCurrentSourceNext145Plan
{
    /**
    ...
    public static function compare(string $sql, array $currentTables, array $nextTables): array
    {
        ...
        self::assertSupportedPlan($currentPlan, $nextPlan);
     ...
     */
    private static function assertSupportedPlan(array $currentPlan, array $nextPlan): void
    {
