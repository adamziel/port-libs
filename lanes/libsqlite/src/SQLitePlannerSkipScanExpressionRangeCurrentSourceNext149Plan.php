...
final class SQLitePlannerSkipScanExpressionRangeCurrentSourceNext149Plan
{
    /**
    ...
    public static function materialize(
        ...
        $base = SQLitePlannerExpressionSkipScanRangeCurrentSourceNext143Plan::materialize(
            $preparedSource,
            $currentSource,
            $partialPredicate,
            $queryTerms,
        ...
        return array_replace($base, [
            ...
            'dependencies' => [
                'SQLitePlannerExpressionSkipScanRangeCurrentSourceNext143Plan',
    ...
    private static function rangeAudit(array $plan, array $source, array $rowsByRowid): array
    {
        ...
        foreach (self::intList($plan['rowids'] ?? []) as $rowid) {
            ...
            $lowerOk = $lower === null || (($lowerCmp = self::compare($value, $lower, $collation)) !== null && $lowerCmp >= 0);
            $upperCmp = $upper === null ? null : self::compare($value, $upper, $collation);
