...
final class SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan
{
    ...
    public static function keyValueRowKeyEscapeRebindPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* escape rebind */',
            'currentPattern' => $currentPattern,
            'nextPattern' => $nextPattern,
            'currentEscape' => $currentEscape,
            'nextEscape' => $nextEscape,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroZero rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroZero rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyFullScanPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? /* no fixed prefix */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'caseSensitiveLike' => false,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroThree rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroThree rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyNonAsciiFullScanPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* non-ASCII prefix fallback */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroFive rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroFive rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyPreparedBomPatternPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* prepared UTF-16 BOM pattern */',
    ...
    public static function keyValueRowKeyRtrimCollationRebindPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* rtrim collation rebind */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroSeven rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroSeven rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyPreparedEscapePlan(
        ...
        return [
            ...
            'baseStatus' => $base['status'],
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* prepared UTF-16 escape */',
    ...
    public static function keyValueRowKeyAsciiSpaceRtrimPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* ASCII-space RTRIM only */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    private static function v209_decodeRows(array $rows): array
    {
        ...
        foreach ($rows as $row) {
            if (!isset($row['setting_id']) || !is_int($row['setting_id'])) {
                throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroNine rows require integer setting_id');
            }
            if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
                throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroNine rows require key_name_bytes');
            }
    ...
    public static function keyValueRowKeyEmbeddedNulPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? /* embedded NUL */',
            'pattern' => $pattern,
    ...
    private static function v210_decodeRows(array $rows): array
    {
        ...
        foreach ($rows as $row) {
            if (!isset($row['setting_id']) || !is_int($row['setting_id'])) {
                throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneZero rows require integer setting_id');
            }
            if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
                throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneZero rows require key_name_bytes');
            }
            if (!isset($row['text_encoding']) || !is_int($row['text_encoding'])) {
            ...
            try {
                $decoded[$row['setting_id']] = SQLiteEncodingCollationSourceCursor::decodeText($row['key_name_bytes'], $row['text_encoding']);
            } catch (\InvalidArgumentException) {
                continue;
            }
        }
    ...
    public static function keyValueRowKeySourceRefreshPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* current-source refresh */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneOne rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneOne rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyUnicodeEscapePlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* UTF-16 Unicode ESCAPE */',
            'currentPattern' => $currentPattern,
            'nextPattern' => $nextPattern,
            'currentEscape' => $currentEscape,
            'nextEscape' => $nextEscape,
    ...
    public static function keyValueRowKeySelfEscapedEscapePlan(
        ...
        return array_replace($base, [
            ...
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* UTF-16 self-escaped Unicode ESCAPE */',
            'currentSource' => $currentSource,
            'nextSource' => $nextSource,
            'currentSchemaCookie' => $currentSchemaCookie,
            'nextSchemaCookie' => $nextSchemaCookie,
    ...
    public static function keyValueRowKeyPreparedPatternSpacePlan(
        ...
        return [
            ...
            'baseStatus' => $base['status'],
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* prepared UTF-16 pattern space */',
            'currentPattern' => $currentPattern,
            'nextPattern' => $nextPattern,
    ...
    private static function v217_decodeRows(array $rows): array
    {
        ...
        foreach ($rows as $row) {
            if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
                throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneSeven rows require integer setting_id');
            }
            if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
                throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneSeven rows require key_name_bytes');
            }
            if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyYieldPagePlan(
        ...
        return [
            ...
            'baseStatus' => $base['status'],
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? ORDER BY rtrim(key_name) COLLATE NOCASE, rowid LIMIT ? OFFSET ?',
            'pattern' => $pattern,
            'currentEscape' => $base['currentEscape'],
            'nextEscape' => $base['nextEscape'],
    ...
    public static function keyValueRowKeySupplementaryWildcardPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* supplementary wildcard */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneNine rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneNine rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyPreparedByteSignaturePlan(
        ...
        return [
            ...
            'baseStatus' => $base['status'],
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* prepared UTF-16 byte signature */',
            'currentPattern' => $currentPattern,
            'nextPattern' => $nextPattern,
            'currentEscape' => $currentEscape,
            'nextEscape' => $nextEscape,
    ...
    public static function keyValueRowKeyDescYieldPagePlan(
        ...
        return [
            ...
            'baseStatus' => $base['status'],
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? ORDER BY rtrim(key_name) COLLATE NOCASE DESC, rowid DESC LIMIT ? OFFSET ?',
            'pattern' => $pattern,
            'currentEscape' => $base['currentEscape'],
            'nextEscape' => $base['nextEscape'],
            'currentEscapeBytesHex' => $base['currentEscapeBytesHex'],
    ...
    public static function keyValueRowKeyKeysetResumePlan(
        ...
        return [
            ...
            'baseStatus' => $base['status'],
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? AND (rtrim(key_name) COLLATE NOCASE, rowid) > (?, ?) ORDER BY rtrim(key_name) COLLATE NOCASE, rowid LIMIT ?',
            'pattern' => $pattern,
            'currentEscape' => $base['currentEscape'],
            'nextEscape' => $base['nextEscape'],
            'currentEscapeBytesHex' => $base['currentEscapeBytesHex'],
    ...
    public static function keyValueRowKeySourceBytePlan(
        ...
        return [
            ...
            'baseStatus' => $base['status'],
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* source-byte fence */',
            'pattern' => $base['pattern'],
            'escape' => $base['escape'],
            'collation' => $base['collation'],
            'currentSource' => $base['currentSource'],
    ...
    private static function v225_rawRowsById(array $rows): array
    {
        ...
        foreach ($rows as $row) {
            if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
                throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoTwoFive rows require integer setting_id');
            }
            if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
                throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoTwoFive rows require key_name_bytes');
            }
            if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyCombiningMarkPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? /* combining mark normalization boundary */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoTwoSix rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoTwoSix rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyAsciiSpaceBoundaryPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? /* ASCII-space RTRIM boundary */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoTwoSeven rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoTwoSeven rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyHeaderEncodingFencePlan(
        ...
        return [
            ...
            'baseStatus' => $base['status'],
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* database text-encoding fence */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => $base['collation'],
            'currentSource' => $base['currentSource'],
    ...
    public static function keyValueRowKeyUnicodeSpaceRtrimPlan(
        ...
        return array_replace($base, [
            ...
            'baseStatus' => $base['status'],
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* UTF-16 non-ASCII spaces are not RTRIM spaces */',
            'currentSource' => $currentSource,
            'nextSource' => $nextSource,
            'currentSchemaCookie' => $currentSchemaCookie,
            'nextSchemaCookie' => $nextSchemaCookie,
    ...
    private static function v229_decodedTexts(array $rows): array
    {
        $texts = [];
        foreach ($rows as $row) {
            if (!isset($row['setting_id'], $row['key_name_bytes'], $row['text_encoding'])) {
                continue;
            }
            try {
                $texts[(int) $row['setting_id']] = SQLiteEncodingCollationSourceCursor::decodeText(
                    (string) $row['key_name_bytes'],
    ...
    public static function keyValueRowKeyLineBreakBoundaryPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? /* line-break RTRIM boundary */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
        ...
        foreach ($rows as $row) {
            ...
            try {
                ...
                if ($suffixClass === 'ascii-space') {
                    ...
                    $lineBreaks[] = $row['setting_id'];
                } elseif ($suffixClass === 'form-feed') {
                    $formFeeds[] = $row['setting_id'];
                }
                $decoded[] = [
                    'rowid' => $row['setting_id'],
                    'text' => $text,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoThreeZero rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoThreeZero rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyAsciiOnlyNocasePlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? /* ASCII-only NOCASE boundary */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    private static function v231_scan(array $rows, string $pattern, ?string $escape, ?array $range): array
    {
        ...
        foreach ($rows as $row) {
            ...
            try {
                ...
                if ($class !== 'none') {
                    $nonAsciiVariants[] = $row['setting_id'];
                }
                if ($nocaseKey !== $rtrim) {
                    $asciiFolded[] = $row['setting_id'];
                }
                $decoded[] = [
                    'rowid' => $row['setting_id'],
                    'text' => $text,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoThreeOne rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoThreeOne rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyCanonicalUnicodePlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* no Unicode normalization */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    private static function v233_scan(array $rows, string $pattern, ?string $escape, ?array $range): array
    {
        ...
        foreach ($rows as $row) {
            ...
            try {
                ...
                if ($hasPrecomposed) {
                    $precomposed[] = $row['setting_id'];
                }
                if ($hasCombining || $hasPrecomposed) {
                    $canonicalEquivalent[] = $row['setting_id'];
                }
                $decoded[] = [
                    'rowid' => $row['setting_id'],
                    'text' => $text,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoThreeThree rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoThreeThree rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyNullPatternRebindPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* NULL pattern rebind */',
            'currentPattern' => $currentPattern,
            'nextPattern' => $nextPattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroOne rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroOne rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyNonAsciiPrefixFullScanPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* non-ASCII prefix full scan */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'caseSensitiveLike' => false,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroFour rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoZeroFour rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
    ...
    public static function keyValueRowKeyEmbeddedNulTokenPlan(
        ...
        return [
            ...
            'operator' => 'LIKE',
            'expression' => 'rtrim(key_name) COLLATE NOCASE LIKE ? ESCAPE ? /* embedded NUL token fence */',
            'pattern' => $pattern,
            'escape' => $escape,
            'collation' => 'NOCASE',
            'currentSource' => $currentSource,
    ...
    {
        if (!array_key_exists('setting_id', $row) || !is_int($row['setting_id'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneFive rows require integer setting_id');
        }
        if (!array_key_exists('key_name_bytes', $row) || !is_string($row['key_name_bytes'])) {
            throw new \InvalidArgumentException('SQLite UTF-16 NOCASE LIKE RTRIM nextTwoOneFive rows require key_name_bytes');
        }
        if (!array_key_exists('text_encoding', $row) || !is_int($row['text_encoding'])) {
