...
final class SQLitePragmaQuickcheckRootpageForeignKeyCurrentSourceNext142Plan
{
    /**
    ...
    private static function sideRows(
        ...
        $foreignKeyRows = SQLitePragmaRootpagePointerMapForeignKeyCurrentSourceNext122::collect($database, $schemas, $catalog, $foreignKeySql);
