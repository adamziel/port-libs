...
final class SQLiteAttachWalTempSchemaCacheCurrentNext77Plan
{
    /**
    ...
    public static function plan(array $schemas, array $operations, array $statements, string $outcome = 'commit', string $sourceSchema = 'main'): array
    {
        ...
        $transaction = SQLiteAttachWalTempTransactionCurrentNext69Plan::plan($schemas, $operations, $outcome);
