...
final class SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan
{
    ...
    public static function materializeNext910925(
        ...
        return array_replace_recursive($base, [
            ...
            "non_overlap" => "prepares next910-925 current-source handoff slices only; avoids changing next894-909 handoff windows, next878-893 handoff windows, next862-877 handoff windows, next846-861 handoff windows, next830-845 handoff windows, next814-829 handoff windows, next798-813 handoff windows, next782-797 handoff windows, next766-781 handoff windows, next750-765 handoff windows, next734-749 handoff windows, next718-733 handoff windows, next702-717 handoff windows, next686-701 handoff windows, next638-653 handoff windows, next622-637 handoff windows, next606-621 handoff windows, next590-605 handoff windows, next574-589 handoff windows, next558-573 handoff windows, next542-557 handoff windows, next510-525 handoff windows, next494-509 handoff windows, next478-493 handoff windows, next462-477 handoff windows, next430-445 handoff windows, next414-429 handoff windows, next398-413 handoff windows, next382-397 handoff windows, next366-381 handoff windows, next334-349 handoff windows, next318-333 handoff windows, next302-317 handoff windows, next286-301 handoff windows, next270-285 handoff windows, next254-269 handoff windows, next253 payload row-image validation, page anchors, JSON, WAL, VFS, B-tree, trigger, PRAGMA, compound SELECT, and UTF clusters",
    ...
    private static function handoffFenceNext910925(array $base, array $currentSource, array $neededColumns): array
    {
        ...
        $prior = $base["stat4Next894909PreparationFence"] ?? null;
        if (!is_array($prior)) {
            throw new \InvalidArgumentException("SQLite next910-925 needs next894-909 handoff fence");
        }
    ...
    private static function cursorProgramNext910925(array $program, bool $ready, array $fence): array
    {
        ...
        $program[] = [
            "opcode" => "PrepareStat4ExpressionPartialNext910925Handoff",
            "mode" => "next910-925-current-source-stat4-expression-partial-prep",
            "sliceRange" => $fence["sliceRange"],
            "priorSliceRange" => $fence["priorSliceRange"],
            "preparedSlices" => $fence["preparedSlices"],
            "priorHandoffSignature" => $fence["priorHandoffSignature"],
    ...
    public static function materializeNext926941(
        ...
        return array_replace_recursive($base, [
            ...
            "non_overlap" => "prepares next926-941 current-source handoff slices only; avoids changing next910-925 handoff windows, next894-909 handoff windows, next878-893 handoff windows, next862-877 handoff windows, next846-861 handoff windows, next830-845 handoff windows, next814-829 handoff windows, next798-813 handoff windows, next782-797 handoff windows, next766-781 handoff windows, next750-765 handoff windows, next734-749 handoff windows, next718-733 handoff windows, next702-717 handoff windows, next686-701 handoff windows, next638-653 handoff windows, next622-637 handoff windows, next606-621 handoff windows, next590-605 handoff windows, next574-589 handoff windows, next558-573 handoff windows, next542-557 handoff windows, next510-525 handoff windows, next494-509 handoff windows, next478-493 handoff windows, next462-477 handoff windows, next430-445 handoff windows, next414-429 handoff windows, next398-413 handoff windows, next382-397 handoff windows, next366-381 handoff windows, next334-349 handoff windows, next318-333 handoff windows, next302-317 handoff windows, next286-301 handoff windows, next270-285 handoff windows, next254-269 handoff windows, next253 payload row-image validation, page anchors, JSON, WAL, VFS, B-tree, trigger, PRAGMA, compound SELECT, and UTF clusters",
    ...
    private static function handoffFenceNext926941(array $base, array $currentSource, array $neededColumns): array
    {
        ...
        $prior = $base["stat4Next910925PreparationFence"] ?? null;
        if (!is_array($prior)) {
            throw new \InvalidArgumentException("SQLite next926-941 needs next910-925 handoff fence");
        }
    ...
    private static function cursorProgramNext926941(array $program, bool $ready, array $fence): array
    {
        ...
        $program[] = [
            "opcode" => "PrepareStat4ExpressionPartialNext926941Handoff",
            "mode" => "next926-941-current-source-stat4-expression-partial-prep",
            "sliceRange" => $fence["sliceRange"],
            "priorSliceRange" => $fence["priorSliceRange"],
            "preparedSlices" => $fence["preparedSlices"],
            "priorHandoffSignature" => $fence["priorHandoffSignature"],
    ...
    public static function materializeNext942957(
        ...
        return array_replace_recursive($base, [
            "status" => $ready ? "stat4-expression-partial-current-source-next942-957-prepared" : "requires-current-source-stat4-next942-957-prep",
            "stat4Next942957PreparationFence" => $fence,
            "selectedPlan" => [
                "next942957Prepared" => $ready,
                "next942957SliceCount" => $fence["sliceCount"],
                "next942957PreparedSlices" => $fence["preparedSlices"],
                "next942957BlockedSlices" => $fence["blockedSlices"],
                "next942957PriorHandoffSignature" => $fence["priorHandoffSignature"],
            ...
            "dependency_closure" => "no new support component needed; next942-957 preparation extends the accepted next926-941 current-source STAT4 handoff slices and keeps their projected row continuity for follow-on planner work",
            "non_overlap" => "prepares next942-957 current-source handoff slices only; avoids changing next926-941 handoff windows, next910-925 handoff windows, next894-909 handoff windows, next878-893 handoff windows, next862-877 handoff windows, next846-861 handoff windows, next830-845 handoff windows, next814-829 handoff windows, next798-813 handoff windows, next782-797 handoff windows, next766-781 handoff windows, next750-765 handoff windows, next734-749 handoff windows, next718-733 handoff windows, next702-717 handoff windows, next686-701 handoff windows, next638-653 handoff windows, next622-637 handoff windows, next606-621 handoff windows, next590-605 handoff windows, next574-589 handoff windows, next558-573 handoff windows, next542-557 handoff windows, next510-525 handoff windows, next494-509 handoff windows, next478-493 handoff windows, next462-477 handoff windows, next430-445 handoff windows, next414-429 handoff windows, next398-413 handoff windows, next382-397 handoff windows, next366-381 handoff windows, next334-349 handoff windows, next318-333 handoff windows, next302-317 handoff windows, next286-301 handoff windows, next270-285 handoff windows, next254-269 handoff windows, next253 payload row-image validation, page anchors, JSON, WAL, VFS, B-tree, trigger, PRAGMA, compound SELECT, and UTF clusters",
            "detail" => trim((string) ($base["detail"] ?? "") . " NEXT942-957 PREPARED HANDOFF"),
        ]);
    }
    ...
    private static function handoffFenceNext942957(array $base, array $currentSource, array $neededColumns): array
    {
        ...
        $prior = $base["stat4Next926941PreparationFence"] ?? null;
        if (!is_array($prior)) {
            throw new \InvalidArgumentException("SQLite next942-957 needs next926-941 handoff fence");
        }
    ...
    private static function cursorProgramNext942957(array $program, bool $ready, array $fence): array
    {
        ...
        $program[] = [
            "opcode" => "PrepareStat4ExpressionPartialNext942957Handoff",
            "mode" => "next942-957-current-source-stat4-expression-partial-prep",
            "sliceRange" => $fence["sliceRange"],
            "priorSliceRange" => $fence["priorSliceRange"],
            "preparedSlices" => $fence["preparedSlices"],
            "priorHandoffSignature" => $fence["priorHandoffSignature"],
    ...
    public static function materializeNext958973(
        ...
        return array_replace_recursive($base, [
            "status" => $ready ? "stat4-expression-partial-current-source-next958-973-prepared" : "requires-current-source-stat4-next958-973-prep",
            "stat4Next958973PreparationFence" => $fence,
            "selectedPlan" => [
                "next958973Prepared" => $ready,
                "next958973SliceCount" => $fence["sliceCount"],
                "next958973PreparedSlices" => $fence["preparedSlices"],
                "next958973BlockedSlices" => $fence["blockedSlices"],
                "next958973PriorHandoffSignature" => $fence["priorHandoffSignature"],
            ...
            "dependency_closure" => "no new support component needed; next958-973 preparation extends the accepted next942-957 current-source STAT4 handoff slices and keeps their projected row continuity for follow-on planner work",
            "non_overlap" => "prepares next958-973 current-source handoff slices only; avoids changing next942-957 handoff windows, next926-941 handoff windows, next910-925 handoff windows, next894-909 handoff windows, next878-893 handoff windows, next862-877 handoff windows, next846-861 handoff windows, next830-845 handoff windows, next814-829 handoff windows, next798-813 handoff windows, next782-797 handoff windows, next766-781 handoff windows, next750-765 handoff windows, next734-749 handoff windows, next718-733 handoff windows, next702-717 handoff windows, next686-701 handoff windows, next638-653 handoff windows, next622-637 handoff windows, next606-621 handoff windows, next590-605 handoff windows, next574-589 handoff windows, next558-573 handoff windows, next542-557 handoff windows, next510-525 handoff windows, next494-509 handoff windows, next478-493 handoff windows, next462-477 handoff windows, next430-445 handoff windows, next414-429 handoff windows, next398-413 handoff windows, next382-397 handoff windows, next366-381 handoff windows, next334-349 handoff windows, next318-333 handoff windows, next302-317 handoff windows, next286-301 handoff windows, next270-285 handoff windows, next254-269 handoff windows, next253 payload row-image validation, page anchors, JSON, WAL, VFS, B-tree, trigger, PRAGMA, compound SELECT, and UTF clusters",
            "detail" => trim((string) ($base["detail"] ?? "") . " NEXT958-973 PREPARED HANDOFF"),
        ]);
    }
    ...
    private static function handoffFenceNext958973(array $base, array $currentSource, array $neededColumns): array
    {
        ...
        $prior = $base["stat4Next942957PreparationFence"] ?? null;
        if (!is_array($prior)) {
            throw new \InvalidArgumentException("SQLite next958-973 needs next942-957 handoff fence");
        }
    ...
    private static function cursorProgramNext958973(array $program, bool $ready, array $fence): array
    {
        ...
        $program[] = [
            "opcode" => "PrepareStat4ExpressionPartialNext958973Handoff",
            "mode" => "next958-973-current-source-stat4-expression-partial-prep",
            "sliceRange" => $fence["sliceRange"],
            "priorSliceRange" => $fence["priorSliceRange"],
            "preparedSlices" => $fence["preparedSlices"],
            "priorHandoffSignature" => $fence["priorHandoffSignature"],
     ...
     * @return array<string,mixed>
     */
    public static function materializeNext974989(
        array $preparedSource,
        array $currentSource,
        array $queryTerms,
        array $neededColumns,
        ...
        $fence = self::handoffFenceNext974989($base, $currentSource, $neededColumns);
        $ready = ($base["status"] ?? null) === "stat4-expression-partial-current-source-next958-973-prepared"
            && $fence["allSlicesPrepared"]
            && $fence["previousFenceReady"];

        return array_replace_recursive($base, [
            "status" => $ready ? "stat4-expression-partial-current-source-next974-989-prepared" : "requires-current-source-stat4-next974-989-prep",
            "stat4Next974989PreparationFence" => $fence,
            "selectedPlan" => [
                "next974989Prepared" => $ready,
                "next974989SliceCount" => $fence["sliceCount"],
                "next974989PreparedSlices" => $fence["preparedSlices"],
                "next974989BlockedSlices" => $fence["blockedSlices"],
                "next974989PriorHandoffSignature" => $fence["priorHandoffSignature"],
                "next974989HandoffSignature" => $fence["handoffSignature"],
            ],
            "stat4Fence" => [
                "next974989Prepared" => $ready,
                "next974989HandoffSignature" => $fence["handoffSignature"],
            ],
            "cursorProgram" => self::cursorProgramNext974989($base["cursorProgram"] ?? [], $ready, $fence),
            "dependencies" => array_values(array_unique(array_merge(
                $base["dependencies"] ?? [],
                ["sqlite-sqlplanner-stat4-expression-partial-current-source-next974-989-prep"],
            ))),
            "dependency_closure" => "no new support component needed; next974-989 preparation extends the accepted next958-973 current-source STAT4 handoff slices and keeps their projected row continuity for follow-on planner work",
            "non_overlap" => "prepares next974-989 current-source handoff slices only; avoids changing next958-973 handoff windows, next942-957 handoff windows, next926-941 handoff windows, next910-925 handoff windows, next894-909 handoff windows, next878-893 handoff windows, next862-877 handoff windows, next846-861 handoff windows, next830-845 handoff windows, next814-829 handoff windows, next798-813 handoff windows, next782-797 handoff windows, next766-781 handoff windows, next750-765 handoff windows, next734-749 handoff windows, next718-733 handoff windows, next702-717 handoff windows, next686-701 handoff windows, next638-653 handoff windows, next622-637 handoff windows, next606-621 handoff windows, next590-605 handoff windows, next574-589 handoff windows, next558-573 handoff windows, next542-557 handoff windows, next510-525 handoff windows, next494-509 handoff windows, next478-493 handoff windows, next462-477 handoff windows, next430-445 handoff windows, next414-429 handoff windows, next398-413 handoff windows, next382-397 handoff windows, next366-381 handoff windows, next334-349 handoff windows, next318-333 handoff windows, next302-317 handoff windows, next286-301 handoff windows, next270-285 handoff windows, next254-269 handoff windows, next253 payload row-image validation, page anchors, JSON, WAL, VFS, B-tree, trigger, PRAGMA, compound SELECT, and UTF clusters",
            "detail" => trim((string) ($base["detail"] ?? "") . " NEXT974-989 PREPARED HANDOFF"),
        ]);
    }

    private static function handoffFenceNext974989(array $base, array $currentSource, array $neededColumns): array
    {
        if ($neededColumns === []) {
            throw new \InvalidArgumentException("SQLite next974-989 needs projected columns");
        }

        $prior = $base["stat4Next958973PreparationFence"] ?? null;
        if (!is_array($prior)) {
            throw new \InvalidArgumentException("SQLite next974-989 needs next958-973 handoff fence");
        }

        $priorWindows = $prior["handoffWindows"] ?? null;
        if (!is_array($priorWindows) || $priorWindows === []) {
            throw new \InvalidArgumentException("SQLite next974-989 needs next958-973 handoff windows");
        }
        ...
        foreach (range(974, 989) as $slice) {
            $ordinal = $slice - 974;
            $priorWindow = $priorWindows[$ordinal % count($priorWindows)];
            if (!is_array($priorWindow)) {
                throw new \InvalidArgumentException("SQLite next974-989 prior handoff windows must be arrays");
            }
    ...
    private static function cursorProgramNext974989(array $program, bool $ready, array $fence): array
    {
        if (!$ready) {
            return $program;
        }
        ...
        $program[] = [
            "opcode" => "PrepareStat4ExpressionPartialNext974989Handoff",
            "mode" => "next974-989-current-source-stat4-expression-partial-prep",
            "sliceRange" => $fence["sliceRange"],
            "priorSliceRange" => $fence["priorSliceRange"],
            "preparedSlices" => $fence["preparedSlices"],
            "priorHandoffSignature" => $fence["priorHandoffSignature"],
    ...
    private static function handoffFenceNext9901005(array $base, array $currentSource, array $neededColumns): array
    {
        ...
        $prior = $base["stat4Next974989PreparationFence"] ?? null;
        if (!is_array($prior)) {
            throw new \InvalidArgumentException("SQLite next990-1005 needs next974-989 handoff fence");
        }

        $priorWindows = $prior["handoffWindows"] ?? null;
        if (!is_array($priorWindows) || $priorWindows === []) {
            throw new \InvalidArgumentException("SQLite next990-1005 needs next974-989 handoff windows");
        }
        ...
        foreach (range(990, 1005) as $slice) {
            ...
            $priorWindow = $priorWindows[$ordinal % count($priorWindows)];
            if (!is_array($priorWindow)) {
                throw new \InvalidArgumentException("SQLite next990-1005 prior handoff windows must be arrays");
            }
