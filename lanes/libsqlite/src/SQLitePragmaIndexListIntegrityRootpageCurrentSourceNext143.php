...
final class SQLitePragmaIndexListIntegrityRootpageCurrentSourceNext143
{
    /**
    ...
    public static function currentNextPage(
        ...
        $currentRows = self::sideRows('current', SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139::collect(
            $currentCatalog,
            $indexListSql,
            $currentDatabase,
            $integritySql,
        ...
        $nextRows = self::sideRows('next', SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139::collect(
            $nextCatalog,
            $indexListSql,
            $nextDatabase,
            $integritySql,
