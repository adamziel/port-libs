...
final class SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext185Plan
{
    /**
    ...
    public static function execute(
        ...
        $failExecuted = self::statementSummary('or-fail-partial-before-rollback', 0, $failStatement, $failResult, $beforeFailStatement, $rowIdColumn);
        $failReturning = [[
        ...
        return [
            ...
            'pre_fail_returning_count' => self::returningCount($preFailReturning),
            'partial_fail_returning_count' => self::returningCount($failReturning),
            'suppressed_by_rollback_count' => self::returningCount($suppressedReturning),
            'yielded_after_retry_count' => self::returningCount($retryReturning),
            'attempted_changes_before_rollback_to' => self::changeCount($attemptedExecuted),
            'partial_fail_changes_before_rollback_to' => self::changeCount([$failExecuted]),
