...
final class SQLitePragmaForeignKeyIndexRootpageCurrentSourceNext144
{
    /**
    ...
    public static function page(
        ...
        $currentPage = SQLitePragmaForeignKeyIndexRootCurrentSourceNext125::page(
            $currentCatalog,
            $indexXinfoSql,
            $currentDatabase,
            $currentSchemas,
        ...
        $nextPage = SQLitePragmaForeignKeyIndexRootCurrentSourceNext125::page(
            $nextCatalog,
            $indexXinfoSql,
            $nextDatabase,
            $nextSchemas,
