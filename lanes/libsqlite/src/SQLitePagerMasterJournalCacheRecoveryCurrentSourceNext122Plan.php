...
final class SQLitePagerMasterJournalCacheRecoveryCurrentSourceNext122Plan
{
    /**
    ...
    public static function currentSourceNext(
        ...
        $cachedRecovery = SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext(
            $masterJournalPath,
            $cachedMasterJournalBytes,
            $databases,
            $pageSize,
        ...
        $currentRecovery = SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext(
            $masterJournalPath,
            $currentMasterJournalBytes,
            $databases,
            $pageSize,
