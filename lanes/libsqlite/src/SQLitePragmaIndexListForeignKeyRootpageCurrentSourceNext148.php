...
final class SQLitePragmaIndexListForeignKeyRootpageCurrentSourceNext148
{
    /**
    ...
    public static function collect(
        ...
        $indexRows = array_map(
            ...
            SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139::collect($catalog, $indexListSql, $database, $integritySql, $tableValuedIndexList),
        );
        $foreignKeyRows = array_map(
            ...
            SQLitePragmaRootpagePointerMapForeignKeyCurrentSourceNext122::collect($database, $schemas, $catalog, $foreignKeySql),
        );
