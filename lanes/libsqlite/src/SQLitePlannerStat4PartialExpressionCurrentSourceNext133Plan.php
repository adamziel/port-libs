...
final class SQLitePlannerStat4PartialExpressionCurrentSourceNext133Plan
{
    /**
    ...
    public static function materialize(
        ...
        $base = SQLitePlannerCoveringExpressionStat4CurrentSourceNext122Plan::materialize(
            $preparedSource,
            $currentSource,
            $predicate,
            $currentRows,
    ...
    private static function cursorTape(array $base, array $rowDelta, array $neededColumns, bool $ready): array
    {
        ...
        return array_replace($base['cursorTape'] ?? [], [
            'currentNextRows' => self::currentNext($currentRows),
