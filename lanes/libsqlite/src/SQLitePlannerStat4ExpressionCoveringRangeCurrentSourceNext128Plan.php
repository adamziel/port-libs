...
final class SQLitePlannerStat4ExpressionCoveringRangeCurrentSourceNext128Plan
{
    /**
    ...
    public static function materialize(
        ...
        $preparedView = SQLitePlannerCoveringExpressionStat4CurrentSourceNext122Plan::materialize(
            $preparedSource,
            $preparedSource,
            $preparedPredicate,
            $currentRows,
        ...
        $currentView = SQLitePlannerCoveringExpressionStat4CurrentSourceNext122Plan::materialize(
            $preparedSource,
            $currentSource,
            $currentPredicate,
            $currentRows,
        ...
        return array_replace($currentView, [
            ...
            'dependencies' => [
                ...
                'SQLitePlannerCoveringExpressionStat4CurrentSourceNext122Plan',
