...
final class SQLiteUtf16NoCaseLikeRtrimPatternCurrentSourceNextPlan
{
    /**
     ...
     */
    public static function keyValueRowKeyPatternPlan(
        array $currentRows,
        array $nextRows,
        ...
        string $currentSource = 'main.app_settings@159',
        string $nextSource = 'main.app_settings@160',
