...
final class SQLitePlannerStat4ExpressionCoveringCurrentSourceNext144Plan
{
    /**
    ...
    public static function materialize(
        ...
        $preparedView = SQLiteStat4ExpressionCoveringCurrentSourceNext117Plan::materialize(
            $preparedSource,
            $preparedSource,
            $predicate,
            $orderBy,
        ...
        $currentView = SQLiteStat4ExpressionCoveringCurrentSourceNext117Plan::materialize(
            $preparedSource,
            $currentSource,
            $predicate,
            $orderBy,
        ...
        return array_replace($currentView, [
            ...
            'currentSourceFence' => array_replace(
                ...
                [
                    ...
                    'next144PreparedRowStreamSignature' => self::rowStreamSignature($preparedRows),
                    'next144CurrentRowStreamSignature' => self::rowStreamSignature($currentRows),
                    'next144PayloadSignature' => self::payloadSignature($currentRows),
                ],
            ),
            ...
            'dependencies' => array_values(array_unique(array_merge(
                ...
                [
                    'SQLiteStat4ExpressionCoveringCurrentSourceNext117Plan',
