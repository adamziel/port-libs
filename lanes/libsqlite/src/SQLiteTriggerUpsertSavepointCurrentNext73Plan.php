...
final class SQLiteTriggerUpsertSavepointCurrentNext73Plan
{
    /**
    ...
    public static function execute(
        ...
        foreach ($incomingRows as $ordinal => $incoming) {
            ...
            } catch (SQLiteTriggerUpsertSavepointCurrentNext73Signal $signal) {
    ...
    private static function fireTriggers(array &$state, array $triggers, string $timing, string $event, ?array $old, array &$new, array $uniqueColumns, array $assignments, int $depth, int $ordinal): void
    {
        foreach ($triggers as $trigger) {
            ...
            if ($action === 'set-new') {
                ...
                throw new SQLiteTriggerUpsertSavepointCurrentNext73Signal(
...
final class SQLiteTriggerUpsertSavepointCurrentNext73Signal extends \RuntimeException
{
