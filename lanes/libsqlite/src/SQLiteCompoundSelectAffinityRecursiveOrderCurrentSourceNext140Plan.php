...
final class SQLiteCompoundSelectAffinityRecursiveOrderCurrentSourceNext140Plan
{
    /**
    ...
    public static function compare(string $sql, array $currentTables, array $nextTables): array
    {
        ...
        return [
            ...
            'recursive' => [
                ...
                'currentAcceptedNextNames' => self::acceptedNextNames($currentTrace['trace']),
                'nextAcceptedNextNames' => self::acceptedNextNames($nextTrace['trace']),
     ...
     */
    private static function acceptedNextNames(array $trace): array
    {
        $names = [];
