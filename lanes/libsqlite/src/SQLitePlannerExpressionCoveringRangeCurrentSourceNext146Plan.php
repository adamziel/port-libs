...
final class SQLitePlannerExpressionCoveringRangeCurrentSourceNext146Plan
{
    /**
    ...
    public static function materialize(
        ...
        $base = SQLitePlannerCoveringExpressionRangeCurrentSourceNext134Plan::materialize(
            $preparedSource,
            $currentSource,
            $preparedPredicate,
            $currentPredicate,
        ...
        $nextSummary = $nextSource === null ? null : self::nextSummary($currentSource, $nextSource, $currentRows);
        ...
        return array_replace($base, [
            ...
            'dependencies' => array_values(array_unique(array_merge(
                ...
                [
                    'SQLitePlannerCoveringExpressionRangeCurrentSourceNext134Plan',
     ...
     * @return array<string,mixed>
     */
    private static function nextSummary(array $currentSource, array $nextSource, array $currentRows): array
    {
