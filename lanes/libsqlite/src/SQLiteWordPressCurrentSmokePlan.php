...
final class SQLiteWordPressCurrentSmokePlan
{
    /**
    ...
    {
        $plan = SQLiteWordPressImportTransactionErrorYieldPlan::plan($currentRows, $stagedRows, $options);
        ...
        return [
            ...
            'dependencies' => array_values(array_unique(array_merge($plan['dependencies'], [
                'sqlite-wordpress-current-smoke-option-import',
                'sqlite-wordpress-current-smoke-yield-summary',
            ]))),
        ];
    }
}
