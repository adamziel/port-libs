...
final class SQLiteTriggerDeferredReturningSavepointCurrentSourceNext141Plan
{
    /**
    ...
    public static function commitBarrierRetry(
        ...
        $attempt = SQLiteTriggerDeferredReturningSavepointCurrentSourceNext119Plan::updateParentsWithinSavepoint(
            $parents,
            $children,
            $updates,
            $foreignKey,
