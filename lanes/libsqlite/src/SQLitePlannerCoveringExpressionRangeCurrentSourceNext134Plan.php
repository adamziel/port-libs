...
final class SQLitePlannerCoveringExpressionRangeCurrentSourceNext134Plan
{
    /**
    ...
    public static function materialize(
        ...
        $base = SQLitePlannerStat4ExpressionCoveringRangeCurrentSourceNext128Plan::materialize(
            $preparedSource,
            $currentSource,
            $preparedPredicate,
            $currentPredicate,
        ...
        $streamRows = self::streamRows($currentNextRows);
        if ($descending) {
            $streamRows = array_reverse($streamRows);
        }
        $streamPairs = self::currentNext($streamRows);
        ...
        return array_replace($base, [
            ...
            'dependencies' => [
                ...
                'SQLitePlannerStat4ExpressionCoveringRangeCurrentSourceNext128Plan',
     ...
     */
    private static function streamRows(array $currentNextRows): array
    {
        $rows = [];
