...
final class SQLitePagerMasterJournalCacheSpillSavepointCurrentSourceNext114Plan
{
    /**
    ...
    public static function currentSourceNext(
        ...
        $recovery = SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext(
            $masterJournalPath,
            $masterJournalBytes,
            $databases,
            $pageSize,
