...
/**
    ...
    private static function readyPublicationBase(
        ...
        $base = self::executeNext734($tables, $yieldStatements, $attemptStatements, $retryStatements, $uniqueConstraints, $savepoint, $rowIdColumn);
    ...
    public static function executeReadyPublicationContinuation(
        ...
        if ($publicationStep < 734 || $publicationStep > 1181) {
            throw new \InvalidArgumentException('SQLite row-value window ready-publication continuation step must be between 734 and 1181');
        }
