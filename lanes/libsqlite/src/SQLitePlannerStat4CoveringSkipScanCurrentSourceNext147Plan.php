...
final class SQLitePlannerStat4CoveringSkipScanCurrentSourceNext147Plan
{
    /**
    ...
    public static function materialize(
        ...
        $preparedView = SQLitePlannerExpressionSkipScanRangeCurrentSourceNext143Plan::materialize(
            $preparedSource,
            $preparedSource,
            $partialPredicate,
            $queryTerms,
        ...
        $currentView = SQLitePlannerExpressionSkipScanRangeCurrentSourceNext143Plan::materialize(
            $preparedSource,
            $currentSource,
            $partialPredicate,
            $queryTerms,
        ...
        return array_replace($currentView, [
            ...
            'dependencies' => [
                'SQLitePlannerExpressionSkipScanRangeCurrentSourceNext143Plan::materialize',
    ...
    {
        return self::key($sample['prefix']) . "\0" . self::key($sample['suffix']);
    }
