...
final class SQLiteTriggerReturningSavepointCurrentNext65Plan
{
    /**
    ...
    public static function updateRows(
        ...
        foreach ($working as $index => $old) {
            ...
            } catch (SQLiteTriggerReturningSavepointCurrentNext65Signal $signal) {
    ...
    private static function fireTriggers(string $timing, string $event, array $old, array $next, array $triggers, int $ordinal): array
    {
        ...
        foreach ($triggers as $trigger) {
            ...
            if ($action === 'raise') {
                ...
                throw new SQLiteTriggerReturningSavepointCurrentNext65Signal($raise, (string) ($trigger['reason'] ?? 'trigger-raise'));
            }
            if ($action === 'set-new') {
...
final class SQLiteTriggerReturningSavepointCurrentNext65Signal extends \RuntimeException
{
