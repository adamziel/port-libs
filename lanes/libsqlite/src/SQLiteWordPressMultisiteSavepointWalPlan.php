...
final class SQLiteWordPressMultisiteSavepointWalPlan
{
    /**
    ...
    public static function rollbackToAcrossSites(array $sites, int $pageSize): array
    {
        ...
        $currentReaderMatrix = [];
        $nextReaderMatrix = [];
        $dependencies = ['sqlite-wordpress-multisite-savepoint-wal-current-next'];
        $rolledBack = 0;
        $stable = 0;
    ...
    private static function siteSummary(array $site, int $pageSize): array
    {
        ...
        return [
            ...
            'dependencies' => array_values(array_unique(array_merge(
                ['sqlite-wordpress-multisite-site-savepoint-wal'],
