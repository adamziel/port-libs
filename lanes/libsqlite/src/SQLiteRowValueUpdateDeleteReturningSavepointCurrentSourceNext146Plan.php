...
final class SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext146Plan
{
    /**
    ...
    public static function execute(
        ...
        foreach ($statements as $ordinal => $sql) {
            ...
            $summary = self::statementSummary($ordinal, $result, $rowIdColumn, $before);
            $executed[] = $summary;
            $attemptedYielded[] = [
                'ordinal' => $ordinal,
        ...
        return [
            ...
            'discarded_returning_count' => $rolledBack ? self::returningCount($attemptedYielded) : 0,
