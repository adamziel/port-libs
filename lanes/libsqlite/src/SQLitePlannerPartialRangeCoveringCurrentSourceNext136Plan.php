...
final class SQLitePlannerPartialRangeCoveringCurrentSourceNext136Plan
{
    /**
    ...
    {
        $base = SQLitePlannerCoveringPartialRangeCurrentSourceNext131Plan::materialize(
            $preparedSource,
            $currentSource,
            $predicate,
            $neededColumns,
        ...
        $base['currentSourceNextRows'] = self::currentNextRows($filteredRows);
        ...
        $base['dependencies'] = [
            'SQLitePlannerCoveringPartialRangeCurrentSourceNext131Plan',
