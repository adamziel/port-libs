...
final class SQLitePragmaForeignKeyIntegrityRootpageCurrentSourceNext140Plan
{
    /**
    ...
    public static function page(
        ...
        $currentPage = SQLitePragmaRootpagePointerMapForeignKeyCurrentSourceNext122::page($currentDatabase, $currentSchemas, $currentCatalog, $foreignKeySql, 0, PHP_INT_MAX);
        $nextPage = SQLitePragmaRootpagePointerMapForeignKeyCurrentSourceNext122::page($nextDatabase, $nextSchemas, $nextCatalog, $foreignKeySql, 0, PHP_INT_MAX);
        $source = [
