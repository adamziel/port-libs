...
final class SQLiteTriggerReturningFkSavepointCurrentNext74Plan
{
    /**
    ...
    public static function update(
        ...
        foreach ($attemptParents as $index => $old) {
            ...
            } catch (SQLiteTriggerReturningFkSavepointCurrentNext74Signal $signal) {
    ...
    private static function fireTriggers(string $timing, string $event, array $old, array $next, array $triggers, int $ordinal): array
    {
        ...
        foreach ($triggers as $trigger) {
            ...
            if ($action === 'set-new') {
                ...
                throw new SQLiteTriggerReturningFkSavepointCurrentNext74Signal(
...
final class SQLiteTriggerReturningFkSavepointCurrentNext74Signal extends \RuntimeException
{
