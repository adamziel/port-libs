...
final class SQLitePragmaForeignKeyIndexRootCurrentSourceNext125
{
    /**
    ...
    public static function collect(
        ...
        foreach (SQLitePragmaRootpagePointerMapForeignKeyCurrentSourceNext122::collect($database, $schemas, $catalog, $foreignKeySql) as $row) {
            $rows[] = [
                ...$row,
