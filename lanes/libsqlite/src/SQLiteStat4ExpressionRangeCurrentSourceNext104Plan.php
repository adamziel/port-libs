...
final class SQLiteStat4ExpressionRangeCurrentSourceNext104Plan
{
    /**
     ...
     */
    public static function compare(array $preparedSource, array $currentSource, array $predicate, array $neededColumns = []): array
    {
