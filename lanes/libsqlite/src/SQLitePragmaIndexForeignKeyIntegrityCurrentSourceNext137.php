...
final class SQLitePragmaIndexForeignKeyIntegrityCurrentSourceNext137
{
    /**
    ...
    public static function collect(
        ...
        foreach (SQLitePragmaIndexIntegrityCursorCurrentSourceNext133::collect($catalog, $indexListSql, $database, $integritySql, $tableValuedIndexList) as $row) {
            $rows[] = [
                ...$row,
