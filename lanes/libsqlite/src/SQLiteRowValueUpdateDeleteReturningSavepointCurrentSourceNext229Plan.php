...
final class SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext229Plan
{
    /**
    ...
    public static function execute(
        ...
        [$yieldCurrent, $yieldExecuted, $yieldReturning] = self::runStatements(
            $savepointImage,
            $yieldStatements,
            $uniqueConstraints,
            $rowIdColumn,
        ...
        $yieldedRows = self::flattenReturning($yieldReturning);
        ...
        return [
            ...
            'release_receipt_next229' => [
                ...
                'yielded_ids' => self::idsFromRows($yieldedRows, $rowIdColumn),
