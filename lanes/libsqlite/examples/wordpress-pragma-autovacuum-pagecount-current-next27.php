...
$report = [
    ...
    'wordpressUse' => 'Preview a copied WordPress SQLite database deciding whether enabling incremental auto_vacuum is current or pending while preserving current page_count without ext/sqlite.',
