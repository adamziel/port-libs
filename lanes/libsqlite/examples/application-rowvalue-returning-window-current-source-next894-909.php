...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next894-909 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next893_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next894-909 self-test passed\n";
    return;
}
