...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options JSON aggregate window FILTER regression preserves one output frame per input row while filtered rows only stop contributing to aggregate payloads.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-aggregate-window-filter-regression self-test passed\n";
    return;
}
