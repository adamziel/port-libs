...
echo json_encode([
    ...
    'wordpressUse' => 'Paginate deep PRAGMA integrity_check pointer-map and freelist diagnostics during a copied WordPress SQLite import repair without requiring ext/sqlite.',
    'firstPage' => [
