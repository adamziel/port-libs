...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-next462',
    'epoch' => 462,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 462, 0])),
    'publication_generation' => 462,
    'master_source_digest' => hash('sha256', 'wordpress next462 master source'),
...
$cache = [1 => array_merge($base, ['reader_id' => 'wp-options-reader', 'image' => $recovered[1], 'reader_cache_stmt_vdbe_open_dup_token' => 'stmt-vdbe-open-dup-old'])];
...
echo json_encode([
    ...
    'next462_invalidated_pages' => $plan['reader_cache_stmt_vdbe_open_dup_invalidated_cache_page_numbers'],
