...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options cleanup SQL that uses row-value BETWEEN predicates with UPDATE/DELETE RETURNING, keeping SQLite current-source NULL and simultaneous row-value assignment behavior in native PHP.',
