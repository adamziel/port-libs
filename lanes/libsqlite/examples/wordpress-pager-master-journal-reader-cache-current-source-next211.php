...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext211Plan.php';

use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext211Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext211Plan::plan(
    $database,
    $masterJournal,
    $masterBytes,
