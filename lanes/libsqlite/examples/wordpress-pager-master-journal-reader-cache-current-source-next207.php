...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext207Plan.php';

use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext207Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext207Plan::plan(
    $database,
    $masterJournal,
    implode("\n", $members) . "\n",
