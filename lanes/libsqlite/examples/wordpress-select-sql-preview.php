...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows from bounded SQLite SELECT text through the native query-plan executor, including projection aliases, scalar functions, WHERE predicates, ORDER BY, and LIMIT without requiring ext/sqlite.',
    'sql' => $sql,
