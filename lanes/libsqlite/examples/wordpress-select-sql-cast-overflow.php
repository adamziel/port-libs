...
$summary = [
    'wordpressUse' => 'Preview copied wp_options numeric threshold settings where parser-level CAST() follows SQLite int64 clamp and NUMERIC overflow promotion without requiring ext/sqlite.',
