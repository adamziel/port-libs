...
echo json_encode([
    'scenario' => 'wordpress-json-table-host-join',
    'planned' => [
        'rows' => array_map(
    ...
    'wordpressUse' => 'Local-only wp_options diagnostics can join copied option rows to json_tree() output for plugin-rule scans, preserving LEFT JOIN rows for empty or invalid JSON without ext/sqlite.',
