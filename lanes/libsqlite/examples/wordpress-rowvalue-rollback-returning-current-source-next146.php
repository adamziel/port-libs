...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeRollbackReturningTransaction(
    ['wp_options' => $rows],
    [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-rowvalue-rollback-returning-current-source-next146 self-test passed\n";
    return;
}
