...
$summary = [
    'scenario' => 'application-vfs-uri-filecontrol-shm-current-source-next136',
    'applicationUse' => 'During a copied Application SQLite import, route URI xFileControl probes to the selected main or SHM handle, detect stale SHM current-source data-version after persist-WAL changes, and release SHM xLock ownership when the SHM handle closes without dropping the main database byte lock.',
