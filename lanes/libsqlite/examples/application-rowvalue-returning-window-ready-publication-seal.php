...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the ready-publication row-value UPDATE/DELETE RETURNING window continuation as the direct handoff from the preceding ready receipt.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-ready-publication-seal self-test passed\n";
    return;
}
