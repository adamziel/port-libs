...
echo json_encode([
    'wordpressUse' => 'Walk PRAGMA index_xinfo current/next rows for copied wp_options expression indexes so schema diagnostics can stream expression terms, ordinary columns, and rowid auxiliary rows without ext/sqlite.',
