...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidYieldCost(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next215',
    'applicationUse' => 'Copied wp_options plugin-rule JSON diagnostics can yield an active generated-path json_tree rowid while preserving the next resume rowid and forcing reprepare when the source generation changes.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next215 self-test passed\n";
    return;
}
