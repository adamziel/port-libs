...
$summary = [
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next200',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'Copied wp_options plugin scans can reuse a partial lower(option_name) STAT4 prefix window while preserving NOT BETWEEN residual checks against current-source rows after ANALYZE refresh.',
];
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next200 self-test passed\n";
    return;
}
