...
$summary = [
    'scenario' => 'wordpress-json-table-generated-hidden-rowid-cost',
    'wordpressUse' => 'Copied wp_options plugin-setting previews can keep a generated priority/enabled filter and a hidden rowid seek pinned to the current json_tree() source while a next import adds sibling rules.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-hidden-rowid-cost self-test passed\n";
    return;
}
