...
$summary = [
    'applicationUse' => 'Track copied wp_options temp statement-journal xFileControl state and lock release across close/reopen boundaries without requiring ext/sqlite.',
    'status' => $plan['status'],
