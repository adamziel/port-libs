...
if ($databasePath === null || $lower === null || $upper === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-option-value-integer-range.php path/to/wordpress.sqlite lower_integer|- upper_integer|- [limit] [upper_inclusive]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedIntegerOptionValueRange($lowerBound, $upperBound, $limit, $upperInclusive),
);
