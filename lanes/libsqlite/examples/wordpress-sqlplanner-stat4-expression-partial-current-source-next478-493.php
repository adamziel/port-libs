...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext478493(
    $prepared,
    $current,
    [
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-sqlplanner-stat4-expression-partial-current-source-next478-493 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-source-next478-493',
    'wordpressUse' => 'Copied wp_options plugin-admin pagination carries the next462-477 current-source STAT4 handoff into next478-493 only when projected current rows still match.',
    'status' => $plan['status'],
