...
if ($databasePath === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-option-name-prefix.php path/to/wordpress.sqlite [option_name_prefix] [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedNamePrefix($prefix, $limit),
);
