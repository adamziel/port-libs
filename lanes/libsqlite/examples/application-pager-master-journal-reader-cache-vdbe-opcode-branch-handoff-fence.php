...
$base = [
    'source_id' => 'application-pager-reader-cache-vdbe-opcode-branch-handoff',
    'epoch' => 702,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 702, 0])),
    'publication_generation' => 702,
    'master_source_digest' => hash('sha256', 'application vdbe-opcode-branch-handoff master source'),
