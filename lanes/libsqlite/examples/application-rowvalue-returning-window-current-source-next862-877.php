...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next862-877 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next861_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next862-877 self-test passed\n";
    return;
}
