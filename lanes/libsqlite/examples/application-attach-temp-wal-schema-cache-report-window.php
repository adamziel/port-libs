...
$plan = SQLiteAttachWalTempSchemaCachePlan::schemaCacheReportWindow($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-attach-temp-wal-schema-cache-report-window self-test passed\n";
    return;
}
