...
$report = [
    'scenario' => 'wordpress-wal-crash-recovery-checkpoint-current-next33',
    'wordpressUse' => 'Copied wp_options checkpoint recovery after a crash between durable database pages and durable WAL reset, proving the old WAL can be replayed idempotently for the next opener while current readers remain stable.',
    'status' => $plan['status'],
    'reason' => $plan['reason'],
