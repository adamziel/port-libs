...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext220Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next220',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, commit the latched pointer-map/freeblock page writes with pointer-map pages durable before payload pages.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next220 self-test passed\n";
}
