...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::keyValueRowKeyDescYieldPagePlan(
    $current,
    $next,
    limit: 2,
    offset: 1,
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "application-utf16-nocase-like-rtrim-current-source-next223 self-test passed\n";
}
