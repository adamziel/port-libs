...
$summary = [
    'scenario' => 'application-pager-savepoint-wal-hot-journal-current-source-next148',
    'applicationUse' => 'Copied wp_options imports can recover a hot rollback journal before retrying a savepoint while an existing WAL reader remains pinned to the recovered current source and later savepoint writes use a distinct WAL generation.',
    'status' => $plan['status'],
...
if (PHP_SAPI === 'cli' && realpath($_SERVER['SCRIPT_FILENAME'] ?? '') === __FILE__) {
    ...
    echo "application-pager-savepoint-wal-hot-journal-current-source-next148 self-test passed\n";
}
