...
$database = SQLiteFileUri::parse('file:/srv/wordpress/wp-content/database/site%20copy.sqlite?mode=rw&cache=shared&busy_timeout=35');
...
echo json_encode([
    ...
    'wordpressUse' => 'Preview SQLite busy-handler retry and timeout behavior before copied WordPress database opens or WAL checkpoints on hosts without ext/sqlite.',
