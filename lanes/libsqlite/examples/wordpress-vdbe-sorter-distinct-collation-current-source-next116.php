...
$summary = [
    'scenario' => 'wordpress-vdbe-sorter-distinct-collation-current-source-next116',
    'wordpressUse' => 'Copied wp_options imports can compare VDBE DISTINCT sorter tapes across source changes, preserving NOCASE duplicate classes while exposing inserted rows and changed representatives without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-vdbe-sorter-distinct-collation-current-source-next116 self-test passed\n";
    exit(0);
}
