...
if ($databasePath === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-option-name-length.php path/to/wordpress.sqlite [option_name_length] [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedNameLength($length, $limit),
);
