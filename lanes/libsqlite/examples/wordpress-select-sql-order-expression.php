...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows from bounded SQLite SELECT text whose ORDER BY terms are scalar or aggregate expressions, while hidden sort columns stay out of the returned WordPress import rows and no ext/sqlite dependency is required.',
    'sql' => $sql,
