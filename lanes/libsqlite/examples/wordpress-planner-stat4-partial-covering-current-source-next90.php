...
$output = [
    'scenario' => 'wordpress-planner-stat4-partial-covering-current-source-next90',
    ...
    'wordpressUse' => 'Preview copied multisite wp_options plugin scans where a prepared partial covering index plan must be rebound to current sqlite_stat4 samples after plugin imports update option_name distribution.',
];
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-planner-stat4-partial-covering-current-source-next90 self-test passed\n";
    exit(0);
}
