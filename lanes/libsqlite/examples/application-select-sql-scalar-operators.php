...
echo json_encode([
    'applicationUse' => 'Preview copied wp_options rows from bounded SQLite SELECT text with native scalar arithmetic and concatenation in projection, WHERE, and ORDER BY without requiring ext/sqlite.',
    'sql' => $sql,
