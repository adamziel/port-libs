...
echo json_encode([
    'wordpressUse' => 'Preview SQLite incremental_vacuum-style file shrink after deleting transient wp_options pages, removing only contiguous free tail pages and preserving lower reusable freelist pages.',
