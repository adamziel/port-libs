...
echo json_encode([
    'wordpressUse' => 'Rewrite a large wp_options row to a small value and return the obsolete SQLite overflow pages to the freelist without the SQLite extension.',
    'plan' => $plan->toArray(),
