...
$payload = [
    'scenario' => 'wordpress-compound-select-window-recursive-limit-current-source-final-page-window-limit',
...
if ($payload['status'] !== 'compound-select-window-recursive-limit-current-source-final-page-window-limit-ready') {
    fwrite(STDERR, "wordpress-compound-select-window-recursive-limit-current-source-final-page-window-limit self-test failed\n");
    exit(1);
}
if ($payload['skippedAnchorRows'] !== ['seed']) {
    fwrite(STDERR, "wordpress-compound-select-window-recursive-limit-current-source-final-page-window-limit anchor offset guard failed\n");
    exit(1);
}
