...
echo json_encode([
    'wordpressScenario' => 'autoloaded wp_options plugin scan uses a proved partial covering index, keeps option_name as the current range, and leaves option_value as a residual next-column predicate.',
