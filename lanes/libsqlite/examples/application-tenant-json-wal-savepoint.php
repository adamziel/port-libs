...
$tenants = [
    [
        ...
        'json_imports' => [
            [
                ...
                'json' => '{"rows":[{"key_name":"main_module_settings","key_value":"{\"enabled\":true}","load_policy":"yes"}]}',
                'path' => '$.rows',
            ],
            [
                'name' => 'bad_payload',
    ...
    [
        ...
        'json_imports' => [
            [
                'name' => 'module_settings',
                'json' => '{"rows":[{"key_name":"child_module_settings","key_value":"{\"enabled\":false}","load_policy":"no"}]}',
                'path' => '$.rows',
            ],
        ],
    ],
...
$plan = SQLiteTenantJsonWalSavepointPlan::plan($tenants, [
...
echo json_encode([
    ...
    'aggregate_wal_frame_count' => $plan['aggregate_wal']['frame_count'],
    'aggregate_rollback' => $plan['aggregate_rollback'],
...
if (in_array('--self-test', $argv, true)) {
    ...
    if ($plan['aggregate_wal']['frame_count'] !== 0 || $plan['aggregate_rollback']['discarded_frame_count'] !== 3) {
