...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next166',
    'applicationUse' => 'Copied wp_options plugin-rule previews can keep yielding the current json_tree generated-path rowid point cursor while a shifted next source is prepared separately.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next166 self-test passed\n";
    return;
}
