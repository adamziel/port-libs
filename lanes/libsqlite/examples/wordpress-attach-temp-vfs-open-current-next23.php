...
$site = SQLiteAttachTempVfsOpenPlan::forAttachSql(
    "ATTACH 'file:/srv/wordpress/wp-content/database/site.sqlite?mode=rw&cache=shared' AS site",
    true,
    true,
);
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    assert($summary['site_path'] === '/srv/wordpress/wp-content/database/site.sqlite');
    assert($summary['site_wal_path'] === '/srv/wordpress/wp-content/database/site.sqlite-wal');
    ...
    echo "wordpress-attach-temp-vfs-open-current-next23 self-test passed\n";
    return;
}
