...
$summary = [
    ...
    'wordpressUse' => 'Repair and migration preflights can resume paged pointer-map integrity and attached foreign-key diagnostics only at the exact emitted next offset.',
...
if (in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-integrity-pointermap-foreignkey-current-source-next94 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-integrity-pointermap-foreignkey-current-source-next94 self-test passed\n");
    return;
}
