...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext181Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext181Plan::execute(
    $base,
    [
