...
$summary = [
    'scenario' => 'wordpress-wal-checksum-salt-recovery-current-next70',
    'wordpressUse' => 'Copied wp_options WAL recovery after a restart uses the new WAL header salt and checksum chain while ignoring stale old-salt frames left past the durable next WAL prefix.',
    'status' => $plan['status'],
    'reason' => $plan['reason'],
