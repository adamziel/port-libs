...
$summary = [
    'scenario' => 'wordpress-vfs-uri-shm-lock-current-source-next126',
    'wordpressUse' => 'Model copied WordPress SQLite file: URI SHM byte-lock ownership across wp-admin/wp-cron connections, preserving shared-reader compatibility, writer blockers, and stale current-source data-version detection without ext/sqlite.',
