...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-publication',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, publish current-source next pages only after pointer-map and freeblock visibility make payload reuse safe.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-publication self-test passed\n";
}
