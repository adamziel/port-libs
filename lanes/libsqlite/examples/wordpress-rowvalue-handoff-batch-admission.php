...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeHandoffBatchAdmission(
    ['wp_options' => $rows],
...
if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-handoff-batch-admission self-test passed\n";
    return;
}
