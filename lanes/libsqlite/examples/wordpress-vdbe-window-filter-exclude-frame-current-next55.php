...
$payload = [
    ...
    'wordpressUse' => 'Preview current and next VDBE window aggregate frames for copied wp_options imports without advancing the cursor or requiring ext/sqlite.',
    'rows' => $diagnostics,
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-vdbe-window-filter-exclude-frame-current-next55 self-test passed\n";
    exit(0);
}
