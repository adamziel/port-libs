...
require_once __DIR__ . '/../src/SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan.php';
...
$savepoints->beginTransaction('wordpress-option-import');
...
$plan = SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan::currentSourceNext(
    $databaseBytes,
    $pageSize,
    'plugin-settings',
    $savepoints,
...
$summary = [
    'scenario' => 'wordpress-pager-cache-spill-savepoint-recovery-current-source-next120',
    'status' => $plan['status'],
    ...
    'wordpressUse' => 'During a copied wp_options import, dirty cache pages may spill to the database before a later statement fails. This smoke proves native PHP pager recovery can model ROLLBACK TO restoring the original savepoint page images instead of preserving spilled dirty bytes.',
