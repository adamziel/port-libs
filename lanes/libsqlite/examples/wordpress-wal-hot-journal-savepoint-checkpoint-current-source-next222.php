...
$plan = SQLiteWalHotJournalSavepointCheckpointCurrentSourceNextPlan::next222SourceTicketPlan($next221, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next222 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next222',
    'status' => $plan['status'],
