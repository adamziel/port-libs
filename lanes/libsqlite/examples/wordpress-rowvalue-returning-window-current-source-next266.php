...
$argv = [];
$next265 = require __DIR__ . '/wordpress-rowvalue-returning-window-current-source-next265.php';
...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext266(
    ['wp_options' => $rows],
...
if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next266 self-test passed\n";
    return;
}
