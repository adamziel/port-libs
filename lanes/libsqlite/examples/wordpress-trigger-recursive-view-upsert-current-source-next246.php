...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNextPlan::executeCurrentConflictImageReceipt(
    [
    ...
    [
        ...
        'current_source_cursor_source_close' => 'wp.returning.current.cursor.246',
        'current_source_close_token_source_close' => 'wp.current.source.close.246',
