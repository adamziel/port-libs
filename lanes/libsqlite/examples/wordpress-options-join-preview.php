...
$report = [
    ...
    'wordpressUse' => 'Preview copied wp_options rows joined to option metadata with SQLite INNER/LEFT/USING row-production semantics before import tooling runs SELECT ordering.',
];
