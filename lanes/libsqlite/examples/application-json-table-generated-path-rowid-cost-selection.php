...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-selection',
    'applicationUse' => 'Generated wp_options JSON path scans keep rowid point-cost admission stable while changed copied source rows force the next reader through canonical reprepare behavior.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-selection self-test passed\n";
    return;
}
