...
$base = [
    'source_id' => 'application-pager-reader-cache-foreign-key-fence',
    'epoch' => 306,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 306, 0])),
    'publication_generation' => 306,
    'master_source_digest' => hash('sha256', 'application foreign-key-fence master source'),
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-pager-master-journal-reader-cache-current-source-foreign-key-fence self-test passed\n";
    return;
}
