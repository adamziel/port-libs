...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::optionRowNameYieldPlan(
    [
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-utf16-nocase-like-rtrim-current-source-next164 self-test passed\n";
    return;
}
