...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-finalization',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, finalize the sealed pointer-map/freeblock current-source pages in apply order.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-finalization self-test passed\n";
}
