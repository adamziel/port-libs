...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext172(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next172',
    'wordpressUse' => 'Copied wp_options plugin-rule previews retain the current json_tree generated-path rowid fence while a changed next source receives a fresh fence token.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next172 self-test passed\n";
    return;
}
