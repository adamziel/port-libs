...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafDrainWindowFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next228',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, drain the current-source cursor at EOF without losing duplicate pointer-map page visibility or the secure-delete freeblock receipt.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next228 self-test passed\n";
}
