...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext228Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext228Plan::materialize(
    $prepared,
    $source,
    $where,
