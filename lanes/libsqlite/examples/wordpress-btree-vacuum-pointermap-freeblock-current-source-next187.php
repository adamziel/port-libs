...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext187Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext187Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
    ...
    4,
    str_repeat('next187-final-current-source-barrier-receipt-', 44),
    3,
    true,
);
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next187',
    'status' => $summary['status'],
    'next_source_pages' => $summary['next_source_pages'],
    'fenced_tail_pages' => $summary['fenced_tail_pages'],
    'scrubbed_leaf_pages' => $summary['scrubbed_leaf_pages'],
    'terminal_overflow_pages' => $summary['terminal_overflow_pages'],
    'publish_token' => $summary['publish_token'],
], JSON_PRETTY_PRINT) . PHP_EOL;

if (
    $summary['next_source_pages'] === [3, 106, 107, 108, 109]
    && $summary['fenced_tail_pages'] === [110]
    && $summary['scrubbed_leaf_pages'] === [3]
    && $summary['terminal_overflow_pages'] === [109]
) {
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next187 self-test passed\n";
}
