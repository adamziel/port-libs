...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafCheckpointValidationAuditFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-checkpoint-validation',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, keep current-source next-page cursor receipts chained so pointer-map pages are visible before payload source pages advance.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-checkpoint-validation self-test passed\n";
}
