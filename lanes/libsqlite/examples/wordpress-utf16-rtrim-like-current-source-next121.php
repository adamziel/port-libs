...
$summary = [
    'scenario' => 'wordpress-utf16-rtrim-like-current-source-next121',
    ...
    'wordpressUse' => 'Copied wp_options option_name scans can fall back from an unusable RTRIM LIKE index range to a UTF-16 residual scan while preserving SQLite LIKE trailing-space semantics before import/copy diffing.',
];
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-utf16-rtrim-like-current-source-next121 self-test passed\n";
    return;
}
