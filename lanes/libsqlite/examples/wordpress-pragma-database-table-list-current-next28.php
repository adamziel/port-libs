...
echo json_encode([
    'wordpressUse' => 'Stream copied WordPress attached database inventory and wp_options table metadata with SQLite table-valued PRAGMA current/next semantics without ext/sqlite.',
