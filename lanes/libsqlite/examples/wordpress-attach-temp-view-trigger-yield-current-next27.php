...
echo json_encode([
    'scenario' => 'wordpress attach temp view trigger yielded operations',
    'wordpressUse' => 'Preview copied WordPress option imports through TEMP, main, and attached INSTEAD OF view triggers, yielding schema-qualified writes with NEW row values before ext/sqlite is available.',
    'schemas' => [
