...
$argv = [];
$next267 = require __DIR__ . '/wordpress-rowvalue-returning-window-current-source-next267.php';
$argv = [];
$next268 = require __DIR__ . '/wordpress-rowvalue-returning-window-current-source-next268.php';
$argv = $outerArgv;
...
if ($selfTest) {
    echo "wordpress-rowvalue-returning-window-current-source-next265-268-after-current self-test passed\n";
    return;
}
