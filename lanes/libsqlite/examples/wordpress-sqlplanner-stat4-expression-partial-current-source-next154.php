...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext154Plan;
...
$current = $prepared;
$current['name'] = 'current-wp-options-stat4-expression-partial-next154';
...
echo json_encode([
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-source-next154',
    'status' => $plan['status'],
