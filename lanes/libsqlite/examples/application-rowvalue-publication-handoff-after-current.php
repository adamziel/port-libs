...
$argv = [];
$next266 = require __DIR__ . '/application-rowvalue-source-epoch-watermark.php';
$argv = [];
$next267 = require __DIR__ . '/application-rowvalue-handoff-batch-admission.php';
$argv = [];
$next268 = require __DIR__ . '/application-rowvalue-handoff-manifest.php';
$argv = $outerArgv;
...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the prepared next265-268 current-source row-value UPDATE/DELETE RETURNING handoff as final receipt ledgering, audit watermarking, deterministic batch partitioning, and manifest completion.',
];

if ($selfTest) {
    echo "application-rowvalue-publication-handoff-after-current self-test passed\n";
    return;
}
