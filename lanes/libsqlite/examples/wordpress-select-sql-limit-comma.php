...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options SELECT SQL that uses SQLite comma LIMIT syntax, where LIMIT offset,count skips earlier rows before returning the WordPress import preview without requiring ext/sqlite.',
    'sql' => $sql,
