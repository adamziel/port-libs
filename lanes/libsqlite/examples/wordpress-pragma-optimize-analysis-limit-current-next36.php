...
echo json_encode([
    ...
    'wordpressUse' => 'Copied WordPress SQLite databases can run bounded PRAGMA optimize planning with temporary analysis_limit application, stale sqlite_stat1 detection, attached-schema targeting, and restored connection state without requiring ext/sqlite.',
