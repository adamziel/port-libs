...
$summary = [
    'scenario' => 'application-wal-reader-pin-checkpoint-current-source-next83',
    'applicationUse' => 'During a copied wp_options WAL restart checkpoint, report whether the current reader still uses the preserved WAL, the next reader can source checkpointed pages from the database image, and all later readers use the reset database image without requiring ext/sqlite.',
    'status' => $plan['status'],
