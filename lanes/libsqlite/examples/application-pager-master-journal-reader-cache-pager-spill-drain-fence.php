...
$base = [
    'source_id' => 'application-pager-spill-drain-smoke',
    'epoch' => 258,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 258, 0])),
    'publication_generation' => 258,
    'master_source_digest' => hash('sha256', 'application next258 master source'),
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-pager-master-journal-reader-cache-current-source-next258 self-test passed\n";
    return;
}
