...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-schema-lock-fence',
    'epoch' => 318,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 318, 0])),
    'publication_generation' => 318,
    'master_source_digest' => hash('sha256', 'wordpress schema-lock-fence master source'),
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-schema-lock-fence self-test passed\n";
    return;
}
