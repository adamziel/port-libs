...
echo json_encode([
    'wordpressUse' => 'Vacuum copied wp_options transient table/index overflow pages into current freelist page images, then report the next SQLite freepage allocation order without ext/sqlite.',
