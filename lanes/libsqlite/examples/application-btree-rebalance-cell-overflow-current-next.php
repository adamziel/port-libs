...
echo json_encode([
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, rebalance the current/next leaf pages and reuse the obsolete overflow pages for the next replacement overflow chain.',
