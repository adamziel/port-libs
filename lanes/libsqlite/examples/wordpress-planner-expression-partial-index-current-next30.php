...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo 'wordpress-planner-expression-partial-index-current-next30 self-test passed' . PHP_EOL;
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-planner-expression-partial-index-current-next30',
