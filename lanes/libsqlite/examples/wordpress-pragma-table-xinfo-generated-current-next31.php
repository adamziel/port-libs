...
echo json_encode([
    ...
    'wordpressUse' => 'Inspect copied wp_options generated-column metadata with PRAGMA table_xinfo while keeping literal AS type/default columns visible, without requiring ext/sqlite.',
