...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext236Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext236Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
