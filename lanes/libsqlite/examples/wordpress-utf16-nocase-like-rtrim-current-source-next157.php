...
use PortLibs\LibSqlite\SQLiteUtf16NocaseLikeRtrimCurrentSourceNext157Plan;
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext157Plan::wordpressOptionNamePlan(
    $currentRows,
    $nextRows,
    'plugin\_%',
    '\\',
...
$summary = [
    'scenario' => 'wordpress-utf16-nocase-like-rtrim-current-source-next157',
    'wordpressUse' => 'Copied wp_options scans can keep UTF-16 option_name source rows on an ASCII NOCASE LIKE prefix range over RTRIM index keys, while detecting byte-order changes that invalidate stale import cursors.',
