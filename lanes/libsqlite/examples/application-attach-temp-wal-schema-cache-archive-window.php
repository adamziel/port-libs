...
$plan = SQLiteAttachWalTempSchemaCachePlan::schemaCacheArchiveWindow($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-attach-temp-wal-schema-cache-archive-window self-test passed\n";
    return;
}
