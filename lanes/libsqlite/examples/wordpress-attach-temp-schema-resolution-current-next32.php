...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied WordPress option imports while ATTACH and DETACH change current/next schema resolution; TEMP still shadows main for unqualified names and attached triggers appear only while the schema is attached.',
