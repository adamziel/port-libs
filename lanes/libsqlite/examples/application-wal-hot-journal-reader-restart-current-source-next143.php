...
$summary = [
    'scenario' => 'application-wal-hot-journal-reader-restart-current-source-next143',
    'applicationUse' => 'A copied Application SQLite database recovers hot rollback-journal pages, keeps an existing WAL reader pinned to the recovered current source, then admits the next reader on a restarted WAL generation for later wp_options writes.',
    'status' => $plan['status'],
