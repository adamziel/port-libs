...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext254Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext254Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next254',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient, publish page-local freeblock write slots only after pointer-map anchors and next-source receipts stay current.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next254 self-test passed\n";
}
