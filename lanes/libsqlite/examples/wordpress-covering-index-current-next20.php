...
echo json_encode([
    'scenario' => 'wordpress-covering-index-current-next20',
    'mode' => $mode,
    ...
    'wordpressUse' => 'Preview copied wp_options covering-index choices for option lookups and autoloaded transient scans without table b-tree fetches or ext/sqlite.',
