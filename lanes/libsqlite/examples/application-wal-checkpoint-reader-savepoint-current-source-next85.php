...
echo json_encode([
    'scenario' => 'application-wal-checkpoint-reader-savepoint-current-source-next85',
    'applicationUse' => 'Report current and next reader page sources after a failed wp_options plugin-settings import rolls back to a SAVEPOINT and a checkpoint runs, so repair tooling can distinguish retained WAL pages from database pages restored by the savepoint boundary.',
    'status' => $plan['status'],
