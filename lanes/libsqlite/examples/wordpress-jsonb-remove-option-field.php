...
if ($input === null || $paths === []) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-jsonb-remove-option-field.php json-or-hex path [path...]\n");
...
echo json_encode([
    ...
    'wordpressUse' => 'Preflight or fixture-update JSONB wp_options blobs by removing obsolete plugin setting paths before indexed recovery checks.',
