...
$plan = SQLiteJsonTablePlan::currentSourceIndexedConstraintCostNext119(
    'json_tree',
    $currentOption,
    $nextOption,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-indexed-constraint-cost-current-source-next119',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-indexed-constraint-cost-current-source-next119 self-test passed\n";
    return;
}
