...
echo json_encode([
    'wordpressUse' => 'Delete a large transient option and its option_name index entry while reporting obsolete overflow pages for the subsequent freelist release plan.',
