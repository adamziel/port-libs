...
use PortLibs\LibSqlite\SQLiteUtf16NocaseLikeRtrimCurrentSourceNext184Plan;
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext184Plan::wordpressOptionNameEscapedPeerReplayPlan(
    $rows,
    $rows,
    'plugin!_!%cache%',
    '!',
