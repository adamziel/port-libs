...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options plugin settings can keep a base JSON path and per-request nested path while the JSON virtual-table planner still recognizes constant key constraints and charges only the priority suffix sort.',
];
