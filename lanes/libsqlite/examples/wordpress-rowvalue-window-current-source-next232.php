...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext232Plan::execute(
...
echo json_encode([
    'scenario' => 'wordpress-rowvalue-window-current-source-next232',
    'wordpressUse' => 'During copied wp_options imports, row-value target tuples may drive UPDATE/DELETE RETURNING batches, failed attempts roll back to the savepoint image, and retry RETURNING rows keep stable window-style ordinals for progress reporting before release.',
    'status' => $plan['status'],
