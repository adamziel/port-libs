...
$summary = [
    ...
    'applicationUse' => 'Recover attached Application database images through a master journal, then spill retry-savepoint cache pages only from the recovered current source.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-pager-master-journal-cache-spill-savepoint-current-source-next114 self-test passed\n";
    exit(0);
}
