...
if ($databasePath === null || $jsonPath === null || $lower === null || $upper === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-json-option-value-range.php path/to/wordpress.sqlite json_path lower_json_scalar|- upper_json_scalar|- [limit] [upper_inclusive]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedJsonOptionValueRange($jsonPath, $lowerBound, $upperBound, $limit, $upperInclusive),
);
