...
return [
    'wordpressUse' => 'Preview copied single-site and network wp_options rows through parser-level compound SELECT text, preserving UNION duplicate removal, EXCEPT local-only rows, final ORDER BY, and no ext/sqlite dependency.',
