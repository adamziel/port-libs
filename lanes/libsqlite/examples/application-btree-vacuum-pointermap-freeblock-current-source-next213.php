...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next213',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, publish a post-apply receipt for only the latched current-source pointer-map/freeblock pages.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next213 self-test passed\n";
}
