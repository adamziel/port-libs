...
$summary = [
    'scenario' => 'wordpress-vdbe-sorter-distinct-collation-current-source-next106',
    'wordpressUse' => 'Copied wp_options import previews can refresh a VDBE DISTINCT sorter after schema/source changes while preserving the current collation key and avoiding stale case-folded duplicates without ext/sqlite.',
    'before' => $before,
    'after' => $after,
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-vdbe-sorter-distinct-collation-current-source-next106 self-test passed\n";
    exit(0);
}
