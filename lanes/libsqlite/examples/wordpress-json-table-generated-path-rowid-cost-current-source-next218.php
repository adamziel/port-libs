...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext218(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next218',
    'wordpressUse' => 'Copied wp_options JSON diagnostics can yield xCurrent generated-path rowid output only while the observed current-source generation and fingerprint still match; changed generated paths force reprepare before stale rows reach WordPress import logic.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next218 self-test passed\n";
    return;
}
