...
$prepared = [
    'name' => 'prepared-application-options-next205',
    'schemaCookie' => 2050,
    'stat4Generation' => 200,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-application-options-next205';
...
echo json_encode([
    ...
    'applicationUse' => 'Copied wp_options plugin diagnostics can reuse a current-source partial expression-index LIMIT window only when STAT4 neq still covers duplicate lower(option_name) peers.',
