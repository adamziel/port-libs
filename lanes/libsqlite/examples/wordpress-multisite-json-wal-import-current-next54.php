...
require_once __DIR__ . '/../src/SQLiteWordPressMultisiteJsonWalImportPlan.php';

use PortLibs\LibSqlite\SQLiteWordPressMultisiteJsonWalImportPlan;
...
$plan = SQLiteWordPressMultisiteJsonWalImportPlan::plan($currentRows, [
    [
