...
echo json_encode([
    ...
    'applicationUse' => 'Preview an ALTER TABLE ADD generated column migration for copied wp_options databases where dependent views, triggers, and prepared Application option queries must be reparsed against the current sqlite_schema source after the schema cookie changes.',
