...
$summary = [
    'scenario' => 'wordpress-schema-alter-reparse-view-trigger-current-source-next125',
    'wordpressUse' => 'Reparse copied WordPress views/triggers after ALTER TABLE RENAME so stale sqlite_schema SQL does not target the old options table.',
    'schemaCookie' => [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-schema-alter-reparse-view-trigger-current-source-next125 self-test passed\n";
    return;
}
