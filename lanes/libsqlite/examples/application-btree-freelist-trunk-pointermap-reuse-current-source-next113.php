...
echo json_encode([
    'scenario' => 'application-btree-freelist-trunk-pointermap-reuse-current-source-next113',
    'applicationUse' => 'After copied wp_options cleanup consumes the last leaf from a freelist trunk, the trunk itself is reused as a B-tree page while the next trunk remains the freelist head.',
