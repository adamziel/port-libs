...
$summary = [
    'wordpressUse' => 'Copied wp_options imports can disable FK enforcement while staging rows, then re-enable it and surface the same foreign_key_check rows before commit.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-foreign-keys-enforcement-current self-test failed\n");
        exit(1);
    }

    echo "wordpress-pragma-foreign-keys-enforcement-current self-test passed\n";
    exit(0);
}
