...
$result = [
    'scenario' => 'wordpress-trigger-recursive-view-returning-current-source-next154',
    'wordpressUse' => 'Copied wp_options imports through recursive INSTEAD OF view triggers hold next-source RETURNING rows until the current-source cursor is fully drained and acknowledged.',
...
if (in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-next154 self-test failed\n");
        exit(1);
    }

    echo "wordpress-trigger-recursive-view-returning-current-source-next154 self-test passed\n";
    return;
}
