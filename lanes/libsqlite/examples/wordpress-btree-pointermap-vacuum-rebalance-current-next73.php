...
echo 'WordPress transient delete rebalance promoted trunk page: ' . implode(',', $summary['new_trunk_page_numbers']) . PHP_EOL;
echo 'WordPress transient delete rebalance appended leaf page: ' . implode(',', $summary['leaf_page_numbers']) . PHP_EOL;
echo 'WordPress transient delete pointer-map pages: ' . implode(',', $summary['updated_pointer_map_page_numbers']) . PHP_EOL;
echo 'WordPress transient delete secure-cleared pages: ' . implode(',', $summary['secure_delete_cleared_pages']) . PHP_EOL;
