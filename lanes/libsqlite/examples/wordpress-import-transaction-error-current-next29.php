...
$plan = SQLiteWordPressImportTransactionErrorYieldPlan::plan(
    $currentRows,
    $stagedRows,
...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options imports that yield current/next row state and WP_Error-shaped diagnostics for statement failures before rolling the import transaction back, without requiring ext/sqlite.',
