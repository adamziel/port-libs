...
echo json_encode([
    'wordpressUse' => 'Delete the final copied wp_options transient from a non-root leaf, then release the empty leaf and its obsolete overflow pages into the freelist with auto-vacuum pointer-map free-page updates.',
