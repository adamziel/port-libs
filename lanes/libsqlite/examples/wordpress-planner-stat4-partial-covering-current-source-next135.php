...
$plan = SQLitePlannerStat4PartialCoveringCurrentSourceNextPlan::materializeNext135(
    $prepared,
    $current,
    $and(
        $point('kind', 'plugin'),
...
$output = [
    'scenario' => 'wordpress-planner-stat4-partial-covering-current-source-next135',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-planner-stat4-partial-covering-current-source-next135 self-test passed\n";
    exit(0);
}
