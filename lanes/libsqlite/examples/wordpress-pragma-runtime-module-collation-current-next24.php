...
echo json_encode([
    ...
    'wordpressModuleAvailable' => in_array('wp_option_tokens', array_column($catalog->execute('PRAGMA module_list')['rows'], 'name'), true),
    'wordpressFunctionAvailable' => in_array('wp_option_checksum', array_column($catalog->execute('PRAGMA function_list')['rows'], 'name'), true),
    'dependencies' => [
