...
if ($databasePath === null || $jsonPath === null || $value === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-jsonb-option-value.php path/to/wordpress.sqlite json_path json_scalar [limit]\n");
...
$options = array_map(
    static function (SQLiteWordPressOption $option): array {
        $row = $option->toArray();
