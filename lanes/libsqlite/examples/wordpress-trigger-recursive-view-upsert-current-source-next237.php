...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewUpsertCurrentSourceNext237Plan;
...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNext237Plan::execute(
    [
