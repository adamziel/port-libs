...
echo 'WordPress btree133 released overflow pages: ' . implode(',', $plan->releasedOverflowPages()) . "\n";
echo 'WordPress btree133 vacuum truncated pages: ' . implode(',', $plan->truncatedPageNumbers()) . "\n";
echo 'WordPress btree133 recreated pointer-map pages: ' . implode(',', $plan->recreatedPointerMapPages()) . "\n";
echo 'WordPress btree133 allocated overflow pages: ' . implode(',', $plan->allocatedOverflowPages()) . "\n";
echo 'WordPress btree133 next pointer-map types: ' . implode(',', array_column($plan->rows, 'next_pointer_map_type')) . "\n";
echo 'WordPress btree133 final page count: ' . $plan->databaseAfterAllocation->pageCount() . "\n";
