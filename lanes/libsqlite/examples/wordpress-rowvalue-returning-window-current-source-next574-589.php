...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next574-589 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next558-573 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next574-589 self-test passed\n";
    return;
}
