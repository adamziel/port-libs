...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows through additional HAVING predicate combinations over grouped aggregate SELECT text without requiring ext/sqlite.',
