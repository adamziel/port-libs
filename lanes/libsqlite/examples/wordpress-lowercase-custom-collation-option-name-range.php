...
if ($databasePath === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-lowercase-custom-collation-option-name-range.php path/to/wordpress.sqlite [lower_inclusive|-] [upper_bound|-] [WPSLUG] [limit] [upper_inclusive]\n");
...
$options = $database->wordpressOptionsByIndexedLowercaseNameRangeWithCollation(
    $lowerInclusive,
    $upperBound,
    $collationName,
