...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext952(
    'json_tree',
    $currentOption,
    $nextOption,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next937-952',
    'wordpressUse' => 'Generated wp_options JSON path scans keep rowid point-cost admission stable across the next937-952 follow-on while changed copied source rows force a next reader reprepare.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next937-952 self-test passed\n";
    return;
}
