...
if ($databasePath === null || $arrayPath === null || $value === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-json-array-option-value.php path/to/wordpress.sqlite '$.rules[0].enabled' json_scalar [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedJsonOptionValue($arrayPath, $lookupValue, $limit),
);
