...
echo json_encode([
    'scenario' => 'wordpress-wal-savepoint-restart-checkpoint-apply-current-next74',
    'wordpressUse' => 'Apply a failed wp_options plugin import ROLLBACK TO savepoint, restart checkpoint the retained WAL prefix into the database image, then persist retry WAL frames atomically through native PHP file handles without ext/sqlite.',
    'root' => $root,
