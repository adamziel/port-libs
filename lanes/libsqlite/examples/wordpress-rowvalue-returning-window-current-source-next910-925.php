...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next910-925 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next909_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next910-925 self-test passed\n";
    return;
}
