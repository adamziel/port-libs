...
require_once dirname(__DIR__) . '/src/SQLiteTriggerRecursiveViewReturningCurrentSourceNext228Plan.php';
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext228Plan::execute(
    [
