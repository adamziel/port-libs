...
echo json_encode([
    'wordpressUse' => 'Preview SQLite trigger recursion current-depth/next-depth enforcement for copied wp_options import triggers before entering an over-limit trigger program.',
