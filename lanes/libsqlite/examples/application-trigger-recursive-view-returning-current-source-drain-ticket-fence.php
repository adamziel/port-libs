...
if (
    ...
    || $summary['current_last_resume_token'] !== 'app_recursive_view_returning_cursor_177:app-current-returning-177:5'
    || $summary['next_first_resume_token'] !== 'app_recursive_view_returning_cursor_177:app-next-returning-177:6'
    ...
    || array_column($summary['held_returning_rows'], 'name') !== ['landing_url', 'next_module', 'landing_url:child', 'landing_url:child:child']
) {
    fwrite(STDERR, "application-trigger-recursive-view-returning-current-source-next177 self-test failed\n");
    exit(1);
}

echo "application-trigger-recursive-view-returning-current-source-next177 self-test passed\n";
