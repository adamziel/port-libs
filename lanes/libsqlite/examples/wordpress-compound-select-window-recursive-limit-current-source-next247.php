...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext247Plan;
...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext247Plan::compare(
    $sql,
    ['wp_options' => $current],
    ['wp_options' => $next],
);
