...
$summary = [
    'scenario' => 'application-utf16-nocase-like-rtrim-escape-current-source-next182',
    'status' => $plan['status'],
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-utf16-nocase-like-rtrim-escape-current-source-next182 self-test passed\n";
}
