...
echo json_encode([
    'scenario' => 'application-rowvalue-update-delete-returning-savepoint-current-source-next196',
    'applicationUse' => 'Preserve SQLite UPDATE OR FAIL prefix changes during copied wp_options cleanup so a retry UPDATE/DELETE RETURNING reads the correct current source without ext/sqlite.',
    'status' => $plan['status'],
