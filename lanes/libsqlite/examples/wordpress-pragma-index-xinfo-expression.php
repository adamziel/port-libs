...
echo json_encode([
    'wordpressUse' => 'Preview PRAGMA index_xinfo rows for copied wp_options expression indexes so schema diagnostics can distinguish expression terms from table columns without ext/sqlite.',
