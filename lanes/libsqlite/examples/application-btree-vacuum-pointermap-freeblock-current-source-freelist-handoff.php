...
if (in_array('--self-test', $argv, true)) {
    if (count($rows) !== 80) {
        fwrite(STDERR, "application-btree-vacuum-pointermap-freeblock-current-source-freelist-handoff self-test failed\n");
        exit(1);
    }
    foreach ($rows as $row) {
    ...
    fwrite(STDOUT, "application-btree-vacuum-pointermap-freeblock-current-source-freelist-handoff self-test passed\n");
}
