...
$output = [
    'scenario' => 'application-planner-stat4-partial-covering-range',
    ...
    'applicationUse' => 'Preview copied wp_options imports where a stale prepared partial covering STAT4 scan must rebind to current sqlite_stat4 samples and emit the current index row stream without table lookups.',
];
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-planner-stat4-partial-covering-range self-test passed\n";
    exit(0);
}
