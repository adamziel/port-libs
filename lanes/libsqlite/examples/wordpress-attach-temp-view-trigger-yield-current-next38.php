...
echo json_encode([
    'scenario' => 'wordpress attach temp view trigger WHEN-yielded operations',
    'wordpressUse' => 'Preview copied WordPress option imports through TEMP, main, and attached INSTEAD OF view triggers while honoring SQLite WHEN admission before yielding writes.',
