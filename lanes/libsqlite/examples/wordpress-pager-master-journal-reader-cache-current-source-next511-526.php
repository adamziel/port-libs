...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-next526',
    'epoch' => 526,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 526, 0])),
    'publication_generation' => 526,
    'master_source_digest' => hash('sha256', 'wordpress next526 master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::variantNext526(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
