...
$summary = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next220',
    'wordpressUse' => 'Copied wp_options plugin-rule diagnostics can read json_tree xRowid from a pinned generated-path row while preserving rowid/_rowid_/oid alias agreement and forcing a reprepare when the next source changes.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next220 self-test passed\n";
    return;
}
