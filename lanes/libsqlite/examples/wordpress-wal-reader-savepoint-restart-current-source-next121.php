...
require_once __DIR__ . '/../src/SQLiteWalReaderSavepointRestartCurrentSourceNext121Plan.php';
...
$summary = SQLiteWalReaderSavepointRestartCurrentSourceNext121Plan::plan(
    $savepoints,
    'plugin-settings',
...
$output = [
    ...
    'wordpressUse' => 'After a failed wp_options import rolls back to a SAVEPOINT, stale reader WAL tail frames are ignored and the retry writer appends from the retained prefix as the current source.',
