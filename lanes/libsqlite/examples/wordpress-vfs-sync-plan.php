...
echo json_encode([
    'scenario' => 'wordpress-vfs-sync-plan',
    'wordpressUse' => 'Plan SQLite VFS xSync flags for copied WordPress database, rollback-journal, WAL, and directory handles before native PHP file-handle writes are promoted to durable transaction commits without requiring ext/sqlite.',
