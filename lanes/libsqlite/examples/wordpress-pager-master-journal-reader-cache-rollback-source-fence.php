...
$base = [
    ...
    'master_source_digest' => hash('sha256', 'wordpress rollback-source-fence master source'),
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-rollback-source-fence self-test passed\n";
    return;
}
