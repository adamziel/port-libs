...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext530545Plan.php';

use PortLibs\LibSqlite\SQLiteVfsCurrentSourceNext530545Plan;
...
$plan = SQLiteVfsCurrentSourceNext530545Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next530-545 self-test passed\n";
    return;
}
