...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNextPlan::executeNext255(
    [
    ...
    [
        ...
        'current_source_cursor_next231' => 'wp.returning.current.cursor.255',
        'current_source_close_token_next231' => 'wp.current.source.close.255',
        'current_view_cookie_next231' => 'main@view-cookie-255-current',
        'current_trigger_cookie_next231' => 'main@trigger-cookie-255-current',
