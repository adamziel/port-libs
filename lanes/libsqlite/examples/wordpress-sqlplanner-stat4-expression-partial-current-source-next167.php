...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext167Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext167Plan::materialize(
    $prepared,
    $current,
    [
