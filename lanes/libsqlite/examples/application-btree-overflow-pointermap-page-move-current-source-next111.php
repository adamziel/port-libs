...
$summary = [
    'scenario' => 'application-btree-overflow-pointermap-page-move-current-source-next111',
    'applicationUse' => 'During copied wp_options autoload cache cleanup, autovacuum can move the final overflow page into a lower freelist slot; the previous overflow page next pointer and pointer-map parent must both retarget the moved page.',
...
if (
    ...
    fwrite(STDERR, "application-btree-overflow-pointermap-page-move-current-source-next111 self-test failed\n");
    exit(1);
}
