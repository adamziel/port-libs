...
$root = sys_get_temp_dir() . '/port-libsqlite-wordpress-vfs-sync-apply';
...
$applied = (new SQLiteVfsFileWriter($root))->applySyncPlans($plans, ['wordpress-option-import']);

echo json_encode([
    'scenario' => 'wordpress-vfs-sync-apply',
    'wordpressUse' => 'Apply planned SQLite xSync barriers for copied wp_options rollback-journal, database, WAL, and directory handles through native PHP file handles without requiring ext/sqlite.',
