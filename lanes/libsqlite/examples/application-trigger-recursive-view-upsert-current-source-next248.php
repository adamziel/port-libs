...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNextPlan::executeCurrentWhereOutcomeReceipt(
    ...
    [
        ...
        'current_source_cursor_source_close' => 'wp.returning.current.cursor.248',
        'current_source_close_token_source_close' => 'wp.current.source.close.248',
...
if (
    ...
    fwrite(STDERR, "application-trigger-recursive-view-upsert-current-source-next248 self-test failed\n");
    exit(1);
}

echo "application-trigger-recursive-view-upsert-current-source-next248 self-test passed\n";
