...
echo json_encode([
    'wordpressUse' => 'Plan SQLite b-tree local payload bytes and current/next overflow page links for copied wp_options table rows and option_name index entries before rebalance or delete materialization, without ext/sqlite.',
