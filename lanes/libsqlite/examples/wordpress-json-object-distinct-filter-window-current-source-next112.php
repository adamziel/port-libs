...
$summary = [
    'scenario' => 'wordpress-json-object-distinct-filter-window-current-source-next112',
    ...
    'wordpressUse' => 'Copied wp_options diagnostics can build per-row option maps while removing exact duplicate option/value pairs, honoring FILTER before DISTINCT, and preserving JSONB plugin settings without ext/sqlite.',
    'firstFrame' => $frames[0],
