...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next227',
    'applicationUse' => 'Copied wp_options JSON diagnostics pin a generated-path json_tree rowid cursor to the current source generation and fingerprint before reusing a yielded row.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next227 self-test passed\n";
    return;
}
