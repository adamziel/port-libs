...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options hierarchy rows where recursive queue ORDER BY must keep numeric sort keys before text keys before the final compound SELECT order is applied.',
    'status' => $plan['status'],
