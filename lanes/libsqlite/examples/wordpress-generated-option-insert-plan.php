...
$plan = $database->planWordPressOptionInsert(2, 'generated_cache_fixture', $optionValue, 'no');
...
echo json_encode([
    'wordpressUse' => 'Plan a bounded generated wp_options row insert as page images, including overflow page allocation, without the SQLite extension.',
    'plan' => $plan->toArray(),
