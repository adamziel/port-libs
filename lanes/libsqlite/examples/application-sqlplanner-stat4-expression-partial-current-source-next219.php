...
$prepared = [
    'name' => 'prepared-application-options-next219',
    'schemaCookie' => 2190,
    'stat4Generation' => 219,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-application-options-next219';
...
echo json_encode([
    ...
    'applicationUse' => 'Copied wp_options plugin scans can yield a current-source STAT4 partial lower(option_name) cursor only after duplicate plugin_forms peers are fenced, so import previews resume at the next peer rowid instead of skipping or duplicating options.',
