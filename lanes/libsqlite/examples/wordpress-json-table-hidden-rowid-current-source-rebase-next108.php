...
$payload = [
    'scenario' => 'wordpress-json-table-hidden-rowid-current-source-rebase-next108',
    'wordpressUse' => 'Copied wp_options JSON scans can rebase a json_each hidden rowid constraint from the current source row even when the rowid predicate is supplied by WHERE rather than ON.',
    'rowCount' => count($rows),
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-hidden-rowid-current-source-rebase-next108 self-test passed\n";
    return;
}
