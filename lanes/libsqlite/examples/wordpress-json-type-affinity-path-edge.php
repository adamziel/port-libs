...
echo json_encode([
    ...
    'wordpressUse' => 'Copied wp_options diagnostics may store JSON paths as BLOB-affinity values; parser-level json_type/json_extract now applies SQLite text affinity before path lookup without requiring ext/sqlite.',
