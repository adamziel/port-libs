...
$summary = [
    'scenario' => 'application-pragma-index-xinfo-foreignkey-current-source-next236',
    'applicationUse' => 'Copied taxonomy imports can preserve quoted mixed-case table definitions while PRAGMA foreign_key_list and index_xinfo still admit parent keys using SQLite identifier case-folding.',
    'status' => $page['status'],
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "application-pragma-index-xinfo-foreignkey-current-source-next236 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "application-pragma-index-xinfo-foreignkey-current-source-next236 self-test passed\n");
    exit(0);
}
