...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-schema-generated-check-reparse-current-source self-test passed\n";
    return;
}
...
echo json_encode([
    ...
    'applicationUse' => 'Copied wp_options schemas with generated metadata CHECK changes must expire prepared schema views after sqlite_schema reparses, while CHECK/UNIQUE text inside generated expressions remains literal text.',
