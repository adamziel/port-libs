...
$plan = SQLiteJsonbCheckCurrentNextPlan::plan($schema, [
    ['setting_id' => 401, 'key_name' => 'plugin_alpha_settings', 'key_value' => $jsonb(['plugin' => ['channel' => 'stable', 'rank' => 25, 'min_app' => 6.5]]), 'load_policy' => 'yes'],
    ['setting_id' => 402, 'key_name' => 'plugin_beta_settings', 'key_value' => $jsonb(['plugin' => ['channel' => 'beta', 'rank' => 50, 'min_app' => 6.7]]), 'load_policy' => 'yes'],
], [
    ...
    ['op' => 'INSERT', 'row' => ['setting_id' => 403, 'key_name' => 'plugin_future_settings', 'key_value' => $jsonb(['plugin' => ['channel' => 'stable', 'rank' => 10, 'min_app' => 7.0]]), 'load_policy' => 'no']],
    ['op' => 'INSERT', 'row' => ['setting_id' => 404, 'key_name' => 'plugin_safe_settings', 'key_value' => $jsonb(['plugin' => ['channel' => 'stable', 'rank' => 100, 'min_app' => 8.0]]), 'load_policy' => 'yes']],
]);
...
echo json_encode([
    ...
    'applicationUse' => 'Preflight application settings JSONB plugin settings with SQLite NOT IN and NOT BETWEEN CHECK guards before import rows are admitted.',
