...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through an INSTEAD OF recursive view trigger can drain RETURNING rows from the current source while a next schema/source generation remains attempted-only until the savepoint releases it.',
