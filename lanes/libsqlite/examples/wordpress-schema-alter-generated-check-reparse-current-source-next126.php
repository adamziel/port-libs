...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-schema-alter-generated-check-reparse-current-source-next126 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'copied wp_options ALTER ADD generated CHECK reparse current-source next126',
    'wordpressUse' => 'Plugin import code can add a virtual generated option-name column, scan current copied rows for CHECK compatibility, refresh sqlite_schema text, and reprepare stale statements without ext/sqlite.',
