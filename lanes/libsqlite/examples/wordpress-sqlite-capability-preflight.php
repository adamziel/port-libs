...
echo json_encode([
    ...
    'wordpressUse' => 'Preview SQLite feature gates that affect copied WordPress databases, including FTS, RTree, math functions, JSON availability, page-size defaults, and threadsafe metadata, without requiring ext/sqlite.',
