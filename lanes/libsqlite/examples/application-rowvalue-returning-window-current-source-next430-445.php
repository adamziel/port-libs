...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next430-445 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next414-429 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next430-445 self-test passed\n";
    return;
}
