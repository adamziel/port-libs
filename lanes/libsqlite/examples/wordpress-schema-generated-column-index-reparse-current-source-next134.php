...
$summary = [
    'scenario' => 'wordpress-schema-generated-column-index-reparse-current-source-next134',
    'wordpressUse' => 'After a copied WordPress schema admits a generated lower-case option-name column, legacy index records are classified for current-source reparse before prepared indexed statements are reused.',
    'schemaCookie' => [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-schema-generated-column-index-reparse-current-source-next134 self-test passed\n";
    return;
}
