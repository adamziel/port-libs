...
if ($targetInput === null || $patchInput === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-jsonb-patch-option-field.php json-or-hex json-or-hex-patch\n");
...
echo json_encode([
    ...
    'wordpressUse' => 'Preflight or fixture-update JSONB wp_options blobs by applying SQLite RFC-7396 merge patches where null object members delete keys and arrays replace whole arrays.',
