...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext169(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next169',
    'wordpressUse' => 'Copied wp_options plugin-rule previews can carry generated path plus _rowid_ xFilter bindings into a pinned json_tree() yield tape, then force the shifted next source to reprepare.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next169 self-test passed\n";
    return;
}
