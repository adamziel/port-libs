...
echo json_encode([
    'scenario' => 'wordpress-btree-empty-leaf-freelist-pointermap-next97',
    'wordpressUse' => 'Release empty copied wp_options table and option_name index leaves after transient cleanup, chain their obsolete overflow pages through the freelist, and rewrite auto-vacuum pointer-map entries before the next insert.',
