...
$summary = [
    'scenario' => 'copied WordPress PRAGMA optimize joined to current PRAGMA index_xinfo metadata',
    'wordpressUse' => 'Stream copied wp_options/wp_postmeta index metadata while preserving PRAGMA optimize decisions and current-source cursor tokens during import or repair without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-pragma-optimize-index-xinfo-current-source-next116 self-test passed\n";
    return;
}
