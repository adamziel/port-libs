...
$plan = SQLiteSchemaAlterTriggerGeneratedPlan::plan(
    $records,
...
$summary = [
    'scenario' => 'application-schema-alter-trigger-generated-current-source',
    'applicationUse' => 'After a copied Application wp_options migration adds a generated column used by triggers, stale prepared updates must reparse from the current sqlite_schema source before firing trigger bytecode.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-schema-alter-trigger-generated-current-source self-test passed\n";
    return;
}
