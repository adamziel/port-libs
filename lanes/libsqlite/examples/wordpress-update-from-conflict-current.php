...
echo json_encode([
    'wordpressUse' => 'Preview UPDATE FROM staging-row imports for wp_options where duplicate staged rows use SQLite current last-match behavior and OR REPLACE deletes current option_name conflicts without requiring ext/sqlite.',
    'sql' => $sql,
