...
$summary = [
    'scenario' => 'application-wal-hot-journal-savepoint-checkpoint-current-source-next186',
    'applicationUse' => 'A copied Application plugin import restarts after hot-journal/checkpoint apply and admits a WAL reader only when the retained WAL header checkpoint, salts, page size, checksum, and commit frames still match the published current source.',
...
if ($summary['status'] !== 'wal-hot-journal-savepoint-checkpoint-current-source-next186'
    ...
    fwrite(STDERR, "application-wal-hot-journal-savepoint-checkpoint-current-source-next186 self-test failed\n");
    exit(1);
}
