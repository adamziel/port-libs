...
echo json_encode([
    'scenario' => 'wordpress-btree-write-apply-corruption-current-source-next106',
    ...
    'wordpressUse' => 'Copied wp_options transient cleanup rejects stale post-delete leaf images before applying rebalance/freeblock writes, preventing old repair previews from overwriting newer option rows.',
