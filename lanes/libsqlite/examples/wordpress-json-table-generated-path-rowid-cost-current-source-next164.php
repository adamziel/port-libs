...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext164(
    'json_tree',
    $currentOption,
    $nextOption,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next164',
    'wordpressUse' => 'Copied wp_options JSON rule diagnostics can satisfy rowid ORDER BY from the pinned current-source json_tree seek tape and cap LIMIT cost without allocating a temp sorter.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next164 self-test passed\n";
    return;
}
