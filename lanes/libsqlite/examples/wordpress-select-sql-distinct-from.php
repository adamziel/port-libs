...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options drift checks using SQLite IS DISTINCT FROM / IS NOT DISTINCT FROM NULL-safe predicates without requiring ext/sqlite.',
    'driftSql' => $driftSql,
