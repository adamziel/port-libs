...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext239Plan::execute(
    ['wp_options' => $rows],
...
return [
    ...
    'wordpressUse' => 'Copied wp_options migration batches can rollback a row-value UPDATE/DELETE RETURNING attempt, retry from the savepoint image, and produce statement-local window receipts without mixing suppressed rows into the released current source.',
