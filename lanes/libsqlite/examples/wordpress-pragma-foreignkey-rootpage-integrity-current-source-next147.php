...
$result = SQLitePragmaForeignKeyRootpageIntegrityCurrentSourceNext147::currentNextPage(
    $currentDatabase,
    $schemas,
    $catalog,
    $nextDatabase,
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-pragma-foreignkey-rootpage-integrity-current-source-next147 self-test passed\n";
    return;
}
