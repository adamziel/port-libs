...
echo json_encode([
    'scenario' => 'wordpress-vdbe-sorter-window-exclude-current-next36',
    ...
    'wordpressUse' => 'Copied wp_options ranking/aggregate previews can use VDBE-style sorter current/next frames with NOCASE collation while EXCLUDE CURRENT ROW removes only the current row before aggregate stepping.',
