...
$plan = SQLiteUtf16RtrimNocaseCurrentSourceNextPlan::wordpressOptionNameCurrentNext(
    $current,
    $next,
    'plugin_cache',
    'main.wp_options@131',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-rtrim-nocase-current-source-next132 self-test passed\n";
    return;
}
