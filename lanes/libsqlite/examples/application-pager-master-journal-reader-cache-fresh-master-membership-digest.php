...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-fresh-master-membership-digest',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'A copied wp_options reader can retain a shared schema page, refresh active_plugins from current source, and reopen a stale roles reader when the freshly read master journal gained an attached users journal.',
...
if (
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-fresh-master-membership-digest self-test failed\n");
    exit(1);
}

echo "application-pager-master-journal-reader-cache-fresh-master-membership-digest self-test passed\n";
