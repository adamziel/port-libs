...
$plan = SQLiteEncodingAffinityLikeCurrentSourceNextPlan::wordpressOptionValueDynamicPatternPlan(
    $currentRows,
    $nextRows,
    'option_value',
    'like_pattern',
...
$summary = [
    'scenario' => 'wordpress-encoding-affinity-dynamic-like-current-source-next99',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-encoding-affinity-dynamic-like-current-source-next99 self-test passed\n";
    return;
}
