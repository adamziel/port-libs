...
echo json_encode([
    'wordpressUse' => 'Preview copied WordPress sqlite_schema view and trigger DDL before import tools preserve autoloaded option views, INSTEAD OF triggers, and DROP bookkeeping without requiring ext/sqlite.',
