...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-transaction-snapshot-digest-fence',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'A copied Application options reader that spans active_plugins and plugin settings reopens the whole reader transaction after master-journal recovery, instead of mixing one refreshed page with a byte-identical stale cache ticket.',
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next194'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-transaction-snapshot-digest-fence self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-transaction-snapshot-digest-fence self-test passed\n";
