...
$literalPercentPlan = SQLiteLikeGlobCurrentSourceNextPlan::wordpressOptionNameStatement(
    $currentRows,
    $nextRows,
    $currentStatement,
    $nextStatement,
...
$globPlan = SQLiteLikeGlobCurrentSourceNextPlan::wordpressOptionNameStatement(
    $currentRows,
    $nextRows,
    [
        'source' => 'main.wp_options@schema-cookie-10',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-option-name-like-glob-current-source-next88 self-test passed\n";
    return;
}
