...
$summary = [
    'scenario' => 'application-wal-hot-journal-savepoint-checkpoint-current-source-next164',
    'applicationUse' => 'A copied Application plugin import recovers hot-journal pages, rolls back a failed option savepoint, publishes a checkpoint current-source token, and reopens readers that cannot safely keep their cached view.',
    'status' => $plan['status'],
...
if ($summary['status'] !== 'wal-hot-journal-savepoint-checkpoint-current-source-next164'
    ...
    fwrite(STDERR, "application-wal-hot-journal-savepoint-checkpoint-current-source-next164 self-test failed\n");
    exit(1);
}
