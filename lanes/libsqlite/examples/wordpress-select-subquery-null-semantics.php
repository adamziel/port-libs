...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows with SQLite EXISTS and NOT IN NULL semantics, proving null-bearing subqueries filter unknown NOT IN results without requiring ext/sqlite.',
