...
use PortLibs\LibSqlite\SQLitePragmaForeignKeyIndexRootCurrentSourceNext125;
...
$pointerMap = $writePointer($pointerMap, 7, SQLitePointerMapEntry::BTREE_PAGE, 6);
...
$page = SQLitePragmaForeignKeyIndexRootCurrentSourceNext125::page(
    $catalog,
...
echo json_encode([
    'scenario' => 'copied wp_options pragma foreignkey index root current-source next125',
    'status' => $page['status'],
    'index_xinfo_rows' => $page['current']['index_xinfo'],
    'index_root_integrity_rows' => $page['current']['index_root_integrity'],
    'foreign_key_rootpage_rows' => $page['current']['foreign_key_rootpage'],
    'pointer_map_conflicts' => $page['current']['pointer_map_conflicts'],
    'blocking' => $page['next_state']['blocking'],
    'first_index_row' => $page['rows'][0],
    'last_foreign_key_row' => $page['rows'][count($page['rows']) - 1],
