...
$preview = [
    'scenario' => 'wordpress-malformed-text-like-glob-current-next56',
    'wordpressUse' => 'Copied wp_options option_name predicates can scan malformed imported UTF-8 bytes without losing valid multibyte prefix matching for LIKE/GLOB diagnostics.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-malformed-text-like-glob-current-next56 self-test passed\n";
    return;
}
