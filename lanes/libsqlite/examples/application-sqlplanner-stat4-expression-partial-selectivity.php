...
echo json_encode([
    ...
    'applicationUse' => 'Copied wp_options plugin scans can reuse a current-source partial lower(option_name) expression index only when current sqlite_stat4 counters still cover the selected page and duplicate peer counts.',
