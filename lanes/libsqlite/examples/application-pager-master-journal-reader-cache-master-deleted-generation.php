...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-master-deleted-generation',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'A copied wp_options database can keep a shared schema cache page, refresh a stale options page, and reopen an active_plugins reader whose cache ticket still belongs to the previous master-journal generation after the master file is deleted.',
...
if (
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-master-deleted-generation self-test failed\n");
    exit(1);
}

echo "application-pager-master-journal-reader-cache-master-deleted-generation self-test passed\n";
