...
echo json_encode([
    'wordpressUse' => 'Plan a generated wp_options insert that splits a full secondary-index leaf, splits its full non-root index parent, and updates the root without the SQLite extension.',
    'plan' => $plan->toArray(),
    'indexRootPage' => [
