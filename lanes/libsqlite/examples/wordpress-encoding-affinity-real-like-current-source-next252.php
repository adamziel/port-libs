...
$summary = [
    'scenario' => 'wordpress-encoding-affinity-real-like-current-source-next252',
    'wordpressUse' => 'Copied wp_options numeric option-value scans preserve text-affinity real values ending in zero before applying UTF-8/UTF-16 LIKE range and residual matching.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-encoding-affinity-real-like-current-source-next252 self-test passed\n";
    return;
}
