...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext158(
    ['wp_options' => $rows],
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-rowvalue-update-delete-returning-savepoint-current-source-next158 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-rowvalue-update-delete-returning-savepoint-current-source-next158',
    'status' => $plan['status'],
