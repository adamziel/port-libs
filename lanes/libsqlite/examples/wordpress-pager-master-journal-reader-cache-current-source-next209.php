...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext209Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext209Plan::plan(
    $database,
    $masterJournal,
    $masterBytes,
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-next209 self-test passed\n";
    return;
}
