...
$summary = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next158',
    'applicationUse' => 'Copied wp_options plugin-rule previews can keep the current json_tree() cursor pinned when a generated path and rowid seek are stable, but prepare the next cursor when the incoming option JSON shifts the path/rowid source.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next158 self-test passed\n";
    return;
}
