...
require_once __DIR__ . '/../src/SQLitePagerHotJournalCacheSpillCurrentSourceNext127Plan.php';

use PortLibs\LibSqlite\SQLitePagerHotJournalCacheSpillCurrentSourceNext127Plan;
...
$plan = SQLitePagerHotJournalCacheSpillCurrentSourceNext127Plan::plan(
    $databasePath,
    $staleDatabase,
    $pageSize,
    [
