...
$prepared = [
    'name' => 'prepared-wordpress-options-next213',
    'schemaCookie' => 2130,
    'stat4Generation' => 213,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-wordpress-options-next213';
...
echo json_encode([
    ...
    'wordpressUse' => 'Copied wp_options plugin diagnostics can reuse a current-source STAT4 partial expression index only when the LIKE case/collation mode used by the partial arm still matches the query and selected row payloads.',
