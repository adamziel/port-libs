...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options UPSERT batches that yield after each row while BEFORE/AFTER triggers rekey wp_optionmeta children and deferred foreign-key checks track transient or final violations without requiring ext/sqlite.',
