...
$report = [
    'scenario' => 'wordpress-json-aggregate-grouped-current-next82',
    'matchedAutoloadGroups' => array_map(static fn (array $row): mixed => $row['autoload'], $rows),
    'wordpressUse' => 'Copied wp_options import diagnostics can filter and order grouped rows by JSON aggregate summaries without projecting those summaries or requiring ext/sqlite.',
];
