...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext224Plan::wordpressOptionNameKeysetResumePlan(
    $currentRows,
    $nextRows,
    'plugin!_cache%',
    $escape,
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next224 self-test passed\n";
}

return [
    'scenario' => 'wordpress-utf16-nocase-like-rtrim-current-source-next224',
    'wordpressUse' => 'Copied wp_options scans can fence a resumed UTF-16 NOCASE LIKE RTRIM cursor by the saved keyset tail so new option_name rows before the next page cannot be skipped after source refresh.',
