...
$plan = SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137(
    'json_tree',
    $currentOption,
    $nextOption,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-path-generated-order-current-source-next137',
    'wordpressUse' => 'Copied wp_options JSON rule diagnostics can keep a path-constrained json_tree() cursor and order the resulting object rows by generated JSON keys such as priority and slug when the next option source changes.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-path-generated-order-current-source-next137 self-test passed\n";
    return;
}
