...
if (($argv[1] ?? '') === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-trigger-view-returning-savepoint-recursive-current-source-next123 self-test failed\n");
        exit(1);
    }

    echo "wordpress-trigger-view-returning-savepoint-recursive-current-source-next123 self-test passed\n";
    exit(0);
}
