...
if ($databasePath === null || $jsonPath === null || $valueList === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-json-option-value-list.php path/to/wordpress.sqlite json_path json_scalar[,json_scalar...] [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedJsonOptionValues($jsonPath, $lookupValues, $limit),
);
