...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next718-733 row-value UPDATE/DELETE RETURNING window current-source continuation after integrated next702-717 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next718-733 self-test passed\n";
    return;
}
