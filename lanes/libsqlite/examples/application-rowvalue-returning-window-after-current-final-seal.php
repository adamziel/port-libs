...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the prepared final after-current seal row-value UPDATE/DELETE RETURNING window current-source handoff as receipt, ledger, retry-window, and final seal metadata.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-after-current-final-seal self-test passed\n";
    return;
}
