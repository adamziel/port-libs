...
$summary = [
    ...
    'applicationUse' => 'A copied Application multisite import reuses only reader-cache pages whose attached rollback-journal member was fully recovered and deleted by the current master journal.',
];
...
if (
    ...
    throw new RuntimeException('Application pager master-journal reader cache next169 smoke failed');
}
