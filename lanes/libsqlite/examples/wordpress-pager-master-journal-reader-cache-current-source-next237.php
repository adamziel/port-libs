...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext234Plan.php';
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext237Plan.php';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext237Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
