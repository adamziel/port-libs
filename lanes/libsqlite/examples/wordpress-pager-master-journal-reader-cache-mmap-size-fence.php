...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-mmap-size-fence',
    'epoch' => 302,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 302, 0])),
    'publication_generation' => 302,
    'master_source_digest' => hash('sha256', 'wordpress mmap-size-fence master source'),
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-mmap-size-fence self-test passed\n";
    return;
}
