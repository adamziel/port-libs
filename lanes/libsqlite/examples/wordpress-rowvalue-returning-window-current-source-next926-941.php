...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next926-941 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next925_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next926-941 self-test passed\n";
    return;
}
