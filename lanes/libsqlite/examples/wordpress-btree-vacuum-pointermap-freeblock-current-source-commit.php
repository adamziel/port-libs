...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-commit',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-commit self-test passed\n";
}
