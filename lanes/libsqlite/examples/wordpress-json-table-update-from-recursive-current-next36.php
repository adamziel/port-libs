...
echo json_encode([
    'scenario' => 'wordpress-json-table-update-from-recursive-current-next36',
    'wordpressUse' => 'Copied wp_options plugin JSON settings can seed a recursive CTE from json_tree() and feed UPDATE FROM current-row mutations, preserving duplicate-source last-match behavior, current/next recursive source rows, and autoload derivation without requiring ext/sqlite.',
    'sourceSql' => $sourceSql,
