...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-planner-stat4-expression-partial-current-source-sample-fence self-test passed\n";
    exit(0);
}

printf(
    "application planner stat4 expression partial current-source sample fence: %s rowids=%s stale-blocked=%s status=%s\n",
