...
$root = sys_get_temp_dir() . '/port-libsqlite-wordpress-vfs-open-file-control-' . bin2hex(random_bytes(4));
...
echo json_encode([
    'scenario' => 'wordpress-vfs-open-file-control-apply',
    'wordpressUse' => 'Apply SQLite xFileControl size hints through the native PHP VFS file handle opened for copied wp_options imports, including chunk-size rounded preallocation and file-control state without requiring ext/sqlite.',
    'path' => $databasePath,
