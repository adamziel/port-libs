...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options INSERT ... ON CONFLICT DO UPDATE RETURNING expressions over final inserted/updated rows without requiring ext/sqlite.',
