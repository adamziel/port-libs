...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-rtrim-glob-affinity-current-source-next145 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-utf16-rtrim-glob-affinity-current-source-next145',
    'wordpressUse' => 'Copied wp_options plugin settings can scan a UTF-16 rtrim(option_name) COLLATE NOCASE GLOB range while applying byte-sensitive GLOB residuals and NUMERIC affinity to option_value before reusing or invalidating a current-source cursor.',
