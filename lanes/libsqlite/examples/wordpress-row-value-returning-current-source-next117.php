...
$summary = [
    'scenario' => 'wordpress-row-value-returning-current-source-next117',
    'wordpressUse' => 'Preview copied multisite wp_options cleanup/import SQL that uses row-value predicates and assignments while RETURNING expression aliases inspect the old DELETE image and the new UPDATE image without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-row-value-returning-current-source-next117 self-test passed\n";
    return;
}
