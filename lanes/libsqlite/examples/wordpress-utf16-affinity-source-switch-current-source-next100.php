...
$plan = SQLiteUtf16CollationAffinitySourceSwitchPlan::wordpressOptionValueSourceSwitch(
    $currentRows,
    $nextRows,
...
echo json_encode(
    [
        'scenario' => 'wordpress-utf16-affinity-source-switch-current-source-next100',
