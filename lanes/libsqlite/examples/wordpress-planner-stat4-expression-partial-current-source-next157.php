...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext157Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext157Plan::materialize(
    $prepared,
    $current,
    $predicate,
