...
$payload = [
    'scenario' => 'application-pragma-index-xinfo-foreignkey-implicit-parent-current-source-next162',
    'status' => $page['status'],
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "application-pragma-index-xinfo-foreignkey-implicit-parent-current-source-next162 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "application-pragma-index-xinfo-foreignkey-implicit-parent-current-source-next162 self-test passed\n");
    exit(0);
}
