...
$matches = [
    'jsonNull' => $database->wordpressOptionsByIndexedJsonOptionValue('$.null', 'json-null'),
    'jsonInteger' => $database->wordpressOptionsByIndexedJsonOptionValue('$."123"', 'integer-label'),
    'jsonReal' => $database->wordpressOptionsByIndexedJsonOptionValue('$."1.25"', 'real-label'),
];

echo json_encode([
    'wordpressUse' => 'Preflight copied wp_options JSON operator indexes whose RHS constants use SQLite json_quote() numeric and NULL rendering without requiring the SQLite extension.',
