...
$summary = [
    'scenario' => 'wordpress-pager-statement-journal-savepoint-current-source-next90',
    ...
    'wordpressUse' => 'Release a successful inner wp_options savepoint only after the current database page image matches the statement-journal source, then open the next retry statement under the merged parent savepoint without ext/sqlite.',
];
...
if (
    ...
    fwrite(STDERR, "wordpress-pager-statement-journal-savepoint-current-source-next90 self-test failed\n");
    exit(1);
}
