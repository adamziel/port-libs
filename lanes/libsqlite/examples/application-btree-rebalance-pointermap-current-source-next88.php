...
echo json_encode([
    'scenario' => 'application-btree-rebalance-pointermap-current-source-next88',
    'applicationUse' => 'Delete an overflow-backed wp_options option_name index entry, rebalance sibling leaves from the current source image, then release obsolete overflow pages with auto-vacuum pointer-map entries rewritten to free-page.',
