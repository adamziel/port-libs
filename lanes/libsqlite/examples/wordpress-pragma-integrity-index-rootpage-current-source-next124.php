...
$page = SQLitePragmaIntegrityIndexRootpageCurrentSourceNext124::page(
    $catalog,
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-integrity-index-rootpage-current-source-next124 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-integrity-index-rootpage-current-source-next124 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-pragma-integrity-index-rootpage-current-source-next124',
