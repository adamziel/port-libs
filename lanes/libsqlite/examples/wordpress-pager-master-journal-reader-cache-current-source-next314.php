...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-next314',
    'epoch' => 314,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 314, 0])),
    'publication_generation' => 314,
    'master_source_digest' => hash('sha256', 'wordpress next314 master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::variantNext314(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-next314 self-test passed\n";
    return;
}
