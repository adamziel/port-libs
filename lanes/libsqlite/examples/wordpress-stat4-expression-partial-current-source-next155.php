...
require_once __DIR__ . '/../src/SQLitePlannerStat4ExpressionPartialCurrentSourceNext155Plan.php';
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext155Plan::materialize(
    $prepared,
    $current,
    $and(
        $range($lower, '>=', 'plugin_'),
