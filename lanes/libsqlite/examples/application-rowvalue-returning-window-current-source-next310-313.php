...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the next310-313 row-value UPDATE/DELETE RETURNING window current-source continuation after the ready next306-309 handoff while preserving independent libsqlite preflight throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next310-313 self-test passed\n";
    return;
}
