...
echo json_encode([
    'wordpressUse' => 'Split a copied wp_options table-interior child into current/next pages, insert the parent divider, and rewrite auto-vacuum pointer-map ownership without ext/sqlite.',
    'plan' => $plan->toArray(),
