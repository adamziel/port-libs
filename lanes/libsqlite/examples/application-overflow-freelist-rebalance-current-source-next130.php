...
echo json_encode([
    'applicationUse' => 'Shrink a copied wp_options transient value whose obsolete overflow pages must stay safely on the freelist because older free pages satisfy the smaller replacement overflow chain first.',
