...
echo json_encode([
    'scenario' => 'application-btree-pointermap-vacuum-reuse-current-source-next117',
    'applicationUse' => 'After wp_options cleanup frees overflow chains on both middle and tail pages, incremental vacuum truncates the tail and reuses surviving pages while rewriting both affected auto-vacuum pointer-map pages.',
