...
echo json_encode([
    ...
    'wordpressUse' => 'Applies SQLite jsonb_array_insert/jsonb_set current-index paths to copied wp_options JSONB queues, preserving pre-last insertion, append, and nested metadata creation without requiring ext/sqlite.',
