...
require_once __DIR__ . '/../src/SQLitePragmaRootpageIntegrityAnalysisCurrentSourceNext111.php';
require_once __DIR__ . '/../src/SQLitePragmaRootpagePointerMapForeignKeyCurrentSourceNext122.php';
require_once __DIR__ . '/../src/SQLitePragmaForeignKeyIndexRootCurrentSourceNext125.php';
require_once __DIR__ . '/../src/SQLitePragmaForeignKeyIndexRootpageCurrentSourceNext144.php';

use PortLibs\LibSqlite\SQLiteAttachedSchemaCatalog;
use PortLibs\LibSqlite\SQLiteIndexLeafPage;
use PortLibs\LibSqlite\SQLitePointerMapEntry;
use PortLibs\LibSqlite\SQLitePragmaForeignKeyIndexRootpageCurrentSourceNext144;
...
$result = SQLitePragmaForeignKeyIndexRootpageCurrentSourceNext144::page(
    $catalog,
    $catalog,
...
$second = SQLitePragmaForeignKeyIndexRootpageCurrentSourceNext144::page(
    $catalog,
    $catalog,
    'PRAGMA main.index_xinfo(wp_options_name)',
    $database(false),
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-pragma-foreignkey-index-rootpage-current-source-next144 self-test passed\n";
    return;
}
