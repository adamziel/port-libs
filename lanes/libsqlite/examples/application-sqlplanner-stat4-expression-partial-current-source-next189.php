...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next189 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next189',
    'applicationUse' => 'Copied wp_options plugin admin pagination can admit a current-source STAT4 partial expression index only after each row payload still satisfies lower(option_name), autoload, and NOT NULL partial predicates.',
    'status' => $plan['status'],
