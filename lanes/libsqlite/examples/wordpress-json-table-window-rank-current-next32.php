...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-window-rank-current-next32 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-json-table-window-rank-current-next32',
    'rankedCurrentNext' => $summary,
    'wordpressUse' => 'Copied wp_options plugin settings can be expanded through json_tree() and traversed as current/next ranked rows, preserving peer ties before import repair tools require ext/sqlite.',
