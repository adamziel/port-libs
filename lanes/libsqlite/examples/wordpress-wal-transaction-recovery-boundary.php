...
$summary = [
    'wordpressUse' => 'Recover copied wp_options WAL sidecars only through the last complete committed transaction, discarding valid draft frames and corrupt tail bytes before checkpointing without requiring ext/sqlite.',
