...
echo 'WordPress btree75 materialized action: ' . $summary['source_action'] . PHP_EOL;
echo 'WordPress btree75 next freelist trunk: ' . $summary['next_first_freelist_trunk_page'] . PHP_EOL;
echo 'WordPress btree75 next freelist count: ' . $summary['next_freelist_page_count'] . PHP_EOL;
echo 'WordPress btree75 pointer-map transitions: ' . implode(',', array_column($summary['pointer_map_transitions'], 'page_number')) . PHP_EOL;
echo 'WordPress btree75 updated pages: ' . implode(',', $summary['updated_page_numbers']) . PHP_EOL;
