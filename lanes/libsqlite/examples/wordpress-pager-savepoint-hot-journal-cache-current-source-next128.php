...
use PortLibs\LibSqlite\SQLitePagerSavepointHotJournalCacheCurrentSourceNext128Plan;
...
$plan = SQLitePagerSavepointHotJournalCacheCurrentSourceNext128Plan::currentSourceNext(
    $pageSize,
    'wp_plugin_import',
