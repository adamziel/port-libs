...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next878-893 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next877_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next878-893 self-test passed\n";
    return;
}
