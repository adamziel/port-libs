...
$prepared = [
    'name' => 'prepared-wp-options-range-order-next119',
    'schemaCookie' => 118,
    'stat4Generation' => 41,
    'indexes' => [[
...
$current = $prepared;
$current['name'] = 'current-wp-options-range-order-next119';
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-planner-covering-range-order-current-source-next119 self-test passed\n";
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-planner-covering-range-order-current-source-next119',
