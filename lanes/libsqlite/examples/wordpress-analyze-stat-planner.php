...
echo json_encode([
    'plans' => $plans,
    'wordpressUse' => 'Copied WordPress SQLite databases can reuse ANALYZE sqlite_stat1 cardinality to choose bounded native PHP option/postmeta index scans before row decoding when ext/sqlite is unavailable.',
