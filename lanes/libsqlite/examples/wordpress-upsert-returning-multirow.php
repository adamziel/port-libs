...
$payload = [
    'wordpressUse' => 'Preview copied wp_options INSERT ... ON CONFLICT DO UPDATE RETURNING rows in statement order, including mixed updates/inserts and projected RETURNING aliases without requiring ext/sqlite.',
