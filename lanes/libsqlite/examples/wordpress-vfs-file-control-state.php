...
echo json_encode([
    'scenario' => 'wordpress-vfs-file-control-state',
    'wordpressUse' => 'Apply SQLite xFileControl-style handle state for copied wp_options imports, including persist-WAL, chunk-size, mmap-size, name-hint, size-hint, and immutable archive guards without requiring ext/sqlite.',
