...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::optionRowNameCanonicalUnicodePlan($current, $next);
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-utf16-canonical-like-current-source-next233 self-test passed\n";
    return;
}
