...
if (($argv[1] ?? null) === '--self-test') {
    assert($plan['status'] === 'utf16-nocase-like-rtrim-current-source-nextoneEightZero');
    ...
    echo "application-utf16-nocase-like-rtrim-current-source-nextoneEightZero self-test passed\n";
    return;
}
