...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafHandoffBarrierFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next250',
    'applicationUse' => 'After a copied wp_options transient delete is vacuumed, admit next current-source readers only after checkpointed pointer-map barriers and the freeblock source are visible.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next250 self-test passed\n";
}
