...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next168',
    'applicationUse' => 'Preview copied wp_options cleanup where deleting a transient leaves the table leaf image stable while partial auto-vacuum truncates and reallocates overflow pages with pointer-map continuity.',
