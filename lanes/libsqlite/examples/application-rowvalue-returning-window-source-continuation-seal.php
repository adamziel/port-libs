...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the row-value UPDATE/DELETE RETURNING window current-source continuation after the ready after-current handoff while keeping follow-on slices isolated.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-source-continuation-seal self-test passed\n";
    return;
}
