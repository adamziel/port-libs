...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next253',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, grouped vacuum apply windows must open with pointer-map epochs before reusable freeblock pages are visible to the next writer.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next253 self-test passed\n";
}
