...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next457-472',
    'applicationUse' => 'Generated wp_options JSON path scans keep rowid point-cost admission stable across the next457-472 follow-on while changed copied source rows force a next reader reprepare.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next457-472 self-test passed\n";
    return;
}
