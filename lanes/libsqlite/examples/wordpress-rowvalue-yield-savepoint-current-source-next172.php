...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute(
    ['wp_options' => $rows],
    [$yieldUpdateSql],
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-rowvalue-yield-savepoint-current-source-next172 self-test passed\n";
    return;
}
