...
$replacementValue = $argv[2] ?? str_repeat('root-parent-split-', 24);
...
$firstPage[22] = "\x20";
$firstPage[23] = "\x20";
$firstPage = substr_replace($firstPage, pack('N', 36), 28, 4);
...
echo json_encode([
    'wordpressUse' => 'Plan a wp_options replacement that splits a full table-interior root parent after a table leaf grows, without the SQLite extension.',
    'plan' => $plan->toArray(),
    'root' => [
        'pageType' => $postDatabase->pageHeader(2)->pageType,
        'cellCount' => $postDatabase->pageHeader(2)->cellCount,
        'leftChildPage' => $rootCellsAfter[0]->leftChildPage,
        'separatorRowid' => $rootCellsAfter[0]->key,
        'rightMostPage' => $postDatabase->pageHeader(2)->rightMostPointer,
    ],
    'splitParents' => [
        38 => [
            'cellCount' => $postDatabase->pageHeader(38)->cellCount,
            'rightMostPage' => $postDatabase->pageHeader(38)->rightMostPointer,
            'firstSeparator' => $leftParentCells[0]->key,
        ],
        39 => [
            'cellCount' => $postDatabase->pageHeader(39)->cellCount,
            'rightMostPage' => $postDatabase->pageHeader(39)->rightMostPointer,
