...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows filtered by bounded SQLite SELECT text subqueries, including correlated EXISTS and IN/NOT IN NULL behavior, without requiring ext/sqlite.',
    'publicSql' => $publicSql,
