...
require_once __DIR__ . '/../src/SQLitePagerHotJournalSavepointCacheCurrentSourceNext100Plan.php';
...
$plan = SQLitePagerHotJournalSavepointCacheCurrentSourceNext100Plan::currentSourceNext(
    $pageSize,
    'wp_plugin_import',
