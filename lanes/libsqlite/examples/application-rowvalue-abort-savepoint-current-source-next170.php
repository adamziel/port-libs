...
$summary = [
    'scenario' => 'application-rowvalue-abort-savepoint-current-source-next170',
    'applicationUse' => 'Model a copied wp_options import savepoint where a row-value UPDATE OR ABORT conflict discards only the failed statement, preserves earlier UPDATE/DELETE RETURNING changes, retries against that current source, and then releases the savepoint.',
    'status' => $plan['status'],
