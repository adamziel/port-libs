...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-sqlplanner-stat4-expression-partial-current-partial-predicate-delta-equality self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-partial-predicate-delta-equality',
    'status' => $plan['status'],
