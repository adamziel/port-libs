...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows from bounded SQLite SELECT text through native GROUP BY/HAVING aggregate dispatch, including count, sum, avg, group_concat, ORDER BY, and LIMIT without requiring ext/sqlite.',
    'sql' => $sql,
