...
$sourceId = 'application-database-file-token-source';
$masterDigest = hash('sha256', 'application-next207-master-source');
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-pager-master-journal-reader-cache-current-source-next207 self-test passed\n";
    return;
}
