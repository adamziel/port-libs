...
$summary = [
    'scenario' => 'application-btree-overflow-freepage-apply-current-source-next116',
    'applicationUse' => 'Copied wp_options transient cleanup derives obsolete overflow chains from the current page image before applying freepage, freelist, secure-delete, and auto-vacuum pointer-map updates.',
...
if (
    ...
    fwrite(STDERR, "application-btree-overflow-freepage-apply-current-source-next116 self-test failed\n");
    exit(1);
}
