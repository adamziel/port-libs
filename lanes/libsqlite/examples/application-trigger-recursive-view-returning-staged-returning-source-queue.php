...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through an INSTEAD OF recursive view trigger can drain current-source RETURNING rows while multiple staged next-source trigger yields remain queued and invisible until release order admits them.',
