...
echo json_encode([
    'scenario' => 'wordpress-jsonb-patch-indexed-generated-current-next27',
    'wordpressUse' => 'Preview copied wp_options imports that query indexed generated columns derived from jsonb_patch(option_value, patch) without requiring ext/sqlite.',
