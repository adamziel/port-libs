...
echo json_encode([
    'scenario' => 'application-json-table-orderby-constraint',
    ...
    'applicationUse' => 'Copied wp_options JSON diagnostics can skip a redundant sorter when ORDER BY terms are fixed by pushed json_tree() visible constraints, while the current source remains pinned until cursor reset.',
