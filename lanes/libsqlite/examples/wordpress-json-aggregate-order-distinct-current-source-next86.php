...
$report = [
    'scenario' => 'wordpress-json-aggregate-order-distinct-current-source-next86',
    'groups' => $rows,
    'wordpressUse' => 'Copied wp_options diagnostics can sort JSON aggregate inputs DESC before DISTINCT admission, so newer or higher-priority duplicate option rows determine the current-source summary without ext/sqlite.',
];
