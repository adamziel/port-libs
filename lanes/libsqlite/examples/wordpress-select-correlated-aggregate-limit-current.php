...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options SELECT SQL where LIMIT/OFFSET scalar subqueries use grouped aggregate metadata sources and hide internal ORDER BY columns before SQLite-style scalar width checks.',
    'limitSql' => $limitSql,
