...
$matches = [
    ...
    'slot' => $database->wordpressOptionsByIndexedJsonOptionValue('$[1]', 'one'),
    'fragment' => $database->wordpressOptionsByIndexedJsonOptionFragment('$."settings.v1"', ['mode' => 'dark']),
];

echo json_encode([
    'wordpressUse' => 'Preflight copied wp_options JSON operator indexes whose RHS scalar constants are wrapped in SQL parentheses without requiring the SQLite extension.',
