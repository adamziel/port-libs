...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext434449Plan.php';
...
$plan = SQLiteVfsCurrentSourceNext434449Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next434-449 self-test passed\n";
    return;
}
