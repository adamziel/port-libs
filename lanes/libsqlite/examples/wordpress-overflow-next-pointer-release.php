...
echo json_encode([
    'wordpressUse' => 'Delete a copied wp_options transient whose overflow chain was moved by auto-vacuum, follow the on-page next pointers, reuse the freed local cell slot, and release obsolete overflow pages into the freelist.',
    'plan' => $plan->toArray(),
