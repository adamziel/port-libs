...
$summary = [
    'scenario' => 'wordpress-wal-checkpoint-savepoint-release-current-next51',
    'wordpressUse' => 'Expose copied wp_options import reader visibility after RELEASE SAVEPOINT merges plugin frames, then after checkpoint restart materializes those frames without requiring ext/sqlite.',
    'status' => $plan['status'],
    'mode' => $plan['mode'],
...
if (
    ...
    fwrite(STDOUT, "wordpress-wal-checkpoint-savepoint-release-current-next51 self-test passed\n");
    exit(0);
}

fwrite(STDERR, "wordpress-wal-checkpoint-savepoint-release-current-next51 self-test failed\n");
exit(1);
