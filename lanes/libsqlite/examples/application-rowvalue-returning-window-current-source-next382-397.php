...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the next382-397 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next374-381 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next382-397 self-test passed\n";
    return;
}
