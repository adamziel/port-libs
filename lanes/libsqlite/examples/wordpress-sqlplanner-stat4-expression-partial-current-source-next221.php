...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext221Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext221Plan::materialize(
    $prepared,
    $current,
    [
...
echo json_encode([
    ...
    'samplePositions' => $plan['stat4SampleWindowFence']['samplePositions'],
    'lookaheadRowids' => $plan['stat4YieldFence']['lookaheadRowids'],
    'wordpressUse' => 'Copied wp_options plugin scans can reuse a current-source partial expression index across cursor yields only when the yielded page and lookahead row stay inside current STAT4 sample windows.',
