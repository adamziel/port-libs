...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext213(
    'json_tree',
    $current,
    $next,
    'option_value',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next213 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next213',
    'wordpressUse' => 'Copied wp_options active_plugins diagnostics can resume a generated-path json_tree rowid scan after the last yielded rowid while a changed next-source JSON image keeps the restart fence explicit.',
