...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext494509(
    $prepared,
    $current,
    [
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-sqlplanner-stat4-expression-partial-current-source-next494-509 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-source-next494-509',
    'wordpressUse' => 'Copied wp_options plugin-admin pagination carries the next478-493 current-source STAT4 handoff into next494-509 only when projected current rows still match.',
    'status' => $plan['status'],
