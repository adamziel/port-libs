...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next750-765 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from integrated next734-749.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next750-765 self-test passed\n";
    return;
}
