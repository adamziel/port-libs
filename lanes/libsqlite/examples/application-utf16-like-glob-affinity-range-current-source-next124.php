...
$plan = SQLiteUtf16LikeGlobAffinityRangeCurrentSourceNextPlan::optionRowValuePlan(
    $currentRows,
    $nextRows,
    'option_value',
...
$preview = [
    'scenario' => 'application-utf16-like-glob-affinity-range-current-source-next124',
    'applicationUse' => 'Copied wp_options import scans can decode a UTF-16 LIKE pattern, preserve affinity-coerced option_value matches, and expose encoded range bounds before a schema-cookie source switch forces reprepare.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-utf16-like-glob-affinity-range-current-source-next124 self-test passed\n";
    return;
}
