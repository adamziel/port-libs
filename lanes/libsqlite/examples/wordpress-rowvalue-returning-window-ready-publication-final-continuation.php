...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the row-value UPDATE/DELETE RETURNING window ready-publication final continuation as the direct handoff from the prior ready seal.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-ready-publication-final-continuation self-test passed\n";
    return;
}
