...
$plan = $database->planWordPressOptionInsert(2, 'home', $optionValue, 'yes');
...
echo json_encode([
    'wordpressUse' => 'Plan a bounded generated wp_options row insert while maintaining a sqlite_autoindex-backed UNIQUE(option_name) constraint, without the SQLite extension.',
    'plan' => $plan->toArray(),
