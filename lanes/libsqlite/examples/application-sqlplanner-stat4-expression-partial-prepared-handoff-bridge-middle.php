...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-prepared-handoff-bridge-middle self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-prepared-handoff-bridge-middle',
    'applicationUse' => 'Copied wp_options plugin-admin pagination carries the next334-349 current-source STAT4 handoff into next350-365 only when projected current rows still match.',
    'status' => $plan['status'],
