...
echo json_encode([
    'wordpressUse' => 'Delete copied wp_options transient table/index overflow chains when the first freelist trunk is full, spilling the first obsolete overflow page into a new freelist trunk and rewriting auto-vacuum pointer-map entries without ext/sqlite.',
