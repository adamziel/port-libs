...
echo json_encode([
    'wordpressUse' => 'Summarize copied wp_options value sizes with SQLite count/sum/total/avg/min/max aggregate semantics, including NULL skipping, DISTINCT counting, FILTER-style autoload selection, and bounded rolling totals without requiring the SQLite extension.',
