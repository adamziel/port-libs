...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext254269(
    $prepared,
    $current,
    [
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-sqlplanner-stat4-expression-partial-current-source-next254-269 self-test passed\n";
}

return [
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-source-next254-269',
    'status' => $plan['status'],
    ...
    'wordpressUse' => 'Copied wp_options plugin pagination can hand off next254-269 STAT4 expression partial planner slices only after next253 payload rows are current-source verified.',
];
