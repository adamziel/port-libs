...
echo json_encode([
    'wordpressUse' => 'Preview copied WordPress schema PRAGMA catalog rows for attached database order and foreign-key actions while temp import tables shadow main wp_options without ext/sqlite.',
