...
echo json_encode([
    'scenario' => 'application-btree-freelist-pointermap-reuse-current-source-next124',
    'applicationUse' => 'When a copied wp_options cleanup frees a page while the freelist trunk is full, the page becomes the next freelist trunk and can be immediately reused with its auto-vacuum pointer-map entry rewritten.',
