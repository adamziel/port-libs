...
echo json_encode([
    ...
    'wordpressUse' => 'Inspect WordPress-style generated wp_options metadata while ignoring CHECK/UNIQUE text inside generated-column expressions, without requiring ext/sqlite.',
