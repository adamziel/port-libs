...
$plan = SQLiteBTreePointerMapOverflowVacuumCurrentSourceNext149Plan::fromCurrentSourceOverflowChains(
...
$summary = [
    'scenario' => 'wordpress-btree-pointermap-overflow-vacuum-current-source-next149',
    'wordpressUse' => 'Copied wp_options cleanup can truncate tail overflow pages during incremental vacuum; a later option rewrite must reuse only surviving current-source pages and reject truncated page numbers for pointer-map ownership.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-btree-pointermap-overflow-vacuum-current-source-next149 self-test passed\n";
    return;
}
