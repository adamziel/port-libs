...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next246',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, publish reusable vacuum freeblocks to the next source only when duplicate pointer-map generations, leaf receipts, and trunk leases are current.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next246 self-test passed\n";
}
