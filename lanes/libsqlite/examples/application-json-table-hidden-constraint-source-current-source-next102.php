...
$payload = [
    'scenario' => 'application-json-table-hidden-constraint-source-current-source-next102',
    'applicationUse' => 'Copied wp_options JSON scans can keep a current json_tree cursor pinned while the next option row supplies hidden json/root/rowid constraints and visible type constraints from source columns, without requiring ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-hidden-constraint-source-current-source-next102 self-test passed\n";
    return;
}
