...
echo json_encode([
    'applicationUse' => 'Plan a wp_options autoload rewrite that merges an underfilled non-root composite-index parent under a multi-child root, keeping the index reachable without the SQLite extension.',
    'plan' => $plan->toArray(),
