...
$summary = [
    'scenario' => 'application-pragma-index-xinfo-foreignkey-current-source-next263-266',
    'applicationUse' => 'Copied Application taxonomy and metadata tables can bind foreign-key CASCADE, SET NULL, SET DEFAULT, and RESTRICT actions to child-side lookup index diagnostics before admitting the next schema image.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "application-pragma-index-xinfo-foreignkey-current-source-next263-266 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "application-pragma-index-xinfo-foreignkey-current-source-next263-266 self-test passed\n");
    exit(0);
}
