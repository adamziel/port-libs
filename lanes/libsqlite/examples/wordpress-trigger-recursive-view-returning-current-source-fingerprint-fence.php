...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-fingerprint-fence self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-current-source-fingerprint-fence self-test passed\n";
