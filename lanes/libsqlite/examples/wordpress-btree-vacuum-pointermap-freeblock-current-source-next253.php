...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext253Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext253Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
