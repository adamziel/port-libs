...
echo json_encode([
    'wordpressUse' => 'Plan a wp_options replacement that splits a full non-root table-interior parent and promotes the divider into the root, without the SQLite extension.',
    'plan' => $plan->toArray(),
