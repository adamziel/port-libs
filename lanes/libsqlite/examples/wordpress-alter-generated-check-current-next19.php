...
echo json_encode([
    ...
    'wordpressUse' => 'Validate ALTER TABLE ADD COLUMN generated CHECK constraints against copied wp_options rows before rewriting schema SQL, without requiring ext/sqlite.',
