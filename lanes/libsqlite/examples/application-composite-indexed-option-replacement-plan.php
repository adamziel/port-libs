...
echo json_encode([
    'applicationUse' => 'Plan a bounded wp_options replacement that changes autoload while maintaining a single-leaf autoload, option_name composite index, without the SQLite extension.',
    'plan' => $plan->toArray(),
