...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext163Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext163Plan::plan(
    $database,
