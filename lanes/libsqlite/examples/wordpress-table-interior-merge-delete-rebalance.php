...
echo json_encode([
    'wordpressUse' => 'Preview a copied wp_options table b-tree delete rebalance where two underfilled interior siblings merge, the obsolete sibling becomes a freelist trunk, and auto-vacuum pointer-map children move to the merged parent without ext/sqlite.',
    'plan' => $plan->toArray(),
