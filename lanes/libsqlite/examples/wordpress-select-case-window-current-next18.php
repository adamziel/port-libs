...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows bucketed through parser-level CASE expressions and ranked by native window execution without requiring ext/sqlite.',
    'sql' => $sql,
