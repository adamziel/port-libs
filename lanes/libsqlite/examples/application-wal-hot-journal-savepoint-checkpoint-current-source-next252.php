...
$digest = hash('sha256', 'application next252 post truncate current source');
$truncationPlan = [
    ...
    'source_token' => 'application-next252-import-source',
...
$receipts = [
    array_replace($baseReceipt, ['name' => 'application-next252-wal-truncate', 'kind' => 'wal-truncate']),
    array_replace($baseReceipt, ['name' => 'application-next252-shm-reset', 'kind' => 'shm-reset']),
    array_replace($baseReceipt, ['name' => 'application-next252-readmark-reset', 'kind' => 'readmark-reset']),
    array_replace($baseReceipt, ['name' => 'application-next252-journal-unlink', 'kind' => 'journal-unlink']),
    array_replace($baseReceipt, ['name' => 'application-next252-directory-sync', 'kind' => 'directory-sync']),
];
