...
$prepared = [
    'name' => 'prepared-application-options-stat4-samples',
    'schemaCookie' => 2070,
    'stat4Generation' => 207,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-application-options-stat4-samples';
...
if (($plan['stat4SamplePredicateFence']['sampleRowidsRejectedByCurrentPartialPredicate'] ?? []) !== []) {
    throw new RuntimeException('Expected all Application option STAT4 samples to remain inside the partial index predicate');
}
