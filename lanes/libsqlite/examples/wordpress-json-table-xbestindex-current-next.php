...
echo json_encode([
    ...
    'wordpressUse' => 'Copied wp_options JSON diagnostics can expose SQLite-style xBestIndex constraint usage, residual predicates, and current/next cursor metadata before json_tree() scans run without ext/sqlite.',
