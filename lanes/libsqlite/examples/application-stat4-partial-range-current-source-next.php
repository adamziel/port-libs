...
$summary = [
    'scenario' => 'application-stat4-partial-range-current-source-stable',
    'status' => $plan['status'],
    ...
    'detail' => $plan['detail'],
    'applicationUse' => 'Preview copied wp_options plugin-option imports after ANALYZE narrows a partial STAT4 index; the planner reparses so stale prepared range bounds do not admit rows outside the current partial index.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-stat4-partial-range-current-source-stable self-test passed\n";
    return;
}
