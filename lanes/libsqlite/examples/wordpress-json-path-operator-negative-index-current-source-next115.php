...
$payload = [
    'wordpressUse' => 'Evaluate copied wp_options JSON settings with SQLite 3.47-style negative integer RHS JSON operators, so the latest rule/channel can be inspected without ext/sqlite.',
