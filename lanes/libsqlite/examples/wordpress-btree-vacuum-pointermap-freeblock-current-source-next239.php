...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafSourceDrainFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode($plan->drainSummary(), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . PHP_EOL;
