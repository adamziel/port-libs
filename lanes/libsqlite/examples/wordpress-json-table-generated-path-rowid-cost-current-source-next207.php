...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext207(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next207',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    if ($payload['currentBoundedRowids'] !== [8, 7]) {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next207 self-test passed\n";
    return;
}
