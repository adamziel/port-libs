...
$payload = [
    'scenario' => 'application-json-table-path-constraint',
    'applicationUse' => 'Copied wp_options JSON import tooling can push path-qualified json_tree() constraints into the current-source planner before comparing old and next plugin rule payloads without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-path-constraint self-test passed\n";
    return;
}
