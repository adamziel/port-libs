...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options SELECT text where TEMP import rows shadow main and attached databases until schema-qualified names pin the current source, without requiring ext/sqlite.',
