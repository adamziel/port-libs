...
echo json_encode([
    'wordpressUse' => 'Replace a copied wp_options transient row and option_name index entry whose obsolete overflow chains are immediately reused for the next large option value without ext/sqlite.',
