...
if ($databasePath === null || $jsonPath === null || $jsonValue === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-json-option-fragment.php path/to/wordpress.sqlite json_path json_value [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedJsonOptionFragment($jsonPath, $lookupValue, $limit),
);
