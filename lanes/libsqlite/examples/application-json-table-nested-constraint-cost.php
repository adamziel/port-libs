...
$summary = [
    ...
    'applicationUse' => 'A copied wp_options plugin setting can keep a base JSON root and per-request nested fragment; this previews when json_tree() visible constraints should be replanned because the nested fragment changes row count, output fullkeys, and indexed cost.',
];
