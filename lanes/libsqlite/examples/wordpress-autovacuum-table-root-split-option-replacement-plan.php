...
echo json_encode([
    'wordpressUse' => 'Preflight an auto-vacuum wp_options replacement that grows the table root while assigning pointer-map parent links for the new b-tree child pages.',
    'plan' => $plan->toArray(),
