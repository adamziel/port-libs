...
$plan = SQLiteWordPressJsonImportWalSavepointPlan::insertWalCurrentNext(
    $wal,
    $databaseBytes,
    [
...
echo json_encode([
    'scenario' => 'wordpress-json-import-insert-wal-current-next50',
    'wordpressUse' => 'Import copied wp_options JSON payloads under SQLite savepoints, then expose released inserts and updates through committed WAL current/next reader visibility while a malformed later batch rolls back.',
    'status' => $plan['status'],
