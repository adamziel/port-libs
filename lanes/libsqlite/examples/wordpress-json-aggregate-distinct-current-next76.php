...
$report = [
    ...
    'wordpressUse' => 'Copied wp_options rows execute parser-level json_group_array(DISTINCT ... ORDER BY ...) and jsonb_group_array(DISTINCT ... ORDER BY ...) FILTER summaries for duplicate option cleanup/import diagnostics without requiring ext/sqlite.',
];
