...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-xcolumn-snapshot',
    'applicationUse' => 'Copied wp_options JSON rule diagnostics can resume a generated-path rowid scan and materialize xColumn values from the pinned current-source snapshot while a next source waits for reprepare.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-xcolumn-snapshot self-test passed\n";
    return;
}
