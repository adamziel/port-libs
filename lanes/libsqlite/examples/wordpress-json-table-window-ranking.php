...
echo json_encode([
    'scenario' => 'wordpress-json-table-window-ranking',
    'planned' => [
        'rows' => array_map(
    ...
    'wordpressUse' => 'Local-only wp_options diagnostics can expand copied plugin settings through json_tree() and preview SQLite window ranking over JSON table rows before import or repair tools require ext/sqlite.',
