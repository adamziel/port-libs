...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafPublishBarrierFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next187',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next187 self-test passed\n";
}
