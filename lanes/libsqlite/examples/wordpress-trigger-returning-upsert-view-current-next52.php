...
echo json_encode([
    'scenario' => 'wordpress-trigger-returning-upsert-view-current-next52',
    'wordpressUse' => 'Preview copied wp_options imports routed through an INSTEAD OF view trigger whose UPSERT RETURNING rows expose current and next table images without requiring ext/sqlite.',
