...
echo json_encode([
    'scenario' => 'wordpress-planner-or-partial-covering-current-next34',
    'mode' => $mode,
    'usable' => $plan !== null,
    'type' => $plan['type'] ?? null,
    ...
    'wordpressUse' => 'Preview copied wp_options OR predicates where each arm can be served by a proven partial covering expression index, avoiding unsafe broad scans and table b-tree fetches without ext/sqlite.',
