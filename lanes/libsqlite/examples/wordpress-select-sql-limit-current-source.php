...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options SELECT SQL where LIMIT/OFFSET scalar subqueries resolve against the current SELECT source tables, preserving SQLite import previews without ext/sqlite.',
    'sql' => $sql,
