...
echo json_encode([
    'scenario' => 'wordpress-json-table-cursor',
    'planned' => [
    ...
    'wordpressUse' => 'Local-only wp_options diagnostics can iterate json_tree()/json_each() through a bounded virtual-table cursor, including JSONB payloads and malformed-BLOB planning, before a full native VDBE cursor is available.',
