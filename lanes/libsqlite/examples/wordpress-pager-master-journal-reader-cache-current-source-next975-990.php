...
$formatPage = static function (string $label) use ($pageSize): string {
    ...
    $page = substr_replace($page, pack('N', 990), 60, 4);
...
$next975990Fields = [
    'reader_cache_stmt_vdbe_notnull_branch_condition_branch_condition_handoff_token', 'reader_cache_stmt_vdbe_ne_branch_condition_branch_condition_handoff_token',
    'reader_cache_stmt_vdbe_eq_branch_condition_branch_condition_handoff_token', 'reader_cache_stmt_vdbe_gt_branch_condition_branch_condition_handoff_token',
    'reader_cache_stmt_vdbe_le_branch_condition_branch_condition_handoff_token', 'reader_cache_stmt_vdbe_lt_branch_condition_branch_condition_handoff_token',
    'reader_cache_stmt_vdbe_ge_branch_condition_branch_condition_handoff_token', 'reader_cache_stmt_vdbe_else_eq_branch_condition_branch_condition_handoff_token',
    'reader_cache_stmt_vdbe_zero_or_null_branch_condition_branch_condition_handoff_token', 'reader_cache_stmt_vdbe_seek_hit_branch_condition_branch_condition_handoff_token',
    'reader_cache_stmt_vdbe_if_not_open_branch_condition_branch_condition_handoff_token', 'reader_cache_stmt_vdbe_not_open_branch_condition_branch_condition_handoff_token',
    'reader_cache_stmt_vdbe_if_open_branch_condition_branch_condition_handoff_token', 'reader_cache_stmt_vdbe_transaction_branch_condition_branch_condition_handoff_token',
    'reader_cache_stmt_vdbe_auto_commit_branch_condition_branch_condition_handoff_token', 'reader_cache_stmt_vdbe_savepoint_branch_condition_branch_condition_handoff_token',
];
...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-next990',
    'epoch' => 990,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 990, 0])),
    'publication_generation' => 990,
    'master_source_digest' => hash('sha256', 'wordpress next990 master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::variantNext990(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
echo json_encode([
    ...
    'next990_reopen_reason' => $plan['next_reads'][0]['reader_cache_stmt_vdbe_savepoint_branch_condition_branch_condition_handoff_token_reason'],
