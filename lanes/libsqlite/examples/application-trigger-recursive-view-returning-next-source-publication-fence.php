...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through an INSTEAD OF recursive view trigger keep RETURNING rows tied to the current-source snapshot and view schema cookie before a savepoint release exposes queued next-source rows.',
