...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "application-trigger-recursive-view-returning-current-source-next178 self-test passed\n";
}

return [
    'scenario' => 'application-trigger-recursive-view-returning-current-source-next178',
    'applicationUse' => 'Copied app_settings imports through an INSTEAD OF recursive view trigger keep RETURNING rows tied to the current-source snapshot and view schema cookie before a savepoint release exposes queued next-source rows.',
