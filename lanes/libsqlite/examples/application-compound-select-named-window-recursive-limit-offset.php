...
$result = [
    'scenario' => 'application-compound-select-window-recursive-limit-current-source-named-window-recursive-limit-offset',
    ...
    'applicationUse' => 'Copied wp_options import previews can rank recursive seed rows and autoloaded option rows through named windows before the final compound SELECT boundary decides which current-source rows yield to next-source rows.',
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "application-compound-select-window-recursive-limit-current-source-named-window-recursive-limit-offset self-test passed\n";
}
