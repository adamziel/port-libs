...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeReceiptLedgerHandoff(
    ['wp_options' => $rows],
...
if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-receipt-ledger-handoff self-test passed\n";
    return;
}
