...
echo json_encode([
    'scenario' => 'wordpress-jsonb-check-current-next64',
    ...
    'wordpressUse' => 'Preflight copied wp_options JSONB plugin settings against table CHECK constraints before current/next import rows are admitted to storage and index maintenance.',
