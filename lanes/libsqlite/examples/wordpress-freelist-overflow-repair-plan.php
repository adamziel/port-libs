...
echo json_encode([
    'wordpressUse' => 'Inspect SQLite freelist trunk metadata, choose reusable pages for a large wp_options value, update the freelist metadata, and parse the repaired image without the SQLite extension.',
