...
if ($databasePath === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-autoloaded-option-name-range.php path/to/wordpress.sqlite [autoload] [lower_inclusive|-] [upper_bound|-] [limit] [upper_inclusive]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedAutoloadAndNameRange($autoload, $lowerInclusive, $upperBound, $limit, $upperInclusive),
);
