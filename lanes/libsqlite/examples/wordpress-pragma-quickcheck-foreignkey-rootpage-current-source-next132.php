...
use PortLibs\LibSqlite\SQLitePragmaQuickcheckForeignKeyRootpageCurrentSourceNext132;
...
$page = SQLitePragmaQuickcheckForeignKeyRootpageCurrentSourceNext132::page(
    $catalog,
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-quickcheck-foreignkey-rootpage-current-source-next132 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-quickcheck-foreignkey-rootpage-current-source-next132 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-pragma-quickcheck-foreignkey-rootpage-current-source-next132',
