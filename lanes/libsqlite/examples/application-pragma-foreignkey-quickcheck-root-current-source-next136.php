...
$cleanSchemas = [
    'main' => [
        'tables' => [
            'wp_option_names' => [['rowid' => 1, 'name' => 'siteurl']],
            'wp_options' => [['rowid' => 1, 'option_name' => 'siteurl']],
        ],
        'foreignKeys' => $schemas['main']['foreignKeys'],
    ],
];
...
$result = SQLitePragmaForeignKeyRootIntegrityCurrentSourceYield::currentNextPage(
    $currentDatabase,
    $schemas,
    $nextDatabase,
    $cleanSchemas,
...
echo json_encode([
    ...
    'current_root_blockers' => $result['current']['integrity_root'],
    'current_foreign_key_blockers' => $result['current']['foreign_key'],
    'next_ready' => $result['next_state']['ready'],
    'cleared' => $result['delta']['cleared'],
    'delta_total' => $result['delta']['total'],
