...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the prepared admission after-current row-value UPDATE/DELETE RETURNING handoff as admission, balance, next-source package, and final handoff receipts.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-admission-after-current self-test passed\n";
    return;
}
