...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafApplyReceiptFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next211',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, replay applies pointer-map barriers before payload/freeblock pages and keeps truncated tail pages fenced.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next211 self-test passed\n";
}
