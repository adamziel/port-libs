...
$report = [
    'scenario' => 'wordpress-wal-restart-checkpoint-reader-yield-current-next52',
    'wordpressUse' => 'A copied wp_options reader releases its SHM read mark so a blocked restart checkpoint can reset the WAL for the next importer reader.',
    'status' => $plan['status'],
