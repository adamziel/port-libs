...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-current-source-next170',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'A copied wp_options recovery rejects reader-cache pages keyed from an older rollback-journal source before rewriting active_plugins.',
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next170'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-current-source-next170 self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-current-source-next170 self-test passed\n";
