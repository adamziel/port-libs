...
$plan = SQLiteJsonTablePlan::lateralConstraintHiddenCurrentSourceNext118(
    $currentOptions,
    $nextOptions,
    'option_id',
    'json_each',
...
$summary = [
    'scenario' => 'wordpress-json-table-lateral-constraint-hidden-current-source-next118',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-lateral-constraint-hidden-current-source-next118 self-test passed\n";
    return;
}
