...
echo json_encode([
    'scenario' => 'wordpress-wal-savepoint-checkpoint-current-source-next79',
    'wordpressUse' => 'Guard a wp_options plugin import ROLLBACK TO savepoint plus RESTART checkpoint so stale WAL bytes from a prior source salt cannot be checkpointed into the current database image.',
    'status' => $plan['status'],
