...
$sourceId = 'application-master-journal-file-token-source';
$masterDigest = hash('sha256', 'application-next206-master-source');
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-pager-master-journal-reader-cache-current-source-next206 self-test passed\n";
    return;
}
