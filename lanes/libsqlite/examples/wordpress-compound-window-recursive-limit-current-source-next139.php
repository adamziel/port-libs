...
require_once __DIR__ . '/../src/SQLiteCompoundWindowRecursiveLimitCurrentSourceNext139Plan.php';
...
$summary = SQLiteCompoundWindowRecursiveLimitCurrentSourceNext139Plan::compare($sql, $currentTables, $nextTables);
