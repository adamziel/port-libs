...
echo json_encode([
    'scenario' => 'wordpress-json-table-limit-offset',
    'planned' => [
        'used' => array_map(
    ...
    'wordpressUse' => 'Local-only wp_options diagnostics preserve SQLite JSON virtual-table LIMIT/OFFSET pushdown while filtering copied plugin settings rows, so paged JSON scans can be previewed without ext/sqlite before import.',
