...
$plan = SQLiteWalHotJournalSavepointCheckpointCurrentSourceNextPlan::next175Plan(
    $databasePath,
    implode('', $database),
    $pageSize,
    'plugin-import-inner-next175',
...
$summary = [
    ...
    'wordpressUse' => 'A copied wp_options import reuses reopened checkpoint page cache only after hot-journal savepoint rollback pages are checkpointed, synced, and sealed to the current source.',
];
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next175 self-test passed\n";
    return;
}
