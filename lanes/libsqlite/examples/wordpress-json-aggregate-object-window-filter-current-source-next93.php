...
$summary = [
    'scenario' => 'wordpress-json-aggregate-object-window-filter-current-source-next93',
    ...
    'rows' => $rows,
    'wordpressUse' => 'Copied wp_options import previews can build current-source option summary objects from the active window frame while FILTER removes disabled rows before JSON object aggregation.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-aggregate-object-window-filter-current-source-next93 self-test passed\n";
    return;
}
