...
require_once __DIR__ . '/../src/SQLitePragmaForeignKeyIndexIntegrityCurrentSourceNext131.php';
...
$page = SQLitePragmaForeignKeyIndexIntegrityCurrentSourceNext131::page(
    $records,
    $foreignKeys,
    $tables,
    'cf317d66c8667530b6b7e4bc41f70f5a0397ef54',
    'pragma-foreignkey-index-integrity-current-source-next131',
    0,
    2,
);
