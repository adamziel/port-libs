...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext165Plan;
...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext165Plan::compare($sql, $currentTables, $nextTables);
$result = [
