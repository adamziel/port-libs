...
if (
    ...
    || array_column($summary['visible_returning_payloads_source_sequence_fence'], 'name') !== ['blogdescription_child', 'template_child', 'home', 'next_plugin']
    || $summary['held_next_source_rows_source_sequence_fence'] !== []
) {
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-source-sequence self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-current-source-source-sequence self-test passed\n";
