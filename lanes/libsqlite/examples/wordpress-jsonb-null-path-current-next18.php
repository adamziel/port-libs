...
echo json_encode([
    ...
    'wordpressUse' => 'Preserves SQLite JSONB mutation behavior for optional wp_options JSON path filters: NULL mutation paths are skipped while JSON remove with a NULL path returns SQL NULL, without requiring ext/sqlite.',
