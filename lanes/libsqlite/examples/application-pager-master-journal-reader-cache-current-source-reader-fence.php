...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-current-source-reader-fence',
    'applicationUse' => 'A copied Application options reader re-reads the current master journal and rejects stale pager-cache pages before serving active_plugins and plugin settings pages.',
    'status' => $plan['status'],
