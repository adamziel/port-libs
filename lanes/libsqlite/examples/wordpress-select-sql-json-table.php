...
echo json_encode([
    'scenario' => 'wordpress-select-sql-json-table',
    'wordpressUse' => 'Local-only wp_options diagnostics can execute bounded SELECT SQL text whose FROM clause is json_tree()/json_each(), preserving JSON table predicates, ordering, joins, and NULL-extension behavior without requiring ext/sqlite.',
