...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext188Plan::compare($sql, $currentTables, $nextTables);
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-compound-select-window-recursive-limit-current-source-next188 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-compound-select-window-recursive-limit-current-source-next188',
