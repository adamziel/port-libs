...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next234',
    'applicationUse' => 'Copied wp_options JSON diagnostics can advance a generated-path json_tree rowid cursor with xNext only when the delivered rowid tape and yield-guard fingerprint still match the pinned current source.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next234 self-test passed\n";
    return;
}
