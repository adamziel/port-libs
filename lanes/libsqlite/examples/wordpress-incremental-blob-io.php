...
echo json_encode([
    'scenario' => 'wordpress-incremental-blob-io',
    'wordpressUse' => 'Patch a fixed-size copied wp_options BLOB value in chunks using SQLite incremental BLOB semantics without requiring ext/sqlite.',
