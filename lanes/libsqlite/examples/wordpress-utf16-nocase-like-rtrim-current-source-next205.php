...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext205Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext205Plan::wordpressOptionNameNonAsciiPrefixPlan($current, $next);
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next205 self-test passed\n";
