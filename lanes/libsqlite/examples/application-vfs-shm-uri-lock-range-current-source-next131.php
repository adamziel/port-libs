...
$summary = [
    'scenario' => 'application-vfs-shm-uri-lock-range-current-source-next131',
    'applicationUse' => 'Model copied Application SQLite WAL shared-memory xShmLock ranges for multi-slot read-mark and checkpoint locks, preserving atomic conflict handling, URI current-source routing, and stale data-version checks without ext/sqlite.',
