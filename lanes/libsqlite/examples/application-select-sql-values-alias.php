...
echo json_encode([
    'applicationUse' => 'Preview inline VALUES import staging tuples with SQLite column-alias lists before applying Application wp_options updates/inserts without ext/sqlite.',
    'sql' => $sql,
