...
$first = SQLitePragmaIndexForeignKeyIntegrityCurrentSourceNext137::page(
    $catalog,
    ...
    'pragma-index-foreignkey-integrity-current-source-next137',
    0,
    8,
);
$second = SQLitePragmaIndexForeignKeyIntegrityCurrentSourceNext137::page(
    $catalog,
    'PRAGMA main.index_list(wp_options)',
    $database,
    $records,
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-index-foreignkey-integrity-current-source-next137 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-index-foreignkey-integrity-current-source-next137 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-pragma-index-foreignkey-integrity-current-source-next137',
