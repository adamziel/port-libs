...
echo json_encode([
    'wordpressUse' => 'Apply a copied wp_options option_name index interior sibling redistribution from the current database image to the next image, including parent divider replacement and auto-vacuum pointer-map ownership changes.',
