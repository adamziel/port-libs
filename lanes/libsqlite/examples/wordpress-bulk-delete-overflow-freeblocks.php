...
echo json_encode([
    'wordpressUse' => 'Delete a transient option plus timeout partner from wp_options and the autoload/option_name index, returning coalesced freeblocks and obsolete overflow pages for freelist release.',
