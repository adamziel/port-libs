...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeSourceSegmentWatermark(
    ['wp_options' => $rows],
...
if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-source-segment-watermark self-test passed\n";
}
...
return [
    ...
    'applicationUse' => 'Copied wp_options retry batches publish next-source UPDATE/DELETE RETURNING window rows only after current and retry source segments match their watermarks.',
