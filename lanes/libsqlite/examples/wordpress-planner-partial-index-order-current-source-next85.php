...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-planner-partial-index-order-current-source-next85 self-test passed\n";

    return;
}

echo json_encode([
    'scenario' => 'wordpress-planner-partial-index-order-current-source-next85',
    ...
    'detail' => $plan['detail'],
    'wordpressUse' => 'Copied wp_options plugin diagnostics can stream ORDER BY option_name from an implied partial index current source, while next-source residual predicates remain explicit and no temp sort is introduced without requiring ext/sqlite.',
