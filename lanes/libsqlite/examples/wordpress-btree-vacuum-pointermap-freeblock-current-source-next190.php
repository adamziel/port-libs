...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext190Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext190Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
