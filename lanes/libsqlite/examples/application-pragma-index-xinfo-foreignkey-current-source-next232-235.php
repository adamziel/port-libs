...
$summary = [
    'scenario' => 'application-pragma-index-xinfo-foreignkey-current-source-next232-235',
    'applicationUse' => 'Bulk Application schema import checks can separate child-action prefix blockers, expression-prefixed child indexes, expression parent UNIQUE indexes, and DESC parent UNIQUE metadata.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "application-pragma-index-xinfo-foreignkey-current-source-next232-235 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "application-pragma-index-xinfo-foreignkey-current-source-next232-235 self-test passed\n");
    exit(0);
}
