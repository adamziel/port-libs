...
use PortLibs\LibSqlite\SQLitePragmaRootpageIntegrityAnalysisCurrentSourceNext111;
...
$valid = SQLitePragmaRootpageIntegrityAnalysisCurrentSourceNext111::analyze($build($schemaRows, [
    [3, SQLitePointerMapEntry::BTREE_PAGE, 4],
    [4, SQLitePointerMapEntry::ROOT_PAGE, 0],
    [5, SQLitePointerMapEntry::ROOT_PAGE, 0],
]));

$duplicateRoot = SQLitePragmaRootpageIntegrityAnalysisCurrentSourceNext111::analyze($build([
    $schemaRows[0],
...
echo json_encode([
    ...
    'dependencyTags' => [
        ...
        'wordpress-sqlite-import-repair',
    ],
