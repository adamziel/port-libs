...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext224(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next224',
    'wordpressUse' => 'Copied wp_options JSON diagnostics can resume a generated-path json_tree rowid cursor only when the xCurrent fingerprint and active rowid still match the current source; changed next-source settings restart instead of reusing stale projected values.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next224 self-test passed\n";
    return;
}
