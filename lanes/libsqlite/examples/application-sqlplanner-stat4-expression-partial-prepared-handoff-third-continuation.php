...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializePreparedHandoffRangeContinuation(
    $prepared,
    $current,
    [
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-prepared-handoff-third-continuation self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-prepared-handoff-third-continuation',
    'applicationUse' => 'Copied wp_options plugin-admin pagination carries the next766-781 current-source STAT4 handoff into next782-797 only when projected current rows still match.',
    'status' => $plan['status'],
