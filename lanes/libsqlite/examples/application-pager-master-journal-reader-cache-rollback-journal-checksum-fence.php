...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-rollback-journal-checksum-fence',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'A copied wp_options recovery reuses only checksum-verified reader cache pages before rewriting active_plugins; plugin settings waits for a verified before-image.',
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next175'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-rollback-journal-checksum-fence self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-rollback-journal-checksum-fence self-test passed\n";
