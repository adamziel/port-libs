...
$summary = [
    'scenario' => 'application-expression-covering-order-current-source-next103',
    ...
    'applicationUse' => 'Preview copied wp_options autoloaded plugin scans after ANALYZE refresh: lower(option_name) expression index ordering is selected from the current source while the covering cursor avoids table lookups and temp sorting without ext/sqlite.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-expression-covering-order-current-source-next103 self-test passed\n";
    return;
}
