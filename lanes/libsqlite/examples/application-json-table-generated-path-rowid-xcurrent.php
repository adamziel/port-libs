...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-xcurrent',
    'applicationUse' => 'Copied wp_options JSON diagnostics can pin xCurrent output for a generated-path json_tree rowid range while forcing reprepare when the next source changes generated-path fingerprints.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-xcurrent self-test passed\n";
    return;
}
