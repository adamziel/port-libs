...
echo json_encode([
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient, immediately reuse the current/next freelist pages for the replacement overflow chain and rewrite auto-vacuum pointer-map ownership.',
