...
require_once __DIR__ . '/../src/SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext190Plan.php';
...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext190Plan::execute(
    ['wp_options' => $rows],
    [$release],
    [$speculative],
    [$retry, $cleanup],
