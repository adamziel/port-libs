...
$root = sys_get_temp_dir() . '/port-libsqlite-wordpress-wal-hot-reader-hot-journal-reader-checkpoint-apply-' . bin2hex(random_bytes(4));
...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-reader-checkpoint-apply-hot-journal-reader-checkpoint-apply',
...
if (PHP_SAPI === 'cli' && in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-wal-hot-journal-reader-checkpoint-apply-hot-journal-reader-checkpoint-apply self-test passed\n";
    return;
}
