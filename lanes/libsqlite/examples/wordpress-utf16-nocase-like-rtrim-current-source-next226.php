...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext226Plan::wordpressOptionNameCombiningMarkPlan($current, $next);
...
$payload = [
    ...
    'wordpressUse' => 'Copied wp_options scans keep SQLite-compatible UTF-16 LIKE semantics: composed and decomposed accents are not normalized, a combining mark remains its own LIKE character, and NOCASE/RTRIM stay ASCII scoped.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next226 self-test passed\n";
    return;
}
