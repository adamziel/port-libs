...
$result = [
    'scenario' => 'wordpress-compound-values-affinity-order-current-source-next127',
    'wordpressUse' => 'Copied wp_options import previews can seed staged VALUES rows into a compound SELECT before reading the current table, preserving SQLite storage-class ordering and left-arm column names without ext/sqlite.',
    'sql' => $sql,
