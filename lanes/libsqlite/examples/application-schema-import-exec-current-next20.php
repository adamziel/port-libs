...
echo json_encode([
    'scenario' => 'application-schema-import-exec-current-next20',
    'applicationUse' => 'Import copied Application schema DDL into bounded sqlite_schema records, including temp staging tables, attached archive tables, autoindexes, rootpages, and PRAGMA catalog handoff without requiring ext/sqlite.',
