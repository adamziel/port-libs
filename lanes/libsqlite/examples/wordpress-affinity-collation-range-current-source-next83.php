...
$numeric = SQLiteAffinityRangeCurrentSourceCursor::wordpressOptionRange(
    $rows,
    'option_value',
    2,
    10,
...
$names = SQLiteAffinityRangeCurrentSourceCursor::wordpressOptionRange(
    $rows,
    'option_name',
    'plugin_',
    'theme_',
...
$summary = [
    'scenario' => 'wordpress-affinity-collation-range-current-source-next83',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-affinity-collation-range-current-source-next83 self-test passed\n";
    return;
}
