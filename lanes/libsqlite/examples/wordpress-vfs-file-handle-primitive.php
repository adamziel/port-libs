...
$root = sys_get_temp_dir() . '/port-libsqlite-wordpress-vfs-file-handle-' . bin2hex(random_bytes(4));
...
echo json_encode([
    'scenario' => 'wordpress-vfs-file-handle-primitive',
    'wordpressUse' => 'Read copied wp_options database pages and apply WAL sidecar bytes through bounded SQLite VFS xRead/xWrite/xTruncate/xFileSize primitives without requiring ext/sqlite.',
    'root' => $root,
    'database' => [
        'path' => $database,
        'exists' => $stat['exists'],
