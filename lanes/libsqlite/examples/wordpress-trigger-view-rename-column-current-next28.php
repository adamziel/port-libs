...
echo json_encode([
    ...
    'wordpressUse' => 'Preview ALTER TABLE wp_options RENAME COLUMN option_name TO option_key across copied WordPress trigger/view SQL where implicit aliases, table aliases, and CTE names happen to match the old column name; source column references are rewritten while alias/source names and raise() messages stay stable without requiring ext/sqlite.',
