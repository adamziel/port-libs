...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next622-637 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next606-621 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next622-637 self-test passed\n";
    return;
}
