...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext196Plan;
...
$currentHeaders = [
    $mainJournal => hash('sha256', 'wordpress-main-current-rollback-header'),
    $usersJournal => hash('sha256', 'wordpress-users-current-rollback-header'),
];
$oldHeaders = [
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext196Plan::plan(
    $database,
    $masterJournal,
    $mainJournal . "\n" . $usersJournal . "\n",
    ...
    'wordpress-member-header-source',
    196,
    196,
    hash('sha256', 'wordpress-current-master-source'),
    11,
    $currentTokens,
    $currentHeaders,
);
