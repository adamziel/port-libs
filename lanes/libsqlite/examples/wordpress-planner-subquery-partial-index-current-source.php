...
$summary = [
    'scenario' => 'wordpress-planner-subquery-partial-index-current_source-current_source',
    'status' => $plan['status'],
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-planner-subquery-partial-index-current_source-current_source self-test passed\n";
    exit(0);
}
