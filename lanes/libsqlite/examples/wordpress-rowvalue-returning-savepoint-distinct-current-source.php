...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-rowvalue-returning-savepoint-distinct-current-source self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-rowvalue-returning-savepoint-distinct-current-source',
    'status' => $plan['status'],
