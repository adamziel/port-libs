...
echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-stat4-expression-partial-reprepare',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'Preview copied wp_options partial expression-index planning after ANALYZE/stat4 changes without using ext/sqlite; stale prepared plans re-read the current source before scanning option_name plugin rows.',
