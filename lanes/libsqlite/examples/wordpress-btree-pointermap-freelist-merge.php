...
echo json_encode([
    'wordpressUse' => 'Delete copied wp_options overflow-backed transient table and option_name index cells, then merge the obsolete current next-pointer overflow pages into the existing freelist trunk while auto-vacuum pointer-map entries become free-page.',
