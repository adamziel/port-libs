...
if (in_array('--self-test', $argv, true)) {
    ...
    fwrite(STDOUT, "wordpress-compound-window-filter-current-source-next126 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-compound-window-filter-current-source-next126',
    'wordpressUse' => 'Preview copied wp_options current and staged rows through a compound SELECT whose window FILTER clauses use correlated subqueries before choosing the next import source.',
    'status' => $plan['status'],
