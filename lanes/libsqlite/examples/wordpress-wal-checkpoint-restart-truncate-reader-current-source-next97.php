...
$plan = $wal->checkpointRestartTruncateReaderCurrentSourceNext97(
    $databaseBytes,
    $walBytes,
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-wal-checkpoint-restart-truncate-reader-current-source-next97 self-test passed\n";
    return;
}
