...
$plan = SQLiteEncodingCollationAffinityLikeCurrentSourceNextPlan::optionRowNameNumericAffinityLikePlan($current, $next);
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-option-name-numeric-like-current-source-next257 self-test passed\n";
    return;
}
