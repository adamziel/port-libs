...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNextPlan::executeCurrentSourceWatermarkDrain(
    ...
    [
        ...
        'current_generation' => 'app-current-returning-209',
        'next_generation' => 'app-next-returning-209',
        'page_size' => 3,
        'admit_next_source' => true,
        'current_source_token' => 'app.current.source.209',
        'drain_ack_token' => 'app.returning.drain.209',
...
if (
    ...
    || array_column($summary['visible_returning_payloads_next209'], 'name') !== ['app_summary_child', 'template_child', 'landing_url', 'next_module']
