...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next734-749 row-value UPDATE/DELETE RETURNING window current-source continuation after integrated next718-733 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next734-749 self-test passed\n";
    return;
}
