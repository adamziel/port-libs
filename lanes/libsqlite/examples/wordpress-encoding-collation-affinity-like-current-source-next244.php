...
$summary = [
    'scenario' => 'wordpress-encoding-collation-affinity-like-current-source-next244',
    'wordpressUse' => 'Copied wp_options migrations can resume mixed UTF-8/UTF-16 option_name LIKE scans while preserving SQLite ASCII-only NOCASE behavior for accented plugin slugs.',
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "wordpress-encoding-collation-affinity-like-current-source-next244 self-test passed\n";
}
