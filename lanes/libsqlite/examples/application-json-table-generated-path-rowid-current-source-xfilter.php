...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next176',
    'applicationUse' => 'Copied wp_options JSON rule previews can keep a generated-path and rowid xFilter pinned to the current json_tree source while a next import reprepare blocks stale row output.',
...
if (PHP_SAPI === 'cli' && realpath($_SERVER['SCRIPT_FILENAME'] ?? '') === __FILE__) {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next176 self-test passed\n";
}
