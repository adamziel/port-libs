...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through recursive INSTEAD OF view triggers keep current-source RETURNING rows immutable when a reparsed next-source cursor would yield duplicate option_name rows.',
    'status' => $plan['status'],
