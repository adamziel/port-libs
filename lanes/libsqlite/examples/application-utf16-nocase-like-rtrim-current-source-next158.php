...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::optionRowNameSourceDeltaPlan(
    $currentRows,
    $nextRows,
    'plugin!_%',
    '!',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application utf16 nocase like rtrim current source next158 smoke passed\n";
    exit(0);
}
