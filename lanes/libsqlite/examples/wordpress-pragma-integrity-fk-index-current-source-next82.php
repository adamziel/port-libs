...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-integrity-fk-index-current-source-next82 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-integrity-fk-index-current-source-next82 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress foreign_key_check current-source schema resolution',
