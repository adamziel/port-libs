...
require_once __DIR__ . '/../src/SQLitePlannerStat4ExpressionPartialCurrentSourceNext187Plan.php';
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext187Plan::materialize(
    $prepared,
    $current,
    [
