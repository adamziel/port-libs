...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-VDBE virtual table opcode branch handoff',
    'epoch' => 686,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 686, 0])),
    'publication_generation' => 686,
    'master_source_digest' => hash('sha256', 'wordpress VDBE virtual table opcode branch handoff master source'),
