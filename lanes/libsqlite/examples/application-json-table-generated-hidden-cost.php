...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options plugin settings can re-cost json_tree() hidden-source scans when generated priority/enabled columns filter nested JSON rules between current and next source rows.',
];
