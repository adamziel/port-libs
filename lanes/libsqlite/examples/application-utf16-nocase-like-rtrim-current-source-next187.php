...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::keyValueRowKeyDanglingEscapePlan($current, $next);
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-utf16-nocase-like-rtrim-current-source-next187 self-test passed\n";
