...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafApplyPageFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next210',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, the next writer applies pointer-map current-source pages before payload pages and keeps truncated tails fenced.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next210 self-test passed\n";
}
