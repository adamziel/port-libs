...
$root = sys_get_temp_dir() . '/port-libsqlite-wordpress-vfs-locked-writer-' . bin2hex(random_bytes(4));
...
echo json_encode([
    'scenario' => 'wordpress-vfs-locked-writer-apply',
    'wordpressUse' => 'Apply copied wp_options database writes only after an exclusive SQLite VFS process lock is held, then release the lock after durable file and directory sync diagnostics without requiring ext/sqlite.',
    'root' => $root,
