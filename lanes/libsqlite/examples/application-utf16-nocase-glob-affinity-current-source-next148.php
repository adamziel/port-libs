...
$plan = SQLiteUtf16NocaseGlobAffinityCurrentSourceNextPlan::optionRowNameGlobPlan(
    $current,
    $next,
    $argv[1] ?? 'plugin_cache*',
    'main.wp_options@147',
...
echo json_encode([
    'applicationUse' => 'Preview a UTF-16 wp_options NOCASE index cursor for GLOB while preserving SQLite case-sensitive GLOB residual matching after TEXT affinity.',
