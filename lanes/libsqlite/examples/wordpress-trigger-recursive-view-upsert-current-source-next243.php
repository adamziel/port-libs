...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNextPlan::executeNext243(
    [
...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-upsert-current-source-next243 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-upsert-current-source-next243 self-test passed\n";
