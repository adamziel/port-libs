...
$plan = SQLiteJsonTablePlan::currentSourceHiddenGeneratedCostNext148(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    'scenario' => 'wordpress-json-table-hidden-generated-cost-current-source-next148',
    ...
    'replanReasons' => $plan['next148ReplanReasons'],
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-hidden-generated-cost-current-source-next148 self-test passed\n";
    return;
}
