...
echo json_encode([
    'scenario' => 'wordpress-select-sql-json-negative-path',
    'wordpressUse' => 'Local-only wp_options diagnostics can execute SQLite SELECT text with json_extract/jsonb_extract reverse array paths such as $.rules[#-1] in projection, WHERE, JOIN, and ORDER BY clauses without requiring ext/sqlite.',
    'sql' => $sql,
    'rows' => $rows,
