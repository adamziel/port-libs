...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext250Plan;
...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext250Plan::compare($sql, $current, $next);
