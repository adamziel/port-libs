...
echo json_encode([
    'scenario' => 'wordpress-index-partial-covering-corpus',
    'mode' => $mode,
    ...
    'wordpressUse' => 'Preview copied wp_options planner choices for partial expression indexes that also cover projected columns, avoiding table b-tree fetches for option-name, transient, and schema-version probes without ext/sqlite.',
