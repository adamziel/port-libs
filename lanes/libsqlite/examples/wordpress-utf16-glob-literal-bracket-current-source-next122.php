...
if (($argv[1] ?? null) === '--self-test') {
    ...
    if ($actual !== $expected) {
        fwrite(STDERR, "wordpress-utf16-glob-literal-bracket-current-source-next122 self-test failed\n");
        fwrite(STDERR, var_export($actual, true) . "\n");
        exit(1);
    }

    echo "wordpress-utf16-glob-literal-bracket-current-source-next122 self-test passed\n";
    exit(0);
}
