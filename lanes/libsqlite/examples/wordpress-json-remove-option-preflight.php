...
echo json_encode([
    ...
    'jsonAfter' => $removed,
    'wordpressUse' => 'Local-only wp_options option_value cleanup that mirrors SQLite json_remove() text-result behavior for copied JSON, JSON5, or JSONB option fixtures before import.',
