...
$summary = [
    'scenario' => 'wordpress-schema-alter-view-trigger-generated-current-source-next128',
    'wordpressUse' => 'Preview copied WordPress ALTER TABLE ADD generated-column migrations where dependent views/triggers must be reparsed from the current sqlite_schema source, especially SELECT * view/trigger bodies whose expanded columns change after the generated column is admitted.',
    'schemaCookie' => [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-schema-alter-view-trigger-generated-current-source-next128 self-test passed\n";
    return;
}
