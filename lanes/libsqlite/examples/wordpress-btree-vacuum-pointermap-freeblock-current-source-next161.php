...
require_once __DIR__ . '/../src/SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext161Plan.php';

use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext161Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext161Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
