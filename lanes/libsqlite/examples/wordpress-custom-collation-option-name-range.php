...
if ($databasePath === null || ($lowerInclusive === null && $upperBound === null)) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-custom-collation-option-name-range.php path/to/wordpress.sqlite [lower|null] [upper|null] [WPSLUG|WPCASE|BACKWARDS] [--inclusive]\n");
    exit(1);
}
...
$options = $database->wordpressOptionsByIndexedNameRangeWithCollation(
    $lowerInclusive,
    $upperBound,
    $collationName,
