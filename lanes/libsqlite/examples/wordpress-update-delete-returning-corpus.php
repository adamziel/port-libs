...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options UPDATE/DELETE RETURNING rows after bounded mutation selection, preserving old DELETE values, new UPDATE assignment values, aliases, and computed RETURNING columns without requiring ext/sqlite.',
