...
$payload = [
    'wordpressUse' => 'Preview copied wp_options INSERT ... ON CONFLICT clauses with RETURNING where the first matching conflict target wins, DO NOTHING omits RETURNING rows, and a catch-all arm handles another current UNIQUE conflict without ext/sqlite.',
