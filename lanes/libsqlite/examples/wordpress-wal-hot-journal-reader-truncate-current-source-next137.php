...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-reader-truncate-current-source-next137',
    'wordpressUse' => 'After a copied wp_options import recovers a hot rollback journal, native PHP WAL handling feeds the recovered database image into a truncate checkpoint while the current reader remains pinned and the next writer starts a fresh WAL generation.',
    'status' => $plan['status'],
