...
$result = [
    'wordpressUse' => 'Preview copied wp_options aggregate summaries using SQLite group_concat(DISTINCT value ORDER BY key) FILTER (WHERE predicate) semantics, including first-duplicate order-key retention and SQL truthiness, without requiring ext/sqlite.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "PASS wordpress aggregate filter order distinct edge\n";
    exit(0);
}
