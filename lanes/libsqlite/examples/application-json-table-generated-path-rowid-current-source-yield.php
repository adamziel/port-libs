...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next168',
    'applicationUse' => 'Copied wp_options JSON rule diagnostics can yield a pinned json_tree current-source rowid batch with a stable resume token while forcing reprepare when the next imported option changes generated path coverage.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next168 self-test passed\n";
    return;
}
