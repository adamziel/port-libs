...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the prepared current-source ready seal row-value UPDATE/DELETE RETURNING window current-source handoff as receipt, ledger, retry-window, and final seal metadata.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-ready-seal self-test passed\n";
    return;
}
