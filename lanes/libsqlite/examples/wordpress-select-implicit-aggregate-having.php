...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options aggregate preflight checks that use SQLite implicit single-group HAVING without GROUP BY, including empty import-marker detection.',
