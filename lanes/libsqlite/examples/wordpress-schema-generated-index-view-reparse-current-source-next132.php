...
$summary = [
    'scenario' => 'wordpress-schema-generated-index-view-reparse-current-source-next132',
    'wordpressUse' => 'Copied wp_options export views that force a generated-column expression index are marked as current-source reparse points before WordPress import diagnostics resume stale prepared statements.',
    'status' => $plan['status'],
...
if (PHP_SAPI === 'cli' && in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "wordpress-schema-generated-index-view-reparse-current-source-next132 self-test failed\n");
        exit(1);
    }

    echo "wordpress-schema-generated-index-view-reparse-current-source-next132 self-test passed\n";
    exit(0);
}
