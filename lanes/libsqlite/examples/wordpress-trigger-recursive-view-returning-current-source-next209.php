...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNextPlan::executeNext209(
    [
...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-next209 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-current-source-next209 self-test passed\n";
