...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializeStat4SamplePartialPredicateFence(
    $prepared,
    $source,
    $where,
...
printf(
    "application sqlplanner stat4 expression partial current-source next228: %s samples=%d rowids=%s signature=%s\n",
    $plan['status'],
