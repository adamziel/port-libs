...
echo json_encode([
    'scenario' => 'wordpress-recursive-trigger-conflict-rollback',
    'wordpressUse' => 'Preview copied wp_options plugin imports where a recursive trigger UNIQUE conflict uses SQLite OR ROLLBACK semantics to restore the pre-transaction image instead of keeping prestatement rows, without requiring ext/sqlite.',
