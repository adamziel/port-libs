...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafCommitReceiptAuditFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-commit-receipt',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient and partially vacuuming tail pages, the next writer has commit receipts for only readable pointer-map, freeblock, and replacement overflow pages.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-commit-receipt self-test passed\n";
}
