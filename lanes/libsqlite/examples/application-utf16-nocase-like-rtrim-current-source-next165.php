...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::optionRowNameResumePlan(
    [
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-utf16-nocase-like-rtrim-current-source-next165 self-test passed\n";
    return;
}
