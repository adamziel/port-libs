...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext466481Plan.php';
...
$plan = SQLiteVfsCurrentSourceNext466481Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next466-481 self-test passed\n";
    return;
}
