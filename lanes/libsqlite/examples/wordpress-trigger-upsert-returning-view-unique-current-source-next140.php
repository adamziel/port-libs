...
$summary = [
    'scenario' => 'wordpress-trigger-upsert-returning-view-unique-current-source-next140',
    'wordpressUse' => 'Preview a copied wp_options import routed through an INSTEAD OF view trigger, where secondary UNIQUE option_id conflicts roll back previously yielded UPSERT RETURNING rows.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-trigger-upsert-returning-view-unique-current-source-next140 self-test passed\n";
    return;
}
