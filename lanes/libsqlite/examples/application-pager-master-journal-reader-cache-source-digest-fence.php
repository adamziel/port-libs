...
$sourceDigest = hash('sha256', 'application-next168-master-current-source');
$generation = 6;
...
if ($plan['retained_cache_page_numbers'] !== [1] || $plan['refreshed_cache_page_numbers'] !== [2]) {
    throw new RuntimeException('Retained/refreshed Application cache pages changed unexpectedly');
}
...
echo "application-pager-master-journal-reader-cache-current-source-next168 self-test passed\n";
