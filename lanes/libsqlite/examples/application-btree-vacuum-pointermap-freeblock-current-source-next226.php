...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafPublishWindowFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next226',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and verifying readback, publish only fenced pointer-map/freeblock pages before payload pages.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next226 self-test passed\n";
}
