...
$result = [
    'scenario' => 'wordpress-json-aggregate-default-window-current-source-next100',
    'wordpressUse' => 'Copied wp_options diagnostics can use SQLite default JSON aggregate window frames without spelling ROWS/RANGE clauses, preserving DISTINCT, FILTER, and aggregate-local ORDER BY for import summaries.',
    'sqlShape' => $sql,
    'windows' => array_map(
