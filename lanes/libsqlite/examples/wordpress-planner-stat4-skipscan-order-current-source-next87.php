...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-planner-stat4-skipscan-order-current-source-next87 self-test passed\n";
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-planner-stat4-skipscan-order-current-source-next87',
    ...
    'detail' => $plan['detail'],
    'wordpressUse' => 'Copied wp_options plugin scans must abandon stale STAT4 skip-scan ORDER plans after ANALYZE/schema-cookie changes and replan against the current source before import cleanup queries run.',
