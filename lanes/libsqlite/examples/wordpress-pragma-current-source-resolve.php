...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options PRAGMA schema introspection using SQLite current-source resolution so temp import tables shadow main tables while attached site metadata remains discoverable without ext/sqlite.',
