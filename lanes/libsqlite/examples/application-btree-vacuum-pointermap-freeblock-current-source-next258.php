...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafReusableHandoffFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next258',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, fence stale current-source freeblock slots before the next-source cursor consumes reusable overflow pages.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next258 self-test passed\n";
}
