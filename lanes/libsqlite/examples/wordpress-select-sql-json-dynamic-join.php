...
echo json_encode([
    'scenario' => 'wordpress-select-sql-json-dynamic-join',
    'wordpressUse' => 'Local-only wp_options diagnostics can join each copied option row to json_tree/json_each using that row option_value as the JSON argument, preserving INNER, LEFT, nested LEFT JOIN, rowid-alias NULL-extension, ORDER BY, and NULL-extension behavior without requiring ext/sqlite.',
