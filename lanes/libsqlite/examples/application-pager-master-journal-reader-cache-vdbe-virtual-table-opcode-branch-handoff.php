...
$base = [
    'source_id' => 'application-pager-reader-cache-VDBE virtual table opcode branch handoff',
    'epoch' => 686,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 686, 0])),
    'publication_generation' => 686,
    'master_source_digest' => hash('sha256', 'application VDBE virtual table opcode branch handoff master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeVirtualTableOpcodeBranchHandoff(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
echo json_encode([
    ...
    'vdbe_virtual_table_opcode_branch_handoff_invalidated_pages' => $plan['reader_cache_stmt_vdbe_opcode_trace_branch_handoff_invalidated_cache_page_numbers'],
