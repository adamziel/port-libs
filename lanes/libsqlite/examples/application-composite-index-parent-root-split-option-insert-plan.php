...
echo json_encode([
    'applicationUse' => 'Plan a generated wp_options insert that splits a full composite autoload, option_name leaf and grows a full index-interior root, without the SQLite extension.',
    'plan' => $plan->toArray(),
    ...
    'insertedOption' => $postDatabase->optionRowByIndexedAutoloadAndName('yes', $optionName)?->toArray(),
