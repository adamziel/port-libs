...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-generation-depth-fence self-test failed\n");
    exit(1);
}

if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    echo "wordpress-trigger-recursive-view-returning-current-source-generation-depth-fence self-test passed\n";
}

return [
    'scenario' => 'wordpress-trigger-recursive-view-returning-current-source-generation-depth-fence',
