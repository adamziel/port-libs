...
$summary = [
    'scenario' => 'wordpress-rowvalue-update-delete-returning-savepoint-current-source-next171',
    'wordpressUse' => 'Copied wp_options cleanup/import SQL can use OR-composed row-value predicates for UPDATE/DELETE RETURNING while a savepoint current source advances through the yielded rows without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-rowvalue-update-delete-returning-savepoint-current-source-next171 self-test passed\n";
    return;
}
