...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next654-669 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next638-653 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next654-669 self-test passed\n";
    return;
}
