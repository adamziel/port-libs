...
echo json_encode([
    'scenario' => 'wordpress-wal-checkpoint-transaction',
    'wordpressUse' => 'Plan copied wp_options WAL checkpoint admission with SQLite lock escalation before applying durable VFS writes, so import and repair tooling can distinguish restart/truncate-ready checkpoints from reader-blocked busy outcomes without ext/sqlite.',
    'ready' => [
        'status' => $ready['status'],
        'mode' => $ready['mode'],
