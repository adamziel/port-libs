...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext221Plan::wordpressOptionNamePreparedByteSignaturePlan(
    $rows,
    $rows,
...
$payload = [
    ...
    'wordpressUse' => 'Copied wp_options scanners must fence current-source cursor reuse when a prepared UTF-16 LIKE pattern decodes to the same SQL text but carries different endian byte metadata.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next221 self-test passed\n";
    return;
}
