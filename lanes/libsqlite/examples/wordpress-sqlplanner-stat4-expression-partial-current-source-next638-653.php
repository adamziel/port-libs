...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext638653(
    $prepared,
    $current,
    [
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-sqlplanner-stat4-expression-partial-current-source-next638-653 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-source-next638-653',
    'wordpressUse' => 'Copied wp_options plugin-admin pagination carries the next622-637 current-source STAT4 handoff into next638-653 only when projected current rows still match.',
    'status' => $plan['status'],
