...
$output = [
    'scenario' => 'application-rowvalue-parenthesized-savepoint-current-source-next202',
    'applicationUse' => 'Executes generated Application wp_options cleanup SQL whose row-value predicates and RETURNING expressions are wrapped in extra parentheses, then rolls back the attempted batch and retries from the savepoint image.',
    'status' => $plan['status'],
