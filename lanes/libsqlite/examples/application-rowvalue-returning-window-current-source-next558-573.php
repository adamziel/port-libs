...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next558-573 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next542-557 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next558-573 self-test passed\n";
    return;
}
