...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-complete-master-read',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'A copied wp_options rollback reader rejects an active_plugins page cached from a prefix master-journal read before the attached metadata journal member was visible.',
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next187'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-complete-master-read self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-complete-master-read self-test passed\n";
