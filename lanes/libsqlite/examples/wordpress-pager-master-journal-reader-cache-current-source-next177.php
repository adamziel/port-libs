...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options reads after master-journal recovery fence reader-cache reuse with the recovered page-1 header change-counter/schema-cookie/freelist ticket before serving cached option pages.',
