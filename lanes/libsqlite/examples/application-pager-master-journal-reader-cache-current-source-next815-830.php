...
$base = [
    'source_id' => 'application-pager-reader-cache-next830',
    'epoch' => 830,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 830, 0])),
    'publication_generation' => 830,
    'master_source_digest' => hash('sha256', 'application next830 master source'),
...
$read = array_merge($base, [
    ...
    'reader_cache_stmt_vdbe_ge_branch_condition_handoff_token' => 'stmt-vdbe-ge-branch-condition-handoff-old',
]);
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeAffinityConditionBranchHandoff(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
echo json_encode([
    ...
    'next830_reopen_reason' => $plan['next_reads'][0]['reader_cache_stmt_vdbe_ge_branch_condition_handoff_token_reason'],
