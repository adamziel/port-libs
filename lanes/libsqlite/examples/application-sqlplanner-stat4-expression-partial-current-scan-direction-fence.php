...
$source = [
    'name' => 'wp-options-current-next252',
    'schemaCookie' => 2528,
    'stat4Generation' => 852,
    'rows' => $rows,
    'indexes' => [[
...
$prepared = $source;
$prepared['name'] = 'wp-options-prepared-next252';
$prepared['schemaCookie'] = 2520;
$prepared['stat4Generation'] = 252;
...
if (($argv[1] ?? null) === '--self-test' && $plan['status'] !== 'stat4-expression-partial-current-source-next252-ready') {
    throw new RuntimeException('Expected next252 STAT4 scan-direction fence to be ready');
}

printf(
    "application sqlplanner stat4 expression partial current scan-direction fence: %s anchors=%s signature=%s\n",
    $plan['status'],
