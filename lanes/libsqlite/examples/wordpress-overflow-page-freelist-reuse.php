...
$option = $database->wordpressOptions()[0] ?? null;
...
echo json_encode([
    'wordpressUse' => 'Assemble a wp_options overflow value on non-contiguous reusable pages while respecting SQLite reserved bytes, then parse it back without the SQLite extension.',
