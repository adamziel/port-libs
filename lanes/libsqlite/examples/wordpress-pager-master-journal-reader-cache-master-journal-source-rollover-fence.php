...
$summary = [
    ...
    'wordpressUse' => 'A copied WordPress SQLite database must reopen schema/rewrite readers when a second master-journal source supersedes the current source, even if a page image still matches; only cache entries ticketed to the next source may be reused.',
