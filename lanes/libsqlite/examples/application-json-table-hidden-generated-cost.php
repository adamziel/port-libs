...
$summary = [
    'scenario' => 'application-json-table-hidden-generated-cost',
    'applicationUse' => 'Copied wp_options plugin-setting previews can keep json_tree hidden path/rowid constraints and generated JSON filters costed as a single xBestIndex-style seek while the next import mutates generated values.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-hidden-generated-cost self-test passed\n";
    return;
}
