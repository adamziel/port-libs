...
echo json_encode([
    ...
    'wordpressUse' => 'Stream UNIQUE autoindex integrity rows with current/next root-page cursor metadata and auto-vacuum pointer-map root ownership during WordPress SQLite import preflight without ext/sqlite.',
