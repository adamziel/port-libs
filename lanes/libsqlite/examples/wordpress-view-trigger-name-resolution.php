...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied WordPress sqlite_schema import checks that resolve INSTEAD OF triggers against autoloaded-option view output columns before replaying trigger bodies without requiring ext/sqlite.',
