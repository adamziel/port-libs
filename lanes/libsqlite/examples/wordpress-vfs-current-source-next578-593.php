...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext578593Plan.php';
...
$plan = SQLiteVfsCurrentSourceNext578593Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next578-593 self-test passed\n";
    return;
}
