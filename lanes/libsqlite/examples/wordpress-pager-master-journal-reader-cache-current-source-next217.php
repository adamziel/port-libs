...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext217Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext217Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
