...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext143Plan;

$plan = SQLiteTriggerRecursiveViewReturningCurrentSourceNext143Plan::insertThroughViewSources(
