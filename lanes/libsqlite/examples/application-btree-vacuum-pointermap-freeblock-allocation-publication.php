...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-allocation-publication',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, publish next-source freeblock allocations only after pointer-map cursor epochs and leaf receipts carry forward.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-allocation-publication self-test passed\n";
}
