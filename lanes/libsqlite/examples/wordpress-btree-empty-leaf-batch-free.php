...
echo json_encode([
    'wordpressUse' => 'Delete the last copied wp_options transient row and its option_name index entry, then batch-release both emptied leaves and obsolete overflow pages into the existing freelist with auto-vacuum pointer-map updates.',
