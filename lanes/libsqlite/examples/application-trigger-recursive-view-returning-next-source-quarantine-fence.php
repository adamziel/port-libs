...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through an INSTEAD OF recursive view trigger keep RETURNING rows tied to the current view-source and trigger-source generation before queued next-source rows are visible.',
