...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafHandoffCursorFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next234',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, open the current-source freeblock cursor only after pointer-map handoff rows are visible and before overflow payload reuse.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next234 self-test passed\n";
}
