...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext217Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext217Plan::execute(
    [
