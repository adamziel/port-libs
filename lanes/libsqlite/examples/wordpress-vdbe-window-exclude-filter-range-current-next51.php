...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options import rows through VDBE-style RANGE current-next yields, exposing raw frame rows, EXCLUDE removals, and FILTER-selected aggregate rows without ext/sqlite.',
    'rows' => $summary,
