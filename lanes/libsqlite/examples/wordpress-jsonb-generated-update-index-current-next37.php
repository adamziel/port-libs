...
echo json_encode([
    'scenario' => 'wordpress-jsonb-generated-update-index-current-next37',
    'wordpressUse' => 'Preview copied wp_options UPDATE statements that mutate JSONB option_value data feeding generated columns, producing current index deletes and next index inserts without requiring ext/sqlite.',
