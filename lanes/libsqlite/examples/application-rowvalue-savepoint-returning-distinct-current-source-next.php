...
echo "application-rowvalue-savepoint-returning-distinct-current-source-next self-test passed\n";

return [
    'scenario' => 'application-rowvalue-savepoint-returning-distinct-current-source-next',
    'applicationUse' => 'Copied wp_options import cleanup can use row-value IS DISTINCT FROM / IS NOT DISTINCT FROM predicates, yield de-duplicated RETURNING stream diagnostics, roll back attempted inner savepoint rows, and retry from the restored current source without ext/sqlite.',
