...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "wordpress-trigger-recursive-view-returning-current-source-next188 self-test passed\n";
}

return [
    'scenario' => 'wordpress-trigger-recursive-view-returning-current-source-next188',
    'wordpressUse' => 'Copied wp_options imports through recursive INSTEAD OF view triggers can acknowledge every current-source RETURNING row ordinal before exposing next-source rows from a changed view/trigger definition.',
