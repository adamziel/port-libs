...
require_once dirname(__DIR__) . '/src/SQLiteTriggerRecursiveViewReturningCurrentSourceNext213Plan.php';

use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext213Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext213Plan::execute(
    [
...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-next213 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-current-source-next213 self-test passed\n";
