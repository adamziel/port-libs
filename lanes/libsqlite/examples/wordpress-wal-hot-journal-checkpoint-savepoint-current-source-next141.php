...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-checkpoint-savepoint-current-source-next141',
    'wordpressUse' => 'A copied wp_options import recovers a hot rollback journal, rolls back an inner savepoint, keeps the current reader pinned through checkpoint, and opens the next writer on a separate WAL source.',
    'status' => $plan['status'],
