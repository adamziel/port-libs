...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-compound-select-window-recursive-limit-current-source-next211 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-compound-select-window-recursive-limit-current-source-next211',
