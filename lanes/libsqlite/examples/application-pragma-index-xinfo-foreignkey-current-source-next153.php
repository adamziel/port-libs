...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-pragma-index-xinfo-foreignkey-current-source-next153 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'copied wp_options PRAGMA index_xinfo plus foreign_key_check current-source next153',
    'applicationUse' => 'Resume a copied wp_options import only after unique option-name index metadata remains stable and foreign-key violations are cleared in the next database image.',
