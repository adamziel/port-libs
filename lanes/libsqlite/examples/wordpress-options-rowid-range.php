...
if ($databasePath === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-options-rowid-range.php path/to/wordpress.sqlite [lower|-] [upper|-] [limit] [upper_inclusive]\n");
    exit(1);
}
...
$options = array_map(
    ...
    $database->wordpressOptionsByRowIdRange($lowerInclusive, $upperBound, $limit, $upperInclusive),
);
