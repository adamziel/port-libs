...
require_once __DIR__ . '/../src/SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext184Plan.php';
...
$plan = SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext184Plan::plan(
    $reopen,
    $currentWal,
    $currentWalBytes,
    $nextWal,
