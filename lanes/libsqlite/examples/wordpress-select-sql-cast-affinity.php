...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options option_value comparisons where parser-level CAST() controls SQLite storage-class comparison and numeric affinity without requiring ext/sqlite.',
