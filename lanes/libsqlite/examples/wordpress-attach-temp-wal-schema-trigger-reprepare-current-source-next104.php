...
$plan = SQLiteAttachTempWalSchemaTriggerPlan::currentSourceNext104(
    $current,
    $next,
    [
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-attach-temp-wal-schema-trigger-reprepare-current-source-next104 self-test passed\n";
    return;
}
