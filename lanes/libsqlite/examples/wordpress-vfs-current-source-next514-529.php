...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext514529Plan.php';
...
$plan = SQLiteVfsCurrentSourceNext514529Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next514-529 self-test passed\n";
    return;
}
