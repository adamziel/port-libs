...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext205Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext205Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
