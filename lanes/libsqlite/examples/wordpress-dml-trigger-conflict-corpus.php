...
echo json_encode([
    'wordpressUse' => 'Preview wp_options import triggers where the outer INSERT OR REPLACE conflict policy controls side-table trigger conflicts without requiring ext/sqlite.',
