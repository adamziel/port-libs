...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafBatchCursorFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next174',
    'status' => $summary['status'],
    'readable_cursor_pages' => $summary['readable_cursor_pages'],
    'fenced_cursor_pages' => $summary['fenced_cursor_pages'],
    'resume_token_count' => count($summary['resume_tokens']),
    'final_database_page_count' => $summary['final_database_page_count'],
], JSON_PRETTY_PRINT) . PHP_EOL;

if ($summary['readable_cursor_pages'] === [1, 3, 105, 106, 107, 108] && $summary['fenced_cursor_pages'] === [109, 110]) {
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next174 self-test passed\n";
}
