...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext418433Plan.php';
...
$plan = SQLiteVfsCurrentSourceNext418433Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next418-433 self-test passed\n";
    return;
}
