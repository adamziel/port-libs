...
$summary = [
    'scenario' => 'application-pragma-index-xinfo-foreignkey-current-source-next252-255',
    'applicationUse' => 'Application taxonomy import checks can keep missing child columns, generated child SET actions, nullable parent UNIQUE keys, and PRAGMA next255 availability visible.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "application-pragma-index-xinfo-foreignkey-current-source-next252-255 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "application-pragma-index-xinfo-foreignkey-current-source-next252-255 self-test passed\n");
    exit(0);
}
