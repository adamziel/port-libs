...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options generated-column schemas whose CASE expressions derive cache routing columns, preserving dependency order and UNIQUE autoindex metadata without requiring ext/sqlite.',
