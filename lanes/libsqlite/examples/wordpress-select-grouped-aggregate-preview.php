...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows through bounded SQLite SELECT multi-column GROUP BY/HAVING aggregate dispatch with projected summary columns before import diagnostics, without requiring ext/sqlite.',
