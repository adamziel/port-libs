...
$summary = [
    'scenario' => 'wordpress-rowvalue-compound-subquery-savepoint-current-source',
    'status' => $plan['status'],
...
if (in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "wordpress-rowvalue-compound-subquery-savepoint-current-source self-test failed\n");
        exit(1);
    }
    fwrite(STDOUT, "wordpress-rowvalue-compound-subquery-savepoint-current-source self-test passed\n");
    exit(0);
}
