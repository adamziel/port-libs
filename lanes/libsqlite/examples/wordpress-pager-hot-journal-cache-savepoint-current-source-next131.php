...
use PortLibs\LibSqlite\SQLitePagerHotJournalCacheSavepointCurrentSourceNext131Plan;
...
$plan = SQLitePagerHotJournalCacheSavepointCurrentSourceNext131Plan::currentSourceNext(
    $pageSize,
    'wp_import',
    'plugin_settings',
