...
echo json_encode([
    'scenario' => 'wordpress-vdbe-window-peer-range-current-next',
    'wordpressUse' => 'Evaluate copied wp_options import diagnostics through VDBE-style RANGE CURRENT ROW AND N FOLLOWING aggregate frames, preserving peer groups for equal option payload sizes and applying SQL FILTER truthiness without requiring ext/sqlite.',
    'frameUnit' => 'RANGE',
