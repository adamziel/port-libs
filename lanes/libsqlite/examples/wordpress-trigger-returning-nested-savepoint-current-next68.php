...
require_once __DIR__ . '/../src/SQLiteTriggerReturningNestedSavepointCurrentNext68Plan.php';

use PortLibs\LibSqlite\SQLiteTriggerReturningNestedSavepointCurrentNext68Plan;
...
$plan = SQLiteTriggerReturningNestedSavepointCurrentNext68Plan::apply(
    'wp_import_outer',
