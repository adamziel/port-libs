...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next414-429 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next398-413 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next414-429 self-test passed\n";
    return;
}
