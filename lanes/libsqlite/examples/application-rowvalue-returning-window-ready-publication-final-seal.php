...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the final row-value UPDATE/DELETE RETURNING window current-source publication seal after the prior ready handoff.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-ready-publication-final-seal self-test passed\n";
    return;
}
