...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext205(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next205',
    'wordpressUse' => 'Copied wp_options JSON diagnostics can satisfy ORDER BY _rowid_ from the pinned generated-path rowid xColumn cache without running a temp sorter.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next205 self-test passed\n";
    return;
}
