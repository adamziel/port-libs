...
$pluginPlan = SQLiteEncodingLikeGlobSourceSwitchPlan::wordpressOptionNameSourceSwitch(
    $currentRows,
    $nextRows,
    'plugin%',
    'LIKE',
...
$literalPercentPlan = SQLiteEncodingLikeGlobSourceSwitchPlan::wordpressOptionNameSourceSwitch(
    $currentRows,
    $nextRows,
    'plugin\_100\%%',
    'LIKE',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-option-name-source-switch-current-next86 self-test passed\n";
    return;
}
