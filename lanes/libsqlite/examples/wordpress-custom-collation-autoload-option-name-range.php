...
if ($databasePath === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-custom-collation-autoload-option-name-range.php path/to/wordpress.sqlite [autoload] [lower|null] [upper|null] [WPSLUG|WPCASE|BACKWARDS] [limit] [--inclusive]\n");
    exit(1);
}
