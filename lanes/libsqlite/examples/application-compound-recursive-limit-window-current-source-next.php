...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-compound-recursive-limit-window-current-source-next self-test passed\n";
    exit(0);
}

echo json_encode([
    'applicationUse' => 'Preview copied wp_options dependency walks where a recursive CTE queue LIMIT feeds compound SELECT rows with CURRENT ROW/FOLLOWING window frames before final LIMIT/OFFSET.',
    'sql' => $sql,
