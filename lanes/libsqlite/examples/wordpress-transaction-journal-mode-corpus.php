...
echo json_encode([
    'scenario' => 'wordpress-transaction-journal-mode-corpus',
    'wordpressUse' => 'Plan copied wp_options rollback-journal transaction open/close, persistent-journal commit ordering, temp-journal delete-on-commit, and locking_mode preflight without ext/sqlite.',
    'lockingMode' => [
