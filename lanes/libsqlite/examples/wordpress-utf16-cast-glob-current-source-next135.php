...
$summary = [
    'scenario' => 'wordpress-utf16-cast-glob-current-source-next135',
    'wordpressUse' => 'Copied wp_options imports can compare UTF-16 option_value payloads with CAST(option_value AS TEXT) GLOB while preserving binary GLOB residuals, malformed-row diagnostics, and current/next source invalidation.',
    'range' => $plan['range'],
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-utf16-cast-glob-current-source-next135 self-test passed\n";
    return;
}
