...
$base = [
    'source_id' => 'application-pager-reader-cache-next958',
    'epoch' => 958,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 958, 0])),
    'publication_generation' => 958,
    'master_source_digest' => hash('sha256', 'application next958 master source'),
...
$read = array_merge($base, [
    ...
    'reader_cache_stmt_vdbe_remainder_branch_condition_handoff_token' => 'stmt-vdbe-remainder-branch-condition-handoff-old',
]);
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeLiteralArithmeticBranchConditionFence(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
echo json_encode([
    ...
    'next958_reopen_reason' => $plan['next_reads'][0]['reader_cache_stmt_vdbe_remainder_branch_condition_handoff_token_reason'],
