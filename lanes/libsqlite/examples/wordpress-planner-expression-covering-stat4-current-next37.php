...
$output = [
    'scenario' => 'wordpress-planner-expression-covering-stat4-current-next37',
    ...
    'wordpressUse' => 'Preview copied wp_options expression-covering planner choices with sqlite_stat4-style current/next samples, so native imports can rank skewed option_name lookups without ext/sqlite.',
];
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-planner-expression-covering-stat4-current-next37 self-test passed\n";
    exit(0);
}
