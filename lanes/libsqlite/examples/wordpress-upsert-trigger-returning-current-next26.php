...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options UPSERT RETURNING rows captured before AFTER-trigger target mutations while triggers maintain wp_optionmeta child keys without requiring ext/sqlite.',
