...
echo json_encode([
    'wordpressUse' => 'Replace a deleted overflow-backed wp_options transient with a smaller local cell in the same leaf freeblock while releasing obsolete overflow pages to the freelist.',
    'plan' => $plan->toArray(),
