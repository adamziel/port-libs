...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next590-605 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next574-589 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next590-605 self-test passed\n";
    return;
}
