...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafMaterializedReceiptFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next183',
    'status' => $summary['status'],
    'committed_page_images' => $summary['committed_page_images'],
    ...
    'committed_fenced_pages' => $summary['committed_fenced_pages'],
    'receipt_count' => $summary['receipt_count'],
], JSON_PRETTY_PRINT) . PHP_EOL;

if (
    $summary['committed_page_images'] === [1, 3, 105, 106, 107, 108]
    && $summary['committed_pointer_map_pages'] === [2, 105]
    && $summary['committed_leaf_freeblock_pages'] === [3]
    && $summary['committed_fenced_pages'] === []
) {
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next183 self-test passed\n";
}
