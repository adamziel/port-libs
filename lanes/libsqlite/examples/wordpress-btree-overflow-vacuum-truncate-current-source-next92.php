...
echo json_encode([
    'scenario' => 'copied wp_options overflow vacuum truncates through auto-vacuum pointer-map page current-source-next92',
    ...
    'current_source_next92' => $plan->overflowVacuumTruncateCurrentSourceNext92(),
