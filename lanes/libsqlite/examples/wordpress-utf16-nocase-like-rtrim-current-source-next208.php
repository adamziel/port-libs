...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext208Plan::wordpressOptionNamePreparedEscapePlan(
    $current,
    $next,
    'plugin!_cache%',
    $escape('!', 'UTF-16LE'),
...
$summary = [
    'scenario' => 'wordpress-utf16-nocase-like-rtrim-current-source-next208',
    'wordpressUse' => 'Copied wp_options imports can decode a prepared UTF-16 ESCAPE parameter before reusing an RTRIM/NOCASE LIKE cursor, avoiding stale range/residual behavior when the next source uses a BOM-prefixed escape byte string.',
    'status' => $plan['status'],
...
if (PHP_SAPI === 'cli' && realpath($_SERVER['SCRIPT_FILENAME'] ?? '') === __FILE__) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next208 self-test passed\n";
}
