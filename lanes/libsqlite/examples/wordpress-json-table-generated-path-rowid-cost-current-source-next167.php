...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext167(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next167',
    'wordpressUse' => 'Copied wp_options plugin-rule previews can bind generated path and rowid argv into a pinned json_tree() xFilter cursor, then force a fresh next-source filter when imported JSON changes.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next167 self-test passed\n";
    return;
}
