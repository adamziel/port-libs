...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext203(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next203',
...
if (($argv[1] ?? '') === '--self-test') {
    if ($payload['currentOpcode'] !== 'OP_JsonTableRowidAliasPointNext203') {
    ...
    if (($payload['currentProjectedColumns']['fullkey'] ?? null) !== '$.rules[2].slug') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next203 self-test passed\n";
    return;
}
