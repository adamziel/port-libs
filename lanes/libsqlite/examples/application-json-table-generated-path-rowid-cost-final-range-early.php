...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-final-range-early',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-final-range-early self-test passed\n";
    return;
}
