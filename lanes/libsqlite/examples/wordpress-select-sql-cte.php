...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows through bounded SQLite WITH CTE text execution, materializing hot options and ranked metadata before native join/order/limit dispatch without ext/sqlite.',
    'sql' => $sql,
