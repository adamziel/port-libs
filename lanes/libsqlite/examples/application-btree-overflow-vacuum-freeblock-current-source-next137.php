...
$plan = SQLiteBTreeOverflowVacuumFreeblockCurrentSourceNextPlan::fromDeleteResults(
    ...
    3,
    5,
    str_repeat('next137-application-overflow-vacuum-freeblock-', 24),
);

$summary = [
    'scenario' => 'application-btree-overflow-vacuum-freeblock-current-source-next137',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-btree-overflow-vacuum-freeblock-current-source-next137 self-test passed\n";
    return;
}
