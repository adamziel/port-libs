...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports can validate the prepared closure after-current row-value UPDATE/DELETE RETURNING handoff as closure receipts, DELETE guards, UPDATE fences, and final after-current readiness.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-closure-after-current self-test passed\n";
    return;
}
