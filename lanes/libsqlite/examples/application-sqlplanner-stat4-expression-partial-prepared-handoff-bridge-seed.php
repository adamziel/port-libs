...
$current = $prepared;
$current['name'] = 'current-wp-options-stat4-handoff-next334349';
$current['schemaCookie'] = 3348;
$current['stat4Generation'] = 902;
$current['indexes'][0]['rootPage'] = 33488;
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-prepared-handoff-bridge-seed self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-prepared-handoff-bridge-seed',
    'applicationUse' => 'Copied wp_options plugin-admin pagination carries the next318-333 current-source STAT4 handoff into next334-349 only when projected current rows still match.',
    'status' => $plan['status'],
    'selectedIndex' => $plan['selectedPlan']['name'] ?? null,
    'preparedSlices' => $plan['stat4Next334349PreparationFence']['preparedSlices'],
    'handoffSignature' => $plan['stat4Next334349PreparationFence']['handoffSignature'],
