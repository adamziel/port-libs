...
echo json_encode([
    'wordpressUse' => 'Merge an underfilled copied wp_options option_name index interior sibling while preserving an overflow-backed separator payload and retargeting auto-vacuum pointer-map ownership to the merged page.',
