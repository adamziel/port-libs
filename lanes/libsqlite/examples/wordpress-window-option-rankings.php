...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows with SQLite built-in window ranking and offset semantics for local import diagnostics without requiring the SQLite extension.',
