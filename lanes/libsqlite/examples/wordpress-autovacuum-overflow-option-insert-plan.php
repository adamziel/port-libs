...
$plan = $database->planWordPressOptionInsert(2, 'theme_mods_twentyfive', $largeThemeMods, 'yes');
...
echo json_encode([
    'wordpressUse' => 'Preflight a large wp_options theme_mods insert for an auto-vacuum SQLite database while updating pointer-map entries for the new overflow chain.',
    'plan' => [
