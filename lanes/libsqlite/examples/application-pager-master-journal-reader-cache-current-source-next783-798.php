...
$base = [
    'source_id' => 'application-pager-reader-cache-next798',
    'epoch' => 798,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 798, 0])),
    'publication_generation' => 798,
    'master_source_digest' => hash('sha256', 'application next798 master source'),
...
$read = array_merge($base, [
    ...
    'reader_cache_stmt_vdbe_real_affinity_value_branch_handoff_token' => 'stmt-vdbe-real-affinity-value-branch-handoff-old',
]);
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeValueArithmeticBranchHandoff(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
echo json_encode([
    ...
    'next798_reopen_reason' => $plan['next_reads'][0]['reader_cache_stmt_vdbe_real_affinity_value_branch_handoff_token_reason'],
