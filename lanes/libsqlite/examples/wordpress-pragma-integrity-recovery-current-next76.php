...
echo json_encode([
    'scenario' => 'wordpress-pragma-integrity-recovery-current-next76',
    'wordpressUse' => 'Gate a copied wp_options recovery handoff by comparing PRAGMA integrity_check diagnostics before and after the recovered database image. Recovery may resume only when no findings persist or appear in the next image.',
    'status' => $plan['status'],
