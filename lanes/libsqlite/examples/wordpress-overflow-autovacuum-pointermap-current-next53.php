...
echo json_encode([
    'scenario' => 'wordpress-overflow-autovacuum-pointermap-current-next53',
    'wordpressUse' => 'Allocate a copied wp_options overflow payload from a current freelist trunk and its next trunk while materializing auto-vacuum pointer-map ownership across both pointer-map pages without ext/sqlite.',
