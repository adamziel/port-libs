...
$base = [
    'source_id' => 'application-pager-reader-cache-next942',
    'epoch' => 942,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 942, 0])),
    'publication_generation' => 942,
    'master_source_digest' => hash('sha256', 'application next942 master source'),
...
$read = array_merge($base, [
    ...
    'reader_cache_stmt_vdbe_blob_branch_condition_handoff_token' => 'stmt-vdbe-blob-branch-condition-handoff-old',
]);
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeVirtualTableBranchConditionFence(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
echo json_encode([
    ...
    'next942_reopen_reason' => $plan['next_reads'][0]['reader_cache_stmt_vdbe_blob_branch_condition_handoff_token_reason'],
