...
$root = sys_get_temp_dir() . '/port-libsqlite-wordpress-wal-tx-recovery-' . bin2hex(random_bytes(4));
...
$result = [
    'scenario' => 'wordpress-wal-transaction-recovery-apply-current-next58',
    'wordpressUse' => 'Recover a copied wp_options WAL by checkpointing the last committed transaction prefix and truncating later draft frames before the next WordPress import reader opens the database.',
