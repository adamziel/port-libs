...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options rows through correlated EXISTS subqueries whose inner SELECT uses joins, preserving SQLite subquery truthiness without flattening the joined metadata source into the outer query and without requiring ext/sqlite.',
