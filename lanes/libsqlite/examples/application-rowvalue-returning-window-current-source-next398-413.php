...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the next398-413 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next382-397 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next398-413 self-test passed\n";
    return;
}
