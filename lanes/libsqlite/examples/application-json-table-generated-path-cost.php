...
echo json_encode([
    'scenario' => 'application-json-table-generated-path-cost',
    'planned' => [
    ...
    'applicationUse' => 'Copied wp_options rows with a generated JSON path column can feed json_tree() path-cost planning so migration previews detect when a generated path no longer covers the selected path after plugin settings are rewritten, without ext/sqlite.',
