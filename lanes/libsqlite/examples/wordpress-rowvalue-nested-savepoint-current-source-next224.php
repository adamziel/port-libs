...
require_once __DIR__ . '/../src/SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext224Plan.php';
...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext224Plan::execute(
    ['wp_options' => $rows],
    [
...
$summary = [
    'scenario' => 'wordpress-rowvalue-nested-savepoint-current-source-next224',
    'wordpressUse' => 'Copied wp_options imports can RELEASE an inner row-value UPDATE/DELETE RETURNING batch, roll back the outer savepoint after a later validation failure, suppress both inner and outer attempted RETURNING rows, and retry from the outer savepoint image.',
    'status' => $plan['status'],
