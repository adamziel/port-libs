...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next243 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next243',
    'applicationUse' => 'Copied wp_options plugin scans can reuse a current STAT4 partial expression index only after re-reading the current sqlite_stat4 sample tape, expanding duplicate expression keys, and rejecting stale prepared sample rowids.',
    'status' => $plan['status'],
