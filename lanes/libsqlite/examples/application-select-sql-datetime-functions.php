...
$summary = [
    'applicationUse' => 'Normalize copied wp_options plugin/transient timestamps with SQLite date/time scalar functions, including timezone suffixes, unixepoch input, and subsecond output without requiring ext/sqlite.',
    'sql' => $sql,
    'epochSql' => $epochSql,
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-select-sql-datetime-functions self-test passed\n";
    return;
}
