...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-compound-select-window-recursive-limit-current-source-next187 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-compound-select-window-recursive-limit-current-source-next187',
    'applicationUse' => 'Copied wp_options import previews can use a recursive CTE with SQLite LIMIT -1 OFFSET semantics, evaluate lag/lead windows before UNION distinct suppression, and let the final compound LIMIT choose the current/next source boundary.',
