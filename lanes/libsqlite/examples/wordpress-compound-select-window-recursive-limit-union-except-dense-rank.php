...
$payload = [
    'scenario' => 'wordpress-compound-select-window-recursive-limit-current-source-union-except-dense-rank-limit',
...
if (($payload['status'] ?? null) !== 'compound-select-window-recursive-limit-current-source-union-except-dense-rank-limit-ready') {
    fwrite(STDERR, "wordpress-compound-select-window-recursive-limit-current-source-union-except-dense-rank-limit self-test failed\n");
    exit(1);
}
if ($payload['tokenChanged'] !== true || $payload['nextLabels'] !== ['plugin_prime', 'seed:2:3:4', 'home']) {
    fwrite(STDERR, "wordpress-compound-select-window-recursive-limit-current-source-union-except-dense-rank-limit boundary guard failed\n");
    exit(1);
}
