...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext190Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext190Plan::execute(
    [
