...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-upsert-do-nothing-returning-current self-test passed\n";
    return;
}

echo json_encode([
    'wordpressUse' => 'Preview copied wp_options INSERT ... ON CONFLICT DO NOTHING RETURNING so idempotent imports can emit only newly admitted option rows without ext/sqlite.',
