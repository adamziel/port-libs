...
$plan = SQLiteJsonTablePlan::currentSourceNestedPathPlannerNext121(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options plugin settings can store a base JSON root and per-request nested path fragment; native JSON table planning composes the current and next roots before scanning json_tree() priority leaves.',
];
