...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next193',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, the published current-source manifest exposes only readable pointer-map/freeblock/overflow pages while fencing truncated tail pages.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next193 self-test passed\n";
}
