...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through recursive INSTEAD OF view triggers can acknowledge every current-source RETURNING row ordinal before exposing next-source rows from a changed view/trigger definition.',
