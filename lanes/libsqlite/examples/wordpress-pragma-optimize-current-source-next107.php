...
echo json_encode([
    ...
    'wordpressUse' => 'Copied WordPress SQLite databases can reuse PRAGMA optimize preflight metadata only while schema cookies, sqlite_stat1 cookies, and source ids match the current schema snapshot; stale rows are skipped instead of scheduling ANALYZE from obsolete catalog state.',
