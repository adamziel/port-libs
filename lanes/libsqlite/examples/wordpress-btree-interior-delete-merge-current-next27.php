...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options delete rebalancing where the current underfilled interior child merges with its next sibling, the parent divider is removed, the next page enters the freelist, and auto-vacuum pointer-map children move to the merged current page without ext/sqlite.',
