...
$summary = [
    'wordpressScenario' => 'Copied wp_options transient cleanup can choose a STAT4-estimated covering skip-scan when autoload is unconstrained, blog_id is constrained, and option_value is available from the index payload.',
...
if (in_array('--self-test', $argv, true)) {
    if (($summary['index'] !== 'idx_autoload_blog_name_value_stat4')
        ...
        fwrite(STDERR, "wordpress-planner-stat4-skipscan-covering-current-next48 self-test failed\n");
        exit(1);
    }

    echo "wordpress-planner-stat4-skipscan-covering-current-next48 self-test passed\n";
    exit(0);
}
