...
use PortLibs\LibSqlite\SQLiteTriggerUpsertSavepointCurrentNext73Plan;
...
$plan = SQLiteTriggerUpsertSavepointCurrentNext73Plan::execute(
    $rows,
    $incoming,
    ['option_name'],
    $assignments,
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-trigger-upsert-savepoint-current-next73 self-test passed\n";
    return;
}
