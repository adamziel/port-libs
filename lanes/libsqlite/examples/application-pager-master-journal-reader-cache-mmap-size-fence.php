...
$pageSize = 512;
$database = '/srv/wp-content/database/wp-options-mmap-size-fence.sqlite';
$usersDatabase = '/srv/wp-content/database/wp-users-mmap-size-fence.sqlite';
...
$formatPage = static function (string $label) use ($pageSize): string {
    ...
    $page = substr_replace($page, pack('N', 302), 60, 4);
...
$tokens = [$mainJournal => 'member-main-current-302', $usersJournal => 'member-users-current-302'];
$headers = [$mainJournal => hash('sha256', 'main header mmap-size-fence'), $usersJournal => hash('sha256', 'users header mmap-size-fence')];
$base = [
    'source_id' => 'application-pager-reader-cache-mmap-size-fence',
    'epoch' => 302,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 302, 0])),
    'publication_generation' => 302,
    'master_source_digest' => hash('sha256', 'application mmap-size-fence master source'),
    'recovery_sequence' => 302,
    'recovered_page_set_digest' => $recoveredDigest($recovered),
    'member_journal_tokens' => $tokens,
    'member_journal_header_digests' => $headers,
    'master_member_order_digest' => hash('sha256', implode("\n", array_keys($tokens))),
    'master_journal_file_token' => 'master-file-current-302',
    'master_journal_bytes_digest' => hash('sha256', $masterBytes),
    'database_file_token' => 'database-file-current-302',
    'master_journal_cleanup_token' => 'master-cleanup-current-302',
    'reader_lease_token' => 'reader-lease-current-302',
    'pager_cache_source_token' => 'pager-cache-source-current-302',
    'read_transaction_token' => 'read-transaction-current-302',
    'schema_reparse_token' => 'schema-reparse-current-302',
    'statement_schema_root_token' => 'statement-schema-root-current-302',
    'current_source_provenance_token' => 'source-provenance-current-302',
    'pager_reader_cache_generation_token' => 'cache-generation-current-302',
    'reader_snapshot_token' => 'reader-snapshot-current-302',
    'master_journal_recovery_receipt_token' => 'recovery-receipt-current-302',
    'pager_spill_drain_token' => 'spill-drain-current-302',
    'rollback_journal_reader_source_token' => 'rollback-source-current-302',
    'pager_hot_journal_header_token' => 'hot-header-current-302',
    'master_journal_member_epoch_token' => 'member-epoch-current-302',
    'reader_cache_schema_cookie_token' => 'schema-cookie-current-302',
    'reader_cache_vacuum_root_token' => 'vacuum-root-current-302',
    'pager_reserved_lock_token' => 'reserved-lock-current-302',
    'reader_cache_page_count_token' => 'page-count-current-302',
    'reader_cache_schema_version_token' => 'schema-version-current-302',
    'reader_cache_change_counter_token' => 'change-counter-current-302',
    'reader_cache_freelist_trunk_token' => 'freelist-trunk-current-302',
    'reader_cache_auto_vacuum_token' => 'auto-vacuum-current-302',
    'reader_cache_encoding_token' => 'encoding-current-302',
    'reader_cache_text_schema_token' => 'text-schema-current-302',
    'reader_cache_index_schema_token' => 'index-schema-current-302',
    'reader_cache_trigger_schema_token' => 'trigger-schema-current-302',
    'reader_cache_view_schema_token' => 'view-schema-current-302',
    'reader_cache_virtual_table_schema_token' => 'virtual-table-schema-current-302',
    'reader_cache_module_schema_token' => 'module-schema-current-302',
    'reader_cache_pragma_schema_token' => 'pragma-schema-current-302',
    'reader_cache_collation_schema_token' => 'collation-schema-current-302',
    'reader_cache_authorizer_schema_token' => 'authorizer-schema-current-302',
    'reader_cache_transaction_state_token' => 'transaction-state-current-302',
    'reader_cache_commit_phase_token' => 'commit-phase-current-302',
    'reader_cache_busy_handler_token' => 'busy-handler-current-302',
    'reader_cache_savepoint_stack_token' => 'savepoint-stack-current-302',
    'reader_cache_statement_journal_token' => 'statement-journal-current-302',
    'reader_cache_temp_page_token' => 'temp-page-current-302',
    'reader_cache_dirty_list_token' => 'dirty-list-current-302',
    'reader_cache_spill_epoch_token' => 'spill-epoch-current-302',
    'reader_cache_locking_mode_token' => 'locking-mode-current-302',
    'reader_cache_journal_mode_token' => 'journal-mode-current-302',
    'reader_cache_synchronous_token' => 'synchronous-current-302',
    'reader_cache_mmap_size_token' => 'mmap-size-current-302',
];
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceReaderCacheMmapSizeFence(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
if (in_array('--self-test', $argv, true)) {
    if ($plan['status'] !== 'pager-master-journal-reader-cache-current-source-mmap-size-fence') {
        fwrite(STDERR, "unexpected pager reader-cache mmap-size-fence status\n");
        exit(1);
    }
    ...
    echo "application-pager-master-journal-reader-cache-current-source-mmap-size-fence self-test passed\n";
    return;
}
...
echo json_encode([
    ...
    'current_reader_cache_mmap_size_token' => $plan['current_reader_cache_mmap_size_token'],
