...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext208Plan;
...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext208Plan::compare(
    $sql,
    ['wp_options' => $current],
    ['wp_options' => $next],
);
