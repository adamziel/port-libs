...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-statement-virtual-branch-fence',
    'epoch' => 766,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 766, 0])),
    'publication_generation' => 766,
    'master_source_digest' => hash('sha256', 'wordpress statement virtual branch fence master source'),
