...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-compound-recursive-affinity-window-current-source-source-boundary self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-compound-recursive-affinity-window-current-source-source-boundary',
