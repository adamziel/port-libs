...
echo json_encode([
    'wordpressUse' => 'Preview a copied wp_options table b-tree delete rebalance where an underfilled interior parent borrows a child pointer from its right sibling and rewrites auto-vacuum pointer-map parent links without ext/sqlite.',
    'plan' => $plan->toArray(),
    'leftParent' => [
        'page' => 4,
