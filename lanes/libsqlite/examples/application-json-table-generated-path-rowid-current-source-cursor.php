...
$summary = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next171',
    'applicationUse' => 'Copied wp_options plugin-rule previews can keep a pinned json_tree() current-source cursor through xNext rowid/path yields, while the shifted next source is prepared through a fresh cursor.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next171 self-test passed\n";
    return;
}
