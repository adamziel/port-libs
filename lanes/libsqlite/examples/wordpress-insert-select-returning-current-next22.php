...
$summary = [
    'scenario' => 'wordpress insert select returning current next22',
    ...
    'wordpressUse' => 'Preview copied wp_options archive/import rows with SQLite INSERT SELECT RETURNING semantics, including OR IGNORE conflicts and returned imported-row labels, without requiring ext/sqlite.',
];
