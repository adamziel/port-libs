...
$payload = [
    'scenario' => 'wordpress-upsert-returning-trigger-current',
    'wordpressUse' => 'Preview copied wp_options UPSERT RETURNING rows alongside INSERT/UPDATE trigger audit effects, preserving SQLite current-row RETURNING values before AFTER-trigger target mutations without requiring ext/sqlite.',
