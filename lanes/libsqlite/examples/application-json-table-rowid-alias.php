...
echo json_encode([
    'scenario' => 'application-json-table-rowid-alias',
    'applicationUse' => 'Copied wp_options JSON diagnostics can safely treat json_tree rowid, _rowid_, and oid constraints as the same virtual-table rowid, deduping identical aliases and short-circuiting contradictory aliases before current-source cursor reuse.',
