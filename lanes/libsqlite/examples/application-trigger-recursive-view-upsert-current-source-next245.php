...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNextPlan::executeCurrentTargetReasonReceipt(
    ...
    [
        ...
        'current_source_cursor_source_close' => 'wp.returning.current.cursor.245',
        'current_source_close_token_source_close' => 'wp.current.source.close.245',
...
if (
    ...
    || $summary['current_source_upsert_conflict_target_next245'] !== ['option_name']
    || $summary['current_source_upsert_excluded_columns_next245'] !== ['option_value', 'autoload']
    || array_column($summary['visible_returning_payloads_next245'], 'name') !== ['blogdescription_child', 'template_child', 'home', 'next_plugin']
