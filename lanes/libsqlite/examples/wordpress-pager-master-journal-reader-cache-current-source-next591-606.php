...
$base = [
    ...
    'master_source_digest' => hash('sha256', 'wordpress next606 master source'),
...
$cache = [1 => array_merge($base, ['reader_id' => 'wp-options-reader', 'image' => $recovered[1], 'reader_cache_stmt_vdbe_vrename_branch_token' => 'stmt-vdbe-vrename-branch-old'])];
