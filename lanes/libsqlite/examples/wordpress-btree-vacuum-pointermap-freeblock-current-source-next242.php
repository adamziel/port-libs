...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext242Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext242Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next242',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next242 self-test passed\n";
}
