...
echo json_encode([
    'scenario' => 'wordpress-jsonb-check-current-next67',
    ...
    'wordpressUse' => 'Preflight copied wp_options JSONB plugin settings with OR/NOT CHECK guards before next import rows are admitted to storage.',
