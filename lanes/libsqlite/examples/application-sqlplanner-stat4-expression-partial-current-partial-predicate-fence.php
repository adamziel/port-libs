...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-partial-predicate-fence self-test passed\n";
}

return [
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-partial-predicate-fence',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'Copied wp_options plugin preload pagination can reuse a current-source partial lower(option_name) STAT4 index only after every yielded rowid is rechecked against the current partial-index WHERE clause.',
];
