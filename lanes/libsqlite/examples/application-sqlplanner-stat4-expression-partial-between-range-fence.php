...
$prepared = [
    'name' => 'prepared-application-options-next177',
    'schemaCookie' => 1770,
    'stat4Generation' => 50,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-application-options-next177';
...
if (($plan['matchedRowids'] ?? []) !== [10, 11, 20, 30]) {
    throw new RuntimeException('Expected Application plugin option BETWEEN scan to include inclusive STAT4 boundaries from current source');
}
