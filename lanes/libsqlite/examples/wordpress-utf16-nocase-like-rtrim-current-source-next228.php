...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext228Plan::wordpressOptionNameHeaderEncodingFencePlan(
    $currentRows,
    $nextRows,
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next228 self-test passed\n";
}

return [
    'scenario' => 'wordpress-utf16-nocase-like-rtrim-current-source-next228',
    'wordpressUse' => 'Copied wp_options scans retain the logical NOCASE/RTRIM LIKE rowset across a UTF-16LE to UTF-16BE source refresh, but force prepared cursor reprepare because the SQLite database text-encoding header changed.',
