...
echo json_encode([
    'scenario' => 'wordpress-vfs-lock-state-apply',
    'wordpressUse' => 'Apply bounded SQLite VFS shared/reserved/pending/exclusive lock state over copied wp_options database opens, preserving reader concurrency, writer exclusivity, pending-reader blocking, and byte-range plan dependencies without requiring ext/sqlite.',
    'databasePath' => $path,
    'reader' => [
