...
$summary = [
    ...
    'applicationUse' => 'A copied Application database reuses wp_options reader-cache pages only after two identical reads of the current master journal; active_plugins reopens when its ticket came from an older master-journal read.',
];
...
if (in_array('--self-test', $argv, true)) {
    if (
        ...
        throw new RuntimeException('Application pager master-journal reader-cache next193 smoke failed');
    }

    echo "application-pager-master-journal-reader-cache-stable-master-read-token-fence self-test passed\n";
    return;
}
