...
$plan = SQLiteBTreeOverflowRebalanceFreelistCurrentSourceNextPlan::tableLeafReplacement(
    ...
    3,
    [13401],
    str_repeat('application-option-replacement-next134-', 35),
    4,
    true,
);

$summary = [
    'scenario' => 'application-btree-overflow-rebalance-freelist-current-source-next134',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-btree-overflow-rebalance-freelist-current-source-next134 self-test passed\n";
    return;
}
