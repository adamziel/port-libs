...
echo json_encode([
    'scenario' => 'wordpress-select-expression-index-cost',
    ...
    'wordpressUse' => 'Preview copied wp_options SELECT planner cost decisions for competing expression/range indexes before native row decoding, choosing point/range scans that satisfy covering and ORDER BY requirements without ext/sqlite.',
