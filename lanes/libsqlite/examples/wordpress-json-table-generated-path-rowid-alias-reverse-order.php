...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-alias-reverse-order',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-alias-reverse-order self-test passed\n";
    return;
}
