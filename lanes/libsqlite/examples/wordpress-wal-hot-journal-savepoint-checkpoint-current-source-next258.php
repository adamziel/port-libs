...
$readerPlan = [
    ...
    'source_token' => 'wordpress-next258-source',
...
$receipts = [
    array_replace($baseReceipt, ['name' => 'wordpress-next258-header-salt', 'kind' => 'header-salt']),
    array_replace($baseReceipt, ['name' => 'wordpress-next258-first-frame', 'kind' => 'first-frame']),
    array_replace($baseReceipt, ['name' => 'wordpress-next258-reader-fence', 'kind' => 'reader-fence']),
