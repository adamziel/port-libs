...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePeerGroupAdmission(
    ['wp_options' => $rows],
...
echo "wordpress-rowvalue-returning-window-peer-group-admission self-test passed\n";
