...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-page-image-digest-receipt-fence',
    'applicationUse' => 'A copied Application database keeps schema/options cache pages only when the reader ticket also carries the current recovered page-image digest receipt; stale active_plugins readers reopen before plugin import resumes.',
    'status' => $plan['status'],
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next244'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-page-image-digest-receipt-fence self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-page-image-digest-receipt-fence self-test passed\n";
