...
$base = [
    'source_id' => 'application-pager-reader-cache-next846',
    'epoch' => 846,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 846, 0])),
    'publication_generation' => 846,
    'master_source_digest' => hash('sha256', 'application next846 master source'),
...
echo json_encode([
    ...
    'next846_reopen_reason' => $plan['next_reads'][0]['reader_cache_stmt_vdbe_vbegin_branch_handoff_token_reason'],
