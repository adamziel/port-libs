...
$summary = [
    'scenario' => 'application-json-table-ranked-alternative-planner',
    'applicationUse' => 'A copied wp_options diagnostics query can plan OR branches over json_tree() once, rank the cheapest usable JSON-table branch first, and merge duplicate virtual rows deterministically without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-ranked-alternative-planner self-test passed\n";
    return;
}
