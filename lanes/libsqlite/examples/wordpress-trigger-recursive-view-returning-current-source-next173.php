...
require_once __DIR__ . '/../src/SQLiteTriggerRecursiveViewReturningCurrentSourceNext173Plan.php';
...
$plan = SQLiteTriggerRecursiveViewReturningCurrentSourceNext173Plan::execute(
    $rows,
    [
