...
$report = [
    'scenario' => 'wordpress-wal-recovery-checkpoint-savepoint-current-source-next82',
    'wordpressUse' => 'Copied wp_options import recovery rejects stale WAL source bytes before savepoint rollback checkpoint recovery, so a retry does not checkpoint a WAL sidecar from a previous salt or checkpoint sequence.',
    'status' => $plan['status'],
