...
$handoff = [
    ...
    'stale_reader_tokens' => [],
    'retry_transition_digest' => hash('sha256', 'wordpress-next193-transition'),
    'next_wal_sha256' => hash('sha256', 'wordpress-next193-wal'),
...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next193',
    'status' => $plan['status'],
...
if (in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next193 self-test failed\n");
        exit(1);
    }

    echo "wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next193 self-test passed\n";
    exit(0);
}
