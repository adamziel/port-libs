...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-alias-projection',
    'applicationUse' => 'Copied wp_options JSON diagnostics can project json_tree rowid aliases from a generated-path xColumn cache without losing the current-source resume guard.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-alias-projection self-test passed\n";
    return;
}
