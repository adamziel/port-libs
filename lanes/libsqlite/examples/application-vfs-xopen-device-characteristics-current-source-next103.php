...
$summary = [
    'applicationUse' => 'Open copied wp_options database handles through the native VFS model, surface xDeviceCharacteristics bits chosen at xOpen, and show sibling current-source freshness after one handle changes powersafe-overwrite policy.',
    'status' => $plan['status'],
    'firstOpen' => [
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-vfs-xopen-device-characteristics-current-source-next103 self-test passed\n";
    return;
}
