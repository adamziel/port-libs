...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next606-621 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next590-605 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next606-621 self-test passed\n";
    return;
}
