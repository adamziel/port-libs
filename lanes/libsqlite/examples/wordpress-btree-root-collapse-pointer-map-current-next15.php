...
echo json_encode([
    'wordpressUse' => 'Apply a copied wp_options auto-vacuum delete/rebalance root-collapse where the obsolete child is released on pointer-map page 2 while the adopted grandchild is reparented on pointer-map page 105.',
