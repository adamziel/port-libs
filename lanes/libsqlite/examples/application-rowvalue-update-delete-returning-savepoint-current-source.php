...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-rowvalue-update-delete-returning-savepoint-current-source self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-rowvalue-update-delete-returning-savepoint-current-source',
    'status' => $plan['status'],
