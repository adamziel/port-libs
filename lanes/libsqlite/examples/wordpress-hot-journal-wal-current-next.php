...
echo json_encode([
    'wordpressUse' => 'Compare copied wp_options reader-visible pages before and after hot rollback-journal recovery followed by committed WAL prefix recovery, showing the next reader sees journal-restored pages plus committed WAL pages while uncommitted WAL tail pages stay invisible without ext/sqlite.',
