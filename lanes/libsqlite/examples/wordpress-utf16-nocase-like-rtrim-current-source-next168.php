...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext168Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext168Plan::wordpressOptionNameCaseSensitiveLikePlan(
    $currentRows,
    $nextRows,
    'plugin!_cache%',
    '!',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next168 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-utf16-nocase-like-rtrim-current-source-next168',
    'wordpressUse' => 'Copied wp_options prefix scans must not resume a UTF-16 NOCASE/RTRIM LIKE cursor after case_sensitive_like changes residual matching.',
