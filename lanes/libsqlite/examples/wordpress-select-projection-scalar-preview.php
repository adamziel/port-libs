...
echo json_encode([
    'wordpressUse' => 'Preview SELECT row production for copied wp_options imports where scalar expressions are evaluated as projected result columns before ORDER BY, without requiring ext/sqlite.',
