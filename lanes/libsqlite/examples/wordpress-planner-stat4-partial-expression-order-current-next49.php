...
echo json_encode([
    'scenario' => 'wordpress-planner-stat4-partial-expression-order-current-next49',
    'index' => $plan['name'],
    ...
    'wordpressUse' => 'Preview copied wp_options plugin-option scans where autoload and lower(option_name) prove a partial expression index, STAT4 supplies current/next selectivity, and ORDER BY lower(option_name), autoload, option_id DESC is satisfied without a table sort.',
