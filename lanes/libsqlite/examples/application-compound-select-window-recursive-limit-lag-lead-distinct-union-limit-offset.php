...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-compound-select-window-recursive-limit-current-source-lag-lead-distinct-union-limit-offset self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-compound-select-window-recursive-limit-current-source-lag-lead-distinct-union-limit-offset',
    'applicationUse' => 'Copied wp_options import previews can compare current and next option trees while recursive LIMIT/OFFSET, lag/lead window metrics, UNION ALL streaming, UNION distinct de-duplication, and final tail LIMIT/OFFSET determine the rows shown before commit.',
