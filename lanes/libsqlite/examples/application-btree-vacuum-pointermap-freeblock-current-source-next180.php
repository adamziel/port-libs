...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next180',
...
if ($summary['apply_pages'] === [1, 3, 105, 106, 107, 108] && $summary['fenced_apply_pages'] === []) {
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next180 self-test passed\n";
}
