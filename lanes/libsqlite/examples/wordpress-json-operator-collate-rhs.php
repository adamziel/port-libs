...
$matches = [
    'cache' => $database->wordpressOptionsByIndexedJsonOptionValue('$.cache', 'hit'),
    'pluginEnabled' => $database->wordpressOptionsByIndexedJsonOptionValue('$."plugin.enabled"', 'yes'),
];

echo json_encode([
    'scenario' => 'wordpress-json-operator-collate-rhs',
    'wordpressUse' => 'Preflight copied wp_options JSON expression indexes whose -> and ->> RHS constants carry their own COLLATE clause, while the outer index collation remains separate, without requiring ext/sqlite.',
