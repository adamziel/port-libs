...
$prepared = [
    'name' => 'prepared-application-options-stat4-sample-window',
    'schemaCookie' => 2210,
    'stat4Generation' => 221,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-application-options-stat4-sample-window';
...
echo json_encode([
    ...
    'applicationUse' => 'Copied wp_options plugin scans can reuse a current-source partial expression index across cursor yields only when the yielded page and lookahead row stay inside current STAT4 sample windows.',
