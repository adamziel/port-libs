...
$report = [
    'scenario' => 'wordpress-wal-savepoint-reader-pin-current-next35',
    'wordpressUse' => 'During a copied wp_options import, roll back a plugin-settings savepoint while an existing WAL reader keeps its read-mark pin, then report the current reader snapshot and the next reader view after the checkpoint/reset attempt without requiring ext/sqlite.',
    'status' => $plan['status'],
