...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options import checks can preserve SQLite LIKE ESCAPE semantics for literal underscore/percent option values while applying text affinity and NOCASE range invalidation between current and next sources without ext/sqlite.',
...
if (PHP_SAPI === 'cli' && in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-option-value-like-escape-affinity-current-source-next237 self-test passed\n";
    return;
}
