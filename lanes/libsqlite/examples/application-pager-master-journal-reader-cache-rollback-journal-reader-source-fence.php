...
$base = [
    ...
    'master_source_digest' => hash('sha256', 'application next261 master source'),
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-pager-master-journal-reader-cache-current-source-next261 self-test passed\n";
    return;
}
