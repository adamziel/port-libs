...
if (
    ...
    fwrite(STDERR, "application-trigger-recursive-view-returning-current-source-next217 self-test failed\n");
    exit(1);
}

echo "application-trigger-recursive-view-returning-current-source-next217 self-test passed\n";
