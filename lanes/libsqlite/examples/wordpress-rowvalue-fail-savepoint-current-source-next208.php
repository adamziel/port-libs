...
require_once __DIR__ . '/../src/SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext208Plan.php';

use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext208Plan;
...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext208Plan::execute(
    ['wp_options' => $rows],
