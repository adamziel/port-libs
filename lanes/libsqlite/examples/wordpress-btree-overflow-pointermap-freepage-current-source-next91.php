...
$plan = SQLiteBTreeOverflowVacuumFreepagePlan::fromOverflowChains(
    ...
    [
        ...
        [
            ...
            'record_values' => [['_transient_timeout_next91', 91]],
        ],
    ],
    secureDelete: true,
...
echo json_encode([
    'scenario' => 'wordpress-btree-overflow-pointermap-freepage-current-source-next91',
    ...
    'pointerMapFreepageRows' => $plan->overflowPointerMapFreepageCurrentSourceNext91(),
