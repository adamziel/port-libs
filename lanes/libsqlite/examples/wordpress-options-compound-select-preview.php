...
$report = [
    ...
    'wordpressUse' => 'Preview copied wp_options rows composed from multiple SELECT arms with SQLite UNION, UNION ALL, INTERSECT, and EXCEPT semantics before migration/import tooling applies final ordering.',
];
