...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext165Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext165Plan::execute(
    $rows,
    [['root_name' => 'siteurl']],
