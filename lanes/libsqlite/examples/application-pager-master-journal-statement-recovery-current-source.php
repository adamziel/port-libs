...
$summary = [
    'scenario' => 'application-pager-master-journal-statement-recovery-current-source',
    'applicationUse' => 'Recover failed statement pages for copied Application option databases only when the current statement journal sidecar still exists; stale preimage input for a missing sidecar is skipped under the master-journal transaction.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-pager-master-journal-statement-recovery-current-source self-test passed\n";
    exit(0);
}
