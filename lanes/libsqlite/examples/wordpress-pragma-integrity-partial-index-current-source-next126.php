...
$integrity = SQLitePragmaIntegrityPartialIndexCurrentSourceNext126::page(
    $rows,
    $indexEntries,
    $predicate,
...
$quick = SQLitePragmaIntegrityPartialIndexCurrentSourceNext126::page(
    $rows,
    $indexEntries,
    $predicate,
    ['autoload', 'option_name'],
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-integrity-partial-index-current-source-next126 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-integrity-partial-index-current-source-next126 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-pragma-integrity-partial-index-current-source-next126',
