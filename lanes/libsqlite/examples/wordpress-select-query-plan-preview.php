...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows through one bounded SQLite SELECT plan with LEFT JOIN, WHERE residual predicates, table-star projection, DISTINCT, ORDER BY, and LIMIT before import diagnostics, without requiring ext/sqlite.',
