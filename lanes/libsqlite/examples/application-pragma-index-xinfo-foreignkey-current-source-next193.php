...
$summary = [
    'scenario' => 'application-pragma-index-xinfo-foreignkey-current-source-next193',
    'applicationUse' => 'Copied wp_options imports can block parent-key repair when PRAGMA index_xinfo shows that a UNIQUE parent key has the right columns in the wrong order.',
...
if (in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "application-pragma-index-xinfo-foreignkey-current-source-next193 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "application-pragma-index-xinfo-foreignkey-current-source-next193 self-test passed\n");
    exit(0);
}
