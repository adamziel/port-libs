...
$report = [
    ...
    'wordpressUse' => 'Preflight copied wp_options numeric option_value rows through SQLite JSON mutation functions without ext/sqlite, preserving scalar SQL JSON input behavior before plugin settings are promoted or cleaned up.',
];
