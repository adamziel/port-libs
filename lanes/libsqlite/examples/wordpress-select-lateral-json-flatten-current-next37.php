...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-select-lateral-json-flatten-current-next37 self-test passed\n";
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-select-lateral-json-flatten-current-next37',
    'wordpressUse' => 'Copied wp_options plugin settings can be flattened through comma-form json_tree/json_each sources whose later JSON table roots use the current joined row, without requiring ext/sqlite.',
