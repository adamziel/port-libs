...
echo json_encode([
    'scenario' => 'wordpress-select-expression-index-plan',
    ...
    'wordpressUse' => 'Preview copied wp_options SELECT WHERE expression-index dispatch for lower(option_name), length(option_name), and CAST(option_value AS INTEGER) predicates before row decoding without requiring ext/sqlite.',
