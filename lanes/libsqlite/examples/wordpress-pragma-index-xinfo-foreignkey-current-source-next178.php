...
use PortLibs\LibSqlite\SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext178;
...
$page = SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext178::currentNextPageFromCatalog(
    $currentRecords,
    $currentTables,
    $nextRecords,
    $nextTables,
