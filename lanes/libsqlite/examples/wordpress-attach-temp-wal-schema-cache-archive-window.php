...
$plan = SQLiteAttachWalTempSchemaCacheCurrentSourceNextPlan::schemaCacheArchiveWindow($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-attach-temp-wal-schema-cache-archive-window self-test passed\n";
    return;
}
