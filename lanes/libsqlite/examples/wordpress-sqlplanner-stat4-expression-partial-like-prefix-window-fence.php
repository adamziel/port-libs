...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-sqlplanner-stat4-expression-partial-current-source-next175 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-source-next175',
    'wordpressUse' => 'Preview copied wp_options plugin scans after ANALYZE reparses a partial lower(option_name) index and admits the current STAT4 LIKE-prefix window while blocking stale prepared rows.',
    'status' => $plan['status'],
