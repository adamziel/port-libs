...
$likeRows = SQLiteUtf16LikeGlobCurrentNextCursor::wordpressOptionNameScan(
    $rows,
    'plugin\_100\%%',
    'LIKE',
    'UTF-16LE',
...
$globRows = SQLiteUtf16LikeGlobCurrentNextCursor::wordpressOptionNameScan(
    $rows,
    'plugin_[😀-😀]*',
    'GLOB',
    'UTF-16LE',
...
echo json_encode(
    [
        'scenario' => 'wordpress-option-name-utf16-like-glob-current-next75',
