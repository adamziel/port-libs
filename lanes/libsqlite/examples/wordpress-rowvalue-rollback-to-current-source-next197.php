...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext197Plan::execute(
    ['wp_options' => $rows],
    [$outer],
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-rowvalue-rollback-to-current-source-next197 self-test passed\n";
    return;
}
