...
$plan = SQLiteJsonTablePlan::currentSourceHiddenRowidPathNext146(
    'json_tree',
    $currentOption,
    $nextOption,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-hidden-rowid-path-current-source-next146',
    ...
    'replanReasons' => $plan['next146ReplanReasons'],
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-hidden-rowid-path-current-source-next146 self-test passed\n";
    return;
}
