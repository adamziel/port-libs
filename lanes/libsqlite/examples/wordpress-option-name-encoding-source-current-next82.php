...
$literalPercent = SQLiteEncodingCollationSourceCursor::wordpressOptionNameScan(
    $sourceRows,
    'plugin\_100\%%',
    'LIKE',
    'NOCASE',
...
$emoji = SQLiteEncodingCollationSourceCursor::wordpressOptionNameScan(
    $sourceRows,
    'plugin_😀%',
    'LIKE',
    'BINARY',
...
$glob = SQLiteEncodingCollationSourceCursor::wordpressOptionNameScan(
    $sourceRows,
    'plugin_*',
    'GLOB',
    'BINARY',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-option-name-encoding-source-current-next82 self-test passed\n";
    return;
}
