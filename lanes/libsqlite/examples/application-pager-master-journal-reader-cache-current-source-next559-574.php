...
$base = [
    'source_id' => 'application-pager-reader-cache-next574',
    'epoch' => 574,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 574, 0])),
    'publication_generation' => 574,
    'master_source_digest' => hash('sha256', 'application next574 master source'),
...
$cache = [1 => array_merge($base, ['reader_id' => 'wp-options-reader', 'image' => $recovered[1], 'reader_cache_stmt_vdbe_if_branch_token' => 'stmt-vdbe-if-branch-old'])];
...
echo json_encode([
    ...
    'next574_invalidated_pages' => $plan['reader_cache_stmt_vdbe_if_branch_invalidated_cache_page_numbers'],
