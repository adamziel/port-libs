...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafWriterLeaseFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next194',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next194 self-test passed\n";
}
