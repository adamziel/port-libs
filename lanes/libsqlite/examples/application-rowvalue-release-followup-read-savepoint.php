...
echo json_encode([
    ...
    'applicationUse' => 'Model copied wp_options import cleanup where RELEASE of a row-value UPDATE/DELETE RETURNING savepoint promotes the current source for the next statement, so a follow-up UPDATE and DELETE see the released replacement row.',
    'status' => $plan['status'],
