...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options UPDATE RETURNING rows while trigger audit rows and foreign-key cascades update copied wp_optionmeta child keys without requiring ext/sqlite.',
