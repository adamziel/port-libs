...
require_once __DIR__ . '/../src/SQLiteTriggerReturningFkSavepointCurrentNext74Plan.php';
...
$plan = SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update(
    $parents,
    $meta,
    [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-trigger-returning-fk-savepoint-current-next74 self-test passed\n";
    return;
}
