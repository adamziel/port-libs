...
echo json_encode([
    'wordpressUse' => 'Plan an auto-vacuum-safe wp_options repair preflight that frees an obsolete overflow page and updates SQLite pointer-map metadata before any future page moves or reuse.',
    'plan' => [
