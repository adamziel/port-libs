...
$payload = [
    'scenario' => 'wordpress-utf16-nocase-like-rtrim-current-source-next173',
    ...
    'wordpressUse' => 'Copied wp_options cursors over UTF-16 rtrim(option_name) COLLATE NOCASE LIKE probes can distinguish byte-only trailing-space changes from semantic rowset changes before resuming a current-source cursor.',
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    if ($payload['status'] !== 'utf16-nocase-like-rtrim-current-source-next173'
        ...
        fwrite(STDERR, "wordpress-utf16-nocase-like-rtrim-current-source-next173 self-test failed\n");
        exit(1);
    }
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next173 self-test passed\n";
}
