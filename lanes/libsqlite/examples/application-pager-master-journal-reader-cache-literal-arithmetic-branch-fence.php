...
$base = [
    'source_id' => 'application-pager-reader-cache-next718',
    'epoch' => 718,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 718, 0])),
    'publication_generation' => 718,
    'master_source_digest' => hash('sha256', 'application next718 master source'),
...
$cache = [1 => array_merge($base, ['reader_id' => 'wp-options-reader', 'image' => $recovered[1], 'reader_cache_stmt_vdbe_shift_right_branch_handoff_token' => 'stmt-vdbe-shift-right-branch-handoff-old'])];
...
echo json_encode([
    ...
    'next718_invalidated_pages' => $plan['reader_cache_stmt_vdbe_shift_right_branch_handoff_invalidated_cache_page_numbers'],
