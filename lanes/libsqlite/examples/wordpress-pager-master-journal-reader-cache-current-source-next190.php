...
$summary = [
    ...
    'wordpressUse' => 'After a copied wp_options recovery, a byte-identical active_plugins page is still reopened when its reader-cache ticket came from the pre-master source rather than the current master-journal member source.',
