...
$summary = [
    'scenario' => 'application-vfs-close-reopen-current-source',
    'applicationUse' => 'Continue hydrated Application SQLite VFS current-source state through WAL sidecar staleness, full sync, close/reopen, and readonly archive lock blocking.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-vfs-close-reopen-current-source self-test passed\n";
    return;
}
