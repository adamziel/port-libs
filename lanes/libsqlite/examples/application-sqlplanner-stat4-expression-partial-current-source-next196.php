...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next196 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next196',
    'applicationUse' => 'Copied wp_options plugin scans can reuse a current STAT4 partial lower(option_name) covering index only when duplicate mixed-case option names retain stable rowid peer order for LIMIT windows.',
    'status' => $plan['status'],
