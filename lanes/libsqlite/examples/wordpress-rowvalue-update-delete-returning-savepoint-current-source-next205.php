...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext205Plan;
...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext205Plan::execute(
    ['wp_options' => $rows],
    [
