...
echo json_encode([
    'wordpressUse' => 'Delete a copied wp_options transient row and option_name index entry, then connect their obsolete overflow chains to the SQLite freelist and auto-vacuum pointer-map free-page entries without ext/sqlite.',
