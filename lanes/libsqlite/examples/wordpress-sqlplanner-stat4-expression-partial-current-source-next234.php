...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-sqlplanner-stat4-expression-partial-current-source-next234 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-source-next234',
    'wordpressUse' => 'Copied wp_options plugin-admin pagination can keep a partial lower(option_name) STAT4 plan only when current neq/nlt/ndlt histogram counts still match the current source.',
    'status' => $plan['status'],
