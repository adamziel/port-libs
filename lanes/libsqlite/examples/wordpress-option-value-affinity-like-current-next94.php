...
$summary = [
    ...
    'wordpressUse' => 'Copied WordPress option imports can invalidate LIKE/GLOB value cursors when text-affinity coercion, UTF-16 scan encoding, or matched rowsets change, without treating BLOB payloads as text and without ext/sqlite.',
    'pluginValuePlan' => SQLiteEncodingAffinityLikeCurrentSourceNextPlan::wordpressOptionValuePlan(
        $currentRows,
        $nextRows,
        'option_value',
        'plugin%',
    ...
    'numericValuePlan' => SQLiteEncodingAffinityLikeCurrentSourceNextPlan::wordpressOptionValuePlan(
        $currentRows,
        $nextRows,
        'option_value',
        '1%',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-option-value-affinity-like-current-next94 self-test passed\n";
    return;
}
