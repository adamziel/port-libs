...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext162Plan;
...
echo json_encode(
    SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext162Plan::compare($sql, $currentTables, $nextTables),
