...
$summary = [
    'scenario' => 'application-json-table-rowid-hidden-generated',
    'applicationUse' => 'Copied wp_options plugin-setting previews can pin a json_tree rowid while generated hidden columns expose slug, priority, and enabled values across a next import.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-rowid-hidden-generated self-test passed\n";
    return;
}
