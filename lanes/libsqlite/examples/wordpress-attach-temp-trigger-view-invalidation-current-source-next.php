...
$plan = SQLiteAttachTempWalSchemaTriggerPlan::triggerViewInvalidationCurrentSourceNext(
    $current,
    $next,
...
$output = [
    'scenario' => 'wordpress attach temp trigger view invalidation current source next108',
