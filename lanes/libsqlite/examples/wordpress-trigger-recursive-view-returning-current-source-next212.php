...
$nextView = $view;
$nextView['source'] = 'main@view-cookie-212-next';
$nextView['trigger_source'] = 'main@trigger-cookie-212-next';
$postResetView = $view;
$postResetView['source'] = 'main@view-cookie-212-post-reset';
$postResetView['trigger_source'] = 'main@trigger-cookie-212-post-reset';
$followingView = $view;
$followingView['source'] = 'main@view-cookie-212-following';
$followingView['trigger_source'] = 'main@trigger-cookie-212-following';

$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNextPlan::executeNext212(
    [
...
if (
    $summary['status_next212'] !== 'trigger-recursive-view-returning-current-source-next212-yield-released'
    || $summary['current_source_yield_plan_next212']['decision'] !== 'publish-next-source-after-current-source-yield'
    || array_column($summary['visible_returning_payloads_next212'], 'name') !== ['blogdescription_child', 'template_child', 'home', 'next_plugin']
    || $summary['held_next_source_rows_next212'] !== []
) {
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-next212 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-current-source-next212 self-test passed\n";
