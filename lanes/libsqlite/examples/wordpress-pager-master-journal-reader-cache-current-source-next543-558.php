...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-next558',
    'epoch' => 558,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 558, 0])),
    'publication_generation' => 558,
    'master_source_digest' => hash('sha256', 'wordpress next558 master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::variantNext558(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
