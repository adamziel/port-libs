...
$summary = [
    'scenario' => 'application-schema-generated-trigger-reparse-current-source-next141',
    'applicationUse' => 'Copied wp_options imports often add audit triggers over compatibility views; the trigger reparse must keep generated-column dependencies from the view current source before stale inserts resume.',
    'status' => $plan['status'],
...
if (PHP_SAPI === 'cli' && in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "application-schema-generated-trigger-reparse-current-source-next141 self-test failed\n");
        exit(1);
    }

    echo "application-schema-generated-trigger-reparse-current-source-next141 self-test passed\n";
    exit(0);
}
