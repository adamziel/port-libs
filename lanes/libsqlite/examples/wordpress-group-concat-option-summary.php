...
echo json_encode([
    'wordpressUse' => 'Summarize copied wp_options names with SQLite group_concat()/string_agg() aggregate semantics, including DISTINCT, ORDER BY, FILTER-style autoload selection, NULL skipping, and bounded window previews without requiring the SQLite extension.',
