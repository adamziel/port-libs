...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext185Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext185Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
