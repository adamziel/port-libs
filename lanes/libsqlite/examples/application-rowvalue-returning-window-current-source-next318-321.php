...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the next318-321 row-value UPDATE/DELETE RETURNING window current-source continuation after the ready next314-317 handoff while preserving independent libsqlite preflight throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next318-321 self-test passed\n";
    return;
}
