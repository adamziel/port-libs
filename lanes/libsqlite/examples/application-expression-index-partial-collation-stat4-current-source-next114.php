...
$summary = [
    'scenario' => 'application-expression-index-partial-collation-stat4-current-source-next114',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'Preview copied wp_options autoloaded plugin scans after ANALYZE: a partial lower(option_name) COLLATE NOCASE expression index is selected from the current source, using STAT4 boundaries without requiring ext/sqlite.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-expression-index-partial-collation-stat4-current-source-next114 self-test passed\n";
    return;
}
