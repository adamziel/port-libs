...
$summary = [
    'scenario' => 'application-pager-hot-journal-cache-spill-current-source-next127',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'After a copied wp_options import crashes with a hot rollback journal, native PHP pager planning must recover the hot-journal page images before allowing cache-spill writes from the retry transaction.',
