...
$summary = [
    'scenario' => 'wordpress-rowvalue-is-savepoint-current-source-next133',
    'wordpressUse' => 'During copied wp_options cleanup, row-value IS/IS NOT predicates distinguish NULL=NULL from ordinary comparison UNKNOWN so nullable staged option rows update, delete, return, and roll back under a savepoint like SQLite current source.',
    'status' => $plan['status'],
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-rowvalue-is-savepoint-current-source-next133 self-test passed\n";
    return;
}
