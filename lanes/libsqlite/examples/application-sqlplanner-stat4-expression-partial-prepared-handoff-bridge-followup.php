...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-prepared-handoff-bridge-followup self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-prepared-handoff-bridge-followup',
    'applicationUse' => 'Copied wp_options plugin-admin pagination carries the next382-397 current-source STAT4 handoff into next398-413 only when projected current rows still match.',
    'status' => $plan['status'],
