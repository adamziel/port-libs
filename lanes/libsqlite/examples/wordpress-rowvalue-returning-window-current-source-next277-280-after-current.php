...
$next277 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext277(...$args);
$next278 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext278(...$args);
$next279 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext279(...$args);
$next280 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext280(...$args);
...
$summary = [
    'status' => 'rowvalue-update-delete-returning-window-current-source-next277-280-after-current',
    'candidateStatuses' => $statuses,
    'next277Attestation' => $next277['current_source_attestation_next277']['current_source_attestation_next277'],
    'next278Manifest' => $next278['returning_manifest_next278']['returning_manifest_next278'],
    'next279Bridge' => $next279['after_current_bridge_next279']['after_current_bridge_next279'],
    'next280Seal' => $next280['after_current_seal_next280']['after_current_seal_next280'],
    'next280Ready' => $next280['after_current_ready_next280'],
    'wordpressUse' => 'Copied wp_options imports can validate the prepared next277-280 after-current row-value UPDATE/DELETE RETURNING handoff as attestation, manifest, bridge, and final seal receipts.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next277-280-after-current self-test passed\n";
    return;
}
