...
$base = [
    ...
    'master_source_digest' => hash('sha256', 'wordpress next267 master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::variantNext267(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
if (in_array('--self-test', $argv, true)) {
    if ($plan['status'] !== 'pager-master-journal-reader-cache-current-source-next267') {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-next267 self-test passed\n";
    return;
}
