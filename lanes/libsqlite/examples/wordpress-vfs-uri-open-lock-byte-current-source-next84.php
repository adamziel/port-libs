...
echo json_encode([
    ...
    'wordpressUse' => 'Track copied WordPress SQLite file: URI opens as named current sources, then derive SQLite lock-byte ranges from the active source before import or read-only archive inspection.',
