...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next830-845 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next829_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next830-845 self-test passed\n";
    return;
}
