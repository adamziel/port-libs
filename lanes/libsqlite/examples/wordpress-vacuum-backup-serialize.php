...
$vacuum = SQLiteVacuumBackupSerializePlan::vacuumInto($database, 'wordpress-copy-vacuum.sqlite');

echo json_encode([
    'scenario' => 'wordpress-vacuum-backup-serialize',
    'wordpressUse' => 'Serialize a copied wp_options SQLite database image, reopen it read-only, run a bounded backup page step, and plan a VACUUM INTO maintenance copy without requiring ext/sqlite.',
