...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext192Plan::wordpressOptionNameCandidateTokenPlan(
    $current,
    $next,
    'plugin!_cache',
    '!',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next192 self-test passed\n";
