...
$plan = SQLiteAttachWalTempSchemaCachePlan::finalSchemaCachePreparationWindow($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-attach-temp-wal-schema-cache-final-preparation-window self-test passed\n";
    return;
}
