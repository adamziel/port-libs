...
$databaseBytes = $page('dirty schema after WordPress plugin crash')
    . $page('dirty active_plugins after WordPress plugin crash')
    . $page('dirty autoload index after WordPress plugin crash');
