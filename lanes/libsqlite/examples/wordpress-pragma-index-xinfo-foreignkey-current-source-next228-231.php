...
$summary = [
    'scenario' => 'wordpress-pragma-index-xinfo-foreignkey-current-source-next228-231',
    'wordpressUse' => 'Bulk WordPress schema import checks can separate DESC-compatible parent UNIQUE indexes from wider-prefix, pseudo-rowid, and expression-index FK parent-key blockers.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-index-xinfo-foreignkey-current-source-next228-231 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-index-xinfo-foreignkey-current-source-next228-231 self-test passed\n");
    exit(0);
}
