...
if ($databasePath === null || $jsonPath === null || $lower === null || $upper === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-json-option-fragment-range.php path/to/wordpress.sqlite json_path lower_json|- upper_json|- [limit] [upper_inclusive]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedJsonOptionFragmentRange($jsonPath, $lowerBound, $upperBound, $limit, $upperInclusive),
);
