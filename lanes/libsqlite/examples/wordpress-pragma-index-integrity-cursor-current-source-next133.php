...
$first = SQLitePragmaIndexIntegrityCursorCurrentSourceNext133::page($catalog, 'PRAGMA main.index_list(wp_options)', $database, 0, 6);
$second = SQLitePragmaIndexIntegrityCursorCurrentSourceNext133::page(
    $catalog,
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-index-integrity-cursor-current-source-next133 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-index-integrity-cursor-current-source-next133 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-pragma-index-integrity-cursor-current-source-next133',
