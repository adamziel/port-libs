...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-alias-limit',
    'applicationUse' => 'Copied wp_options JSON diagnostics can satisfy ORDER BY rowid DESC LIMIT directly from a generated-path json_tree cursor, bounding imported settings previews without a temp sorter while next-source changes force reprepare.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-alias-limit self-test passed\n";
    return;
}
