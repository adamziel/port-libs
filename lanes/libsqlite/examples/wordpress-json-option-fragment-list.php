...
if ($databasePath === null || $jsonPath === null || $jsonValues === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-json-option-fragment-list.php path/to/wordpress.sqlite json_path json_values_array [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedJsonOptionFragments($jsonPath, $lookupValues, $limit),
);
