...
$summary = [
    'scenario' => 'wordpress-json-aggregate-distinct-object-window-current-next81',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-aggregate-distinct-object-window-current-next81 self-test passed\n";
    exit(0);
}
