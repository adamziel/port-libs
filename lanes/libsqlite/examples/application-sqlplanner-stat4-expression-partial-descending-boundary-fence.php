...
$prepared = [
    'name' => 'prepared-application-options-next180',
    'schemaCookie' => 1800,
    'stat4Generation' => 70,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-application-options-next180';
...
if (($plan['matchedRowids'] ?? []) !== [60, 30, 20, 10]) {
    throw new RuntimeException('Expected Application plugin option scan to use descending current-source rowids');
}
