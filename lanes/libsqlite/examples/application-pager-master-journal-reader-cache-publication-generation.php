...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-publication-generation',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'A copied wp_options database prevents an old reader-cache publication from being reused after a newer master-journal recovery source is opened.',
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next183'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-publication-generation self-test failed\n");
    exit(1);
}

echo "application-pager-master-journal-reader-cache-publication-generation self-test passed\n";
