...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-planner-stat4-skipscan-covering-current-source-next120 self-test passed\n";
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-planner-stat4-skipscan-covering-current-source-next120',
    ...
    'wordpressUse' => 'Copied wp_options plugin-option scans can combine STAT4 skip-scan current/next evidence with a covering index payload, avoiding table seeks while preserving suffix ORDER BY block-sort evidence.',
