...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next360',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next360 self-test passed\n";
    return;
}
