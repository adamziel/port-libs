...
$preview = [
    'scenario' => 'wordpress-like-collation-current-next65',
    'wordpressUse' => 'Copied wp_options option_name scans can plan LIKE prefix ranges against BINARY/NOCASE/RTRIM indexes while preserving SQLite LIKE/GLOB matcher semantics for collated operands.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-like-collation-current-next65 self-test passed\n";
    return;
}
