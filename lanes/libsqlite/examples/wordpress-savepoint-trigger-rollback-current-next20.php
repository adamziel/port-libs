...
$report = [
    'wordpressUse' => 'Preview a copied wp_options plugin import where an AFTER INSERT trigger rolls back only the current savepoint, preserving earlier transaction rows and reporting page/WAL rollback evidence without requiring ext/sqlite.',
