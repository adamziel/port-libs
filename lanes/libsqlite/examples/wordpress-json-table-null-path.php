...
echo json_encode([
    'scenario' => 'wordpress-json-table-null-path',
    'reports' => $reports,
    'wordpressUse' => 'Local-only wp_options diagnostics preserve SQLite JSON table-valued NULL-path behavior: json_each(option_value, NULL) and json_tree(option_value, NULL) return no rows instead of expanding copied plugin settings or throwing before import.',
