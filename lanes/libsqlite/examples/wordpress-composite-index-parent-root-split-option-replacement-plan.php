...
echo json_encode([
    'wordpressUse' => 'Plan a wp_options replacement that moves an autoloaded option into a full composite secondary-index leaf and grows a full index-interior root, without the SQLite extension.',
    'plan' => $plan->toArray(),
