...
$result = [
    'wordpressUse' => 'Preview copied wp_options window aggregate input ordering where the window frame follows import order but group_concat(... ORDER BY priority, option_name) uses a separate aggregate sorter after FILTER.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "PASS wordpress sql aggregate window order current next72\n";
    exit(0);
}
