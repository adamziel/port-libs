...
$schemas = [
    ...
    'temp' => ['schema_cookie' => 720, 'tables' => ['wp_theme_stage_publish_review_next720', 'wp_theme_stage_publish_notice_next736'], 'indexes' => [], 'temp' => true],
    'archive' => ['schema_cookie' => 718, 'tables' => ['wp_schema_archive_done_next718'], 'indexes' => ['wp_schema_archive_done_key_next718'], 'file' => '/srv/wp/archive-next733.sqlite'],
    'audit' => ['schema_cookie' => 725, 'tables' => ['wp_schema_audit_receipt_next725'], 'indexes' => ['wp_schema_audit_receipt_key_next725'], 'file' => '/srv/wp/audit-next733.sqlite'],
    'handoff' => ['schema_cookie' => 729, 'tables' => ['wp_schema_handoff_receipt_next729'], 'indexes' => ['wp_schema_handoff_receipt_key_next729'], 'file' => '/srv/wp/handoff-next733.sqlite'],
    'publish' => ['schema_cookie' => 707, 'tables' => ['wp_schema_publish_next679', 'wp_schema_publish_done_next706'], 'indexes' => ['wp_schema_publish_key_next686', 'wp_schema_publish_done_key_next722'], 'file' => '/srv/wp/publish-next733.sqlite'],
    'queue' => ['schema_cookie' => 724, 'tables' => ['wp_job_retry_checkpoint_delivered_next688', 'wp_job_retry_checkpoint_archive_next724'], 'indexes' => ['wp_job_retry_checkpoint_delivered_key_next702', 'wp_job_retry_checkpoint_archive_key_next724'], 'file' => '/srv/wp/queue-next733.sqlite'],
    'report' => ['schema_cookie' => 696, 'tables' => ['wp_schema_report_next730', 'wp_schema_report_meta_next694'], 'indexes' => ['wp_schema_report_key_next693', 'wp_schema_report_meta_key_next694'], 'file' => '/srv/wp/report-next733.sqlite'],
];
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    assert($plan['schema_cookies_next']['main'] === 748);
    assert($plan['schema_cookies_next']['temp'] === 736);
    assert($plan['schema_cookies_next']['publish'] === 746);
    assert($plan['schema_cookies_next']['review'] === 741);
    ...
    echo "application-attach-temp-wal-schema-cache-locale-publish-window self-test passed\n";
    return;
}
