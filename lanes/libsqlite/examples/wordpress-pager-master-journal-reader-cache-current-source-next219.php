...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext219Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext219Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-next219 self-test passed\n";
    return;
}
