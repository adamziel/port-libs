...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-current-source-next255',
    'applicationUse' => 'A copied Application database keeps schema reader-cache pages only when the reader page-map digest was opened after master-journal current-source recovery; stale wp_options and active_plugins readers reopen before import continues.',
    'status' => $plan['status'],
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next255'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-current-source-next255 self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-current-source-next255 self-test passed\n";
