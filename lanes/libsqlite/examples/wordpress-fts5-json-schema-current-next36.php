...
echo json_encode([
    'wordpressUse' => 'Preview imported WordPress FTS5 schema records, JSON metadata, external-content rebuild SQL, tokenizer settings, and shadow tables without requiring ext/sqlite.',
    'status' => $plan['status'],
