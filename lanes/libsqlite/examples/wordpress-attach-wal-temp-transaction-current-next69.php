...
$committed = SQLiteAttachWalTempTransactionCurrentNext69Plan::plan($schemas, $operations);
$rolledBack = SQLiteAttachWalTempTransactionCurrentNext69Plan::plan($schemas, $operations, 'rollback');
