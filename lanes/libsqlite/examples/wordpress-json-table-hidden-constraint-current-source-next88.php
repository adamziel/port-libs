...
$plan = SQLiteJsonTablePlan::currentSourceHiddenConstraintPlannerNext88(
    'json_each',
    $currentOption,
    $nextOption,
    'option_value',
...
echo json_encode([
    'scenario' => 'wordpress-json-table-hidden-constraint-current-source-next88',
    ...
    'next88ReplanReasons' => $plan['next88ReplanReasons'],
