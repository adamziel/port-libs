...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafSourceCursorFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-cursor',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient, validate the current-source freelist cursor before exposing reusable pages to later WordPress option rewrites.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-cursor self-test passed\n";
}
