...
$base = [
    'source_id' => 'application-pager-reader-cache-vdbe-control-literal-branch-fence',
    'epoch' => 622,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 622, 0])),
    'publication_generation' => 622,
    'master_source_digest' => hash('sha256', 'application vdbe control literal branch fence master source'),
...
$cache = [1 => array_merge($base, ['reader_id' => 'wp-options-reader', 'image' => $recovered[1], 'reader_cache_stmt_vdbe_null_branch_token' => 'stmt-vdbe-null-branch-old'])];
