...
$nextView = $view;
$nextView['source'] = 'main@view-cookie-224-next';
$nextView['trigger_source'] = 'main@trigger-cookie-224-next';
$postResetView = $view;
$postResetView['source'] = 'main@view-cookie-224-post-reset';
$postResetView['trigger_source'] = 'main@trigger-cookie-224-post-reset';
$followingView = $view;
$followingView['source'] = 'main@view-cookie-224-following';
$followingView['trigger_source'] = 'main@trigger-cookie-224-following';

$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNextPlan::executeCurrentReturningSourceSeal(
    [
...
if (
    ...
    || array_column($summary['visible_returning_payloads_source_seal'], 'name') !== ['app_summary_child', 'template_child', 'landing_url', 'next_module']
    || $summary['held_next_source_rows_source_seal'] !== []
) {
    fwrite(STDERR, "application-trigger-recursive-view-returning-current-source-source_seal self-test failed\n");
    exit(1);
}

echo "application-trigger-recursive-view-returning-current-source-source_seal self-test passed\n";
