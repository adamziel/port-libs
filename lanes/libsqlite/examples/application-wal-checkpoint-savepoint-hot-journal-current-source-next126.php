...
echo json_encode([
    'scenario' => 'application-wal-checkpoint-savepoint-hot-journal-current-source-next126',
    'applicationUse' => 'Recover a copied wp_options database from a hot rollback journal, discard WAL frames inside a failed plugin import savepoint, and checkpoint only the retained WAL prefix without requiring ext/sqlite.',
    'status' => $plan['status'],
    'reason' => $plan['reason'],
