...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext185Plan.php';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext185Plan::plan(
    $databasePath,
    $masterPath,
    $masterBytes,
    $journalBytes,
