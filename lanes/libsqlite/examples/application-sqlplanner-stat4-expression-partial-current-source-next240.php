...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next240 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next240',
    'applicationUse' => 'Copied wp_options plugin scans can reuse a current STAT4 partial expression index only after proving current partial predicates and rejecting stale prepared-only predicate terms.',
    'status' => $plan['status'],
