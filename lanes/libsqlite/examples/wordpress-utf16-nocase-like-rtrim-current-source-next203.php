...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext203Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext203Plan::wordpressOptionNameFullScanPlan($current, $next);
