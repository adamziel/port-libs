...
echo json_encode([
    'scenario' => 'wordpress-create-index-expression-collation-preflight',
    'expressionIndexes' => [
        'lowerName' => [
    ...
    'wordpressUse' => 'Preflight copied wp_options CREATE INDEX expression terms that SQLite stores with redundant parentheses around expression/collation syntax before trusting expression-index root pages.',
