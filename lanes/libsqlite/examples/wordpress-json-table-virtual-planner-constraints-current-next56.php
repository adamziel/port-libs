...
echo json_encode([
    'scenario' => 'wordpress-json-table-virtual-planner-constraints-current-next56',
    'idxStr' => $plan['idxStr'],
    ...
    'wordpressUse' => 'Copied wp_options JSON diagnostics can expose the SQLite virtual-table xFilter argv tape for json_tree() visible constraints while residual predicates remain outside the cursor argument stream.',
