...
if ($databasePath === null || $prefixJson === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-prefixed-option-name-range.php path/to/wordpress.sqlite '{\"autoload\":\"no\",\"option_value\":\"cached-feed\"}' [lower_inclusive|-] [upper_bound|-] [limit] [upper_inclusive]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedNameRangeWithPrefix($equalityPrefix, $lowerInclusive, $upperBound, $limit, $upperInclusive),
);
