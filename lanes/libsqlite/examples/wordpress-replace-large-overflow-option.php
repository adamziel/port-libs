...
echo json_encode([
    'wordpressUse' => 'Rewrite a large wp_options row to a larger overflow value, allocating the new overflow chain before freeing obsolete overflow pages, without the SQLite extension.',
    'plan' => $plan->toArray(),
