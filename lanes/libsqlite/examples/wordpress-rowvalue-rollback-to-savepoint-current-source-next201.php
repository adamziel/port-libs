...
require_once __DIR__ . '/../src/SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext201Plan.php';

use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext201Plan;
...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext201Plan::execute(
    ['wp_options' => $rows],
