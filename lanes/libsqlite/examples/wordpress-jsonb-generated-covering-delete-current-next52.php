...
$summary = [
    'scenario' => 'wordpress-jsonb-generated-covering-delete-current-next52',
    'wordpressUse' => 'Delete copied wp_options JSONB plugin rows through a generated-column covering index while returning generated JSONB values and emitting current index-entry deletes without requiring ext/sqlite.',
...
if (PHP_SAPI === 'cli' && realpath($_SERVER['SCRIPT_FILENAME'] ?? '') === __FILE__) {
    if ($summary['coveringIndex'] !== 'idx_wp_options_delete_channel_covering' || $summary['deletedIds'] !== [201, 204] || $summary['deleteEntryCount'] !== 4) {
        fwrite(STDERR, "wordpress-jsonb-generated-covering-delete-current-next52 self-test failed\n");
        exit(1);
    }

    echo "wordpress-jsonb-generated-covering-delete-current-next52 self-test passed\n";
}
