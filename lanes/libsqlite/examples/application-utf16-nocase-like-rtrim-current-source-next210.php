...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::optionRowNameEmbeddedNulPlan(
    $currentRows,
    $nextRows,
    "plugin\0cache%",
    null,
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "application-utf16-nocase-like-rtrim-current-source-next210 self-test passed\n";
}
