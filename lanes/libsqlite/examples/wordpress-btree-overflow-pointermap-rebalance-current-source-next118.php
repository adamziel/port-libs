...
echo 'WordPress btree118 transition pages: ' . implode(',', array_column($rows, 'page_number')) . PHP_EOL;
echo 'WordPress btree118 current types: ' . implode(',', array_map(static fn (?string $type): string => $type ?? 'none', array_column($rows, 'current_type_name'))) . PHP_EOL;
echo 'WordPress btree118 next types: ' . implode(',', array_column($rows, 'next_type_name')) . PHP_EOL;
echo 'WordPress btree118 roles: ' . implode(',', array_column($rows, 'rebalance_role')) . PHP_EOL;
echo 'WordPress btree118 replacement pages: ' . implode(',', $plan->rebalancePlan->replacementOverflowPageNumbers()) . PHP_EOL;
