...
$report = [
    ...
    'wordpressUse' => 'Preview copied wp_options rows filtered by correlated EXISTS and IN subqueries without ext/sqlite before import or repair tooling applies SELECT result ordering.',
];
