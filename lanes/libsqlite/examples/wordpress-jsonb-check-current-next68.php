...
echo json_encode([
    'scenario' => 'wordpress-jsonb-check-current-next68',
    ...
    'wordpressUse' => 'Preflight copied wp_options JSONB plugin settings with optional JSON paths before admitting current/next rows to storage.',
