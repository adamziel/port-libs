...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackConflictRetry(
    $tables,
    [$outer],
    [$savepoint],
    [$rollback],
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application rowvalue rollback savepoint next204 self-test passed\n";
    return;
}
