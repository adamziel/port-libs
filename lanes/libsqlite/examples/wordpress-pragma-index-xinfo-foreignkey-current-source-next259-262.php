...
$summary = [
    'scenario' => 'wordpress-pragma-index-xinfo-foreignkey-current-source-next259-262',
    'wordpressUse' => 'Copied WordPress taxonomy tables can distinguish absent, partial, expression, and misordered child-side lookup indexes before cascading foreign-key actions scan large child tables.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-index-xinfo-foreignkey-current-source-next259-262 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-index-xinfo-foreignkey-current-source-next259-262 self-test passed\n");
    exit(0);
}
