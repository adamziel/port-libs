...
echo json_encode([
    ...
    'indexPageCellPointers' => $database->pageHeader(3)->cellPointers($database->page(3)),
    'indexCellHexPrefixes' => [
        bin2hex(substr(SQLiteIndexCell::encode(SQLiteRecord::encode(['home', 2])), 0, 12)),
        bin2hex(substr(SQLiteIndexCell::encode(SQLiteRecord::encode(['siteurl', 1])), 0, 12)),
    ],
