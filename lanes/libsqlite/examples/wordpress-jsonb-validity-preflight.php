...
echo json_encode([
    'checks' => $checks,
    'wordpressUse' => 'Fast preflight SQLite JSONB wp_options option_value BLOBs copied from another store; superficial-only blobs should be scheduled for strict decode or repair before plugin settings are trusted.',
