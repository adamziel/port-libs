...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNext234Plan::execute(
    [
...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-upsert-current-source-next234 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-upsert-current-source-next234 self-test passed\n";
echo json_encode([
    'scenario' => 'wordpress-trigger-recursive-view-upsert-current-source-next234',
    ...
    'wordpressUse' => 'Copied wp_options imports through recursive INSTEAD OF view UPSERT triggers hold next-source RETURNING rows until the current-source conflict-key receipts are acknowledged.',
