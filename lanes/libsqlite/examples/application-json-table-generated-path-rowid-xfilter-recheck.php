...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-xfilter-recheck self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-json-table-generated-path-rowid-xfilter-recheck',
    'applicationUse' => 'Copied wp_options active_plugins diagnostics recheck generated-path rowid checkpoint rows before reusing a json_tree cursor after plugin settings change.',
