...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-current-source-next224',
    'applicationUse' => 'A copied Application database keeps schema/options reader-cache pages only when their shared-cache reader lease was opened after master-journal cleanup; active_plugins readers pinned before cleanup reopen.',
    'status' => $plan['status'],
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next224'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-current-source-next224 self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-current-source-next224 self-test passed\n";
