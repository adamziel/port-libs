...
if ($databasePath === null || $optionName === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-lowercase-custom-collation-option-lookup.php path/to/wordpress.sqlite option_name [WPSLUG]\n");
    exit(1);
}
...
$options = $database->wordpressOptionsByIndexedLowercaseNameWithCollation(
    $optionName,
    $collationName,
