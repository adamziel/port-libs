...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options UPSERT RETURNING rows where trigger-updated rows are checked against statement-current UNIQUE option_name, slug, and slot values without requiring ext/sqlite.',
