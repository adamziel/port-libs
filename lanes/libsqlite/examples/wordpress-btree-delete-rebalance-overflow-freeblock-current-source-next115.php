...
echo 'WordPress transient delete source hash: ' . substr($plan->currentSourcePageHash, 0, 12) . PHP_EOL;
echo 'WordPress transient delete next hash: ' . substr($plan->nextLeafPageHash, 0, 12) . PHP_EOL;
echo 'WordPress transient delete freed overflow pages: ' . implode(',', $plan->obsoleteOverflowPageNumbers) . PHP_EOL;
echo 'WordPress transient delete write order: ' . implode(',', $plan->writeOrderPageNumbers) . PHP_EOL;
echo 'WordPress transient delete freeblock delta: ' . $plan->freeblockBytesDelta . PHP_EOL;
