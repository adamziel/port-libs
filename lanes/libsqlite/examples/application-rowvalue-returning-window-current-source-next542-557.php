...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next542-557 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next526-541 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next542-557 self-test passed\n";
    return;
}
