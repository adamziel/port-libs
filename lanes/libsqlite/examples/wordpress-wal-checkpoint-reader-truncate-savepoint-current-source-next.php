...
$summary = [
    'scenario' => 'wordpress-wal-checkpoint-reader-truncate-savepoint-current-source-next128',
    'wordpressUse' => 'A copied WordPress SQLite database rolls a plugin import back to a WAL savepoint while a reader still pins the retained current WAL prefix; truncate checkpoint must preserve that source until the reader releases.',
    'status' => $plan['status'],
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-wal-checkpoint-reader-truncate-savepoint-current-source-next128 self-test passed\n";
    return;
}
