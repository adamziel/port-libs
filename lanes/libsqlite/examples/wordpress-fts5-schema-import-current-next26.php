...
echo json_encode([
    'wordpressUse' => 'Preview imported WordPress FTS5 virtual table schema, shadow tables, tokenizer/prefix settings, external-content rebuild admission, and unindexed columns without requiring ext/sqlite.',
    'status' => $plan['status'],
