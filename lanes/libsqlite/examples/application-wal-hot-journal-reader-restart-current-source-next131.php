...
$summary = [
    'scenario' => 'application-wal-hot-journal-reader-restart-current-source-next131',
    'applicationUse' => 'After a copied wp_options import leaves a hot rollback journal and a pinned WAL reader, native PHP tooling can restart the current reader from the preserved WAL bytes while keeping the released restart generation separate for later readers.',
    'status' => $plan['status'],
