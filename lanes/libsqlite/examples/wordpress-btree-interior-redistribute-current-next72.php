...
echo json_encode([
    ...
    'summary' => 'Current underfull interior page 7 borrows from next sibling page 8, rewrites the parent divider, and retargets moved child pointer-map ownership before a copied WordPress options repair continues.',
