...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafPublishFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-apply-window',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-apply-window self-test passed\n";
}
