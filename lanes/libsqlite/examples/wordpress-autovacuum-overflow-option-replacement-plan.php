...
$plan = $database->planWordPressOptionReplace('theme_mods_twentyfive', $newThemeMods, 'no');
...
echo json_encode([
    'wordpressUse' => 'Preflight a large wp_options theme_mods replacement in an auto-vacuum SQLite database while marking obsolete overflow pages free and assigning pointer-map owners for the new overflow chain.',
    'plan' => [
