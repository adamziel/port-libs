...
$report = [
    'scenario' => 'wordpress-wal-checkpoint-restart-reader-map-current-next37',
    'wordpressUse' => 'During a copied wp_options import checkpoint restart, preserve the current reader map pinned by SHM read marks while mapping the next reader against checkpointed database bytes.',
    'status' => $plan['status'],
