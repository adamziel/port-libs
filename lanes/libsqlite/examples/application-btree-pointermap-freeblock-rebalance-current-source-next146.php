...
$summary = [
    'scenario' => 'application-btree-pointermap-freeblock-rebalance-current-source-next146',
    'application_use' => 'Delete an oversized copied wp_options transient, apply the leaf freeblock rebalance, free its obsolete overflow pages, and reuse them in the replacement overflow chain with fresh auto-vacuum pointer-map parents.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "application-btree-pointermap-freeblock-rebalance-current-source-next146 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "application-btree-pointermap-freeblock-rebalance-current-source-next146 self-test passed\n");
    exit(0);
}
