...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options plugin settings can keep a hidden json/root json_tree() cursor open while generated priority/slug ORDER BY keys are recomputed for the next source row.',
];
