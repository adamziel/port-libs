...
$base = [
    'source_id' => 'application-pager-reader-cache-next894',
    'epoch' => 894,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 894, 0])),
    'publication_generation' => 894,
    'master_source_digest' => hash('sha256', 'application next894 master source'),
...
$read = array_merge($base, [
    ...
    'reader_cache_stmt_vdbe_compare_affinity_branch_handoff_token' => 'stmt-vdbe-compare-affinity-branch-handoff-old',
]);
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeArithmeticBranchHandoffFence(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
echo json_encode([
    ...
    'next894_reopen_reason' => $plan['next_reads'][0]['reader_cache_stmt_vdbe_compare_affinity_branch_handoff_token_reason'],
