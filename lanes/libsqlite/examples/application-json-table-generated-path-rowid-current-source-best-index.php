...
$summary = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next173',
    'applicationUse' => 'Copied wp_options plugin-rule previews can keep a current json_tree() xBestIndex plan pinned when generated path and rowid argv constraints remain usable, then force a next-source reprepare when the generated path points at a different rowset.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next173 self-test passed\n";
    return;
}
