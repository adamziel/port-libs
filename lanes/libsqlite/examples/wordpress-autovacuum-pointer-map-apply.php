...
echo json_encode([
    'scenario' => 'wordpress-autovacuum-pointer-map-apply',
    'wordpressUse' => 'Apply copied wp_options auto-vacuum pointer-map page images after a repair moves a transient leaf and retargets overflow ownership without ext/sqlite.',
