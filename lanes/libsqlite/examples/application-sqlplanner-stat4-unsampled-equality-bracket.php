...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next171 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next171',
    'applicationUse' => 'Preview copied wp_options plugin scans after ANALYZE when the requested lower(option_name) key is not itself a sqlite_stat4 sample but is bracketed by current samples.',
    'status' => $plan['status'],
