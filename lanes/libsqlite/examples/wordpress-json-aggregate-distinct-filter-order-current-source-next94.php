...
$report = [
    'scenario' => 'wordpress-json-aggregate-distinct-filter-order-current-source-next94',
    'wordpressUse' => 'Copied wp_options diagnostics can compute parser-level JSON aggregate summaries with DISTINCT, FILTER, and multi-term aggregate-local ORDER BY before WordPress import or repair tooling commits option changes.',
    'sqlShape' => $sql,
    'groups' => $rows,
