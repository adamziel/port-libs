...
require_once __DIR__ . '/../src/SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan.php';
...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan::execute(
    $tables,
    $attempt,
    $retry,
    [['blog_id', 'option_name']],
