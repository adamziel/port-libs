...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-seek-cost-current-source-next159',
    'applicationUse' => 'Copied wp_options JSON rule diagnostics can keep a generated path cursor pinned while xBestIndex-style rowid IN seeks are costed against the current and next JSON table row tape.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-seek-cost-current-source-next159 self-test passed\n";
    return;
}
