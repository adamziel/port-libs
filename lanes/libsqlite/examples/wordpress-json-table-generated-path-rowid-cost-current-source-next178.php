...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext178(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next178',
    'wordpressUse' => 'Copied wp_options plugin-rule import previews can resume a pinned generated-path rowid json_tree cursor after a yielded rowid, while a changed next-source cache fence restarts xFilter instead of reusing stale rows.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next178 self-test passed\n";
    return;
}
