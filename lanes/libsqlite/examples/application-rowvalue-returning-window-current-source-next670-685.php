...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next670-685 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next654-669 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next670-685 self-test passed\n";
    return;
}
