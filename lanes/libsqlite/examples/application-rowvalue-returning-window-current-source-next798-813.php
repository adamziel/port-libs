...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next798-813 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from integrated next782-797.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next798-813 self-test passed\n";
    return;
}
