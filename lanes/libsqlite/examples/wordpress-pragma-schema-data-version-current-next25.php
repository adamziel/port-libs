...
echo json_encode([
    ...
    'wordpressUse' => 'Preview PRAGMA schema_version and data_version current/next rows for WordPress import tools that need to distinguish schema-cookie writes from another connection committing data.',
    'before' => [
