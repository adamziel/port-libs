...
$summary = [
    ...
    'wordpressUse' => 'A copied WordPress database can keep a schema reader-cache page only after the current master journal points at a checksum-valid rollback journal scanned to EOF; stale active_plugins cache rows reopen before the next import write.',
