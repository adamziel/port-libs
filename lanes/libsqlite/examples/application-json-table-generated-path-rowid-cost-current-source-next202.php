...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next202 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next202',
    'applicationUse' => 'Copied wp_options active_plugins diagnostics can continue a pinned generated-path rowid json_tree cursor through xNext only while the source fingerprint remains reusable.',
