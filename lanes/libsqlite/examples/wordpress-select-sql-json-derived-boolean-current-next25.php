...
return [
    'scenario' => 'wordpress-select-sql-json-derived-boolean-current-next25',
    'wordpressUse' => 'Local-only wp_options plugin-setting preview that mirrors SQLite JSON boolean truth predicates for json_extract(), jsonb_extract(), ->>, TRUE/FALSE literals, NOT, and IS TRUE/FALSE without requiring ext/sqlite.',
