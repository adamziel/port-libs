...
$plan = SQLiteAttachWalTempSchemaCacheCurrentSourceNext92Plan::currentSourceNext185188($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-attach-temp-wal-schema-cache-current-source-next185-188 self-test passed\n";
    return;
}
