...
$tests = require dirname(__DIR__) . '/tests/SQLiteBTreePageMoveFreelistRebalanceCurrentSourceNext85Test.php';
$runner = new TestRunner();
$failures = 0;
$error = null;

try {
    $tests['btree page move freelist rebalance current source next85 page move parent update']($runner);
...
echo json_encode([
    ...
    'failures' => $failures,
    'error' => $error,
    'focusedTest' => 'SQLiteBTreePageMoveFreelistRebalanceCurrentSourceNext85Test.php',
