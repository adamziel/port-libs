...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext174Plan.php';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext174Plan::plan(
    $databasePath,
    $masterPath,
    $networkJournal . "\n" . $mainJournal . "\n",
    $journalBytes,
