...
$exact = SQLiteUtf16LikeGlobCurrentNextCursor::wordpressOptionNameScan($rows, 'plugin-cache', 'GLOB', 'UTF-16LE', 'RTRIM');
$wildcard = SQLiteUtf16LikeGlobCurrentNextCursor::wordpressOptionNameScan($rows, 'plugin-cache*', 'GLOB', 'UTF-16LE', 'RTRIM');
...
$summary = [
    'scenario' => 'wordpress-utf16-rtrim-like-glob-current-source-next90',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-utf16-rtrim-like-glob-current-source-next90 self-test passed\n";
    return;
}
