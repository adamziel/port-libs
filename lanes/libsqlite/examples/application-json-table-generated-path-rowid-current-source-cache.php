...
$summary = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next175',
    'applicationUse' => 'Copied wp_options plugin-rule diagnostics can reuse a pinned generated-path rowid json_tree cache only while the source generation, rowid argv scope, and xBestIndex fingerprint stay stable across an import preview.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next175 self-test passed\n";
    return;
}
