...
if ($plan === null) {
    fwrite(STDERR, "wordpress-jsonb-path-index-covering-current-next34 failed: no plan\n");
    exit(1);
}
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-jsonb-path-index-covering-current-next34 self-test passed\n";
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-jsonb-path-index-covering-current-next34',
