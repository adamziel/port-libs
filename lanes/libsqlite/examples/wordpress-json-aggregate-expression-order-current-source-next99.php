...
$payload = [
    'wordpressUse' => 'Copied wp_options diagnostics can compute JSON aggregate summaries where aggregate-local ORDER BY uses an expression, so import ranking formulas do not have to be materialized as temporary columns before DISTINCT/FILTER processing.',
