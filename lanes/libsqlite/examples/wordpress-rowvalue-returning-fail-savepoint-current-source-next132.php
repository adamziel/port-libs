...
$summary = [
    'scenario' => 'wordpress-rowvalue-returning-fail-savepoint-current-source-next132',
    'wordpressUse' => 'Model a copied wp_options import savepoint where UPDATE OR FAIL with row-value assignments yields earlier RETURNING rows, preserves those earlier row changes, restores only the conflicting row, and leaves the savepoint open for caller recovery.',
    'status' => $plan['status'],
