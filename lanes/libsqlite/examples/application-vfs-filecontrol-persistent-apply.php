...
$root = sys_get_temp_dir() . '/port-libsqlite-application-vfs-filecontrol-persist75-' . bin2hex(random_bytes(4));
...
echo json_encode([
    'scenario' => 'application-vfs-filecontrol-persistence-persistent-file-control-apply',
    'applicationUse' => 'Persist durable SQLite xFileControl settings for a copied wp_options database across close/reopen while releasing process locks and dropping per-connection hints/timeouts.',
    'path' => $databasePath,
