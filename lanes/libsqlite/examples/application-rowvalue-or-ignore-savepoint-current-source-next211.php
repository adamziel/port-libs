...
$summary = [
    'scenario' => 'application-rowvalue-or-ignore-savepoint-current-source-next211',
    'applicationUse' => 'Copied wp_options repair can suppress RETURNING rows for UPDATE OR IGNORE row-value conflicts while preserving prior savepoint mutations and feeding later cleanup statements from the current source.',
    'status' => $plan['status'],
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-rowvalue-or-ignore-savepoint-current-source-next211 self-test passed\n";
    return;
}
