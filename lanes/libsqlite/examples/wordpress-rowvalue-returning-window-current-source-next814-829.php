...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next814-829 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next813_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next814-829 self-test passed\n";
    return;
}
