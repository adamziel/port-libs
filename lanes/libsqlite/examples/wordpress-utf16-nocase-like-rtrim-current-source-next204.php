...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext204Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext204Plan::wordpressOptionNameNonAsciiPrefixPlan($current, $next);
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next204 self-test passed\n";
