...
echo json_encode([
    'wordpressUse' => 'Copied wp_options cleanup coalesces fragmented table-leaf freeblocks before releasing obsolete overflow pages, then incremental-vacuums only tail overflow pages while preserving a live page.',
    'scenario' => 'wordpress-btree-overflow-freeblock-vacuum-current-source-next122',
