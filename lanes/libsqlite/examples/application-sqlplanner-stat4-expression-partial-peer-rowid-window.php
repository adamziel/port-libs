...
$prepared = [
    'name' => 'prepared-application-options-next210',
    'schemaCookie' => 2100,
    'stat4Generation' => 210,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-application-options-next210';
...
echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next210',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'Copied wp_options diagnostics can reprepare a stale STAT4 partial expression index and preserve SQLite rowid tie-break order for duplicate lower(option_name) plugin rows without ext/sqlite.',
