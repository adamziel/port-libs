...
echo json_encode([
    'scenario' => 'application-wal-checkpoint-current-source-next93',
    'applicationUse' => 'Report copied wp_options WAL checkpoint source transitions so import tooling keeps an active reader on the verified current sidecar while later readers use checkpointed database pages and final readers use the reset WAL generation without ext/sqlite.',
    'status' => $plan['status'],
