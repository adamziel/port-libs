...
if ($databasePath === null || $optionName === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-custom-collation-option-lookup.php path/to/wordpress.sqlite option_name [WPCASE|BACKWARDS]\n");
    exit(1);
}
...
$options = $database->wordpressOptionsByIndexedNameWithCollation(
    $optionName,
    $collationName,
