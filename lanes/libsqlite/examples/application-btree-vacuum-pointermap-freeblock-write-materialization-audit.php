...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next212',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, apply only the latched current-source pointer-map/freeblock pages in pointer-map-before-payload order.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next212 self-test passed\n";
}
