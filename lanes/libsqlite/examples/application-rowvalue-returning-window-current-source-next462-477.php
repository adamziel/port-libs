...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next462-477 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next446-461 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next462-477 self-test passed\n";
    return;
}
