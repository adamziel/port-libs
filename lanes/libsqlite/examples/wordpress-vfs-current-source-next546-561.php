...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext546561Plan.php';
...
$plan = SQLiteVfsCurrentSourceNext546561Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next546-561 self-test passed\n";
    return;
}
