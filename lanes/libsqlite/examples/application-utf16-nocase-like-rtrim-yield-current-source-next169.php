...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::optionRowNameYieldReplayPlan(
    [
...
if (PHP_SAPI === 'cli' && in_array('--self-test', $argv, true)) {
    ...
    echo "application-utf16-nocase-like-rtrim-yield-current-source-next169 self-test passed\n";
