...
echo json_encode([
    'wordpressUse' => 'Preview a copied wp_options import that combines a recursive staging queue using SQLite LIMIT offset,count syntax with window-ranked option rows before a compound SELECT final LIMIT.',
