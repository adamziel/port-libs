...
$plan = SQLiteAttachWalTempSchemaCacheCurrentSourceNextPlan::schemaCachePublishHandoffWindow($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-attach-temp-wal-schema-cache-publish-handoff-window self-test passed\n";
    return;
}
