...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext240Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext240Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
