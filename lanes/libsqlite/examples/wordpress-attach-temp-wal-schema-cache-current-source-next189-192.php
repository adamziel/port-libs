...
$plan = SQLiteAttachWalTempSchemaCacheCurrentSourceNext92Plan::currentSourceNext189192($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-attach-temp-wal-schema-cache-current-source-next189-192 self-test passed\n";
    return;
}
