...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidOffsetCost(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next210',
    'applicationUse' => 'Copied wp_options plugin-rule inspectors can resume a generated-path json_tree rowid range with OFFSET/LIMIT without re-reading skipped rows when the current-source generation and range fingerprint still match.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next210 self-test passed\n";
    return;
}
