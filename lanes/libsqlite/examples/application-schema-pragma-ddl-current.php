...
if (($argv[1] ?? null) === '--self-test') {
    ...
    fwrite(STDOUT, "application-schema-pragma-ddl-current self-test passed\n");
    return;
}

echo json_encode([
    'scenario' => 'application-schema-pragma-ddl-current',
    'applicationUse' => 'Copied Application schema migrations can apply DDL, refresh PRAGMA table/index metadata, bump schema_version/header state, and keep same-connection data_version stable before reusing prepared wp_options readers.',
