...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports can validate the prepared after-current seal row-value UPDATE/DELETE RETURNING handoff as attestation, manifest, bridge, and final seal receipts.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-after-current-seal self-test passed\n";
    return;
}
