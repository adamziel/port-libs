...
$summary = [
    'scenario' => 'wordpress-pragma-index-xinfo-foreignkey-current-source-next248-251',
    'wordpressUse' => 'WordPress schema import checks can keep external parent UNIQUE indexes, generated child columns, generated-child repair, and expression child action indexes visible in one PRAGMA/FK handoff.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-index-xinfo-foreignkey-current-source-next248-251 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-index-xinfo-foreignkey-current-source-next248-251 self-test passed\n");
    exit(0);
}
