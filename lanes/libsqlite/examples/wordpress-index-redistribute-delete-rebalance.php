...
echo json_encode([
    'scenario' => 'wordpress-index-redistribute-delete-rebalance',
    'wordpressUse' => 'Preview a copied wp_options autoload-index delete/rebalance path that redistributes cells from a fuller right sibling into an underfilled left sibling, updates the parent divider, and avoids placing either sibling on the freelist.',
