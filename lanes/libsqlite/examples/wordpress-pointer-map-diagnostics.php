...
echo json_encode([
    'wordpressUse' => 'Inspect SQLite auto-vacuum pointer-map metadata before wp_options repair planning so page moves, free pages, and overflow chains are not treated as ordinary b-tree pages.',
