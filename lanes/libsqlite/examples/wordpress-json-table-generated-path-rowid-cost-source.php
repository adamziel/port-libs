...
$summary = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next160',
    'wordpressUse' => 'Copied wp_options plugin-rule previews can pin a generated JSON path and rowid alias seek to the current json_tree() source, while fingerprinting the next source before a virtual-table filter reset.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next160 self-test passed\n";
    return;
}
