...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext240Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext240Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next240',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient, vacuum reuse must admit payload/freeblock pages only after current-source pointer-map generations are visible.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next240 self-test passed\n";
}
