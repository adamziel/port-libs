...
require_once __DIR__ . '/../src/SQLitePlannerStat4ExpressionPartialCurrentSourceNext175Plan.php';
require_once __DIR__ . '/../src/SQLitePlannerStat4ExpressionPartialCurrentSourceNext190Plan.php';

use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext190Plan;

$prepared = [
    'name' => 'prepared-wordpress-options-next190',
    'schemaCookie' => 1900,
    'stat4Generation' => 64,
    'rows' => [
...
$current = $prepared;
$current['name'] = 'current-wordpress-options-next190';
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext190Plan::materialize(
    $prepared,
    $current,
    [
