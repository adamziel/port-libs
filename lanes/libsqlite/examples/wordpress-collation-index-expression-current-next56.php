...
echo json_encode([
    'scenario' => 'wordpress-collation-index-expression-current-next56',
    ...
    'wordpressUse' => 'Copied wp_options expression-index scans preserve current/next cursor boundaries under custom expression collations before rowid tie-breaks.',
