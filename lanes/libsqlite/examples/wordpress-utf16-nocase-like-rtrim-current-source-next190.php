...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext180Plan.php';
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext183Plan.php';
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext190Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext190Plan::wordpressOptionNameAsciiSpaceTrimBoundaryPlan(
    $current,
    $next,
    'plugin%',
    null,
...
if (in_array('--self-test', $argv, true)) {
    assert($plan['status'] === 'utf16-nocase-like-rtrim-current-source-next190');
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next190 self-test passed\n";
