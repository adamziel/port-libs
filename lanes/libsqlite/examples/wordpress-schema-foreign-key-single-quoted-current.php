...
$summary = [
    'scenario' => 'wordpress-schema-foreign-key-single-quoted-current',
    'wordpressUse' => 'Copied legacy WordPress export schemas can preserve PRAGMA foreign_key_list rows when sqlite_schema SQL uses single-quoted identifiers for option metadata tables.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-schema-foreign-key-single-quoted-current self-test passed\n";
    return;
}
