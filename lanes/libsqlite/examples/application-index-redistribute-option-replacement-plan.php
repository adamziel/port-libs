...
echo json_encode([
    'applicationUse' => 'Plan a wp_options replacement that disables autoload, redistributes an underfilled composite secondary-index leaf with its sibling, and keeps the rewritten option reachable without the SQLite extension.',
    'plan' => $plan->toArray(),
