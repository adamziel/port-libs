...
echo json_encode([
    'optionJson' => $report,
    'wordpressUse' => 'Local-only wp_options JSON review output that mirrors SQLite json_pretty() for strict JSON text, JSON5 plugin settings, custom indentation, cast text BLOBs, JSONB option blobs, scalar SQL option values including whole REAL values, NULL option values, and malformed settings before import.',
