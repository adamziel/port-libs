...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext194Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext194Plan::execute(
    [
