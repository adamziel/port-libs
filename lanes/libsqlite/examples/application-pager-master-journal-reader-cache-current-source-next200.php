...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-current-source-next200',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'A copied Application options reader spanning active_plugins and a byte-identical users page reopens after the users rollback-journal generation advances under a master-journal recovery.',
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next200'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-current-source-next200 self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-current-source-next200 self-test passed\n";
