...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafManifestAuditFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next192',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient, the next reader is admitted only after checkpoint tokens, page hashes, pointer-map pages, leaf freeblocks, and fenced-tail exclusions all validate.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next192 self-test passed\n";
}
