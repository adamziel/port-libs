...
echo json_encode([
    'scenario' => 'wordpress-autovacuum-index-page-move',
    'wordpressUse' => 'Preview copied wp_options autoload index cleanup where the last index leaf page is moved into a lower freelist slot, the index parent pointer is rewritten, and overflow pointer-map ownership follows the moved page without ext/sqlite.',
    'plan' => $plan->toArray(),
    'movedIndexLeaf' => [
        'page' => 5,
