...
echo json_encode([
    'wordpressUse' => 'Release copied wp_options table/index overflow chains by following current SQLite next-page pointers, then secure-delete freelist leaves and rewrite auto-vacuum pointer-map entries without ext/sqlite.',
