...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-path-operator-precedence self-test passed\n";
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-json-path-operator-precedence',
    'wordpressUse' => 'Copied wp_options JSON diagnostics preserve SQLite precedence where ||, ->, and ->> share one left-associative precedence tier, while parenthesized concatenation can still build a JSON path RHS.',
    'sql' => $sql,
    'rows' => $result,
