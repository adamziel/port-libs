...
$summary = [
    'scenario' => 'application-wal-checkpoint-hot-journal-reader-hot-journal-reader',
    'applicationUse' => 'A copied Application SQLite database starts with a hot rollback journal from an interrupted import, then a WAL reader pins the recovered current source while checkpoint restart is attempted.',
    'status' => $plan['status'],
...
if (in_array('--self-test', $argv, true)) {
    assert($summary['status'] === 'wal-checkpoint-hot-journal-reader-hot-journal-reader');
    ...
    echo "application-wal-checkpoint-hot-journal-reader-hot-journal-reader self-test passed\n";
    return;
}
