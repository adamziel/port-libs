...
$summary = [
    'scenario' => 'wordpress-planner-stat4-covering-or-order-current-next54',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    fwrite(STDOUT, "wordpress-planner-stat4-covering-or-order-current-next54 self-test passed\n");
    exit(0);
}
