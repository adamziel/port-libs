...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options import diagnostics through VDBE-style GROUPS CURRENT ROW AND N FOLLOWING frames, combining FILTER truthiness with EXCLUDE CURRENT ROW peer handling without requiring ext/sqlite.',
    'rows' => $summary,
