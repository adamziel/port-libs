...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext226229Plan.php';

use PortLibs\LibSqlite\SQLiteVfsCurrentSourceNext226229Plan;

$plan = SQLiteVfsCurrentSourceNext226229Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next226-229 self-test passed\n";
    return;
}
