...
require_once dirname(__DIR__) . '/src/SQLitePagerHotJournalStatementCacheCurrentSourceNext104Plan.php';
...
$plan = SQLitePagerHotJournalStatementCacheCurrentSourceNext104Plan::plan(
    $pageSize,
