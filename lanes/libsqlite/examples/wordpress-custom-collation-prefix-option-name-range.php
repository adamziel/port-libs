...
if ($databasePath === null || $prefixJson === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-custom-collation-prefix-option-name-range.php path/to/wordpress.sqlite '{\"option_value\":\"plugin_core\"}' [lower_inclusive|-] [upper_bound|-] [WPSLUG|WPCASE|BACKWARDS] [limit] [upper_inclusive]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedNameRangeWithPrefixCollations(
        $equalityPrefix,
        $lowerInclusive,
        $upperBound,
        $customCollations,
