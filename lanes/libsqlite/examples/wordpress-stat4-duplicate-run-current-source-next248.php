...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext248Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext248Plan::materialize(
    $prepared,
    $current,
    $terms,
...
echo json_encode([
    'scenario' => 'wordpress-stat4-duplicate-run-current-source-next248',
    'status' => $plan['status'],
    ...
    'wordpressUse' => 'Prevents a copied wp_options partial expression-index cursor from reusing stale STAT4 duplicate-key sample runs after plugin option rows are duplicated with different case.',
