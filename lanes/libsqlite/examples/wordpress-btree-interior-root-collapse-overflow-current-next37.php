...
echo json_encode([
    'wordpressUse' => 'Apply a copied wp_options autoload index root-collapse where an index-interior child with an overflow-backed separator cell is copied into the root and the first-overflow pointer-map owner changes from the obsolete child to the root.',
