...
$summary = [
    'wordpressUse' => 'Show copied wp_options WAL reader/writer snapshot isolation in pure PHP: a current reader pinned before a writer append keeps old committed pages, the next reader sees the new committed option/index pages, and uncommitted writer tail frames stay invisible without ext/sqlite.',
