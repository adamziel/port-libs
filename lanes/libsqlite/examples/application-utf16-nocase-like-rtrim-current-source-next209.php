...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    assert($plan['status'] === 'utf16-nocase-like-rtrim-current-source-nexttwoZeroNine');
    ...
    echo "application-utf16-nocase-like-rtrim-current-source-nexttwoZeroNine self-test passed\n";
}
