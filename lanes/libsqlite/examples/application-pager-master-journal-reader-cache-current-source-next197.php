...
$sourceId = 'application-next197-master-member-current-source';
$nonce = 'application-import-master-member-next197';

$before = [
    1 => $page('next197 Application schema page before master member source'),
