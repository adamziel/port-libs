...
echo json_encode([
    'wordpressUse' => 'Apply a wp_options delete/rebalance root-collapse where an empty table-interior root copies its only child leaf into the root page, releases the obsolete child page to the freelist, and rewrites auto-vacuum pointer-map state without requiring ext/sqlite.',
    'plan' => $plan->toArray(),
