...
echo json_encode([
    'scenario' => 'wordpress-autovacuum-page-move',
    'wordpressUse' => 'Preview copied wp_options auto-vacuum cleanup where the last table leaf page is moved into a freed lower page, the parent pointer is rewritten, and the database image is truncated without ext/sqlite.',
    'plan' => $plan->toArray(),
    'movedLeaf' => [
        'page' => 5,
