...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext183Plan::wordpressOptionNameAsciiPrefixRangePlan($current, $next);
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next183 self-test passed\n";
    return;
}
