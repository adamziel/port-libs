...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the final ready-publication row-value UPDATE/DELETE RETURNING window current-source continuation without keeping numbered caller files.',
...
if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-ready-publication-final self-test passed\n";
    return;
}
