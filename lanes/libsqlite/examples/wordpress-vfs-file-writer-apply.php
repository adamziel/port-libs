...
$salt1 = 0x10203040;
$salt2 = 0x50607080;
$root = sys_get_temp_dir() . '/port-libsqlite-wordpress-vfs-writer-' . bin2hex(random_bytes(4));
...
echo json_encode([
    'scenario' => 'wordpress-vfs-file-writer-apply',
    'wordpressUse' => 'Apply accepted WAL checkpoint write plans through bounded native PHP file handles for copied wp_options database repairs, including database page writes, WAL restart/truncate sidecar writes, sync markers, and directory persistence diagnostics without ext/sqlite.',
    'root' => $root,
