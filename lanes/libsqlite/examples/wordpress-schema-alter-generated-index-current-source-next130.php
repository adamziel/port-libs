...
$summary = [
    'scenario' => 'wordpress-schema-alter-generated-index-current-source-next130',
    'wordpressUse' => 'Preview copied WordPress option-table migrations that add a generated lookup column and immediately create an index over that current sqlite_schema image before prepared option queries are reused.',
    'schemaCookie' => [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-schema-alter-generated-index-current-source-next130 self-test passed\n";
    return;
}
