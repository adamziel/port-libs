...
if (($argv[1] ?? null) === '--self-test') {
    ...
    if (in_array(false, $checks, true)) {
        fwrite(STDERR, 'wordpress-stat4-range-order-current-source-next92 self-test failed' . PHP_EOL);
        exit(1);
    }
    echo 'wordpress-stat4-range-order-current-source-next92 self-test passed' . PHP_EOL;
