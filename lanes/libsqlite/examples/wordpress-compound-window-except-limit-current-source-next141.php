...
require_once __DIR__ . '/../src/SQLiteCompoundWindowExceptLimitCurrentSourceNext141Plan.php';
...
$summary = SQLiteCompoundWindowExceptLimitCurrentSourceNext141Plan::compare($sql, $currentTables, $nextTables);
