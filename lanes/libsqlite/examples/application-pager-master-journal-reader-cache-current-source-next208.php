...
$sourceId = 'application-master-read-snapshot-source';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::variantRecoveredPageSetFence(
    ...
    [
        1 => [
            ...
            'master_source_digest' => hash('sha256', 'application-current-master-source-next208'),
    ...
    208,
    208,
    hash('sha256', 'application-current-master-source-next208'),
    208,
    $currentTokens,
    $currentHeaders,
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-pager-master-journal-reader-cache-current-source-next208 self-test passed\n";
    return;
}
