...
echo json_encode([
    'wordpressUse' => 'Delete an obsolete oversized wp_options transient and release its overflow pages into the freelist while clearing auto-vacuum pointer-map ownership.',
