...
if ($databasePath === null || $value === null || !preg_match('/^[+-]?\d+$/', $value)) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-option-value-integer.php path/to/wordpress.sqlite integer_value [limit]\n");
    exit(1);
}
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedIntegerOptionValue($integerValue, $limit),
);
