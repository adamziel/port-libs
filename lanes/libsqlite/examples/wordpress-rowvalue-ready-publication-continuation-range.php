...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate a row-value UPDATE/DELETE RETURNING window current-source ready-publication continuation range as the direct handoff from next1085_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-ready-publication-continuation-range self-test passed\n";
    return;
}
