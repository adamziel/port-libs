...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options import staging can order a compound SELECT by the staged arm aliases while returning the current left-most output names used by WordPress import code.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-compound-name-resolution-current-source-next121 self-test passed\n";
