...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options/plugin setting names can be previewed with json_group_array(DISTINCT name ORDER BY priority) over current/next window frames without ext/sqlite.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-aggregate-distinct-order-window-current-next75 self-test passed\n";
    exit(0);
}
