...
echo json_encode([
    'scenario' => 'wordpress-expression-index-partial-current-source-next121',
    'status' => $plan['status'],
    ...
    'wordpressUse' => 'Preview copied wp_options partial expression-index reprepare after schema changes so autoloaded siteurl/home lookups use the current lower(option_name) index without ext/sqlite.',
