...
echo json_encode([
    'scenario' => 'wordpress-vfs-lock-byte-range-current-next72',
    'wordpressUse' => 'Plan SQLite VFS byte-range lock current/next transitions for copied WordPress database readers and writers, showing retained, newly acquired, and released lock bytes before native VFS application without requiring ext/sqlite.',
    'databasePath' => $path,
    'reader' => [
