...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-limit',
    'applicationUse' => 'Copied wp_options JSON diagnostics can keep a generated-path json_tree rowid cursor on the active xCurrent row when ORDER BY rowid plus LIMIT is already satisfied, while a changed next source forces reprepare.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-limit self-test passed\n";
    return;
}
