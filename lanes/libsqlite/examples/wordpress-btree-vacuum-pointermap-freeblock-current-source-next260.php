...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext260Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext260Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next260',
    'wordpressUse' => 'After deleting an overflow-backed copied wp_options transient, reader-visible current-source handoff waits for pointer-map snapshots before exposing reusable freeblock pages.',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next260 self-test passed\n";
}
