...
require_once __DIR__ . '/../src/SQLiteCompoundSelectRecursiveAffinityLimitCurrentSourceNext149Plan.php';
...
$summary = SQLiteCompoundSelectRecursiveAffinityLimitCurrentSourceNext149Plan::compare(
    $sql,
...
return [
    'wordpressUse' => 'Preview recursive option dependency walks during wp_options imports where UNION duplicate handling keeps numeric and text storage classes distinct before final ORDER BY/LIMIT pagination.',
