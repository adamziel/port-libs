...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializeNext238(
    $prepared,
    $source,
    [
...
printf(
    "wordpress sqlplanner stat4 expression partial current-source next238: %s covered=%d payloads=%d signature=%s\n",
    $plan['status'],
