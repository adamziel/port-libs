...
$pages[106] = $overflowPage(107, 'A');
$pages[107] = $overflowPage(108, 'B');
$pages[108] = $overflowPage(109, 'C');
$pages[109] = $overflowPage(110, 'D');
$pages[110] = $overflowPage(0, 'E');
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafBtreePageAllocationFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next155',
    'allocatedBtreePages' => $plan->allocatedBtreePages(),
    'reusedVacuumFreePages' => $plan->reusedVacuumFreePages(),
    'pointerMapTransition' => [
        $plan->rows[0]['source_pointer_map_type'],
        $plan->rows[0]['vacuum_pointer_map_type'],
        $plan->rows[0]['next_pointer_map_type'],
    ],
