...
$summary = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next162',
    'wordpressUse' => 'Copied wp_options plugin-rule previews can preserve the SQLite rowid alias chosen by xBestIndex while reusing a generated-path json_tree() source only when path, rowid, order, and source fingerprints remain stable.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next162 self-test passed\n";
    return;
}
