...
use PortLibs\LibSqlite\SQLitePagerHotJournalSavepointCacheCurrentSourceNext157Plan;

$pageSize = 104;
$page = static fn (string $label): string => str_pad($label, $pageSize, '.', STR_PAD_RIGHT);

$plan = SQLitePagerHotJournalSavepointCacheCurrentSourceNext157Plan::currentSourceNext(
    $pageSize,
    'wp_option_import',
...
$summary = [
    'scenario' => 'wordpress-pager-hot-journal-savepoint-cache-current-source-next157',
    'wordpressUse' => 'A copied WordPress options import rejects stale same-token pager-cache images after hot-journal recovery before capturing savepoint and retry before-images.',
    'status' => $plan['status'],
