...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-next894',
    'epoch' => 894,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 894, 0])),
    'publication_generation' => 894,
    'master_source_digest' => hash('sha256', 'wordpress next894 master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::variantNext894(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
