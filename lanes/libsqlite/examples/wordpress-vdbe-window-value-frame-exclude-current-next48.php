...
echo json_encode([
    'scenario' => 'wordpress-vdbe-window-value-frame-exclude-current-next48',
    'wordpressUse' => 'Preview copied wp_options rows with VDBE-style first_value(), last_value(), and nth_value() over ROWS CURRENT ROW AND 2 FOLLOWING EXCLUDE CURRENT ROW frames, applying SQL FILTER truthiness without ext/sqlite.',
