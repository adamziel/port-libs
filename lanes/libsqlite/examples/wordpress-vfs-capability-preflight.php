...
echo json_encode([
    'scenario' => 'wordpress-vfs-capability-preflight',
    'wordpressUse' => 'Resolve bounded SQLite VFS file-control and device-capability decisions for copied WordPress databases before enabling native writes, WAL persistence, mmap previews, chunked growth, and rollback-journal sync policy.',
