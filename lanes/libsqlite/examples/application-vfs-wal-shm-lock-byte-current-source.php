...
$plan = SQLiteVfsWalShmLockBytePlan::plan([
    'selected_path' => $path,
    'sources' => [
        $path => [
            'path' => $path,
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-vfs-wal-shm-lock-byte-current-source self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-vfs-wal-shm-lock-byte-current-source',
    'database' => $path,
