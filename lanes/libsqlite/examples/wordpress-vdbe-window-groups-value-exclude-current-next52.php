...
$payload = [
    'scenario' => 'wordpress-vdbe-window-groups-value-exclude-current-next52',
    'wordpressUse' => 'Preview copied wp_options rows with VDBE-style first_value(), last_value(), and nth_value() over GROUPS CURRENT ROW AND 1 FOLLOWING EXCLUDE CURRENT ROW frames, including current/next peeks and SQL FILTER truthiness without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-vdbe-window-groups-value-exclude-current-next52 self-test passed\n";
    exit(0);
}
