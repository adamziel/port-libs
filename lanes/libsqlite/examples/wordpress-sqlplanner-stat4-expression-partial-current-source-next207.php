...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext207Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext207Plan::materialize(
    $prepared,
    $current,
    [
