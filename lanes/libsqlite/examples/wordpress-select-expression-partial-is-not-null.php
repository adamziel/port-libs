...
echo json_encode([
    'scenario' => 'wordpress-select-expression-partial-is-not-null',
    ...
    'wordpressUse' => 'Preview copied wp_options SELECT planning where explicit autoload/option_value IS NOT NULL predicates make a partial lower(option_name) expression index safe without requiring ext/sqlite.',
