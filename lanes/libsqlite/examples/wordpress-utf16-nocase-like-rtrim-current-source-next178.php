...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext178Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext178Plan::wordpressOptionNameCanonicalTokenPlan(
    $current,
    $next,
    'plugin!_cache%',
    '!',
...
$payload = [
    'scenario' => 'wordpress-utf16-nocase-like-rtrim-current-source-next178',
    'wordpressUse' => 'Copied wp_options scans can canonicalize a yielded UTF-16 option_name token through RTRIM and ASCII NOCASE before replaying a LIKE cursor across current-source changes.',
    'status' => $plan['status'],
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next178 self-test passed\n";
}
