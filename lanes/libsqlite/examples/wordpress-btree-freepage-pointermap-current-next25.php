...
echo json_encode([
    'wordpressUse' => 'Allocate copied wp_options b-tree pages from the current and next freelist trunks while rewriting auto-vacuum pointer-map entries for every newly-current page without ext/sqlite.',
