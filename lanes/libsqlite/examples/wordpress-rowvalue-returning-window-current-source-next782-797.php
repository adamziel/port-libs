...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next782-797 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from integrated next766-781.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next782-797 self-test passed\n";
    return;
}
