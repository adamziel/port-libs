...
$payload = [
    'scenario' => 'wordpress-json-table-indexed-constraint-cost',
    'wordpressUse' => 'Copied wp_options JSON import tooling can compare the current and next json_tree() indexed constraint driver before committing changed plugin rule metadata without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-indexed-constraint-cost self-test passed\n";
    return;
}
