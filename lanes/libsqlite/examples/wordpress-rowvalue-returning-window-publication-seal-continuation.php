...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next526-541 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next510-525 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-publication-seal-continuation self-test passed\n";
    return;
}
