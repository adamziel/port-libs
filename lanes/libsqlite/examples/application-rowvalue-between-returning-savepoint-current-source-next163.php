...
$summary = [
    'scenario' => 'application-rowvalue-between-returning-savepoint-current-source-next163',
    'applicationUse' => 'Copied wp_options import retry uses row-value BETWEEN in RETURNING projections while ROLLBACK TO discards attempted draft rows and the retry reads the restored current source.',
    'status' => $plan['status'],
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-rowvalue-between-returning-savepoint-current-source-next163 self-test passed\n";
    return;
}
