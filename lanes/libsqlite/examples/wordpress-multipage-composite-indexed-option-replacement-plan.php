...
$plan = $database->planWordPressOptionReplace('siteurl', $replacementValue, 'no');
...
echo json_encode([
    'wordpressUse' => 'Plan a bounded wp_options replacement that moves siteurl from autoload=yes to autoload=no while maintaining a multi-page autoload, option_name index without the SQLite extension.',
    'plan' => $plan->toArray(),
    ...
    'indexedSiteurlOption' => $postDatabase->wordpressOptionByIndexedAutoloadAndName('no', 'siteurl')?->toArray(),
