...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext574589(
    $prepared,
    $current,
    [
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-sqlplanner-stat4-expression-partial-current-source-next574-589 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-sqlplanner-stat4-expression-partial-current-source-next574-589',
    'wordpressUse' => 'Copied wp_options plugin-admin pagination carries the next574-589 current-source STAT4 handoff into next574-589 only when projected current rows still match.',
    'status' => $plan['status'],
