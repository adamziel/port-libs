...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafDurableReceiptFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
    ...
    2,
    str_repeat('next185-application-option-cache-', 42),
    3,
    true,
);
...
echo json_encode([
    'applicationScenario' => 'delete an overflow-backed transient from copied wp_options, replay pointer-map/freeblock pages, then publish the post-vacuum page-count receipt',
