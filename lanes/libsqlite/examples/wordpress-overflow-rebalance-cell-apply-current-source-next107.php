...
echo json_encode([
    'scenario' => 'wordpress-overflow-rebalance-cell-apply-current-source-next107',
    'wordpressUse' => 'Apply a copied wp_options transient replacement to the current table leaf after deleting the old overflow-backed cell, then materialize obsolete overflow pages into the freelist and pointer map.',
