...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-yield-fence self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-yield-fence self-test passed\n";
