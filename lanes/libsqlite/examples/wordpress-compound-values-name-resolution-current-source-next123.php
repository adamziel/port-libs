...
$result = [
    'scenario' => 'wordpress-compound-values-name-resolution-current-source-next123',
    'sql' => $sql,
...
if (PHP_SAPI === 'cli' && in_array('--self-test', $_SERVER['argv'] ?? [], true)) {
    ...
    echo "wordpress-compound-values-name-resolution-current-source-next123 self-test passed\n";
    return;
}
