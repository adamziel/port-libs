...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedHiddenRowidCostNext142(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    'scenario' => 'wordpress-json-table-generated-hidden-rowid-cost-current-source-next142',
    ...
    'replanReasons' => $plan['next142ReplanReasons'],
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-hidden-rowid-cost-current-source-next142 self-test passed\n";
    return;
}
