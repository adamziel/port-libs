...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options plugin scans where a stale partial skip-scan over lower(option_name) reparses against the current STAT4/index source and projects the expression key from the covering index cursor without table b-tree seeks.',
