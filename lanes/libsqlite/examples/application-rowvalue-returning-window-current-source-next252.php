...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePublicationWindowFence(
    ['wp_options' => $rows],
...
return [
    ...
    'applicationUse' => 'Copied wp_options cleanup/import flows can checkpoint RETURNING windows at the current-source high-water row before resuming next-source retry rows.',
