...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext177Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext177Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
