...
$base = [
    'source_id' => 'application-pager-reader-cache-next734',
    'epoch' => 734,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 734, 0])),
    'publication_generation' => 734,
    'master_source_digest' => hash('sha256', 'application next734 master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeStatementAffinityComparisonBranchFence(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
