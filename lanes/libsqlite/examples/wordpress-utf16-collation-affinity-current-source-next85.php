...
$numeric = SQLiteUtf16CollationAffinityCursor::wordpressOptionValueSeek(
    $rows,
...
$text = SQLiteUtf16CollationAffinityCursor::wordpressOptionValueSeek(
    $rows,
    'Plugin_Alpha',
    'TEXT',
    'TEXT',
...
echo json_encode(
    [
        'scenario' => 'wordpress-utf16-collation-affinity-current-source-next85',
