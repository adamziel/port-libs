...
echo json_encode([
    'wordpressUse' => 'Allocate reusable pages for a copied wp_options b-tree write by draining the current freelist trunk, following its next-trunk pointer, and appending only after the freelist is depleted without requiring ext/sqlite.',
