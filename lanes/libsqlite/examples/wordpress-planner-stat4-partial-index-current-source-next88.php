...
$output = [
    'scenario' => 'wordpress-planner-stat4-partial-index-current-source-next88',
    ...
    'wordpressUse' => 'Preview copied multisite wp_options plugin-option scans where a partial index predicate is proved and sqlite_stat4 samples at the current option_name source tighten import/query planning without ext/sqlite.',
];
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-planner-stat4-partial-index-current-source-next88 self-test passed\n";
    exit(0);
}
