...
echo json_encode([
    ...
    'applicationUse' => 'Copied Application termmeta imports can decide whether cascade/delete repair should first build a child-side FK lookup index by paging PRAGMA index_xinfo and foreign_key_list current-source diagnostics.',
    'pragma' => [
        'PRAGMA main.index_xinfo(wp_termmeta_lookup)',
        'PRAGMA main.foreign_key_list(wp_termmeta_import)',
    ],
