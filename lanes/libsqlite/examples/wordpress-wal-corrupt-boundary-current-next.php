...
$summary = [
    'wordpressUse' => 'Compare current reader-visible pages with the next recovered reader view for a copied wp_options WAL sidecar that has a valid draft frame followed by corrupt tail bytes.',
