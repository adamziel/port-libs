...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-publication-audit',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-publication-audit self-test passed\n";
}
