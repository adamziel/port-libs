...
$plan = SQLiteWordPressSchemaJsonWalImportPlan::plan($schema, [
    [
        'option_id' => 1,
...
echo json_encode([
    'scenario' => 'wordpress-schema-json-wal-import-current-next41',
    'wordpressUse' => 'Plan a copied WordPress schema plus JSON wp_options import as one WAL-yielding transaction, preserving schema/data cookies, applied JSON option pages, checkpoint admission, and commit ordering without requiring ext/sqlite.',
    'status' => $plan['status'],
