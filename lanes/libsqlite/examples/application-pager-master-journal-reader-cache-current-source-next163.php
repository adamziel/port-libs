...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-current-source-next163',
    'applicationUse' => 'A copied Application options reader keeps only unchanged recovered pages in cache, reads changed active_plugins from the next source, and reports dirty plugin settings cache before another reader observes it.',
    'status' => $plan['status'],
