...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports can reprepare a stale lower(option_name) STAT4 expression-covering point lookup after ANALYZE and stream current plugin_cache rows directly from the covering index without table rowid seeks.',
];
