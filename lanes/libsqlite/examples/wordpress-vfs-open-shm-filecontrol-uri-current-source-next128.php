...
$plan = SQLiteVfsLockByteUriShmCurrentSourceNext97::currentSourceNext128([
...
$summary = [
    'scenario' => 'wordpress-vfs-open-shm-filecontrol-uri-current-source-next128',
    'wordpressUse' => 'Expose SQLite URI xFileControl probes from copied WordPress main/WAL/SHM current sources so import and repair code can inspect per-handle role, busy/readmark, and checkpoint hints while preserving byte-lock, SHM-lock, and data-version freshness state without ext/sqlite.',
