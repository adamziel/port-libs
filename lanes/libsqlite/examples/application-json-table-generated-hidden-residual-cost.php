...
$summary = [
    'scenario' => 'application-json-table-generated-hidden-residual-cost',
    'applicationUse' => 'Copied wp_options JSON import diagnostics can keep generated hidden constraints usable while preserving an unusable generated slug predicate as a residual filter with an explicit cost penalty before the next option payload is committed.',
...
if (($argv[1] ?? '') === '--self-test') {
    if (
        ...
        fwrite(STDERR, "application-json-table-generated-hidden-residual-cost self-test failed\n");
        exit(1);
    }

    echo "application-json-table-generated-hidden-residual-cost self-test passed\n";
    return;
}
