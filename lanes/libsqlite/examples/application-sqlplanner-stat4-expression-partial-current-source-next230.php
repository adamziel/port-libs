...
$summary = [
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next230',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'Keeps copied wp_options plugin-option scans on a current partial expression index when imported peer rows sit between sparse STAT4 samples.',
];
...
if ($summary['status'] !== 'stat4-expression-partial-current-source-next230-ready'
    ...
    fwrite(STDERR, "application-sqlplanner-stat4-expression-partial-current-source-next230 self-test failed\n");
    exit(1);
}
