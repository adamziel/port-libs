...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext196Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext196Plan::execute(
    [
