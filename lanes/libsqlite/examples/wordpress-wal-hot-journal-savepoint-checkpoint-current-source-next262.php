...
$pageCacheDigest = $digest('wordpress next262 clean page cache');
...
echo json_encode([
    'scenario' => 'wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next262',
    'wordpressUse' => 'A copied WordPress import retries option/autoload reads after hot-journal recovery and checkpoint publication without reusing stale reader page-cache entries from the old WAL generation.',
    'status' => $plan['status'],
