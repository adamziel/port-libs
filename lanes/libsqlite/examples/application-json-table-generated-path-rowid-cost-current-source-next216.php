...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidAdvancePlan(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-xnext-current-source',
    'applicationUse' => 'Copied wp_options JSON rule previews can advance a pinned generated-path rowid json_tree cursor through the current-source range with xNext while changed next-source rows force reprepare instead of reusing stale rowids.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-xnext-current-source self-test passed\n";
    return;
}
