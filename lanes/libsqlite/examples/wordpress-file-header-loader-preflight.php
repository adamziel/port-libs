...
if ($path === false) {
    throw new RuntimeException('Unable to create copied WordPress SQLite fixture');
}
...
echo json_encode([
    'scenario' => 'wordpress-file-header-loader-preflight',
    'wordpressUse' => 'Read and validate only the bounded SQLite database header for a copied WordPress database before full file-handle/VFS loading, without ext/sqlite.',
    'database' => [
