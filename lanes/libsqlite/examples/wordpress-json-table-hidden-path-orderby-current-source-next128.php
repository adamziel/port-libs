...
$plan = SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options plugin-settings JSON can keep hidden path and rowid constraints while detecting when ORDER BY path/atom output has to be resorted after an import source changes.',
];
