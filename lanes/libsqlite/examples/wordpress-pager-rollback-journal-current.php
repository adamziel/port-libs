...
$summary = [
    'scenario' => 'wordpress-pager-rollback-journal-current',
    'wordpressUse' => 'A copied WordPress database admits dirty wp_options pages only when the rollback journal contains page images from the current database file, preventing a stale journal from publishing plugin import changes.',
...
if (in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "wordpress-pager-rollback-journal-current self-test failed\n");
        exit(1);
    }

    echo "wordpress-pager-rollback-journal-current self-test passed\n";
}
