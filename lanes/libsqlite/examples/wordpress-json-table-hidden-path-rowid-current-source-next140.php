...
$plan = SQLiteJsonTablePlan::currentSourceHiddenPathRowidNext140(
    'json_tree',
    $current,
    $next,
    'option_value',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    assert(in_array('json-table-hidden-path-rowid-current-source-value-changed', $plan['next140ReplanReasons'], true));
    echo "wordpress-json-table-hidden-path-rowid-current-source-next140 self-test passed\n";
    return;
}
...
echo json_encode([
    ...
    'replanReasons' => $plan['next140ReplanReasons'],
