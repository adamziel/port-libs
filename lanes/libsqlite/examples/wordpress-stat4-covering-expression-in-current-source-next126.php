...
$plan = SQLitePlannerStat4CoveringExpressionInCurrentSourceNext126Plan::materialize(
    $prepared,
    $current,
    $predicate,
    $rows,
...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options plugin option-name IN scans after ANALYZE refresh: stale prepared expression-index plans reprepare to current STAT4 samples and read option payload columns from the covering index cursor.',
