...
echo json_encode([
    ...
    'wordpressUse' => 'Preview a copied wp_options autoload lookup after ANALYZE/stat4 refresh so stale prepared partial-expression plans reprepare to current-source sample selectivity before native row decoding.',
