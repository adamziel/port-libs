...
$plan = SQLiteJsonTablePlan::currentSourceHiddenGeneratedRowidNext157(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    'scenario' => 'wordpress-json-table-hidden-generated-rowid-current-source-next157',
    'wordpressUse' => 'Copied wp_options plugin-setting previews can pin a json_tree() hidden path seek, generated-column filters, and a rowid alias lookup to the current source while the next import mutates sibling JSON values.',
    ...
    'replanReasons' => $plan['next157ReplanReasons'],
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-hidden-generated-rowid-current-source-next157 self-test passed\n";
    return;
}
