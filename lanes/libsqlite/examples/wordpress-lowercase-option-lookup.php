...
if ($databasePath === null || $optionName === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-lowercase-option-lookup.php path/to/wordpress.sqlite option_name\n");
    exit(1);
}

$database = SQLiteDatabase::fromFile($databasePath);
$indexRootPage = $database->indexRootPageForLowercasePointLookup('wp_options', 'option_name', $optionName);
$option = $database->wordpressOptionByIndexedLowercaseName($optionName);
