...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next251',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, advance the reusable current-source cursor only after pointer-map seals and freeblock receipts make payload reuse safe.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next251 self-test passed\n";
}
