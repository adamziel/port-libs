...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-select-sql-named-window-subquery-current-source-next107 self-test passed\n";
    exit(0);
}

echo json_encode([
    'wordpressUse' => 'Preview copied wp_options import rows with parser-level SQLite named WINDOW clauses whose partition/order/filter expressions use correlated scalar subqueries, without requiring ext/sqlite.',
    'sql' => $sql,
    'rows' => $rows,
