...
use PortLibs\LibSqlite\SQLitePragmaIndexQuickCheckForeignKeyCurrentSourceNext141;
...
$result = SQLitePragmaIndexQuickCheckForeignKeyCurrentSourceNext141::currentNextPage(
    $catalog,
    $catalog,
...
if (
    ...
    fwrite(STDERR, "wordpress-pragma-index-quickcheck-foreignkey-current-source-next141 self-test failed\n");
    exit(1);
}

fwrite(STDOUT, "wordpress-pragma-index-quickcheck-foreignkey-current-source-next141 self-test passed\n");
echo json_encode([
