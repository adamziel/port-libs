...
echo json_encode([
    'wordpressUse' => 'After rewriting a large wp_options row to a small inline value, return its obsolete overflow pages to SQLite freelist metadata without the SQLite extension.',
