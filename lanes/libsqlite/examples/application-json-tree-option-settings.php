...
echo json_encode([
    'reports' => $reports,
    'applicationUse' => 'Local-only wp_options option_value recursive expansion that mirrors bounded SQLite json_tree() selected-root rows and hidden json/root columns for strict JSON, JSON5 text, JSONB blobs, missing paths, and SQL NULL before copied plugin settings are imported.',
