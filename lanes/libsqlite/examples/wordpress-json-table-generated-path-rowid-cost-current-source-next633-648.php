...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext648(
    'json_tree',
    $currentOption,
    $nextOption,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next633-648',
    'wordpressUse' => 'Generated wp_options JSON path scans keep rowid point-cost admission stable across the next633-648 follow-on while changed copied source rows force a next reader reprepare.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next633-648 self-test passed\n";
    return;
}
