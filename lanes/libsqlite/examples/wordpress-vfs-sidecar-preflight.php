...
echo json_encode([
    'scenario' => 'wordpress-vfs-sidecar-preflight',
    'wordpressUse' => 'Resolve SQLite main, WAL, SHM, rollback-journal, super-journal, and temp-file paths for copied WordPress databases before activating a full native VFS implementation.',
