...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext206(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next206',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    if ($payload['currentOrderedRowids'] !== [8, 7]) {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next206 self-test passed\n";
    return;
}
