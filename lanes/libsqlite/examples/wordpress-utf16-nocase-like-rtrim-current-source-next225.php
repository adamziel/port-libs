...
$payload = [
    ...
    'wordpressUse' => 'Copied wp_options cursors must restart when UTF-16 source bytes or endian encoding change, even when decoded NOCASE/RTRIM LIKE results are unchanged.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next225 self-test passed\n";
    return;
}
