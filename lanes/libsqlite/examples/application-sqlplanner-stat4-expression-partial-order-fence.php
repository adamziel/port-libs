...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next178 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next178',
    'applicationUse' => 'Preview copied wp_options plugin scans after ANALYZE/source changes where a DESC lower(option_name) partial expression index satisfies ORDER BY without reusing stale prepared row order.',
    'status' => $plan['status'],
