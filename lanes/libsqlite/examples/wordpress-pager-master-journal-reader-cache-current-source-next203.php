...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext203Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext203Plan::plan(
    $database,
    $masterJournal,
    implode("\n", $members) . "\n",
