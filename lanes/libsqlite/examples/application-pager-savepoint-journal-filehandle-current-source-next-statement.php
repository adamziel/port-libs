...
$root = sys_get_temp_dir() . '/libsqlite-application-savepoint-filehandle-current-source-next-statement-' . bin2hex(random_bytes(4));
...
try {
    ...
    $summary = [
        'status' => 'pager_savepoint_journal_filehandle_current_source_next_statement',
        ...
        'retryStatementJournalFromRestoredSource' => str_contains((string) file_get_contents($dir . '/retry.stmt'), 'before plugin autoload next statement'),
