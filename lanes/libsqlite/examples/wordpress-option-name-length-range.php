...
if ($databasePath === null || $lower === null || $upper === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-option-name-length-range.php path/to/wordpress.sqlite lower_length|- upper_length|- [limit] [upper_inclusive]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedNameLengthRange($lowerBound, $upperBound, $limit, $upperInclusive),
);
