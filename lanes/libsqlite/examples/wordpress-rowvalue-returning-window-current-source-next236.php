...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext236(
    ['wp_options' => $rows],
...
return [
    ...
    'wordpressUse' => 'Copied wp_options import batches can rollback a yielded row-value UPDATE/DELETE RETURNING stream, retry from the savepoint image, and compute current-row window frame receipts for migration progress summaries without ext/sqlite.',
