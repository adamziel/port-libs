...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext192Plan.php';
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext196Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext196Plan::wordpressOptionNameDuplicatePeerResumePlan(
    $current,
    $next,
    'plugin!_cache',
    '!',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next196 self-test passed\n";
