...
echo json_encode([
    'scenario' => 'wordpress-jsonb-generated-index-operator-current-source-next107',
    'wordpressUse' => 'Copied wp_options JSONB plugin settings can maintain generated expression indexes declared with SQLite JSON -> and ->> operators across current/next import rows, including partial autoload activation and canonical JSON object keys, without requiring ext/sqlite.',
