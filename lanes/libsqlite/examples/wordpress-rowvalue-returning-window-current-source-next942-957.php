...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports validate the next942-957 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next941_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next942-957 self-test passed\n";
    return;
}
