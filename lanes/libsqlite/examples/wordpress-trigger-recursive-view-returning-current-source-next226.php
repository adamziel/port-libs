...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext226Plan::execute(
    [
...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-next226 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-current-source-next226 self-test passed\n";
