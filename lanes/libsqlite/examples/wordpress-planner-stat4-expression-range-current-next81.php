...
$output = [
    'scenario' => 'wordpress-planner-stat4-expression-range-current-next81',
    ...
    'wordpressUse' => 'Preview copied wp_options expression-index range scans with sqlite_stat4 current/next sample boundaries before choosing a native PHP import/query plan.',
];
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-planner-stat4-expression-range-current-next81 self-test passed\n";
    exit(0);
}
