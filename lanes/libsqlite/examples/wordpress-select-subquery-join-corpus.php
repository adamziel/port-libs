...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows joined to site visibility rows and filtered/projected through correlated SELECT subqueries, exercising parser-level SELECT subquery behavior over joined sources without requiring ext/sqlite.',
    'sql' => $sql,
