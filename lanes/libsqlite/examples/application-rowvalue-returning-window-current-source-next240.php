...
return [
    ...
    'applicationUse' => 'Copied wp_options import batches can rollback a yielded row-value UPDATE/DELETE RETURNING stream, retry from the savepoint image, and compute GROUPS-style peer/exclusion window receipts for migration progress summaries without ext/sqlite.',
