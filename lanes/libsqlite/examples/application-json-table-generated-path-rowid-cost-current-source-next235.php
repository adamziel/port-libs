...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next235',
    'applicationUse' => 'Copied wp_options JSON diagnostics can keep a generated-path json_tree rowid yield tape only while the current-source fingerprint and last yielded rowid match; changed next-source settings restart instead of yielding stale plugin rule rows.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next235 self-test passed\n";
    return;
}
