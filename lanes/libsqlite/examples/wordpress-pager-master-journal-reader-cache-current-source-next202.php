...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext202Plan.php';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext202Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
