...
echo json_encode([
    'scenario' => 'copied wp_options overflow delete plus incremental vacuum materialized apply current/next66',
    'released_overflow_pages' => $plan->releasedOverflowPages(),
    'materialized_apply' => $plan->materializedApplySummary(),
    'surviving_pointer_map_types' => [
        306 => $plan->materializedDatabase()->pointerMapEntryForPage(306)->typeName(),
        307 => $plan->materializedDatabase()->pointerMapEntryForPage(307)->typeName(),
    ],
