...
return [
    ...
    'applicationUse' => 'Copied wp_options imports can compute FILTER-style UPDATE/DELETE RETURNING window receipts across a rolled-back attempt and a released retry without admitting suppressed rows into the retry release.',
