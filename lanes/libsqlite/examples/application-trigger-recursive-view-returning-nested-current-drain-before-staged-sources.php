...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through an INSTEAD OF recursive view trigger can run a re-entrant current-source RETURNING segment and drain it before staged next-source rows are exposed.',
