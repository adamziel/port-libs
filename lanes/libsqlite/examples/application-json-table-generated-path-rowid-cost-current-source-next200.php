...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next200',
    'applicationUse' => 'Copied wp_options plugin-rule diagnostics can carry generated-path and rowid constraints into a stable json_tree xFilter argv tape only while the current-source pin and emitted rowids remain reusable.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next200 self-test passed\n";
    return;
}
