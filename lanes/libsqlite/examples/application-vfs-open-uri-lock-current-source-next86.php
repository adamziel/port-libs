...
$summary = [
    'scenario' => 'application-vfs-open-uri-lock-current-source-next86',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'Track copied wp_options database file: URI open/reopen source identity across percent-encoded paths and localhost authority while immutable archive opens skip byte-range locks.',
...
if (
    ...
    fwrite(STDERR, "application-vfs-open-uri-lock-current-source-next86 self-test failed\n");
    exit(1);
}
