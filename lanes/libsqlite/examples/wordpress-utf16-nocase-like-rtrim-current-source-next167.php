...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext167Plan::wordpressOptionNameFallbackPlan(
    [
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next167 self-test passed\n";
    return;
}
