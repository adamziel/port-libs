...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options SELECT SQL text with SQLite bind parameters in projection, predicates, ORDER/LIMIT inputs, and mixed positional/named forms before imports without requiring ext/sqlite.',
    'sql' => $sql,
