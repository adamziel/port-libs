...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-final-cost',
    'applicationUse' => 'Copied wp_options plugin-rule diagnostics can admit a final generated-path/rowid JSON table xColumn snapshot only when the current source, rowid aliases, projection, and cost profile are still covering; changed next sources force reprepare.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-final-cost self-test passed\n";
    return;
}
