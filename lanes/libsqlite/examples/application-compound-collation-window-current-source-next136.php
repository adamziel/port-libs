...
$plan = SQLiteCompoundCollationWindowCurrentSourceNextPlan::compareCollationWindowSources($sql, $currentTables, $nextTables);
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-compound-collation-window-current-source-next136 self-test passed\n";
    return;
}
