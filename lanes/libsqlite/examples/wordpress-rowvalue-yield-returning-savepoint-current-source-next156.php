...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan;
...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan::execute(
    ['wp_options' => $rows],
    [
