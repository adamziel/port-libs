...
use PortLibs\LibSqlite\SQLiteEncodingCollationAffinityGlobCurrentSourceNext239Plan;
...
$plan = SQLiteEncodingCollationAffinityGlobCurrentSourceNext239Plan::wordpressOptionValueMalformedGlobPlan(
    $currentRows,
    $nextRows,
    "plugin_[\xe2-\xe2]*",
);
