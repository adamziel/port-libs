...
$plan = SQLiteJsonbCheckCurrentNextPlan::plan($schema, [
    ['setting_id' => 301, 'key_name' => 'plugin_alpha_settings', 'key_value' => $jsonb(['plugin' => ['channel' => 'stable', 'rank' => 10, 'deprecated' => false, 'requires' => 6.5]]), 'load_policy' => 'yes'],
    ['setting_id' => 302, 'key_name' => 'plugin_beta_settings', 'key_value' => $jsonb(['plugin' => ['channel' => 'beta', 'rank' => 40, 'deprecated' => false]]), 'load_policy' => 'yes'],
], [
    ...
    ['op' => 'INSERT', 'row' => ['setting_id' => 303, 'key_name' => 'plugin_release_settings', 'key_value' => $jsonb(['plugin' => ['channel' => 'stable', 'rank' => 15, 'deprecated' => false]]), 'load_policy' => 'yes']],
]);
...
echo json_encode([
    ...
    'applicationUse' => 'Preflight application settings JSONB plugin settings with OR/NOT CHECK guards before next import rows are admitted to storage.',
