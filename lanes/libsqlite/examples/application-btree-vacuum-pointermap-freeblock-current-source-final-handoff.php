...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafWriterHandoffFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-final-handoff',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, admit the sealed pointer-map/freeblock current-source pages into the next writer before payload reuse.',
    ...
    'duplicate_pointer_map_handoff_pages' => $summary['duplicate_pointer_map_handoff_pages'],
    ...
    'all_leaf_freeblock_receipts_handed_off' => $summary['all_leaf_freeblock_receipts_handed_off'],
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-final-handoff self-test passed\n";
}
