...
require_once __DIR__ . '/../src/SQLiteBTreePointerMapVacuumFreeblockCurrentSourceNextPlan.php';
require_once __DIR__ . '/../src/SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext157Plan.php';
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext157Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
