...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNextPlan::executeNext245(
    [
...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-upsert-current-source-next245 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-upsert-current-source-next245 self-test passed\n";
