...
echo json_encode([
    ...
    'wordpressUse' => 'Local-only wp_options diagnostics can join row-sourced and SQL-literal JSONB option blobs through parser-level json_tree(), while malformed JSONB and SQL NULL option values follow the validated planner path and produce empty or LEFT-join null-extended rowsets without aborting the copied import preview.',
    'innerSql' => $innerSql,
