...
$summary = [
    'scenario' => 'application-compound-cte-window-order-current-source',
    'applicationUse' => 'Copied wp_options import previews can materialize option subsets in CTEs, run ordered window frames inside compound SELECT arms, and apply the final compound ORDER BY against current and next source snapshots without requiring ext/sqlite.',
...
if (PHP_SAPI === 'cli' && realpath($_SERVER['SCRIPT_FILENAME'] ?? '') === __FILE__) {
    ...
    echo "application-compound-cte-window-order-current-source-self-test passed\n";
}
