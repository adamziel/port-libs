...
echo json_encode([
    ...
    'wordpressUse' => 'Copied wp_options rows execute parser-level json_group_array()/jsonb_group_array() with aggregate-local ORDER BY and FILTER clauses for local import summaries without requiring ext/sqlite.',
