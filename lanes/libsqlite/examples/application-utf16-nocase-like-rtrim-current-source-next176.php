...
$summary = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::optionRowNamePeerYieldPlan(
    [
...
$payload = [
    'scenario' => 'application-utf16-nocase-like-rtrim-current-source-next176',
    ...
    'applicationUse' => 'Copied wp_options cursors over UTF-16 rtrim(option_name) COLLATE NOCASE LIKE probes preserve SQLite rowid tie ordering when case and trailing-space variants collapse to the same index key.',
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    if ($payload['status'] !== 'utf16-nocase-like-rtrim-current-source-next176'
        ...
        fwrite(STDERR, "application-utf16-nocase-like-rtrim-current-source-next176 self-test failed\n");
        exit(1);
    }
    echo "application-utf16-nocase-like-rtrim-current-source-next176 self-test passed\n";
}
