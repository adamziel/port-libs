...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options UPDATE/DELETE cleanup statements that use SQLite ORDER BY with LIMIT/OFFSET, selecting affected rows by sorted option metadata while preserving deterministic source-order mutation diagnostics without requiring ext/sqlite.',
