...
$page = SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext250::page(
    $currentRecords,
    $nextRecords,
...
$summary = [
    'scenario' => 'wordpress-pragma-index-xinfo-foreignkey-current-source-next250',
    'wordpressUse' => 'Copied WordPress taxonomy imports can distinguish generated child FK columns that PRAGMA table_info omits from actually missing child-column metadata.',
    'status' => $page['status'],
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-index-xinfo-foreignkey-current-source-next250 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-index-xinfo-foreignkey-current-source-next250 self-test passed\n");
    exit(0);
}
