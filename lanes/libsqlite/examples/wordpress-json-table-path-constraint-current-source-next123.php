...
$plan = SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123(
    'json_tree',
    $currentOption,
    $nextOption,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-path-constraint-current-source-next123',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-path-constraint-current-source-next123 self-test passed\n";
    return;
}
