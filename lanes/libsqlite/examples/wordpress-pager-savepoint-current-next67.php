...
$plan = SQLitePagerSavepointCurrentNextPlan::rollbackJournalLifecycleCurrentNext67($events, [
    'op' => 'rollback_to',
    'name' => 'plugin_batch',
    'journal_mode' => 'delete',
    'page_size' => 1024,
...
echo json_encode([
    ...
    'wordpressUse' => 'Plan rollback-journal current/next pager lifecycle for copied wp_options imports where a failed plugin batch rolls back to an outer SAVEPOINT while preserving the transaction for later rows.',
    'status' => $plan['status'],
