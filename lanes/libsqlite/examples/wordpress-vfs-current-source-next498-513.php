...
require_once __DIR__ . '/../src/SQLiteVfsCurrentSourceNext498513Plan.php';
...
$plan = SQLiteVfsCurrentSourceNext498513Plan::run([
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-vfs-current-source-next498-513 self-test passed\n";
    return;
}
