...
$output = [
    'scenario' => 'wordpress-planner-stat4-expression-range-current-source-next86',
    ...
    'wordpressUse' => 'Preview copied wp_options redundant lower()/range predicates using the current effective STAT4 expression-index interval instead of looser source predicates before choosing a native PHP import/query plan.',
];
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-planner-stat4-expression-range-current-source-next86 self-test passed\n";
    exit(0);
}
