...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext212Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext212Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-next212 self-test passed\n";
    return;
}
