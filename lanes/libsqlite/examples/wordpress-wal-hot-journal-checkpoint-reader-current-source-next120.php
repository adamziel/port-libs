...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-checkpoint-reader-current-source-next120',
    'wordpressUse' => 'Recover a copied wp_options hot rollback journal, roll back a failed savepoint WAL tail, and prove a pinned reader can keep its stale WAL source while checkpoint reset uses the retained current prefix after the reader releases.',
    'status' => $plan['status'],
