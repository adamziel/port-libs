...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext192Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext192Plan::execute(
    [
