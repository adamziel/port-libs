...
echo json_encode([
    'scenario' => 'application-json-table-path-orderby-cost',
    'planned' => [
    ...
    'applicationUse' => 'Copied wp_options plugin JSON can combine path pushdown with ORDER BY cost planning so migration previews know when a json_tree() scan needs a suffix sorter after settings rows change, without ext/sqlite.',
