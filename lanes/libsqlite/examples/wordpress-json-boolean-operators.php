...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options plugin JSON/JSONB rows filtered by SQLite truth-value operators over ->> boolean and numeric extracts without requiring ext/sqlite.',
