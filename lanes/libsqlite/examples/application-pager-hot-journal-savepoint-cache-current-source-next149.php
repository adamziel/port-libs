...
$summary = [
    'scenario' => 'application-pager-hot-journal-savepoint-cache-current-source-next149',
    'applicationUse' => 'A copied Application options import recovers a hot rollback journal, rolls back the active savepoint, refreshes page-cache source tokens, and captures clean before-images before retrying the next active_plugins statement.',
    'status' => $plan['status'],
