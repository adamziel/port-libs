...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext187Plan;
...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext187Plan::compare($sql, $currentTables, $nextTables);
