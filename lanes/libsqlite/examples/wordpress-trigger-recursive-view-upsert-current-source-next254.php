...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNextPlan::executeNext254(
    [
...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-upsert-current-source-next254 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-upsert-current-source-next254 self-test passed\n";
