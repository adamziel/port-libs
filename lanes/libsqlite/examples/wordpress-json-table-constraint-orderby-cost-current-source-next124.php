...
$plan = SQLiteJsonTablePlan::currentSourceConstraintOrderByCostNext124(
    'json_tree',
    $currentOption,
    $nextOption,
    'option_value',
...
$payload = [
    'scenario' => 'wordpress-json-table-constraint-orderby-cost-current-source-next124',
    'wordpressUse' => 'Copied wp_options JSON rule diagnostics can reuse a pushed constant key prefix for ORDER BY key, atom DESC and charge only the suffix block-sort cost while the current json_tree() source remains pinned.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-constraint-orderby-cost-current-source-next124 self-test passed\n";
    return;
}
