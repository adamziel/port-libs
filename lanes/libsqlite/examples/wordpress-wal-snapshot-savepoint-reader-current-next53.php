...
$report = [
    'scenario' => 'wordpress-wal-snapshot-savepoint-reader-current-next53',
    'wordpressUse' => 'During a copied wp_options import, RELEASE merges plugin savepoint WAL frames while an existing reader keeps its earlier read-mark snapshot and the next reader sees the released savepoint frames without ext/sqlite.',
    'status' => $plan['status'],
