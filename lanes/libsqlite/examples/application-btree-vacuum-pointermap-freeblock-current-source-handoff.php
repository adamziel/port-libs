...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafCurrentSourceHandoffFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-handoff',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, expose reusable freeblock pages to the current source only after pointer-map barriers and leaf freeblock receipts are visible.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-handoff self-test passed\n";
}
