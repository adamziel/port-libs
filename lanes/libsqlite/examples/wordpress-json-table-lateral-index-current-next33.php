...
$payload = [
    'scenario' => 'wordpress-json-table-lateral-index-current-next33',
    'wordpressUse' => 'Query copied wp_options plugin settings through lateral json_tree() joins whose ON predicates are advertised as JSON virtual-table index constraints without requiring ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    fwrite(STDOUT, "wordpress-json-table-lateral-index-current-next33 self-test passed\n");
    return;
}
