...
$summary = [
    'scenario' => 'application-pragma-index-xinfo-foreignkey-current-source-next240-243',
    'applicationUse' => 'Bulk Application schema import checks can keep implicit parent primary keys, implicit parent reference resolution, rowid alias rejection, and FK affinity mismatches visible together.',
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "application-pragma-index-xinfo-foreignkey-current-source-next240-243 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "application-pragma-index-xinfo-foreignkey-current-source-next240-243 self-test passed\n");
    exit(0);
}
