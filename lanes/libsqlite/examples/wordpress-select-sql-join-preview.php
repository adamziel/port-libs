...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows joined to bounded option metadata from SQLite SELECT text through the native query-plan executor, including LEFT JOIN null-extension, table-qualified predicates, aliases, ORDER BY, and LIMIT without requiring ext/sqlite.',
    'sql' => $sql,
