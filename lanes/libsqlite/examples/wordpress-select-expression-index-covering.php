...
echo json_encode([
    'scenario' => 'wordpress-select-expression-index-covering',
    ...
    'wordpressUse' => 'Preview copied wp_options SELECT lower(option_name), autoload, option_value lookups where the expression index supplies the lower(option_name) result and trailing index columns avoid table-page reads without ext/sqlite.',
