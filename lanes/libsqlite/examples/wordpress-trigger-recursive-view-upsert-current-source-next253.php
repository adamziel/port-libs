...
$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNextPlan::executeNext253(
    [
...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-upsert-current-source-next253 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-upsert-current-source-next253 self-test passed\n";
