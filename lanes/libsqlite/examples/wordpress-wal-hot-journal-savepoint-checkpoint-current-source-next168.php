...
require_once __DIR__ . '/../src/SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext168Plan.php';
...
$plan = SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext168Plan::plan(
    $databasePath,
    $databaseBytes,
    $pageSize,
    'wp-plugin-import-next168',
