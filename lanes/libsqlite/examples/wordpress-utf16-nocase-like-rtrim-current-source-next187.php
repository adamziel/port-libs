...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext187Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext187Plan::wordpressOptionNameDanglingEscapePlan($current, $next);
