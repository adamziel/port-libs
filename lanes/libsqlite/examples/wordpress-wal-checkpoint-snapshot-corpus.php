...
echo json_encode([
    'scenario' => 'wordpress-wal-checkpoint-snapshot-corpus',
    'wordpressUse' => 'Inspect copied wp_options WAL snapshots while a reader pins an older frame, then plan checkpoint visibility and corrupt-tail recovery without requiring ext/sqlite.',
    'readerPage2' => [
