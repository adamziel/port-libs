...
echo json_encode([
    'scenario' => 'wordpress-json-table-visible-constraint-pushdown',
    'planned' => [
    ...
    'wordpressUse' => 'Copied wp_options plugin settings can advertise visible json_tree() constraints to the planner while still applying residual checks before migration diagnostics run without ext/sqlite.',
