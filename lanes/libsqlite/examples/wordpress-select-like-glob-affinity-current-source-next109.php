...
$preview = [
    'scenario' => 'wordpress-select-like-glob-affinity-current-source-next109',
    'wordpressUse' => 'Copied wp_options SELECT previews coerce numeric, boolean, and BLOB option_value operands for LIKE/GLOB while preserving SQLite RTRIM collation space-only behavior before imports run without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-select-like-glob-affinity-current-source-next109 self-test passed\n";
    return;
}
