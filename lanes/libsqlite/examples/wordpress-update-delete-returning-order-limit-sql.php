...
echo json_encode([
    'wordpressUse' => 'Execute copied wp_options UPDATE/DELETE SQL text with RETURNING plus ORDER BY/LIMIT/OFFSET row selection, preserving old DELETE values and new UPDATE assignment values without requiring ext/sqlite.',
