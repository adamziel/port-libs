...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext239Plan;
...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext239Plan::compare(
    $sql,
    ['wp_options' => $current],
    ['wp_options' => $next],
);
