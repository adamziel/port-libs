...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext176Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext176Plan::materialize(
    $prepared,
    $current,
    [
