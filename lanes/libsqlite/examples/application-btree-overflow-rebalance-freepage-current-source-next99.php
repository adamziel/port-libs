...
$summary = [
    'scenario' => 'application-btree-overflow-rebalance-freepage-current-source-next99',
    'applicationUse' => 'Copied wp_options transient cleanup deletes two overflow-backed rows from the current source: the first delete defragments the still-live leaf, while the second frees the emptied leaf and its overflow chain into the same auto-vacuum freelist without ext/sqlite.',
...
if (
    ...
    fwrite(STDERR, "application-btree-overflow-rebalance-freepage-current-source-next99 self-test failed\n");
    exit(1);
}
