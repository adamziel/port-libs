...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options plugin JSON can keep a json_tree() rowid predicate scoped to the current nested root while the next plugin group points at a different nested path; this records when rowid/fullkey tapes can be reused and when the cursor must be replanned.',
];
