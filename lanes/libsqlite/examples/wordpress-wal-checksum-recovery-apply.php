...
$root = sys_get_temp_dir() . '/port-libsqlite-wordpress-wal-boundary-' . bin2hex(random_bytes(4));
...
$result = [
    'wordpressUse' => 'Apply a checksum-bounded WAL recovery prefix through native PHP VFS handles for copied wp_options databases, checkpointing the last valid committed frame while preserving valid uncommitted WAL frames and discarding corrupt sidecar tails without ext/sqlite.',
