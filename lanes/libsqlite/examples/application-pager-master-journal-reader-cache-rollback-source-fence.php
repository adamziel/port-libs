...
$receipt = 'master-journal-recovery-receipt:epoch=267:members=main,users:cleanup=deleted:dirsync=ok';
$spill = 'pager-spill-drain:epoch=267:dirty-pages=2:journal-sync=ok:exclusive-lock=held';
$rollbackSource = 'pager-rollback-source:epoch=267:dirty-pages=2:journal-sync=ok:exclusive-lock=held';
$oldSpill = 'pager-rollback-source:epoch=263:dirty-pages=2:journal-sync=pending';
$snapshot = 'reader-snapshot:epoch=267:source=master-current:lease=shared:pages=1,2,3';
$generation = 'pager-reader-cache-generation:epoch=267:master-current:reset=complete';
$source = 'current-source:master-journal:epoch=267:members=2:schema=117';
$base = [
    'source_id' => 'application-pager-rollback-source-smoke',
    'epoch' => 267,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 267, 0])),
    'publication_generation' => 267,
    'master_source_digest' => hash('sha256', 'application rollback-source-fence master source'),
    ...
    'master_journal_file_token' => 'dev=8:ino=2670:size=96:mtime=26700:generation=master-current',
    'master_journal_bytes_digest' => hash('sha256', $masterBytes),
    'database_file_token' => 'dev=8:ino=2679:size=1536:mtime=26799:generation=database-current',
    'master_journal_cleanup_token' => 'master-cleanup:deleted:mtime=26500:dirsync=ok',
    'reader_lease_token' => 'reader-lease:shared-cache:epoch=267:opened-after-master-cleanup',
    'pager_cache_source_token' => 'pager-cache-source:epoch=267:master-journal-recovery=complete',
    'read_transaction_token' => 'read-transaction:epoch=267:schema=117:change-counter=267:master-current',
    'schema_reparse_token' => 'schema-reparse:epoch=267:schema-cookie=117:ddl=master-current',
    'statement_schema_root_token' => 'statement-schema-root:epoch=267:root=1:cookie=117:sql=wp-options-current',
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::readerCacheRollbackJournalSourceFence('rollback-source-fence',
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
if (in_array('--self-test', $argv, true)) {
    if ($plan['status'] !== 'pager-master-journal-reader-cache-current-source-rollback-source-fence') {
    ...
    echo "application-pager-master-journal-reader-cache-current-source-rollback-source-fence self-test passed\n";
    return;
}
