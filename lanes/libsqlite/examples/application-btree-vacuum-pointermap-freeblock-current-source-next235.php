...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-next235',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, checkpoint duplicate pointer-map rewrites before payload pages become reusable by the next current-source writer.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-next235 self-test passed\n";
}
