...
echo json_encode([
    'wordpressScenario' => 'Copied wp_options maintenance queries can plan a skip-scan over idx_autoload_blog_name when autoload is unconstrained but blog_id is equal and option_name is the current range.',
