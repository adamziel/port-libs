...
echo json_encode([
    'wordpressUse' => 'Preview bounded recursive INSERT triggers and outer statement conflict precedence for copied wp_options import/audit rows without requiring ext/sqlite.',
