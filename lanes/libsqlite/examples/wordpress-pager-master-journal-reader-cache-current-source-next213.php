...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext213Plan.php';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext213Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
