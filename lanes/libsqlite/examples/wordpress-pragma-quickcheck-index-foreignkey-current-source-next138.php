...
require_once __DIR__ . '/../src/SQLitePragmaIntegrityIndexRootpageCurrentSourceNext124.php';
require_once __DIR__ . '/../src/SQLitePragmaIndexIntegrityCursorCurrentSourceNext133.php';
require_once __DIR__ . '/../src/SQLitePragmaQuickcheckIndexForeignKeyCurrentSourceNext138.php';

use PortLibs\LibSqlite\SQLiteAttachedSchemaCatalog;
use PortLibs\LibSqlite\SQLiteIndexLeafPage;
use PortLibs\LibSqlite\SQLitePointerMapEntry;
use PortLibs\LibSqlite\SQLitePragmaQuickcheckIndexForeignKeyCurrentSourceNext138;
...
$first = SQLitePragmaQuickcheckIndexForeignKeyCurrentSourceNext138::page(
    $catalog,
...
$second = SQLitePragmaQuickcheckIndexForeignKeyCurrentSourceNext138::page(
    $catalog,
    'PRAGMA main.index_list(wp_options)',
    $database,
    $schemas,
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-pragma-quickcheck-index-foreignkey-current-source-next138 self-test passed\n";
    return;
}
