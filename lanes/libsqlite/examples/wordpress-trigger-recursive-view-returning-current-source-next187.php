...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext187Plan;
...
$summary = SQLiteTriggerRecursiveViewReturningCurrentSourceNext187Plan::execute(
    [
