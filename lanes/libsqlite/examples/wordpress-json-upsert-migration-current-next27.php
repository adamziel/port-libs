...
require_once __DIR__ . '/../src/SQLiteWordPressJsonUpsertMigrationPlan.php';
...
$result = SQLiteWordPressJsonUpsertMigrationPlan::execute(
    $current,
    $incoming,
    [
        '$.migrated' => 1,
...
$payload = [
    'wordpressUse' => 'Preview copied wp_options INSERT ... ON CONFLICT DO UPDATE JSON migration rows using current-row JSON values, excluded JSON values, and RETURNING-style decoded output without ext/sqlite.',
