...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next638-653 row-value UPDATE/DELETE RETURNING window current-source continuation after merged next622-637 while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next638-653 self-test passed\n";
    return;
}
