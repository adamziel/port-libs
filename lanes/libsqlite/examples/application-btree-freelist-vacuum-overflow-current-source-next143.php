...
$summary = [
    'scenario' => 'application-btree-freelist-vacuum-overflow-current-source-next143',
    'applicationUse' => 'After deleting copied wp_options rows with two current overflow chains, incremental vacuum truncates tail pages and replacement overflow allocation reuses only surviving freelist pages.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-btree-freelist-vacuum-overflow-current-source-next143 self-test passed\n";
    return;
}
