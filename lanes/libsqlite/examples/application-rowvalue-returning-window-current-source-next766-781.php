...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next766-781 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from integrated next750-765.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next766-781 self-test passed\n";
    return;
}
