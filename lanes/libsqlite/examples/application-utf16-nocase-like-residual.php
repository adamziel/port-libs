...
$plan = SQLiteUtf16NocaseLikeCurrentSourceNextPlan::optionRowNameResidualPlan(
    $currentRows,
    $nextRows,
    'plugin!_cache%',
    '!',
...
$summary = [
    ...
    'applicationUse' => 'A copied UTF-16 wp_options table can continue a NOCASE option_name LIKE prefix scan over valid plugin keys while malformed current/next text bytes are isolated into cursor invalidation diagnostics.',
];
