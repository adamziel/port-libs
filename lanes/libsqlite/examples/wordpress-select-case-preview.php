...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows projected through SQLite CASE expressions before import diagnostics and final ordering, without requiring ext/sqlite.',
