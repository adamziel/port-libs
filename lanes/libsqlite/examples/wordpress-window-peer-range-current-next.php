...
$summary = [
    'scenario' => 'wordpress-window-peer-range-current-next',
    ...
    'wordpressUse' => 'Copied wp_options import diagnostics can preview SQLite RANGE BETWEEN CURRENT ROW AND fractional FOLLOWING peer windows over priority scores without requiring ext/sqlite.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress window peer RANGE current/following smoke passed\n";
    exit(0);
}
