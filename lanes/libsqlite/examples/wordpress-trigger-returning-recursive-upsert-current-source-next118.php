...
if (($argv[1] ?? '') === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-trigger-returning-recursive-upsert-current-source-next118 self-test failed\n");
        exit(1);
    }

    echo "wordpress-trigger-returning-recursive-upsert-current-source-next118 self-test passed\n";
    exit(0);
}
