...
$root = sys_get_temp_dir() . '/port-libsqlite-application-vfs-open-filecontrol-74-' . bin2hex(random_bytes(4));
...
echo json_encode([
    'applicationUse' => 'Preflight copied wp_options database open file-controls and lock escalation before an import writes database pages without ext/sqlite.',
    'status' => $plan['status'],
