...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-source-next183 self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-current-source-next183 self-test passed\n";
