...
$summary = [
    'scenario' => 'application-vfs-uri-shm-filecontrol-current-source-next104',
    ...
    'applicationUse' => 'Track copied Application SQLite URI main/WAL/SHM sidecar handles against one current-source generation so xFileControl writes on any sidecar make older handles data_version-stale while SHM byte locks remain isolated on the SHM handle.',
];
...
if (
    ...
    fwrite(STDERR, "application-vfs-uri-shm-filecontrol-current-source-next104 self-test failed\n");
    exit(1);
}
