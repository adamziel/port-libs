...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext260Plan;
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext260Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
