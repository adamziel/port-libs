...
$report = [
    'scenario' => 'wordpress-wal-checkpoint-busy-reader-current-next29',
    'wordpressUse' => 'A copied wp_options import runs FULL checkpoint while an existing reader is pinned at an older WAL frame; current readers keep their snapshot, while next readers use the checkpointed database plus preserved WAL tail.',
    'status' => $plan['status'],
    'reason' => $plan['reason'],
