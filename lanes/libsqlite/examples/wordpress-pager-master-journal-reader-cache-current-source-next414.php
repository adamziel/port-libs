...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-next414',
    'epoch' => 414,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 414, 0])),
    'publication_generation' => 414,
    'master_source_digest' => hash('sha256', 'wordpress next414 master source'),
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::variantNext414(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
