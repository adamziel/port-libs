...
echo json_encode([
    ...
    'applicationUse' => 'Resume copied wp_options index metadata and foreign-key diagnostics only when PRAGMA index_xinfo rows, database bytes, schema rows, and FK catalog state still match the current source.',
