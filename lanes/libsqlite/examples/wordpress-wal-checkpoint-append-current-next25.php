...
$report = [
    'scenario' => 'wordpress-wal-checkpoint-append-current-next25',
    'wordpressUse' => 'After a copied wp_options WAL checkpoint restarts the sidecar, append the next writer transaction to the fresh WAL while preserving current-reader visibility on the old frame set.',
    'status' => $plan['status'],
