...
if ($databasePath === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-lowercase-option-name-range.php path/to/wordpress.sqlite [lower_inclusive|-] [upper_bound|-] [limit] [upper_inclusive]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedLowercaseNameRange($lowerInclusive, $upperBound, $limit, $upperInclusive),
);
