...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through an INSTEAD OF recursive view trigger can hold next-source RETURNING rows until nested recursive current-source rows at every required trigger depth have drained.',
