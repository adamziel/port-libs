...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-alias-order-consumption',
    'applicationUse' => 'Copied wp_options JSON diagnostics can consume ORDER BY rowid aliases from a generated-path json_tree cursor without adding a temp sorter, while source changes force reprepare.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-alias-order-consumption self-test passed\n";
    return;
}
