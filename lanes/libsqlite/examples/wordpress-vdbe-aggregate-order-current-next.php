...
$summary = [
    'scenario' => 'wordpress-vdbe-aggregate-order-current-next',
    ...
    'wordpressUse' => 'Copied wp_options aggregate previews can feed group_concat(... ORDER BY ... FILTER ...) through a VDBE-style sorted input cursor with stable current/next behavior, NULL placement, affinity, and collation semantics without requiring ext/sqlite.',
];
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo 'wordpress-vdbe-aggregate-order-current-next self-test passed' . PHP_EOL;
    exit(0);
}
