...
echo json_encode([
    'scenario' => 'wordpress-json-table-disjunctive-pushdown',
    'planned' => [
    ...
    'wordpressUse' => 'Copied wp_options plugin settings can plan OR-shaped json_tree() diagnostics as separate visible-column pushdown branches, preserving duplicate suppression and residual row semantics without requiring ext/sqlite.',
