...
$plan = SQLiteJsonTablePlan::currentSourceNestedHiddenCostNext129(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options plugin settings can keep a hidden json/root cursor open while a nested group fragment changes; this previews when the next json_tree() plan must be costed and prepared instead of reusing the current hidden-argument tape.',
];
