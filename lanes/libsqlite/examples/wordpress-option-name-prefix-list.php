...
if ($databasePath === null || $prefixList === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-option-name-prefix-list.php path/to/wordpress.sqlite prefix[,prefix...] [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedNamePrefixes($prefixes, $limit),
);
