...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext193Plan;
...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext193Plan::compare(
    $sql,
    ['wp_options' => $current],
    ['wp_options' => $next],
);
