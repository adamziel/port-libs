...
$payload = [
    'scenario' => 'wordpress-json-table-hidden-rowid-path-current-source',
    'wordpressUse' => 'Copied wp_options plugin-rule diagnostics can pin hidden rowid aliases with path constraints while the next JSON source adds a rule.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-hidden-rowid-path-current-source self-test passed\n";
    return;
}
