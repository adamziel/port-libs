...
use PortLibs\LibSqlite\SQLitePagerMasterJournalCacheSpillSavepointCurrentSourceNext114Plan;
...
$plan = SQLitePagerMasterJournalCacheSpillSavepointCurrentSourceNext114Plan::currentSourceNext(
    $masterPath,
    $mainPath . "-journal\n" . $sitePath . "-journal\n",
    [
        [
