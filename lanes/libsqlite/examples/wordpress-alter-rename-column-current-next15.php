...
echo json_encode([
    ...
    'wordpressUse' => 'Preview ALTER TABLE wp_options RENAME COLUMN option_name TO option_key current-source schema rewrites for copied WordPress views, triggers, and expression indexes without requiring ext/sqlite; explicit SELECT aliases and string literals are preserved while source references, old/new trigger references, UPDATE OF lists, and expression predicates are rewritten.',
