...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext168Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext168Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
