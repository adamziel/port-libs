...
$next306 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext306(...$args);
$next307 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext307(...$args);
$next308 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext308(...$args);
$next309 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext309(...$args);
...
$summary = [
    ...
    'next307SourceReceipt' => $next307['next307_source_receipt']['next307_source_receipt'],
    'next307PreservesCurrentSource' => $next307['next307_source_receipt']['retry_rows_preserve_current_source'],
    'next308Preflight' => $next308['next308_preflight']['next308_preflight'],
    'next308IndependentPreflight' => $next308['next308_preflight']['independent_preflight'],
    'next309Final' => $next309['next309_final']['next309_final'],
    'next309Ready' => $next309['next309_ready'],
    'wordpressUse' => 'Copied wp_options imports can validate the next306-309 row-value UPDATE/DELETE RETURNING window current-source continuation after the ready next302-305 handoff while preserving independent preflight throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next306-309 self-test passed\n";
    return;
}
