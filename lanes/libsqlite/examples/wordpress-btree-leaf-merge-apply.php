...
echo json_encode([
    'scenario' => 'wordpress-btree-leaf-merge-apply',
    'wordpressUse' => 'Apply a copied wp_options autoload-index delete/rebalance preview by materializing the merged leaf page, placing the obsolete sibling on the freelist, and rewriting auto-vacuum pointer-map metadata without requiring ext/sqlite.',
