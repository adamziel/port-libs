...
$output = [
    ...
    'applicationUse' => 'Copied wp_options scans can advance a LIKE range over valid UTF-16 option_name index entries while quarantining odd-length and unpaired-surrogate UTF-16 text from the current/next source switch.',
];
