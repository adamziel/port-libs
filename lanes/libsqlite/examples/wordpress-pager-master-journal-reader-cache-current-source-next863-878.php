...
$base = [
    'source_id' => 'wordpress-pager-reader-cache-next878',
    'epoch' => 878,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 878, 0])),
    'publication_generation' => 878,
    'master_source_digest' => hash('sha256', 'wordpress next878 master source'),
...
$read = array_merge($base, [
    ...
    'reader_cache_stmt_vdbe_string8_branch_handoff_token' => 'stmt-vdbe-string8-branch-handoff-old',
]);
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeLiteralBranchHandoffFence(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
...
echo json_encode([
    ...
    'next878_reopen_reason' => $plan['next_reads'][0]['reader_cache_stmt_vdbe_string8_branch_handoff_token_reason'],
