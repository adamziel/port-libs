...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next176 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next176',
    'applicationUse' => 'Preview copied wp_options plugin scans where an ANALYZE-refresh partial expression index must use exact exclusive/inclusive STAT4 cursor boundaries.',
    'status' => $plan['status'],
