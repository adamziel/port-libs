...
echo json_encode([
    'wordpressScenario' => 'wp_options multicolumn index range planning keeps the first range as the current B-tree interval and leaves later range predicates as residual filters.',
