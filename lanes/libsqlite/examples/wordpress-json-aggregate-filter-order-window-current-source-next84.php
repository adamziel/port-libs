...
$summary = [
    'scenario' => 'wordpress-json-aggregate-filter-order-window-current-source-next84',
    ...
    'wordpressUse' => 'Copied wp_options import diagnostics can preview current-row JSON aggregate windows with aggregate-local ORDER BY and FILTER clauses before requiring ext/sqlite.',
];
