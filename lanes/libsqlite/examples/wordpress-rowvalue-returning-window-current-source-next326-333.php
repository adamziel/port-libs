...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options imports can validate the next326-333 row-value UPDATE/DELETE RETURNING window current-source continuation after the ready next322-325 handoff while preserving independent libsqlite throughput.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next326-333 self-test passed\n";
    return;
}
