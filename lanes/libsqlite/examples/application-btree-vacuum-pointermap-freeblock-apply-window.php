...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-apply-window',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, vacuum apply must publish pointer-map pages before reusable payload/freeblock pages and keep truncated tail pages fenced.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-apply-window self-test passed\n";
}
