...
$publishPlan = [
    ...
    'current_source_token' => ['id' => 'application-import-hot-journal-next230', 'epoch' => 230],
    'checkpoint_frame' => 52,
...
$ticket = static function (string $reader, string $scope, array $pages) use ($pageDigests): array {
    return [
        'reader_name' => $reader,
        'scope_name' => $scope,
        'source_token_id' => 'application-import-hot-journal-next230',
        'source_epoch' => 231,
        'checkpoint_frame' => 52,
        'checkpoint_cookie' => 90230,
        'schema_cookie' => 1230,
...
if (in_array('--self-test', $argv, true)) {
    if ($plan['status'] !== 'wal-hot-journal-savepoint-checkpoint-current-source-next230'
        ...
        fwrite(STDERR, "application-wal-hot-journal-savepoint-checkpoint-current-source-next230 self-test failed\n");
        exit(1);
    }

    echo "application-wal-hot-journal-savepoint-checkpoint-current-source-next230 self-test passed\n";
    return;
}
