...
$summary = [
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next163',
    'wordpressUse' => 'Copied wp_options plugin-rule previews can admit a pinned json_tree() cursor through generated path plus rowid alias xBestIndex metadata before the next source reparses.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next163 self-test passed\n";
    return;
}
