...
$summary = [
    'scenario' => 'copied WordPress taxonomy/options FK diagnostics with schema rootpage context',
    'status' => $page['status'],
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-pragma-integrity-rootpage-fk-current-source-next114 self-test passed\n";
    return;
}
