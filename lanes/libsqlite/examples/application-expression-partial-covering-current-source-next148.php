...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-expression-partial-covering-current-source-next148 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-expression-partial-covering-current-source-next148',
    'status' => $plan['status'],
