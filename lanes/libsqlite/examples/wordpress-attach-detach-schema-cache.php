...
echo json_encode([
    'wordpressUse' => 'Invalidate copied WordPress import prepared metadata plans when ATTACH/DETACH changes SQLite database_list/search order, so stale wp_sitemeta PRAGMA plans are reprepared without ext/sqlite.',
