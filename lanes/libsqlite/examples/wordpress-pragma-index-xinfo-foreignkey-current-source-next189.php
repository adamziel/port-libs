...
use PortLibs\LibSqlite\SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext189;
...
$page = SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext189::currentNextPageFromCatalog(
    $records,
    $tables,
    $nextRecords,
    $tables,
