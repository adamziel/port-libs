...
if ($databasePath === null || $names === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-uppercase-options-by-name-list.php path/to/wordpress.sqlite option_name[,option_name...] [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedUppercaseNames($optionNames, $limit),
);
