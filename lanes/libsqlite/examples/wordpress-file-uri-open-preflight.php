...
$copiedDatabase = SQLiteFileUri::parse('file:/srv/wordpress/wp-content/database/site%20copy.sqlite?mode=rw&cache=shared&immutable=0&wordpress=copy');
...
echo json_encode([
    ...
    'wordpressUse' => 'Decode and validate SQLite file: URI filenames before opening copied WordPress databases in repair, import, or read-only inspection tools without requiring ext/sqlite.',
