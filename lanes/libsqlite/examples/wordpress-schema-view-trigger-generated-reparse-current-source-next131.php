...
$summary = [
    'scenario' => 'wordpress-schema-view-trigger-generated-reparse-current-source-next131',
    'wordpressUse' => 'After a copied WordPress schema import adds a generated option-name column, dependent SELECT-star views and triggers are marked for current-source reparse before prepared statements are reused.',
    'schemaCookie' => [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-schema-view-trigger-generated-reparse-current-source-next131 self-test passed\n";
    return;
}
