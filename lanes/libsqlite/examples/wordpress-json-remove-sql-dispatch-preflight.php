...
echo json_encode([
    ...
    'wordpressUse' => 'Local-only wp_options cleanup preflight that preserves SQLite json_remove() text results versus jsonb_remove() JSONB blob results through SQL argument-vector dispatch before import.',
