...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext174Plan;
...
$summary = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext174Plan::execute(
    $tables,
