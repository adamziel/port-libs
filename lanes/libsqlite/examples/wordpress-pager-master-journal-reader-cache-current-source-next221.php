...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext221Plan;
...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext221Plan.php';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext221Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
