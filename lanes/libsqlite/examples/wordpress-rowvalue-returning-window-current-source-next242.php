...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext242Plan::execute(
    ['wp_options' => $rows],
...
return [
    ...
    'wordpressUse' => 'Copied wp_options imports can rollback a row-value UPDATE/DELETE RETURNING attempt and retry from the savepoint image while lag/lead and GROUPS-frame receipts prove suppressed attempt rows stay out of the released current source.',
