...
$plan = SQLiteEncodingAffinityLikeCurrentSourceNextPlan::wordpressOptionValueDynamicLikeGlobPlan(
    $currentRows,
    $nextRows,
    'option_value',
    'glob_pattern',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-affinity-glob-current-source-next105 self-test passed\n";
    return;
}
