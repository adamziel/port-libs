...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext168Plan.php';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext168Plan::plan(
    $databasePath,
    $masterPath,
    $masterBytes,
    implode('', $before),
