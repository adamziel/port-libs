...
if ($plan['invalidated_cache_page_numbers'] !== [3, 4]) {
    throw new RuntimeException('Stale Application reader cache pages were not invalidated');
}
...
echo "application-pager-master-journal-reader-cache-current-source-next164 self-test passed\n";
