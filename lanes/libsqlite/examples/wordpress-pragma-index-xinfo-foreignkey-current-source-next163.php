...
$page = SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext163::currentNextPageFromCatalog(
    $records,
    $currentTables,
    $records,
    $nextTables,
...
if (
    ...
    fwrite(STDERR, "wordpress-pragma-index-xinfo-foreignkey-current-source-next163 self-test failed\n");
    exit(1);
}
