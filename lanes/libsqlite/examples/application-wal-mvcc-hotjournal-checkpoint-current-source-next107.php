...
$result = [
    'scenario' => 'application-wal-mvcc-hotjournal-checkpoint-current-source-next107',
    'applicationUse' => 'Preview a copied Application SQLite database where a crashed import left both a hot rollback journal and WAL sidecar: pinned current readers keep their committed WAL snapshot while the next reader sees hot-journal recovery followed by a committed WAL checkpoint.',
    'status' => $plan['status'],
