...
echo json_encode([
    'scenario' => 'wordpress-wal-restart-truncate-savepoint-current-source-next91',
    'wordpressUse' => 'Model a plugin import savepoint that is released into its parent and then rolled back before a WAL restart/truncate checkpoint, while validating the current WAL source bytes used by copied wp_options repair tooling.',
    'restart' => [
