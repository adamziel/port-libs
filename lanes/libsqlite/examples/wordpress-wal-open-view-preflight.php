...
echo json_encode([
    ...
    'options' => array_map(
        ...
        $effectiveDatabase->wordpressOptions(),
    ),
    'wordpressUse' => 'Open a copied wp_options database with its sidecar -wal bytes in pure PHP, read committed option rows through the WAL overlay, preserve uncommitted draft frames, and preview checkpoint output before import or repair tooling accepts the database image.',
