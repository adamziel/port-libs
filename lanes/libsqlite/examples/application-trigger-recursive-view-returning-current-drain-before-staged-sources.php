...
return [
    ...
    'applicationUse' => 'Copied wp_options imports through an INSTEAD OF recursive view trigger can drain current-source RETURNING rows through the cursor next step while staged next source rows stay invisible until the import savepoint explicitly releases them.',
