...
echo json_encode([
    'scenario' => 'wordpress-btree-leaf-merge-plan',
    'wordpressUse' => 'Preview a copied wp_options delete/rebalance path that merges underfilled table and autoload index leaf siblings, removes the parent divider, and marks the obsolete right sibling for freelist reuse without requiring ext/sqlite.',
