...
$summary = [
    ...
    'wordpressUse' => 'Copied wp_options import audits can rank current options by a scalar compound subquery whose aggregate arms reference the current source row.',
    'rows' => $rows,
];
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-compound-correlated-aggregate-current-source-next124 self-test passed\n";
