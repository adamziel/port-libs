...
use PortLibs\LibSqlite\SQLitePragmaForeignKeyIntegrityRootpageCurrentSourceNext140Plan;
...
$page = SQLitePragmaForeignKeyIntegrityRootpageCurrentSourceNext140Plan::page(
    $currentDatabase,
    $currentSchemas,
    $catalog,
    $nextDatabase,
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-foreignkey-integrity-rootpage-current-source-next140 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-foreignkey-integrity-rootpage-current-source-next140 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-pragma-foreignkey-integrity-rootpage-current-source-next140',
