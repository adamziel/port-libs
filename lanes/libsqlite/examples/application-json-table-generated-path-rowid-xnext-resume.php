...
$summary = [
    'scenario' => 'application-json-table-generated-path-rowid-xnext-resume',
    'applicationUse' => 'Copied wp_options plugin-rule import previews can admit one batched xNext step from a pinned generated-path rowid cursor, while a changed next-source fence restarts xFilter before stale JSON rows are yielded.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-xnext-resume self-test passed\n";
    return;
}
