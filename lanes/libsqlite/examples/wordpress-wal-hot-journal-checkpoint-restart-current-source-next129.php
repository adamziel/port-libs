...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-checkpoint-restart-current-source-next129',
    'wordpressUse' => 'After a copied wp_options import leaves both a hot rollback journal and WAL frames, native PHP tooling recovers the hot journal, preserves the current WAL while a reader is pinned, then writes a released restart checkpoint generation for next readers.',
    'status' => $plan['status'],
