...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next214',
    'applicationUse' => 'Copied wp_options JSON diagnostics can satisfy repeated json_tree xColumn reads from the active generated-path rowid current cursor without rebuilding the next-source cursor.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next214 self-test passed\n";
    return;
}
