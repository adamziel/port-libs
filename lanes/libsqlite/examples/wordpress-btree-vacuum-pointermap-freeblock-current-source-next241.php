...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafFromDeleteResultNext241(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next241',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next241 self-test passed\n";
}
