...
echo json_encode([
    ...
    'wordpressUse' => 'Copied wp_options import summary using JSON aggregate window frames with FILTER-like include flags and SQLite EXCLUDE CURRENT ROW/GROUP/TIES peer handling without ext/sqlite.',
