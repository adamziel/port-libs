...
$plan = SQLiteJsonTablePlan::lateralRowidHiddenCurrentSourceNext105(
    $currentOptions,
    $nextOptions,
    'option_id',
    'option_value',
...
$summary = [
    'scenario' => 'wordpress-json-table-lateral-rowid-hidden-current-source-next105',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-json-table-lateral-rowid-hidden-current-source-next105 self-test passed\n";
    return;
}
