...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafContinuityFromDeleteResult(
    ...
    4,
    str_repeat('application-next164-replacement-chain-', 40),
    3,
    true,
);

echo json_encode([
    'application_scenario' => 'wp_options transient delete followed by replacement overflow allocation after incremental vacuum',
