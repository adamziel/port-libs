...
$page = SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139::page(
    $catalog,
...
if (($argv[1] ?? null) === '--self-test') {
    if (
        ...
        fwrite(STDERR, "wordpress-pragma-index-list-rootpage-integrity-current-source-next139 self-test failed\n");
        exit(1);
    }

    fwrite(STDOUT, "wordpress-pragma-index-list-rootpage-integrity-current-source-next139 self-test passed\n");
    exit(0);
}

echo json_encode([
    'scenario' => 'wordpress-pragma-index-list-rootpage-integrity-current-source-next139',
