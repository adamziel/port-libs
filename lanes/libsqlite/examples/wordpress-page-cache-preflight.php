...
if ($path === false) {
    throw new RuntimeException('Unable to create copied WordPress SQLite page-cache fixture');
}
...
echo json_encode([
    'scenario' => 'wordpress-page-cache-preflight',
    'wordpressUse' => 'Read bounded page-size-aligned SQLite pages for copied WordPress databases after open and header admission, without ext/sqlite or a shared VFS implementation.',
    'database' => [
