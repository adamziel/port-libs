...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows with SQLite ORDER BY collation and explicit NULL placement in native PHP, useful when imports need deterministic case-insensitive option ordering without ext/sqlite.',
    'sql' => $sql,
