...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext249Plan::materialize(
    $prepared,
    $source,
    [
...
printf(
    "wordpress sqlplanner stat4 expression partial current-source next249: %s peers=%s signature=%s\n",
    $plan['status'],
