...
$planner = SQLiteJsonTablePlan::currentSourceRowidHiddenConstraintPlannerNext99(
    'json_tree',
    $current,
    $next,
    'option_value',
...
$summary = [
    'scenario' => 'wordpress-json-table-rowid-hidden-constraint-current-source-next99',
    'rows' => $rows,
    ...
    'replanReasons' => $planner['next99ReplanReasons'],
