...
echo json_encode([
    'wordpressUse' => 'Plan a wp_options autoload rewrite in a deeper composite index, merge the underfilled source leaf below a non-root parent, and put the obsolete page on the freelist without the SQLite extension.',
    'plan' => $plan->toArray(),
    'lowerIndexParent' => [
        'page' => 4,
