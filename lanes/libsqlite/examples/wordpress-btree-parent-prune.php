...
echo json_encode([
    'wordpressUse' => 'Delete the last transient row from a copied wp_options leaf, remove the now-empty child pointer from its table-interior parent, and return the empty child plus obsolete overflow page to the freelist without ext/sqlite.',
    'plan' => $plan->toArray(),
