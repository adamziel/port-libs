...
echo json_encode([
    'scenario' => 'wordpress-subquery-covering-partial-current-source-next115',
    'status' => $plan['status'],
    ...
    'wordpressUse' => 'Preview copied wp_options plugin payload imports where a current-source partial lower(option_name) index probes IN-subquery keys while the subquery projection supplies autoload and option_value without a table lookup.',
