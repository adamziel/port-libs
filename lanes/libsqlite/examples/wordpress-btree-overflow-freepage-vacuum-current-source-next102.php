...
$plan = SQLiteBTreeOverflowVacuumFreepagePlan::fromOverflowChains(
    ...
    [
        ...
        [
            ...
            'record_values' => [['_transient_next102', 102]],
        ],
    ],
    secureDelete: true,
...
echo json_encode([
    'scenario' => 'wordpress-btree-overflow-freepage-vacuum-current-source-next102',
    'releasedOverflowPages' => $plan->releasePlan->releasedOverflowPages,
    'currentFreelistPages' => $plan->currentFreelistPages,
    'vacuumReuseRows' => $plan->overflowFreepageVacuumCurrentSourceNext102(5, 3),
