...
$result = [
    'wordpressUse' => 'Preview copied wp_options aggregate input rows ordered for group_concat(... ORDER BY ...) FILTER (WHERE include), while filtered-out rows with missing aggregate/order payloads are skipped before current/next iteration.',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "PASS wordpress vdbe aggregate filter order current next\n";
    exit(0);
}
