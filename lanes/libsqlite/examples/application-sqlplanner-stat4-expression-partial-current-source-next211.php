...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-next211 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-next211',
    'applicationUse' => 'Copied wp_options plugin admin pagination can reuse a changed STAT4 partial expression-index plan only after lower/upper seek-window samples and selected rowids are proven against the current source.',
    'status' => $plan['status'],
