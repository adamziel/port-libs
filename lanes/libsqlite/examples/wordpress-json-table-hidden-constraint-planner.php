...
echo json_encode([
    'scenario' => 'wordpress-json-table-hidden-constraint-planner',
    'wordpressUse' => 'Copied wp_options JSON diagnostics can keep the first hidden json/root argument pinned to the active option row while retaining duplicate hidden constraints as residual planner evidence for the next row source, including row-count transitions, without requiring ext/sqlite.',
