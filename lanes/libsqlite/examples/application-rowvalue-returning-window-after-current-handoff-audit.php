...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports can validate the prepared row-value UPDATE/DELETE RETURNING window current-source handoff with handoff, window-audit, source-audit, and final-seal metadata.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-after-current-handoff-audit self-test passed\n";
    return;
}
