...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-receipt-publication',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, publish reusable current-source pages only after pointer-map generations and freeblock receipts are commit-ready.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-receipt-publication self-test passed\n";
}
