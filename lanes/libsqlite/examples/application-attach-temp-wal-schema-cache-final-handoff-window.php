...
$plan = SQLiteAttachWalTempSchemaCachePlan::schemaCacheFinalHandoffWindow($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-attach-temp-wal-schema-cache-final-handoff-window self-test passed\n";
    return;
}
