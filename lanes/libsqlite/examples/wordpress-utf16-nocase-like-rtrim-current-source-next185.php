...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext185Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext185Plan::wordpressOptionNameDeletedTokenResumePlan(
    $current,
    $next,
    'plugin!_cache%',
    '!',
