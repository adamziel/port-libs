...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext218Plan::wordpressOptionNameYieldPagePlan(
    $current,
    $next,
    'plugin!_cache%',
    $enc('!', 'UTF-16LE'),
...
$summary = [
    'scenario' => 'wordpress-utf16-nocase-like-rtrim-current-source-next218',
    'wordpressUse' => 'Copied wp_options imports can resume a UTF-16 RTRIM/NOCASE LIKE page only when the ordered LIMIT window still matches the current-source token.',
    'status' => $plan['status'],
...
if (PHP_SAPI === 'cli' && realpath($_SERVER['SCRIPT_FILENAME'] ?? '') === __FILE__) {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next218 self-test passed\n";
}
