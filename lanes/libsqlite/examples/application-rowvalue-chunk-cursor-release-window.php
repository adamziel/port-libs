...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeChunkCursorReleaseWindow(
    ['wp_options' => $rows],
...
if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-chunk-cursor-release-window self-test passed\n";
    return;
}
...
return [
    ...
    'applicationUse' => 'Copied wp_options imports can keep next-source retry RETURNING rows hidden until current-source row-value UPDATE/DELETE window chunks have been acknowledged.',
