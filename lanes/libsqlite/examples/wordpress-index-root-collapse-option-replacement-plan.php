...
echo json_encode([
    'wordpressUse' => 'Plan a wp_options replacement that disables autoload, empties one composite secondary-index leaf, collapses the two-child index root, and returns obsolete child pages to the freelist without the SQLite extension.',
    'plan' => $plan->toArray(),
