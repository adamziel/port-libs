...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext242Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext242Plan::materialize(
    $prepared,
    $current,
    [
