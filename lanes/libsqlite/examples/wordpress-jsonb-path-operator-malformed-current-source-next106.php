...
echo json_encode([
    'wordpressUse' => 'Copied wp_options import diagnostics can keep the current JSONB path operator source stable while a next statement source contains malformed JSONB blobs, distinguishing malformed JSONB from missing JSON paths before native SELECT execution aborts.',
    'textOperator' => [
        'path' => $textPlan['path'],
