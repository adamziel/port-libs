...
if (($argv[1] ?? '') === '--self-test') {
    assert($plan['status'] === 'compound-select-window-recursive-limit-current-source-generation-seal-ready');
    ...
    echo "application-compound-select-window-recursive-limit-source-generation-seal self-test passed\n";
    return;
}
