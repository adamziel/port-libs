...
use PortLibs\LibSqlite\SQLitePlannerStat4ExpressionPartialCurrentSourceNext158Plan;
...
$plan = SQLitePlannerStat4ExpressionPartialCurrentSourceNext158Plan::materialize(
    $preparedSource,
    $currentSource,
    $predicate,
    $preparedRows,
