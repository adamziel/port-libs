...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-stat4-payload-fence self-test passed\n";
}

return [
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-stat4-payload-fence',
    'status' => $plan['status'],
    ...
    'applicationUse' => 'Copied wp_options plugin preload pagination can reuse a current-source partial lower(option_name) STAT4 index only after STAT4 expression payloads for yielded rowids match the current row image.',
];
