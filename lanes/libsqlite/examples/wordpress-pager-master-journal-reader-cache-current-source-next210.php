...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext210Plan.php';
...
$sourceId = 'wordpress-master-journal-read-source';
$masterDigest = hash('sha256', 'wordpress-next210-master-source');

$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext210Plan::plan(
    $database,
    $masterJournal,
    $masterBytes,
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-pager-master-journal-reader-cache-current-source-next210 self-test passed\n";
    return;
}
