...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-savepoint-checkpoint-post-checkpoint-append-admission',
...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    if (
        ...
        fwrite(STDERR, "wordpress-wal-hot-journal-savepoint-checkpoint-post-checkpoint-append-admission self-test failed\n");
        exit(1);
    }
