...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-rowvalue-update-delete-savepoint-current-source-next126 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-rowvalue-update-delete-savepoint-current-source-next126',
    'status' => $plan['status'],
