...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafMaterializedReceiptFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-current-source-next183',
...
if (
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-current-source-next183 self-test passed\n";
}
