...
echo json_encode([
    'scenario' => 'wordpress-index-leaf-balance-apply',
    'wordpressUse' => 'Apply a copied wp_options autoload-index delete rebalance by moving separator records through sibling index leaves and rewriting the parent divider without requiring ext/sqlite.',
