...
$payload = [
    'scenario' => 'application-json-table-generated-path-rowid-cost-current-source-next232',
    'applicationUse' => 'Copied wp_options JSON diagnostics keep a generated-path json_tree rowid batch pinned to the current source token before next-source rows are admitted.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-json-table-generated-path-rowid-cost-current-source-next232 self-test passed\n";
    return;
}
