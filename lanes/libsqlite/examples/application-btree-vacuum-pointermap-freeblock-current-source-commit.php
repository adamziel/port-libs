...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafReadbackAuditFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
...
echo json_encode([
    'scenario' => 'application-btree-vacuum-pointermap-freeblock-current-source-commit',
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient and vacuuming tail pages, commit only applied current-source pointer-map/freeblock pages while keeping truncated tail pages fenced.',
...
if (
    ...
    echo "application-btree-vacuum-pointermap-freeblock-current-source-commit self-test passed\n";
}
