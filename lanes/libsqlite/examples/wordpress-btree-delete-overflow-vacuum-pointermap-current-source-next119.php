...
echo json_encode([
    'wordpressUse' => 'Copied wp_options transient cleanup deletes table and option_name index overflow chains, frees their pointer-map entries, and incremental-vacuums only the tail pages while preserving a live page before the tail.',
    'scenario' => 'wordpress-btree-delete-overflow-vacuum-pointermap-current-source-next119',
