...
$output = [
    'scenario' => 'application-join-order-stat4-range-current-source-next116',
    ...
    'applicationUse' => 'Preview copied Application plugin-import joins where ANALYZE refreshes sqlite_stat4 enough to start from wp_options before probing postmeta/posts.',
];
...
echo "application-join-order-stat4-range-current-source-next116 self-test passed\n";
