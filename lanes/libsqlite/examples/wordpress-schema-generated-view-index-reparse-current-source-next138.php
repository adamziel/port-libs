...
$summary = [
    'scenario' => 'wordpress-schema-generated-view-index-reparse-current-source-next138',
    'wordpressUse' => 'Copied wp_options export views layered on generated-column index views keep their current-source reparse metadata when plugin import triggers read the nested view.',
    'status' => $plan['status'],
...
if (PHP_SAPI === 'cli' && in_array('--self-test', $argv, true)) {
    if (
        ...
        fwrite(STDERR, "wordpress-schema-generated-view-index-reparse-current-source-next138 self-test failed\n");
        exit(1);
    }

    echo "wordpress-schema-generated-view-index-reparse-current-source-next138 self-test passed\n";
    exit(0);
}
