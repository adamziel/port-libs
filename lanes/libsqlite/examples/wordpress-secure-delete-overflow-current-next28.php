...
echo json_encode([
    'wordpressUse' => 'Audit copied wp_options overflow current/next links before secure-delete release, then prove released overflow pages are freelist-owned and scrubbed without ext/sqlite.',
