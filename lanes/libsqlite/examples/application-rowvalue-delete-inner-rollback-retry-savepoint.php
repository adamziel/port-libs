...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeDeleteInnerRollbackRetrySavepoint(
    ['wp_options' => $rows],
    [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-rowvalue-delete-inner-rollback-retry-savepoint self-test passed\n";
    return;
}
