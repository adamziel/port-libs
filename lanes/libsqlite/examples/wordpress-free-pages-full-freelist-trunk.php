...
echo json_encode([
    'wordpressUse' => 'Preview freeing obsolete wp_options overflow pages when the current SQLite freelist trunk is full; the first freed page becomes a new trunk and secure-delete clears leaf pages before reuse.',
