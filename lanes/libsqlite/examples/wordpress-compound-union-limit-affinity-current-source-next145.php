...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options merge rows where UNION removes numeric duplicate ranks before a final LIMIT/OFFSET boundary, while text ranks with the same characters remain distinct SQLite values.',
    'status' => $plan['status'],
