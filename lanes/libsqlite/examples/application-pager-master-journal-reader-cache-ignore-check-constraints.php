...
$base = [
    'source_id' => 'application-pager-reader-cache-next310',
    'epoch' => 310,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 310, 0])),
    'publication_generation' => 310,
    'master_source_digest' => hash('sha256', 'application next310 master source'),
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-pager-master-journal-reader-cache-ignore-check-constraints self-test passed\n";
    return;
}
