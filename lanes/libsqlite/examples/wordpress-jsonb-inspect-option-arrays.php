...
if ($input === null || $paths === []) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-jsonb-inspect-option-arrays.php json-or-hex path [path...]\n");
...
echo json_encode([
    ...
    'checks' => $checks,
    'wordpressUse' => 'Preflight wp_options option arrays and postmeta migration queues stored as SQLite JSONB before import or migration tools append or reorder entries.',
