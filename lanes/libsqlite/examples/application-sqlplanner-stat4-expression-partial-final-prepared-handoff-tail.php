...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-sqlplanner-stat4-expression-partial-current-source-final-prepared-handoff self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-sqlplanner-stat4-expression-partial-current-source-final-prepared-handoff',
    'applicationUse' => 'Copied wp_options plugin-admin pagination carries the terminal prepared current-source STAT4 handoff into final-prepared-handoff only when projected current rows still match.',
    'status' => $plan['status'],
