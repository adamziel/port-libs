...
echo json_encode([
    'wordpressUse' => 'Apply a wp_options autoload index parent merge after delete underflow, freeing the obsolete sibling and rewriting auto-vacuum pointer-map ownership without the SQLite extension.',
