...
$digest = hash('sha256', 'application next256 sealed checkpoint source');
$sealedPlan = [
    ...
    'source_token' => 'application-next256-sealed-source',
...
$receipts = [
    array_replace($baseReceipt, ['name' => 'application-next256-front-page', 'reader_name' => 'front-page', 'readmark_slot' => 1, 'page_numbers' => [1, 2, 3]]),
    array_replace($baseReceipt, ['name' => 'application-next256-plugin-cache', 'reader_name' => 'plugin-cache', 'readmark_slot' => 2, 'page_numbers' => [3, 5, 8]]),
    array_replace($baseReceipt, ['name' => 'application-next256-options-import', 'reader_name' => 'wp-options-import', 'readmark_slot' => 3, 'page_numbers' => [8, 13]]),
];
