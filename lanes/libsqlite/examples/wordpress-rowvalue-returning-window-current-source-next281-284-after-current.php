...
$next281 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext281(...$args);
$next282 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext282(...$args);
$next283 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext283(...$args);
$next284 = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext284(...$args);
...
$summary = [
    'status' => 'rowvalue-update-delete-returning-window-current-source-next281-284-after-current',
    'candidateStatuses' => $statuses,
    'next281Receipt' => $next281['current_source_receipt_next281']['current_source_receipt_next281'],
    'next282Ledger' => $next282['returning_window_ledger_next282']['returning_window_ledger_next282'],
    'next283Window' => $next283['after_current_window_receipt_next283']['after_current_window_receipt_next283'],
    'next283RetryWindowRows' => $next283['after_current_window_receipt_next283']['retry_window_rows'],
    'next284Seal' => $next284['current_source_next284']['current_source_next284'],
    'next284Ready' => $next284['current_source_ready_next284'],
    'wordpressUse' => 'Copied wp_options imports can validate the prepared next281-284 after-current row-value UPDATE/DELETE RETURNING window current-source handoff as receipt, ledger, retry-window, and final seal metadata.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "wordpress-rowvalue-returning-window-current-source-next281-284-after-current self-test passed\n";
    return;
}
