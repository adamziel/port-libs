...
$pages[3] = SQLiteTableLeafPage::assemble([
    ...
    SQLiteTableLeafCell::encode(2, SQLiteRecord::encode([null, '_transient_final', str_repeat('cache:', 42)])),
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafFinalizationFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
    ...
    2,
    str_repeat('finalz-current-final-', 50),
    3,
    true,
    2,
);
...
echo json_encode([
    'scenario' => 'wordpress-btree-vacuum-pointermap-freeblock-finalization',
...
if (
    $summary['status'] === 'btree-vacuum-pointermap-freeblock-finalization-ready'
    ...
    echo "wordpress-btree-vacuum-pointermap-freeblock-finalization self-test passed\n";
}
