...
$next245 = require __DIR__ . '/wordpress-rowvalue-returning-window-current-source-next245.php';
$next246 = require __DIR__ . '/wordpress-rowvalue-returning-filter-window-current-source-next246.php';
ob_start();
$next247 = require __DIR__ . '/wordpress-rowvalue-returning-window-current-source-next247.php';
$next247Output = ob_get_clean();
$next247Decoded = json_decode((string) $next247Output, true, 512, JSON_THROW_ON_ERROR);
$next248 = require __DIR__ . '/wordpress-rowvalue-returning-window-current-source-next248.php';
...
return [
    ...
    'wordpressUse' => 'Copied wp_options imports can validate the prepared next245-248 current-source row-value UPDATE/DELETE RETURNING handoff as yield admission, filtered release receipts, peer-group exclusion, and resumable publication cursor coverage.',
];
