...
echo json_encode([
    'scenario' => 'wordpress-vacuum-page-size-autovacuum',
    'wordpressUse' => 'Preview a copied WordPress SQLite database VACUUM that applies pending page_size and auto_vacuum settings before import on hosts without ext-sqlite.',
