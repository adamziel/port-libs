...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::keyValueRowKeyReusedRowidResumePlan(
    $current,
    $next,
    'plugin!_cache%',
    '!',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "application-utf16-nocase-like-rtrim-current-source-next188 self-test passed\n";
    return;
}
