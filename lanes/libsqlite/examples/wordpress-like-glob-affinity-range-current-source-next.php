...
echo json_encode([
    'likePluginPrefix' => SQLiteEncodingLikeGlobAffinityRangeCurrentSourceNextPlan::wordpressOptionValuePlan(
        $currentRows,
        $nextRows,
        'option_value',
        'plugin:%',
    ...
    'globPluginPrefix' => SQLiteEncodingLikeGlobAffinityRangeCurrentSourceNextPlan::wordpressOptionValuePlan(
        $currentRows,
        $nextRows,
        'option_value',
        'plugin:*',
    ...
    'numericTextAffinity' => SQLiteEncodingLikeGlobAffinityRangeCurrentSourceNextPlan::wordpressOptionValuePlan(
        $currentRows,
        $nextRows,
        'option_value',
        '4%',
