...
$matches = $database->wordpressOptionsByIndexedJsonOptionValue('$.""', 'empty-label');

echo json_encode([
    'wordpressUse' => 'Preflight copied wp_options JSON expression indexes and skip malformed SQLite JSON paths before trusting root pages.',
    'pathSyntax' => [
    ...
    'matches' => array_map(static fn (SQLiteWordPressOption $option): string => $option->optionName, $matches),
