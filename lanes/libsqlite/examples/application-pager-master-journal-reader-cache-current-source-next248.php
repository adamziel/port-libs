...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-current-source-next248',
    'applicationUse' => 'A copied Application database keeps a shared schema reader-cache page only when the recovered sqlite_schema rootpage map and B-tree page-owner map are both current; stale wp_options page ownership and stale active_plugins rootpage readers reopen before import queries resume.',
    'status' => $plan['status'],
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next248'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-current-source-next248 self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-current-source-next248 self-test passed\n";
