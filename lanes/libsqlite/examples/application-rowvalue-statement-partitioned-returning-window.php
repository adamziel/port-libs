...
echo json_encode([
    ...
    'yielded_retry_statement_window_ordinals' => array_column($plan['yielded_retry_statement_window_rows'], 'statement_ordinal'),
    'yielded_retry_statement_window_actions' => array_column($plan['yielded_retry_statement_window_rows'], 'action'),
