...
$summary = [
    ...
    'applicationUse' => 'A copied wp_options import can yield RETURNING rows from an INSTEAD OF view trigger chain before rolling the current source back to a savepoint, then admit the next source from the saved image.',
    'status' => $plan['status'],
