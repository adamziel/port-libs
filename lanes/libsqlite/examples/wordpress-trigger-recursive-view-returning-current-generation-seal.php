...
if (
    ...
    fwrite(STDERR, "wordpress-trigger-recursive-view-returning-current-generation-seal self-test failed\n");
    exit(1);
}

echo "wordpress-trigger-recursive-view-returning-current-generation-seal self-test passed\n";
