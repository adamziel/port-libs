...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext180(
    'json_tree',
    $current,
    $next,
    'option_value',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next180 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next180',
    'wordpressUse' => 'Copied wp_options active_plugins JSON diagnostics can drain a pinned generated-path/rowid json_tree xFilter program into current-source materialized rows while forcing changed next-source rowsets through reprepare.',
