...
$result = [
    'scenario' => 'wordpress-pager-master-journal-reader-cache-current-source-next162',
    ...
    'wordpressUse' => 'After a copied wp_options database recovers through a master journal, the next PHP reader reuses only cache pages proven to match the current source and reopens stale or speculative reader tickets.',
...
if (
    ...
    fwrite(STDERR, "wordpress-pager-master-journal-reader-cache-current-source-next162 self-test failed\n");
    exit(1);
}
