...
echo json_encode([
    'wordpressUse' => 'Apply copied wp_options option_name index interior sibling redistribution to current page images, including parent divider replacement and auto-vacuum pointer-map ownership rewrites, without ext/sqlite.',
    'plan' => $plan->toArray(),
