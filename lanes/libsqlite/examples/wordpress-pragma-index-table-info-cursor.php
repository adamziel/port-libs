...
echo json_encode([
    'wordpressUse' => 'Iterate copied WordPress PRAGMA table_info/index_info rowsets with SQLite current/next cursor semantics so import code can stream temp wp_options metadata and attached site indexes without ext/sqlite.',
