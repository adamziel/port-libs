...
use PortLibs\LibSqlite\SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext210Plan;
...
$plan = SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNext210Plan::compare(
    $sql,
    ['wp_options' => $current],
    ['wp_options' => $next],
);
