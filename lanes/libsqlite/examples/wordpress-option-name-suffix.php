...
if ($databasePath === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-option-name-suffix.php path/to/wordpress.sqlite [option_name_suffix] [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedNameSuffix($suffix, $limit),
);
