...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext249Plan;
...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext249Plan::execute(
    ['wp_options' => $rows],
...
return [
    ...
    'wordpressUse' => 'Copied wp_options imports can checkpoint row-value UPDATE/DELETE RETURNING windows in small acknowledgement chunks, then resume retry rows only after the current-source yield chunks have a stable token.',
