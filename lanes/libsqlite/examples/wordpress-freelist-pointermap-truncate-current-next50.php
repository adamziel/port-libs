...
echo json_encode([
    'wordpressUse' => 'Copied wp_options transient cleanup can truncate tail freelist pages while preserving the current auto-vacuum pointer-map boundary for the next live B-tree page.',
