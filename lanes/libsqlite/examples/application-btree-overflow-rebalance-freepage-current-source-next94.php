...
$plan = SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNextPlan::baseTableLeaf(
...
$summary = [
    'scenario' => 'application-btree-overflow-rebalance-freepage-current-source-next94',
    'applicationUse' => 'Copied wp_options transient cleanup can free an emptied leaf page and its obsolete overflow chain into the same current-source freelist, including auto-vacuum pointer-map free-page entries, without ext/sqlite.',
...
if (
    ...
    fwrite(STDERR, "application-btree-overflow-rebalance-freepage-current-source-next94 self-test failed\n");
    exit(1);
}
