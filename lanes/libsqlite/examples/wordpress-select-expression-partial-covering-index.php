...
echo json_encode([
    'scenario' => 'wordpress-select-expression-partial-covering-index',
    ...
    'wordpressUse' => 'Preview copied wp_options SELECT planning where ordinary WHERE terms prove partial expression indexes safe, while covering metadata avoids table payload reads before native row decoding.',
