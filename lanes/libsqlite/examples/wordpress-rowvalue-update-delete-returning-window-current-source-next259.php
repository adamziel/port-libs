...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext259Plan;
...
$plan = SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext259Plan::execute(
    ['wp_options' => $rows],
    [
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-rowvalue-update-delete-returning-window-current-source-next259 self-test passed\n";
    return;
}
