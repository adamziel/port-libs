...
require_once __DIR__ . '/../src/SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext158Plan.php';

use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext158Plan;
...
$plan = SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext158Plan::tableLeafFromDeleteResult(
    $database,
    3,
    [
        'page' => $deletedPage,
