...
use PortLibs\LibSqlite\SQLitePagerCacheSpillWalSavepointCurrentSourceNext143Plan;
...
$plan = SQLitePagerCacheSpillWalSavepointCurrentSourceNext143Plan::currentSourceNext(
    $databasePath,
    implode('', $base),
    $pageSize,
    'plugin-settings',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-pager-cache-spill-wal-savepoint-current-source-next143 self-test passed\n";
    return;
}
