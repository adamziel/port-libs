...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows filtered by parser-level SQLite WITH RECURSIVE current-frontier CTE execution without requiring ext/sqlite.',
    'sql' => $sql,
