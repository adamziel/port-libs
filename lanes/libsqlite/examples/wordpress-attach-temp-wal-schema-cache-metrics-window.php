...
$plan = SQLiteAttachWalTempSchemaCacheCurrentSourceNextPlan::schemaCacheMetricsWindow($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "wordpress-attach-temp-wal-schema-cache-metrics-window self-test passed\n";
    return;
}
