...
$plan = SQLiteBTreeFreelistVacuumPointerMapCurrentSourceNext139Plan::fromDeleteResults(
...
$summary = [
    'scenario' => 'wordpress-btree-freelist-vacuum-pointermap-current-source-next139',
    'wordpressUse' => 'After deleting copied wp_options transient rows with tail overflow pages, incremental vacuum truncates removed tail pages and the replacement overflow chain reuses only surviving freelist pages with fresh pointer-map ownership.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-btree-freelist-vacuum-pointermap-current-source-next139 self-test passed\n";
    return;
}
