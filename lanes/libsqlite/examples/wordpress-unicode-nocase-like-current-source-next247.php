...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-unicode-nocase-like-current-source-next247 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-unicode-nocase-like-current-source-next247',
    'wordpressUse' => 'Copied wp_options scans with accented plugin slugs keep LIKE residuals authoritative across UTF-16LE/UTF-16BE source switches because SQLite NOCASE folds ASCII only.',
