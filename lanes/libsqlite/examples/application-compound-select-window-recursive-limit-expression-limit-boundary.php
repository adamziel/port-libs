...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-compound-select-window-recursive-limit-current-source-expression-limit-boundary self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'application-compound-select-window-recursive-limit-current-source-expression-limit-boundary',
    'applicationUse' => 'Copied wp_options import previews can evaluate expression-valued recursive and final compound LIMIT/OFFSET terms while window functions run before UNION distinct suppression shifts the current/next source boundary.',
