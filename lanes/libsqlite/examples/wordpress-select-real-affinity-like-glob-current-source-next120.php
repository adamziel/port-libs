...
$preview = [
    'scenario' => 'wordpress-select-real-affinity-like-glob-current-source-next120',
    'wordpressUse' => 'Copied wp_options diagnostics that store numeric option_value data as REAL can use SQLite-compatible LIKE/GLOB text affinity, preserving decimal points and exponent spelling without ext/sqlite.',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-select-real-affinity-like-glob-current-source-next120 self-test passed\n";
    return;
}
