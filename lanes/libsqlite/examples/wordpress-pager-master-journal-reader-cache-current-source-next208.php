...
require_once __DIR__ . '/../src/SQLitePagerMasterJournalReaderCacheCurrentSourceNext208Plan.php';
...
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNext208Plan::plan(
    $database,
    $masterJournal,
    $masterBytes,
    $databaseBytes,
