...
$likePlan = SQLiteEncodingCollationIndexLikeGlobCurrentSourceNextPlan::wordpressOptionNameIndexPlan(
    $currentRows,
    $nextRows,
    'plugin!_100!%%',
    'LIKE',
...
$globPlan = SQLiteEncodingCollationIndexLikeGlobCurrentSourceNextPlan::wordpressOptionNameIndexPlan(
    $currentRows,
    $nextRows,
    'plugin_😀*',
    'GLOB',
...
$summary = [
    'scenario' => 'wordpress-encoding-collation-index-like-glob-current-source-next89',
    'like' => [
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-encoding-collation-index-like-glob-current-source-next89 self-test passed\n";
    return;
}
