...
if ($databasePath === null || $valueList === null) {
    fwrite(STDERR, "Usage: php lanes/libsqlite/examples/wordpress-option-value-integer-list.php path/to/wordpress.sqlite integer_value[,integer_value...] [limit]\n");
...
$options = array_map(
    ...
    $database->wordpressOptionsByIndexedIntegerOptionValues($values, $limit),
);
