...
$result = [
    'scenario' => 'wordpress-json-aggregate-window-jsonb-distinct-current-source-next105',
    'wordpressUse' => 'Copied wp_options diagnostics can summarize current-source JSONB option payload windows while DISTINCT collapses duplicate JSONB payloads and FILTER skips disabled plugin rows before import.',
    'sqlShape' => $sql,
    'windows' => $windows,
