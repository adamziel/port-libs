...
$base = [
    'source_id' => 'application-pager-reader-cache-statement-virtual-branch-fence',
    'epoch' => 766,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 766, 0])),
    'publication_generation' => 766,
    'master_source_digest' => hash('sha256', 'application statement virtual branch fence master source'),
...
$read = array_merge($base, [
    ...
    'reader_cache_stmt_vdbe_init_branch_handoff_token' => 'stmt-vdbe-init-branch-handoff-old',
]);
$plan = SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceVdbeStatementInitBranchFence(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
