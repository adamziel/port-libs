...
require_once __DIR__ . '/../src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext177Plan.php';
...
$plan = SQLiteUtf16NocaseLikeRtrimCurrentSourceNext177Plan::wordpressOptionNameUnicodeWildcardPlan(
    $current,
    $next,
    'plugin!_cache_',
    '!',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-utf16-nocase-like-rtrim-current-source-next177 self-test passed\n";
    return;
}
