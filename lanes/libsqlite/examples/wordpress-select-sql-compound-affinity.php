...
return [
    'wordpressUse' => 'Preview copied wp_options compound INTERSECT/EXCEPT comparisons where SQLite does not apply affinity between text, numeric, and BLOB option_value storage classes before migration/import tooling deduplicates rows.',
