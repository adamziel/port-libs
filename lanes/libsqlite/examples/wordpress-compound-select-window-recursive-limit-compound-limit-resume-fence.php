...
$payload = [
    'scenario' => 'wordpress-compound-select-window-recursive-limit-compound-limit-resume-fence',
...
if (($payload['status'] ?? null) !== 'compound-select-window-recursive-limit-current-source-compound-limit-resume-fence-ready') {
    fwrite(STDERR, "wordpress-compound-select-window-recursive-limit-compound-limit-resume-fence self-test failed\n");
    exit(1);
}
if ($payload['nextOnly'] !== ['plugin_prime'] || $payload['resumeTokenLength'] !== 64 || $payload['requiredResumeAckCount'] !== 3) {
    fwrite(STDERR, "wordpress-compound-select-window-recursive-limit-compound-limit-resume-fence resume fence failed\n");
    exit(1);
}
