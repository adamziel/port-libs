...
$summary = [
    'scenario' => 'application-wal-checkpoint-reader-savepoint-recovery-current-source-next118',
    'applicationUse' => 'Recover a copied wp_options import after ROLLBACK TO trims a WAL savepoint prefix and a reader-pinned checkpoint crashes, ensuring recovery replays only the retained current-source WAL prefix instead of discarded savepoint frames.',
    'status' => $plan['status'],
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "application-wal-checkpoint-reader-savepoint-recovery-current-source-next118 self-test passed\n";
    return;
}
