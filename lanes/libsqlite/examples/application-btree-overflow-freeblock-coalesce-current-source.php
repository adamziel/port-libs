...
echo json_encode([
    'applicationUse' => 'After deleting an overflow-backed copied wp_options transient, coalesce the leaf freeblock fragments and release obsolete overflow pages into the freelist in one materialized page-image update.',
