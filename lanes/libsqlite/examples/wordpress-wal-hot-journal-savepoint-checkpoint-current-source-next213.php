...
$summary = [
    'wordpressUse' => 'After a copied wp_options import recovers a hot journal and a PASSIVE checkpoint preserves WAL bytes for an active reader, stale plugin/cron readers must reopen before a restart checkpoint may reset the WAL source.',
    'status' => $plan['status'],
