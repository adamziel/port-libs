...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options GROUP BY autoload summaries with count(), sum(), avg(), min(), max(), group_concat(), HAVING, and ORDER BY result semantics without requiring the SQLite extension.',
