...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewUpsertCurrentSourceNext235Plan;

$summary = SQLiteTriggerRecursiveViewUpsertCurrentSourceNext235Plan::execute(
    [
