...
$plan = SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext211(
    'json_tree',
    $current,
    $next,
    'option_value',
...
if (($argv[1] ?? null) === '--self-test') {
    ...
    echo "wordpress-json-table-generated-path-rowid-cost-current-source-next211 self-test passed\n";
    return;
}

echo json_encode([
    'scenario' => 'wordpress-json-table-generated-path-rowid-cost-current-source-next211',
