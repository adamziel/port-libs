...
echo json_encode([
    'scenario' => 'application-btree-freelist-vacuum-reuse-current-source-next104',
    'applicationUse' => 'After copied wp_options overflow cleanup and incremental vacuum, reuse surviving free pages for new table/index B-tree pages while leaving truncated tail pages unavailable.',
