...
$summary = [
    'scenario' => 'wordpress-pager-master-journal-statement-recovery-current-next80',
    'wordpressUse' => 'Roll back failed plugin statement pages across copied wp_options and multisite metadata databases while preserving the master journal and outer rollback journals for the active attached transaction.',
...
if (
    ...
    fwrite(STDERR, "wordpress-pager-master-journal-statement-recovery-current-next80 self-test failed\n");
    exit(1);
}
