...
echo json_encode([
    'wordpressUse' => 'Plan a wp_options replacement that changes autoload and splits a full same-depth composite secondary-index leaf, without the SQLite extension.',
    'plan' => $plan->toArray(),
