...
$plan = SQLiteAttachWalTempSchemaCachePlan::schemaCacheAuditWindow($schemas, $statements, [
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-attach-temp-wal-schema-cache-audit-window self-test passed\n";
    return;
}
