...
$summary = [
    'scenario' => 'wordpress-wal-checkpoint-hot-journal-reader-hot-journal-reader',
...
if (in_array('--self-test', $argv, true)) {
    ...
    echo "wordpress-wal-checkpoint-hot-journal-reader-hot-journal-reader self-test passed\n";
    return;
}
