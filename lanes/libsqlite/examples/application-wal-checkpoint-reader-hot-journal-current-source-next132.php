...
$summary = [
    'scenario' => 'application-wal-checkpoint-reader-hot-journal-current-source-next132',
    'applicationUse' => 'After a copied wp_options import leaves a hot rollback journal and a reader still holds an older WAL source, native PHP tooling restores the hot journal but defers restart checkpoint reset until the reader reopens on the current WAL source.',
    'status' => $plan['status'],
