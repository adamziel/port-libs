...
$plan = SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext157(
    ['wp_options' => $rows],
...
$summary = [
    'scenario' => 'wordpress-rowvalue-update-delete-returning-savepoint-current-source-next157',
...
if (
    ...
    fwrite(STDERR, "wordpress-rowvalue-update-delete-returning-savepoint-current-source-next157 self-test failed\n");
    exit(1);
}

echo "wordpress-rowvalue-update-delete-returning-savepoint-current-source-next157 self-test passed\n";
