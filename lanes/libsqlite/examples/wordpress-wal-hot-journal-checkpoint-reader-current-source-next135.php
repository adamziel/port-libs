...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-checkpoint-reader-current-source-next135',
    'wordpressUse' => 'After a copied wp_options import recovers a hot rollback journal, a current WAL reader stays pinned to its source while a later writer opens the next WAL generation for new option rows.',
    'status' => $plan['status'],
