...
echo json_encode([
    'scenario' => 'wordpress-json-import-savepoint-insert-current-next48',
    'wordpressUse' => 'Insert missing copied wp_options JSON rows inside the active import savepoint while statement rollback removes a malformed inserted row without discarding earlier JSON imports.',
    'status' => $plan['status'],
