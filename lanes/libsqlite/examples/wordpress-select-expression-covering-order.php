...
echo json_encode([
    'scenario' => 'wordpress-select-expression-covering-order',
    ...
    'wordpressUse' => 'Preview copied wp_options SELECT planning where lower(option_name) expression lookup can stream autoload/option_id ordering from trailing index columns and avoid table reads for option_value.',
