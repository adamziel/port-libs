...
echo json_encode([
    'wordpressUse' => 'Plan a generated wp_options insert while splitting a full same-depth option_name index leaf, without the SQLite extension.',
    'plan' => $plan->toArray(),
    ...
    'insertedOption' => $postDatabase->wordpressOptionByIndexedName($optionName)?->toArray(),
