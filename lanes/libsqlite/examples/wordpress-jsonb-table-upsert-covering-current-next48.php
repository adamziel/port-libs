...
echo json_encode([
    'scenario' => 'wordpress-jsonb-table-upsert-covering-current-next48',
    'wordpressUse' => 'Preview copied wp_options INSERT ... ON CONFLICT DO UPDATE rows whose JSONB option_value feeds generated/path indexes, yielding current index deletes, next inserts, inserted-row entries, and covering RETURNING-style rows without ext/sqlite.',
