...
echo json_encode([
    ...
    'wordpressUse' => 'Preview copied wp_options auto-vacuum table-root split where both new child pages receive btree-page pointer-map entries owned by the current root page.',
    'plan' => $plan->toArray(),
    'root' => [
        'page' => 3,
