...
echo json_encode([
    'wordpressUse' => 'Preview copied wp_options rows enriched by correlated scalar SELECT subqueries in projection, expression ORDER BY, and composed labels without requiring ext/sqlite.',
