...
$summary = [
    'scenario' => 'wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next185',
    'wordpressUse' => 'A copied WordPress import recovers a hot journal and rolls back a savepoint, then admits only prepared wp_options/usermeta readers that observed the current WAL checkpoint sequence and salt.',
    'status' => $plan['status'],
...
if ($summary['status'] !== 'wal-hot-journal-savepoint-checkpoint-current-source-next185'
    ...
    fwrite(STDERR, "wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next185 self-test failed\n");
    exit(1);
}
