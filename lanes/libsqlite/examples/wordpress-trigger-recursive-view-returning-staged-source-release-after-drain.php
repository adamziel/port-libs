...
if (PHP_SAPI === 'cli' && basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'] ?? '')) {
    ...
    echo "wordpress-trigger-recursive-view-returning-current-source-next166 self-test passed\n";
}

return [
    'scenario' => 'wordpress-trigger-recursive-view-returning-current-source-next166',
    'wordpressUse' => 'Copied wp_options imports through recursive INSTEAD OF view triggers drain current RETURNING rows before trigger-generated audit rows seed a released next view source.',
