...
$summary = [
    'scenario' => 'application-pager-master-journal-reader-cache-current-source-next259',
    'applicationUse' => 'A copied Application SQLite database reopens page-1 schema and active_plugins readers unless their cached header version-valid-for value matches the recovered master-journal current source before plugin import resumes.',
    'status' => $plan['status'],
...
if ($summary['status'] !== 'pager-master-journal-reader-cache-current-source-next259'
    ...
    fwrite(STDERR, "application-pager-master-journal-reader-cache-current-source-next259 self-test failed\n");
    exit(1);
}

echo json_encode($summary, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) . "\n";
echo "application-pager-master-journal-reader-cache-current-source-next259 self-test passed\n";
