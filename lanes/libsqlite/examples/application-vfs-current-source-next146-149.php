...
$summary = [
    'scenario' => 'application-vfs-current-source-next146-149',
    'applicationUse' => 'Carry hydrated Application SQLite VFS main/temp handles through next146-149 current-source routing while opening a readonly archive database.',
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    echo "application-vfs-current-source-next146-149 self-test passed\n";
    return;
}
