...
$summary = [
    ...
    'applicationUse' => 'Copied wp_options imports validate the next846-861 row-value UPDATE/DELETE RETURNING window current-source continuation as the direct handoff from next845_ready.',
];

if (($argv[1] ?? null) === '--self-test') {
    echo "application-rowvalue-returning-window-current-source-next846-861 self-test passed\n";
    return;
}
