...
$cases = [
    ...
    'dependency previous recovery' => static fn (): mixed => in_array('sqlite-pager-savepoint-master-journal-current-source-next92', $plan()['dependencies'], true),
...
$expected = [
    ...
    'retry status' => 'master_journal_recovered_retry_savepoint_current_source_next',
