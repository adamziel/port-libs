...
$pathEquals123 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123(
    'json_tree',
    $current123,
    $next123,
    'option_value',
...
$pathLike123 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123(
    'json_tree',
    $current123,
    $next123,
    'option_value',
...
$pathIn123 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123(
    'json_tree',
    $current123,
    $next123,
    'option_value',
...
$pathBetween123 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123(
    'json_tree',
    $current123,
    $next123,
    'option_value',
...
$stable123 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123(
    'json_tree',
    $current123,
    $current123,
    'option_value',
...
$unrunnable123 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123(
    'json_tree',
    $current123,
...
$nonPath123 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123(
    'json_each',
    $current123,
    $current123,
    'option_value',
...
$tests = [
    ...
    'bad json column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123('json_tree', $current123, $next123, '', [])),
    'bad root column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123('json_tree', $current123, $next123, 'option_value', [], '')),
    'missing json source is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123('json_tree', ['scan_root' => '$'], $next123, 'option_value', [])),
    'malformed root path is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123('json_tree', $current123, array_replace($next123, ['scan_root' => '$[']), 'option_value', [], 'scan_root')),
    'bad function is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123('json_bad', $current123, $next123, 'option_value', [])),
];
