...
$plan248 = static fn (?array $samples = null, ?array $rows = null, int $limit = 8, int $offset = 0): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext248Plan::materialize(
    $prepared248(),
