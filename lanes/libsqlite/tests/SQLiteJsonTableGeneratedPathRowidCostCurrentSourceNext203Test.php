...
): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext203(
    'json_tree',
    $current ?? $current203,
    $next ?? $next203,
    'option_value',
...
$tests = [
    ...
    'current checkpoint rowids' => static fn (TestRunner $t) => $t->same([8], $plan203()['currentGeneratedPathRowidAliasProjection203']['checkpointRowids']),
    'current accepted rowids' => static fn (TestRunner $t) => $t->same([8], $plan203()['currentGeneratedPathRowidAliasProjection203']['acceptedRowids']),
    ...
    'current estimated rows one' => static fn (TestRunner $t) => $t->same(1, $plan203()['currentGeneratedPathRowidAliasProjection203']['estimatedRows']),
    'current estimated cost includes alias width' => static fn (TestRunner $t) => $t->same(7, $plan203()['currentGeneratedPathRowidAliasProjection203']['estimatedCost']),
    'current alias opcode point' => static fn (TestRunner $t) => $t->same('OP_JsonTableRowidAliasPointNext203', $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasOpcode']),
    'current cost class point wide' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-alias-point-wide-next203', $plan203()['currentGeneratedPathRowidAliasProjection203']['costClass']),
    ...
    'current alias tape rowid' => static fn (TestRunner $t) => $t->same(8, $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['rowid']),
    ...
    'rowid alias value' => static fn (TestRunner $t) => $t->same(8, $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['aliasValues']['rowid']),
    '_rowid_ alias value' => static fn (TestRunner $t) => $t->same(8, $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['aliasValues']['_rowid_']),
    'oid alias value' => static fn (TestRunner $t) => $t->same(8, $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['aliasValues']['oid']),
    'projected rowid value' => static fn (TestRunner $t) => $t->same(8, $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['projectedColumns']['rowid']),
    'projected _rowid_ value' => static fn (TestRunner $t) => $t->same(8, $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['projectedColumns']['_rowid_']),
    'projected oid value' => static fn (TestRunner $t) => $t->same(8, $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['projectedColumns']['oid']),
    'projected text value' => static fn (TestRunner $t) => $t->same('forms', $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['projectedColumns']['value']),
    'projected type value' => static fn (TestRunner $t) => $t->same('text', $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['projectedColumns']['type']),
    'projected fullkey value' => static fn (TestRunner $t) => $t->same('$.rules[2].slug', $plan203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['projectedColumns']['fullkey']),
    ...
    'range accepted rowids' => static fn (TestRunner $t) => $t->same([6, 5], $range203()['currentGeneratedPathRowidAliasProjection203']['acceptedRowids']),
    ...
    'range cost class' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-alias-range-next203', $range203()['currentGeneratedPathRowidAliasProjection203']['costClass']),
    'range estimated rows' => static fn (TestRunner $t) => $t->same(2, $range203()['currentGeneratedPathRowidAliasProjection203']['estimatedRows']),
    'range estimated cost includes aliases' => static fn (TestRunner $t) => $t->same(14, $range203()['currentGeneratedPathRowidAliasProjection203']['estimatedCost']),
    'range first rowid alias value' => static fn (TestRunner $t) => $t->same(6, $range203()['currentGeneratedPathRowidAliasProjection203']['aliasTape'][0]['aliasValues']['rowid']),
    ...
    'single alias cost' => static fn (TestRunner $t) => $t->same(3, $singleAlias203()['currentGeneratedPathRowidAliasProjection203']['estimatedCost']),
    'single alias cost class' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-alias-point-next203', $singleAlias203()['currentGeneratedPathRowidAliasProjection203']['costClass']),
...
foreach ($tests as $name => $case) {
    $tests['json table generated path rowid cost current source next203 ' . $name] = $case;
    unset($tests[$name]);
}
