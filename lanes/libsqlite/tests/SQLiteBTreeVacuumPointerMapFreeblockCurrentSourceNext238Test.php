...
$plan238 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext238Plan {
    global $database238;

    $database = $database238();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext238Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
