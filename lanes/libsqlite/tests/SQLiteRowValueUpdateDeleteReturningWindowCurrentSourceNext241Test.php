...
$plan241 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePairCurrentRowFrames(
    $tables241,
    [$attemptUpdate241, $attemptDelete241],
    [$retryUpdate241, $retryDelete241],
    $unique241,
);
$customPlan241 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePairCurrentRowFrames(
    $tables241,
    [$attemptUpdate241],
    [$retryUpdate241],
    $unique241,
...
$cases241 = [
    ...
    'plan savepoint' => [static fn (): mixed => $plan241()['savepoint'], 'app_settings_rowvalue_returning_window_next241'],
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePairCurrentRowFrames($tables241, [], [$retryUpdate241], $unique241), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePairCurrentRowFrames($tables241, [$attemptUpdate241], [], $unique241), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePairCurrentRowFrames($tables241, [$attemptUpdate241], [$retryUpdate241], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePairCurrentRowFrames($tables241, [$attemptUpdate241], [$retryUpdate241], $unique241, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePairCurrentRowFrames(['wp_options' => ['bad']], [$attemptUpdate241], [$retryUpdate241], $unique241), InvalidArgumentException::class],
];
