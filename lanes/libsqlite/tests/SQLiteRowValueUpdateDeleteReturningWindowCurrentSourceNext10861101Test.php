...
$cases = [
    'combined next1086-1101 current-source handoff seal' => static function (TestRunner $t) use ($examplesDir): void {
        $result = require $examplesDir . '/wordpress-rowvalue-returning-window-current-source-next1086-1101.php';
        ...
        $t->same('rowvalue-update-delete-returning-window-current-source-next1086-1101', $result['status']);
...
foreach ($cases as $name => $callback) {
    $tests['rowvalue update delete returning window current source next1086-1101 ' . $name] = $callback;
}
