...
): array => SQLitePragmaQuickcheckIndexRootpageCurrentSourceNext135::page(
...
$tests['pragma quickcheck index rootpage current source next135 rejects negative offset'] = static function (TestRunner $t) use ($catalogFactory, $validDatabase): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaQuickcheckIndexRootpageCurrentSourceNext135::page($catalogFactory(), 'PRAGMA index_xinfo(wp_options_plugin_expr)', $validDatabase, -1, 135));
};
...
$tests['pragma quickcheck index rootpage current source next135 rejects zero limit'] = static function (TestRunner $t) use ($catalogFactory, $validDatabase): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaQuickcheckIndexRootpageCurrentSourceNext135::page($catalogFactory(), 'PRAGMA index_xinfo(wp_options_plugin_expr)', $validDatabase, 0, 0));
};
