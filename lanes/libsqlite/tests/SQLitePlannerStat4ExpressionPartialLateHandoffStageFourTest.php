...
$tests = [
    ...
    'planner stat4 expression partial current source next718733 cursor appended' => static fn (TestRunner $t) => $t->same('PrepareStat4ExpressionPartialPreparedHandoffRange', $plan718733()['cursorProgram'][array_key_last($plan718733()['cursorProgram'])]['opcode']),
    'planner stat4 expression partial current source next718733 cursor mode' => static fn (TestRunner $t) => $t->same('prepared-handoff-range-current-source-stat4-expression-partial-prep', $plan718733()['cursorProgram'][array_key_last($plan718733()['cursorProgram'])]['mode']),
