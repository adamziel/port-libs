...
$plan254 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $database254;

    $database = $database254();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafCurrentSourceFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases254 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan254()->currentSourceSummary()['non_overlap'], 'does not repeat allocation publication'),
...
$expected254 = [
    ...
    'dependency closure' => 'no new support component needed; next254 reuses allocation publication rows and records page-local current-source freeblock write slots',
    'non overlap' => true,
