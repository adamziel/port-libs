...
use PortLibs\LibSqlite\SQLiteTriggerReturningFkSavepointCurrentNext74Plan;
...
$cascade = static fn (): array => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update(
    $parents,
    $children,
    $assignments,
...
$deferred = static fn (): array => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update(
    $parents,
    $children,
...
$immediate = static fn (): array => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update(
    $parents,
    $children,
...
$setNull = static fn (): array => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update(
    $parents,
    $children,
...
$triggerRollback = static fn (): array => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update(
    $parents,
    $children,
    $assignments,
    static fn (array $row): bool => $row['option_id'] >= 3,
...
$cases = [
    ...
    'bad savepoint rejected' => [static fn (): mixed => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update($parents, $children, $assignments, static fn (): bool => true, ['parent_key' => 'option_id', 'child_key' => 'option_id'], [], ['*'], ['savepoint' => 'bad-name']), InvalidArgumentException::class],
    'empty assignments rejected' => [static fn (): mixed => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update($parents, $children, [], static fn (): bool => true, ['parent_key' => 'option_id', 'child_key' => 'option_id']), InvalidArgumentException::class],
    'bad fk action rejected' => [static fn (): mixed => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update($parents, $children, $assignments, static fn (): bool => true, ['parent_key' => 'option_id', 'child_key' => 'option_id', 'on_update' => 'restrict-now']), InvalidArgumentException::class],
    'bad trigger action rejected' => [static fn (): mixed => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update($parents, $children, $assignments, static fn (): bool => true, ['parent_key' => 'option_id', 'child_key' => 'option_id'], [['timing' => 'before', 'event' => 'update', 'action' => 'delete-row']]), InvalidArgumentException::class],
    'bad returning column rejected' => [static fn (): mixed => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update($parents, $children, $assignments, static fn (array $row): bool => $row['option_id'] === 1, ['parent_key' => 'option_id', 'child_key' => 'option_id', 'on_update' => 'cascade'], [], ['missing']), InvalidArgumentException::class],
    'bad conflict action rejected' => [static fn (): mixed => SQLiteTriggerReturningFkSavepointCurrentNext74Plan::update($parents, $children, $assignments, static fn (): bool => true, ['parent_key' => 'option_id', 'child_key' => 'option_id'], [], ['*'], ['conflict_action' => 'replace']), InvalidArgumentException::class],
];
