...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext241Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext241Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
