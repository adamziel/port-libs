...
$currentTables188 = ['wp_options' => $currentOptions188];
$nextTables188 = ['wp_options' => $nextOptions188];
...
$tests['compound select window recursive limit next188 compound metadata'] = static function (TestRunner $t) use ($summary188): void {
    $compound = $summary188()['compound'];
...
$tests['compound select window recursive limit next188 current rows'] = static function (TestRunner $t) use ($summary188): void {
    $rows = $summary188()['currentRows'];
...
$tests['compound select window recursive limit next188 next rows'] = static function (TestRunner $t) use ($summary188): void {
    $rows = $summary188()['nextRows'];
...
$tests['compound select window recursive limit next188 prelimit rowsets'] = static function (TestRunner $t) use ($summary188): void {
    $plan = $summary188();
...
$tests['compound select window recursive limit next188 window endpoints'] = static function (TestRunner $t) use ($summary188): void {
    $windows = $summary188()['windows'];
...
$tests['compound select window recursive limit next188 recursive trace'] = static function (TestRunner $t) use ($summary188): void {
    $recursive = $summary188()['recursive'];
...
$tests['compound select window recursive limit next188 endpoint tape'] = static function (TestRunner $t) use ($summary188): void {
    $tape = $summary188()['frameEndpointTape'];
...
$tests['compound select window recursive limit next188 limit trace'] = static function (TestRunner $t) use ($summary188): void {
    $trace = $summary188()['limitTrace'];
...
$tests['compound select window recursive limit next188 boundary delta'] = static function (TestRunner $t) use ($summary188): void {
    $boundary = $summary188()['boundary'];
...
$tests['compound select window recursive limit next188 replan reasons'] = static function (TestRunner $t) use ($summary188): void {
    $reasons = $summary188()['replanReasons'];
...
foreach (range(1, 52) as $case) {
    $tests['compound select window recursive limit next188 generated endpoint boundary ' . $case] = static function (TestRunner $t) use ($case): void {
        $tables = [
            'wp_options' => [
