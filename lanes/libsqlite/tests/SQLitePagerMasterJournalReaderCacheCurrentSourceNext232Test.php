...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext232Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext232Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
