...
$plan213 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $database213;

    $database = $database213();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafPageReceiptPublicationFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases213 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan213()->receiptSummary()['non_overlap'], 'does not repeat page-apply'),
...
$expected213 = [
    ...
    'dependency closure' => 'no new support component needed; next213 reuses page-apply current-source apply rows, pointer-map/payload page classes, leaf freeblock receipts, and fenced-tail metadata',
    'non overlap' => true,
