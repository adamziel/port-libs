...
$plan235 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext235Plan {
    global $database235;

    $database = $database235();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext235Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
