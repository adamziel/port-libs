...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext233Plan;
...
$plan233 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext233Plan {
    global $database233;

    $database = $database233();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext233Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases233 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan233()->checkpointSummary()['non_overlap'], 'does not repeat next229'),
...
$expected233 = [
    ...
    'dependency closure' => 'no new support component needed; next233 reuses next229 resume rows and records checkpoint-admission receipts only',
    'non overlap' => true,
    'resume action' => 'btree-vacuum-pointermap-freeblock-current-source-next229',
    'resume row count' => 7,
