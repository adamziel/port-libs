...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext191Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext191Plan::plan(
    $path ?? $database,
    $masterPath ?? $master,
