...
$cases202 = [
    ...
    'base next196 admitted' => [static fn (): mixed => $released202()['base_generationDepthFence']['status_next196'], 'trigger-recursive-view-returning-current-source-next196-next-source-visible'],
    'base next196 held' => [static fn (): mixed => $baseHeld202()['base_generationDepthFence']['status_next196'], 'trigger-recursive-view-returning-current-source-next196-awaiting-recursive-child-acks'],
    ...
    'plan decision base' => [static fn (): mixed => $baseHeld202()['current_source_next_plan_generationDepthFence']['decision'], 'hold-next-until-next196-child-drain'],
    ...
    'dependency closure marker' => [static fn (): mixed => $released202()['dependency_closure_generationDepthFence'], 'no new support component needed; reuses next196 recursive child drain and adds current view generation/depth acknowledgement fencing'],
    ...
    'dependencies include next196' => [static fn (): mixed => in_array('sqlite-trigger-recursive-view-returning-current-source-next196', $released202()['dependencies_generationDepthFence'], true), true],
    'non overlap names next196' => [static fn (): mixed => str_contains($released202()['non_overlap_generationDepthFence'], 'next196 child-ordinal drains'), true],
