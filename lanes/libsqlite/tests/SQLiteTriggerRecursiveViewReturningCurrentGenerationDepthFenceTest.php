...
$generationHeld202 = static fn (): array => $plan202(['expected_current_view_generation_generationDepthFence' => 'app.current.recursive.view.stale.202']);
$baseHeld202 = static fn (): array => $plan202(['recursive_child_acknowledged_ordinals' => [0]]);
$custom202 = static fn (): array => $plan202([
    'current_view_generation_generationDepthFence' => 'app.current.recursive.view.custom.202',
    'expected_current_view_generation_generationDepthFence' => 'app.current.recursive.view.custom.202',
    'next_view_generation_generationDepthFence' => 'app.next.recursive.view.custom.202',
    'returning_resume_barrier_generationDepthFence' => 'app.returning.resume.custom.202',
...
$cases202 = [
    ...
    'savepoint retained' => [static fn (): mixed => $released202()['savepoint_generationDepthFence'], 'app_recursive_view_202'],
    'current generation retained' => [static fn (): mixed => $released202()['current_view_generation_generationDepthFence'], 'app.current.recursive.view.202'],
    'expected generation retained' => [static fn (): mixed => $released202()['expected_current_view_generation_generationDepthFence'], 'app.current.recursive.view.202'],
    'custom current generation retained' => [static fn (): mixed => $custom202()['current_view_generation_generationDepthFence'], 'app.current.recursive.view.custom.202'],
    ...
    'next generation retained' => [static fn (): mixed => $released202()['next_view_generation_generationDepthFence'], 'app.next.recursive.view.202'],
    'custom next generation retained' => [static fn (): mixed => $custom202()['next_view_generation_generationDepthFence'], 'app.next.recursive.view.custom.202'],
    'barrier retained' => [static fn (): mixed => $released202()['returning_resume_barrier_generationDepthFence'], 'app.returning.resume.barrier.202'],
    'custom barrier retained' => [static fn (): mixed => $custom202()['returning_resume_barrier_generationDepthFence'], 'app.returning.resume.custom.202'],
    ...
    'current generation stamped' => [static fn (): mixed => array_values(array_unique(array_column($released202()['current_generation_rows_generationDepthFence'], 'current_view_generation_generationDepthFence'))), ['app.current.recursive.view.202']],
    'next generation stamped' => [static fn (): mixed => array_values(array_unique(array_column($released202()['attempted_next_generation_rows_generationDepthFence'], 'next_view_generation_generationDepthFence'))), ['app.next.recursive.view.202']],
    'barrier stamped on current rows' => [static fn (): mixed => array_values(array_unique(array_column($released202()['current_generation_rows_generationDepthFence'], 'returning_resume_barrier_generationDepthFence'))), ['app.returning.resume.barrier.202']],
    'barrier stamped on next rows' => [static fn (): mixed => array_values(array_unique(array_column($released202()['attempted_next_generation_rows_generationDepthFence'], 'returning_resume_barrier_generationDepthFence'))), ['app.returning.resume.barrier.202']],
    ...
    'visible payload names released' => [static fn (): mixed => array_column($released202()['visible_returning_payloads_generationDepthFence'], 'name'), ['app_summary', 'theme_style_key', 'template', 'app_summary_child', 'template_child', 'landing_url', 'next_module']],
    'held payload names depth' => [static fn (): mixed => array_column($depthHeld202()['held_next_returning_payloads_generationDepthFence'], 'name'), ['landing_url', 'next_module']],
