...
): array => SQLiteUtf16CollationAffinityPatternCurrentSourceNext118Plan::wordpressOptionValuePlan(
    $currentRows,
    $nextRows,
...
$tests['utf16 glob literal bracket current source next122 stable same range encoding is reusable'] = static function (TestRunner $t) use ($currentRows, $bytes): void {
    $stable = SQLiteUtf16CollationAffinityPatternCurrentSourceNext118Plan::wordpressOptionValuePlan(
        $currentRows,
        $currentRows,
