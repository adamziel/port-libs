...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext170Plan;
...
) use ($database170): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext170Plan {
    $database = $database170();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: $secureDelete);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext170Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
