...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext242Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext242Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
