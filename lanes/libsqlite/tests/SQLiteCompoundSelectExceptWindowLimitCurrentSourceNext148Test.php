...
use PortLibs\LibSqlite\SQLiteCompoundSelectExceptWindowLimitCurrentSourceNext148Plan;
...
$summary148 = static fn (): array => SQLiteCompoundSelectExceptWindowLimitCurrentSourceNext148Plan::compare($sql148, $currentTables148, $nextTables148);
$tests = [];
...
$tests['compound select except window limit current source next148 rejects single except'] = static function (TestRunner $t) use ($currentTables148): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundSelectExceptWindowLimitCurrentSourceNext148Plan::compare(
