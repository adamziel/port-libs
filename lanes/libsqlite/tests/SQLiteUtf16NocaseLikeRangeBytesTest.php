...
$plan = static fn (
    ...
    string $currentSource = 'main.app_settings@cookie125',
    string $nextSource = 'main.app_settings@cookie126',
...
$cases = [
    ...
    'records current source' => ['currentSource', 'main.app_settings@cookie125'],
    'records next source' => ['nextSource', 'main.app_settings@cookie126'],
