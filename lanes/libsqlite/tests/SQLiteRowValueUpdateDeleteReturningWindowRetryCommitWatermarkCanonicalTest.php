...
$planWatermark = static fn (?array $yieldAck = null, ?array $chunkAck = null, ?array $commitAck = null, int $chunkSize = 2): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeRetryCommitWatermark(
    ...
    $uniqueWatermark,
    'app_settings_rowvalue_window_retry_commit',
    'option_id',
    $yieldAck,
    $chunkSize,
    $chunkAck,
...
$casesWatermark = [
    ...
    'watermark savepoint' => [static fn (): mixed => $planWatermark()['retry_commit_watermark']['savepoint'], 'app_settings_rowvalue_window_retry_commit'],
