...
$plan245 = static fn (?array $ack = null): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeYieldGateWindow(
    ...
    $unique245,
    'app_settings_rowvalue_window_current_next245',
    'option_id',
    $ack,
);
...
$cases245 = [
    ...
    'plan savepoint' => [static fn (): mixed => $plan245()['savepoint'], 'app_settings_rowvalue_window_current_next245'],
    ...
    'receipt savepoint' => [static fn (): mixed => $plan245()['yield_window_receipt_next245']['savepoint'], 'app_settings_rowvalue_window_current_next245'],
    ...
    'dependency application' => [static fn (): mixed => in_array('application-rowvalue-returning-window-yield-gate-next245', $plan245()['dependencies_next245'], true), true],
