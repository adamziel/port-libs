...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext245Plan;
...
$plan245 = static fn (?array $ack = null): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext245Plan::execute(
    $tables245,
...
$customPlan245 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext245Plan::execute(
    $tables245,
    [$yieldUpdate245],
    [$attemptUpdate245],
    [$retryUpdate245],
...
$cases245 = [
    ...
    'malformed empty yield rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext245Plan::execute($tables245, [], [$attemptUpdate245], [$retryUpdate245], $unique245), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext245Plan::execute($tables245, [$yieldUpdate245], [], [$retryUpdate245], $unique245), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext245Plan::execute($tables245, [$yieldUpdate245], [$attemptUpdate245], [], $unique245), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext245Plan::execute($tables245, [$yieldUpdate245], [$attemptUpdate245], [$retryUpdate245], $unique245, 'bad-name'), InvalidArgumentException::class],
];
