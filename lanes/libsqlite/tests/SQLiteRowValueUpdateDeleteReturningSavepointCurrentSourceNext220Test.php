...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan;
...
$plan220 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute(
    $tables220,
...
$customPlan220 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute(
    $tables220,
    [$preUpdate220],
    $abortUpdate220,
    [$retryUpdate220],
...
$cases220 = [
    ...
    'malformed empty pre rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute($tables220, [], $abortUpdate220, [$retryUpdate220], $unique220), InvalidArgumentException::class],
    'malformed empty abort rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute($tables220, [$preUpdate220], '', [$retryUpdate220], $unique220), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute($tables220, [$preUpdate220], $abortUpdate220, [], $unique220), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute($tables220, [$preUpdate220], $abortUpdate220, [$retryUpdate220], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute($tables220, [$preUpdate220], $abortUpdate220, [$retryUpdate220], $unique220, 'bad-name'), InvalidArgumentException::class],
    'malformed non abort action rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute($tables220, [$preUpdate220], str_replace('OR ABORT', 'OR FAIL', $abortUpdate220), [$retryUpdate220], $unique220), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext220Plan::execute(['wp_options' => ['bad']], [$preUpdate220], $abortUpdate220, [$retryUpdate220], $unique220), InvalidArgumentException::class],
];
