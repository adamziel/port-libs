...
$expected217 = [
    ...
    'dependency closure' => 'no new support component needed; write-materialization reuses next212 current-source apply rows, pointer-map apply pages, leaf freeblock receipts, and fenced-tail guards',
    'non overlap' => true,
