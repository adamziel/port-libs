...
$plan121 = static fn (array $current = null, array $next = null, array $constraints = null, array $orderBy = null): array => SQLiteJsonTablePlan::currentSourceNestedPathPlannerNext121(
    'json_tree',
    $current ?? $current121,
    $next ?? $next121,
    'option_value',
...
$tests = [
    ...
    'empty json column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedPathPlannerNext121('json_tree', $current121, $next121, '', 'base_root', 'nested_path')),
    'empty base root column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedPathPlannerNext121('json_tree', $current121, $next121, 'option_value', '', 'nested_path')),
    'empty nested path column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedPathPlannerNext121('json_tree', $current121, $next121, 'option_value', 'base_root', '')),
    'bad function is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedPathPlannerNext121('json_bad', $current121, $next121, 'option_value', 'base_root', 'nested_path')),
];
