...
$plan10551070 = static function (int $sliceNumber, int $batchSize = 2) use ($database10551070): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan {
...
foreach (range(1055, 1070) as $sliceNumber) {
    $tests["btree vacuum pointermap freeblock current source next{$sliceNumber} continues next1055-1070 handoff receipts"] = static function (TestRunner $t) use ($plan10551070, $sliceNumber): void {
