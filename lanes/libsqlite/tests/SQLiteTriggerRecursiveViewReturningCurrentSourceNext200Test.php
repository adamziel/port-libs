...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext200Plan;
...
$run200 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext200Plan::execute(
    $rows200,
    $currentInput200,
    $nextInput200,
    $currentView200,
