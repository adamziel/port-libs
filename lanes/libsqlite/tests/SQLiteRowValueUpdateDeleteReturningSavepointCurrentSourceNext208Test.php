...
$plan208 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry(
    $tables208,
    [$outerUpdate208],
...
$customPlan208 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry(
    $tables208,
    [$outerUpdate208],
    [$preFailUpdate208],
    $failUpdate208,
...
$cases208 = [
    ...
    'malformed empty outer rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry($tables208, [], [$preFailDelete208], $failUpdate208, [$retryDelete208], $unique208), InvalidArgumentException::class],
    'malformed empty pre fail rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry($tables208, [$outerUpdate208], [], $failUpdate208, [$retryDelete208], $unique208), InvalidArgumentException::class],
    'malformed empty fail rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry($tables208, [$outerUpdate208], [$preFailDelete208], '', [$retryDelete208], $unique208), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry($tables208, [$outerUpdate208], [$preFailDelete208], $failUpdate208, [], $unique208), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry($tables208, [$outerUpdate208], [$preFailDelete208], $failUpdate208, [$retryDelete208], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry($tables208, [$outerUpdate208], [$preFailDelete208], $failUpdate208, [$retryDelete208], $unique208, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executePreFailRollbackRetry(['wp_options' => ['bad']], [$outerUpdate208], [$preFailDelete208], $failUpdate208, [$retryDelete208], $unique208), InvalidArgumentException::class],
];
