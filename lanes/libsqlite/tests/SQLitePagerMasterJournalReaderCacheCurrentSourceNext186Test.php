...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext186Plan;
...
$plan = static fn (
    ...
    ?string $bytes = null,
    ?int $size = null,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext186Plan::plan(
    $database,
    $master,
    $masterBytes,
    $bytes ?? $databaseBytes,
