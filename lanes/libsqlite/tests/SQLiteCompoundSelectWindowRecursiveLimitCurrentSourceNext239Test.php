...
$summary239 = static fn (?array $cursor = null): array => SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNextPlan::compareCompoundLimitResumeFence($sql239, $currentTables239, $nextTables239, $cursor);
$tests = [];
