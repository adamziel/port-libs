...
$cases141 = [
    ...
    'first generated index refs come from view current source' => [static fn (): mixed => $op141(0)['generated_index_references'], ['wp_options_generated_lookup']],
    'first generated index count' => [static fn (): mixed => $op141(0)['generated_index_reference_count'], 1],
    ...
    'second generated index refs come from view current source' => [static fn (): mixed => $op141(1)['generated_index_references'], ['wp_options_hash_lookup']],
    ...
    'third generated index refs come from star view current source' => [static fn (): mixed => $op141(2)['generated_index_references'], ['wp_options_generated_lookup']],
    ...
    'quoted view source propagates generated indexes' => [static fn (): mixed => $plan141(['CREATE TRIGGER wp_options_quoted_view AFTER INSERT ON "wp_options" BEGIN INSERT INTO wp_option_audit(option_id, option_name, label) SELECT option_id, option_name_lc, "quoted" FROM "wp_autoloaded_generated_options" WHERE option_id = new.option_id; END'])['operations'][0]['generated_index_references'], ['wp_options_generated_lookup']],
