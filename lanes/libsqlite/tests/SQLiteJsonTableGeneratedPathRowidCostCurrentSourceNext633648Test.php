...
$tests['json table generated path rowid cost current source next648 no later alias yet'] = static function (TestRunner $t) use ($plan633648): void {
    $t->throws(Error::class, static fn () => $plan633648(649));
};
