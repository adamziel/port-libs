...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext245Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext245Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
