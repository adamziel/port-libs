...
$plan246 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan {
    global $database246;

    $database = $database246();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafReceiptFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases246 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan246()->reuseSummary()['non_overlap'], 'does not repeat current-source handoff'),
...
$expected246 = [
    ...
    'dependency closure' => 'no new support component needed; next246 reuses current-source handoff rows and validates vacuum reuse cursor publication',
    'non overlap' => true,
    'current source action' => 'btree-vacuum-pointermap-freeblock-current-source-handoff',
