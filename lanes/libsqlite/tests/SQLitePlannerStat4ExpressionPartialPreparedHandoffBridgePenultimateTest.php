...
$tests = [
    ...
    'planner stat4 expression partial current source next414429 cursor appended' => static fn (TestRunner $t) => $t->same('PrepareStat4ExpressionPartialNext414429Handoff', $plan414429()['cursorProgram'][array_key_last($plan414429()['cursorProgram'])]['opcode']),
    'planner stat4 expression partial current source next414429 cursor mode' => static fn (TestRunner $t) => $t->same('next414-429-current-source-stat4-expression-partial-prep', $plan414429()['cursorProgram'][array_key_last($plan414429()['cursorProgram'])]['mode']),
