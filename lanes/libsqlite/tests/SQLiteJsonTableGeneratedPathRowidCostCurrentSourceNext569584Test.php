...
$tests['json table generated path rowid cost current source next584 no later alias yet'] = static function (TestRunner $t) use ($plan569584): void {
    $t->throws(Error::class, static fn () => $plan569584(585));
};
