...
use PortLibs\LibSqlite\SQLiteUtf16NocaseLikeRtrimCurrentSourceNext228Plan;
...
$plan228 = static fn (
    ...
    int $nextCookie = 228,
): array => SQLiteUtf16NocaseLikeRtrimCurrentSourceNext228Plan::wordpressOptionNameHeaderEncodingFencePlan(
    $current ?? $current228,
    $next ?? $next228,
    'plugin!_cache%',
    '!',
