...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext209Plan;
...
$plan209 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext209Plan::execute(
    $rows209,
    $currentInput209,
    $nextInput209,
    $currentView209,
