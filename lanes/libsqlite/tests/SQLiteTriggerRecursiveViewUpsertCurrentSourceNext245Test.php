...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewUpsertCurrentSourceNext245Plan;
...
$plan = static fn (array $options = []): array => SQLiteTriggerRecursiveViewUpsertCurrentSourceNext245Plan::execute(
    [
