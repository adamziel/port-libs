...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext191Plan;
...
$plan191 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext191Plan::execute(
    $rows191,
    $currentInput191,
    $nextInput191,
    $currentView191,
