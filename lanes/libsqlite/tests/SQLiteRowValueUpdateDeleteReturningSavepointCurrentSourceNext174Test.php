...
$plan174 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext174Plan::execute(
    $tables174,
    [$outerSql174],
...
$cases174 = [
    ...
    'malformed empty outer statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext174Plan::execute($tables174, [], [$innerDeleteSql174], [$retryUpdateSql174], $unique174), InvalidArgumentException::class],
    'malformed empty inner statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext174Plan::execute($tables174, [$outerSql174], [], [$retryUpdateSql174], $unique174), InvalidArgumentException::class],
    'malformed empty retry statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext174Plan::execute($tables174, [$outerSql174], [$innerDeleteSql174], [], $unique174), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext174Plan::execute($tables174, [$outerSql174], [$innerDeleteSql174], [$retryUpdateSql174], []), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext174Plan::execute(['wp_options' => ['bad']], [$outerSql174], [$innerDeleteSql174], [$retryUpdateSql174], $unique174), InvalidArgumentException::class],
];
