...
$plan798813 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext798813(
    $prepared798813(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next798813 cursor appended' => static fn (TestRunner $t) => $t->same('PrepareStat4ExpressionPartialNext798813Handoff', $plan798813()['cursorProgram'][array_key_last($plan798813()['cursorProgram'])]['opcode']),
    'planner stat4 expression partial current source next798813 cursor mode' => static fn (TestRunner $t) => $t->same('next798-813-current-source-stat4-expression-partial-prep', $plan798813()['cursorProgram'][array_key_last($plan798813()['cursorProgram'])]['mode']),
    ...
    'planner stat4 expression partial current source next798813 malformed needed column' => static function (TestRunner $t) use ($prepared798813, $current798813, $terms798813): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext798813($prepared798813(), $current798813(), $terms798813(), ['option_name', ''], 6));
    },
];
