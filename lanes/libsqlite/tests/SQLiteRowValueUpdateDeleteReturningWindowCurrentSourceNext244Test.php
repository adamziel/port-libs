...
$plan244 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext244Plan::execute(
    $tables244,
    [$attemptUpdate244, $attemptDelete244],
    [$retryUpdate244, $retryDelete244],
    $unique244,
);
$customPlan244 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext244Plan::execute(
    $tables244,
    [$attemptUpdate244],
    [$retryUpdate244],
    $unique244,
...
$cases244 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext244Plan::execute($tables244, [], [$retryUpdate244], $unique244), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext244Plan::execute($tables244, [$attemptUpdate244], [], $unique244), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext244Plan::execute($tables244, [$attemptUpdate244], [$retryUpdate244], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext244Plan::execute($tables244, [$attemptUpdate244], [$retryUpdate244], $unique244, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext244Plan::execute(['wp_options' => ['bad']], [$attemptUpdate244], [$retryUpdate244], $unique244), InvalidArgumentException::class],
];
