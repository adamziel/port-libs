...
$planAllocationPublication = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $databaseAllocationPublication;

    $database = $databaseAllocationPublication();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafAllocationPublicationFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
