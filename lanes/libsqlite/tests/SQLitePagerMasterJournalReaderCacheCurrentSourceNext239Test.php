...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext239Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext239Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
