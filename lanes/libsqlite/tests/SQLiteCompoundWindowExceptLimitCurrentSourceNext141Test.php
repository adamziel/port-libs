...
use PortLibs\LibSqlite\SQLiteCompoundWindowExceptLimitCurrentSourceNext141Plan;
...
$summary141 = static fn (): array => SQLiteCompoundWindowExceptLimitCurrentSourceNext141Plan::compare($sql141, $currentTables141, $nextTables141);
$tests = [];
...
$tests['compound window except limit current source next141 rejects missing except'] = static function (TestRunner $t) use ($currentTables141): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundWindowExceptLimitCurrentSourceNext141Plan::compare(
