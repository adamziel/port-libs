...
$plan225 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan {
    global $database225;

    $database = $database225();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafReadWindowFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases225 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan225()->readSummary()['non_overlap'], 'does not repeat next219'),
...
$expected225 = [
    ...
    'dependency closure' => 'no new support component needed; next225 reuses next219 current-source readback rows, token chains, pointer-map-before-payload ordering, and fenced-tail guards',
    'non overlap' => true,
