...
$cases164 = [
    ...
    'duplicate base key throws' => [static fn (): mixed => SQLiteTriggerRecursiveViewReturningCurrentSourceNextPlan::executeRecursiveViewUpsertAdmission(array_merge($rows164, [['option_name' => 'siteurl']]), $currentInput164, $nextInput164, $currentView164, $nextView164, $returning164), InvalidArgumentException::class],
];
