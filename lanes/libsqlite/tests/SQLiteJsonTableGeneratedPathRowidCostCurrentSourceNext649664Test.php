...
$tests['json table generated path rowid cost current source next664 no later alias yet'] = static function (TestRunner $t) use ($plan649664): void {
    $t->throws(Error::class, static fn () => $plan649664(665));
};
