...
$plan164 = static fn (?array $current = null, ?array $next = null, ?array $constraints = null, ?array $orderBy = null, ?int $limit = null): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext164(
    'json_tree',
    $current ?? $current164,
    $next ?? $next164,
    'option_value',
