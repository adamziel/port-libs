...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext189Plan;
...
$plan = static fn (
    ...
    ?string $bytes = null,
    ?int $size = null,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext189Plan::plan(
    $database,
    $master,
    $masterBytes,
    $bytes ?? $databaseBytes,
