...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext208Plan;
...
$plan = static fn (
    ...
    ?array $headers = null,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext208Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
