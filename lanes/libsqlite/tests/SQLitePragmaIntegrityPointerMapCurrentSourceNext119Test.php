...
use PortLibs\LibSqlite\SQLitePragmaIntegrityPointerMapCurrentSourceNext119;
...
$compareClean119 = static fn (): array => SQLitePragmaIntegrityPointerMapCurrentSourceNext119::compare($current119, $nextClean119, $currentSource119, $nextSource119);
$comparePartial119 = static fn (): array => SQLitePragmaIntegrityPointerMapCurrentSourceNext119::compare($current119, $nextPartial119, $currentSource119, $nextSource119);
$compareIntroduced119 = static fn (): array => SQLitePragmaIntegrityPointerMapCurrentSourceNext119::compare($current119, $nextIntroduced119, $currentSource119, $nextSource119);
$pageClean119 = static fn (): array => SQLitePragmaIntegrityPointerMapCurrentSourceNext119::page($current119, $nextClean119, $currentSource119, $nextSource119, 0, 119);
$pagePartial119 = static fn (): array => SQLitePragmaIntegrityPointerMapCurrentSourceNext119::page($current119, $nextPartial119, $currentSource119, $nextSource119, 3, 4);
...
$tests['pragma integrity pointermap current source next119 quick check skips pointer map diagnostics'] = static function (TestRunner $t) use ($current119, $nextClean119, $currentSource119, $nextSource119): void {
    $comparison = SQLitePragmaIntegrityPointerMapCurrentSourceNext119::compare($current119, $nextClean119, $currentSource119, $nextSource119, 'PRAGMA quick_check');
...
$tests['pragma integrity pointermap current source next119 rejects negative offset'] = static function (TestRunner $t) use ($current119, $nextClean119, $currentSource119, $nextSource119): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaIntegrityPointerMapCurrentSourceNext119::page($current119, $nextClean119, $currentSource119, $nextSource119, -1, 119));
};
...
$tests['pragma integrity pointermap current source next119 rejects zero limit'] = static function (TestRunner $t) use ($current119, $nextClean119, $currentSource119, $nextSource119): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaIntegrityPointerMapCurrentSourceNext119::page($current119, $nextClean119, $currentSource119, $nextSource119, 0, 0));
};
...
$tests['pragma integrity pointermap current source next119 rejects blank sources'] = static function (TestRunner $t) use ($current119, $nextClean119, $nextSource119): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaIntegrityPointerMapCurrentSourceNext119::compare($current119, $nextClean119, ' ', $nextSource119));
};
