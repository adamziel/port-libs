...
$plan = static fn (
    ...
    string $currentSource = 'main.wp_options@144',
    string $nextSource = 'main.wp_options@145',
...
$cases = [
    ...
    'current source' => ['currentSource', 'main.wp_options@144'],
    'next source' => ['nextSource', 'main.wp_options@145'],
