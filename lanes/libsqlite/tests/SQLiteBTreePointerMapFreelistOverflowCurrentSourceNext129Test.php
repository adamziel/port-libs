...
$plan129 = static fn (bool $secureDelete = false): SQLiteBTreePointerMapFreelistOverflowCurrentSourceNext129Plan => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNext129Plan::fromOverflowChains(
    $database129(),
    [[
...
$cases129 = [
    ...
    'bad payload count rejected' => static fn (): mixed => $throwMessage129(static fn () => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNext129Plan::fromOverflowChains($database129(), [['first_page' => 6, 'overflow_payload_bytes' => 700]], 0, 3, '')),
    'bad parent rejected' => static fn (): mixed => $throwMessage129(static fn () => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNext129Plan::fromOverflowChains($database129(), [['first_page' => 6, 'overflow_payload_bytes' => 700]], 4, 1, 'abcd')),
    'short payload rejected' => static fn (): mixed => $throwMessage129(static fn () => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNext129Plan::fromOverflowChains($database129(), [['first_page' => 6, 'overflow_payload_bytes' => 700]], 4, 3, 'abc')),
];
