...
$plan846861 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializePreparedHandoffContinuationWindow(
    $prepared846861(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next846861 malformed needed column' => static function (TestRunner $t) use ($prepared846861, $current846861, $terms846861): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializePreparedHandoffContinuationWindow($prepared846861(), $current846861(), $terms846861(), ['option_name', ''], 6));
    },
];
