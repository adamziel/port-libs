...
$planHandoff = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $databaseHandoff;

    $database = $databaseHandoff();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafCurrentSourceHandoffFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
