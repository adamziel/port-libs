...
$plan245 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan {
    global $database245;

    $database = $database245();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafCursorAdmissionFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases245 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan245()->cursorSummary()['non_overlap'], 'does not repeat current-source handoff'),
...
$expected245 = [
    ...
    'dependency closure' => 'no new support component needed; next245 reuses current-source handoff rows and verifies cursor admission ordering only',
    'non overlap' => true,
