...
$plan165 = static fn (
    ...
    ?array $orderBy = null,
): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostNext165(
    'json_tree',
    $current ?? $current165,
    $next ?? $next165,
    'option_value',
...
$tests = [
    ...
    'bad generated path column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostNext165('json_tree', $current165, $next165, 'option_value', '', [])),
    'bad json source column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostNext165('json_tree', $current165, $next165, '', 'generated_path', [])),
