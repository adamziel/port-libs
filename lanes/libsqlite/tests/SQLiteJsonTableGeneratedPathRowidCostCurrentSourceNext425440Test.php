...
$tests['json table generated path rowid cost current source next440 no later alias yet'] = static function (TestRunner $t) use ($plan425440): void {
    $t->throws(Error::class, static fn () => $plan425440(441));
};
