...
$tests['json table generated path rowid cost current source next872 rejects next873 alias'] = static function (TestRunner $t) use ($plan857872): void {
    $t->throws(Error::class, static fn () => $plan857872(873));
};
