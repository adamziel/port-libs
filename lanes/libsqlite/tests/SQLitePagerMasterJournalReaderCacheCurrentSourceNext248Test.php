...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext248Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext248Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
