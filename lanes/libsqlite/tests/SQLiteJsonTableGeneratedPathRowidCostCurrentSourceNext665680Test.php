...
$tests['json table generated path rowid cost current source next680 no later alias yet'] = static function (TestRunner $t) use ($plan665680): void {
    $t->throws(Error::class, static fn () => $plan665680(681));
};
