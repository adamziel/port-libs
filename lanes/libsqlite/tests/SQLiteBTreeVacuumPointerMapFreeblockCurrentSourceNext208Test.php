...
$plan208 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext208Plan {
    global $database208;

    $database = $database208();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext208Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
