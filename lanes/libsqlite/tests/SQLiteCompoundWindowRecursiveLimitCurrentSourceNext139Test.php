...
$tests['compound window recursive limit current source next139 status and dependencies'] = static function (TestRunner $t) use ($summary): void {
    $plan = $summary();
    $t->same('compound-window-recursive-limit-current-source-next139-ready', $plan['status']);
    $t->same([
...
$tests['compound window recursive limit current source next139 compound metadata'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound window recursive limit current source next139 current limited rows'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound window recursive limit current source next139 next limited rows'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound window recursive limit current source next139 recursive queue trace'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound window recursive limit current source next139 window metadata'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound window recursive limit current source next139 limit trace'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound window recursive limit current source next139 changed signatures and reasons'] = static function (TestRunner $t) use ($summary): void {
    $plan = $summary();
...
foreach (range(1, 54) as $case) {
    $tests['compound window recursive limit current source next139 generated recursive window boundary ' . $case] = static function (TestRunner $t) use ($case): void {
        $cteLimit = 2 + ($case % 4);
        $finalLimit = 2 + ($case % 3);
        $offset = $case % 2;
        $tables = [
