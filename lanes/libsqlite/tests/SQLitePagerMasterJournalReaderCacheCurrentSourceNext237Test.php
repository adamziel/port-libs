...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext237Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext237Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
