...
$plan = static fn (?array $base = null, ?array $input = null): array => SQLiteWalHotJournalSavepointCheckpointCurrentSourceNextPlan::next222SourceTicketPlan($base ?? $next221, $input ?? $tickets);
