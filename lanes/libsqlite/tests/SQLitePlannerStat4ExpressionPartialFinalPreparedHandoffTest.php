...
$tests = [
    ...
    'planner stat4 expression partial current source finalPreparedHandoff legacy next958973 alias preserved' => static fn (TestRunner $t) => $t->same($planfinalPreparedHandoff()['stat4TerminalPreparedHandoffFence'], $planfinalPreparedHandoff()['stat4Next958973PreparationFence']),
