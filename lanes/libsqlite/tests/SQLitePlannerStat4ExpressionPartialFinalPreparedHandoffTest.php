...
$tests = [
    ...
    'planner stat4 expression partial current source finalPreparedHandoff inherits next974989' => static fn (TestRunner $t) => $t->same(true, $planfinalPreparedHandoff()['selectedPlan']['next974989Prepared']),
    ...
    'planner stat4 expression partial current source finalPreparedHandoff prior range' => static fn (TestRunner $t) => $t->same([974, 989], $planfinalPreparedHandoff()['stat4FinalPreparedHandoffPreparationFence']['priorSliceRange']),
    ...
    'planner stat4 expression partial current source finalPreparedHandoff first continues' => static fn (TestRunner $t) => $t->same(974, $planfinalPreparedHandoff()['stat4FinalPreparedHandoffPreparationFence']['handoffWindows'][0]['continuesSlice']),
    ...
    'planner stat4 expression partial current source finalPreparedHandoff prior signature threaded' => static fn (TestRunner $t) => $t->same($planfinalPreparedHandoff()['stat4Next974989PreparationFence']['handoffSignature'], $planfinalPreparedHandoff()['selectedPlan']['finalPreparedHandoffPriorHandoffSignature']),
    'planner stat4 expression partial current source finalPreparedHandoff preserves next974989 fence' => static fn (TestRunner $t) => $t->same(range(974, 989), $planfinalPreparedHandoff()['stat4Next974989PreparationFence']['preparedSlices']),
    ...
    'planner stat4 expression partial current source finalPreparedHandoff non overlap' => static fn (TestRunner $t) => $t->contains('next974-989 handoff windows', $planfinalPreparedHandoff()['non_overlap']),
