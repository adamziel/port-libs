...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext168Plan;
...
$plan = static fn (
    ...
    ?string $source = null,
    int $epoch = 13,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext168Plan::plan(
    $path ?? $databasePath,
