...
$plan259 = static fn (?array $ackYield = null, ?string $resume = null, ?array $ackNext = null, ?array $ackFrame = null, bool $requirePrevious = true): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeCurrentRowFrameAdmission(
    $tables259,
    [$yieldUpdate259, $yieldDelete259],
    [$attemptUpdate259, $attemptDelete259],
    [$retryUpdate259, $retryDelete259],
    $unique259,
    'app_settings_rowvalue_window_current_next259',
    'option_id',
    $ackYield,
    $resume,
    $ackNext,
...
$cases259 = [
    ...
    'fence savepoint' => [static fn (): mixed => $plan259()['current_row_frame_fence_next259']['savepoint'], 'app_settings_rowvalue_window_current_next259'],
    ...
    'bad savepoint rejected by base' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeCurrentRowFrameAdmission($tables259, [$yieldUpdate259], [$attemptUpdate259], [$retryUpdate259], $unique259, 'bad-name'), InvalidArgumentException::class],
];
