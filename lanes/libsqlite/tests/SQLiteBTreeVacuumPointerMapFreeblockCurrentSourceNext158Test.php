...
$plan158 = static function (?string $payload = null) use ($database158): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    $database = $database158();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafVacuumAllocationFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
