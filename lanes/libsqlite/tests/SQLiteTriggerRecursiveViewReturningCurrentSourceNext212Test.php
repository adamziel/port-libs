...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext212Plan;
...
$plan212 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext212Plan::execute(
    $rows212,
    $currentInput212,
    $nextInput212,
    $currentView212,
