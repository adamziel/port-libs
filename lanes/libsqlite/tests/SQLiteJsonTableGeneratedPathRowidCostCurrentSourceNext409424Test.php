...
$tests['json table generated path rowid cost current source next424 no later alias yet'] = static function (TestRunner $t) use ($plan409424): void {
    $t->throws(Error::class, static fn () => $plan409424(425));
};
