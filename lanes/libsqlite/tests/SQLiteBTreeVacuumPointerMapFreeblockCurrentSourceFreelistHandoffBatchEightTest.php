...
$plan11191134 = static function (int $sliceNumber, int $batchSize = 2) use ($database11191134): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
...
foreach (range(1119, 1134) as $sliceNumber) {
    $tests["btree vacuum pointermap freeblock current source freelist handoff case {$sliceNumber} receipts"] = static function (TestRunner $t) use ($plan11191134, $sliceNumber): void {
