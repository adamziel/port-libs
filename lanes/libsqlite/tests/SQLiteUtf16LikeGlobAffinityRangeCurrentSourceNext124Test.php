...
$cases = [
    ...
    'source switch reason first' => ['autoload:%', 'UTF-16LE', 'LIKE', 'TEXT', 'BINARY', null, null, true, 'invalidationReasons.0', 'source-name', 'main.app_settings', 'temp.app_settings'],
    'source switch next source' => ['autoload:%', 'UTF-16LE', 'LIKE', 'TEXT', 'BINARY', null, null, true, 'nextSource', 'temp.app_settings', 'main.app_settings', 'temp.app_settings'],
    'reusable current rowids' => ['plugin_α:%', 'UTF-16LE', 'LIKE', 'TEXT', 'BINARY', null, null, true, 'currentRowids', [6], 'main.app_settings', 'main.app_settings', 1240, 1240],
    'reusable flag stays true' => ['plugin_α:%', 'UTF-16LE', 'LIKE', 'TEXT', 'BINARY', null, null, true, 'cursorReusable', true, 'main.app_settings', 'main.app_settings', 1240, 1240],
