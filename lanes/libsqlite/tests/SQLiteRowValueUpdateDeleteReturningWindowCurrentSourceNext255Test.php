...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext255Plan;
...
$plan255 = static fn (?array $ackYield = null, ?string $resume = null, ?array $ackNext = null): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext255Plan::execute(
    $tables255,
...
$cases255 = [
    ...
    'bad savepoint rejected by base' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext255Plan::execute($tables255, [$yieldUpdate255], [$attemptUpdate255], [$retryUpdate255], $unique255, 'bad-name'), InvalidArgumentException::class],
];
