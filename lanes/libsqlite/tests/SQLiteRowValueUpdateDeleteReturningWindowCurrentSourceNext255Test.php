...
$plan255 = static fn (?array $ackYield = null, ?string $resume = null, ?array $ackNext = null): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext255(
    $tables255,
...
$cases255 = [
    ...
    'bad savepoint rejected by base' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeNext255($tables255, [$yieldUpdate255], [$attemptUpdate255], [$retryUpdate255], $unique255, 'bad-name'), InvalidArgumentException::class],
];
