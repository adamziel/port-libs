...
use PortLibs\LibSqlite\SQLiteTriggerFkReturningUpsertSavepointCurrentNext75Plan;
...
$run = static fn (array $current = null, array $next = null, array $currentTriggers = null, array $nextTriggers = null, array $currentOptions = [], array $projection = null): array => SQLiteTriggerFkReturningUpsertSavepointCurrentNext75Plan::execute(
    'wp_import',
    $parents,
    $children,
    $current ?? $currentRows,
...
$cases = [
    ...
    'bad savepoint throws' => [static fn (): mixed => SQLiteTriggerFkReturningUpsertSavepointCurrentNext75Plan::execute('bad-name', $parents, $children, $currentRows, $nextRows, ['option_name'], $assignments, $foreignKey, $orphanTriggers, $validTriggers, $returning), InvalidArgumentException::class],
    'empty current rows throws' => [static fn (): mixed => SQLiteTriggerFkReturningUpsertSavepointCurrentNext75Plan::execute('wp_import', $parents, $children, [], $nextRows, ['option_name'], $assignments, $foreignKey, $orphanTriggers, $validTriggers, $returning), InvalidArgumentException::class],
    'empty next rows throws' => [static fn (): mixed => SQLiteTriggerFkReturningUpsertSavepointCurrentNext75Plan::execute('wp_import', $parents, $children, $currentRows, [], ['option_name'], $assignments, $foreignKey, $orphanTriggers, $validTriggers, $returning), InvalidArgumentException::class],
    'empty returning throws' => [static fn (): mixed => SQLiteTriggerFkReturningUpsertSavepointCurrentNext75Plan::execute('wp_import', $parents, $children, $currentRows, $nextRows, ['option_name'], $assignments, $foreignKey, $orphanTriggers, $validTriggers, []), InvalidArgumentException::class],
