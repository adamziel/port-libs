...
$range128 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128(
    'json_tree',
    $current128,
    $next128,
    'option_value',
...
$point128 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128(
    'json_tree',
    $current128,
    $current128,
    'option_value',
...
$pathOnly128 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128(
    'json_tree',
    $current128,
    $next128,
    'option_value',
...
$unrunnable128 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128(
    'json_tree',
    $current128,
...
$tests = [
    ...
    'bad function rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128('json_bad', $current128, $next128, 'option_value', [])),
    'bad json column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128('json_tree', $current128, $next128, '', [])),
    'bad order direction rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128('json_tree', $current128, $next128, 'option_value', [], 'scan_root', [['column' => 'path', 'direction' => 'SIDEWAYS']])),
