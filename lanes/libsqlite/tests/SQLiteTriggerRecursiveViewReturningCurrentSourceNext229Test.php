...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext229Plan;
...
$plan229 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext229Plan::execute(
    $rows229,
    $currentInput229,
    $nextInput229,
    $currentView229,
