...
$tests['json table generated path rowid cost current source next840 has no next841 alias yet'] = static function (TestRunner $t) use ($plan825840): void {
    $t->throws(Error::class, static fn () => $plan825840(841));
};
