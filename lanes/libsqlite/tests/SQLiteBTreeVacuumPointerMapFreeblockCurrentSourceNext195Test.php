...
$plan195 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext195Plan {
    global $database195;

    $database = $database195();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext195Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
