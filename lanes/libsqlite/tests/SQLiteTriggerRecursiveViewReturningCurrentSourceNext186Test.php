...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext186Plan;
...
$plan186 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext186Plan::execute(
    $rows186,
    $currentInput186,
    $nextInput186,
    $currentView186,
