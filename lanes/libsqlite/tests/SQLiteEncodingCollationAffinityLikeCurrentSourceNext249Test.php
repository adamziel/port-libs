...
$plan249 = static fn (
    ...
    int $nextCookie = 249,
): array => SQLiteEncodingCollationAffinityLikeCurrentSourceNextPlan::applicationRtrimLikeSourcePlan(
    $current ?? $current249,
...
$cases249 = [
    ...
    'current source' => ['currentSource', 'main.app_settings@248'],
    'next source' => ['nextSource', 'main.app_settings@249'],
