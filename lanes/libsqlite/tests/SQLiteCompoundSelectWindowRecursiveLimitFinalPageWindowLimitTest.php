...
$summary234 = static fn (?array $cursor = null): array => SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNextPlan::compareFinalPageWindowLimit($sql234, $currentTables234, $nextTables234, $cursor);
$tests = [];

$tests['compound select window recursive limit current source final-page-window-limit status dependencies'] = static function (TestRunner $t) use ($summary234): void {
    $plan = $summary234();
    $t->same('compound-select-window-recursive-limit-current-source-final-page-window-limit-ready', $plan['status']);
    $t->same([
        'sqlite-select-sql-recursive-multi-anchor-queue-limit-final-page-window-limit',
        'sqlite-select-sql-row-number-first-value-window-final-page-window-limit',
...
$tests['compound select window recursive limit current source final-page-window-limit compound metadata'] = static function (TestRunner $t) use ($summary234): void {
...
$tests['compound select window recursive limit current source final-page-window-limit anchor window rows'] = static function (TestRunner $t) use ($summary234): void {
...
$tests['compound select window recursive limit current source final-page-window-limit next boundary'] = static function (TestRunner $t) use ($summary234): void {
    $plan = $summary234();
...
$tests['compound select window recursive limit current source final-page-window-limit recursive queue trace'] = static function (TestRunner $t) use ($summary234): void {
...
$tests['compound select window recursive limit current source final-page-window-limit window shape'] = static function (TestRunner $t) use ($summary234): void {
...
$tests['compound select window recursive limit current source final-page-window-limit token fence'] = static function (TestRunner $t) use ($summary234): void {
    $first = $summary234();
...
$tests['compound select window recursive limit current source final-page-window-limit rejects stale cursor'] = static function (TestRunner $t) use ($summary234): void {
...
$tests['compound select window recursive limit current source final-page-window-limit limit trace'] = static function (TestRunner $t) use ($summary234): void {
...
$tests['compound select window recursive limit current source final-page-window-limit replan reasons'] = static function (TestRunner $t) use ($summary234): void {
    $plan = $summary234();
...
$tests['compound select window recursive limit current source final-page-window-limit rows match executor'] = static function (TestRunner $t) use ($sql234, $currentTables234, $summary234): void {
