...
$plan226 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $database226;

    $database = $database226();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafPublishWindowFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases226 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan226()->publishSummary()['non_overlap'], 'does not repeat readback'),
...
$expected226 = [
    ...
    'dependency closure' => 'no new support component needed; next226 reuses readback readback rows, read tokens, duplicate pointer-map rewrite receipts, and fenced-tail guards',
    'non overlap' => true,
