...
$schema = static fn (): array => [
    [
        ...
        'type' => 'table',
        'rootpage' => 2,
        'sql' => 'CREATE TABLE app_settings (setting_id integer primary key, key_name text unique, key_value text, load_policy text)',
    ],
    [
        'name' => 'key_name',
        'type' => 'index',
        'rootpage' => 3,
        'sql' => 'CREATE UNIQUE INDEX key_name ON app_settings(key_name)',
    ],
];
...
$steps = static fn (): array => [
    [
        ...
        'page_number' => 1,
        'wal_frame_index' => 3,
        'sql' => 'CREATE TABLE app_json_schema (key_name text primary key, schema_json text not null)',
    ],
    [
        'name' => 'create_json_schema_key_index',
        'type' => 'index',
        'rootpage' => 9,
        'page_number' => 3,
        'wal_frame_index' => 4,
        'sql' => 'CREATE INDEX app_json_schema_key_index ON app_json_schema(key_name)',
    ],
    [
        ...
        'page_number' => 1,
        'wal_frame_index' => 5,
        'sql' => 'CREATE TRIGGER app_json_schema_validate BEFORE INSERT ON app_settings BEGIN SELECT json_valid(NEW.key_value); END',
    ],
    [
...
$cases = [
    ...
    'initial schema names include app settings' => static fn (): mixed => $plan()['initial_schema_names'],
    ...
    'custom transaction name is reported' => static fn (): mixed => $plan(null, ['transaction' => 'app_schema_txn'])['transaction'],
    'custom savepoint name is reported' => static fn (): mixed => $plan(null, ['savepoint' => 'app_schema_sp'])['savepoint'],
    ...
    'view schema object can apply when not failed' => static fn (): mixed => in_array('json_schema_view', $plan([
        [
            ...
            'type' => 'view',
            'sql' => 'CREATE VIEW json_schema_view AS SELECT key_name FROM app_settings',
        ],
...
$expected = [
    ...
    'initial schema names include app settings' => ['app_settings', 'key_name'],
    'final schema names include applied table index trigger' => ['app_settings', 'key_name', 'create_json_schema', 'create_json_schema_key_index', 'create_json_schema_trigger'],
    ...
    'second applied schema step name' => 'create_json_schema_key_index',
    ...
    'custom transaction name is reported' => 'app_schema_txn',
    'custom savepoint name is reported' => 'app_schema_sp',
    ...
    'trigger rootpage defaults to zero' => ['app_settings', 'key_name', 'create_json_schema_trigger'],
