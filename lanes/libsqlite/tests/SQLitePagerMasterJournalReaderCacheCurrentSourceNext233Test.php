...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext233Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext233Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
