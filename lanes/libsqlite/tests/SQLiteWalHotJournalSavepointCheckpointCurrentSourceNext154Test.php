...
use PortLibs\LibSqlite\SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext154Plan;
...
): array => SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext154Plan::plan(
    $databasePath,
    $dirtyDatabase,
    $journalBytes,
    $currentWal,
...
$throws = [
    ...
    'empty path rejected by base' => static fn () => SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext154Plan::plan('', $dirtyDatabase, $journalBytes, $currentWal, $walBytes, $hotDatabase, $walBytes, $checkpointDatabase, 'sp', 3, [1], 1),
    'empty dirty database rejected by base' => static fn () => SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext154Plan::plan($databasePath, '', $journalBytes, $currentWal, $walBytes, $hotDatabase, $walBytes, $checkpointDatabase, 'sp', 3, [1], 1),
    'empty journal rejected by base' => static fn () => SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext154Plan::plan($databasePath, $dirtyDatabase, '', $currentWal, $walBytes, $hotDatabase, $walBytes, $checkpointDatabase, 'sp', 3, [1], 1),
    'empty wal rejected by base' => static fn () => SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext154Plan::plan($databasePath, $dirtyDatabase, $journalBytes, $currentWal, '', $hotDatabase, $walBytes, $checkpointDatabase, 'sp', 3, [1], 1),
    'empty reader database rejected by base' => static fn () => SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext154Plan::plan($databasePath, $dirtyDatabase, $journalBytes, $currentWal, $walBytes, '', $walBytes, $checkpointDatabase, 'sp', 3, [1], 1),
    'empty pages rejected by base' => static fn () => SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext154Plan::plan($databasePath, $dirtyDatabase, $journalBytes, $currentWal, $walBytes, $hotDatabase, $walBytes, $checkpointDatabase, 'sp', 3, [], 1),
