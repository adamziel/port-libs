...
$plan257 = static fn (?array $yieldAck = null, ?array $chunkAck = null, int $chunkSize = 2): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeDeleteRetryPublication(
    ...
    $unique257,
    'app_settings_rowvalue_window_current_next257',
    'option_id',
    $yieldAck,
    $chunkSize,
    $chunkAck,
...
$cases257 = [
    ...
    'bad chunk rejected by base' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeDeleteRetryPublication($tables257, [$yieldUpdate257], [$attemptUpdate257], [$retryUpdate257], $unique257, 'app_settings_rowvalue_window_current_next257', 'option_id', null, 0), InvalidArgumentException::class],
