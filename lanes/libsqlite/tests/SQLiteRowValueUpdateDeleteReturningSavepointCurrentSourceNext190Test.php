...
$plan190 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNegatedRollbackRetrySavepoint(
    $tables190,
...
$cases190 = [
    ...
    'malformed empty release rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNegatedRollbackRetrySavepoint($tables190, [], [$rollbackUpdate190], [$retryUpdate190], $unique190), InvalidArgumentException::class],
    'malformed empty rollback rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNegatedRollbackRetrySavepoint($tables190, [$releaseUpdate190], [], [$retryUpdate190], $unique190), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNegatedRollbackRetrySavepoint($tables190, [$releaseUpdate190], [$rollbackUpdate190], [], $unique190), InvalidArgumentException::class],
    'malformed unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNegatedRollbackRetrySavepoint($tables190, [$releaseUpdate190], [$rollbackUpdate190], [$retryUpdate190], []), InvalidArgumentException::class],
    'malformed savepoint name rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNegatedRollbackRetrySavepoint($tables190, [$releaseUpdate190], [$rollbackUpdate190], [$retryUpdate190], $unique190, 'bad-name'), InvalidArgumentException::class],
    'malformed row rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNegatedRollbackRetrySavepoint(['wp_options' => ['bad']], [$releaseUpdate190], [$rollbackUpdate190], [$retryUpdate190], $unique190), InvalidArgumentException::class],
];
