...
$plan168 = static fn (?array $current = null, ?array $next = null, ?array $constraints = null, ?array $orderBy = null, ?int $limit = null, int $batchSize = 2, int $offset = 0): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext168(
    'json_tree',
    $current ?? $current168,
    $next ?? $next168,
    'option_value',
