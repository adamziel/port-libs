...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext180Plan;
...
$plan180 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext180Plan::execute(
    $tables180,
    [$outerSql180],
...
$cases180 = [
    ...
    'malformed empty outer statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext180Plan::execute($tables180, [], [$innerYieldSql180], [$innerDiscardDeleteSql180], [$innerRetryUpdateSql180], $unique180), InvalidArgumentException::class],
    'malformed empty yielded statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext180Plan::execute($tables180, [$outerSql180], [], [$innerDiscardDeleteSql180], [$innerRetryUpdateSql180], $unique180), InvalidArgumentException::class],
    'malformed empty discarded statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext180Plan::execute($tables180, [$outerSql180], [$innerYieldSql180], [], [$innerRetryUpdateSql180], $unique180), InvalidArgumentException::class],
    'malformed empty retry statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext180Plan::execute($tables180, [$outerSql180], [$innerYieldSql180], [$innerDiscardDeleteSql180], [], $unique180), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext180Plan::execute($tables180, [$outerSql180], [$innerYieldSql180], [$innerDiscardDeleteSql180], [$innerRetryUpdateSql180], []), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext180Plan::execute(['wp_options' => ['bad']], [$outerSql180], [$innerYieldSql180], [$innerDiscardDeleteSql180], [$innerRetryUpdateSql180], $unique180), InvalidArgumentException::class],
];
