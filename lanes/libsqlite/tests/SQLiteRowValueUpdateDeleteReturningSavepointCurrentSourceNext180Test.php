...
$plan180 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext180(
    $tables180,
    [$outerSql180],
...
$cases180 = [
    ...
    'malformed empty outer statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext180($tables180, [], [$innerYieldSql180], [$innerDiscardDeleteSql180], [$innerRetryUpdateSql180], $unique180), InvalidArgumentException::class],
    'malformed empty yielded statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext180($tables180, [$outerSql180], [], [$innerDiscardDeleteSql180], [$innerRetryUpdateSql180], $unique180), InvalidArgumentException::class],
    'malformed empty discarded statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext180($tables180, [$outerSql180], [$innerYieldSql180], [], [$innerRetryUpdateSql180], $unique180), InvalidArgumentException::class],
    'malformed empty retry statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext180($tables180, [$outerSql180], [$innerYieldSql180], [$innerDiscardDeleteSql180], [], $unique180), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext180($tables180, [$outerSql180], [$innerYieldSql180], [$innerDiscardDeleteSql180], [$innerRetryUpdateSql180], []), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext180(['wp_options' => ['bad']], [$outerSql180], [$innerYieldSql180], [$innerDiscardDeleteSql180], [$innerRetryUpdateSql180], $unique180), InvalidArgumentException::class],
];
