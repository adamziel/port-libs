...
$tests['json table generated path rowid cost current source next584 no later alias yet'] = static function (TestRunner $t) use ($plan553568): void {
    $t->throws(Error::class, static fn () => $plan553568(585));
};
