...
$point134 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134(
    'json_tree',
    $current134,
    $next134,
    'option_value',
...
$stable134 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134(
    'json_tree',
    $current134,
    $current134,
    'option_value',
...
$like134 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134(
    'json_tree',
...
$mismatch134 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134(
    'json_tree',
...
$missing134 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134(
    'json_tree',
...
$unrunnable134 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134(
    'json_tree',
    $current134,
...
$tests = [
    ...
    'invalid generated path column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134('json_tree', $current134, $next134, 'option_value', '', [])),
    'missing generated path column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134('json_tree', $current134, $next134, 'option_value', 'missing_path', [])),
    'non text generated path is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134('json_tree', array_replace($current134, ['generated_path' => 134]), $next134, 'option_value', 'generated_path', [])),
    'malformed generated path is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134('json_tree', array_replace($current134, ['generated_path' => '$[']), $next134, 'option_value', 'generated_path', [])),
