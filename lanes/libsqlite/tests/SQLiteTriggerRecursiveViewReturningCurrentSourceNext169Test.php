...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext169Plan;
...
$run169 = static fn (array $options = [], ?array $nestedRoots = null): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext169Plan::execute(
    $rows169,
    [['root_name' => 'siteurl']],
