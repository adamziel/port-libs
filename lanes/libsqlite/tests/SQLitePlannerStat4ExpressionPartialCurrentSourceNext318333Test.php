...
$plan318333 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext318333(
    $prepared318333(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next318333 malformed needed column' => static function (TestRunner $t) use ($prepared318333, $current318333, $terms318333): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext318333($prepared318333(), $current318333(), $terms318333(), ['option_name', ''], 6));
    },
];
