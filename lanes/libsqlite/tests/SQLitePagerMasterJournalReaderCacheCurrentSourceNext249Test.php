...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext249Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext249Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
