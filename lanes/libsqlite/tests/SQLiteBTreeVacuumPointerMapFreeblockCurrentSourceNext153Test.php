...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext153Plan;
...
$plan153 = static fn (bool $secureDelete = true): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext153Plan => SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext153Plan::tableAndIndexFromCurrentSourceDeleteResults(
    $database153(),
    3,
    [
        [
...
$cases153 = [
    ...
    'no autovacuum rejected' => static fn (): mixed => $message153(static fn () => SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext153Plan::tableAndIndexFromCurrentSourceDeleteResults(SQLiteDatabase::fromBytes(substr_replace($database153()->toBytes(), pack('N', 0), 52, 4)), 3, [['first_page' => 5, 'overflow_payload_bytes' => 1016]], [['obsolete_overflow_page_numbers' => [5, 6]], ['obsolete_overflow_page_numbers' => [8, 9]]], 3, 'x')),
    'empty replacement rejected' => static fn (): mixed => $message153(static fn () => SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext153Plan::tableAndIndexFromCurrentSourceDeleteResults($database153(), 3, [['first_page' => 5, 'overflow_payload_bytes' => 1016]], [['obsolete_overflow_page_numbers' => [5, 6]], ['obsolete_overflow_page_numbers' => [8, 9]]], 3, '')),
];
