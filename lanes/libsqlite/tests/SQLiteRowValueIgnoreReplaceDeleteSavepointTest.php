...
$plan203 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint(
    $tables203,
    [$ignoreUpdate203],
    [$replaceUpdate203],
...
$customPlan203 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint(
    $tables203,
    [$ignoreUpdate203],
    [$replaceUpdate203],
    [$deleteAfterReplace203],
...
$cases203 = [
    ...
    'malformed empty ignore rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint($tables203, [], [$replaceUpdate203], [$deleteAfterReplace203], $unique203), InvalidArgumentException::class],
    'malformed empty replace rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint($tables203, [$ignoreUpdate203], [], [$deleteAfterReplace203], $unique203), InvalidArgumentException::class],
    'malformed empty delete rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint($tables203, [$ignoreUpdate203], [$replaceUpdate203], [], $unique203), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint($tables203, [$ignoreUpdate203], [$replaceUpdate203], [$deleteAfterReplace203], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint($tables203, [$ignoreUpdate203], [$replaceUpdate203], [$deleteAfterReplace203], $unique203, 'bad-name'), InvalidArgumentException::class],
    'malformed ignore phase rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint($tables203, [$replaceUpdate203], [$replaceUpdate203], [$deleteAfterReplace203], $unique203), InvalidArgumentException::class],
    'malformed replace phase rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint($tables203, [$ignoreUpdate203], [$ignoreUpdate203], [$deleteAfterReplace203], $unique203), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeIgnoreReplaceDeleteSavepoint(['wp_options' => ['bad']], [$ignoreUpdate203], [$replaceUpdate203], [$deleteAfterReplace203], $unique203), InvalidArgumentException::class],
];
