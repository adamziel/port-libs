...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext215Plan;
...
$plan215 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext215Plan::execute($tables215, [$attemptUpdate215, $attemptDelete215], [$retryUpdate215, $retryDelete215], $unique215);
$customPlan215 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext215Plan::execute($tables215, [$attemptUpdate215], [$retryUpdate215], $unique215, 'wp_custom_rowvalue_limit215');
...
$cases215 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext215Plan::execute($tables215, [], [$retryUpdate215], $unique215), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext215Plan::execute($tables215, [$attemptUpdate215], [], $unique215), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext215Plan::execute($tables215, [$attemptUpdate215], [$retryUpdate215], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext215Plan::execute($tables215, [$attemptUpdate215], [$retryUpdate215], $unique215, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext215Plan::execute(['wp_options' => ['bad']], [$attemptUpdate215], [$retryUpdate215], $unique215), InvalidArgumentException::class],
];
