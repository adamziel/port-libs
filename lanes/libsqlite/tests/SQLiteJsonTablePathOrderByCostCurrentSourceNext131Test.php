...
$pathPriority131 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131(
    'json_tree',
    $current131,
    $next131,
    'option_value',
...
$pathPoint131 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131(
    'json_tree',
    $current131,
    $current131,
    'option_value',
...
$pathInsert131 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131(
    'json_tree',
    $current131,
    $next131,
    'option_value',
...
$unrunnable131 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131(
    'json_tree',
    $current131,
...
$tests = [
    ...
    'invalid json column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131('json_tree', $current131, $next131, '', [])),
    'invalid root column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131('json_tree', $current131, $next131, 'option_value', [], '')),
    'missing source json is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131('json_tree', ['scan_root' => '$'], $next131, 'option_value', [])),
    'malformed root is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131('json_tree', $current131, array_replace($next131, ['scan_root' => '$[']), 'option_value', [], 'scan_root')),
    'bad function is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathOrderByCostNext131('json_bad', $current131, $next131, 'option_value', [])),
];
