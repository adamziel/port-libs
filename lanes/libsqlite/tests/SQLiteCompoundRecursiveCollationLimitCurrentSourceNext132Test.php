...
$summary = static fn (): array => SQLiteCompoundRecursiveCollationLimitCurrentSourceNextPlan::compareRecursiveCollationLimit($sql, $currentTables, $nextTables);
$tests = [];
...
$tests['compound recursive collation limit current source next132 rejects non compound recursive select'] = static function (TestRunner $t) use ($currentTables): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundRecursiveCollationLimitCurrentSourceNextPlan::compareRecursiveCollationLimit(
