...
): array => SQLiteJsonTablePlan::currentSourceHiddenGeneratedRowidNext157(
    'json_tree',
    $current ?? $current157,
    $next ?? $next157,
    'option_value',
...
$tests = [
    ...
    'records next157 dependency' => static fn (TestRunner $t) => $t->true(in_array('sqlite-json-table-hidden-generated-rowid-current-source-next157', $plan157()['dependencies'], true)),
    'preserves hidden generated cost dependency' => static fn (TestRunner $t) => $t->true(in_array('sqlite-json-table-hidden-generated-cost-current-source-next148', $plan157()['dependencies'], true)),
    'preserves hidden path generated dependency' => static fn (TestRunner $t) => $t->true(in_array('sqlite-json-table-hidden-path-generated-current-source-next143', $plan157()['dependencies'], true)),
    ...
    'stable has no next157 reasons' => static fn (TestRunner $t) => $t->same([], $stable157()['next157ReplanReasons']),
    ...
    'transition count records next157 fields' => static fn (TestRunner $t) => $t->same(12, count($plan157()['hiddenGeneratedRowidTransitions'])),
    ...
    'reasons include values change' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-generated-rowid-values-changed', $plan157()['next157ReplanReasons'], true)),
    'reasons include rowset change' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-generated-rowid-rowset-changed', $plan157()['next157ReplanReasons'], true)),
    'reasons include row estimate change' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-generated-rowid-row-estimate-changed', $plan157()['next157ReplanReasons'], true)),
    'reasons include cost change' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-generated-rowid-cost-changed', $plan157()['next157ReplanReasons'], true)),
    'reasons include fingerprint change' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-generated-rowid-fingerprint-changed', $plan157()['next157ReplanReasons'], true)),
    'reasons preserve next148 values change' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-generated-cost-values-changed', $plan157()['next157ReplanReasons'], true)),
    ...
    'jsonb next records source kind change' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-generated-cost-source-kind-changed', $jsonb157()['next157ReplanReasons'], true)),
...
foreach ($tests as $name => $case) {
    $tests['json table hidden generated rowid current source next157 ' . $name] = $case;
    unset($tests[$name]);
}
