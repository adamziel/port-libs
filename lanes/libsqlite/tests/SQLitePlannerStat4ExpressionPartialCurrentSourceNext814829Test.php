...
$plan814829 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext814829(
    $prepared814829(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next814829 malformed needed column' => static function (TestRunner $t) use ($prepared814829, $current814829, $terms814829): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext814829($prepared814829(), $current814829(), $terms814829(), ['option_name', ''], 6));
    },
];
