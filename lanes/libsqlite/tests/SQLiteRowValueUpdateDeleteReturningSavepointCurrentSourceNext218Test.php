...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan;
...
$plan218 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan::execute(
    $tables218,
...
$customPlan218 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan::execute(
    $tables218,
    [$savepointUpdate218],
    [$attemptUpdate218],
    [$retryUpdate218],
...
$cases218 = [
    ...
    'malformed empty savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan::execute($tables218, [], [$attemptUpdate218], [$retryUpdate218], $unique218), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan::execute($tables218, [$savepointUpdate218], [], [$retryUpdate218], $unique218), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan::execute($tables218, [$savepointUpdate218], [$attemptUpdate218], [], $unique218), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan::execute($tables218, [$savepointUpdate218], [$attemptUpdate218], [$retryUpdate218], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan::execute($tables218, [$savepointUpdate218], [$attemptUpdate218], [$retryUpdate218], $unique218, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext218Plan::execute(['wp_options' => ['bad']], [$savepointUpdate218], [$attemptUpdate218], [$retryUpdate218], $unique218), InvalidArgumentException::class],
];
