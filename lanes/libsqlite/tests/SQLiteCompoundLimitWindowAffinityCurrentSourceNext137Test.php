...
$summary = static fn (): array => SQLiteCompoundLimitWindowAffinityCurrentSourceNextPlan::compareLimitWindowAffinity($sql, $currentTables, $nextTables);
$tests = [];
...
$tests['compound limit window affinity current source next137 rejects non compound select'] = static function (TestRunner $t) use ($currentTables): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundLimitWindowAffinityCurrentSourceNextPlan::compareLimitWindowAffinity(
