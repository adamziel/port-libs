...
$formatPage = static function (string $label) use ($pageSize): string {
    ...
    $page = substr_replace($page, pack('N', 606), 60, 4);
...
$base = [
    ...
    'master_source_digest' => hash('sha256', 'master-next606'),
    'recovery_sequence' => 606,
...
foreach ($tokenFields as $field) {
    $base[$field] = str_replace('_', '-', preg_replace('/_token$/', '', $field)) . '-current-606';
}
