...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext179Plan;
...
$plan = static fn (
    ...
    int $epoch = 179,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext179Plan::plan(
    $db ?? $database,
    $mj ?? $master,
