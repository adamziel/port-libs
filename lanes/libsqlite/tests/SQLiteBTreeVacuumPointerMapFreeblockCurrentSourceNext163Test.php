...
$plan163 = static function (
    ...
    ?string $payload = null,
) use ($database163): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan {
    $database = $database163();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafPointerMapAuditFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
