...
$plan163 = static function (
    ...
    ?string $payload = null,
) use ($database163): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    $database = $database163();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafPointerMapAuditFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
