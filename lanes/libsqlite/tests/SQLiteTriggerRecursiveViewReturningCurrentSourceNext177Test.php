...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext177Plan;
...
$run177 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext177Plan::execute(
    $rows177,
    $currentInput177,
    $nextInput177,
    $currentView177,
