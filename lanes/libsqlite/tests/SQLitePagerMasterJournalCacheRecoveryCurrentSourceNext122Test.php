...
$plan = static fn (?string $cached = null, ?string $current = null, ?SQLiteSavepointStack $stack = null): array => SQLitePagerMasterJournalCacheRecoveryCurrentSourceNext122Plan::currentSourceNext(
    $masterPath,
...
$throws = [
    'empty master path rejected' => static fn () => SQLitePagerMasterJournalCacheRecoveryCurrentSourceNext122Plan::currentSourceNext('', $cachedMaster, $currentMaster, $databases, $pageSize, $mainPath, 'active-plugins', $makeStack(), $retryWrites),
    'missing database path rejected' => static fn () => SQLitePagerMasterJournalCacheRecoveryCurrentSourceNext122Plan::currentSourceNext($masterPath, $cachedMaster, $currentMaster, [['current_database_bytes' => 'x', 'current_journal_bytes' => 'y']], $pageSize, $mainPath, 'active-plugins', $makeStack(), $retryWrites),
    'empty savepoint rejected' => static fn () => SQLitePagerMasterJournalCacheRecoveryCurrentSourceNext122Plan::currentSourceNext($masterPath, $cachedMaster, $currentMaster, $databases, $pageSize, $mainPath, '', $makeStack(), $retryWrites),
    'empty retry writes rejected' => static fn () => SQLitePagerMasterJournalCacheRecoveryCurrentSourceNext122Plan::currentSourceNext($masterPath, $cachedMaster, $currentMaster, $databases, $pageSize, $mainPath, 'active-plugins', $makeStack(), []),
    'bad page size rejected' => static fn () => SQLitePagerMasterJournalCacheRecoveryCurrentSourceNext122Plan::currentSourceNext($masterPath, $cachedMaster, $currentMaster, $databases, 500, $mainPath, 'active-plugins', $makeStack(), $retryWrites),
    'read only rejected' => static fn () => SQLitePagerMasterJournalCacheRecoveryCurrentSourceNext122Plan::currentSourceNext($masterPath, $cachedMaster, $currentMaster, $databases, $pageSize, $mainPath, 'active-plugins', $makeStack(), $retryWrites, true),
];
