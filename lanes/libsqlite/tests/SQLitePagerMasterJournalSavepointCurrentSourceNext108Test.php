...
use PortLibs\LibSqlite\SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan;
...
$plan = static fn (?string $master = null, ?SQLiteSavepointStack $stack = null, array $input = null, array $writes = null): array => SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext(
    $masterPath,
...
$reserved = static function () use ($databases, $masterBytes, $masterPath, $pageSize, $mainPath, $makeStack, $retryWrites): array {
    ...
    return SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext(
        $masterPath,
        $masterBytes,
        $copy,
        $pageSize,
...
$throws = [
    'empty savepoint rejected' => static fn () => SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext($masterPath, $masterBytes, $databases, $pageSize, $mainPath, '', $makeStack(), $retryWrites),
    'unknown savepoint rejected' => static fn () => SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext($masterPath, $masterBytes, $databases, $pageSize, $mainPath, 'missing', $makeStack(), $retryWrites),
    'empty retry writes rejected' => static fn () => SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext($masterPath, $masterBytes, $databases, $pageSize, $mainPath, 'plugin-settings', $makeStack(), []),
    'short retry page rejected' => static fn () => SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext($masterPath, $masterBytes, $databases, $pageSize, $mainPath, 'plugin-settings', $makeStack(), [2 => 'short']),
    'bad page size rejected' => static fn () => SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext($masterPath, $masterBytes, $databases, 500, $mainPath, 'plugin-settings', $makeStack(), $retryWrites),
    'missing primary rejected' => static fn () => SQLitePagerMasterJournalSavepointCurrentSourceNext108Plan::currentSourceNext($masterPath, $masterBytes, $databases, $pageSize, '/missing.sqlite', 'plugin-settings', $makeStack(), $retryWrites),
];
