...
$plan248 = static fn (?array $ack = null, ?string $resume = null): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePublicationResumeBarrier(
    ...
    $unique248,
    'app_settings_rowvalue_window_current_next248',
    'option_id',
    $ack,
    $resume,
);
...
$cases248 = [
    ...
    'barrier savepoint' => [static fn (): mixed => $plan248()['publication_barrier_next248']['savepoint'], 'app_settings_rowvalue_window_current_next248'],
