...
$cases = [
    ...
    'quoted schema scoped target accepted' => [static fn (): mixed => $execute('PRAGMA "main".quick_check(wp_options)', $validDatabase)['rows'][0]['quick_check'], 'ok'],
    ...
    'quoted schema numeric argument remains global limit' => [static fn (): mixed => $execute('PRAGMA "main".quick_check(2)', $freelistHeaderMismatch)['limit'], 2],
