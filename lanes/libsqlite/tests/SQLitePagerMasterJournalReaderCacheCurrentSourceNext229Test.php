...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext229Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext229Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
