...
use PortLibs\LibSqlite\SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan;
...
): array => SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan::currentSourceNext(
    $db ?? $databaseBytes,
    $pageSize,
    $savepoint,
    $makeStack(),
...
$throws = [
    'rejects empty database' => static fn () => SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan::currentSourceNext('', $pageSize, 'plugin-settings', $makeStack(), $cachePages, 8, 3),
    'rejects unaligned database' => static fn () => SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan::currentSourceNext($databaseBytes . 'x', $pageSize, 'plugin-settings', $makeStack(), $cachePages, 8, 3),
    'rejects bad page size' => static fn () => SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan::currentSourceNext($databaseBytes, 0, 'plugin-settings', $makeStack(), $cachePages, 8, 3),
    'rejects empty savepoint' => static fn () => SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan::currentSourceNext($databaseBytes, $pageSize, '', $makeStack(), $cachePages, 8, 3),
    'rejects empty cache pages' => static fn () => SQLitePagerCacheSpillSavepointRecoveryCurrentSourceNext120Plan::currentSourceNext($databaseBytes, $pageSize, 'plugin-settings', $makeStack(), [], 8, 3),
