...
$plan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeFailConflictRollbackSavepoint($tables, [$failSql, $deleteSql], $unique);
$releasePlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeFailConflictRollbackSavepoint($tables, [$releaseSql, $deleteSql], $unique, 'wp_options_no_fail_next162');
...
$cases = [
    ...
    'malformed empty statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeFailConflictRollbackSavepoint($tables, [], $unique), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeFailConflictRollbackSavepoint($tables, [$failSql], []), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeFailConflictRollbackSavepoint(['wp_options' => ['bad']], [$failSql], $unique), InvalidArgumentException::class],
];
