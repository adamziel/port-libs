...
$plan11031118 = static function (int $sliceNumber, int $batchSize = 2) use ($database11031118): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
...
foreach (range(1103, 1118) as $sliceNumber) {
    $tests["btree vacuum pointermap freeblock current source freelist handoff case {$sliceNumber} receipts"] = static function (TestRunner $t) use ($plan11031118, $sliceNumber): void {
