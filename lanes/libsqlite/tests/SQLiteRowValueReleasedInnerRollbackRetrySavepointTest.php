...
$plan206 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerRollbackRetry(
    $tables206,
    [$outerUpdate206],
...
$customPlan206 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerRollbackRetry(
    $tables206,
    [$outerUpdate206],
    [$innerUpdate206],
    [$retryUpdate206],
...
$cases206 = [
    ...
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerRollbackRetry($tables206, [$outerUpdate206], [$innerUpdate206], [], $unique206), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerRollbackRetry($tables206, [$outerUpdate206], [$innerUpdate206], [$retryUpdate206], []), InvalidArgumentException::class],
    'malformed outer savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerRollbackRetry($tables206, [$outerUpdate206], [$innerUpdate206], [$retryUpdate206], $unique206, 'bad-name'), InvalidArgumentException::class],
    'malformed inner savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerRollbackRetry($tables206, [$outerUpdate206], [$innerUpdate206], [$retryUpdate206], $unique206, 'outer_ok', 'bad-name'), InvalidArgumentException::class],
    'malformed same savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerRollbackRetry($tables206, [$outerUpdate206], [$innerUpdate206], [$retryUpdate206], $unique206, 'same206', 'same206'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerRollbackRetry(['wp_options' => ['bad']], [$outerUpdate206], [$innerUpdate206], [$retryUpdate206], $unique206), InvalidArgumentException::class],
];
