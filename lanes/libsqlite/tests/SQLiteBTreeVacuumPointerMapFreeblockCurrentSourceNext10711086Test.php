...
foreach (range(1071, 1086) as $sliceNumber) {
    $tests["btree vacuum pointermap freeblock current source next{$sliceNumber} continues next1071-1086 handoff receipts"] = static function (TestRunner $t) use ($plan10711086, $sliceNumber): void {
