...
): array => SQLitePagerHotJournalWalSavepointCurrentSourceNext124Plan::plan(
...
$throws = [
    'empty savepoint rejected' => static fn () => SQLitePagerHotJournalWalSavepointCurrentSourceNext124Plan::plan($journal, $dirtyDatabase, $journalBytes, $makeStack(), '', $wal, $walBytes, $databasePath, [1], $pageSize),
    'empty path rejected' => static fn () => SQLitePagerHotJournalWalSavepointCurrentSourceNext124Plan::plan($journal, $dirtyDatabase, $journalBytes, $makeStack(), 'plugin-settings-next124', $wal, $walBytes, '', [1], $pageSize),
    'empty pages rejected' => static fn () => SQLitePagerHotJournalWalSavepointCurrentSourceNext124Plan::plan($journal, $dirtyDatabase, $journalBytes, $makeStack(), 'plugin-settings-next124', $wal, $walBytes, $databasePath, [], $pageSize),
    ...
    'stale wal bytes rejected' => static fn () => SQLitePagerHotJournalWalSavepointCurrentSourceNext124Plan::plan($journal, $dirtyDatabase, $journalBytes, $makeStack(), 'plugin-settings-next124', $wal, substr($walBytes, 0, -1) . 'x', $databasePath, [1], $pageSize),
];
