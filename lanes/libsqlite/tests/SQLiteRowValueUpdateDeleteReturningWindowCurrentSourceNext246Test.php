...
$plan246 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeFilteredReleaseWindow(
    $tables246,
...
$customPlan246 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeFilteredReleaseWindow(
    $tables246,
    [$yieldUpdate246],
    [$attemptUpdate246],
    [$retryUpdate246],
...
$cases246 = [
    ...
    'malformed empty yield rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeFilteredReleaseWindow($tables246, [], [$attemptUpdate246], [$retryUpdate246], $unique246), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeFilteredReleaseWindow($tables246, [$yieldUpdate246], [], [$retryUpdate246], $unique246), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeFilteredReleaseWindow($tables246, [$yieldUpdate246], [$attemptUpdate246], [], $unique246), InvalidArgumentException::class],
    'malformed rowid rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeFilteredReleaseWindow($tables246, [$yieldUpdate246], [$attemptUpdate246], [$retryUpdate246], $unique246, 'sp246', 'missing_rowid'), InvalidArgumentException::class],
];
