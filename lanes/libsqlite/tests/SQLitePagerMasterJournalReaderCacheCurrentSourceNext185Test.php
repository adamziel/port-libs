...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext185Plan;
...
$plan = static fn (
    ...
    ?string $source = null,
    int $epoch = 185,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext185Plan::plan(
    $path ?? $database,
    $masterPath ?? $master,
