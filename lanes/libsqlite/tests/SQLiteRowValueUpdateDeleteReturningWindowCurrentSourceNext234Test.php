...
$plan234 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute(
    $tables234,
    [$attemptUpdate234, $attemptDelete234],
    [$retryUpdate234, $retryDelete234],
    $unique234,
);
$customPlan234 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute(
    $tables234,
    [$attemptUpdate234],
    [$retryUpdate234],
    $unique234,
...
$cases234 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute($tables234, [], [$retryUpdate234], $unique234), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute($tables234, [$attemptUpdate234], [], $unique234), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute($tables234, [$attemptUpdate234], [$retryUpdate234], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute($tables234, [$attemptUpdate234], [$retryUpdate234], $unique234, 'blog_id', 'option_id', 'option_id', 'bad-name'), InvalidArgumentException::class],
    'malformed partition rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute($tables234, [$attemptUpdate234], [$retryUpdate234], $unique234, 'bad column'), InvalidArgumentException::class],
    'malformed missing partition column rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute($tables234, [$attemptUpdate234], [$retryUpdate234], $unique234, 'missing_column'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext234Plan::execute(['wp_options' => ['bad']], [$attemptUpdate234], [$retryUpdate234], $unique234), InvalidArgumentException::class],
];
