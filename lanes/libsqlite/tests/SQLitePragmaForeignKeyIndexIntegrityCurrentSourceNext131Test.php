...
use PortLibs\LibSqlite\SQLitePragmaForeignKeyIndexIntegrityCurrentSourceNext131;
...
$page = static fn (int $offset = 0, int $limit = 131, ?array $cursor = null, ?array $recordsValue = null, ?array $foreignKeysValue = null, ?array $tablesValue = null, string $sql = 'PRAGMA foreign_key_check'): array => SQLitePragmaForeignKeyIndexIntegrityCurrentSourceNext131::page(
...
$tests['pragma foreignkey index integrity current source next131 rejects empty source'] = static function (TestRunner $t) use ($records, $foreignKeys, $tables, $nextSource): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaForeignKeyIndexIntegrityCurrentSourceNext131::page($records, $foreignKeys, $tables, '', $nextSource));
};
