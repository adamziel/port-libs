...
): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidResumePlan(
    'json_tree',
    $current ?? $current234,
    $next ?? $next234,
    'option_value',
...
$currentProfile234 = static fn (): array => $plan234()['currentGeneratedPathRowidXNextResume'];
$nextProfile234 = static fn (): array => $plan234()['nextGeneratedPathRowidXNextResume'];

$tests = [
    'records next234 dependency' => static fn (TestRunner $t) => $t->true(in_array('sqlite-json-table-generated-path-rowid-xnext-resume', $plan234()['dependencies'], true)),
    ...
    'current reader policy resumes xnext' => static fn (TestRunner $t) => $t->same('xnext-resume-current-json-table-generated-path-rowid', $plan234()['currentReaderPolicy']),
    'changed next reader restarts xnext' => static fn (TestRunner $t) => $t->same('restart-xnext-resume-json-table-generated-path-rowid', $plan234()['nextReaderPolicy']),
    'stable reader reuses xnext' => static fn (TestRunner $t) => $t->same('reuse-xnext-resume-current-json-table-generated-path-rowid', $stable234()['nextReaderPolicy']),
    'stable next234 reasons empty' => static fn (TestRunner $t) => $t->same([], $stable234()['generatedPathRowidXNextResumeReplanReasons']),
    ...
    'current opcode resumes' => static fn (TestRunner $t) => $t->same('OP_JsonTableGeneratedPathRowidXNextResume', $currentProfile234()['xNextResumeOpcode']),
    ...
    'current point cost class after advance' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-xnext-point', $currentProfile234()['costClass']),
    ...
    'next opcode reparses' => static fn (TestRunner $t) => $t->same('OP_JsonTableGeneratedPathRowidXNextReprepare', $nextProfile234()['xNextResumeOpcode']),
    'next cost sentinel' => static fn (TestRunner $t) => $t->same(1000000, $nextProfile234()['estimatedCost']),
    'next cost class reprepare' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-xnext-reprepare', $nextProfile234()['costClass']),
    'transition count' => static fn (TestRunner $t) => $t->same(23, count($plan234()['generatedPathRowidXNextResumeTransitions'])),
    'reasons include source changed' => static fn (TestRunner $t) => $t->true(in_array('json-table-generated-path-rowid-xnext-source-changed', $plan234()['generatedPathRowidXNextResumeReplanReasons'], true)),
    'reasons include rowset changed' => static fn (TestRunner $t) => $t->true(in_array('json-table-generated-path-rowid-xnext-rowset-changed', $plan234()['generatedPathRowidXNextResumeReplanReasons'], true)),
    'reasons include admission changed' => static fn (TestRunner $t) => $t->true(in_array('json-table-generated-path-rowid-xnext-admission-changed', $plan234()['generatedPathRowidXNextResumeReplanReasons'], true)),
    'reasons include cost changed' => static fn (TestRunner $t) => $t->true(in_array('json-table-generated-path-rowid-xnext-cost-changed', $plan234()['generatedPathRowidXNextResumeReplanReasons'], true)),
    'preserves next224 source reason' => static fn (TestRunner $t) => $t->true(in_array('json-table-generated-path-rowid-yield-guard-source-changed-next224', $plan234()['generatedPathRowidXNextResumeReplanReasons'], true)),
    'point xnext eof opcode' => static fn (TestRunner $t) => $t->same('OP_JsonTableGeneratedPathRowidXNextEof', $point234()['currentGeneratedPathRowidXNextResume']['xNextResumeOpcode']),
    'point xnext eof rowid null' => static fn (TestRunner $t) => $t->same(null, $point234()['currentGeneratedPathRowidXNextResume']['nextRowid']),
    'point xnext eof class' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-xnext-eof', $point234()['currentGeneratedPathRowidXNextResume']['costClass']),
    'eof keeps delivered pending row' => static fn (TestRunner $t) => $t->same([7], $eof234()['currentGeneratedPathRowidXNextResume']['pendingRowids']),
    'stale fingerprint mismatch' => static fn (TestRunner $t) => $t->same(false, $staleFingerprint234()['currentGeneratedPathRowidXNextResume']['yieldGuardFingerprintMatches']),
    'stale fingerprint opcode' => static fn (TestRunner $t) => $t->same('OP_JsonTableGeneratedPathRowidXNextRestartFingerprint', $staleFingerprint234()['currentGeneratedPathRowidXNextResume']['xNextResumeOpcode']),
    'stale fingerprint cost class' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-xnext-stale-fingerprint', $staleFingerprint234()['currentGeneratedPathRowidXNextResume']['costClass']),
    'stale delivered mismatch' => static fn (TestRunner $t) => $t->same(false, $staleDelivered234()['currentGeneratedPathRowidXNextResume']['deliveredRowidsMatch']),
    'stale delivered opcode' => static fn (TestRunner $t) => $t->same('OP_JsonTableGeneratedPathRowidXNextRestartDeliveredRowids', $staleDelivered234()['currentGeneratedPathRowidXNextResume']['xNextResumeOpcode']),
    'stale delivered cost class' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-xnext-stale-delivered-rowids', $staleDelivered234()['currentGeneratedPathRowidXNextResume']['costClass']),
    'stale xcurrent forces reprepare' => static fn (TestRunner $t) => $t->same('OP_JsonTableGeneratedPathRowidXNextReprepare', $xcurrentStale234()['currentGeneratedPathRowidXNextResume']['xNextResumeOpcode']),
