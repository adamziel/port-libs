...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext224Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext224Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
