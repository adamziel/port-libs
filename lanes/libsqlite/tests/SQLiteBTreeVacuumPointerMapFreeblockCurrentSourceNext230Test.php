...
$expected230 = [
    ...
    'dependency closure' => 'no new support component needed; next230 reuses publication seals, duplicate pointer-map rewrite receipts, leaf freeblock receipts, and fenced-tail guards',
    'non overlap' => true,
