...
$plan782797 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializeNext782797(
    $prepared782797(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next782797 malformed needed column' => static function (TestRunner $t) use ($prepared782797, $current782797, $terms782797): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializeNext782797($prepared782797(), $current782797(), $terms782797(), ['option_name', ''], 6));
    },
];
