...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewUpsertCurrentSourceNext241Plan;
...
$plan241 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewUpsertCurrentSourceNext241Plan::execute(
    $rows241,
    $currentInput241,
    $nextInput241,
    $currentView241,
