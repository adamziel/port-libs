...
$plan141 = static fn (
    ...
    ?array $current = null,
    ?array $next = null,
    string $currentSource = 'main.app_settings@140',
    string $nextSource = 'main.app_settings@141',
    string $currentEncoding = 'UTF-16LE',
    string $nextEncoding = 'UTF-16BE',
): array => SQLiteUtf16NocaseLikeCurrentSourceNextPlan::keyValueRowKeyResidualPlan(
    $current ?? $current141,
    $next ?? $residualRows,
    $pattern,
    $escape,
...
$cases141 = [
    ...
    'current source recorded' => ['currentSource', 'main.app_settings@140'],
    'next source recorded' => ['nextSource', 'main.app_settings@141'],
