...
): array => SQLitePagerCacheSpillWalSavepointCurrentSourceNext143Plan::currentSourceNext(
    $path,
    $bytes ?? $databaseBytes,
    $size ?? $pageSize,
    $savepoint,
...
$throws = [
    ...
    'rejects bad threshold' => static fn () => SQLitePagerCacheSpillWalSavepointCurrentSourceNext143Plan::currentSourceNext($databasePath, $databaseBytes, $pageSize, 'plugin-batch', $makeStack(), $walFrames, $cachePages, 7, 0),
    'rejects bad max spill' => static fn () => SQLitePagerCacheSpillWalSavepointCurrentSourceNext143Plan::currentSourceNext($databasePath, $databaseBytes, $pageSize, 'plugin-batch', $makeStack(), $walFrames, $cachePages, 7, 3, true, true, 0),
];
