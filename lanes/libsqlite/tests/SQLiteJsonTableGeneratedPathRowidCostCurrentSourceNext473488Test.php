...
$tests['json table generated path rowid cost current source next488 no later alias yet'] = static function (TestRunner $t) use ($plan473488): void {
    $t->throws(Error::class, static fn () => $plan473488(489));
};
