...
use PortLibs\LibSqlite\SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext159;
...
): array => SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext159::currentNextPageFromCatalog(
    $currentRecords162,
    $currentTables162,
...
$foreignKeys162 = static fn (?array $records = null): array => SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext159::foreignKeysFromCatalog($records ?? $currentRecords162);
