...
$tests['json table generated path rowid cost current source next600 no later alias yet'] = static function (TestRunner $t) use ($plan585600): void {
    $t->throws(Error::class, static fn () => $plan585600(601));
};
