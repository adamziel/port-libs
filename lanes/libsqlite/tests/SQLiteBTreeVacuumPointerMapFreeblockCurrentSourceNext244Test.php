...
$plan244 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext244Plan {
    global $database244;

    $database = $database244();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext244Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases244 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan244()->publishSummary()['non_overlap'], 'does not repeat next241'),
...
$expected244 = [
    ...
    'dependency closure' => 'no new support component needed; next244 reuses next241 current-source cursor rows and adds publish-order validation only',
    'non overlap' => true,
    'source action' => 'btree-vacuum-pointermap-freeblock-current-source-next241',
    'source row count' => 7,
