...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext159Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext159Plan::plan(
    $path ?? $databasePath,
