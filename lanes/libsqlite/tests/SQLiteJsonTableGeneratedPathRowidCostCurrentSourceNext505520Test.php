...
$tests['json table generated path rowid cost current source next520 no later alias yet'] = static function (TestRunner $t) use ($plan505520): void {
    $t->throws(Error::class, static fn () => $plan505520(521));
};
