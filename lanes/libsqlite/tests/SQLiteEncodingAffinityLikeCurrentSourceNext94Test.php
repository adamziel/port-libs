...
$cases = [
    ...
    'current source retained' => ['plugin%', 'LIKE', 'NOCASE', null, false, 'currentSource', 'main.app_settings'],
    'next source retained' => ['plugin%', 'LIKE', 'NOCASE', null, false, 'nextSource', 'main.app_settings'],
    ...
    'stable theme is reusable' => ['theme%', 'LIKE', 'NOCASE', null, false, 'cursorReusable', true, 'UTF-16LE', 'UTF-16LE', 'main.app_settings', 'main.app_settings', 41, 41],
    'stable theme no invalidation' => ['theme%', 'LIKE', 'NOCASE', null, false, 'invalidationReasons', [], 'UTF-16LE', 'UTF-16LE', 'main.app_settings', 'main.app_settings', 41, 41],
    'source switch reason first' => ['theme%', 'LIKE', 'NOCASE', null, false, 'invalidationReasons.0', 'source-name', 'UTF-16LE', 'UTF-16LE', 'main.app_settings', 'temp.app_settings', 41, 41],
