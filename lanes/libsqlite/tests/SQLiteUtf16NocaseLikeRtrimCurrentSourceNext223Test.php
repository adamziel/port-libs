...
use PortLibs\LibSqlite\SQLiteUtf16NocaseLikeRtrimCurrentSourceNext223Plan;
...
$plan223 = static fn (
    ...
    ?array $cursor = null,
): array => SQLiteUtf16NocaseLikeRtrimCurrentSourceNext223Plan::wordpressOptionNameDescYieldPagePlan(
    $current ?? $current223,
    $next ?? $next223,
    'plugin!_cache%',
