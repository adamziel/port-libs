...
$cases = [
    ...
    'dependency marker names next51 behavior' => static fn (): mixed => in_array('sqlite-wordpress-json-schema-wal-savepoint-current-next51', $plan()['dependencies'], true),
...
$expected = [
    ...
    'dependency marker names next51 behavior' => true,
