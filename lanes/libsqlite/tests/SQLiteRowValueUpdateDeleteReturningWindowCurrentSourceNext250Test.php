...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext250Plan;
...
$plan250 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext250Plan::execute(
    $tables250,
    [$attemptUpdate250, $attemptDelete250],
    [$retryUpdate250, $retryDelete250],
    $unique250,
);
$customPlan250 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext250Plan::execute(
    $tables250,
    [$attemptUpdate250],
    [$retryUpdate250],
    $unique250,
...
$cases250 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext250Plan::execute($tables250, [], [$retryUpdate250], $unique250), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext250Plan::execute($tables250, [$attemptUpdate250], [], $unique250), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext250Plan::execute($tables250, [$attemptUpdate250], [$retryUpdate250], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext250Plan::execute($tables250, [$attemptUpdate250], [$retryUpdate250], $unique250, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext250Plan::execute(['wp_options' => ['bad']], [$attemptUpdate250], [$retryUpdate250], $unique250), InvalidArgumentException::class],
];
