...
$cases = [
    ...
    'table before current next fragment bytes' => static fn (): mixed => $tableFixture()['before']->freeblockCurrentNextFragmentReport($tableFixture()['page'])['current_next_fragment_bytes'],
    ...
    'table after fragment report has no current next gap' => static fn (): mixed => $tableFixture()['after']->freeblockCurrentNextFragmentReport($tableFixture()['mutated'])['current_next_fragment_bytes'],
    ...
    'index before current next fragment bytes' => static fn (): mixed => $indexFixture()['before']->freeblockCurrentNextFragmentReport($indexFixture()['page'])['current_next_fragment_bytes'],
    ...
    'index after fragment report has no current next gap' => static fn (): mixed => $indexFixture()['after']->freeblockCurrentNextFragmentReport($indexFixture()['mutated'])['current_next_fragment_bytes'],
