...
$plan189 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext189Plan {
    global $database189;

    $database = $database189();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext189Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
