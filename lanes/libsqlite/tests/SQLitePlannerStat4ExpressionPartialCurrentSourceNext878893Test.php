...
$plan878893 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializePreparedHandoffValidationWindow(
    $prepared878893(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next878893 malformed needed column' => static function (TestRunner $t) use ($prepared878893, $current878893, $terms878893): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializePreparedHandoffValidationWindow($prepared878893(), $current878893(), $terms878893(), ['option_name', ''], 6));
    },
];
