...
$plan199 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrderExpressionSavepointRetry(
    $tables199,
    [$attemptUpdate199, $attemptDelete199],
    [$retryUpdate199, $retryDelete199],
);
$customPlan199 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrderExpressionSavepointRetry(
    $tables199,
    [$attemptUpdate199],
    [$retryUpdate199],
...
$cases199 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrderExpressionSavepointRetry($tables199, [], [$retryUpdate199]), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrderExpressionSavepointRetry($tables199, [$attemptUpdate199], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrderExpressionSavepointRetry($tables199, [$attemptUpdate199], [$retryUpdate199], 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrderExpressionSavepointRetry(['wp_options' => ['bad']], [$attemptUpdate199], [$retryUpdate199]), InvalidArgumentException::class],
];
