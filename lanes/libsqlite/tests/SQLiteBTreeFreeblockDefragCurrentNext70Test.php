...
$cases = [
    ...
    'table page image has no current next fragments' => static fn (): mixed => $tableAfterHeader()->freeblockCurrentNextFragmentReport($tableFixture()->pageImage)['current_next_fragment_bytes'],
    ...
    'index page image has no current next fragments' => static fn (): mixed => $indexAfterHeader()->freeblockCurrentNextFragmentReport($indexFixture()->pageImage)['current_next_fragment_bytes'],
