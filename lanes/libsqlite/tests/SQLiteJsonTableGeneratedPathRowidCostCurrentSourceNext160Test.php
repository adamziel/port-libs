...
): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostSourceNext160(
    'json_tree',
    $current ?? $current160,
    $next ?? $next160,
    'option_value',
...
$tests = [
    ...
    'bad json source column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostSourceNext160('json_tree', $current160, $next160, '', 'generated_path', $constraints160)),
    'bad generated path source column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostSourceNext160('json_tree', $current160, $next160, 'option_value', '', $constraints160)),
    'missing generated path source column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostSourceNext160('json_tree', $current160, $next160, 'option_value', 'missing_path', $constraints160)),
