...
$plan157 = static fn (array $options = [], ?array $currentRoots = null, ?array $nextRoots = null, ?array $currentView = null, ?array $nextView = null, ?array $returning = null): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext157Plan::execute(
    $rows157,
...
$cases157 = [
    ...
    'duplicate option throws' => [static fn (): mixed => SQLiteTriggerRecursiveViewReturningCurrentSourceNext157Plan::execute(array_merge($rows157, [['option_name' => 'siteurl']]), [], [], $currentView157, $nextView157, $returning157), InvalidArgumentException::class],
];
