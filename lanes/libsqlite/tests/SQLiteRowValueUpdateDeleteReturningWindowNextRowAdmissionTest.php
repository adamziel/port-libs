...
$plan255 = static fn (?array $ackYield = null, ?string $resume = null, ?array $ackNext = null): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeWindowRowAdmission(
    ...
    $unique255,
    'app_settings_rowvalue_window_current_next255',
    'option_id',
    $ackYield,
    $resume,
    $ackNext,
...
$cases255 = [
    ...
    'fence savepoint' => [static fn (): mixed => $plan255()['next_row_admission_fence_next255']['savepoint'], 'app_settings_rowvalue_window_current_next255'],
