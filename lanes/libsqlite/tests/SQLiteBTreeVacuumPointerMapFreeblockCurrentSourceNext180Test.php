...
$plan180 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext180Plan {
    global $database180;

    $database = $database180();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext180Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
