...
) use ($database171): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext171Plan {
    $database = $database171();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext171Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
