...
$tests = [
    ...
    'planner stat4 expression partial current source stat4SampleAnchor first sample blog' => static fn (TestRunner $t) => $t->same(1, $plan245()['stat4SampleAnchorFence']['sampleAnchorProofs'][0]['currentBlogId']),
    ...
    'planner stat4 expression partial current source stat4SampleAnchor stale blog proof current' => static fn (TestRunner $t) => $t->same(1, $staleBlog245()['stat4SampleAnchorFence']['sampleAnchorProofs'][0]['currentBlogId']),
