...
$point126 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126(
    'json_tree',
    $current126,
    $next126,
    'option_value',
...
$range126 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126(
    'json_tree',
    $current126,
    $next126,
    'option_value',
...
$rowidOnly126 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126(
    'json_tree',
    $current126,
    $next126,
    'option_value',
...
$pathOnly126 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126(
    'json_tree',
    $current126,
    $next126,
    'option_value',
...
$stable126 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126(
    'json_tree',
    $current126,
    $current126,
    'option_value',
...
$unrunnable126 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126(
    'json_tree',
    $current126,
...
$tests = [
    ...
    'bad json column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126('json_tree', $current126, $next126, '', [])),
    'bad root column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126('json_tree', $current126, $next126, 'option_value', [], '')),
    'bad function rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathHiddenRowidCostNext126('json_bad', $current126, $next126, 'option_value', [])),
