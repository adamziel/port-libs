...
$cases252 = [
    ...
    'wordpress payload preserved row three' => [static fn (): mixed => $matched252()[0]['payload']['option_name'], [], 'thumbnail_size_w'],
    'wordpress payload preserved row five' => [static fn (): mixed => $matched252()[3]['payload']['option_name'], [], 'large_size_w'],
