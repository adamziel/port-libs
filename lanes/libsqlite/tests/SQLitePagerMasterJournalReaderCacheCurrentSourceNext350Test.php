...
$pageSize = 512;
$database = '/srv/wp-content/database/wp-next350.sqlite';
$usersDatabase = '/srv/wp-content/database/wp-next350-users.sqlite';
...
$formatPage = static function (string $label) use ($pageSize): string {
    ...
    $page = substr_replace($page, pack('N', 350), 60, 4);
...
$before = [1 => $formatPage('next350 stale schema'), 2 => $page('next350 stale options'), 3 => $page('next350 stale plugins'), 4 => $page('next350 stale users')];
$recovered = [1 => $formatPage('next350 current schema'), 2 => $page('next350 current options'), 3 => $page('next350 current plugins'), 4 => $page('next350 current users')];
$tokens = [$mainJournal => 'member-main-current-350', $usersJournal => 'member-users-current-350'];
$headers = [$mainJournal => hash('sha256', 'main header next350'), $usersJournal => hash('sha256', 'users header next350')];
$base = [
    'source_id' => 'pager-reader-cache-current-source-next350',
    'epoch' => 350,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 350, 0])),
    'publication_generation' => 350,
    'master_source_digest' => hash('sha256', 'master-next350'),
    'recovery_sequence' => 350,
    'recovered_page_set_digest' => $recoveredDigest($recovered),
    'member_journal_tokens' => $tokens,
    'member_journal_header_digests' => $headers,
    'master_member_order_digest' => hash('sha256', implode("\n", array_keys($tokens))),
    'master_journal_file_token' => 'master-file-current-350',
    'master_journal_bytes_digest' => hash('sha256', $masterBytes),
    'database_file_token' => 'database-file-current-350',
    'master_journal_cleanup_token' => 'master-cleanup-current-350',
    'reader_lease_token' => 'reader-lease-current-350',
    'pager_cache_source_token' => 'pager-cache-source-current-350',
    'read_transaction_token' => 'read-transaction-current-350',
    'schema_reparse_token' => 'schema-reparse-current-350',
    'statement_schema_root_token' => 'statement-schema-root-current-350',
    'current_source_provenance_token' => 'source-provenance-current-350',
    'pager_reader_cache_generation_token' => 'cache-generation-current-350',
    'reader_snapshot_token' => 'reader-snapshot-current-350',
    'master_journal_recovery_receipt_token' => 'recovery-receipt-current-350',
    'pager_spill_drain_token' => 'spill-drain-current-350',
    'rollback_journal_reader_source_token' => 'rollback-source-current-350',
    'pager_hot_journal_header_token' => 'hot-header-current-350',
    'master_journal_member_epoch_token' => 'member-epoch-current-350',
    'reader_cache_schema_cookie_token' => 'schema-cookie-current-350',
    'reader_cache_vacuum_root_token' => 'vacuum-root-current-350',
    'pager_reserved_lock_token' => 'reserved-lock-current-350',
    'reader_cache_page_count_token' => 'page-count-current-350',
    'reader_cache_schema_version_token' => 'schema-version-current-350',
    'reader_cache_change_counter_token' => 'change-counter-current-350',
    'reader_cache_freelist_trunk_token' => 'freelist-trunk-current-350',
    'reader_cache_auto_vacuum_token' => 'auto-vacuum-current-350',
    'reader_cache_encoding_token' => 'encoding-current-350',
    'reader_cache_text_schema_token' => 'text-schema-current-350',
    'reader_cache_index_schema_token' => 'index-schema-current-350',
    'reader_cache_trigger_schema_token' => 'trigger-schema-current-350',
    'reader_cache_view_schema_token' => 'view-schema-current-350',
    'reader_cache_virtual_table_schema_token' => 'virtual-table-schema-current-350',
    'reader_cache_module_schema_token' => 'module-schema-current-350',
    'reader_cache_pragma_schema_token' => 'pragma-schema-current-350',
    'reader_cache_collation_schema_token' => 'collation-schema-current-350',
    'reader_cache_authorizer_schema_token' => 'authorizer-schema-current-350',
    'reader_cache_transaction_state_token' => 'transaction-state-current-350',
    'reader_cache_commit_phase_token' => 'commit-phase-current-350',
    'reader_cache_busy_handler_token' => 'busy-handler-current-350',
    'reader_cache_savepoint_stack_token' => 'savepoint-stack-current-350',
    'reader_cache_statement_journal_token' => 'statement-journal-current-350',
    'reader_cache_temp_page_token' => 'temp-page-current-350',
    'reader_cache_dirty_list_token' => 'dirty-list-current-350',
    'reader_cache_spill_epoch_token' => 'spill-epoch-current-350',
    'reader_cache_locking_mode_token' => 'locking-mode-current-350',
    'reader_cache_journal_mode_token' => 'journal-mode-current-350',
    'reader_cache_synchronous_token' => 'synchronous-current-350',
    'reader_cache_mmap_size_token' => 'mmap-size-current-350',
    'reader_cache_cache_size_token' => 'cache-size-current-350',
    'reader_cache_wal_autocheckpoint_token' => 'wal-autocheckpoint-current-350',
    'reader_cache_query_only_token' => 'query-only-current-350',
    'reader_cache_foreign_key_token' => 'foreign-key-current-350',
    'reader_cache_defer_foreign_key_token' => 'defer-foreign-key-current-350',
    'reader_cache_recursive_trigger_token' => 'recursive-trigger-current-350',
    'reader_cache_trusted_schema_token' => 'trusted-schema-current-350',
    'reader_cache_ignore_check_constraints_token' => 'ignore-check-constraints-current-350',
    'reader_cache_application_id_token' => 'application-id-current-350',
    'reader_cache_user_version_token' => 'user-version-current-350',
    'reader_cache_data_version_token' => 'data-version-current-350',
    'reader_cache_schema_lock_token' => 'schema-lock-current-350',
    'reader_cache_schema_format_token' => 'schema-format-current-350',
    'reader_cache_auto_vacuum_incremental_token' => 'auto-vacuum-incremental-current-350',
    'reader_cache_reverse_unordered_selects_token' => 'reverse-unordered-selects-current-350',
    'reader_cache_automatic_index_token' => 'automatic-index-current-350',
    'reader_cache_case_sensitive_like_token' => 'case-sensitive-like-current-350',
    'reader_cache_count_changes_token' => 'count-changes-current-350',
    'reader_cache_checkpoint_fullfsync_token' => 'checkpoint-fullfsync-current-350',
    'reader_cache_fullfsync_token' => 'fullfsync-current-350',
    'reader_cache_legacy_file_format_token' => 'legacy-file-format-current-350',
    'reader_cache_read_uncommitted_token' => 'read-uncommitted-current-350',
    'reader_cache_reverse_scan_order_token' => 'reverse-scan-order-current-350',
    'reader_cache_defensive_token' => 'defensive-current-350',
    'reader_cache_writable_schema_token' => 'writable-schema-current-350',
    'reader_cache_journal_size_limit_token' => 'journal-size-limit-current-350',
    'reader_cache_secure_delete_token' => 'secure-delete-current-350',
    'reader_cache_temp_store_token' => 'temp-store-current-350',
    'reader_cache_cache_spill_token' => 'cache-spill-current-350',
    'reader_cache_cell_size_check_token' => 'cell-size-check-current-350',
    'reader_cache_threads_token' => 'threads-current-350',
    'reader_cache_optimize_token' => 'optimize-current-350',
    'reader_cache_analysis_limit_token' => 'analysis-limit-current-350',
    'reader_cache_hard_heap_limit_token' => 'hard-heap-limit-current-350',
    'reader_cache_soft_heap_limit_token' => 'soft-heap-limit-current-350',
    'reader_cache_page_size_token' => 'page-size-current-350',
    'reader_cache_max_page_count_token' => 'max-page-count-current-350',
    'reader_cache_locking_proxy_file_token' => 'locking-proxy-file-current-350',
    'reader_cache_page_cache_overflow_token' => 'page-cache-overflow-current-350',
    'reader_cache_scratch_allocator_token' => 'scratch-allocator-current-350',
    'reader_cache_lookaside_token' => 'lookaside-current-350',
    'reader_cache_pcache_dirty_limit_token' => 'pcache-dirty-limit-current-350',
    'reader_cache_mmap_read_limit_token' => 'mmap-read-limit-current-350',
    'reader_cache_sorter_reference_token' => 'sorter-reference-current-350',
    'reader_cache_worker_thread_token' => 'worker-thread-current-350',
    'reader_cache_memory_alarm_token' => 'memory-alarm-current-350',
];
...
$plan = static function (?array $cache = null, ?array $reads = null) use ($database, $master, $masterBytes, $before, $pageSize, $recovered, $base, $tokens, $headers, $cacheEntry, $read): array {
    return SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceReaderCacheMemoryAlarmFence($database, $master, $masterBytes, implode('', $before), $pageSize, $recovered, $cache ?? [
...
$cases = [
    'status' => [static fn (): mixed => $plan()['status'], 'pager-master-journal-reader-cache-current-source-next350'],
    ...
    'next291 transaction-state fence is current' => [static fn (): mixed => $plan()['current_reader_cache_transaction_state_token'], 'transaction-state-current-350'],
    'next292 commit-phase fence is current' => [static fn (): mixed => $plan()['current_reader_cache_commit_phase_token'], 'commit-phase-current-350'],
    'next293 busy-handler fence is current' => [static fn (): mixed => $plan()['current_reader_cache_busy_handler_token'], 'busy-handler-current-350'],
    ...
    'dependencies include next350' => [static fn (): mixed => in_array('sqlite-pager-master-journal-reader-cache-current-source-next350', $plan()['dependencies'], true), true],
    ...
    'default plan points at next350' => [static fn (): mixed => $plan()['status'], 'pager-master-journal-reader-cache-current-source-next350'],
];

foreach ($cases as $name => [$callback, $expected]) {
    $tests['pager master journal reader cache current source next350 ' . $name] = static function (TestRunner $t) use ($callback, $expected): void {
        $t->same($expected, $callback());
    };
}

$tests['pager master journal reader cache current source next350 missing token rejects'] = static function (TestRunner $t) use ($plan, $cacheEntry, $recovered): void {
    $t->throws(Throwable::class, static fn () => $plan([1 => array_diff_key($cacheEntry('missing', $recovered[1]), ['reader_cache_memory_alarm_token' => true])]));
};
