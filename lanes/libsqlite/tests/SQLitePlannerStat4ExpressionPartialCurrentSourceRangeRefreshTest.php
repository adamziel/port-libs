...
): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializeCurrentSourceRangeRefresh(
...
$tests['planner stat4 expression partial current source next172 validates schema cookie'] = static function (TestRunner $t) use ($prepared172, $current172): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializeCurrentSourceRangeRefresh($prepared172(['schemaCookie' => -1]), $current172(), $GLOBALS['predicate_next172']));
};
$tests['planner stat4 expression partial current source next172 validates stat4 sample'] = static function (TestRunner $t) use ($prepared172, $current172): void {
    ...
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan::materializeCurrentSourceRangeRefresh($prepared172(), $bad, $GLOBALS['predicate_next172']));
};
