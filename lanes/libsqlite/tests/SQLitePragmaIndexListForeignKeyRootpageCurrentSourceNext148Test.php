...
use PortLibs\LibSqlite\SQLitePragmaIndexListForeignKeyRootpageCurrentSourceNext148;
...
): array => SQLitePragmaIndexListForeignKeyRootpageCurrentSourceNext148::currentNextPage(
...
$tests['pragma index list foreignkey rootpage current source next148 table valued index and fk SQL'] = static function (TestRunner $t) use ($catalog148, $currentDatabase148, $nextDatabase148, $schemas148): void {
    $result = SQLitePragmaIndexListForeignKeyRootpageCurrentSourceNext148::currentNextPage(
        $catalog148(),
        $currentDatabase148,
        $schemas148(),
        $catalog148(),
...
$tests['pragma index list foreignkey rootpage current source next148 rejects negative offset'] = static function (TestRunner $t) use ($catalog148, $currentDatabase148, $nextDatabase148, $schemas148): void {
    $t->throws(InvalidArgumentException::class, static fn (): array => SQLitePragmaIndexListForeignKeyRootpageCurrentSourceNext148::currentNextPage(
        $catalog148(),
        $currentDatabase148,
        $schemas148(),
        $catalog148(),
