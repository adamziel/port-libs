...
$tests = [
    ...
    'zero limit reprepare opcode' => static fn (TestRunner $t) => $t->same('OP_JsonTableGeneratedPathRowidFinalCostReprepareNext208', $zeroLimit208()['currentGeneratedPathRowidFinalCost208']['finalCostOpcode']),
    'zero limit reprepare class' => static fn (TestRunner $t) => $t->same('json-table-generated-path-rowid-final-cost-reprepare-next208', $zeroLimit208()['currentGeneratedPathRowidFinalCost208']['costClass']),
