...
$cases = [
    ...
    'retry action' => [static fn (): mixed => $plan()['retry_action'], 'retry_wordpress_import_readers_on_generation_262'],
    ...
    'dependency wordpress' => [static fn (): mixed => in_array('wordpress-import-retry-reader-cache-current-source', $plan()['dependencies'], true), true],
