...
$plan160 = static function (
    ...
    ?string $payload = null,
) use ($database160): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext160Plan {
    $database = $database160();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext160Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
