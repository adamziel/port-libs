...
$cases237 = [
    ...
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeExcludeCurrentRetryWindow($tables237, [$attemptUpdate237], [$retryUpdate237], $unique237, 'blog_id', 'bytes', 'option_id', 'bad-name'), InvalidArgumentException::class],
    ...
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeExcludeCurrentRetryWindow(['wp_options' => ['bad']], [$attemptUpdate237], [$retryUpdate237], $unique237), InvalidArgumentException::class],
];
