...
$cases238 = [
    ...
    'plan replay row nine current value' => [static fn (): mixed => $plan238()['window_pair_rows_next238'][7]['current_key_value_next238'], 'plugin:attempt238'],
    'plan replay row nine next value' => [static fn (): mixed => $plan238()['window_pair_rows_next238'][7]['next_key_value_next238'], 'plugin:retry238'],
    'plan restart row ten next value' => [static fn (): mixed => $plan238()['window_pair_rows_next238'][8]['next_key_value_next238'], 'network:retry238'],
    'plan discarded row seven current value' => [static fn (): mixed => $plan238()['window_pair_rows_next238'][5]['current_key_value_next238'], 'theme:attempt238'],
