...
$plan186 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext186Plan {
    global $database186;

    $database = $database186();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext186Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
