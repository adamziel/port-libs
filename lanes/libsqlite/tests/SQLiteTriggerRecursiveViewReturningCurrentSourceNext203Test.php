...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext203Plan;
...
$plan203 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext203Plan::execute(
    $rows203,
    $currentInput203,
    $nextInput203,
    $currentView203,
