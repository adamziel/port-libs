...
) use ($database178): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    $database = $database178();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafPublicationReceiptFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
