...
use PortLibs\LibSqlite\SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan;
...
$fixture99 = static function () use ($databaseFixture99): array {
    ...
    $table = SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan::tableLeaf($database, 3, [
        ['rowid' => 41, 'obsolete_overflow_page_numbers' => [6, 7]],
        ['rowid' => 42, 'obsolete_overflow_page_numbers' => [8, 9]],
    ], true);
    $index = SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan::indexLeaf($database, 4, [
...
$cases99 = [
    ...
    'rejects empty table deletes' => static fn (array $fx): mixed => $throwsMessage99(static fn () => SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan::tableLeaf($fx[0], 3, [])),
    'rejects bad table rowid' => static fn (array $fx): mixed => $throwsMessage99(static fn () => SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan::tableLeaf($fx[0], 3, [['rowid' => '41', 'obsolete_overflow_page_numbers' => []]])),
    'rejects missing overflow list' => static fn (array $fx): mixed => $throwsMessage99(static fn () => SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan::tableLeaf($fx[0], 3, [['rowid' => 41]])),
    'rejects bad overflow page' => static fn (array $fx): mixed => $throwsMessage99(static fn () => SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan::tableLeaf($fx[0], 3, [['rowid' => 41, 'obsolete_overflow_page_numbers' => ['6']]])),
    'rejects empty index deletes' => static fn (array $fx): mixed => $throwsMessage99(static fn () => SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan::indexLeaf($fx[0], 4, [])),
    'rejects missing index record' => static fn (array $fx): mixed => $throwsMessage99(static fn () => SQLiteBTreeOverflowRebalanceFreepageCurrentSourceNext99Plan::indexLeaf($fx[0], 4, [['obsolete_overflow_page_numbers' => []]])),
];
