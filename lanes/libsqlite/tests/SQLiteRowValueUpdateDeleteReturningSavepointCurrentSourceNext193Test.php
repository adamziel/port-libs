...
$plan193 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext193Plan::execute(
    $tables193,
    [$outerSql193],
    [$failSql193],
...
$customPlan193 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext193Plan::execute(
    $tables193,
    [$outerSql193],
    [$failSql193],
    [$retryUpdateSql193],
...
$cases193 = [
    ...
    'malformed empty outer rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext193Plan::execute($tables193, [], [$failSql193], [$retryUpdateSql193], $unique193), InvalidArgumentException::class],
    'malformed empty fail rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext193Plan::execute($tables193, [$outerSql193], [], [$retryUpdateSql193], $unique193), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext193Plan::execute($tables193, [$outerSql193], [$failSql193], [], $unique193), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext193Plan::execute($tables193, [$outerSql193], [$failSql193], [$retryUpdateSql193], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext193Plan::execute($tables193, [$outerSql193], [$failSql193], [$retryUpdateSql193], $unique193, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext193Plan::execute(['wp_options' => ['bad']], [$outerSql193], [$failSql193], [$retryUpdateSql193], $unique193), InvalidArgumentException::class],
];
