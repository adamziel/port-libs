...
$summary = static fn (): array => SQLiteCompoundRecursiveOrderLimitCurrentSourceNext146Plan::compare($sql, $currentTables, $nextTables);
$tests = [];
...
$tests['compound recursive order limit current source next146 rejects non recursive compound'] = static function (TestRunner $t) use ($currentTables): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundRecursiveOrderLimitCurrentSourceNext146Plan::compare(
