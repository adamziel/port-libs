...
use PortLibs\LibSqlite\SQLiteTriggerReturningSavepointCurrentNext65Plan;
...
$commit = static fn (): array => SQLiteTriggerReturningSavepointCurrentNext65Plan::updateRows(
    'wp_import_current',
    $rows,
    $assignments,
...
$rollback = static fn (): array => SQLiteTriggerReturningSavepointCurrentNext65Plan::updateRows(
    'wp_import_current',
    $rows,
    $assignments,
    static fn (array $row): bool => str_contains((string) $row['option_name'], 'plugin') || $row['autoload'] === 'yes',
...
$star = static fn (): array => SQLiteTriggerReturningSavepointCurrentNext65Plan::updateRows(
    'wp_import_current',
    $rows,
    ['option_value' => 'star'],
...
$cases = [
    ...
    'bad savepoint throws' => [static fn (): mixed => SQLiteTriggerReturningSavepointCurrentNext65Plan::updateRows('bad-name', $rows, $assignments, static fn (): bool => true), InvalidArgumentException::class],
    'missing assignments throws' => [static fn (): mixed => SQLiteTriggerReturningSavepointCurrentNext65Plan::updateRows('ok_name', $rows, [], static fn (): bool => true), InvalidArgumentException::class],
    'bad trigger raise throws' => [static fn (): mixed => SQLiteTriggerReturningSavepointCurrentNext65Plan::updateRows('ok_name', $rows, $assignments, static fn (): bool => true, [['timing' => 'before', 'event' => 'update', 'action' => 'raise', 'raise' => 'abort']]), InvalidArgumentException::class],
    'bad returning alias throws' => [static fn (): mixed => SQLiteTriggerReturningSavepointCurrentNext65Plan::updateRows('ok_name', $rows, $assignments, static fn (): bool => true, [], [['expr' => 'new.option_name', 'as' => 'bad-alias']]), InvalidArgumentException::class],
];
