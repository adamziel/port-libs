...
$plan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeInPredicateRetrySavepointBatch(
    $tables,
    [$failSql, $cleanSql],
    [$retryUpdateSql, $retryDeleteSql],
    $unique,
);
$cleanPlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeInPredicateRetrySavepointBatch(
    $tables,
    [$cleanSql],
    [$retryDeleteSql],
    $unique,
...
$cases = [
    ...
    'malformed empty attempts rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeInPredicateRetrySavepointBatch($tables, [], [$retryUpdateSql], $unique), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeInPredicateRetrySavepointBatch($tables, [$cleanSql], [], $unique), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeInPredicateRetrySavepointBatch($tables, [$cleanSql], [$retryDeleteSql], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeInPredicateRetrySavepointBatch($tables, [$cleanSql], [$retryDeleteSql], $unique, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeInPredicateRetrySavepointBatch(['wp_options' => ['bad']], [$cleanSql], [$retryDeleteSql], $unique), InvalidArgumentException::class],
];
