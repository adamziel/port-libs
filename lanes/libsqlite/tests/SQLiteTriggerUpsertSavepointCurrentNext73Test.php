...
$plan = static fn (array $selected = null, array $options = []): array => SQLiteTriggerUpsertSavepointCurrentNext73Plan::execute(
    $rows,
    $selected ?? $incoming,
    ['option_name'],
    $assignments,
...
$cases = [
    ...
    'empty savepoint rejected' => [static fn (): mixed => SQLiteTriggerUpsertSavepointCurrentNext73Plan::execute($rows, [], ['option_name'], $assignments, $triggers, ['savepoint' => ' ']), InvalidArgumentException::class],
    'empty conflict target rejected' => [static fn (): mixed => SQLiteTriggerUpsertSavepointCurrentNext73Plan::execute($rows, [], [], $assignments, $triggers), InvalidArgumentException::class],
    'bad conflict target rejected' => [static fn (): mixed => SQLiteTriggerUpsertSavepointCurrentNext73Plan::execute($rows, [], ['bad-name'], $assignments, $triggers), InvalidArgumentException::class],
    'bad conflict action rejected' => [static fn (): mixed => $plan([], ['conflict_action' => 'replace']), InvalidArgumentException::class],
    'bad trigger action rejected' => [static fn (): mixed => SQLiteTriggerUpsertSavepointCurrentNext73Plan::execute($rows, [$incoming[1]], ['option_name'], $assignments, [[
        'name' => 'bad',
        'timing' => 'after',
        'event' => 'insert',
        'action' => 'delete-row',
    ]]), InvalidArgumentException::class],
    'bad trigger when operator rejected' => [static fn (): mixed => SQLiteTriggerUpsertSavepointCurrentNext73Plan::execute($rows, [$incoming[1]], ['option_name'], $assignments, [[
        'name' => 'bad_when',
        'timing' => 'after',
        'event' => 'insert',
        'action' => 'audit',
    ...
    'old reference on insert rejected' => [static fn (): mixed => SQLiteTriggerUpsertSavepointCurrentNext73Plan::execute($rows, [$incoming[1]], ['option_name'], $assignments, [[
        'name' => 'bad_old',
        'timing' => 'after',
        'event' => 'insert',
        'action' => 'audit',
