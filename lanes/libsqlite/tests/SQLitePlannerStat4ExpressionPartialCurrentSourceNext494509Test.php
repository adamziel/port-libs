...
$plan494509 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext494509(
    $prepared494509(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next494509 malformed needed column' => static function (TestRunner $t) use ($prepared494509, $current494509, $terms494509): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext494509($prepared494509(), $current494509(), $terms494509(), ['option_name', ''], 6));
    },
];
