...
$tests['json table generated path rowid cost current source next936 rejects next937 alias'] = static function (TestRunner $t) use ($plan921936): void {
    $t->throws(Error::class, static fn () => $plan921936(937));
};
