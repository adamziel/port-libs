...
$plan235 = static fn (
    ...
    int $nextCookie = 235,
): array => SQLiteEncodingCollationAffinityLikeCurrentSourceNextPlan::keyValueRowValueNotLikePlan(
    $current ?? $current235,
...
$cases235 = [
    ...
    'current source' => ['currentSource', 'main.app_settings@234'],
    'next source' => ['nextSource', 'main.app_settings@235'],
