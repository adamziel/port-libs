...
$plan169 = static function (array $observedCurrentPages = []) use ($database169): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext169Plan {
    $database = $database169();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext169Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$stalePlan169 = static function () use ($database169, $plan169): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext169Plan {
    $database = $database169();
