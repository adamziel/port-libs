...
$plan174 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext174Plan {
    global $database174;

    $database = $database174();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext174Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
