...
use PortLibs\LibSqlite\SQLitePagerCacheSpillSavepointMasterCurrentSourceNext141Plan;
...
): array => SQLitePagerCacheSpillSavepointMasterCurrentSourceNext141Plan::plan(
    $databasePath,
    $masterPath,
...
$throws = [
    ...
    'bad page size rejected' => static fn () => SQLitePagerCacheSpillSavepointMasterCurrentSourceNext141Plan::plan($databasePath, $masterPath, null, $databasePath . "-journal\n", implode('', $before), 500, 'plugin-batch', $makeStack(), $recovered, $cache, [1], 'next141-current-source', 8, 8, 3),
    'missing savepoint rejected' => static fn () => SQLitePagerCacheSpillSavepointMasterCurrentSourceNext141Plan::plan($databasePath, $masterPath, null, $databasePath . "-journal\n", implode('', $before), $pageSize, 'missing', $makeStack(), $recovered, $cache, [1], 'next141-current-source', 8, 8, 3),
