...
use PortLibs\LibSqlite\SQLitePagerHotJournalSavepointStatementCurrentSourceNext97Plan;
...
$plan = static fn (
    ...
    string $bytes = null,
    int $size = null,
): array => SQLitePagerHotJournalSavepointStatementCurrentSourceNext97Plan::plan(
    $path ?? $databasePath,
    $bytes ?? $databaseBytes,
    $size ?? $pageSize,
    'plugin-batch-next97',
