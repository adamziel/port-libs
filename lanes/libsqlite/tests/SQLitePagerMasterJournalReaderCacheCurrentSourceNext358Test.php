...
$pageSize = 512;
$database = '/srv/wp-content/database/wp-next358.sqlite';
$usersDatabase = '/srv/wp-content/database/wp-next358-users.sqlite';
...
$formatPage = static function (string $label) use ($pageSize): string {
    ...
    $page = substr_replace($page, pack('N', 358), 60, 4);
...
$before = [1 => $formatPage('next358 stale schema'), 2 => $page('next358 stale options'), 3 => $page('next358 stale plugins'), 4 => $page('next358 stale users')];
$recovered = [1 => $formatPage('next358 current schema'), 2 => $page('next358 current options'), 3 => $page('next358 current plugins'), 4 => $page('next358 current users')];
$tokens = [$mainJournal => 'member-main-current-358', $usersJournal => 'member-users-current-358'];
$headers = [$mainJournal => hash('sha256', 'main header next358'), $usersJournal => hash('sha256', 'users header next358')];
$base = [
    'source_id' => 'pager-reader-cache-current-source-next358',
    'epoch' => 358,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 358, 0])),
    'publication_generation' => 358,
    'master_source_digest' => hash('sha256', 'master-next358'),
    'recovery_sequence' => 358,
    'recovered_page_set_digest' => $recoveredDigest($recovered),
    'member_journal_tokens' => $tokens,
    'member_journal_header_digests' => $headers,
    'master_member_order_digest' => hash('sha256', implode("\n", array_keys($tokens))),
    'master_journal_file_token' => 'master-file-current-358',
    'master_journal_bytes_digest' => hash('sha256', $masterBytes),
    'database_file_token' => 'database-file-current-358',
    'master_journal_cleanup_token' => 'master-cleanup-current-358',
    'reader_lease_token' => 'reader-lease-current-358',
    'pager_cache_source_token' => 'pager-cache-source-current-358',
    'read_transaction_token' => 'read-transaction-current-358',
    'schema_reparse_token' => 'schema-reparse-current-358',
    'statement_schema_root_token' => 'statement-schema-root-current-358',
    'current_source_provenance_token' => 'source-provenance-current-358',
    'pager_reader_cache_generation_token' => 'cache-generation-current-358',
    'reader_snapshot_token' => 'reader-snapshot-current-358',
    'master_journal_recovery_receipt_token' => 'recovery-receipt-current-358',
    'pager_spill_drain_token' => 'spill-drain-current-358',
    'rollback_journal_reader_source_token' => 'rollback-source-current-358',
    'pager_hot_journal_header_token' => 'hot-header-current-358',
    'master_journal_member_epoch_token' => 'member-epoch-current-358',
    'reader_cache_schema_cookie_token' => 'schema-cookie-current-358',
    'reader_cache_vacuum_root_token' => 'vacuum-root-current-358',
    'pager_reserved_lock_token' => 'reserved-lock-current-358',
    'reader_cache_page_count_token' => 'page-count-current-358',
    'reader_cache_schema_version_token' => 'schema-version-current-358',
    'reader_cache_change_counter_token' => 'change-counter-current-358',
    'reader_cache_freelist_trunk_token' => 'freelist-trunk-current-358',
    'reader_cache_auto_vacuum_token' => 'auto-vacuum-current-358',
    'reader_cache_encoding_token' => 'encoding-current-358',
    'reader_cache_text_schema_token' => 'text-schema-current-358',
    'reader_cache_index_schema_token' => 'index-schema-current-358',
    'reader_cache_trigger_schema_token' => 'trigger-schema-current-358',
    'reader_cache_view_schema_token' => 'view-schema-current-358',
    'reader_cache_virtual_table_schema_token' => 'virtual-table-schema-current-358',
    'reader_cache_module_schema_token' => 'module-schema-current-358',
    'reader_cache_pragma_schema_token' => 'pragma-schema-current-358',
    'reader_cache_collation_schema_token' => 'collation-schema-current-358',
    'reader_cache_authorizer_schema_token' => 'authorizer-schema-current-358',
    'reader_cache_transaction_state_token' => 'transaction-state-current-358',
    'reader_cache_commit_phase_token' => 'commit-phase-current-358',
    'reader_cache_busy_handler_token' => 'busy-handler-current-358',
    'reader_cache_savepoint_stack_token' => 'savepoint-stack-current-358',
    'reader_cache_statement_journal_token' => 'statement-journal-current-358',
    'reader_cache_temp_page_token' => 'temp-page-current-358',
    'reader_cache_dirty_list_token' => 'dirty-list-current-358',
    'reader_cache_spill_epoch_token' => 'spill-epoch-current-358',
    'reader_cache_locking_mode_token' => 'locking-mode-current-358',
    'reader_cache_journal_mode_token' => 'journal-mode-current-358',
    'reader_cache_synchronous_token' => 'synchronous-current-358',
    'reader_cache_mmap_size_token' => 'mmap-size-current-358',
    'reader_cache_cache_size_token' => 'cache-size-current-358',
    'reader_cache_wal_autocheckpoint_token' => 'wal-autocheckpoint-current-358',
    'reader_cache_query_only_token' => 'query-only-current-358',
    'reader_cache_foreign_key_token' => 'foreign-key-current-358',
    'reader_cache_defer_foreign_key_token' => 'defer-foreign-key-current-358',
    'reader_cache_recursive_trigger_token' => 'recursive-trigger-current-358',
    'reader_cache_trusted_schema_token' => 'trusted-schema-current-358',
    'reader_cache_ignore_check_constraints_token' => 'ignore-check-constraints-current-358',
    'reader_cache_application_id_token' => 'application-id-current-358',
    'reader_cache_user_version_token' => 'user-version-current-358',
    'reader_cache_data_version_token' => 'data-version-current-358',
    'reader_cache_schema_lock_token' => 'schema-lock-current-358',
    'reader_cache_schema_format_token' => 'schema-format-current-358',
    'reader_cache_auto_vacuum_incremental_token' => 'auto-vacuum-incremental-current-358',
    'reader_cache_reverse_unordered_selects_token' => 'reverse-unordered-selects-current-358',
    'reader_cache_automatic_index_token' => 'automatic-index-current-358',
    'reader_cache_case_sensitive_like_token' => 'case-sensitive-like-current-358',
    'reader_cache_count_changes_token' => 'count-changes-current-358',
    'reader_cache_checkpoint_fullfsync_token' => 'checkpoint-fullfsync-current-358',
    'reader_cache_fullfsync_token' => 'fullfsync-current-358',
    'reader_cache_legacy_file_format_token' => 'legacy-file-format-current-358',
    'reader_cache_read_uncommitted_token' => 'read-uncommitted-current-358',
    'reader_cache_reverse_scan_order_token' => 'reverse-scan-order-current-358',
    'reader_cache_defensive_token' => 'defensive-current-358',
    'reader_cache_writable_schema_token' => 'writable-schema-current-358',
    'reader_cache_journal_size_limit_token' => 'journal-size-limit-current-358',
    'reader_cache_secure_delete_token' => 'secure-delete-current-358',
    'reader_cache_temp_store_token' => 'temp-store-current-358',
    'reader_cache_cache_spill_token' => 'cache-spill-current-358',
    'reader_cache_cell_size_check_token' => 'cell-size-check-current-358',
    'reader_cache_threads_token' => 'threads-current-358',
    'reader_cache_optimize_token' => 'optimize-current-358',
    'reader_cache_analysis_limit_token' => 'analysis-limit-current-358',
    'reader_cache_hard_heap_limit_token' => 'hard-heap-limit-current-358',
    'reader_cache_soft_heap_limit_token' => 'soft-heap-limit-current-358',
    'reader_cache_page_size_token' => 'page-size-current-358',
    'reader_cache_max_page_count_token' => 'max-page-count-current-358',
    'reader_cache_locking_proxy_file_token' => 'locking-proxy-file-current-358',
    'reader_cache_page_cache_overflow_token' => 'page-cache-overflow-current-358',
    'reader_cache_scratch_allocator_token' => 'scratch-allocator-current-358',
    'reader_cache_lookaside_token' => 'lookaside-current-358',
    'reader_cache_pcache_dirty_limit_token' => 'pcache-dirty-limit-current-358',
    'reader_cache_mmap_read_limit_token' => 'mmap-read-limit-current-358',
    'reader_cache_sorter_reference_token' => 'sorter-reference-current-358',
    'reader_cache_worker_thread_token' => 'worker-thread-current-358',
    'reader_cache_memory_alarm_token' => 'memory-alarm-current-358',
    'reader_cache_status_counter_token' => 'status-counter-current-358',
    'reader_cache_pagecache_size_token' => 'pagecache-size-current-358',
    'reader_cache_pagecache_recycle_token' => 'pagecache-recycle-current-358',
    'reader_cache_scratch_spill_token' => 'scratch-spill-current-358',
    'reader_cache_lookaside_hit_token' => 'lookaside-hit-current-358',
    'reader_cache_lookaside_miss_size_token' => 'lookaside-miss-size-current-358',
    'reader_cache_pcache_refcount_token' => 'pcache-refcount-current-358',
    'reader_cache_memory_used_token' => 'memory-used-current-358',
];
...
$plan = static function (?array $cache = null, ?array $reads = null) use ($database, $master, $masterBytes, $before, $pageSize, $recovered, $base, $tokens, $headers, $cacheEntry, $read): array {
    return SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceReaderCacheMemoryUsedFence($database, $master, $masterBytes, implode('', $before), $pageSize, $recovered, $cache ?? [
...
$cases = [
    'status' => [static fn (): mixed => $plan()['status'], 'pager-master-journal-reader-cache-current-source-next358'],
    ...
    'next291 transaction-state fence is current' => [static fn (): mixed => $plan()['current_reader_cache_transaction_state_token'], 'transaction-state-current-358'],
    'next292 commit-phase fence is current' => [static fn (): mixed => $plan()['current_reader_cache_commit_phase_token'], 'commit-phase-current-358'],
    'next293 busy-handler fence is current' => [static fn (): mixed => $plan()['current_reader_cache_busy_handler_token'], 'busy-handler-current-358'],
    ...
    'dependencies include next358' => [static fn (): mixed => in_array('sqlite-pager-master-journal-reader-cache-current-source-next358', $plan()['dependencies'], true), true],
    ...
    'operation next302' => [static fn (): mixed => $opCount($plan(), 'reopen_reader_for_reader_cache_mmap_size_current_source_mmap-size-fence'), 1],
    ...
    'operation next306' => [static fn (): mixed => $opCount($plan(), 'reopen_reader_for_reader_cache_foreign_key_current_source_foreign-key-fence'), 1],
    ...
    'operation next318' => [static fn (): mixed => $opCount($plan(), 'reopen_reader_for_reader_cache_schema_lock_current_source_schema-lock-fence'), 1],
    ...
    'operation next322' => [static fn (): mixed => $opCount($plan(), 'reopen_reader_for_reader_cache_cell_size_check_current_source_cell-size-check-fence'), 1],
    ...
    'operation next326' => [static fn (): mixed => $opCount($plan(), 'reopen_reader_for_reader_cache_count_changes_current_source_count-changes-fence'), 1],
    ...
    'default plan points at next358' => [static fn (): mixed => $plan()['status'], 'pager-master-journal-reader-cache-current-source-next358'],
];

foreach ($cases as $name => [$callback, $expected]) {
    $tests['pager master journal reader cache current source next358 ' . $name] = static function (TestRunner $t) use ($callback, $expected): void {
        $t->same($expected, $callback());
    };
}

$tests['pager master journal reader cache current source next358 missing token rejects'] = static function (TestRunner $t) use ($plan, $cacheEntry, $recovered): void {
    $t->throws(Throwable::class, static fn () => $plan([1 => array_diff_key($cacheEntry('missing', $recovered[1]), ['reader_cache_memory_used_token' => true])]));
};
