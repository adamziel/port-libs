...
$point133 = static fn (): array => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133(
    'json_tree',
    $current133,
    $next133,
    'option_value',
...
$stable133 = static fn (): array => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133(
    'json_tree',
    $current133,
    $current133,
    'option_value',
...
$miss133 = static fn (): array => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133(
    'json_tree',
    $current133,
    $next133,
    'option_value',
...
$range133 = static fn (): array => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133(
    'json_tree',
    $current133,
    $next133,
    'option_value',
...
$absolute133 = static fn (): array => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133(
    'json_tree',
...
$unusable133 = static fn (): array => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133(
    'json_tree',
    $current133,
    $next133,
    'option_value',
...
$unrunnable133 = static fn (): array => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133(
    'json_tree',
    $current133,
...
$tests = [
    ...
    'bad function is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133('json_bad', $current133, $next133, 'option_value', 'base_root', 'nested_path')),
    'empty json column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133('json_tree', $current133, $next133, '', 'base_root', 'nested_path')),
