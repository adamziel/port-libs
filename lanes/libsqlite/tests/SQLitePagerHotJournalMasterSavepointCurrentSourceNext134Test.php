...
use PortLibs\LibSqlite\SQLitePagerHotJournalMasterSavepointCurrentSourceNext134Plan;
...
$plan = static fn (
    ...
    array $reads = [1, 2, 3, 4],
    bool $reserved = false,
): array => SQLitePagerHotJournalMasterSavepointCurrentSourceNext134Plan::plan(
