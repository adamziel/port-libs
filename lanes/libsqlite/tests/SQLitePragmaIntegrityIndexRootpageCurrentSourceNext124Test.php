...
use PortLibs\LibSqlite\SQLitePragmaIntegrityIndexRootpageCurrentSourceNext124;
...
): array => SQLitePragmaIntegrityIndexRootpageCurrentSourceNext124::page(
...
$tests['pragma integrity index rootpage current source next124 rejects negative offset'] = static function (TestRunner $t) use ($catalogFactory, $validDatabase): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaIntegrityIndexRootpageCurrentSourceNext124::page($catalogFactory(), 'PRAGMA index_xinfo(wp_options_name)', $validDatabase, -1, 124));
};
...
$tests['pragma integrity index rootpage current source next124 rejects zero limit'] = static function (TestRunner $t) use ($catalogFactory, $validDatabase): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaIntegrityIndexRootpageCurrentSourceNext124::page($catalogFactory(), 'PRAGMA index_xinfo(wp_options_name)', $validDatabase, 0, 0));
};
