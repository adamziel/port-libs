...
$sourceAdmissionCases = [
    ...
    'current trigger effects target options' => [static fn (): mixed => array_column($retainedSource()['current_trigger_effects'], 'target_option'), ['landing_url', 'routing_rules']],
    'next trigger effects source options' => [static fn (): mixed => array_column($retainedSource()['next_trigger_effects'], 'source_key'), ['base_url', 'landing_url']],
