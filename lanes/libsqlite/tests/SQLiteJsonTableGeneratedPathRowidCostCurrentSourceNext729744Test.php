...
$tests['json table generated path rowid cost current source next744 no later alias yet'] = static function (TestRunner $t) use ($plan729744): void {
    $t->throws(Error::class, static fn () => $plan729744(745));
};
