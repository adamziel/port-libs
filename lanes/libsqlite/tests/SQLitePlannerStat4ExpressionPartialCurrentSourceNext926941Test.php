...
$plan926941 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext926941(
    $prepared926941(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next926941 malformed needed column' => static function (TestRunner $t) use ($prepared926941, $current926941, $terms926941): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext926941($prepared926941(), $current926941(), $terms926941(), ['option_name', ''], 6));
    },
];
