...
$summary170 = static fn (): array => SQLiteCompoundExceptWindowRecursiveLimitCurrentSourceNextPlan::compareRecursiveExceptWindowOffsetExhaustion($sql170, $currentTables170, $nextTables170);
$tests = [];
...
$tests['compound select window recursive limit current source next170 rejects missing except'] = static function (TestRunner $t) use ($currentTables170): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundExceptWindowRecursiveLimitCurrentSourceNextPlan::compareRecursiveExceptWindowOffsetExhaustion(
