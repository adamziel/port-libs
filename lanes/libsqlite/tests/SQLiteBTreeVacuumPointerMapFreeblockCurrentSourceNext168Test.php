...
) use ($database168): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext168Plan {
    $database = $database168();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext168Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
