...
) use ($database168): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    $database = $database168();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafReplacementChainAuditFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
