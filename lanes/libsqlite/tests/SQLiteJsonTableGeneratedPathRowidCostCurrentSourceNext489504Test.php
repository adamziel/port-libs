...
$tests['json table generated path rowid cost current source next504 no later alias yet'] = static function (TestRunner $t) use ($plan489504): void {
    $t->throws(Error::class, static fn () => $plan489504(505));
};
