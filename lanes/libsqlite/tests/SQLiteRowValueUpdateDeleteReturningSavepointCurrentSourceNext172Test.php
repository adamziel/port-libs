...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan;
...
$plan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute(
    $tables,
    [$yieldUpdateSql],
...
$customPlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute(
    $tables,
    [$yieldUpdateSql],
    [$discardDeleteSql],
    [$retryUpdateSql],
...
$cases = [
    ...
    'malformed empty yielded statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute($tables, [], [$discardDeleteSql], [$retryUpdateSql], $unique), InvalidArgumentException::class],
    'malformed empty discarded statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute($tables, [$yieldUpdateSql], [], [$retryUpdateSql], $unique), InvalidArgumentException::class],
    'malformed empty retry statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute($tables, [$yieldUpdateSql], [$discardDeleteSql], [], $unique), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute($tables, [$yieldUpdateSql], [$discardDeleteSql], [$retryUpdateSql], []), InvalidArgumentException::class],
    'malformed bad savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute($tables, [$yieldUpdateSql], [$discardDeleteSql], [$retryUpdateSql], $unique, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext172Plan::execute(['wp_options' => ['bad']], [$yieldUpdateSql], [$discardDeleteSql], [$retryUpdateSql], $unique), InvalidArgumentException::class],
];
