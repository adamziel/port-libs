...
) use ($database167): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    $database = $database167();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafFinalImageAuditFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
