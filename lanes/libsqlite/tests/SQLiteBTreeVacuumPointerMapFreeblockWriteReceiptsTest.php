...
$plan218 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $database218;

    $database = $database218();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafWriteReceiptAuditFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases218 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan218()->writeSummary()['non_overlap'], 'does not repeat page-apply'),
...
$expected218 = [
    ...
    'dependency closure' => 'no new support component needed; write-receipts reuses page-apply current-source apply rows and adds per-page write receipts only',
    'non overlap' => true,
