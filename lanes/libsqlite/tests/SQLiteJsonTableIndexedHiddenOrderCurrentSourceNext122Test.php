...
$jsonOrder122 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedHiddenOrderNext122(
    'json_tree',
    $current122,
    $next122,
    'option_value',
...
$rootOrder122 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedHiddenOrderNext122(
    'json_tree',
    $current122,
    $nextRoot122,
    'option_value',
...
$stable122 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedHiddenOrderNext122(
    'json_tree',
    $current122,
    $current122,
    'option_value',
...
$visibleOrder122 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedHiddenOrderNext122(
    'json_tree',
    $current122,
    $next122,
    'option_value',
...
$unrunnable122 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedHiddenOrderNext122(
    'json_tree',
    $current122,
...
$tests = [
    ...
    'bad hidden order direction is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceIndexedHiddenOrderNext122('json_tree', $current122, $next122, 'option_value', $constraints122, 'scan_root', [['column' => 'json', 'direction' => 'BAD']])),
