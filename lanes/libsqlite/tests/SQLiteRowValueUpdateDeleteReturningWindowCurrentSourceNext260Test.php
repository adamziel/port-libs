...
$plan260 = static fn (?array $ackYield = null, ?string $resume = null, ?array $ackNext = null, ?array $ackBoundary = null): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext260Plan::execute(
    ...
    $unique260,
    'wp_options_rowvalue_window_current_next260',
    'option_id',
    $ackYield,
    $resume,
    $ackNext,
...
$cases260 = [
    ...
    'fence savepoint' => [static fn (): mixed => $plan260()['boundary_fence_next260']['savepoint'], 'wp_options_rowvalue_window_current_next260'],
