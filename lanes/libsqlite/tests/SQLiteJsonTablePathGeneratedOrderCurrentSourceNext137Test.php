...
$plan137 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137(
    'json_tree',
    $current137,
    $next137,
    'option_value',
...
$desc137 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137(
    'json_tree',
    $current137,
    $next137,
    'option_value',
...
$single137 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137(
    'json_tree',
    $current137,
    $current137,
    'option_value',
...
$jsonSource137 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137(
    'json_tree',
    $current137,
    $current137,
    'option_value',
...
$unrunnable137 = static fn (): array => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137(
    'json_tree',
    $current137,
...
$tests = [
    ...
    'missing generated order rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137('json_tree', $current137, $next137, 'option_value', [], 'scan_root', [], [])),
    'bad generated source rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137('json_tree', $current137, $next137, 'option_value', [], 'scan_root', [], [['name' => 'bad', 'source' => 'missing', 'path' => '$.x']])),
    'bad generated path rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137('json_tree', $current137, $next137, 'option_value', [], 'scan_root', [], [['name' => 'bad', 'path' => '$[']])),
    'bad function rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourcePathGeneratedOrderNext137('json_bad', $current137, $next137, 'option_value', [], 'scan_root', [], $generatedOrder137)),
];
