...
$rollbackPlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeUpdateDeleteReturningSavepointBatch(
    $tables,
    [$beforeSql],
...
$cases = [
    ...
    'malformed empty before rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeUpdateDeleteReturningSavepointBatch($tables, [], [$protectedUpdateSql], [$afterUpdateSql], $unique), InvalidArgumentException::class],
    'malformed empty protected rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeUpdateDeleteReturningSavepointBatch($tables, [$beforeSql], [], [$afterUpdateSql], $unique), InvalidArgumentException::class],
    'malformed empty after rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeUpdateDeleteReturningSavepointBatch($tables, [$beforeSql], [$protectedUpdateSql], [], $unique), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeUpdateDeleteReturningSavepointBatch($tables, [$beforeSql], [$protectedUpdateSql], [$afterUpdateSql], []), InvalidArgumentException::class],
    'malformed rollback ordinal rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeUpdateDeleteReturningSavepointBatch($tables, [$beforeSql], [$protectedUpdateSql], [$afterUpdateSql], $unique, 'bad', 4), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeUpdateDeleteReturningSavepointBatch($tables, [$beforeSql], [$protectedUpdateSql], [$afterUpdateSql], $unique, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeUpdateDeleteReturningSavepointBatch(['wp_options' => ['bad']], [$beforeSql], [$protectedUpdateSql], [$afterUpdateSql], $unique), InvalidArgumentException::class],
];
