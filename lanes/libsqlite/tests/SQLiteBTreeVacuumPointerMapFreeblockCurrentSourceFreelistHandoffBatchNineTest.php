...
$planFreelistHandoffBatchNine = static function (int $sliceNumber, int $batchSize = 2) use ($databaseFreelistHandoffBatchNine): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan {
