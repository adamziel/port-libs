...
$tests['json table generated path rowid cost current source next904 rejects next905 alias'] = static function (TestRunner $t) use ($plan889904): void {
    $t->throws(Error::class, static fn () => $plan889904(905));
};
