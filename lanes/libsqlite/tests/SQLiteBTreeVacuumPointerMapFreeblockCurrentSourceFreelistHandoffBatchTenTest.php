...
$planFreelistHandoffBatchTen = static function (int $sliceNumber, int $batchSize = 2) use ($databaseFreelistHandoffBatchTen): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
