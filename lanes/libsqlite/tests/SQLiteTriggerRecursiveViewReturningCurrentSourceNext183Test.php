...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext183Plan;
...
$run183 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext183Plan::execute(
    $rows183,
    $currentInput183,
    $nextInput183,
    $currentView183,
