...
$legacySourceMatches = static function (): array {
    ...
    $start = $reflection->getMethod('keyValueRowKeyTokenFingerprintPlan')->getStartLine();
    $end = $reflection->getMethod('keyValueRowKeyAsciiPrefixRangePlan')->getStartLine() - 1;
...
return [
    'utf16 nocase like rtrim next175 through next181 source uses generic setting keys' => static fn (TestRunner $t) => $t->same([], $legacySourceMatches()),
];
