...
$plan182 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerSavepointRollback(
    $tables182,
    [$outerUpdate182],
...
$cases182 = [
    ...
    'malformed empty outer statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerSavepointRollback($tables182, [], [$innerDelete182], [$retryUpdate182], $unique182), InvalidArgumentException::class],
    'malformed empty inner statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerSavepointRollback($tables182, [$outerUpdate182], [], [$retryUpdate182], $unique182), InvalidArgumentException::class],
    'malformed empty retry statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerSavepointRollback($tables182, [$outerUpdate182], [$innerDelete182], [], $unique182), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerSavepointRollback($tables182, [$outerUpdate182], [$innerDelete182], [$retryUpdate182], []), InvalidArgumentException::class],
    'malformed same savepoint names rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerSavepointRollback($tables182, [$outerUpdate182], [$innerDelete182], [$retryUpdate182], $unique182, 'same', 'same'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeReleasedInnerSavepointRollback(['wp_options' => ['bad']], [$outerUpdate182], [$innerDelete182], [$retryUpdate182], $unique182), InvalidArgumentException::class],
];
