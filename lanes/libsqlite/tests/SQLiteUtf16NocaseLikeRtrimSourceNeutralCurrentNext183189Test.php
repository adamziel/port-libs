...
$legacySourceMatches = static function (): array {
    ...
    $start = $reflection->getMethod('keyValueRowKeyAsciiPrefixRangePlan')->getStartLine();
    $end = $reflection->getMethod('keyValueRowKeyAsciiSpaceTrimBoundaryPlan')->getStartLine() - 1;
...
return [
    'utf16 nocase like rtrim next183 through next189 source uses generic setting keys' => static fn (TestRunner $t) => $t->same([], $legacySourceMatches()),
];
