...
$tests = [
    ...
    'planner stat4 expression partial current source penultimate prepared handoff inherits advanced handoff' => static fn (TestRunner $t) => $t->same(true, $planPenultimatePreparedHandoff()['selectedPlan']['advancedPreparedHandoffContinuationReady']),
    ...
    'planner stat4 expression partial current source penultimate prepared handoff prior signature threaded' => static fn (TestRunner $t) => $t->same($planPenultimatePreparedHandoff()['stat4AdvancedPreparedHandoffContinuationFence']['handoffSignature'], $planPenultimatePreparedHandoff()['selectedPlan']['penultimatePreparedHandoffPriorHandoffSignature']),
    'planner stat4 expression partial current source penultimate prepared handoff preserves advanced fence' => static fn (TestRunner $t) => $t->same(range(926, 941), $planPenultimatePreparedHandoff()['stat4AdvancedPreparedHandoffContinuationFence']['preparedSlices']),
