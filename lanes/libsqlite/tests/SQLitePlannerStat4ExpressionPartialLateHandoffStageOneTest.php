...
$tests = [
    ...
    'planner stat4 expression partial current source next670685 cursor appended' => static fn (TestRunner $t) => $t->same('PrepareStat4ExpressionPartialNext670685Handoff', $plan670685()['cursorProgram'][array_key_last($plan670685()['cursorProgram'])]['opcode']),
    'planner stat4 expression partial current source next670685 cursor mode' => static fn (TestRunner $t) => $t->same('next670-685-current-source-stat4-expression-partial-prep', $plan670685()['cursorProgram'][array_key_last($plan670685()['cursorProgram'])]['mode']),
