...
$plan254 = static fn (?array $receipts = null, ?string $resume = null, ?array $ack = null, bool $requireNext = true): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeRowReceiptAdmissionWindow(
    $tables254,
