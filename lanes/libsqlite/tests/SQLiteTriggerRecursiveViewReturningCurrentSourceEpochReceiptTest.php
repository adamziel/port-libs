...
$badEpoch230 = static fn (): array => $plan230(['auto_ack_current_source_epoch' => true, 'expected_current_source_epoch' => 'wp.current.source.epoch.other.230']);
$badCursor230 = static fn (): array => $plan230(['auto_ack_current_source_epoch' => true, 'expected_current_source_epoch_cursor' => 'wp.returning.current.epoch.cursor.other.230']);
$custom230 = static fn (): array => $plan230(['auto_ack_current_source_epoch' => true, 'current_source_epoch' => 'wp.current.source.epoch.custom.230']);
...
$cases230 = [
    ...
    'epoch retained' => [static fn (): mixed => $released230()['current_source_epoch'], 'wp.current.source.epoch.230'],
    'custom epoch retained' => [static fn (): mixed => $custom230()['current_source_epoch'], 'wp.current.source.epoch.custom.230'],
    'expected epoch retained' => [static fn (): mixed => $released230()['expected_current_source_epoch'], 'wp.current.source.epoch.230'],
    ...
    'cursor retained' => [static fn (): mixed => $released230()['current_source_epoch_cursor'], 'wp.returning.current.epoch.cursor.230'],
