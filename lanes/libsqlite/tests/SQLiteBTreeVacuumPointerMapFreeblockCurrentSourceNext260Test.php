...
$plan260 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext260Plan {
    global $database260;

    $database = $database260();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext260Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
