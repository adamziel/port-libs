...
$statementHeld244 = static fn (): array => $plan244(['auto_ack_current_source_upsert_commits_next244' => true, 'expected_current_source_upsert_statement_id_next244' => 'app.current.source.upsert.statement.stale.244']);
$watermarkHeld244 = static fn (): array => $plan244(['auto_ack_current_source_upsert_commits_next244' => true, 'expected_current_source_upsert_commit_watermark_next244' => 'app.current.source.upsert.commit.stale.244']);
...
$custom244 = static fn (): array => $plan244([
    ...
    'current_source_upsert_statement_id_next244' => 'app.current.source.upsert.statement.custom.244',
    'current_source_upsert_commit_watermark_next244' => 'app.current.source.upsert.commit.custom.244',
...
$cases244 = [
    ...
    'savepoint retained' => [static fn (): mixed => $released244()['savepoint'], 'app_recursive_view_244'],
    ...
    'statement id retained' => [static fn (): mixed => $released244()['current_source_upsert_statement_id_next244'], 'app.current.source.upsert.statement.244'],
    'custom statement id retained' => [static fn (): mixed => $custom244()['current_source_upsert_statement_id_next244'], 'app.current.source.upsert.statement.custom.244'],
    'watermark retained' => [static fn (): mixed => $released244()['current_source_upsert_commit_watermark_next244'], 'app.current.source.upsert.commit.244'],
    'custom watermark retained' => [static fn (): mixed => $custom244()['current_source_upsert_commit_watermark_next244'], 'app.current.source.upsert.commit.custom.244'],
    ...
    'current statement stamped' => [static fn (): mixed => array_values(array_unique(array_column($released244()['current_source_rows_next244'], 'current_source_upsert_statement_id_next244'))), ['app.current.source.upsert.statement.244']],
    'next statement stamped' => [static fn (): mixed => array_values(array_unique(array_column($released244()['attempted_next_source_rows_next244'], 'current_source_upsert_statement_id_next244'))), ['app.current.source.upsert.statement.244']],
    'current watermark stamped' => [static fn (): mixed => array_values(array_unique(array_column($released244()['current_source_rows_next244'], 'current_source_upsert_commit_watermark_next244'))), ['app.current.source.upsert.commit.244']],
    'visible payload names released' => [static fn (): mixed => array_column($released244()['visible_returning_payloads_next244'], 'name'), ['app_summary_child', 'template_child', 'landing_url', 'next_module']],
    'held payload names missing' => [static fn (): mixed => array_column($missing244()['held_next_returning_payloads_next244'], 'name'), ['landing_url', 'next_module']],
