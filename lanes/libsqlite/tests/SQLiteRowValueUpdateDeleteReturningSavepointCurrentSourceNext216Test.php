...
$plan216 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext216Plan::execute(
    $tables216,
    [$attemptUpdate216, $attemptDelete216],
    [$retryUpdate216, $retryDelete216],
    $unique216,
);
$customPlan216 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext216Plan::execute(
    $tables216,
    [$attemptUpdate216],
    [$retryUpdate216],
    $unique216,
...
$cases216 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext216Plan::execute($tables216, [], [$retryUpdate216], $unique216), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext216Plan::execute($tables216, [$attemptUpdate216], [], $unique216), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext216Plan::execute($tables216, [$attemptUpdate216], [$retryUpdate216], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext216Plan::execute($tables216, [$attemptUpdate216], [$retryUpdate216], $unique216, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext216Plan::execute(['wp_options' => ['bad']], [$attemptUpdate216], [$retryUpdate216], $unique216), InvalidArgumentException::class],
];
