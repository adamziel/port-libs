...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext211Plan;
...
$plan211 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext211Plan {
    global $database211;

    $database = $database211();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext211Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases211 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan211()->applySummary()['non_overlap'], 'does not repeat next209'),
...
$expected211 = [
    ...
    'dependency closure' => 'no new support component needed; next211 reuses next209 latched current-source writer rows, pointer-map pages, payload/freeblock pages, and fenced-tail metadata',
    'non overlap' => true,
