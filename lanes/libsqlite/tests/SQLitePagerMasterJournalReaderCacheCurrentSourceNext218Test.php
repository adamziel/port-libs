...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext218Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext218Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
