...
$releasePlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan::execute($tables, [$ignoreSql, $replaceSql, $deleteSql], $unique);
$rollbackPlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan::execute($tables, [$releaseSql, $deleteSql], $unique, 'wp_options_retry', 'option_id', 1);
$simpleReleasePlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan::execute($tables, [$releaseSql, $deleteSql], $unique);
...
$cases = [
    ...
    'malformed empty statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan::execute($tables, [], $unique), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan::execute($tables, [$releaseSql], []), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan::execute(['wp_options' => ['bad']], [$releaseSql], $unique), InvalidArgumentException::class],
    'malformed negative rollback ordinal rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext156Plan::execute($tables, [$releaseSql], $unique, 'bad', 'option_id', -1), InvalidArgumentException::class],
];
