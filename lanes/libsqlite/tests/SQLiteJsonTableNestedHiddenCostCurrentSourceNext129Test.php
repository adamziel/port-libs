...
$plan129 = static fn (
    ...
    ?array $orderBy = null,
): array => SQLiteJsonTablePlan::currentSourceNestedHiddenCostNext129(
    'json_tree',
    $current ?? $current129,
    $next ?? $next129,
    'option_value',
...
$tests = [
    ...
    'bad function is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedHiddenCostNext129('json_bad', $current129, $next129, 'option_value', 'base_root', 'nested_path')),
    'empty json column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedHiddenCostNext129('json_tree', $current129, $next129, '', 'base_root', 'nested_path')),
    'empty base root column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedHiddenCostNext129('json_tree', $current129, $next129, 'option_value', '', 'nested_path')),
    'empty nested path column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedHiddenCostNext129('json_tree', $current129, $next129, 'option_value', 'base_root', '')),
