...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewUpsertCurrentSourceNext234Plan;
...
$plan234 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewUpsertCurrentSourceNext234Plan::execute(
    $rows234,
    $currentInput234,
    $nextInput234,
    $currentView234,
