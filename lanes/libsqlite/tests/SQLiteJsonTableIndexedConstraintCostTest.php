...
$fullkey119 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedConstraintCost(
    'json_tree',
    $current119,
    $next119,
    'option_value',
...
$stable119 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedConstraintCost(
    'json_tree',
    $current119,
    $current119,
    'option_value',
...
$rowid119 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedConstraintCost(
    'json_tree',
    $current119,
    $next119,
    'option_value',
...
$scan119 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedConstraintCost(
    'json_each',
    $current119,
    $current119,
    'option_value',
...
$unrunnable119 = static fn (): array => SQLiteJsonTablePlan::currentSourceIndexedConstraintCost(
    'json_tree',
    $current119,
...
$tests = [
    ...
    'bad order direction still rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceIndexedConstraintCost('json_each', $current119, $next119, 'option_value', $priorityConstraints119, 'scan_root', [['column' => 'key', 'direction' => 'BAD']])),
];
