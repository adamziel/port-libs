...
$tests['compound recursive affinity window current source next142 status dependencies'] = static function (TestRunner $t) use ($summary): void {
    $plan = $summary();
    $t->same('compound-recursive-affinity-window-current-source-next142-ready', $plan['status']);
    $t->same([
...
$tests['compound recursive affinity window current source next142 compound metadata'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound recursive affinity window current source next142 current rows preserve left names'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound recursive affinity window current source next142 next rows add source boundary'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound recursive affinity window current source next142 recursive queue captures affinity duplicate skip'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound recursive affinity window current source next142 recursive current next trace counts'] = static function (TestRunner $t) use ($summary): void {
    $recursive = $summary()['recursive'];
...
$tests['compound recursive affinity window current source next142 window metadata'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound recursive affinity window current source next142 affinity diagnostics'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound recursive affinity window current source next142 source delta'] = static function (TestRunner $t) use ($summary): void {
...
$tests['compound recursive affinity window current source next142 changed signatures and reasons'] = static function (TestRunner $t) use ($summary): void {
    $plan = $summary();
...
foreach (range(1, 58) as $case) {
    $tests['compound recursive affinity window current source next142 generated affinity source boundary ' . $case] = static function (TestRunner $t) use ($case): void {
        $tables = [
            'wp_options' => [
