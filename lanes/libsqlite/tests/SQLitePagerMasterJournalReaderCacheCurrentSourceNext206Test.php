...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext206Plan;
...
$plan = static fn (
    ...
    ?array $headers = null,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext206Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
