...
use PortLibs\LibSqlite\SQLitePragmaIndexForeignKeyIntegrityCurrentSourceNext137;
...
): array => SQLitePragmaIndexForeignKeyIntegrityCurrentSourceNext137::page(
...
$tests['pragma index foreignkey integrity current source next137 rejects empty source'] = static function (TestRunner $t) use ($catalog, $pointerMismatchDatabase, $records, $foreignKeys, $tables, $nextSource): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaIndexForeignKeyIntegrityCurrentSourceNext137::page($catalog, 'PRAGMA main.index_list(wp_options)', $pointerMismatchDatabase, $records, $foreignKeys, $tables, '', $nextSource));
};
