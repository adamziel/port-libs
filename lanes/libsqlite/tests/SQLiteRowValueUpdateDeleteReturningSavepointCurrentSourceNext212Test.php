...
$plan212 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeSubquerySavepointRollbackRetry(
    $tables212,
    [$attemptUpdate212, $attemptDelete212],
    [$retryUpdate212, $retryDelete212],
    $unique212,
);
$customPlan212 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeSubquerySavepointRollbackRetry(
    $tables212,
    [$attemptUpdate212],
    [$retryUpdate212],
    $unique212,
...
$cases212 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeSubquerySavepointRollbackRetry($tables212, [], [$retryUpdate212], $unique212), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeSubquerySavepointRollbackRetry($tables212, [$attemptUpdate212], [], $unique212), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeSubquerySavepointRollbackRetry($tables212, [$attemptUpdate212], [$retryUpdate212], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeSubquerySavepointRollbackRetry($tables212, [$attemptUpdate212], [$retryUpdate212], $unique212, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeSubquerySavepointRollbackRetry(['wp_options' => ['bad']], [$attemptUpdate212], [$retryUpdate212], $unique212), InvalidArgumentException::class],
];
