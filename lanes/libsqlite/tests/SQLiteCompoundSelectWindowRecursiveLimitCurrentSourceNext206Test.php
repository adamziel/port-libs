...
$summary206 = static fn (?array $cursor = null): array => SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNextPlan::compareLeadNthValueIntersectLimit($sql206, $currentTables206, $nextTables206, $cursor);
$tests = [];
