...
$point159 = static fn (?array $current = null, ?array $next = null): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidSeekCostNext159(
    'json_tree',
    $current ?? $current159,
    $next ?? $next159,
    'option_value',
...
$in159 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidSeekCostNext159(
    'json_tree',
...
$between159 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidSeekCostNext159(
    'json_tree',
    array_replace($current159, ['generated_path' => '$.rules']),
    array_replace($next159, ['generated_path' => '$.rules']),
    'option_value',
...
$wide159 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidSeekCostNext159(
    'json_tree',
    array_replace($current159, ['generated_path' => '$.rules']),
    $next159,
    'option_value',
...
$unconstrained159 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidSeekCostNext159(
    'json_tree',
    $current159,
    $next159,
    'option_value',
...
$tests = [
    ...
    'preserves next145 dependency' => static fn (TestRunner $t) => $t->true(in_array('sqlite-json-table-generated-path-rowid-cost-current-source-next145', $point159()['dependencies'], true)),
    ...
    'bad generated path column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidSeekCostNext159('json_tree', $current159, $next159, 'option_value', '', [])),
    'missing generated path column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidSeekCostNext159('json_tree', $current159, $next159, 'option_value', 'missing_path', [])),
