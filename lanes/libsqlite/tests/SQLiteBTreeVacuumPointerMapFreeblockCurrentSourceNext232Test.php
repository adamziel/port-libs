...
$plan232 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext232Plan {
    global $database232;

    $database = $database232();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext232Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases232 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan232()->handoffSummary()['non_overlap'], 'does not repeat next229'),
...
$expected232 = [
    ...
    'dependency closure' => 'no new support component needed; next232 reuses next229 resume rows and adds next-writer handoff admission only',
    'non overlap' => true,
