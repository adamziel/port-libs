...
$tests['pager master journal reader cache current source checkpoint branch fence admits current VDBE literal and arithmetic opcode fences'] = static function (TestRunner $t) use ($plan): void {
    ...
    $t->same('reader-cache-stmt-vdbe-bit-and-handoff-current-670', $result['current_reader_cache_stmt_vdbe_bit_and_handoff_token']);
    $t->same('reader-cache-stmt-vdbe-checkpoint-branch-handoff-current-670', $result['current_reader_cache_stmt_vdbe_checkpoint_branch_handoff_token']);
