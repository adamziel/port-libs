...
$plan141 = static fn (bool $secureDelete = false): SQLiteBTreePointerMapFreelistOverflowCurrentSourceNextPlan => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNextPlan::currentSourceFreelistFromPreparedOverflowChains(
    $database141(false),
    $database141(true),
    $preparedChains141(),
    $currentChains141(),
...
$cases141 = [
    ...
    'empty replacement rejected' => static fn (): mixed => $throwMessage141(static fn () => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNextPlan::currentSourceFreelistFromPreparedOverflowChains($database141(false), $database141(true), $preparedChains141(), $currentChains141(), '', 4)),
    'bad parent rejected' => static fn (): mixed => $throwMessage141(static fn () => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNextPlan::currentSourceFreelistFromPreparedOverflowChains($database141(false), $database141(true), $preparedChains141(), $currentChains141(), 'abc', 1)),
    'empty current chains rejected' => static fn (): mixed => $throwMessage141(static fn () => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNextPlan::currentSourceFreelistFromPreparedOverflowChains($database141(false), $database141(true), $preparedChains141(), [], 'abc', 4)),
    'trailing current chain rejected' => static function () use ($database141, $preparedChains141, $currentChains141, $throwMessage141): mixed {
        ...
        return $throwMessage141(static fn () => SQLiteBTreePointerMapFreelistOverflowCurrentSourceNextPlan::currentSourceFreelistFromPreparedOverflowChains($database141(false), $database141(true), $preparedChains141(), $chains, 'abc', 4));
    },
];
