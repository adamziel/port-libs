...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext239Plan;
...
$plan239 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext239Plan::execute(
    $tables239,
...
$customPlan239 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext239Plan::execute(
    $tables239,
    [$yieldUpdate239],
    [$attemptUpdate239],
    [$retryUpdate239],
...
$cases239 = [
    ...
    'plan savepoint' => [static fn (): mixed => $plan239()['savepoint'], 'wp_options_rowvalue_window_current_next239'],
    ...
    'release seal savepoint' => [static fn (): mixed => $plan239()['release_window_seal_next239']['savepoint'], 'wp_options_rowvalue_window_current_next239'],
    ...
    'malformed empty yield rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext239Plan::execute($tables239, [], [$attemptUpdate239], [$retryUpdate239], $unique239), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext239Plan::execute($tables239, [$yieldUpdate239], [], [$retryUpdate239], $unique239), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext239Plan::execute($tables239, [$yieldUpdate239], [$attemptUpdate239], [], $unique239), InvalidArgumentException::class],
    'malformed rowid rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext239Plan::execute($tables239, [$yieldUpdate239], [$attemptUpdate239], [$retryUpdate239], $unique239, 'sp239', 'missing_rowid'), InvalidArgumentException::class],
];
