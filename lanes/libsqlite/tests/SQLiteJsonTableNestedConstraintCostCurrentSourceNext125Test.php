...
$plan125 = static fn (array $current = null, array $next = null, array $constraints = null, array $orderBy = null): array => SQLiteJsonTablePlan::currentSourceNestedConstraintCostNext125(
    'json_tree',
    $current ?? $current125,
    $next ?? $next125,
    'option_value',
...
$tests = [
    ...
    'bad function is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedConstraintCostNext125('json_bad', $current125, $next125, 'option_value', 'base_root', 'nested_path')),
    'empty json column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedConstraintCostNext125('json_tree', $current125, $next125, '', 'base_root', 'nested_path')),
    'empty base column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedConstraintCostNext125('json_tree', $current125, $next125, 'option_value', '', 'nested_path')),
    'empty nested column is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceNestedConstraintCostNext125('json_tree', $current125, $next125, 'option_value', 'base_root', '')),
