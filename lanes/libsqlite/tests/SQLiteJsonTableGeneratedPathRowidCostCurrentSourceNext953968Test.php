...
$tests['json table generated path rowid cost current source next968 rejects next969 alias'] = static function (TestRunner $t) use ($plan953968): void {
    $t->throws(Error::class, static fn () => $plan953968(969));
};
