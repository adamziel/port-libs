...
$tests = [
    ...
    'planner stat4 expression partial current source next750765 cursor appended' => static fn (TestRunner $t) => $t->same('PrepareStat4ExpressionPartialPreparedHandoffRange', $plan750765()['cursorProgram'][array_key_last($plan750765()['cursorProgram'])]['opcode']),
    'planner stat4 expression partial current source next750765 cursor mode' => static fn (TestRunner $t) => $t->same('prepared-handoff-range-current-source-stat4-expression-partial-prep', $plan750765()['cursorProgram'][array_key_last($plan750765()['cursorProgram'])]['mode']),
