...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext195Plan;
...
$plan195 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext195Plan::execute(
    $rows195,
    $currentInput195,
    $nextInput195,
    $currentView195,
