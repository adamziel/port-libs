...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext176Plan;
...
$plan176 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext176Plan::execute(
    $rows176,
    $currentInput176,
    $nextInput176,
    $currentView176,
