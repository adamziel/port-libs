...
$plan186 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext186Plan::execute(
    $tables186,
    [$outerUpdate186],
...
$customPlan186 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext186Plan::execute(
    $tables186,
    [$outerUpdate186],
    [$attemptUpdate186],
    [$retryUpdate186],
...
$cases186 = [
    ...
    'malformed empty outer rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext186Plan::execute($tables186, [], [$attemptUpdate186], [$retryUpdate186], $unique186), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext186Plan::execute($tables186, [$outerUpdate186], [], [$retryUpdate186], $unique186), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext186Plan::execute($tables186, [$outerUpdate186], [$attemptUpdate186], [], $unique186), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext186Plan::execute($tables186, [$outerUpdate186], [$attemptUpdate186], [$retryUpdate186], []), InvalidArgumentException::class],
    'malformed same savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext186Plan::execute($tables186, [$outerUpdate186], [$attemptUpdate186], [$retryUpdate186], $unique186, 'same', 'same'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext186Plan::execute(['wp_options' => ['bad']], [$outerUpdate186], [$attemptUpdate186], [$retryUpdate186], $unique186), InvalidArgumentException::class],
];
