...
$plan153 = static fn (bool $secureDelete = true): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan => SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableAndIndexReleasedOverflowReuseFromCurrentSourceDeleteResults(
    $database153(),
    3,
    [
        [
