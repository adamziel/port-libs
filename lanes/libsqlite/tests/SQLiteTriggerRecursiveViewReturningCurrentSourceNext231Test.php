...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext231Plan;
...
$plan231 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext231Plan::execute(
    $rows231,
    $currentInput231,
    $nextInput231,
    $currentView231,
