...
) use ($database166): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext166Plan {
    $database = $database166();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: $secureDelete);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext166Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
