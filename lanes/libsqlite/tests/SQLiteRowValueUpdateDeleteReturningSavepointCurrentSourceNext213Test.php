...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan;
...
$plan213 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan::execute(
    $tables213,
    [$attemptUpdate213, $attemptDelete213],
    [$retryUpdate213, $retryDelete213],
    $unique213,
);
$customPlan213 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan::execute(
    $tables213,
    [$attemptUpdate213],
    [$retryUpdate213],
    $unique213,
...
$cases213 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan::execute($tables213, [], [$retryUpdate213], $unique213), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan::execute($tables213, [$attemptUpdate213], [], $unique213), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan::execute($tables213, [$attemptUpdate213], [$retryUpdate213], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan::execute($tables213, [$attemptUpdate213], [$retryUpdate213], $unique213, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext213Plan::execute(['wp_options' => ['bad']], [$attemptUpdate213], [$retryUpdate213], $unique213), InvalidArgumentException::class],
];
