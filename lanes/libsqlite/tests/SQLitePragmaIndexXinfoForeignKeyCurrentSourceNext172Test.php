...
use PortLibs\LibSqlite\SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext172;
...
): array => SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext172::currentNextPageFromCatalog(
    $currentRecords172,
    $currentTables172,
    $nextRecords172,
