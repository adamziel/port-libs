...
$pageSize = 512;
$database = '/srv/wp-content/database/wp-cell-size-check-fence.sqlite';
$usersDatabase = '/srv/wp-content/database/wp-cell-size-check-fence-users.sqlite';
...
$formatPage = static function (string $label) use ($pageSize): string {
    ...
    $page = substr_replace($page, pack('N', 322), 60, 4);
...
$before = [1 => $formatPage('cell-size-check-fence stale schema'), 2 => $page('cell-size-check-fence stale options'), 3 => $page('cell-size-check-fence stale plugins'), 4 => $page('cell-size-check-fence stale users')];
$recovered = [1 => $formatPage('cell-size-check-fence current schema'), 2 => $page('cell-size-check-fence current options'), 3 => $page('cell-size-check-fence current plugins'), 4 => $page('cell-size-check-fence current users')];
$tokens = [$mainJournal => 'member-main-current-322', $usersJournal => 'member-users-current-322'];
$headers = [$mainJournal => hash('sha256', 'main header cell-size-check-fence'), $usersJournal => hash('sha256', 'users header cell-size-check-fence')];
$base = [
    'source_id' => 'pager-reader-cache-cell-size-check-fence',
    'epoch' => 322,
    'format_signature' => hash('sha256', implode('|', [512, 4, 2, 322, 0])),
    'publication_generation' => 322,
    'master_source_digest' => hash('sha256', 'master-cell-size-check-fence'),
    'recovery_sequence' => 322,
    'recovered_page_set_digest' => $recoveredDigest($recovered),
    'member_journal_tokens' => $tokens,
    'member_journal_header_digests' => $headers,
    'master_member_order_digest' => hash('sha256', implode("\n", array_keys($tokens))),
    'master_journal_file_token' => 'master-file-current-322',
    'master_journal_bytes_digest' => hash('sha256', $masterBytes),
    'database_file_token' => 'database-file-current-322',
    'master_journal_cleanup_token' => 'master-cleanup-current-322',
    'reader_lease_token' => 'reader-lease-current-322',
    'pager_cache_source_token' => 'pager-cache-source-current-322',
    'read_transaction_token' => 'read-transaction-current-322',
    'schema_reparse_token' => 'schema-reparse-current-322',
    'statement_schema_root_token' => 'statement-schema-root-current-322',
    'current_source_provenance_token' => 'source-provenance-current-322',
    'pager_reader_cache_generation_token' => 'cache-generation-current-322',
    'reader_snapshot_token' => 'reader-snapshot-current-322',
    'master_journal_recovery_receipt_token' => 'recovery-receipt-current-322',
    'pager_spill_drain_token' => 'spill-drain-current-322',
    'rollback_journal_reader_source_token' => 'rollback-source-current-322',
    'pager_hot_journal_header_token' => 'hot-header-current-322',
    'master_journal_member_epoch_token' => 'member-epoch-current-322',
    'reader_cache_schema_cookie_token' => 'schema-cookie-current-322',
    'reader_cache_vacuum_root_token' => 'vacuum-root-current-322',
    'pager_reserved_lock_token' => 'reserved-lock-current-322',
    'reader_cache_page_count_token' => 'page-count-current-322',
    'reader_cache_schema_version_token' => 'schema-version-current-322',
    'reader_cache_change_counter_token' => 'change-counter-current-322',
    'reader_cache_freelist_trunk_token' => 'freelist-trunk-current-322',
    'reader_cache_auto_vacuum_token' => 'auto-vacuum-current-322',
    'reader_cache_encoding_token' => 'encoding-current-322',
    'reader_cache_text_schema_token' => 'text-schema-current-322',
    'reader_cache_index_schema_token' => 'index-schema-current-322',
    'reader_cache_trigger_schema_token' => 'trigger-schema-current-322',
    'reader_cache_view_schema_token' => 'view-schema-current-322',
    'reader_cache_virtual_table_schema_token' => 'virtual-table-schema-current-322',
    'reader_cache_module_schema_token' => 'module-schema-current-322',
    'reader_cache_pragma_schema_token' => 'pragma-schema-current-322',
    'reader_cache_collation_schema_token' => 'collation-schema-current-322',
    'reader_cache_authorizer_schema_token' => 'authorizer-schema-current-322',
    'reader_cache_transaction_state_token' => 'transaction-state-current-322',
    'reader_cache_commit_phase_token' => 'commit-phase-current-322',
    'reader_cache_busy_handler_token' => 'busy-handler-current-322',
    'reader_cache_savepoint_stack_token' => 'savepoint-stack-current-322',
    'reader_cache_statement_journal_token' => 'statement-journal-current-322',
    'reader_cache_temp_page_token' => 'temp-page-current-322',
    'reader_cache_dirty_list_token' => 'dirty-list-current-322',
    'reader_cache_spill_epoch_token' => 'spill-epoch-current-322',
    'reader_cache_locking_mode_token' => 'locking-mode-current-322',
    'reader_cache_journal_mode_token' => 'journal-mode-current-322',
    'reader_cache_synchronous_token' => 'synchronous-current-322',
    'reader_cache_mmap_size_token' => 'mmap-size-current-322',
    'reader_cache_cache_size_token' => 'cache-size-current-322',
    'reader_cache_wal_autocheckpoint_token' => 'wal-autocheckpoint-current-322',
    'reader_cache_query_only_token' => 'query-only-current-322',
    'reader_cache_foreign_key_token' => 'foreign-key-current-322',
    'reader_cache_defer_foreign_key_token' => 'defer-foreign-key-current-322',
    'reader_cache_recursive_trigger_token' => 'recursive-trigger-current-322',
    'reader_cache_trusted_schema_token' => 'trusted-schema-current-322',
    'reader_cache_ignore_check_constraints_token' => 'ignore-check-constraints-current-322',
    'reader_cache_application_id_token' => 'application-id-current-322',
    'reader_cache_user_version_token' => 'user-version-current-322',
    'reader_cache_data_version_token' => 'data-version-current-322',
    'reader_cache_schema_lock_token' => 'schema-lock-current-322',
    'reader_cache_schema_format_token' => 'schema-format-current-322',
    'reader_cache_auto_vacuum_incremental_token' => 'auto-vacuum-incremental-current-322',
    'reader_cache_reverse_unordered_selects_token' => 'reverse-unordered-selects-current-322',
    'reader_cache_automatic_index_token' => 'automatic-index-current-322',
    'reader_cache_case_sensitive_like_token' => 'case-sensitive-like-current-322',
    'reader_cache_count_changes_token' => 'count-changes-current-322',
    'reader_cache_secure_delete_token' => 'secure-delete-current-322',
    'reader_cache_temp_store_token' => 'temp-store-current-322',
    'reader_cache_cache_spill_token' => 'cache-spill-current-322',
    'reader_cache_cell_size_check_token' => 'cell-size-check-current-322',
];
...
$plan = static function (?array $cache = null, ?array $reads = null) use ($database, $master, $masterBytes, $before, $pageSize, $recovered, $base, $tokens, $headers, $cacheEntry, $read): array {
    return SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::currentSourceReaderCacheCellSizeCheckFence($database, $master, $masterBytes, implode('', $before), $pageSize, $recovered, $cache ?? [
...
$cases = [
    'status' => [static fn (): mixed => $plan()['status'], 'pager-master-journal-reader-cache-current-source-cell-size-check-fence'],
    ...
    'next291 transaction-state fence is current' => [static fn (): mixed => $plan()['current_reader_cache_transaction_state_token'], 'transaction-state-current-322'],
    'next292 commit-phase fence is current' => [static fn (): mixed => $plan()['current_reader_cache_commit_phase_token'], 'commit-phase-current-322'],
    'next293 busy-handler fence is current' => [static fn (): mixed => $plan()['current_reader_cache_busy_handler_token'], 'busy-handler-current-322'],
    ...
    'cell-size-check-fence cell-size-check ticket reopens reader' => [static fn (): mixed => $plan()['next_reads'][3]['reader_cache_cell_size_check_token_reason'], 'reader_ticket_reader_cache_cell_size_check_predates_current_source'],
    ...
    'dependencies include cell-size-check-fence' => [static fn (): mixed => in_array('sqlite-pager-master-journal-reader-cache-current-source-cell-size-check-fence', $plan()['dependencies'], true), true],
    ...
    'default plan points at cell-size-check-fence' => [static fn (): mixed => $plan()['status'], 'pager-master-journal-reader-cache-current-source-cell-size-check-fence'],
];

foreach ($cases as $name => [$callback, $expected]) {
    $tests['pager master journal reader cache cell size check fence ' . $name] = static function (TestRunner $t) use ($callback, $expected): void {
        $t->same($expected, $callback());
    };
}

$tests['pager master journal reader cache cell size check fence missing token rejects'] = static function (TestRunner $t) use ($plan, $cacheEntry, $recovered): void {
