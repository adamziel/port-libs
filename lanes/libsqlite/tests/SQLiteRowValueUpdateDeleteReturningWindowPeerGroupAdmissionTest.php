...
$plan262 = static fn (?array $peerAck = null, array $peerColumns = ['status'], ?array $boundaryAck = null): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executePeerGroupAdmission(
    $tables262,
