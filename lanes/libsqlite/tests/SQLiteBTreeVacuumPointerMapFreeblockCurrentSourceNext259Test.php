...
$plan259 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext259Plan {
    global $database259;

    $database = $database259();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext259Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases259 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan259()->sourceNextSummary()['non_overlap'], 'does not repeat next255'),
...
$expected259 = [
    ...
    'dependency closure' => 'no new support component needed; next259 reuses next255 publication rows and validates current-source next links before freeblock/payload reuse',
    'non overlap' => true,
    'publication action' => 'btree-vacuum-pointermap-freeblock-current-source-next255',
