...
$rollbackPlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeRollbackReturningTransaction($tables, [$stageSql, $cleanupSql, $rollbackSql], $unique);
$releasePlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeRollbackReturningTransaction($tables, [$releaseSql, $cleanupSql], $unique);
...
$cases = [
    ...
    'custom savepoint accepted' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeRollbackReturningTransaction($tables, [$releaseSql], $unique, 'wp_custom_rollback')['savepoint'], 'wp_custom_rollback'],
    'malformed empty statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeRollbackReturningTransaction($tables, [], $unique), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeRollbackReturningTransaction($tables, [$releaseSql], []), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeRollbackReturningTransaction(['wp_options' => ['bad']], [$releaseSql], $unique), InvalidArgumentException::class],
];
