...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext230Plan;
...
$plan230 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext230Plan::execute(
    $rows230,
    $currentInput230,
    $nextInput230,
    $currentView230,
