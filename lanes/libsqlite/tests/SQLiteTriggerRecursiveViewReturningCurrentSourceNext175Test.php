...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext175Plan;
...
$plan175 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext175Plan::execute(
    $rows175,
    $currentInput175,
    $nextInput175,
    $currentView175,
