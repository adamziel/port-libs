...
$plan188 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext188Plan::execute(
    $tables188,
...
$cases188 = [
    ...
    'malformed empty attempts rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext188Plan::execute($tables188, [], [$retryUpdate188]), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext188Plan::execute($tables188, [$emptyDelete188], []), InvalidArgumentException::class],
    'malformed savepoint name rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext188Plan::execute($tables188, [$emptyDelete188], [$retryUpdate188], 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext188Plan::execute(['wp_options' => ['bad']], [$emptyDelete188], [$retryUpdate188]), InvalidArgumentException::class],
];
