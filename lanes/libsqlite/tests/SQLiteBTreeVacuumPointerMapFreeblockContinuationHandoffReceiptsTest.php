...
foreach ([703, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713, 714, 715, 716, 717, 718] as $sliceNumber) {
    $tests["btree vacuum pointermap freeblock publishes stable continuation handoff receipt {$sliceNumber}"] = static function (TestRunner $t) use ($planForHandoff, $sliceNumber): void {
