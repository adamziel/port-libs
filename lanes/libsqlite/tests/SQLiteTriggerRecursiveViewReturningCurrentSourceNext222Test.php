...
$canonical222 = static fn (): array => $plan222([
    ...
    'current_source_ticket' => 'wp.current.source.ticket.canonical',
...
$cases222 = [
    ...
    'canonical ticket option retained' => [static fn (): mixed => $canonical222()['current_source_ticket'], 'wp.current.source.ticket.canonical'],
    'canonical ticket legacy alias retained' => [static fn (): mixed => $canonical222()['current_source_ticket_next222'], 'wp.current.source.ticket.canonical'],
    'view source retained' => [static fn (): mixed => $released222()['current_view_source_next222'], 'main@view-cookie-222-current'],
    'canonical view source option retained' => [static fn (): mixed => $canonical222()['current_view_source_ticket'], 'main@view-cookie-canonical-current'],
    ...
    'canonical trigger source option retained' => [static fn (): mixed => $canonical222()['current_trigger_source_ticket'], 'main@trigger-cookie-canonical-current'],
