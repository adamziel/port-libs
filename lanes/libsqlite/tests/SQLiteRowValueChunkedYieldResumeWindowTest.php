...
$plan249 = static fn (?array $ack = null, int $chunkSize = 2): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeChunkedYieldResumeWindow(
    ...
    $unique249,
    'wp_options_rowvalue_window_current_next249',
    'option_id',
    $ack,
    $chunkSize,
);
...
$cases249 = [
    ...
    'invalid chunk rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeChunkedYieldResumeWindow($tables249, [$yieldUpdate249], [$attemptUpdate249], [$retryUpdate249], $unique249, 'wp_options_rowvalue_window_current_next249', 'option_id', null, 0), InvalidArgumentException::class],
