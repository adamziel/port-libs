...
$cases253 = [
    ...
    'invalid chunk rejected by base' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeChunkCursorReleaseWindow($tables253, [$yieldUpdate253], [$attemptUpdate253], [$retryUpdate253], $unique253, 'wp_options_rowvalue_window_current_next253', 'option_id', null, 0), InvalidArgumentException::class],
