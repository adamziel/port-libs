...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext234Plan;
...
$plan = static fn (
    ...
    ?int $user = null,
    ?int $app = null,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext234Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
