...
$cases = [
    ...
    'current LIKE range is nocase prefix' => [$statement(), $statement(source: 'main.app_settings@cookie11'), 'current.range.lowerInclusive', 'plugin'],
    'next LIKE range has same prefix upper bound' => [$statement(), $statement(source: 'main.app_settings@cookie11'), 'next.range.upperBound', 'plugio'],
    ...
    'current bytes expose utf16 percent row' => [$statement('plugin\_100\%%', escape: '\\'), $statement('plugin\_100\%%', escape: '\\', source: 'main.app_settings@cookie11'), 'current.bytesHex.4', '70006c007500670069006e005f0031003000300025005f0065006e00610062006c0065006400'],
    'next bytes expose utf16be percent row' => [$statement('plugin\_100\%%', escape: '\\'), $statement('plugin\_100\%%', escape: '\\', source: 'main.app_settings@cookie11'), 'next.bytesHex.4', '0070006c007500670069006e005f0031003000300025005f0065006e00610062006c00650064'],
    'escaped percent rowset is retained' => [$statement('plugin\_100\%%', escape: '\\'), $statement('plugin\_100\%%', escape: '\\', source: 'main.app_settings@cookie11'), 'retainedRowids', [4]],
    'escaped percent has no entered rows' => [$statement('plugin\_100\%%', escape: '\\'), $statement('plugin\_100\%%', escape: '\\', source: 'main.app_settings@cookie11'), 'enteredRowids', []],
    'escaped percent still invalidates on source' => [$statement('plugin\_100\%%', escape: '\\'), $statement('plugin\_100\%%', escape: '\\', source: 'main.app_settings@cookie11'), 'reprepareReasons.0', 'source-name'],
