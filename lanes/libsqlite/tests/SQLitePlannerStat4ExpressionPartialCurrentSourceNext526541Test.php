...
$plan526541 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext526541(
    $prepared526541(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next526541 cursor appended' => static fn (TestRunner $t) => $t->same('PrepareStat4ExpressionPartialNext526541Handoff', $plan526541()['cursorProgram'][array_key_last($plan526541()['cursorProgram'])]['opcode']),
    'planner stat4 expression partial current source next526541 cursor mode' => static fn (TestRunner $t) => $t->same('next526-541-current-source-stat4-expression-partial-prep', $plan526541()['cursorProgram'][array_key_last($plan526541()['cursorProgram'])]['mode']),
    ...
    'planner stat4 expression partial current source next526541 malformed needed column' => static function (TestRunner $t) use ($prepared526541, $current526541, $terms526541): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext526541($prepared526541(), $current526541(), $terms526541(), ['option_name', ''], 6));
    },
];
