...
$plan253 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan {
    global $database253;

    $database = $database253();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafFromDeleteResultNext253(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases253 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan253()->applySummary()['non_overlap'], 'does not repeat next249'),
...
$expected253 = [
    ...
    'dependency closure' => 'no new support component needed; next253 reuses next249 next-source rows and records grouped vacuum apply ordering only',
    'non overlap' => true,
