...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext210Plan;
...
$plan = static fn (
    ...
    ?array $headers = null,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext210Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
