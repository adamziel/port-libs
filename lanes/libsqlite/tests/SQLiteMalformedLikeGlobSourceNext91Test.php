...
$plan = static fn (
    ...
    string $currentSource = 'main.app_settings@cookie88',
    string $nextSource = 'main.app_settings@cookie91',
    ?array $current = null,
    ?array $next = null,
...
$cases = [
    ...
    'records current source' => ['currentSource', 'main.app_settings@cookie88'],
    'records next source' => ['nextSource', 'main.app_settings@cookie91'],
