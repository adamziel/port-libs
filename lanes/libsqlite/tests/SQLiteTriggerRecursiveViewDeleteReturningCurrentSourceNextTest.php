...
$returning168 = [
    ...
    ['expr' => 'old.parent_name', 'as' => 'parent'],
...
$run168 = static fn (array $options = [], ?array $currentRoots = null, ?array $nextRoots = null, ?array $currentView = null, ?array $nextView = null, ?array $returning = null): array => SQLiteTriggerRecursiveViewDeleteReturningCurrentSourceNextPlan::execute(
    ...
    $options + ['savepoint' => 'wp_recursive_view_delete_168'],
);
...
$cases168 = [
    ...
    'rolled savepoint' => [static fn (): mixed => $rolled168()['savepoint'], 'wp_recursive_view_delete_168'],
    ...
    'rolled drained returning before blocker' => [static fn (): mixed => array_column(array_column($rolled168()['current_returning_rows'], 'returning'), 'option_name'), ['plugin_root', 'plugin_child_a']],
    ...
    'rolled blocked key' => [static fn (): mixed => $rolled168()['current_blocked_rows'][0]['returning']['option_name'], 'plugin_child_b'],
    ...
    'rolled rows restored' => [static fn (): mixed => array_column($rolled168()['after_current_savepoint'], 'option_name'), array_column($rows168, 'option_name')],
    'rolled next attempted from restored image' => [static fn (): mixed => array_column(array_column($rolled168()['attempted_next_returning_rows'], 'returning'), 'option_name'), ['plugin_next_root', 'plugin_next_child']],
    ...
    'released rows remain' => [static fn (): mixed => array_column($released168()['after_current_savepoint'], 'option_name'), ['siteurl', 'plugin_next_root', 'plugin_next_child']],
    ...
    'admitted next names' => [static fn (): mixed => array_column(array_column($admitted168()['next_returning_rows'], 'returning'), 'option_name'), ['plugin_next_root', 'plugin_next_child']],
    ...
    'admitted final rows' => [static fn (): mixed => array_column($admitted168()['after_savepoint'], 'option_name'), ['siteurl']],
    ...
    'nonrecursive keeps children' => [static fn (): mixed => array_column($nonRecursive168()['after_current_savepoint'], 'option_name'), ['plugin_child_a', 'plugin_child_b', 'plugin_grandchild', 'siteurl', 'plugin_next_root', 'plugin_next_child']],
    ...
    'custom savepoint accepted' => [static fn (): mixed => $run168(['savepoint' => 'wp_custom_delete_168'])['savepoint'], 'wp_custom_delete_168'],
