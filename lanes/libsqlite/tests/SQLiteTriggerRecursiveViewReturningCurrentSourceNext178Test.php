...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext178Plan;
...
$plan178 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext178Plan::execute(
    $rows178,
    $currentInput178,
    $nextInput178,
    $currentView178,
