...
$partial124 = static fn (): array => SQLiteJsonTablePlan::currentSourceConstraintOrderByCostNext124(
    'json_tree',
    $current124,
    $next124,
    'option_value',
...
$complete124 = static fn (): array => SQLiteJsonTablePlan::currentSourceConstraintOrderByCostNext124(
    'json_tree',
    $current124,
    $current124,
    'option_value',
...
$fullSort124 = static fn (): array => SQLiteJsonTablePlan::currentSourceConstraintOrderByCostNext124(
    'json_tree',
    $current124,
    $current124,
    'option_value',
...
$singleRow124 = static fn (): array => SQLiteJsonTablePlan::currentSourceConstraintOrderByCostNext124(
    'json_tree',
    $current124,
    $current124,
    'option_value',
...
$unrunnable124 = static fn (): array => SQLiteJsonTablePlan::currentSourceConstraintOrderByCostNext124(
    'json_tree',
    $current124,
...
$tests = [
    ...
    'bad order direction is rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceConstraintOrderByCostNext124('json_tree', $current124, $next124, 'option_value', $priorityConstraints124, 'scan_root', [['column' => 'key', 'direction' => 'SIDEWAYS']])),
];
