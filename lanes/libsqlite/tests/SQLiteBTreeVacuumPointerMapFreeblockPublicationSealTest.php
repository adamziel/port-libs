...
$plan227 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $database227;

    $database = $database227();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafSealAuditFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases227 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan227()->sealSummary()['non_overlap'], 'does not repeat readback'),
...
$expected227 = [
    ...
    'dependency closure' => 'no new support component needed; publication-seal reuses readback readback rows, duplicate pointer-map rewrite receipts, leaf freeblock receipts, and fenced-tail guards',
    'non overlap' => true,
