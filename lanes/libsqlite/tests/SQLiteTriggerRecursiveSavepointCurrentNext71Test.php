...
use PortLibs\LibSqlite\SQLiteRecursiveTriggerSavepointCurrentNext71Plan;
...
$run = static fn (
    ...
    array $nextOptions = []
): array => SQLiteRecursiveTriggerSavepointCurrentNext71Plan::retryAfterRollback(
    'wp_import_sp',
    $savepointRows,
    $current ?? $currentRows,
...
$cases = [
    ...
    'bad savepoint throws' => [static fn (): mixed => SQLiteRecursiveTriggerSavepointCurrentNext71Plan::retryAfterRollback('bad-name', $savepointRows, $currentRows, $conflictingTrigger, $nextRows, $recursiveTrigger, ['option_name'], $returning), InvalidArgumentException::class],
    'empty current rows throws' => [static fn (): mixed => SQLiteRecursiveTriggerSavepointCurrentNext71Plan::retryAfterRollback('ok_name', $savepointRows, [], $conflictingTrigger, $nextRows, $recursiveTrigger, ['option_name'], $returning), InvalidArgumentException::class],
    'empty next rows throws' => [static fn (): mixed => SQLiteRecursiveTriggerSavepointCurrentNext71Plan::retryAfterRollback('ok_name', $savepointRows, $currentRows, $conflictingTrigger, [], $recursiveTrigger, ['option_name'], $returning), InvalidArgumentException::class],
    'bad unique column throws through recursive plan' => [static fn (): mixed => SQLiteRecursiveTriggerSavepointCurrentNext71Plan::retryAfterRollback('ok_name', $savepointRows, $currentRows, $conflictingTrigger, $nextRows, $recursiveTrigger, ['bad-column'], $returning), InvalidArgumentException::class],
    'bad trigger operator throws through recursive plan' => [static function () use ($savepointRows, $currentRows, $nextRows, $recursiveTrigger, $returning, $conflictingTrigger): mixed {
        ...
        return SQLiteRecursiveTriggerSavepointCurrentNext71Plan::retryAfterRollback('ok_name', $savepointRows, $currentRows, $bad, $nextRows, $recursiveTrigger, ['option_name'], $returning);
