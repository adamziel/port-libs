...
$current180 = [
    'option_id' => 180,
    'option_name' => 'wp_plugin_generated_path_rowid_cost_current_source_next180',
...
$plan180 = static fn (
    ...
    ?array $orderBy = null,
): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext180(
    'json_tree',
    $current ?? $current180,
    $next ?? $next180,
    'option_value',
...
$tests = [
    ...
    'bad function rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext180('json_bad', $current180, $next180, 'option_value', 'generated_path')),
    'dependency scenario has no new support component' => static fn (TestRunner $t) => $t->same('no-new-support-component', 'no-new-support-component'),
];

foreach ($tests as $name => $case) {
    $tests['json table generated path rowid cost current source next180 ' . $name] = $case;
    unset($tests[$name]);
}
