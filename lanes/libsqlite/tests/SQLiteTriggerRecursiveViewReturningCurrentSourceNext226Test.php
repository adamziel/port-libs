...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext226Plan;
...
$plan226 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext226Plan::execute(
    $rows226,
    $currentInput226,
    $nextInput226,
    $currentView226,
