...
$plan226 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNextPlan::executeFollowingCurrentSeal(
    ...
    $options + [
        ...
        'following_current_seal_token_next226' => 'app.following.current.seal.226',
        'following_current_seal_cursor_next226' => 'app.returning.following.current.cursor.226',
        'subsequent_next_source_token_next226' => 'app.subsequent.next.source.226',
...
$badCursor226 = static fn (): array => $plan226(['auto_ack_following_current_seal_next226' => true, 'expected_following_current_seal_cursor_next226' => 'app.returning.following.current.cursor.other.226']);
$badToken226 = static fn (): array => $plan226(['auto_ack_following_current_seal_next226' => true, 'expected_subsequent_next_source_token_next226' => 'app.subsequent.next.source.other.226']);
$custom226 = static fn (): array => $plan226(['auto_ack_following_current_seal_next226' => true, 'following_current_seal_token_next226' => 'app.following.current.seal.custom.226']);
...
$cases226 = [
    ...
    'savepoint retained' => [static fn (): mixed => $released226()['savepoint'], 'app_recursive_view_226'],
    'seal token retained' => [static fn (): mixed => $released226()['following_current_seal_token_next226'], 'app.following.current.seal.226'],
    'custom seal token retained' => [static fn (): mixed => $custom226()['following_current_seal_token_next226'], 'app.following.current.seal.custom.226'],
    'seal cursor retained' => [static fn (): mixed => $released226()['following_current_seal_cursor_next226'], 'app.returning.following.current.cursor.226'],
    'expected seal cursor retained' => [static fn (): mixed => $released226()['expected_following_current_seal_cursor_next226'], 'app.returning.following.current.cursor.226'],
    ...
    'subsequent token retained' => [static fn (): mixed => $released226()['subsequent_next_source_token_next226'], 'app.subsequent.next.source.226'],
    ...
    'following seal token tagged' => [static fn (): mixed => array_values(array_unique(array_column($released226()['following_current_rows_next226'], 'following_current_seal_token_next226'))), ['app.following.current.seal.226']],
    'following seal cursor tagged' => [static fn (): mixed => array_values(array_unique(array_column($released226()['following_current_rows_next226'], 'following_current_seal_cursor_next226'))), ['app.returning.following.current.cursor.226']],
    ...
    'subsequent token stamped' => [static fn (): mixed => array_values(array_unique(array_column($released226()['subsequent_next_rows_next226'], 'subsequent_next_source_token_next226'))), ['app.subsequent.next.source.226']],
    'subsequent seal token stamped' => [static fn (): mixed => array_values(array_unique(array_column($released226()['subsequent_next_rows_next226'], 'following_current_seal_token_next226'))), ['app.following.current.seal.226']],
    'subsequent seal cursor stamped' => [static fn (): mixed => array_values(array_unique(array_column($released226()['subsequent_next_rows_next226'], 'following_current_seal_cursor_next226'))), ['app.returning.following.current.cursor.226']],
    ...
    'visible payload names released' => [static fn (): mixed => array_column($released226()['visible_returning_payloads_next226'], 'name'), ['app_summary_child', 'template_child', 'landing_url', 'next_module', 'active_modules', 'routing_rules', 'theme_mods_modern_theme', 'cron', 'widget_block']],
    'visible payload names held' => [static fn (): mixed => array_column($missing226()['visible_returning_payloads_next226'], 'name'), ['app_summary_child', 'template_child', 'landing_url', 'next_module', 'active_modules', 'routing_rules', 'theme_mods_modern_theme']],
