...
$constantKey120 = static fn (): array => SQLiteJsonTablePlan::currentSourceOrderByConstraint(
    'json_tree',
    $current120,
    $next120,
    'option_value',
...
$singleInType120 = static fn (): array => SQLiteJsonTablePlan::currentSourceOrderByConstraint(
    'json_each',
    $current120,
    $next120,
    'option_value',
...
$betweenId120 = static fn (): array => SQLiteJsonTablePlan::currentSourceOrderByConstraint(
    'json_tree',
    $current120,
    $next120,
    'option_value',
...
$notConsumed120 = static fn (): array => SQLiteJsonTablePlan::currentSourceOrderByConstraint(
    'json_tree',
    $current120,
    $next120,
    'option_value',
