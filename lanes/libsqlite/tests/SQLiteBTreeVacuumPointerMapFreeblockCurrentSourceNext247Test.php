...
$plan247 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $database247;

    $database = $database247();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafCheckpointFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases247 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan247()->checkpointSummary()['non_overlap'], 'does not repeat publish-ordering'),
...
$expected247 = [
    ...
    'dependency closure' => 'no new support component needed; next247 reuses publish-ordering cursor rows and adds checkpoint admission for pointer-map/freeblock visibility',
    'non overlap' => true,
    'publish action' => 'btree-vacuum-pointermap-freeblock-publish-ordering',
    'publish row count' => 7,
