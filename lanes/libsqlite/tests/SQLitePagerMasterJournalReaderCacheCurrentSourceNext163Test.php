...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::planMasterJournalMemberDigestRefreshFence(
    $database,
    $master,
    $cached ?? $cachedBytes,
...
$throws = [
    'rejects empty database path' => static fn () => SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::planMasterJournalMemberDigestRefreshFence('', $master, $cachedBytes, $currentBytes, $pageSize, $currentPages, $nextPages, $cache, $readPages, $currentSourceId, $nextSourceId, $currentEpoch, $nextEpoch),
    'rejects empty master path' => static fn () => SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::planMasterJournalMemberDigestRefreshFence($database, '', $cachedBytes, $currentBytes, $pageSize, $currentPages, $nextPages, $cache, $readPages, $currentSourceId, $nextSourceId, $currentEpoch, $nextEpoch),
    ...
    'rejects bad page size' => static fn () => SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan::planMasterJournalMemberDigestRefreshFence($database, $master, $cachedBytes, $currentBytes, 0, $currentPages, $nextPages, $cache, $readPages, $currentSourceId, $nextSourceId, $currentEpoch, $nextEpoch),
