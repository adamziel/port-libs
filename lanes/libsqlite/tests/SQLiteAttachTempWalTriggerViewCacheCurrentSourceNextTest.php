...
$cases97 = [
    ...
    'operation marker' => ['operation', 'attach-temp-wal-trigger-view-cache-reprepare'],
    ...
    'dependency marker first' => ['dependencies.0', 'sqlite-attach-temp-wal-trigger-view-cache-reprepare'],
    'dependency trigger current source' => ['dependencies.1', 'sqlite-attach-temp-wal-schema-trigger-source-reprepare'],
