...
$tests['json table generated path rowid cost current source next824 has no next825 alias yet'] = static function (TestRunner $t) use ($plan809824): void {
    $t->throws(Error::class, static fn () => $plan809824(825));
};
