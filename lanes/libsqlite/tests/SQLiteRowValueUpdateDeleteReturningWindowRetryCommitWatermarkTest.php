...
$plan256 = static fn (?array $yieldAck = null, ?array $chunkAck = null, ?array $commitAck = null, int $chunkSize = 2): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeRetryCommitWatermark(
    $tables256,
...
$cases256 = [
    ...
    'wordpress marker' => [static fn (): mixed => in_array('wordpress-rowvalue-returning-window-retry-commit-watermark', $plan256()['dependencies_next256'], true), true],
    ...
    'invalid chunk rejected by base' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeRetryCommitWatermark($tables256, [$yieldUpdate256], [$attemptUpdate256], [$retryUpdate256], $unique256, 'wp_options_rowvalue_window_current_next256', 'option_id', null, 0), InvalidArgumentException::class],
    'malformed empty yield rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeRetryCommitWatermark($tables256, [], [$attemptUpdate256], [$retryUpdate256], $unique256), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeRetryCommitWatermark($tables256, [$yieldUpdate256], [], [$retryUpdate256], $unique256), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeRetryCommitWatermark($tables256, [$yieldUpdate256], [$attemptUpdate256], [], $unique256), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan::executeRetryCommitWatermark($tables256, [$yieldUpdate256], [$attemptUpdate256], [$retryUpdate256], $unique256, 'bad-name'), InvalidArgumentException::class],
];
