...
$page132 = static fn (
    ...
    ?array $cursor = null,
): array => SQLitePragmaQuickcheckForeignKeyRootpageCurrentSourceNext132::page(
    $catalog ?? $catalog132(),
...
$tests['pragma quickcheck foreignkey rootpage current source next132 rejects integrity check sql'] = static function (TestRunner $t) use ($catalog132, $dirtyDatabase132, $schemas132): void {
    $t->throws(InvalidArgumentException::class, static fn (): mixed => SQLitePragmaQuickcheckForeignKeyRootpageCurrentSourceNext132::page($catalog132(), 'PRAGMA index_xinfo(wp_options_value_expr)', $dirtyDatabase132, $schemas132(), 'PRAGMA foreign_key_check', 0, 132, 'PRAGMA integrity_check'));
};
...
$tests['pragma quickcheck foreignkey rootpage current source next132 rejects negative offset'] = static function (TestRunner $t) use ($catalog132, $dirtyDatabase132, $schemas132): void {
    $t->throws(InvalidArgumentException::class, static fn (): mixed => SQLitePragmaQuickcheckForeignKeyRootpageCurrentSourceNext132::page($catalog132(), 'PRAGMA index_xinfo(wp_options_value_expr)', $dirtyDatabase132, $schemas132(), 'PRAGMA foreign_key_check', -1));
};
...
$tests['pragma quickcheck foreignkey rootpage current source next132 rejects zero limit'] = static function (TestRunner $t) use ($catalog132, $dirtyDatabase132, $schemas132): void {
    $t->throws(InvalidArgumentException::class, static fn (): mixed => SQLitePragmaQuickcheckForeignKeyRootpageCurrentSourceNext132::page($catalog132(), 'PRAGMA index_xinfo(wp_options_value_expr)', $dirtyDatabase132, $schemas132(), 'PRAGMA foreign_key_check', 0, 0));
};
