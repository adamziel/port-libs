...
$plan243 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext243Plan::execute(
    $tables243,
...
$customPlan243 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext243Plan::execute(
    $tables243,
    [$yieldUpdate243],
    [$attemptUpdate243],
    [$retryUpdate243],
...
$cases243 = [
    ...
    'malformed empty yield rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext243Plan::execute($tables243, [], [$attemptUpdate243], [$retryUpdate243], $unique243), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext243Plan::execute($tables243, [$yieldUpdate243], [], [$retryUpdate243], $unique243), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext243Plan::execute($tables243, [$yieldUpdate243], [$attemptUpdate243], [], $unique243), InvalidArgumentException::class],
    'malformed rowid rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext243Plan::execute($tables243, [$yieldUpdate243], [$attemptUpdate243], [$retryUpdate243], $unique243, 'sp243', 'missing_rowid'), InvalidArgumentException::class],
];
