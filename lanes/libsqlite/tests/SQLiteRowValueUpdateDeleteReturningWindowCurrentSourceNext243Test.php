...
$cases243 = [
    ...
    'plan savepoint' => [static fn (): mixed => $plan243()['savepoint'], 'app_settings_rowvalue_window_current_next243'],
    ...
    'release savepoint' => [static fn (): mixed => $plan243()['retry_tuple_release_boundary_next243']['savepoint'], 'app_settings_rowvalue_window_current_next243'],
