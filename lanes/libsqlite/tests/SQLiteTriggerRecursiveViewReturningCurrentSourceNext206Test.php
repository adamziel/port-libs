...
$plan206 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNextPlan::executeYieldWatermarkFence(
    ...
    $options + [
        'key' => 'key_name',
        'savepoint' => 'app_recursive_view_206',
        'cursor_name' => 'app_recursive_view_returning_cursor_206',
        'current_generation' => 'app-current-returning-206',
        'next_generation' => 'app-next-returning-206',
        'page_size' => 3,
        'admit_next_source' => true,
        'current_source_token' => 'app.current.source.206',
        'drain_ack_token' => 'app.returning.drain.206',
        'rollback_token' => 'app.rollback.current.206',
        'reset_generation' => 'app-current-reset-206',
        'post_reset_current_source_token' => 'app.current.source.postreset.206',
        'post_reset_cursor' => 'app.returning.postreset.cursor.206',
        'post_reset_view' => $postResetView206,
        'post_reset_input' => $postResetInput206,
        'fresh_acknowledged_ordinals' => [0, 1],
        'next_source_token' => 'app.next.source.206',
        'next_cursor' => 'app.returning.next.cursor.206',
        'next_acknowledged_ordinals' => [0, 1],
        'close_next_cursor' => 'app.returning.next.cursor.206',
        'following_current_source_token' => 'app.current.source.following.206',
        'following_cursor' => 'app.returning.following.cursor.206',
        'following_current_view' => $followingView206,
        'following_current_input' => $followingInput206,
        'following_generation' => 'app-following-current-206',
        'recursive_child_acknowledged_ordinals' => [0, 1],
        'recursive_child_source_token' => 'app.current.source.recursive.child.206',
        'recursive_child_cursor' => 'app.returning.recursive.child.cursor.206',
        'recursive_child_generation' => 'app-recursive-child-current-206',
        'current_generation_next203' => 'app.current.recursive.returning.generation.206',
        'expected_current_generation_next203' => 'app.current.recursive.returning.generation.206',
        'current_handoff_cursor_next203' => 'app.returning.current.handoff.cursor.206',
        'current_generation_commit_marker_next203' => 'app.current.recursive.returning.commit.206',
        'auto_ack_current_generation_receipts_next203' => true,
        'yield_current_source_token_next206' => 'app.current.recursive.returning.source.206',
        'yield_current_cursor_next206' => 'app.returning.current.cursor.206',
        'yield_statement_token_next206' => 'app.recursive.view.returning.statement.206',
    ],
);
...
$custom206 = static fn (): array => $plan206([
    'yield_current_source_token_next206' => 'app.current.recursive.returning.source.custom.206',
    'yield_current_cursor_next206' => 'app.returning.current.cursor.custom.206',
    'yield_statement_token_next206' => 'app.recursive.view.returning.statement.custom.206',
]);
...
$cases206 = [
    ...
    'savepoint retained' => [static fn (): mixed => $released206()['savepoint'], 'app_recursive_view_206'],
    ...
    'source token retained' => [static fn (): mixed => $released206()['yield_current_source_token_next206'], 'app.current.recursive.returning.source.206'],
    'cursor retained' => [static fn (): mixed => $released206()['yield_current_cursor_next206'], 'app.returning.current.cursor.206'],
    'statement retained' => [static fn (): mixed => $released206()['yield_statement_token_next206'], 'app.recursive.view.returning.statement.206'],
    'custom source token retained' => [static fn (): mixed => $custom206()['yield_current_source_token_next206'], 'app.current.recursive.returning.source.custom.206'],
    'custom cursor retained' => [static fn (): mixed => $custom206()['yield_current_cursor_next206'], 'app.returning.current.cursor.custom.206'],
    'custom statement retained' => [static fn (): mixed => $custom206()['yield_statement_token_next206'], 'app.recursive.view.returning.statement.custom.206'],
    ...
    'visible payload names released' => [static fn (): mixed => array_column($released206()['visible_returning_payloads_next206'], 'name'), ['app_summary_child', 'template_child', 'landing_url', 'next_module']],
    'visible payload names held current only' => [static fn (): mixed => array_column($staleWatermark206()['visible_returning_payloads_next206'], 'name'), ['app_summary_child', 'template_child']],
    'held payload names' => [static fn (): mixed => array_column($staleWatermark206()['held_next_returning_payloads_next206'], 'name'), ['landing_url', 'next_module']],
