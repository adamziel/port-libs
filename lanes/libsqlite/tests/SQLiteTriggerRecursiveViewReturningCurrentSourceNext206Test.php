...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext206Plan;
...
$plan206 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext206Plan::execute(
    $rows206,
    $currentInput206,
    $nextInput206,
    $currentView206,
