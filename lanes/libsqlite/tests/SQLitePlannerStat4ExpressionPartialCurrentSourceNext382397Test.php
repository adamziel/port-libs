...
$plan382397 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext382397(
    $prepared382397(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next382397 malformed needed column' => static function (TestRunner $t) use ($prepared382397, $current382397, $terms382397): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext382397($prepared382397(), $current382397(), $terms382397(), ['option_name', ''], 6));
    },
];
