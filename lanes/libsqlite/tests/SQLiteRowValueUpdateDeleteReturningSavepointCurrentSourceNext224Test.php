...
$plan224 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization(
    $tables224,
...
$customPlan224 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization(
    $tables224,
    [$innerUpdate224],
    [$outerUpdate224],
    [$retryUpdate224],
...
$cases224 = [
    ...
    'malformed empty inner rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization($tables224, [], [$outerUpdate224], [$retryUpdate224], $unique224), InvalidArgumentException::class],
    'malformed empty outer rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization($tables224, [$innerUpdate224], [], [$retryUpdate224], $unique224), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization($tables224, [$innerUpdate224], [$outerUpdate224], [], $unique224), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization($tables224, [$innerUpdate224], [$outerUpdate224], [$retryUpdate224], []), InvalidArgumentException::class],
    'malformed outer savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization($tables224, [$innerUpdate224], [$outerUpdate224], [$retryUpdate224], $unique224, 'bad-name'), InvalidArgumentException::class],
    'malformed inner savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization($tables224, [$innerUpdate224], [$outerUpdate224], [$retryUpdate224], $unique224, 'outer_good', 'bad-name'), InvalidArgumentException::class],
    'malformed same savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization($tables224, [$innerUpdate224], [$outerUpdate224], [$retryUpdate224], $unique224, 'same224', 'same224'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedSavepointMaterialization(['wp_options' => ['bad']], [$innerUpdate224], [$outerUpdate224], [$retryUpdate224], $unique224), InvalidArgumentException::class],
];
