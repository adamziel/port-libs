...
$plan = static fn (?array $readerCache = null, ?array $nextReads = null, ?string $receiptToken = null): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext254Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
