...
use PortLibs\LibSqlite\SQLitePagerHotJournalStatementCacheCurrentSourceNext104Plan;
...
$plan = static fn (
    ...
    int $epoch = 11,
): array => SQLitePagerHotJournalStatementCacheCurrentSourceNext104Plan::plan(
    $size ?? $pageSize,
    $current,
    $recovered,
    $epoch,
