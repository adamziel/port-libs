...
$cases = [
    ...
    'dependency names network JSON WAL slice' => [static fn (): mixed => in_array('sqlite-wordpress-network-json-wal-savepoint-current-next47', $plan()['dependencies'], true), true],
    'dependency names JSON WAL import planner' => [static fn (): mixed => in_array('sqlite-wordpress-json-import-wal-savepoint-current-next35', $plan()['dependencies'], true), true],
