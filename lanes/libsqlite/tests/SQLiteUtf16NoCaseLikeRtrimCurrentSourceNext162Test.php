...
$plan = static function (
    ...
    return SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::keyValueRowKeyNormalizedPatternPlan(
...
$tests['utf16 nocase like rtrim current source nextOneSixTwo malformed pattern bytes throw before planning'] = static function (TestRunner $t) use ($stableRows): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteUtf16NocaseLikeRtrimCurrentSourceNextPlan::keyValueRowKeyNormalizedPatternPlan(
        $stableRows,
        $stableRows,
        "p\0x",
        2,
