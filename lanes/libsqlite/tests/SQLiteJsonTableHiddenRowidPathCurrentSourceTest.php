...
$tests = [
    ...
    'current source token carries option id' => static fn (TestRunner $t) => $t->same(146, $hiddenRowidPathPlan()['currentHiddenRowidPathSource']['sourceToken']['option_id']),
    'current source token carries option name' => static fn (TestRunner $t) => $t->same('wp_plugin_hidden_rowid_path', $hiddenRowidPathPlan()['currentHiddenRowidPathSource']['sourceToken']['option_name']),
