...
$sqlCases = [
    ...
    'cast integer shift comparison' => ["SELECT option_id AS id, option_name FROM wp_options WHERE 1 << CAST(bucket AS INTEGER) >= 4 ORDER BY option_id", ['siteurl', 'home', 'blogname', 'active_plugins']],
    ...
    'cast integer hidden order column with limit' => ["SELECT option_id AS id, option_name FROM wp_options ORDER BY CAST(bucket AS INTEGER) DESC, option_id LIMIT 3", ['active_plugins', 'blogname', 'siteurl']],
