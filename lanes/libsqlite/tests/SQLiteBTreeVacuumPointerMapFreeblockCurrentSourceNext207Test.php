...
$plan207 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $database207;

    $database = $database207();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafPageSealFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases207 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan207()->writerWindowSummary()['non_overlap'], 'does not repeat sealed-writer-admission'),
...
$expected207 = [
    ...
    'dependency closure' => 'no new support component needed; next207 reuses sealed-writer-admission sealed pointer-map and payload/freeblock rows to admit a deterministic writer window',
    'non overlap' => true,
