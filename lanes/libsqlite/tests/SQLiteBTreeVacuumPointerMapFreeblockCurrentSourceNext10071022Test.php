...
foreach (range(1007, 1022) as $sliceNumber) {
    $tests["btree vacuum pointermap freeblock current source next{$sliceNumber} extends next1007-1022 handoff receipts"] = static function (TestRunner $t) use ($plan10071022, $sliceNumber): void {
