...
$plan210 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
    global $database210;

    $database = $database210();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan::tableLeafApplyPageFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases210 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan210()->applySummary()['non_overlap'], 'does not repeat writer-source-latch'),
...
$expected210 = [
    ...
    'dependency closure' => 'no new support component needed; next210 reuses writer-source-latch writer-source rows, pointer-map ordering, leaf freeblock receipts, and fenced-tail metadata',
    'non overlap' => true,
