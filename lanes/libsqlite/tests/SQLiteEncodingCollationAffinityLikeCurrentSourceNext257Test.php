...
$plan257 = static fn (
    ...
    int $nextCookie = 257,
): array => SQLiteEncodingCollationAffinityLikeCurrentSourceNextPlan::keyValueRowKeyNumericAffinityLikePlan(
    $current ?? $current257,
...
$cases257 = [
    ...
    'current source' => ['currentSource', 'main.app_settings@256'],
    'next source' => ['nextSource', 'main.app_settings@257'],
...
$tests['encoding collation affinity like current source nextTwoFiveSeven stable numeric cursor is reusable'] = static function (TestRunner $t) use ($numeric257, $text257): void {
    ...
    $result = SQLiteEncodingCollationAffinityLikeCurrentSourceNextPlan::keyValueRowKeyNumericAffinityLikePlan($rows, $rows, '2024%', null, 'stable', 'stable', 9, 9);
...
$tests['encoding collation affinity like current source nextTwoFiveSeven escaped underscore keeps numeric prefix'] = static function (TestRunner $t) use ($text257, $numeric257): void {
    ...
    $result = SQLiteEncodingCollationAffinityLikeCurrentSourceNextPlan::keyValueRowKeyNumericAffinityLikePlan($rows, $rows, '2024!_%', '!', 'stable', 'stable', 9, 9);
...
$tests['encoding collation affinity like current source nextTwoFiveSeven non ascii prefix disables nocase range'] = static function (TestRunner $t) use ($text257): void {
    ...
    $result = SQLiteEncodingCollationAffinityLikeCurrentSourceNextPlan::keyValueRowKeyNumericAffinityLikePlan($rows, $rows, 'é%', null, 'stable', 'stable', 9, 9);
