...
$plan = static fn (?string $master = null, array $pages = null, string $journalMode = 'delete', bool $synced = true): array => SQLitePagerMasterJournalCacheSpillSavepointCurrentSourceNext114Plan::currentSourceNext(
    $masterPath,
...
$walPlan = static fn (): array => SQLitePagerMasterJournalCacheSpillSavepointCurrentSourceNext114Plan::currentSourceNext(
    $masterPath,
    $masterBytes,
    $databases,
    $pageSize,
...
$throws = [
    'empty cache pages rejected' => static fn () => SQLitePagerMasterJournalCacheSpillSavepointCurrentSourceNext114Plan::currentSourceNext($masterPath, $masterBytes, $databases, $pageSize, $mainPath, 'plugin-settings', $makeStack(), $retryWrites, [], 4, 2),
    ...
    'unknown savepoint rejected' => static fn () => SQLitePagerMasterJournalCacheSpillSavepointCurrentSourceNext114Plan::currentSourceNext($masterPath, $masterBytes, $databases, $pageSize, $mainPath, 'missing', $makeStack(), $retryWrites, $cachePages, 4, 2),
