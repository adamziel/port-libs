...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext226Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext226Plan::plan(
    $database,
    $master,
    $masterBytes,
    $databaseBytes,
