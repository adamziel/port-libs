...
$plan230 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint(
    $tables230,
    [$preSql230],
...
$customPlan230 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint(
    $tables230,
    [$preSql230],
    [$innerUpdateSql230],
    [$afterReleaseDeleteSql230],
...
$cases230 = [
    ...
    'malformed empty inner rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint($tables230, [$preSql230], [], [$afterReleaseDeleteSql230], [$retryUpdateSql230], $unique230), InvalidArgumentException::class],
    'malformed empty after release rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint($tables230, [$preSql230], [$innerUpdateSql230], [], [$retryUpdateSql230], $unique230), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint($tables230, [$preSql230], [$innerUpdateSql230], [$afterReleaseDeleteSql230], [], $unique230), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint($tables230, [$preSql230], [$innerUpdateSql230], [$afterReleaseDeleteSql230], [$retryUpdateSql230], []), InvalidArgumentException::class],
    'malformed outer savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint($tables230, [$preSql230], [$innerUpdateSql230], [$afterReleaseDeleteSql230], [$retryUpdateSql230], $unique230, 'bad-name', 'good_inner'), InvalidArgumentException::class],
    'malformed inner savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint($tables230, [$preSql230], [$innerUpdateSql230], [$afterReleaseDeleteSql230], [$retryUpdateSql230], $unique230, 'good_outer', 'bad-name'), InvalidArgumentException::class],
    'malformed duplicate savepoint names rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint($tables230, [$preSql230], [$innerUpdateSql230], [$afterReleaseDeleteSql230], [$retryUpdateSql230], $unique230, 'same_name', 'same_name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeNestedReleaseOuterRollbackSavepoint(['wp_options' => ['bad']], [$preSql230], [$innerUpdateSql230], [$afterReleaseDeleteSql230], [$retryUpdateSql230], $unique230), InvalidArgumentException::class],
];
