...
use PortLibs\LibSqlite\SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext228Plan;
...
$plan228 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext228Plan {
    global $database228;

    $database = $database228();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext228Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
...
$cases228 = [
    ...
    'non overlap' => static fn (): mixed => str_contains($plan228()->drainSummary()['non_overlap'], 'does not repeat next224'),
...
$expected228 = [
    ...
    'dependency closure' => 'no new support component needed; next228 reuses next224 current-source next-page cursor receipts and adds drain/finalization metadata only',
    'non overlap' => true,
    'base action' => 'btree-vacuum-pointermap-freeblock-current-source-next224',
    'base source rows' => 7,
