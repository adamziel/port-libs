...
$priorityOrder135 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenRowidOrderNext135(
    'json_tree',
    $current135,
    $next135,
    'option_value',
...
$stable135 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenRowidOrderNext135(
    'json_tree',
    $current135,
    $current135,
    'option_value',
...
$point135 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenRowidOrderNext135(
    'json_tree',
    $current135,
    $current135,
    'option_value',
...
$oidDesc135 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenRowidOrderNext135(
    'json_tree',
    $current135,
    $current135,
    'option_value',
...
$unrunnable135 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenRowidOrderNext135(
    'json_tree',
    $current135,
...
$tests = [
    ...
    'bad function rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceHiddenRowidOrderNext135('json_bad', $current135, $next135, 'option_value')),
    'bad order direction rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceHiddenRowidOrderNext135('json_tree', $current135, $next135, 'option_value', [], 'scan_root', [['column' => 'rowid', 'direction' => 'SIDEWAYS']])),
    'missing json column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceHiddenRowidOrderNext135('json_tree', ['scan_root' => '$'], $next135, 'option_value')),
