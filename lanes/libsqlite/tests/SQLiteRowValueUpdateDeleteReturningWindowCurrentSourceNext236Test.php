...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext236Plan;
...
$plan236 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext236Plan::execute(
    $tables236,
...
$customPlan236 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext236Plan::execute(
    $tables236,
    [$yieldUpdate236],
    [$attemptUpdate236],
    [$retryUpdate236],
...
$cases236 = [
    ...
    'plan savepoint' => [static fn (): mixed => $plan236()['savepoint'], 'wp_options_rowvalue_window_current_next236'],
    ...
    'receipt savepoint' => [static fn (): mixed => $plan236()['current_source_receipt_next236']['savepoint'], 'wp_options_rowvalue_window_current_next236'],
    ...
    'malformed empty yield rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext236Plan::execute($tables236, [], [$attemptUpdate236], [$retryUpdate236], $unique236), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext236Plan::execute($tables236, [$yieldUpdate236], [], [$retryUpdate236], $unique236), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext236Plan::execute($tables236, [$yieldUpdate236], [$attemptUpdate236], [], $unique236), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext236Plan::execute($tables236, [$yieldUpdate236], [$attemptUpdate236], [$retryUpdate236], $unique236, 'bad-name'), InvalidArgumentException::class],
];
