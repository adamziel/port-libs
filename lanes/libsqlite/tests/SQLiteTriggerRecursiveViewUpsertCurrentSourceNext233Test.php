...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewUpsertCurrentSourceNext233Plan;
...
$plan233 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewUpsertCurrentSourceNext233Plan::execute(
    $rows233,
    $currentInput233,
    $nextInput233,
    $currentView233,
