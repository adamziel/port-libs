...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext219Plan;
...
$plan219 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext219Plan::execute(
    $tables219,
    [$attemptUpdate219, $attemptDelete219],
    [$retryUpdate219, $retryDelete219],
    $unique219,
);
$customPlan219 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext219Plan::execute(
    $tables219,
    [$attemptUpdate219],
    [$retryUpdate219],
    $unique219,
...
$cases219 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext219Plan::execute($tables219, [], [$retryUpdate219], $unique219), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext219Plan::execute($tables219, [$attemptUpdate219], [], $unique219), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext219Plan::execute($tables219, [$attemptUpdate219], [$retryUpdate219], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext219Plan::execute($tables219, [$attemptUpdate219], [$retryUpdate219], $unique219, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext219Plan::execute(['wp_options' => ['bad']], [$attemptUpdate219], [$retryUpdate219], $unique219), InvalidArgumentException::class],
];
