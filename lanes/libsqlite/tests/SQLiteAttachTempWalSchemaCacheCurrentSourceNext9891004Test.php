...
$plan9891004 = static fn (array $events, ?array $statements = null, ?array $schemas = null): array => SQLiteAttachWalTempSchemaCacheCurrentSourceNext92Plan::currentSourceNext9891004(
...
$tests['attach temp wal schema cache current source next989-1004 extends next973-988 handoff'] = static function (TestRunner $t) use ($plan9891004): void {
    ...
    $t->same('sqlite-attach-temp-wal-schema-cache-current-source-next988', $result['dependencies'][31]);
