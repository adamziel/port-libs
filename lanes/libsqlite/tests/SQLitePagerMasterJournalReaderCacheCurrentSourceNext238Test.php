...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext238Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext238Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
