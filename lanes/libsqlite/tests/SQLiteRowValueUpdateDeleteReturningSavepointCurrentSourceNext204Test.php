...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan;
...
$plan204 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute(
    $tables204,
    [$outerSql204],
    [$savepointSql204],
    [$rollbackSql204],
...
$customPlan204 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute(
    $tables204,
    [$outerSql204],
    [$savepointSql204],
    [$rollbackSql204],
...
$cases204 = [
    ...
    'malformed empty outer rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute($tables204, [], [$savepointSql204], [$rollbackSql204], [$retryUpdateSql204], $unique204), InvalidArgumentException::class],
    'malformed empty savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute($tables204, [$outerSql204], [], [$rollbackSql204], [$retryUpdateSql204], $unique204), InvalidArgumentException::class],
    'malformed empty rollback rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute($tables204, [$outerSql204], [$savepointSql204], [], [$retryUpdateSql204], $unique204), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute($tables204, [$outerSql204], [$savepointSql204], [$rollbackSql204], [], $unique204), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute($tables204, [$outerSql204], [$savepointSql204], [$rollbackSql204], [$retryUpdateSql204], []), InvalidArgumentException::class],
    'malformed transaction rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute($tables204, [$outerSql204], [$savepointSql204], [$rollbackSql204], [$retryUpdateSql204], $unique204, 'bad-name'), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute($tables204, [$outerSql204], [$savepointSql204], [$rollbackSql204], [$retryUpdateSql204], $unique204, 'ok_name', 'bad-name'), InvalidArgumentException::class],
    'malformed non rollback statement rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute($tables204, [$outerSql204], [$savepointSql204], [$retryUpdateSql204], [$retryUpdateSql204], $unique204), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext204Plan::execute(['wp_options' => ['bad']], [$outerSql204], [$savepointSql204], [$rollbackSql204], [$retryUpdateSql204], $unique204), InvalidArgumentException::class],
];
