...
use PortLibs\LibSqlite\SQLiteCompoundIntersectWindowRecursiveLimitCurrentSourceNext164Plan;
...
$summary164 = static fn (): array => SQLiteCompoundIntersectWindowRecursiveLimitCurrentSourceNext164Plan::compare($sql164, $currentTables164, $nextTables164);
$tests = [];

$tests['compound intersect window recursive limit next164 status dependencies'] = static function (TestRunner $t) use ($summary164): void {
    $plan = $summary164();
    $t->same('compound-intersect-window-recursive-limit-current-source-next164-ready', $plan['status']);
    $t->same([
...
$tests['compound intersect window recursive limit next164 compound metadata'] = static function (TestRunner $t) use ($summary164): void {
...
$tests['compound intersect window recursive limit next164 current rows'] = static function (TestRunner $t) use ($summary164): void {
...
$tests['compound intersect window recursive limit next164 next rows'] = static function (TestRunner $t) use ($summary164): void {
...
$tests['compound intersect window recursive limit next164 prelimit rows show intersect before final limit'] = static function (TestRunner $t) use ($summary164): void {
    $plan = $summary164();
...
$tests['compound intersect window recursive limit next164 recursive queue order limit metadata'] = static function (TestRunner $t) use ($summary164): void {
...
$tests['compound intersect window recursive limit next164 window metadata'] = static function (TestRunner $t) use ($summary164): void {
...
$tests['compound intersect window recursive limit next164 intersect diagnostics'] = static function (TestRunner $t) use ($summary164): void {
...
$tests['compound intersect window recursive limit next164 yield boundary'] = static function (TestRunner $t) use ($summary164): void {
...
$tests['compound intersect window recursive limit next164 current next boundary delta'] = static function (TestRunner $t) use ($summary164): void {
...
$tests['compound intersect window recursive limit next164 changed signatures and reasons'] = static function (TestRunner $t) use ($summary164): void {
    $plan = $summary164();
...
$tests['compound intersect window recursive limit next164 rejects missing recursive'] = static function (TestRunner $t) use ($currentTables164): void {
    $t->throws(InvalidArgumentException::class, static fn (): array => SQLiteCompoundIntersectWindowRecursiveLimitCurrentSourceNext164Plan::compare(
...
$tests['compound intersect window recursive limit next164 rejects missing recursive queue order'] = static function (TestRunner $t) use ($currentTables164): void {
    $t->throws(InvalidArgumentException::class, static fn (): array => SQLiteCompoundIntersectWindowRecursiveLimitCurrentSourceNext164Plan::compare(
...
$tests['compound intersect window recursive limit next164 rejects missing intersect'] = static function (TestRunner $t) use ($currentTables164): void {
    $t->throws(InvalidArgumentException::class, static fn (): array => SQLiteCompoundIntersectWindowRecursiveLimitCurrentSourceNext164Plan::compare(
...
$tests['compound intersect window recursive limit next164 rejects missing final offset'] = static function (TestRunner $t) use ($currentTables164): void {
    $t->throws(InvalidArgumentException::class, static fn (): array => SQLiteCompoundIntersectWindowRecursiveLimitCurrentSourceNext164Plan::compare(
...
foreach (range(1, 50) as $case) {
    $tests['compound intersect window recursive limit next164 generated intersect boundary ' . $case] = static function (TestRunner $t) use ($case): void {
