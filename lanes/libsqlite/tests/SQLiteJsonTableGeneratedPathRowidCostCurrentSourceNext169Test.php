...
$plan169 = static fn (
    ...
    ?array $orderBy = null,
): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext169(
    'json_tree',
    $current ?? $current169,
    $next ?? $next169,
    'option_value',
...
$tests = [
    ...
    'bad generated path column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext169('json_tree', $current169, $next169, 'option_value', '', [])),
    'bad json source column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext169('json_tree', $current169, $next169, '', 'generated_path', [])),
