...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewReturningCurrentSourceNext173Plan;
...
$plan173 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewReturningCurrentSourceNext173Plan::execute(
    $rows173,
    $currentInput173,
    $nextInput173,
    $currentView173,
