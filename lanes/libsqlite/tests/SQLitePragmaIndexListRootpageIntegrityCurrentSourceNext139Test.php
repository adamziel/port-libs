...
use PortLibs\LibSqlite\SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139;
...
): array => SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139::page(
...
$tests['pragma index list rootpage integrity current source next139 rejects negative offset'] = static function (TestRunner $t) use ($catalogFactory, $validDatabase): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139::page($catalogFactory(), 'PRAGMA index_list(wp_options)', $validDatabase, -1, 139));
};
...
$tests['pragma index list rootpage integrity current source next139 rejects zero limit'] = static function (TestRunner $t) use ($catalogFactory, $validDatabase): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139::page($catalogFactory(), 'PRAGMA index_list(wp_options)', $validDatabase, 0, 0));
};
