...
$currentOptionsLagLeadDistinctUnionLimitOffset = [
...
$nextOptionsLagLeadDistinctUnionLimitOffset = [
    ...$currentOptionsLagLeadDistinctUnionLimitOffset,
    ['option_id' => 5, 'option_name' => 'plugin_alpha', 'autoload' => 'yes', 'score' => 85],
    ['option_id' => 6, 'option_name' => 'theme_mods', 'autoload' => 'yes', 'score' => 65],
];
$currentTablesLagLeadDistinctUnionLimitOffset = ['wp_options' => $currentOptionsLagLeadDistinctUnionLimitOffset];
$nextTablesLagLeadDistinctUnionLimitOffset = ['wp_options' => $nextOptionsLagLeadDistinctUnionLimitOffset];

$sqlLagLeadDistinctUnionLimitOffset = <<<'SQL'
...
$summaryLagLeadDistinctUnionLimitOffset = static fn (): array => SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNextPlan::compareLagLeadDistinctUnionLimitOffset($sqlLagLeadDistinctUnionLimitOffset, $currentTablesLagLeadDistinctUnionLimitOffset, $nextTablesLagLeadDistinctUnionLimitOffset);
$tests = [];

$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset status dependencies'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $plan = $summaryLagLeadDistinctUnionLimitOffset();
    $t->same('compound-select-window-recursive-limit-current-source-lag-lead-distinct-union-limit-offset-ready', $plan['status']);
    $t->same([
        'sqlite-select-sql-recursive-limit-offset-lag-lead-distinct-union-limit-offset',
        'sqlite-select-sql-compound-union-all-union-distinct-lag-lead-distinct-union-limit-offset',
        'sqlite-select-sql-window-lag-lead-lag-lead-distinct-union-limit-offset',
        'sqlite-current-source-lag-lead-distinct-union-limit-offset',
    ], $plan['dependencies']);
    $t->contains('no new support component needed', $plan['dependency_closure']);
};

$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset compound metadata'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $compound = $summaryLagLeadDistinctUnionLimitOffset()['compound'];
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset current rows'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $rows = $summaryLagLeadDistinctUnionLimitOffset()['currentRows'];
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset next rows'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $rows = $summaryLagLeadDistinctUnionLimitOffset()['nextRows'];
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset prelimit rows'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $plan = $summaryLagLeadDistinctUnionLimitOffset();
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset recursive trace'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $recursive = $summaryLagLeadDistinctUnionLimitOffset()['recursive'];
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset window metadata'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $windows = $summaryLagLeadDistinctUnionLimitOffset()['windows'];
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset distinct union diagnostics'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $distinct = $summaryLagLeadDistinctUnionLimitOffset()['distinctUnion'];
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset limit trace'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $trace = $summaryLagLeadDistinctUnionLimitOffset()['limitTrace'];
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset source classes'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $classes = $summaryLagLeadDistinctUnionLimitOffset()['sourceClasses'];
    $t->same(['recursive' => 2, 'table' => 3], $classes['current']);
    $t->same(['recursive' => 2, 'table' => 3], $classes['next']);
};

$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset boundary delta'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $boundary = $summaryLagLeadDistinctUnionLimitOffset()['boundary'];
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset replan reasons'] = static function (TestRunner $t) use ($summaryLagLeadDistinctUnionLimitOffset): void {
    $plan = $summaryLagLeadDistinctUnionLimitOffset();
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset rejects missing distinct union'] = static function (TestRunner $t) use ($currentTablesLagLeadDistinctUnionLimitOffset): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNextPlan::compareLagLeadDistinctUnionLimitOffset(
        ...
        $currentTablesLagLeadDistinctUnionLimitOffset,
        $currentTablesLagLeadDistinctUnionLimitOffset,
    ));
};

$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset rejects missing lead'] = static function (TestRunner $t) use ($currentTablesLagLeadDistinctUnionLimitOffset): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNextPlan::compareLagLeadDistinctUnionLimitOffset(
...
$tests['compound select window recursive limit lag-lead-distinct-union-limit-offset rejects final limit without offset'] = static function (TestRunner $t) use ($currentTablesLagLeadDistinctUnionLimitOffset): void {
    $t->throws(InvalidArgumentException::class, static fn () => SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNextPlan::compareLagLeadDistinctUnionLimitOffset(
...
foreach (range(1, 52) as $case) {
    $tests['compound select window recursive limit lag-lead-distinct-union-limit-offset generated union boundary ' . $case] = static function (TestRunner $t) use ($case): void {
