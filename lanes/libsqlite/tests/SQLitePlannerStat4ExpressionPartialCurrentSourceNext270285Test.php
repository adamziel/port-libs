...
$plan270285 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext270285(
    $prepared270285(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next270285 malformed needed column' => static function (TestRunner $t) use ($prepared270285, $current270285, $terms270285): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext270285($prepared270285(), $current270285(), $terms270285(), ['option_name', ''], 6));
    },
];
