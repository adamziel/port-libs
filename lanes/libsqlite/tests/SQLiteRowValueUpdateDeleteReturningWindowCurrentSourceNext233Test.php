...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan;
...
$plan233 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan::execute(
    $tables233,
...
$customPlan233 = static fn (): array => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan::execute(
    $tables233,
    [$yieldUpdate233],
    [$attemptUpdate233],
    [$retryUpdate233],
...
$cases233 = [
    ...
    'malformed empty yield rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan::execute($tables233, [], [$attemptUpdate233], [$retryUpdate233], $unique233), InvalidArgumentException::class],
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan::execute($tables233, [$yieldUpdate233], [], [$retryUpdate233], $unique233), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan::execute($tables233, [$yieldUpdate233], [$attemptUpdate233], [], $unique233), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan::execute($tables233, [$yieldUpdate233], [$attemptUpdate233], [$retryUpdate233], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan::execute($tables233, [$yieldUpdate233], [$attemptUpdate233], [$retryUpdate233], $unique233, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext233Plan::execute(['wp_options' => ['bad']], [$yieldUpdate233], [$attemptUpdate233], [$retryUpdate233], $unique233), InvalidArgumentException::class],
];
