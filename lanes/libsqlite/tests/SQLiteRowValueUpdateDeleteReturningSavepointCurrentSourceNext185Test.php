...
$plan185 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrFailRollbackRetrySavepoint(
    $tables185,
...
$cases185 = [
    ...
    'malformed empty pre fail statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrFailRollbackRetrySavepoint($tables185, [], $failUpdate185, [$retryUpdate185], $unique185), InvalidArgumentException::class],
    'malformed empty fail statement rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrFailRollbackRetrySavepoint($tables185, [$preDelete185], '', [$retryUpdate185], $unique185), InvalidArgumentException::class],
    'malformed empty retry statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrFailRollbackRetrySavepoint($tables185, [$preDelete185], $failUpdate185, [], $unique185), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrFailRollbackRetrySavepoint($tables185, [$preDelete185], $failUpdate185, [$retryUpdate185], []), InvalidArgumentException::class],
    'malformed savepoint name rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrFailRollbackRetrySavepoint($tables185, [$preDelete185], $failUpdate185, [$retryUpdate185], $unique185, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeOrFailRollbackRetrySavepoint(['wp_options' => ['bad']], [$preDelete185], $failUpdate185, [$retryUpdate185], $unique185), InvalidArgumentException::class],
];
