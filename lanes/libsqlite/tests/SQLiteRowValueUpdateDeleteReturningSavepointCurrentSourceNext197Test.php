...
$plan197 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry(
    $tables197,
    [$outerUpdate197],
...
$customPlan197 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry(
    $tables197,
    [$outerUpdate197],
    [$innerUpdate197],
    [$retryUpdate197],
...
$cases197 = [
    ...
    'malformed empty outer rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry($tables197, [], [$innerUpdate197], [$retryUpdate197], $unique197), InvalidArgumentException::class],
    'malformed empty inner rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry($tables197, [$outerUpdate197], [], [$retryUpdate197], $unique197), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry($tables197, [$outerUpdate197], [$innerUpdate197], [], $unique197), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry($tables197, [$outerUpdate197], [$innerUpdate197], [$retryUpdate197], []), InvalidArgumentException::class],
    'malformed outer savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry($tables197, [$outerUpdate197], [$innerUpdate197], [$retryUpdate197], $unique197, 'bad-name'), InvalidArgumentException::class],
    'malformed inner savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry($tables197, [$outerUpdate197], [$innerUpdate197], [$retryUpdate197], $unique197, 'ok_name', 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry(['wp_options' => ['bad']], [$outerUpdate197], [$innerUpdate197], [$retryUpdate197], $unique197), InvalidArgumentException::class],
    'malformed rowid rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeRollbackToInnerSavepointRetry(['wp_options' => [['option_name' => 'siteurl']]], [$outerUpdate197], [$innerUpdate197], [$retryUpdate197], $unique197), InvalidArgumentException::class],
];
