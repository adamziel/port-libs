...
use PortLibs\LibSqlite\SQLiteTriggerRecursiveViewUpsertCurrentSourceNext243Plan;
...
$plan243 = static fn (array $options = []): array => SQLiteTriggerRecursiveViewUpsertCurrentSourceNext243Plan::execute(
    $rows243,
    $currentInput243,
    $nextInput243,
    $currentView243,
