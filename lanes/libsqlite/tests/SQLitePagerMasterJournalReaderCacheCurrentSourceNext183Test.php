...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext183Plan;
...
$plan = static fn (
    ...
    ?string $source = null,
    int $epoch = 183,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext183Plan::plan(
    $path ?? $database,
    $masterPath ?? $master,
