...
$tests['json table generated path rowid cost current source next728 no later alias yet'] = static function (TestRunner $t) use ($plan713728): void {
    $t->throws(Error::class, static fn () => $plan713728(729));
};
