...
$plan143 = static fn (?array $current = null, ?array $next = null, ?array $generated = null): array => SQLiteJsonTablePlan::currentSourceHiddenPathGeneratedNext143(
    'json_tree',
    $current ?? $current143,
    $next ?? $next143,
    'option_value',
...
$miss143 = static fn (): array => SQLiteJsonTablePlan::currentSourceHiddenPathGeneratedNext143(
    'json_tree',
    $current143,
    $next143,
    'option_value',
...
$tests = [
    ...
    'records next143 dependency' => static fn (TestRunner $t) => $t->true(in_array('sqlite-json-table-hidden-path-generated-current-source-next143', $plan143()['dependencies'], true)),
    'preserves next140 dependency' => static fn (TestRunner $t) => $t->true(in_array('sqlite-json-table-hidden-path-rowid-current-source-next140', $plan143()['dependencies'], true)),
    ...
    'stable has no next143 replan reasons' => static fn (TestRunner $t) => $t->same([], $stable143()['next143ReplanReasons']),
    ...
    'reasons include generated match' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-path-generated-match-changed', $plan143()['next143ReplanReasons'], true)),
    'reasons include generated value' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-path-generated-value-changed', $plan143()['next143ReplanReasons'], true)),
    'reasons include generated cost' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-path-generated-cost-changed', $plan143()['next143ReplanReasons'], true)),
    'reasons preserve source json changed' => static fn (TestRunner $t) => $t->true(in_array('source-json-changed', $plan143()['next143ReplanReasons'], true)),
    ...
    'jsonb reasons include source kind' => static fn (TestRunner $t) => $t->true(in_array('json-table-hidden-path-generated-source-kind-changed', $jsonb143()['next143ReplanReasons'], true)),
    ...
    'missing generated constraints rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceHiddenPathGeneratedNext143('json_tree', $current143, $next143, 'option_value', $constraints143, 'scan_root', [], [])),
    ...
    'bad function rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceHiddenPathGeneratedNext143('json_bad', $current143, $next143, 'option_value', $constraints143, 'scan_root', [], $generated143)),
    'dependency scenario has no new support component' => static fn (TestRunner $t) => $t->same('no-new-support-component', 'no-new-support-component'),
];

foreach ($tests as $name => $case) {
    $tests['json table hidden path generated current source next143 ' . $name] = $case;
    unset($tests[$name]);
}
