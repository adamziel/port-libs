...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan;
...
$rollbackPlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute(
    $tables,
    [$beforeSql],
...
$releasePlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute(
    $tables,
    [$beforeSql],
    [$protectedUpdateSql],
    [$releaseAfterSql],
...
$cases = [
    ...
    'malformed empty before rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute($tables, [], [$protectedUpdateSql], [$afterUpdateSql], $unique), InvalidArgumentException::class],
    'malformed empty protected rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute($tables, [$beforeSql], [], [$afterUpdateSql], $unique), InvalidArgumentException::class],
    'malformed empty after rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute($tables, [$beforeSql], [$protectedUpdateSql], [], $unique), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute($tables, [$beforeSql], [$protectedUpdateSql], [$afterUpdateSql], []), InvalidArgumentException::class],
    'malformed rollback ordinal rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute($tables, [$beforeSql], [$protectedUpdateSql], [$afterUpdateSql], $unique, 'bad', 4), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute($tables, [$beforeSql], [$protectedUpdateSql], [$afterUpdateSql], $unique, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext160Plan::execute(['wp_options' => ['bad']], [$beforeSql], [$protectedUpdateSql], [$afterUpdateSql], $unique), InvalidArgumentException::class],
];
