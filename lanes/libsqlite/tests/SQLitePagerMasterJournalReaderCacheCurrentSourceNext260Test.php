...
$plan = static fn (?array $readerCache = null, ?array $nextReads = null, ?string $ticketToken = null): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext260Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
