...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext247Plan;
...
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext247Plan::plan(
    $database,
    $master,
    $masterBytes,
    implode('', $before),
