...
use PortLibs\LibSqlite\SQLitePagerMasterJournalReaderCacheCurrentSourceNext184Plan;
...
$plan = static fn (
    ...
    ?string $source = null,
    int $epoch = 21,
): array => SQLitePagerMasterJournalReaderCacheCurrentSourceNext184Plan::plan(
    $path ?? $databasePath,
