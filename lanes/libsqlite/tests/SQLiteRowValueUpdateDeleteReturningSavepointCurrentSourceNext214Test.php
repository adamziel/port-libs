...
$plan214 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext214(
    $tables214,
    [$attemptUpdate214, $attemptDelete214],
    [$retryUpdate214, $retryDelete214],
    $unique214,
);
$customPlan214 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext214(
    $tables214,
    [$attemptUpdate214],
    [$retryUpdate214],
    $unique214,
...
$cases214 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext214($tables214, [], [$retryUpdate214], $unique214), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext214($tables214, [$attemptUpdate214], [], $unique214), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext214($tables214, [$attemptUpdate214], [$retryUpdate214], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext214($tables214, [$attemptUpdate214], [$retryUpdate214], $unique214, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNextPlan::executeNext214(['wp_options' => ['bad']], [$attemptUpdate214], [$retryUpdate214], $unique214), InvalidArgumentException::class],
];
