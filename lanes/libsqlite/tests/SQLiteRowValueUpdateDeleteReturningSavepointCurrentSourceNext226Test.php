...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext226Plan;
...
$plan226 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext226Plan::execute(
    $tables226,
    [$attemptUpdate226, $attemptDelete226],
    [$retryUpdate226, $retryDelete226],
    $unique226,
);
$customPlan226 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext226Plan::execute(
    $tables226,
    [$attemptUpdate226],
    [$retryUpdate226],
    $unique226,
...
$cases226 = [
    ...
    'malformed empty attempt rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext226Plan::execute($tables226, [], [$retryUpdate226], $unique226), InvalidArgumentException::class],
    'malformed empty retry rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext226Plan::execute($tables226, [$attemptUpdate226], [], $unique226), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext226Plan::execute($tables226, [$attemptUpdate226], [$retryUpdate226], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext226Plan::execute($tables226, [$attemptUpdate226], [$retryUpdate226], $unique226, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext226Plan::execute(['wp_options' => ['bad']], [$attemptUpdate226], [$retryUpdate226], $unique226), InvalidArgumentException::class],
];
