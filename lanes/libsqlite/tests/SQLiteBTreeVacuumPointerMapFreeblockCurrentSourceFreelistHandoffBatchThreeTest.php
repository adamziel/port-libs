...
$plan10391054 = static function (int $sliceNumber, int $batchSize = 2) use ($database10391054): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan {
...
foreach (range(1039, 1054) as $sliceNumber) {
    $tests["btree vacuum pointermap freeblock current source freelist handoff case {$sliceNumber} receipts"] = static function (TestRunner $t) use ($plan10391054, $sliceNumber): void {
