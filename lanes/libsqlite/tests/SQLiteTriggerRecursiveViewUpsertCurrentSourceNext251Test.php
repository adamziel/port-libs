...
$baseOptions251 = [
    'key' => 'key_name',
    'savepoint' => 'app_recursive_view_251',
    'cursor_name' => 'app_recursive_view_returning_cursor_251',
    'admit_next_source' => true,
    'rollback_token' => 'app.rollback.current.251',
    'reset_generation' => 'app-current-reset-251',
    'post_reset_current_source_token' => 'app.current.source.postreset.251',
    'post_reset_cursor' => 'app.returning.postreset.cursor.251',
    ...
    'next_source_token' => 'app.next.source.251',
    'next_cursor' => 'app.returning.next.cursor.251',
    'next_acknowledged_ordinals' => [0, 1],
    'close_next_cursor' => 'app.returning.next.cursor.251',
    'following_current_source_token' => 'app.current.source.following.251',
    'following_cursor' => 'app.returning.following.cursor.251',
    ...
    'following_generation' => 'app-following-current-251',
    'recursive_child_acknowledged_ordinals' => [0, 1],
    'recursive_child_source_token' => 'app.current.source.recursive.child.251',
    'recursive_child_cursor' => 'app.returning.recursive.child.cursor.251',
    'recursive_child_generation' => 'app-recursive-child-current-251',
    'current_generation_next203' => 'app.current.recursive.returning.generation.251',
    'expected_current_generation_next203' => 'app.current.recursive.returning.generation.251',
    'current_handoff_cursor_next203' => 'app.returning.current.handoff.cursor.251',
    'current_generation_commit_marker_next203' => 'app.current.recursive.returning.commit.251',
    'auto_ack_current_generation_receipts_next203' => true,
    'current_source_drain_token_next209' => 'app.current.source.drain.251',
    ...
    'current_source_yield_token_next212' => 'app.current.source.yield.251',
    'current_view_yield_cursor_next212' => 'app.returning.view.yield.cursor.251',
    'current_trigger_yield_cursor_next212' => 'app.returning.trigger.yield.cursor.251',
    'auto_ack_current_source_yields_next212' => true,
    'current_source_epoch_next218' => 'app.current.source.epoch.251',
    'current_view_epoch_next218' => 'app.returning.view.epoch.cursor.251',
    'current_trigger_epoch_next218' => 'app.returning.trigger.epoch.cursor.251',
    'auto_ack_current_source_epochs_next218' => true,
    'current_source_ticket_next222' => 'app.current.source.ticket.251',
    ...
    'current_source_cursor_source_close' => 'app.returning.current.cursor.251',
    'current_source_close_token_source_close' => 'app.current.source.close.251',
    ...
    'current_source_upsert_token_next234' => 'app.current.source.upsert.251',
    ...
    'current_source_upsert_action_token_next237' => 'app.current.source.upsert.action.251',
    ...
    'current_source_upsert_close_token_next241' => 'app.current.source.upsert.close.251',
    ...
    'current_source_upsert_statement_id_next244' => 'app.current.source.upsert.statement.251',
    'current_source_upsert_commit_watermark_next244' => 'app.current.source.upsert.commit.251',
    ...
    'current_source_sequence_cursor_next247' => 'app.returning.current.sequence.cursor.251',
    ...
    'current_source_change_counter_cursor_next251' => 'app.returning.current.change.counter.251',
];
...
$custom251 = static fn (): array => $plan251([
    ...
    'current_source_change_counter_cursor_next251' => 'app.returning.current.change.counter.custom.251',
]);
...
$cases251 = [
    ...
    'savepoint retained' => [static fn (): mixed => $released251()['savepoint'], 'app_recursive_view_251'],
    ...
    'counter cursor retained' => [static fn (): mixed => $released251()['current_source_change_counter_cursor_next251'], 'app.returning.current.change.counter.251'],
    'custom counter cursor retained' => [static fn (): mixed => $custom251()['current_source_change_counter_cursor_next251'], 'app.returning.current.change.counter.custom.251'],
    ...
    'visible payload names released' => [static fn (): mixed => array_column($released251()['visible_returning_payloads_next251'], 'name'), ['app_summary_child', 'template_child', 'landing_url', 'next_module']],
    'held payload names missing' => [static fn (): mixed => array_column($missing251()['held_next_returning_payloads_next251'], 'name'), ['landing_url', 'next_module']],
