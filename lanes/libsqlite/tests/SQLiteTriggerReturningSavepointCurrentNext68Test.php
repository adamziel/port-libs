...
$plan = static fn (): array => SQLiteTriggerReturningNestedSavepointCurrentNext68Plan::apply(
    'wp_import_outer',
...
$starPlan = static fn (): array => SQLiteTriggerReturningNestedSavepointCurrentNext68Plan::apply(
    'outer_ok',
    'insert_release',
    'update_rollback',
    $baseRows,
...
$cases = [
    ...
    'bad outer savepoint throws' => [static fn (): mixed => SQLiteTriggerReturningNestedSavepointCurrentNext68Plan::apply('bad-name', 'ok_name', 'ok_name2', $baseRows, $insertRows, ['option_value' => 'x'], static fn (): bool => true, [], $returning), InvalidArgumentException::class],
    'bad released savepoint throws' => [static fn (): mixed => SQLiteTriggerReturningNestedSavepointCurrentNext68Plan::apply('ok_name', 'bad-name', 'ok_name2', $baseRows, $insertRows, ['option_value' => 'x'], static fn (): bool => true, [], $returning), InvalidArgumentException::class],
    'missing assignments throws' => [static fn (): mixed => SQLiteTriggerReturningNestedSavepointCurrentNext68Plan::apply('ok_name', 'ok_name2', 'ok_name3', $baseRows, $insertRows, [], static fn (): bool => true, [], $returning), InvalidArgumentException::class],
    'bad returning alias throws' => [static fn (): mixed => SQLiteTriggerReturningNestedSavepointCurrentNext68Plan::apply('ok_name', 'ok_name2', 'ok_name3', $baseRows, $insertRows, ['option_value' => 'x'], static fn (): bool => true, [], [['expr' => 'new.option_name', 'as' => 'bad-alias']]), InvalidArgumentException::class],
];
