...
use PortLibs\LibSqlite\SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan;
...
$plan211 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute(
    $tables211,
...
$customPlan211 = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute(
    $tables211,
    [$preUpdate211],
    $ignoreUpdate211,
    [$afterUpdate211],
...
$cases211 = [
    ...
    'malformed empty pre rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute($tables211, [], $ignoreUpdate211, [$afterUpdate211], $unique211), InvalidArgumentException::class],
    'malformed empty ignore rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute($tables211, [$preUpdate211], '', [$afterUpdate211], $unique211), InvalidArgumentException::class],
    'malformed empty after rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute($tables211, [$preUpdate211], $ignoreUpdate211, [], $unique211), InvalidArgumentException::class],
    'malformed empty unique rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute($tables211, [$preUpdate211], $ignoreUpdate211, [$afterUpdate211], []), InvalidArgumentException::class],
    'malformed savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute($tables211, [$preUpdate211], $ignoreUpdate211, [$afterUpdate211], $unique211, 'bad-name'), InvalidArgumentException::class],
    'malformed ignore action rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute($tables211, [$preUpdate211], str_replace('OR IGNORE', 'OR FAIL', $ignoreUpdate211), [$afterUpdate211], $unique211), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointCurrentSourceNext211Plan::execute(['wp_options' => ['bad']], [$preUpdate211], $ignoreUpdate211, [$afterUpdate211], $unique211), InvalidArgumentException::class],
];
