...
$tests = [
    ...
    'planner stat4 expression partial current source finalPreparedHandoff terminal alias prepared' => static fn (TestRunner $t) => $t->same(true, $plan974989()['selectedPlan']['terminalPreparedHandoffAliasPrepared']),
    ...
    'planner stat4 expression partial current source finalPreparedHandoff stable terminal fence alias' => static fn (TestRunner $t) => $t->same($plan974989()['stat4TerminalPreparedHandoffPreparationFence'], $plan974989()['stat4TerminalPreparedHandoffFence']),
