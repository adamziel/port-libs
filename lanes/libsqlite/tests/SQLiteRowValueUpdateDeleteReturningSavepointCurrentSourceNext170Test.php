...
$plan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeAbortReturningSavepointBatch(
    $tables,
    [$stageSql, $deleteSql, $abortSql],
    [$retrySql],
    $unique,
);
$cleanPlan = static fn (): array => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeAbortReturningSavepointBatch(
    $tables,
    [$cleanSql, $deleteSql],
    [],
    $unique,
...
$cases = [
    ...
    'malformed empty statements rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeAbortReturningSavepointBatch($tables, [], [], $unique), InvalidArgumentException::class],
    'malformed empty unique constraints rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeAbortReturningSavepointBatch($tables, [$stageSql], [], []), InvalidArgumentException::class],
    'malformed bad savepoint rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeAbortReturningSavepointBatch($tables, [$stageSql], [], $unique, 'bad-name'), InvalidArgumentException::class],
    'malformed row list rejected' => [static fn (): mixed => SQLiteRowValueUpdateDeleteReturningSavepointPlan::executeAbortReturningSavepointBatch(['wp_options' => ['bad']], [$stageSql], [], $unique), InvalidArgumentException::class],
];
