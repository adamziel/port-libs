...
$point158 = static fn (?array $current = null, ?array $next = null): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostNext158(
    'json_tree',
    $current ?? $current158,
    $next ?? $next158,
    'option_value',
...
$range158 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostNext158(
    'json_tree',
...
$miss158 = static fn (): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostNext158(
    'json_tree',
    $current158,
    $next158,
    'option_value',
...
$tests = [
    ...
    'missing json source rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostNext158('json_tree', [], $next158, 'option_value', 'generated_path')),
    'missing generated path source rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostNext158('json_tree', $current158, $next158, 'option_value', 'missing_path')),
