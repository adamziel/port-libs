...
$plan638653 = static fn (?array $rows = null, ?array $samples = null): array => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext638653(
    $prepared638653(),
...
$tests = [
    ...
    'planner stat4 expression partial current source next638653 cursor appended' => static fn (TestRunner $t) => $t->same('PrepareStat4ExpressionPartialNext638653Handoff', $plan638653()['cursorProgram'][array_key_last($plan638653()['cursorProgram'])]['opcode']),
    'planner stat4 expression partial current source next638653 cursor mode' => static fn (TestRunner $t) => $t->same('next638-653-current-source-stat4-expression-partial-prep', $plan638653()['cursorProgram'][array_key_last($plan638653()['cursorProgram'])]['mode']),
    ...
    'planner stat4 expression partial current source next638653 malformed needed column' => static function (TestRunner $t) use ($prepared638653, $current638653, $terms638653): void {
        $t->throws(InvalidArgumentException::class, static fn () => SQLitePlannerStat4ExpressionPartialCurrentSourceNext224Plan::materializeNext638653($prepared638653(), $current638653(), $terms638653(), ['option_name', ''], 6));
    },
];
