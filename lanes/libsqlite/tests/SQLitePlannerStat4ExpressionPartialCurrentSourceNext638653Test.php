...
$tests = [
    ...
    'planner stat4 expression partial current source next638653 cursor omits dynamic legacy opcode' => static fn (TestRunner $t) => $t->same(false, array_key_exists('legacyOpcode', $plan638653()['cursorProgram'][array_key_last($plan638653()['cursorProgram'])])),
    'planner stat4 expression partial current source next638653 cursor omits dynamic legacy mode' => static fn (TestRunner $t) => $t->same(false, array_key_exists('legacyMode', $plan638653()['cursorProgram'][array_key_last($plan638653()['cursorProgram'])])),
