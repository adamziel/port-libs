...
$plan162 = static fn (
    ...
    ?array $orderBy = null,
): array => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostSourceNext162(
    'json_tree',
    $current ?? $current162,
    $next ?? $next162,
    'option_value',
...
$tests = [
    ...
    'bad generated path source column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostSourceNext162('json_tree', $current162, $next162, 'option_value', '', $constraints162)),
    'bad json source column rejected' => static fn (TestRunner $t) => $t->throws(InvalidArgumentException::class, static fn () => SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostSourceNext162('json_tree', $current162, $next162, '', 'generated_path', $constraints162)),
