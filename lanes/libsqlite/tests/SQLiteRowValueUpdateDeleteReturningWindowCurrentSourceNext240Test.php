...
$cases240 = [
    ...
    'plan savepoint' => [static fn (): mixed => $plan240()['savepoint'], 'app_settings_rowvalue_window_groups_next240'],
    ...
    'receipt savepoint' => [static fn (): mixed => $plan240()['retry_peer_group_receipt_next240']['savepoint'], 'app_settings_rowvalue_window_groups_next240'],
