...
$plan259 = static fn (
    ...
    int $nextCookie = 259,
): array => SQLiteEncodingCollationAffinityLikeCurrentSourceNextPlan::applicationBinaryCollationDefaultLikePlan(
    $current ?? $current259,
...
$cases259 = [
    ...
    'current source' => ['currentSource', 'main.app_settings@258'],
    'next source' => ['nextSource', 'main.app_settings@259'],
