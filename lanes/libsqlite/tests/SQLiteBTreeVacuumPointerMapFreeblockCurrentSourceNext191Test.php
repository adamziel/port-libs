...
$plan191 = static function (int $batchSize = 2): SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext191Plan {
    global $database191;

    $database = $database191();
    $deletedPage = SQLiteTableLeafPage::deleteCellByRowId($database->page(3), 2, secureDelete: true);

    return SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext191Plan::tableLeafFromDeleteResult(
        $database,
        3,
        [
            'page' => $deletedPage,
