...
- `SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext548563Test.php` chains next548 through next563 from next547.
...
- `wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next563.php` provides a WordPress-shaped example for the final seal.
