# libsqlite suite upstream veryquick shard current-source next351

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next351 veryquick shard row.
...
This avoids accepted next155 through next324 and live next327 through next342 reserve veryquick shard evidence,
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext351Test.php
