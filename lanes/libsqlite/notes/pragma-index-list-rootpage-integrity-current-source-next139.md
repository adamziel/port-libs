...
```sh
php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIndexListRootpageIntegrityCurrentSourceNext139Test.php
```
...
```sh
php lanes/libsqlite/examples/wordpress-pragma-index-list-rootpage-integrity-current-source-next139.php --self-test
```

Result: `wordpress-pragma-index-list-rootpage-integrity-current-source-next139 self-test passed`.
