...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next722-737.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNextTest.php`
- `php lanes/libsqlite/examples/application-vfs-current-source-next722-737.php --self-test`
- `git diff --check`
