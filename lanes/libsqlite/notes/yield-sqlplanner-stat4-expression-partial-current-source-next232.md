...
and rejects stale STAT4 counter rows before a yielded Application-style
...
- `php -l lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-source-next232.php`
...
- `php lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-source-next232.php --self-test`
  - Result: `stat4-expression-partial-current-source-next232-ready`

Application path: the example models copied autoloaded plugin options where a
