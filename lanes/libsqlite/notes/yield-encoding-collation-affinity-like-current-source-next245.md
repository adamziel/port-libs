...
This is WordPress-relevant for copied option-name scans where import filters generate escaped literal `_` predicates and must not treat a dangling escape as a match.
...
- `php -l lanes/libsqlite/examples/wordpress-dangling-escape-like-current-source-next245.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteEncodingCollationAffinityLikeCurrentSourceNext245Test.php`
  ...
  - `79` PASS lines
- `php lanes/libsqlite/examples/wordpress-dangling-escape-like-current-source-next245.php`
