...
- WordPress smoke: `lanes/libsqlite/examples/wordpress-option-name-malformed-like-glob-source-next91.php --self-test` reports repaired option-name bytes across a `main.wp_options` schema-cookie boundary without requiring `ext/sqlite`.
- Focused evidence:
  ...
  - `php -l lanes/libsqlite/examples/wordpress-option-name-malformed-like-glob-source-next91.php`
  ...
  - `php lanes/libsqlite/examples/wordpress-option-name-malformed-like-glob-source-next91.php --self-test`
  - Result: `wordpress-option-name-malformed-like-glob-source-next91 self-test passed`
