# Upstream veryquick shard current-source next370
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext370()`,
...
classification, and focused PHP PASS-line output all match the next370
evidence record.
...
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext370Test.php
...
file, exact `57` TestRunner PASS lines, `678` assertions, and no failures. The
admitted focused runner-output delta is exactly `57` PASS lines.
