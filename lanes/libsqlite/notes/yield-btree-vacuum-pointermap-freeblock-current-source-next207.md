...
WordPress path: copied `wp_options` transient deletion with overflow pages 106-110, vacuum fencing of tail pages 109-110, and deterministic writer admission for pages `[2, 3, 105, 106, 107, 108]`.
...
- `php -l lanes/libsqlite/examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next207.php`
...
- `php lanes/libsqlite/examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next207.php`
  - `wordpress-btree-vacuum-pointermap-freeblock-current-source-next207 self-test passed`
