...
- Replaced the final numbered row-value/window ready-publication caller files for the 1006-1149 covered ranges with one descriptive focused test and one descriptive Application smoke.
...
- `php -l lanes/libsqlite/examples/application-rowvalue-returning-window-ready-publication-final.php`
...
- `php lanes/libsqlite/examples/application-rowvalue-returning-window-ready-publication-final.php --self-test`
