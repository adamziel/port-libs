# Upstream veryquick shard current-source next401
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext401()`,
...
classification, and focused PHP PASS-line output all match the next401
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext401Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext401Test.php
...
suite/behavior surfaces, and live B-tree/JSON/VFS/WAL/planner/PRAGMA/ATTACH/
window/VDBE work.
