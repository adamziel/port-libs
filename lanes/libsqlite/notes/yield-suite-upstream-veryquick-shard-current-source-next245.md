# Upstream veryquick shard current-source next245
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext245()`,
...
focused PHP PASS-line output all match the next245 evidence record.
...
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext245Test.php
