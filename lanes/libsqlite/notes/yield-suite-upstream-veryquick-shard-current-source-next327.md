# Upstream veryquick shard current-source next327
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext327()`,
...
classification, and focused PHP PASS-line output all match the next327
evidence record.
...
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext327Test.php
