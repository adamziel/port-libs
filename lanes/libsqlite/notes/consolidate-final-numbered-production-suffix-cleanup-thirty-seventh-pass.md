...
- Direct tests/examples: moved the direct test and Application example to unsuffixed filenames and removed direct numbered references from their scenario strings and index names.
...
- Examples: `php lanes/libsqlite/examples/application-planner-covering-partial-range-current-source.php --self-test` and `php lanes/libsqlite/examples/application-planner-partial-range-covering-current-source.php --self-test` passed.
