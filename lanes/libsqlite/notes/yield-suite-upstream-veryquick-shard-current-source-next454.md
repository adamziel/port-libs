# libsqlite suite upstream veryquick shard current-source next454

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next454 veryquick shard row.
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext454Test.php
