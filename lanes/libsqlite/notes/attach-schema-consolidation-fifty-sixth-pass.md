...
- Migrated the direct root-signature test and WordPress smoke to the canonical class.

## Verification

- `php -l lanes/libsqlite/src/SQLiteAttachTempWalSchemaCookiePlan.php && php -l lanes/libsqlite/tests/SQLiteAttachTempWalSchemaCookieRootSignatureTest.php && php -l lanes/libsqlite/examples/wordpress-attach-temp-wal-schema-cookie-root-signature.php`
...
- `php lanes/libsqlite/examples/wordpress-attach-temp-wal-schema-cookie-root-signature.php --self-test` -> self-test passed
