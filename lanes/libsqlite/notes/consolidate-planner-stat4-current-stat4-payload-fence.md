...
covered column image after a Application option import updates copied
`wp_options` rows.
...
- `php -l lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-stat4-payload-fence.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePlannerStat4ExpressionPartialCurrentStat4PayloadFenceTest.php`
- `php lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-stat4-payload-fence.php --self-test`
