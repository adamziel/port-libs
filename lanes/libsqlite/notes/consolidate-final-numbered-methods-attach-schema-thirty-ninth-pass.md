...
Direct tests, WordPress examples, and lane notes were renamed away from generated worker-number filenames and updated to call those canonical methods. No production compatibility shim or numbered production helper was added.
...
php lanes/libsqlite/examples/wordpress-attach-wal-temp-trigger-cookie-cache.php --self-test
php lanes/libsqlite/examples/wordpress-attach-temp-wal-schema-trigger-source-reprepare.php --self-test
