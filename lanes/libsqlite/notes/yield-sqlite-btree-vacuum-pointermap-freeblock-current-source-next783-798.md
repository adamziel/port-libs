# SQLite b-tree vacuum pointer-map freeblock current-source next783-798

Prepared next783-798 as the direct follow-on to integrated next767-782 by extending the canonical
...
- Scope is limited to current-source handoff receipts after the next431-446 freelist splice shape already exercised by next767-782.
...
- `php -l lanes/libsqlite/tests/SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext783798Test.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext783798Test.php`
- `git diff --check`
