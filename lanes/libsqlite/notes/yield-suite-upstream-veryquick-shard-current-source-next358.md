# libsqlite suite upstream veryquick shard current-source next358

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next358 veryquick shard row.
- Ties the row to launcher Base accepted HEAD
  `6fcf43894f6a928c0bc6d32e0acbb8d408f4756c` and accepted batch224 source
  `dfafd6bf4bf76ac953cec16c5d6fe44410de3229`.
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext358Test.php
