...
The serialized result keys, status strings, dependency markers, and opcode labels remain unchanged so existing behavior assertions still cover the accepted handoff payloads. Direct tests and WordPress examples now use stable late-handoff stage filenames and public method names.

## Verification

- `php -l` passed for the changed source file, four renamed focused tests, and four renamed WordPress examples.
...
- WordPress example self-tests passed for the four renamed late-handoff examples.
