...
- Migrated the direct next184 test, WordPress example, and internal next187 caller to the descriptive entry method.
...
- `php lanes/libsqlite/examples/wordpress-trigger-recursive-view-returning-current-source-next184.php --self-test`
  - Result: `wordpress-trigger-recursive-view-returning-current-source-next184 self-test passed`
