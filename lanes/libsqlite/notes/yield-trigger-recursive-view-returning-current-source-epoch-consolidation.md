...
- Renamed direct test and WordPress smoke files from the numbered `current-source-next230` names to stable current-source epoch receipt names.
...
- `php -l lanes/libsqlite/examples/wordpress-trigger-recursive-view-returning-current-source-epoch-receipt.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteTriggerRecursiveViewReturningCurrentSourceEpochReceiptTest.php`
- `php lanes/libsqlite/examples/wordpress-trigger-recursive-view-returning-current-source-epoch-receipt.php --self-test`
