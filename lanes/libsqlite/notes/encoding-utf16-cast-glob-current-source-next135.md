...
Application smoke: `php lanes/libsqlite/examples/application-utf16-cast-glob-current-source-next135.php --self-test`
...
- `php -l lanes/libsqlite/examples/application-utf16-cast-glob-current-source-next135.php`
  - `No syntax errors detected in lanes/libsqlite/examples/application-utf16-cast-glob-current-source-next135.php`
...
- `php lanes/libsqlite/examples/application-utf16-cast-glob-current-source-next135.php --self-test`
  - `application-utf16-cast-glob-current-source-next135 self-test passed`
