...
- Updated the WordPress compound INTERSECT smoke to call the canonical unsuffixed method.
...
- `php -l lanes/libsqlite/examples/wordpress-compound-intersect-window-recursive-limit.php`
...
- `php lanes/libsqlite/examples/wordpress-compound-intersect-window-recursive-limit.php --self-test`
