...
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-final-prepared-handoff-tail.php`
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-final-prepared-handoff-tail.php --self-test`
