# Upstream veryquick shard current-source next384
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSource(..., 'next384-veryquick-shard')`,
...
classification, and focused PHP PASS-line output all match the next384
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext384Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext384Test.php
...
file, `96` TestRunner PASS lines, `1331` assertions, and no failures. The
admitted focused runner-output delta inside the evidence record is exactly
`96` PASS lines.
...
queued suite327/suite330/suite340+ rows, queued runner106/jsonvt104 rebase
work, accepted batch225 behavior surfaces, and live B-tree/JSON/VFS/WAL/
