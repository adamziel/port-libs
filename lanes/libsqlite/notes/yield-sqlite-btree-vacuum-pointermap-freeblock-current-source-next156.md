...
Adds `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext156Plan` for a copied `wp_options` delete/rewrite path that:
...
- `php -l lanes/libsqlite/src/SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext156Plan.php`
