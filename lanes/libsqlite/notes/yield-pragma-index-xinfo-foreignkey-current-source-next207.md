...
- Application smoke: `application-pragma-index-xinfo-foreignkey-current-source-next207.php` models copied `wp_option_import` staging rows gaining a composite child-key index before import/cascade validation.
...
- `php lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next207.php --self-test`
