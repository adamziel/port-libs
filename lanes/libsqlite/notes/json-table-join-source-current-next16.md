...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-json-each-comma-join.php` reports copied `wp_options` JSON expanded through comma and LEFT JSON table joins.
