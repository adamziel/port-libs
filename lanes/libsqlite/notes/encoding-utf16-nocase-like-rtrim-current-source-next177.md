...
- `php lanes/libsqlite/examples/application-utf16-nocase-like-rtrim-current-source-next177.php --self-test`
  - `application-utf16-nocase-like-rtrim-current-source-next177 self-test passed`
