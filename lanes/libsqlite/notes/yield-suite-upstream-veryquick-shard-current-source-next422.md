# Upstream veryquick shard current-source next422
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext422()`,
...
classification, and focused PHP PASS-line output all match the next422
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext422Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext422Test.php
...
next148, queued runner106/jsonvt104 rebase work, accepted batch227 suite
evidence, and live B-tree/JSON/VFS/WAL/planner/PRAGMA/ATTACH/window/VDBE
work.
