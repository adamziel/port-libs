...
```text
$ php lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next228.php
application-pragma-index-xinfo-foreignkey-current-source-next228 self-test passed
```
