...
This slice adds `SQLitePragmaForeignKeyIntegrityRootpageCurrentSourceNext140Plan`, a current/next comparator for `foreign_key_check` rows enriched with sqlite_schema rootpage and pointer-map state.
...
- `php lanes/libsqlite/examples/wordpress-pragma-foreignkey-integrity-rootpage-current-source-next140.php --self-test`
