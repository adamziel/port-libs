# Upstream veryquick shard current-source next303
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext303()`,
...
focused PHP PASS-line output all match the next303 evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext303Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext303Test.php
