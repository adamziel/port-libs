...
Direct tests and WordPress examples were renamed away from numbered worker suffixes and updated to call the stable production methods:
...
- `php -l lanes/libsqlite/examples/wordpress-planner-stat4-order-covering-current-source.php`
- `php -l lanes/libsqlite/examples/wordpress-stat4-order-covering-current-source-cursor-tape.php`
...
- `php lanes/libsqlite/examples/wordpress-planner-stat4-order-covering-current-source.php --self-test`
- `php lanes/libsqlite/examples/wordpress-stat4-order-covering-current-source-cursor-tape.php --self-test`
