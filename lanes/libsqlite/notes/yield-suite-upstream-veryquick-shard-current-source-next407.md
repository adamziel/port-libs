# Upstream veryquick shard current-source next407
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext407()`,
...
classification, and focused PHP PASS-line output all match the next407
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext407Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext407Test.php
...
runner106/jsonvt104 rebase work, accepted batch227 suite evidence and batch109-113 behavior surfaces, and live
