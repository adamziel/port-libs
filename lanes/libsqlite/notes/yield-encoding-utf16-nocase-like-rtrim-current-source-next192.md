...
- Application smoke: `examples/application-utf16-nocase-like-rtrim-current-source-next192.php --self-test`.
...
- Verification:
  ...
  - `php lanes/libsqlite/examples/application-utf16-nocase-like-rtrim-current-source-next192.php --self-test`: self-test passed.
