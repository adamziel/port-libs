...
- The slice verifies that deleting a WordPress-like `wp_options` transient leaves the post-vacuum table leaf freeblock image unchanged while reused current-source overflow pages receive replacement overflow pointer-map entries.
...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next167.php --self-test`
