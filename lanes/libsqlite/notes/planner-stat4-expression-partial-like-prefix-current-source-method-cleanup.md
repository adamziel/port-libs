...
dependency strings, proof keys, exception text, test labels, and WordPress
...
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next168.php`
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next168.php --self-test`
...
group, its direct focused test, and its direct WordPress smoke. It does not
