# ATTACH WAL Temp Schema View Cache Current Source Next82

Status: ready isolated handoff.

This slice adds `SQLiteAttachWalTempViewCachePlan::currentSourceNext82()` for
...
php -l lanes/libsqlite/tests/SQLiteAttachWalTempSchemaViewCacheCurrentSourceNext82Test.php
php -l lanes/libsqlite/examples/wordpress-attach-wal-temp-schema-view-cache-current-source-next82.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteAttachWalTempSchemaViewCacheCurrentSourceNext82Test.php
php lanes/libsqlite/examples/wordpress-attach-wal-temp-schema-view-cache-current-source-next82.php --self-test
...
schema-cache current-next77, temp/main WAL view-cache current-next78, and the
