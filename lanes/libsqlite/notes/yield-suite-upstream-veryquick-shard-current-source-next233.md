# Upstream veryquick shard current-source next233
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext233()`,
...
focused PHP PASS-line output all match the next233 evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext233Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext233Test.php
...
batch109-113, and batch201 behavior surfaces, and live B-tree/JSON/VFS/WAL/
