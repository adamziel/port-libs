...
- Added a copied WordPress settings smoke with JSON text and JSONB option rows.
...
```text
php lanes/libsqlite/examples/wordpress-jsonb-path-operator-index-current-next15.php
