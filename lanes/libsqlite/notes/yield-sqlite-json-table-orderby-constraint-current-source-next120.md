...
- Focused test: `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableOrderByConstraintCurrentSourceNext120Test.php`
- Result: `1 test files, 58 assertions, 0 failures`
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-json-table-orderby-constraint-current-source-next120.php`
