...
direct tests and Application examples.

Direct Application examples for these ranges call canonical descriptive methods
instead of constructing generated numbered method names.

Verification:

- `php -l lanes/libsqlite/src/SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan.php`
- `php -l` for changed row-value window Application examples
