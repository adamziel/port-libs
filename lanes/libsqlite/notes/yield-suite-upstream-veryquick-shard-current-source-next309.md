# libsqlite suite upstream veryquick shard current-source next309

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next309 veryquick shard row.
- Ties the row to launcher Base accepted HEAD
  `a63a17820c8342425b9c9849f5752497926bbaa0` and accepted batch222 source
  `05522ec3eb8441bb12c9d950ca94faeb82cda934`.
...
exact-shard next148, queued JSON-table compatibility repair, accepted batch222
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext309Test.php
