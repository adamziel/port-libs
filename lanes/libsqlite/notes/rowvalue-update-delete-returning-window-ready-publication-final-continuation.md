...
- Renames the direct WordPress smoke and focused test to stable descriptive names.
...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-returning-window-ready-publication-final-continuation.php`
