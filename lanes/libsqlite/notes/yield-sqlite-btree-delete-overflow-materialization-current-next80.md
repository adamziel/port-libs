...
Adds `SQLiteBTreeDeleteOverflowCurrentNext80Plan`, a bounded native PHP
...
- `php -d auto_prepend_file=tools/bootstrap.php lanes/libsqlite/examples/wordpress-btree-delete-overflow-current-next80.php`
- `php -l lanes/libsqlite/src/SQLiteBTreeDeleteOverflowCurrentNext80Plan.php`
- `php -l lanes/libsqlite/tests/SQLiteBTreeDeleteOverflowMaterializationCurrentNext80Test.php`
- `php -l lanes/libsqlite/examples/wordpress-btree-delete-overflow-current-next80.php`
