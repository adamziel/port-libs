...
- Adds `SQLitePragmaIndexListIntegrityRootpageCurrentSourceNext143`, a current/next pager for `PRAGMA index_list` rows plus sqlite_schema rootpage integrity rows for the target table and listed indexes.
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIndexListIntegrityRootpageCurrentSourceNext143Test.php`
- `php lanes/libsqlite/examples/wordpress-pragma-index-list-integrity-rootpage-current-source-next143.php --self-test`
