...
- Example self-test: `application-rowvalue-returning-window-current-source-next638-653.php`
...
php -l lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next638-653.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext638653Test.php
php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next638-653.php --self-test
git diff --check
```
