...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next946-961.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next946-961.php --self-test`
