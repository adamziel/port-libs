...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-json-operator-collate-rhs.php` reports copied `wp_options` JSON text-operator expression indexes resolving collated RHS paths to native root pages and indexed option matches, plus value-operator metadata normalization evidence.
