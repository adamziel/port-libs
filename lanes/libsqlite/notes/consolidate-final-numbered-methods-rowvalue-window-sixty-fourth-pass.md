...
- Renamed the direct final ready-publication row-value/window WordPress smokes and tests from generated range filenames to stable final-handoff/final-seal names.
...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-returning-window-ready-publication-final-seal.php`
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-returning-window-ready-publication-final-seal.php --self-test`
