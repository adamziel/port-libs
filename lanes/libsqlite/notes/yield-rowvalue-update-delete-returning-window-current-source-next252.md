...
- WordPress smoke: `examples/wordpress-rowvalue-returning-window-current-source-next252.php` models copied `wp_options` cleanup/import publication after a savepoint retry.
