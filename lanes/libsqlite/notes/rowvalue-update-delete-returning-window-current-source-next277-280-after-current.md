...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-returning-window-current-source-next277-280-after-current.php`
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-returning-window-current-source-next277-280-after-current.php --self-test`
- `git diff --check`
