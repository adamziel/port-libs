...
Behavior:
- Adds `SQLiteUtf16NocaseLikeRtrimResumeTokenCurrentSourceNext170Plan`.
...
WordPress smoke:
- `php lanes/libsqlite/examples/wordpress-utf16-nocase-like-rtrim-resume-token-current-source-next170.php --self-test`

Focused verification:
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteUtf16NocaseLikeRtrimResumeTokenCurrentSourceNext170Test.php`
