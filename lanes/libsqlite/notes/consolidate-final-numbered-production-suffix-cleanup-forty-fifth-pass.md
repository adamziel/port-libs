...
The direct Application example files and direct focused tests for this block were
...
- Changed Application example self-tests:
...
RETURNING window behavior and Application import examples.
