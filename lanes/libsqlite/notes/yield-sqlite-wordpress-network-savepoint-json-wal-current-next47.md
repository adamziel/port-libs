# Application Network JSON WAL Savepoint Current Next47

Adds `SQLiteNetworkJsonWalSavepointPlan`, a bounded Application-network
...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLiteNetworkJsonWalSavepointCurrentNext47Test.php
...
```text
php lanes/libsqlite/examples/application-network-json-wal-savepoint-current-next47.php
```
...
coverage. This slice is specifically JSON payload imports across a Application
