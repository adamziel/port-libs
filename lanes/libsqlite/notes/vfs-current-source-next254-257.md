...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next254-257.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next254-257.php --self-test`
- `git diff --check`
