...
- Behavior: `SQLiteAttachTempViewTriggerResolution::currentNextSourcePlan()`
  ...
  schema state.
- WordPress path: copied `wp_options` import previews can now tell whether an
...
- WordPress smoke:
  - `php lanes/libsqlite/examples/wordpress-attach-wal-temp-view-trigger-current-source-next86.php --self-test`
  - `wordpress-attach-wal-temp-view-trigger-current-source-next86 self-test passed`
