...
- adds `SQLiteAttachWalTempSchemaCacheCurrentSourceNextPlan::currentSourceNext333348()`;
...
php -l lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-current-source-next333-348.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteAttachTempWalSchemaCacheCurrentSourceNext333348Test.php
php lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-current-source-next333-348.php --self-test
git diff --check
```
