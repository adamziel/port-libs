...
inside copied WordPress `wp_options` queries. It is intentionally separate from
...
- `php lanes/libsqlite/examples/wordpress-select-sql-core-scalar-functions.php --self-test`
