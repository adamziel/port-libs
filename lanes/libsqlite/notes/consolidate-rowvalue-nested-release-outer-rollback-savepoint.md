...
- Renamed the direct focused test and WordPress smoke to descriptive unsuffixed filenames.
...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-nested-release-outer-rollback-savepoint.php`
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-nested-release-outer-rollback-savepoint.php --self-test`
