...
php -l lanes/libsqlite/examples/application-wal-reader-pin-append-current-next61.php
No syntax errors detected in lanes/libsqlite/examples/application-wal-reader-pin-append-current-next61.php
...
```text
php lanes/libsqlite/examples/application-wal-reader-pin-append-current-next61.php
```
