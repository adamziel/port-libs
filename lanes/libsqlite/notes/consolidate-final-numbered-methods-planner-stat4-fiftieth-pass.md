...
canonical method names. The direct focused test and WordPress smoke were renamed
...
- `php -l lanes/libsqlite/examples/wordpress-stat4-expression-partial-current-source.php`
...
- `php lanes/libsqlite/examples/wordpress-stat4-expression-partial-current-source.php` -> ready JSON for `wordpress-stat4-expression-partial-current-source`
