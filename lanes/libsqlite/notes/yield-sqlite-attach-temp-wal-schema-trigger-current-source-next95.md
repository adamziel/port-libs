# ATTACH TEMP WAL Schema Trigger Current Source Next95

## Behavior

Adds `SQLiteAttachTempWalSchemaTriggerPlan::currentSourceNext95()` for prepared
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteAttachTempWalSchemaTriggerCurrentSourceNext95Test.php`
  - `1 test files, 58 assertions, 0 failures`
  - `58` PASS lines
- WordPress smoke:
  - `php lanes/libsqlite/examples/wordpress-attach-temp-wal-schema-trigger-current-source-next95.php --self-test`

## Non-Overlap

This does not repeat accepted batch85/89/90 trigger-cache coverage for plain
