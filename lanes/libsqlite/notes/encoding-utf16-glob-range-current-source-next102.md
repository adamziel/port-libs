...
- `php lanes/libsqlite/examples/wordpress-utf16-glob-range-current-source-next102.php --self-test`
- Result: `wordpress-utf16-glob-range-current-source-next102 self-test passed`
