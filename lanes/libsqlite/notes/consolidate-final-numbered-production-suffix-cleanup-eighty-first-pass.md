...
detail text, non-overlap text, and Application scenario key remain unchanged as
compatibility aliases for existing evidence.

Direct test and Application smoke filenames were renamed to stable unsuffixed
paths:

- `SQLitePlannerSubqueryCoveringPartialCurrentSourceTest.php`
- `application-subquery-covering-partial-current-source.php`
...
- `php -l lanes/libsqlite/examples/application-subquery-covering-partial-current-source.php`
...
- `php lanes/libsqlite/examples/application-subquery-covering-partial-current-source.php`
