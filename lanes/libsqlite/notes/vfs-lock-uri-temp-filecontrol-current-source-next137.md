...
- `php -l lanes/libsqlite/examples/application-vfs-lock-uri-temp-filecontrol-current-source-next137.php`
- `php lanes/libsqlite/examples/application-vfs-lock-uri-temp-filecontrol-current-source-next137.php --self-test`
