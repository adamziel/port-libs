# Upstream veryquick shard current-source next247
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceShard(247, ...)`,
...
focused PHP PASS-line output all match the next247 evidence record.
...
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext247Test.php
