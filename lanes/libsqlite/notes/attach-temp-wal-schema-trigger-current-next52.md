...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-attach-temp-wal-schema-trigger-current-next52.php` reports copied `wp_options` trigger schema writes, schema-cookie reprepare schemas, WAL schemas, and dependencies without requiring ext/sqlite.
