...
- The focused Application scenario models a plugin import where refreshed `sqlite_stat4` samples make the `wp_options(option_name, autoload)` range loop cheaper than older prepared estimates, so the selected connected order becomes `wp_options -> wp_postmeta -> wp_posts`.
...
php lanes/libsqlite/examples/application-join-order-stat4-range-current-source-next116.php
application-join-order-stat4-range-current-source-next116 self-test passed
...
php -l lanes/libsqlite/examples/application-join-order-stat4-range-current-source-next116.php
No syntax errors detected in lanes/libsqlite/examples/application-join-order-stat4-range-current-source-next116.php
