...
- Added `SQLiteJoinOrderStat4RangeCurrentSourceNext116Plan` for connected join-order ranking that reparses stale prepared plans against current schema/stat4/index signatures.
...
php -l lanes/libsqlite/src/SQLiteJoinOrderStat4RangeCurrentSourceNext116Plan.php
No syntax errors detected in lanes/libsqlite/src/SQLiteJoinOrderStat4RangeCurrentSourceNext116Plan.php
