...
- Evidence:
  ...
  - `php lanes/libsqlite/examples/wordpress-index-leaf-balance-apply.php` prints the `wordpress-index-leaf-balance-apply` smoke with the parent divider rewritten to `["yes","autoload_c",13]`.
