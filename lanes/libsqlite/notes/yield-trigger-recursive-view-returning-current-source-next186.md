...
php -l lanes/libsqlite/examples/wordpress-trigger-recursive-view-returning-current-source-next186.php
No syntax errors detected in lanes/libsqlite/examples/wordpress-trigger-recursive-view-returning-current-source-next186.php
...
php lanes/libsqlite/examples/wordpress-trigger-recursive-view-returning-current-source-next186.php
wordpress-trigger-recursive-view-returning-current-source-next186 self-test passed
```
