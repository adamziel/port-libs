...
Implemented `SQLiteJsonTablePlan::currentSourceNestedPathRowidNext133()` for
...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableNestedPathRowidCurrentSourceNext133Test.php
...
```text
php lanes/libsqlite/examples/wordpress-json-table-nested-path-rowid-current-source-next133.php
```
