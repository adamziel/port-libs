...
php lanes/libsqlite/examples/wordpress-stat4-expression-partial-current-source-next155.php
wordpress-stat4-expression-partial-current-source-next155 self-test passed
```
