...
php -l lanes/libsqlite/examples/wordpress-trigger-recursive-view-upsert-current-source-next254.php
# No syntax errors detected in lanes/libsqlite/examples/wordpress-trigger-recursive-view-upsert-current-source-next254.php
...
php lanes/libsqlite/examples/wordpress-trigger-recursive-view-upsert-current-source-next254.php --self-test
# wordpress-trigger-recursive-view-upsert-current-source-next254 self-test passed
```
