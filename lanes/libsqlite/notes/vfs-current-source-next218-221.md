...
- `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext218221Plan.php`
- `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext218221Test.php`
- `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next218-221.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext206209Test.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext218221Test.php`
