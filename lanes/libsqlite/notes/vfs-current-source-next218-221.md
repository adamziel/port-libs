...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next218-221.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next218-221.php --self-test`
- `git diff --check`
