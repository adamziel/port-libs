...
The direct focused test and Application smoke were migrated to the stable
...
- `php -l lanes/libsqlite/examples/application-trigger-recursive-view-returning-snapshot-ack.php`
  - `No syntax errors detected in lanes/libsqlite/examples/application-trigger-recursive-view-returning-snapshot-ack.php`
...
- `php lanes/libsqlite/examples/application-trigger-recursive-view-returning-snapshot-ack.php --self-test`
  - `application-trigger-recursive-view-returning-snapshot-ack self-test passed`
