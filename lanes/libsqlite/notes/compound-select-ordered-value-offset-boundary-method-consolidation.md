...
- Renamed the direct test and WordPress smoke files to remove the numbered suffix.
...
- `php -l lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-ordered-value-offset-boundary.php`
  - `No syntax errors detected in lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-ordered-value-offset-boundary.php`
...
- `php lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-ordered-value-offset-boundary.php --self-test`
  - `wordpress-compound-select-window-recursive-limit-current-source-ordered-value-offset-boundary self-test passed`
