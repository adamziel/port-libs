...
- Renamed the direct focused tests and WordPress examples to stable
...
- `php -l lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-restart-reader-release.php`
- `php -l lanes/libsqlite/examples/wordpress-wal-restart-checkpoint-reader-reopen.php`
- `php -l lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-reader-drain.php`
...
- `php lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-restart-reader-release.php --self-test`
- `php lanes/libsqlite/examples/wordpress-wal-restart-checkpoint-reader-reopen.php --self-test`
- `php lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-reader-drain.php --self-test`
