...
- WordPress smoke:
  - `php lanes/libsqlite/examples/wordpress-option-name-source-switch-current-next86.php --self-test`
  - `wordpress-option-name-source-switch-current-next86 self-test passed`
