...
This slice adds a combined Application smoke wrapper over accepted next257, next258,
...
Application path:
`application-rowvalue-returning-window-current-source-next257-260-after-current.php`
...
- `php -l lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next257-260-after-current.php`
- `php -l lanes/libsqlite/tests/SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext257260AfterCurrentTest.php`
- `php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next257-260-after-current.php`
...
ordered Application coverage batch.
