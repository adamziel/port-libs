...
- Renamed the Application smoke to `application-btree-vacuum-pointermap-freeblock-current-source-handoff.php`.
...
- `php -l lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-handoff.php`
...
- `php lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-handoff.php`: self-test passed.
