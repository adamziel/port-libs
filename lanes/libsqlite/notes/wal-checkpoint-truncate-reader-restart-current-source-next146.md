...
- `php -l lanes/libsqlite/examples/wordpress-wal-checkpoint-truncate-reader-restart-current-source-next146.php` -> no syntax errors
...
- `php lanes/libsqlite/examples/wordpress-wal-checkpoint-truncate-reader-restart-current-source-next146.php --self-test` -> self-test passed
