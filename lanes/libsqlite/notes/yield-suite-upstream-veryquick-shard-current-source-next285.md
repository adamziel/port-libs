# libsqlite suite upstream veryquick shard current-source next285

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next285 veryquick shard row.
...
and batch109-113 behavior surfaces, and the live B-tree, JSON, VFS, WAL,
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext285Test.php
