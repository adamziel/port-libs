...
- Renamed the direct pager-master test and WordPress smoke away from their old numbered filenames and migrated their calls to the descriptive checkpoint branch handoff method.
...
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-checkpoint-branch-handoff.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePagerMasterJournalReaderCacheCheckpointBranchHandoffTest.php`
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-checkpoint-branch-handoff.php`
