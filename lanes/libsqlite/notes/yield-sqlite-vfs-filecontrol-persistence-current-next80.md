# libsqlite VFS file-control persistence current/next80
...
- Focused test: `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsFileControlPersistenceCurrentNext80Test.php`
- Example smoke: `php lanes/libsqlite/examples/wordpress-vfs-filecontrol-persistence-current-next80.php`
- Syntax: `php -l lanes/libsqlite/src/SQLiteVfsFileControlPersistencePlan.php`,
  `php -l lanes/libsqlite/tests/SQLiteVfsFileControlPersistenceCurrentNext80Test.php`,
  and `php -l lanes/libsqlite/examples/wordpress-vfs-filecontrol-persistence-current-next80.php`
...
boundary across close/reopen for the current-next80 VFS slice.
