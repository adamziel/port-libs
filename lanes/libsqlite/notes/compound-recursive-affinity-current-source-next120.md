...
- `php lanes/libsqlite/examples/wordpress-compound-recursive-affinity-current-source-next120.php --self-test`
- `wordpress-compound-recursive-affinity-current-source-next120 self-test passed`
