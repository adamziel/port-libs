...
WordPress smoke: `wordpress-pager-master-journal-reader-cache-current-source-rebase.php` models copied `wp_options` reads after master-journal recovery. It keeps a valid schema reader page, refreshes a stale options page, and invalidates a pinned stale plugin-setting reader page so the next read uses recovered database bytes.

Verification:

- `php -l lanes/libsqlite/src/SQLitePagerMasterJournalReaderCacheCurrentSourceNextPlan.php`
- `php -l lanes/libsqlite/tests/SQLitePagerMasterJournalReaderCacheCurrentSourceRebaseTest.php`
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-rebase.php`
...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-rebase.php --self-test`
