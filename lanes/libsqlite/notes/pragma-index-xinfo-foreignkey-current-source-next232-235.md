...
php lanes/libsqlite/examples/wordpress-pragma-index-xinfo-foreignkey-current-source-next232-235.php --self-test
```

No new source component is required. This note documents the cross-slice
WordPress import smoke only; the individual next232, next233, next234, and
