...
- WordPress smoke: `examples/wordpress-json-table-left-join-rowid-current-next77.php` previews plugin setting flags selected by JSON table rowid aliases without ext/sqlite.
