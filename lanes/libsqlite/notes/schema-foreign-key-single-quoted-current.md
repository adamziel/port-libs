...
- Application path: copied legacy export/import schemas can preserve FK diagnostics for option metadata tables whose identifiers were dumped with single quotes.
...
- `php -l lanes/libsqlite/src/SQLitePragmaSchemaCatalog.php lanes/libsqlite/tests/SQLiteSchemaForeignKeySingleQuotedCurrentTest.php lanes/libsqlite/examples/application-schema-foreign-key-single-quoted-current.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteSchemaForeignKeySingleQuotedCurrentTest.php`
- `php lanes/libsqlite/examples/application-schema-foreign-key-single-quoted-current.php --self-test`
