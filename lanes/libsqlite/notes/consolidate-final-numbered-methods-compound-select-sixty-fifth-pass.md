...
- `php -l lanes/libsqlite/examples/application-compound-select-window-recursive-limit-union-intersect-window-limit-offset.php`
- `php -l lanes/libsqlite/examples/application-compound-select-window-recursive-limit-union-all-window-final-limit-boundary.php`
...
- `php lanes/libsqlite/examples/application-compound-select-window-recursive-limit-union-intersect-window-limit-offset.php --self-test`
- `php lanes/libsqlite/examples/application-compound-select-window-recursive-limit-union-all-window-final-limit-boundary.php --self-test`
