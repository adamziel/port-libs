# Upstream veryquick shard current-source next375
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext375()`,
...
classification, and focused PHP PASS-line output all match the next375
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext375Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext375Test.php
...
batch107/108 and batch109-113 behavior surfaces, current queued next115/next116
B-tree, JSON path/table, VFS, WAL, planner, PRAGMA, ATTACH, window, and VDBE
work, plus all live B-tree/JSON/VFS/WAL/planner/PRAGMA/ATTACH/window/VDBE
behavior slices. This slice only admits the current-source next375 focused
veryquick-shard countability row and does not claim release/all parity.
