...
- Adds `SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext219`, extending the accepted current-source PRAGMA index/FK page with diagnostics for a UNIQUE parent index that contains exactly the referenced parent columns but in a different order.
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext219Test.php`
