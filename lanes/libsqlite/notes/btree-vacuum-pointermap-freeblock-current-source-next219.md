...
Adds `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan`, a post-write current-source readback verifier for the existing vacuum pointer-map/freeblock chain. It consumes the accepted next217 write rows and verifies that the publishable readback stream:
