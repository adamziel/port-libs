...
- `application-sqlplanner-stat4-expression-partial-current-source-next878-893.php`
...
- `php -l lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-source-next878-893.php`
