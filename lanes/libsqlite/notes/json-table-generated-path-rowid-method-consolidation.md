...
Direct tests and Application examples were renamed to stable unsuffixed filenames
...
- Renamed Application generated-path rowid examples with `--self-test`: pass.
