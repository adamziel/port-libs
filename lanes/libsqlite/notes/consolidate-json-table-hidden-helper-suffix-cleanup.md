...
points to stable descriptive names. Direct focused tests and WordPress examples
...
- Renamed WordPress examples executed with `php <example>` for all eight files.
