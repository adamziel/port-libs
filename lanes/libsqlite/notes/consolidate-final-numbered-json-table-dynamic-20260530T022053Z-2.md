...
Application smoke filenames away from the numbered `CurrentSourceNext1017-1048`
surfaces:

- `SQLiteJsonTableGeneratedPathRowidCostFinalRangeEarlyTest.php`
- `SQLiteJsonTableGeneratedPathRowidCostFinalRangeLateTest.php`
- `application-json-table-generated-path-rowid-cost-final-range-early.php`
- `application-json-table-generated-path-rowid-cost-final-range-late.php`
...
- `php -l lanes/libsqlite/examples/application-json-table-generated-path-rowid-cost-final-range-early.php`
...
- `php lanes/libsqlite/examples/application-json-table-generated-path-rowid-cost-final-range-early.php --self-test`
