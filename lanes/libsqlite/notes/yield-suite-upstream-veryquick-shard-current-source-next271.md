# Upstream veryquick shard current-source next271
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext271()`,
...
focused PHP PASS-line output all match the next271 evidence record.

Focused upstream denominator impact: `UPSTREAM_TEST_MANIFEST.json` mapped count
moves from `663` to `664`. The slice records focused current-source veryquick
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext271Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext271Test.php
...
258/259 veryquick evidence, exact-shard next148, queued runner106/jsonvt104
