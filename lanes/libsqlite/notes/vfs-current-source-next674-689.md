...
- `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next674-689.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext626641Test.php`
- `php lanes/libsqlite/examples/wordpress-vfs-current-source-next674-689.php --self-test`
