...
- Matching example: `application-pager-master-journal-reader-cache-literal-arithmetic-branch-fence.php`
...
php -l lanes/libsqlite/examples/application-pager-master-journal-reader-cache-literal-arithmetic-branch-fence.php
...
php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-literal-arithmetic-branch-fence.php
git diff --check
```
