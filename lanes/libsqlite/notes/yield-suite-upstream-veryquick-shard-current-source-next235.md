# Upstream veryquick shard current-source next235
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext235()`,
...
focused PHP PASS-line output all match the next235 evidence record.

Focused upstream denominator impact: `UPSTREAM_TEST_MANIFEST.json` mapped count
moves from `634` to `635`. The slice records focused current-source veryquick
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext235Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext235Test.php
...
file, `1340` assertions, and exact `96` TestRunner PASS lines. The admitted
...
220/222/224/225/226/227/228/229/230 veryquick evidence, exact-shard next148,
queued suite156/160/162/163/165/168/170/182/183/185/186/211
manifest-conflict work, runner106/jsonvt104 rebase work, accepted batch201
behavior surfaces, accepted batch107/108 and batch109-113 surfaces, and live
