## JSON Table Generated Path Rowid Cost Current Source Next301

Implemented `SQLiteJsonTablePlan::currentSourceGeneratedPathRowidCostCurrentSourceNext301()` as an additive generated-path rowid cost-selection layer over the existing next224 yield guard and next220 xRowid profiles.
...
Focused evidence:
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableGeneratedPathRowidCostCurrentSourceNext301Test.php`
- Result: `1 test files, 58 assertions, 0 failures`
- PASS-line delta: `+58`

Application smoke:
- `php lanes/libsqlite/examples/application-json-table-generated-path-rowid-cost-current-source-next301.php --self-test`
- Result: `application-json-table-generated-path-rowid-cost-current-source-next301 self-test passed`
