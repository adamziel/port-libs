...
No new support component is needed. This is production method-wrapper consolidation only; it preserves the existing row-value UPDATE/DELETE RETURNING window continuation behavior and direct WordPress smoke path.
