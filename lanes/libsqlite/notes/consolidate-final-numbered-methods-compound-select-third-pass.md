...
Direct tests, Application examples, and later canonical compound-select methods
...
- `for f in lanes/libsqlite/examples/application-compound-select-window-recursive-limit-current-source-next{237,238,239,240,241,242,243,244,245,246,247}.php; do php "$f" --self-test || exit $?; done` passed.
