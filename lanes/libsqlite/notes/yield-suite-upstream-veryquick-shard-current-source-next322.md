# libsqlite suite upstream veryquick shard current-source next322

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next322 veryquick shard row.
...
exact-shard next148, runner106/jsonvt104 rebase items, accepted batch109-113 and batch222
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext322Test.php
