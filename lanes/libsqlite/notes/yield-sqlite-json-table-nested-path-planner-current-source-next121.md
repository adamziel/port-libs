...
- Added `SQLiteJsonTablePlan::currentSourceNestedPathPlannerNext121()`.
...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableNestedPathPlannerCurrentSourceNext121Test.php
...
php -l lanes/libsqlite/tests/SQLiteJsonTableNestedPathPlannerCurrentSourceNext121Test.php
php -l lanes/libsqlite/examples/wordpress-json-table-nested-path-current-source-next121.php
...
```text
php lanes/libsqlite/examples/wordpress-json-table-nested-path-current-source-next121.php
```
