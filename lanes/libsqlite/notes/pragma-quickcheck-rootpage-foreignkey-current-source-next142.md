# pragma-quickcheck-rootpage-foreignkey-current-source-next142

Slice: `pragma-quickcheck-rootpage-foreignkey-current-source-next142`.

This adds `SQLitePragmaQuickcheckRootpageForeignKeyCurrentSourceNext142Plan`,
...
- `php -l lanes/libsqlite/src/SQLitePragmaQuickcheckRootpageForeignKeyCurrentSourceNext142Plan.php`
  - `No syntax errors detected`
- `php -l lanes/libsqlite/tests/SQLitePragmaQuickcheckRootpageForeignKeyCurrentSourceNext142Test.php`
  - `No syntax errors detected`
- `php -l lanes/libsqlite/examples/wordpress-pragma-quickcheck-rootpage-foreignkey-current-source-next142.php`
  - `No syntax errors detected`
...
- `php lanes/libsqlite/examples/wordpress-pragma-quickcheck-rootpage-foreignkey-current-source-next142.php --self-test`
  - `wordpress-pragma-quickcheck-rootpage-foreignkey-current-source-next142 self-test passed`
