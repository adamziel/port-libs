...
- `php lanes/libsqlite/examples/application-utf16-rtrim-glob-affinity-current-source-next145.php --self-test`
  - `application-utf16-rtrim-glob-affinity-current-source-next145 self-test passed`
