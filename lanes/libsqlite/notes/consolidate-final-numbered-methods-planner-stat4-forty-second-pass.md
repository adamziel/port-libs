...
Direct planner tests and WordPress smoke examples were migrated to the
...
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next590-605.php`
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next590-605.php --self-test`
