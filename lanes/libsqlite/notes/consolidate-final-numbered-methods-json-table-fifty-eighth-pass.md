...
Direct JSON-table tests and WordPress examples were renamed away from their
...
- `php -l lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-batch.php`
- `php -l lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cursor.php`
...
- `php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-batch.php --self-test`
- `php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cursor.php --self-test`
