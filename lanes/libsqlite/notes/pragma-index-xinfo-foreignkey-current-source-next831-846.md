...
php -l lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next831-846.php
...
php lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next831-846.php --self-test
git diff --check
```
