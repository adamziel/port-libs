...
- WordPress smoke command: `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next224.php`
- WordPress smoke result: `wordpress-pager-master-journal-reader-cache-current-source-next224 self-test passed`.
