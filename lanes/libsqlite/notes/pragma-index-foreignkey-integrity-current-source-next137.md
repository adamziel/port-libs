...
```bash
$ php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIndexForeignKeyIntegrityCurrentSourceNext137Test.php
...
```bash
$ php lanes/libsqlite/examples/wordpress-pragma-index-foreignkey-integrity-current-source-next137.php --self-test
wordpress-pragma-index-foreignkey-integrity-current-source-next137 self-test passed
```
