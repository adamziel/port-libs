...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next230-233.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next230-233.php --self-test`
- `git diff --check`
