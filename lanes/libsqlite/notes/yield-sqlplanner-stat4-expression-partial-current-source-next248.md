...
The Application path is copied `wp_options` rows where plugin option names differ
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePlannerStat4ExpressionPartialCurrentSourceNext248Test.php`
  ...
  - 73 PASS lines
- `php lanes/libsqlite/examples/application-stat4-duplicate-run-current-source-next248.php`
...
- `php -l lanes/libsqlite/examples/application-stat4-duplicate-run-current-source-next248.php`
