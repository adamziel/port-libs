...
php lanes/libsqlite/examples/wordpress-dml-trigger-returning-conflict-current-source-next106.php
wordpress-dml-trigger-returning-conflict-current-source-next106 self-test passed
```
