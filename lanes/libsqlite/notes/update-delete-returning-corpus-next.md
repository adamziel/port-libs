...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-update-delete-returning-corpus.php` reports deleted transient rows, remaining option ids, and updated autoload rows with RETURNING aliases/computed values.
