...
- Updated the direct UTF-16 wrapper, focused glob tests, WordPress examples, and nearby notes to use the stable cursor name.
...
- `php -l lanes/libsqlite/examples/wordpress-option-name-glob-cursor.php`
- `php -l lanes/libsqlite/examples/wordpress-option-name-glob-malformed-utf-cursor.php`
- `php -l lanes/libsqlite/examples/wordpress-option-name-like-glob-malformed-cursor.php`
...
- `php lanes/libsqlite/examples/wordpress-option-name-glob-malformed-utf-cursor.php`
- `php lanes/libsqlite/examples/wordpress-option-name-like-glob-malformed-cursor.php`
