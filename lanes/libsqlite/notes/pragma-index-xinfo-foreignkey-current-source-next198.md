...
```text
php lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next198.php --self-test
application-pragma-index-xinfo-foreignkey-current-source-next198 self-test passed
```
