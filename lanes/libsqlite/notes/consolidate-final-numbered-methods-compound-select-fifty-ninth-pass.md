...
- Renamed the direct focused test and Application smoke from numbered paths to descriptive lag/lead distinct-union LIMIT/OFFSET paths.
...
- `php -l lanes/libsqlite/examples/application-compound-select-window-recursive-limit-lag-lead-distinct-union-limit-offset.php`
...
- `php lanes/libsqlite/examples/application-compound-select-window-recursive-limit-lag-lead-distinct-union-limit-offset.php --self-test`
