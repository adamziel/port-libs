...
- Direct WordPress smoke moved from its numbered predecessor to `wordpress-rowvalue-update-delete-returning-savepoint-preflight-retry.php`.
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-update-delete-returning-savepoint-preflight-retry.php --self-test`: self-test passed.
