...
- Example self-test: `wordpress-btree-vacuum-pointermap-freeblock-current-source-next623-638.php`
- Numbered source class: not added; the established local pattern uses the canonical `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan` entrypoints over the shared freelist current-source variant
