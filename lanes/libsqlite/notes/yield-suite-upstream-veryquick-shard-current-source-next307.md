# Upstream veryquick shard current-source next307
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext307()`,
...
classification, and focused PHP PASS-line output all match the next307
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext307Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext307Test.php
...
276/277/278/279 veryquick evidence, exact-shard next148, queued runner106/
jsonvt104 rebase work, accepted batch221 behavior surfaces, and live B-tree/
JSON/VFS/WAL/planner/PRAGMA/ATTACH/window/VDBE work.
