# Upstream veryquick shard current-source next340
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext340()`,
...
classification, and focused PHP PASS-line output all match the next340
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext340Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext340Test.php
...
batch223 behavior surfaces, and live B-tree/JSON/VFS/WAL/planner/PRAGMA/
