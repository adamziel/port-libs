# Upstream veryquick shard current-source next381
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext381()`,
...
classification, and focused PHP PASS-line output all match the next381
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext381Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext381Test.php
...
movement from `740 / 1589` to `741 / 1589`.
...
334/335/336/337/338/339 veryquick evidence, exact-shard next148, queued
runner106/jsonvt104 rebase work, accepted batch225 behavior surfaces, and live
