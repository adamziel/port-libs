...
- Updated the direct Application rowvalue window example for that range to call the canonical continuation helper instead of numbered production methods.
...
- `php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next366-373.php --self-test`
  - `application-rowvalue-returning-window-current-source-next366-373 self-test passed`
