...
- Tests:
  - `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext402417Plan.php`
  - `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext402417Test.php`
  - `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next402-417.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext402417Test.php`
  - `php lanes/libsqlite/examples/wordpress-vfs-current-source-next402-417.php --self-test`
