...
- Application smoke: `lanes/libsqlite/examples/application-option-name-glob-malformed-utf-cursor.php` reports damaged option-name prefix scans and Unicode class scans without requiring `ext/sqlite`.
