...
WordPress smoke: `wordpress-pager-master-journal-reader-cache-current-source-next257.php` models copied `wp_options` import behavior where schema and `active_plugins` pages remain reusable with the current recovered-page checksum receipt, while a stale options-root receipt forces a reader reopen before plugin import continues.
...
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next257.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePagerMasterJournalReaderCacheCurrentSourceNext257Test.php`
  - `1 test files, 59 assertions, 0 failures`
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next257.php --self-test`
  - `wordpress-pager-master-journal-reader-cache-current-source-next257 self-test passed`
