# Upstream veryquick shard current-source next373
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext373()`,
...
classification, and focused PHP PASS-line output all match the next373
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext373Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext373Test.php
...
file, exact `96` TestRunner PASS lines, `1340` assertions, and no failures.
