# Upstream veryquick shard current-source next237
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext237()`,
...
focused PHP PASS-line output all match the next237 evidence record.

Focused upstream denominator impact: `UPSTREAM_TEST_MANIFEST.json` mapped count
moves from `638` to `639`. The slice records focused current-source veryquick
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext237Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext237Test.php
...
220/222/224/225/226/227/228/229/230/231/232/233/234 veryquick evidence,
exact-shard next148, queued runner106/jsonvt104 rebase work, accepted batch203
behavior surfaces, current-source next115/next116 behavior work, and live
