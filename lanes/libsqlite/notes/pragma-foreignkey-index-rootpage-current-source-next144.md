# pragma-foreignkey-index-rootpage-current-source-next144

Slice: `pragma-foreignkey-index-rootpage-current-source-next144`.

This patch adds `SQLitePragmaForeignKeyIndexRootpageCurrentSourceNext144`, a
...
```sh
php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaForeignKeyIndexRootpageCurrentSourceNext144Test.php
# 1 test files, 66 assertions, 0 failures
# 51 PASS lines

php lanes/libsqlite/examples/wordpress-pragma-foreignkey-index-rootpage-current-source-next144.php --self-test
# wordpress-pragma-foreignkey-index-rootpage-current-source-next144 self-test passed
```
