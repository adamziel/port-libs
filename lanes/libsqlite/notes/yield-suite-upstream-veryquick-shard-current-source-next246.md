# libsqlite suite upstream veryquick shard current-source next246

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next246 veryquick shard row.
- Ties the row to launcher Base accepted HEAD
  `f05e736450d7801c62adf068b3f6ab2fd77cf19f` and current integration source
...
This avoids accepted next155 through next243 veryquick shard evidence,
exact-shard next148, runner106/jsonvt104 rebase items, accepted batch210
...
- `phpPass`: `122940 -> 123036`
- mapped coverage: `647 / 1589 -> 648 / 1589`
- focused test:
  `lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext246Test.php`

## Verification

```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext246Test.php
