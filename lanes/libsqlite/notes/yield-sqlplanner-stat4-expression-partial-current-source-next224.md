...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next224.php --self-test`
  - `wordpress-sqlplanner-stat4-expression-partial-current-source-next224 self-test passed`
