...
- Renamed the direct focused test and WordPress smoke from the numbered source-admission filename to stable unsuffixed filenames.
...
- `php -l lanes/libsqlite/examples/wordpress-trigger-recursive-view-returning-source-admission.php`
...
- `php lanes/libsqlite/examples/wordpress-trigger-recursive-view-returning-source-admission.php --self-test`
  - `wordpress-trigger-recursive-view-returning-source-admission self-test passed`
