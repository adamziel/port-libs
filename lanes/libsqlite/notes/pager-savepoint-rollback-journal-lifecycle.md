...
$ php -l lanes/libsqlite/examples/application-pager-savepoint-rollback-journal-lifecycle.php
No syntax errors detected in lanes/libsqlite/examples/application-pager-savepoint-rollback-journal-lifecycle.php

$ php lanes/libsqlite/examples/application-pager-savepoint-rollback-journal-lifecycle.php
{
