...
Adds `SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext211Plan`, a
...
```text
php -l lanes/libsqlite/src/SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext211Plan.php
