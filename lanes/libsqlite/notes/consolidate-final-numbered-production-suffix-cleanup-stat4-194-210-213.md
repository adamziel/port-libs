...
unchanged. Direct tests and WordPress examples were renamed to descriptive
...
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-distinct-residual.php`
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-peer-rowid-window.php`
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-like-case-fence.php`
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-distinct-residual.php`
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-peer-rowid-window.php`
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-like-case-fence.php`
