# Upstream veryquick shard current-source next376
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext376()`,
...
classification, and focused PHP PASS-line output all match the next376
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext376Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext376Test.php
...
file, exact `96` admitted TestRunner PASS lines, no failures, and no broad
runner launch. The admitted focused runner-output delta is exactly `96` PASS
lines.
...
exact-shard next148, runner106/jsonvt104 rebase work, accepted batch107
through batch225 behavior surfaces, and live B-tree/JSON/VFS/WAL/planner/
PRAGMA/ATTACH/window/VDBE work. It does not claim release/all parity.
