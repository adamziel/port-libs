...
- `php lanes/libsqlite/examples/wordpress-rowvalue-returning-window-current-source-next239.php`
  - exited `0`
...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-returning-window-current-source-next239.php`
  - `No syntax errors detected in lanes/libsqlite/examples/wordpress-rowvalue-returning-window-current-source-next239.php`
