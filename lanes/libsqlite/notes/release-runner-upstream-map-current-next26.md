...
```sh
php tools/run-tests.php lanes/libsqlite/tests/SQLiteReleaseRunnerUpstreamMapCurrentNext26Test.php
```
...
php -l lanes/libsqlite/tests/SQLiteReleaseRunnerUpstreamMapCurrentNext26Test.php
```
