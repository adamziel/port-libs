...
lookups and temp B-tree sorting for a Application-style `wp_options` plugin scan.

## Evidence

- Focused test: `php tools/run-tests.php lanes/libsqlite/tests/SQLiteStat4OrderCoveringCurrentSourceNext94Test.php`
- Example smoke: `php lanes/libsqlite/examples/application-planner-stat4-order-covering-current-source-next94.php --self-test`
- Lint: `php -l lanes/libsqlite/src/SQLiteStat4OrderCoveringCurrentSourceNextPlan.php`, `php -l lanes/libsqlite/tests/SQLiteStat4OrderCoveringCurrentSourceNext94Test.php`, `php -l lanes/libsqlite/examples/application-planner-stat4-order-covering-current-source-next94.php`
