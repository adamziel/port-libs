...
Application smoke: `application-rowvalue-returning-window-current-source-next446-461.php`
...
- `php -l lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next446-461.php`
...
- `php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next446-461.php --self-test`
- `git diff --check`
