...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePlannerCoveringExpressionRangeCurrentSourceNext134Test.php`
  - `1 test files, 67 assertions, 0 failures`
- `php lanes/libsqlite/examples/wordpress-covering-expression-range-current-source-next134.php --self-test`
  - `wordpress-covering-expression-range-current-source-next134 self-test passed`
