...
php -l lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-metrics-window.php
...
php lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-metrics-window.php --self-test
git diff --check
```
