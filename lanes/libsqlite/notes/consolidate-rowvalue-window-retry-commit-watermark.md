...
- Renamed the direct retry commit watermark test file to a stable canonical filename and updated the Application smoke to consume the unsuffixed keys.
...
- `php -l lanes/libsqlite/examples/application-rowvalue-returning-window-retry-commit-watermark.php`
...
- `php lanes/libsqlite/examples/application-rowvalue-returning-window-retry-commit-watermark.php --self-test`
  - Result: `application-rowvalue-returning-window-retry-commit-watermark self-test passed`
