...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-rtree-geometry-corpus.php` previews copied WordPress event/location rows filtered by RTREE-style rectangles without ext/sqlite.
