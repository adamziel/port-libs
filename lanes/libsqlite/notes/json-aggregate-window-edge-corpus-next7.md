...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-json-aggregate-window-edges.php` reports copied `wp_options` JSON window summaries with peer exclusion and JSONB decoded frames.
