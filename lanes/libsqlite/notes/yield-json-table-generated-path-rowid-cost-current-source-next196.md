...
```text
php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cost-current-source-next196.php --self-test
wordpress-json-table-generated-path-rowid-cost-current-source-next196 self-test passed
```
