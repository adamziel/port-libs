...
- Behavior: expression-index range planning now compares prepared and current
  ...
  selects current `sqlite_stat4` sample boundaries for a WordPress
...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-stat4-expression-range-current-source-next104.php`.
