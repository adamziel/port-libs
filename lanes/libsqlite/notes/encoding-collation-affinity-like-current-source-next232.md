...
- `php lanes/libsqlite/examples/wordpress-encoding-collation-affinity-like-current-source-next232.php --self-test`
- Result: `wordpress-encoding-collation-affinity-like-current-source-next232 self-test passed`
