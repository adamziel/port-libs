...
- Direct callers: renamed and updated the direct focused test and WordPress smoke away from generated numbered filenames.
- Evidence:
  - `php -l lanes/libsqlite/src/SQLiteCompoundSelectWindowRecursiveLimitCurrentSourceNextPlan.php`
  - `php -l lanes/libsqlite/tests/SQLiteCompoundSelectNamedWindowRecursiveLimitOffsetTest.php`
  - `php -l lanes/libsqlite/examples/wordpress-compound-select-named-window-recursive-limit-offset.php`
  ...
  - `php lanes/libsqlite/examples/wordpress-compound-select-named-window-recursive-limit-offset.php`
