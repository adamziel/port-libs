...
Implemented `SQLiteJsonTablePlan::currentSourceNestedHiddenCostNext129()` for
...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableNestedHiddenCostCurrentSourceNext129Test.php
...
```text
php lanes/libsqlite/examples/wordpress-json-table-nested-hidden-cost-current-source-next129.php
```
