...
2026-05-27 isolated slice `yield-sqlite-wordpress-migration-import-current-next22`.
...
- WordPress smoke: `examples/wordpress-insert-select-returning-current-next22.php` previews copied `wp_options` archive/import rows with `INSERT OR IGNORE ... SELECT ... RETURNING` labels before migration tooling trusts the copied database.
