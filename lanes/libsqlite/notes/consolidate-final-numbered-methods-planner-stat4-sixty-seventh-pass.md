...
markers, direct test filename, and WordPress smoke filename for the
...
- `php -l` for the five changed WordPress example files
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-late-prepared-handoff-continuation.php --self-test`
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-final-prepared-handoff-continuation.php --self-test`
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-advanced-prepared-handoff-continuation.php --self-test`
