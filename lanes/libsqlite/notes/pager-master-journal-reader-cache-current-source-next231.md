...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next231.php --self-test`
- Result: `wordpress-pager-master-journal-reader-cache-current-source-next231 self-test passed`
