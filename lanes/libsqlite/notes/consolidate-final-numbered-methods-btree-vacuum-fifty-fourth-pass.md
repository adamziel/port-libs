...
test and Application smoke now use the stable
...
- `php -l lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-freelist-splice-final-batch.php`
...
- `php lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-freelist-splice-final-batch.php`
