...
- Application path: `application-wal-hot-journal-savepoint-checkpoint-current-source-next221.php` models a copied plugin import that recovers a hot journal, checkpoints a savepoint batch, then publishes the next source after sidecar cleanup is durable.
...
- Focused verification:
  ...
  - `php lanes/libsqlite/examples/application-wal-hot-journal-savepoint-checkpoint-current-source-next221.php`
