# Upstream veryquick shard current-source next380
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext380()`,
...
classification, and focused PHP PASS-line output all match the next380
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext380Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext380Test.php
