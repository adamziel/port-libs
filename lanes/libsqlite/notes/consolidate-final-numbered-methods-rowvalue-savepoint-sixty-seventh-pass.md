...
Direct production caller `SQLiteVfsFileWriter`, focused tests, and Application savepoint examples now call the stable unsuffixed methods. No numbered compatibility methods were left behind.
...
- Changed Application examples:
  - `php lanes/libsqlite/examples/application-pager-savepoint-current-next64.php --self-test`
