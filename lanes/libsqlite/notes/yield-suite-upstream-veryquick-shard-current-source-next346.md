# Upstream veryquick shard current-source next346
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext346()`,
...
classification, and focused PHP PASS-line output all match the next346
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext346Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext346Test.php
php -r 'json_decode(file_get_contents("lanes/libsqlite/UPSTREAM_TEST_MANIFEST.json"), true, 512, JSON_THROW_ON_ERROR); json_decode(file_get_contents("lanes/libsqlite/lane-status.json"), true, 512, JSON_THROW_ON_ERROR);'
git diff --check -- lanes/libsqlite
```

Result: the focused upstream-suite evidence test passed with one test file,
exact `96` TestRunner PASS lines, `1420` assertions, and no failures.
...
surfaces, and live B-tree/JSON/VFS/WAL/planner/PRAGMA/ATTACH/window/VDBE
work.
