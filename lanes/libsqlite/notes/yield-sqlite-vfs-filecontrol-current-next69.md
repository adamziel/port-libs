# SQLite VFS File-Control Current/Next69

## Status delta

- Added `SQLiteVfsFileControlState::currentNext69()` for SQL/pragma-shaped VFS file-control sequences over current/next snapshots.
...
- Added `SQLiteVfsFileControlCurrentNext69Test.php` with 55 focused PASS cases and 184 assertions.
- Added the WordPress smoke `wordpress-vfs-filecontrol-current-next69.php` for copied `wp_options` import handles applying busy timeout, reserved bytes, mmap, size hint, and data-version controls without ext/sqlite.
...
php -l lanes/libsqlite/tests/SQLiteVfsFileControlCurrentNext69Test.php
No syntax errors detected in lanes/libsqlite/tests/SQLiteVfsFileControlCurrentNext69Test.php

php -l lanes/libsqlite/examples/wordpress-vfs-filecontrol-current-next69.php
No syntax errors detected in lanes/libsqlite/examples/wordpress-vfs-filecontrol-current-next69.php

php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsFileControlCurrentNext69Test.php
Focused test run: 1 selected test files (root lock skipped)
55 PASS lines
1 test files, 184 assertions, 0 failures

php lanes/libsqlite/examples/wordpress-vfs-filecontrol-current-next69.php
