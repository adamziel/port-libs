...
Implemented `SQLiteJsonTablePlan::currentSourceNestedConstraintOrderNext127()`.
...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableNestedConstraintOrderCurrentSourceNext127Test.php
