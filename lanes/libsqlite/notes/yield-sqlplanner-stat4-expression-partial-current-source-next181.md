...
Application path: copied `wp_options` option-name range scans over `lower(option_name)` can use a partial expression index for autoloaded plugin options after schema/stat4 changes, while excluding `autoload='no'`, theme, and other-blog rows.

## Verification

- `php -l lanes/libsqlite/src/SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan.php`
- `php -l lanes/libsqlite/tests/SQLitePlannerStat4ExpressionPartialCurrentSourceNext181Test.php`
- `php -l lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-source-next181.php`
...
- `php lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-source-next181.php`
