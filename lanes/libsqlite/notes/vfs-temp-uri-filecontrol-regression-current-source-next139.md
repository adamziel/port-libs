...
- Application path: import scratch/temp databases can carry URI metadata such as sorter role, checkpoint intent, and busy timeout while the live copied database still persists WAL-related controls through normal owner state.
- Focused evidence:
  ...
  - Example smoke: `php lanes/libsqlite/examples/application-vfs-temp-uri-filecontrol-regression-current-source-next139.php --self-test`
  - Result: `application-vfs-temp-uri-filecontrol-regression-current-source-next139 self-test passed`
