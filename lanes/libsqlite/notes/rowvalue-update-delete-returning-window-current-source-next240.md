...
- WordPress path: copied `wp_options` import/migration batches can summarize retry progress after rollback/release with peer/exclusion windows without requiring ext/sqlite.
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-returning-window-current-source-next240.php`
  - exited `0`
