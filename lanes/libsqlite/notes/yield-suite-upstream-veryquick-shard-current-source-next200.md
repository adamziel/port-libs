# Upstream veryquick shard current-source next200
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext200()`,
...
focused PHP PASS-line output all match the next200 evidence record.

Focused upstream denominator impact: `UPSTREAM_TEST_MANIFEST.json` mapped count
moves from `619` to `620`. The slice records focused current-source veryquick
...
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext200Test.php
...
file and exact `86` TestRunner PASS lines. The admitted focused runner-output
delta is exactly `86` PASS lines.
...
172/173/174/175/176/177/178/181/184/187/190/194 veryquick evidence, exact-shard
next148, queued suite156/160/162/163/165/168/170/182/183/185/186 manifest
conflict work, runner106/jsonvt104 rebase work, accepted batch181 behavior
surfaces, accepted batch107/108 and batch109-113 surfaces, and live
