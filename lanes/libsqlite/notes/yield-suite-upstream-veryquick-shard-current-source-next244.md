# Upstream veryquick shard current-source next244
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext244()`,
...
focused PHP PASS-line output all match the next244 evidence record.

Focused upstream denominator impact: `UPSTREAM_TEST_MANIFEST.json` mapped count
moves from `645` to `646`. The slice records focused current-source veryquick
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext244Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext244Test.php
...
240/241 veryquick evidence, exact-shard next148, queued suite156/160/162/163/
165/168/170/182/183/185/186/211 manifest-conflict work, runner106/jsonvt104
rebase work, accepted batch209 behavior surfaces, and live B-tree/JSON/VFS/
