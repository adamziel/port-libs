# Upstream veryquick shard current-source next226
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext226()`,
...
focused PHP PASS-line output all match the next226 evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext226Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext226Test.php
...
veryquick evidence, exact-shard next148, runner106/jsonvt104 rebase work,
accepted batch109-113 behavior surfaces, and live B-tree/JSON/VFS/WAL/planner/
