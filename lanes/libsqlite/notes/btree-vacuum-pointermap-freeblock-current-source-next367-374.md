# B-tree Vacuum Pointer-map Freeblock Current-source Next367-374

Next367-374 extends the existing next263/295-366 freelist splice current-source proof without adding a new support component.

- Source: `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextFreelistSpliceVariant`
- Added entrypoints: `tableLeafFromDeleteResultNext367()` through `tableLeafFromDeleteResultNext374()`
