...
Direct production adapter, focused test, and WordPress example callers now use
...
- `php -l lanes/libsqlite/examples/wordpress-planner-covering-stat4-range-current-source-next138.php`
...
- `php lanes/libsqlite/examples/wordpress-planner-stat4-covering-range-current-source-next140.php --self-test`
  - `wordpress-planner-stat4-covering-range-current-source-next140 self-test passed`
