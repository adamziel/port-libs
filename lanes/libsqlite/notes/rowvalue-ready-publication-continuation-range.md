...
- Migrates the direct range test and WordPress smoke to stable descriptive file names.
...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-ready-publication-continuation-range.php`
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-ready-publication-continuation-range.php --self-test`
