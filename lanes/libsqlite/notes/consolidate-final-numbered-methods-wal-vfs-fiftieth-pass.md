...
- Renamed the direct focused test and Application example entry points to stable descriptive filenames.
...
- `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-literal-arithmetic-branch-fence.php --self-test`
