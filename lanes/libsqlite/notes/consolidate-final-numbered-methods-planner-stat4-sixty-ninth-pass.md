...
`wordpress-planner-stat4-expression-partial-current-source-next174.php` to
...
- `php -l lanes/libsqlite/examples/wordpress-planner-stat4-expression-partial-current-source-range-rows.php`
...
- `php lanes/libsqlite/examples/wordpress-planner-stat4-expression-partial-current-source-range-rows.php --self-test`
