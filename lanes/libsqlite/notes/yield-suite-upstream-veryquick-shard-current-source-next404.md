# Upstream veryquick shard current-source next404
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext404()`,
...
classification, and focused PHP PASS-line output all match the next404
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext404Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext404Test.php
...
Non-overlap: this avoids accepted next155 through next381 veryquick shard
evidence, exact-shard next148, queued runner106/jsonvt104 rebase work,
accepted batch227 suite-only surfaces, and live B-tree/JSON/VFS/WAL/planner/
