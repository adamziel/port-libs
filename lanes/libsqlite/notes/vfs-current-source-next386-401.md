...
- Tests:
  - `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext386401Plan.php`
  - `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext386401Test.php`
  - `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next386-401.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext386401Test.php`
  - `php lanes/libsqlite/examples/wordpress-vfs-current-source-next386-401.php --self-test`
