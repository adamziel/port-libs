# Upstream veryquick shard current-source next337
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext337()`,
...
classification, and focused PHP PASS-line output all match the next337
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext337Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext337Test.php
...
file, exact `96` TestRunner PASS lines, `1504` assertions, and no failures.
