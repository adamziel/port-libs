...
This slice adds a focused WordPress `wp_options.option_name` RTRIM-collated
...
- Local WordPress smoke: `php lanes/libsqlite/examples/wordpress-rtrim-like-residual-next260.php`.
