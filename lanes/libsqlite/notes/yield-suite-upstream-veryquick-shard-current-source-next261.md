# libsqlite suite upstream veryquick shard current-source next261

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next261 veryquick shard row.
...
exact-shard next148, runner106/jsonvt104 rebase items, accepted batch216 and
batch109-113 behavior surfaces, and the live B-tree, JSON, VFS, WAL, planner,
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext261Test.php
