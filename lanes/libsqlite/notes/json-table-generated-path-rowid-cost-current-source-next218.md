...
```text
php lanes/libsqlite/examples/application-json-table-generated-path-rowid-cost-current-source-next218.php --self-test
application-json-table-generated-path-rowid-cost-current-source-next218 self-test passed
```
