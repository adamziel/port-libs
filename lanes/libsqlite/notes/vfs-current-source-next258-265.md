# VFS current-source next258-265

Behavior slice: `vfs-current-source-snapshot-reuse-publish-next258-265`

This prepares the follow-on VFS current-source layer after ready `next254-257`.
The slice keeps the acknowledged reuse-publish receipt from `next254-257`,
...
This does not touch prior `next254-257` files or repeat next206-209
capture/reuse, next214-217 readiness, next218-221 publish fencing, next226-229
lease validation, next234-237 acknowledgement gating, or next254-257 publish
...
- `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext258265Plan.php`
- `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext258265Test.php`
- `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next258-265.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext234237Test.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext258265Test.php`
