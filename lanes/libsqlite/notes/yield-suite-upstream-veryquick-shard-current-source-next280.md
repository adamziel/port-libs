# Upstream veryquick shard current-source next280
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext280()`,
...
focused PHP PASS-line output all match the next280 evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext280Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext280Test.php
