# Upstream veryquick shard current-source next227
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext227()`,
...
focused PHP PASS-line output all match the next227 evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext227Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext227Test.php
