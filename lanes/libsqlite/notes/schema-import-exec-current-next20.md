...
- Scope: bounded Application schema import execution for `CREATE TABLE`, `CREATE TEMP TABLE`, `CREATE INDEX`, and `CREATE UNIQUE INDEX` statements.
...
- Application smoke: `php lanes/libsqlite/examples/application-schema-import-exec-current-next20.php` prints imported `wp_options`, temp staging, and attached archive schema objects plus PRAGMA-derived columns/indexes.
