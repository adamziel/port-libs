...
- Renamed the Application smoke to `application-attach-temp-wal-schema-cache-publication-continuation.php`.
...
- `php -l lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-publication-continuation.php`
...
- `php lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-publication-continuation.php --self-test`
