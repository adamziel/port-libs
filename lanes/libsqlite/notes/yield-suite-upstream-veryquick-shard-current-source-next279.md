# Upstream veryquick shard current-source next279
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext279()`,
...
focused PHP PASS-line output all match the next279 evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext279Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext279Test.php
