...
This slice adds `SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext256Plan`, a bounded current-source admission guard for reopened WordPress readers after the accepted next252 post-truncate seal.
...
- `php -l lanes/libsqlite/src/SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext256Plan.php`
