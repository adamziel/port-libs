...
- `php -l lanes/libsqlite/examples/wordpress-wal-savepoint-master-journal-current-source-next82.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteWalSavepointMasterJournalCurrentSourceNext82Test.php`
- `php lanes/libsqlite/examples/wordpress-wal-savepoint-master-journal-current-source-next82.php`
