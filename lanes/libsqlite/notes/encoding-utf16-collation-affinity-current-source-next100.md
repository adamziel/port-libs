...
- WordPress smoke: `examples/wordpress-utf16-affinity-source-switch-current-source-next100.php` shows copied plugin option priority rows being reparsed after UTF-16LE/UTF-16BE source changes and numeric-affinity text fallback.
...
```text
php lanes/libsqlite/examples/wordpress-utf16-affinity-source-switch-current-source-next100.php
