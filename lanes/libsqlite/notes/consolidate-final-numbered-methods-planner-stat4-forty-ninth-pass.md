...
- Updated the five direct planner/STAT4 tests and four direct WordPress examples to call the descriptive methods.
...
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next510-525.php`
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next510-525.php --self-test`
