...
- `php lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next242.php --self-test`
  - `application-pragma-index-xinfo-foreignkey-current-source-next242 self-test passed`
...
- `php -l lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next242.php`
  - `No syntax errors detected in lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next242.php`
