# yield-sqlite-attach-temp-main-wal-schema-cache-current-next49

Adds `SQLiteAttachTempMainWalSchemaCachePlan`, a bounded native-PHP planner for
ATTACH/temp/main schema-cache current/next behavior when WAL page-1 schema
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteAttachTempMainWalSchemaCacheCurrentNext49Test.php`
- `php -l lanes/libsqlite/src/SQLiteAttachTempMainWalSchemaCachePlan.php`
- `php -l lanes/libsqlite/tests/SQLiteAttachTempMainWalSchemaCacheCurrentNext49Test.php`
- `php -l lanes/libsqlite/examples/wordpress-attach-temp-main-wal-schema-cache-current-next49.php`
- `php lanes/libsqlite/examples/wordpress-attach-temp-main-wal-schema-cache-current-next49.php --self-test`
