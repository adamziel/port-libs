...
- `wordpress-sqlplanner-stat4-unsampled-equality-bracket.php`

Verification:

- `php -l lanes/libsqlite/src/SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan.php`
- `php -l lanes/libsqlite/tests/SQLitePlannerStat4ExpressionPartialUnsampledEqualityBracketTest.php`
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-unsampled-equality-bracket.php`
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-unsampled-equality-bracket.php --self-test`
