...
- adds `SQLiteAttachWalTempSchemaCacheCurrentSourceNextPlan::currentSourceNext253260()`;
...
php -l lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-current-source-next253-260.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteAttachTempWalSchemaCacheCurrentSourceNext253260Test.php
php lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-current-source-next253-260.php --self-test
git diff --check
```
