# Upstream veryquick shard current-source next338
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext338()`,
...
classification, and focused PHP PASS-line output all match the next338
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext338Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext338Test.php
