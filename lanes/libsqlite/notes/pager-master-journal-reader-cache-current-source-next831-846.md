...
- Matching example: `wordpress-pager-master-journal-reader-cache-current-source-next831-846.php`
...
php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next831-846.php
...
php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next831-846.php
git diff --check
```
