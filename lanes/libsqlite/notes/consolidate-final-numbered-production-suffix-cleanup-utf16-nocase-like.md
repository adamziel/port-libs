...
- Renamed the paired focused tests and WordPress examples to descriptive unsuffixed filenames.
...
- `php -l lanes/libsqlite/examples/wordpress-utf16-nocase-like-range-bytes.php`
- `php -l lanes/libsqlite/examples/wordpress-utf16-nocase-like-residual.php`
...
- `php lanes/libsqlite/examples/wordpress-utf16-nocase-like-range-bytes.php`
- `php lanes/libsqlite/examples/wordpress-utf16-nocase-like-residual.php`
