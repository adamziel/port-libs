# Upstream veryquick shard current-source next231
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext231()`,
...
focused PHP PASS-line output all match the next231 evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext231Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext231Test.php
...
file and exact `100` TestRunner PASS lines. The admitted focused runner-output
delta is exactly `100` PASS lines.
...
runner106/jsonvt104 rebase work, accepted batch107/108, batch109-113, and
batch200 behavior surfaces, and live next228-next230 B-tree/JSON/VFS/WAL/
