...
names.
The direct tests and WordPress examples now use stable descriptive filenames:
...
- `wordpress-rowvalue-or-fail-savepoint-retry.php`
- `wordpress-rowvalue-pre-fail-rollback-retry.php`
- `wordpress-rowvalue-fail-statement-retry.php`
...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-or-fail-savepoint-retry.php`
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-pre-fail-rollback-retry.php`
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-fail-statement-retry.php`
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-or-fail-savepoint-retry.php --self-test`
- `php lanes/libsqlite/examples/wordpress-rowvalue-pre-fail-rollback-retry.php --self-test`
