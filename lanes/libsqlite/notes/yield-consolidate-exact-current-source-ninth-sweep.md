...
variants with descriptive stable names. Direct tests and WordPress smokes now
...
- `php lanes/libsqlite/examples/wordpress-hot-journal-savepoint-cache-current-source-next100.php --self-test`
  passed.
- `php lanes/libsqlite/examples/wordpress-pager-hot-journal-savepoint-cache-current-source-next149.php --self-test`
  passed.
- `php lanes/libsqlite/examples/wordpress-pager-hot-journal-savepoint-cache-current-source-next157.php --self-test`
  passed.
