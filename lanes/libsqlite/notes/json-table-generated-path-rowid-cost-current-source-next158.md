...
WordPress path: `wordpress-json-table-generated-path-rowid-cost-current-source-next158.php --self-test` models copied `wp_options` plugin settings where the current source can keep a generated-path rowid seek pinned, while the next import shifts sibling rules and must prepare a fresh cursor.
...
php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cost-current-source-next158.php --self-test
# wordpress-json-table-generated-path-rowid-cost-current-source-next158 self-test passed
```
