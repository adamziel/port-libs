...
- Example self-test: `application-rowvalue-returning-window-current-source-next670-685.php`
...
php -l lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next670-685.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext670685Test.php
php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next670-685.php --self-test
git diff --check
```
