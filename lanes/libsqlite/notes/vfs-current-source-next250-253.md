...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next250-253.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next250-253.php --self-test`
- `git diff --check`
