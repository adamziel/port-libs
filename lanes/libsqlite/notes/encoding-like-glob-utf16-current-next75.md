...
- WordPress smoke: `lanes/libsqlite/examples/wordpress-option-name-utf16-like-glob-current-next75.php` scans copied `wp_options.option_name` UTF-16 bytes for escaped literal-percent LIKE predicates and supplementary-plane GLOB class predicates without requiring `ext/sqlite`.
...
$ php -l lanes/libsqlite/examples/wordpress-option-name-utf16-like-glob-current-next75.php
No syntax errors detected in lanes/libsqlite/examples/wordpress-option-name-utf16-like-glob-current-next75.php
...
$ php lanes/libsqlite/examples/wordpress-option-name-utf16-like-glob-current-next75.php
```
