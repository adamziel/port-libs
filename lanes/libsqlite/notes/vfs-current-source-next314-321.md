...
- Tests:
  ...
  - `php -l lanes/libsqlite/examples/application-vfs-current-source-next314-321.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNextTest.php`
  - `php lanes/libsqlite/examples/application-vfs-current-source-next314-321.php --self-test`
