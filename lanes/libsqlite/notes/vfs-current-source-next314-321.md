...
- Tests:
  - `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext314321Plan.php`
  - `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext314321Test.php`
  - `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next314-321.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext314321Test.php`
