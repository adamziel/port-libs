...
- Application path: `application-wal-hot-journal-savepoint-checkpoint-current-source-next228.php` models a copied plugin import that reopens `wp_options` readers after durable checkpoint-source publication.
...
- Focused verification:
  ...
  - `php lanes/libsqlite/examples/application-wal-hot-journal-savepoint-checkpoint-current-source-next228.php --self-test`
