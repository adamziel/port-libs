...
- Added `wordpress-vfs-open-lock-filecontrol-current-source-next82.php` smoke for copied `wp_options` database open/reopen control handoff without requiring `ext/sqlite`.
...
php -l lanes/libsqlite/examples/wordpress-vfs-open-lock-filecontrol-current-source-next82.php
No syntax errors detected in lanes/libsqlite/examples/wordpress-vfs-open-lock-filecontrol-current-source-next82.php

php lanes/libsqlite/examples/wordpress-vfs-open-lock-filecontrol-current-source-next82.php
wordpress-vfs-open-lock-filecontrol-current-source-next82 self-test passed
```
