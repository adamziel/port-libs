# libsqlite suite upstream veryquick shard current-source next319

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next319 veryquick shard row.
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext319Test.php
