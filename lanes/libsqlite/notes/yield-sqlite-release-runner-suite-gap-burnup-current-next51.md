...
- Adds `SQLiteUpstreamSuiteEvidence::releaseRunnerSuiteGapBurnupCurrentNext51()`.
- Adds focused coverage in `SQLiteReleaseRunnerSuiteGapBurnupCurrentNext51Test.php`.
...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLiteReleaseRunnerSuiteGapBurnupCurrentNext51Test.php
