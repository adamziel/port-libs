...
- Renamed the direct pager-master test and Application example to descriptive unsuffixed names.
...
- `php -l lanes/libsqlite/examples/application-pager-master-journal-reader-cache-vdbe-opcode-branch-handoff-fence.php`
...
- `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-vdbe-opcode-branch-handoff-fence.php`
