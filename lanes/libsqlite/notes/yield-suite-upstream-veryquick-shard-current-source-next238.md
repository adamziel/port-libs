# Upstream veryquick shard current-source next238
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceShard(238, ...)`,
...
focused PHP PASS-line output all match the next238 evidence record.

Focused upstream denominator impact: `UPSTREAM_TEST_MANIFEST.json` mapped count
moves from `639` to `640`. The slice records focused current-source veryquick
...
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext238Test.php
...
220/222/224/225/226/227/228/229/230/231/232/233/234/235 veryquick evidence, exact-shard next148,
