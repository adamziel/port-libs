...
- WordPress smoke: copied `wp_options` import through a recursive view trigger keeps current source visible and suppresses attempted next-source `RETURNING` rows until reprepare/admission.
