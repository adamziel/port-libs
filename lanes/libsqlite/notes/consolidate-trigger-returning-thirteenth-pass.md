...
- `php lanes/libsqlite/examples/application-trigger-recursive-returning-savepoint-source-comparison.php --self-test`
  - self-test passed
- `php lanes/libsqlite/examples/application-trigger-recursive-returning-savepoint-current-source.php`
