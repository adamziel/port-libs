...
- Behavior: adds `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext154Plan`, a current-source wrapper over the existing table-leaf delete/freeblock and pointer-map vacuum path.
