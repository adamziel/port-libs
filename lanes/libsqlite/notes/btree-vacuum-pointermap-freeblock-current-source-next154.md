...
- Behavior: adds `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan`, a current-source wrapper over the existing table-leaf delete/freeblock and pointer-map vacuum path.
...
- Application smoke: `php lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-next154.php --self-test`.
