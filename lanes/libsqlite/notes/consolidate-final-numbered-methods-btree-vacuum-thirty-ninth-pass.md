...
Direct tests, Application examples, and the historical lane notes were migrated
...
- `php -l lanes/libsqlite/examples/application-btree-overflow-freepage-vacuum.php`
...
- `php lanes/libsqlite/examples/application-btree-overflow-pointermap-freepage.php --self-test`
- `php lanes/libsqlite/examples/application-btree-overflow-freepage-vacuum.php --self-test`
- `php lanes/libsqlite/examples/application-btree-incremental-vacuum-reuse.php --self-test`
