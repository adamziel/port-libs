...
WordPress import preflight that composes native `PRAGMA integrity_check`,
...
- `php lanes/libsqlite/examples/wordpress-pragma-integrity-freelist-foreignkey-current-next49.php --self-test`
  - `wordpress-pragma-integrity-freelist-foreignkey-current-next49 self-test passed`
...
- Avoids accepted PRAGMA rootpage diagnostics, PRAGMA index/freelist
  ...
  only the composed current/next PRAGMA gate for WordPress import staging.
