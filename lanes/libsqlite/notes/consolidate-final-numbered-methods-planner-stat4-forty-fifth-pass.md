...
- `php lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-source-next878-893.php --self-test`
...
- `php lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-advanced-prepared-handoff.php --self-test`
