# Upstream veryquick shard current-source next367
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext367()`,
...
classification, and focused PHP PASS-line output all match the next367
evidence record.
...
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext367Test.php
