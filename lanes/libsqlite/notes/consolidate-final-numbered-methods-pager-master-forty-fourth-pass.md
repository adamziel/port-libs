...
- Updated the direct focused test and WordPress example to call the stable entry point.
...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next783-798.php --self-test`
