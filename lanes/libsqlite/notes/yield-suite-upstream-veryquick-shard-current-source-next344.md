# Upstream veryquick shard current-source next344
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext344()`,
...
classification, and focused PHP PASS-line output all match the next344
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext344Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext344Test.php
