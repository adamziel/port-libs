...
- Renamed the direct focused test and Application smoke file away from numbered current-source wording.
...
- `php -l lanes/libsqlite/examples/application-pager-master-journal-reader-cache-master-deleted-generation.php`
...
- `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-master-deleted-generation.php --self-test`
  - `application-pager-master-journal-reader-cache-master-deleted-generation self-test passed`
