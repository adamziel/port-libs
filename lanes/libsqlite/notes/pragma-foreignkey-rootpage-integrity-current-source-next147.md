# pragma-foreignkey-rootpage-integrity-current-source-next147
...
- `SQLitePragmaForeignKeyRootpageIntegrityCurrentSourceNext147` composes the
...
- WordPress smoke:
  `php lanes/libsqlite/examples/wordpress-pragma-foreignkey-rootpage-integrity-current-source-next147.php --self-test`
  reports `wordpress-pragma-foreignkey-rootpage-integrity-current-source-next147 self-test passed`.

Focused verification:

```text
php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaForeignKeyRootpageIntegrityCurrentSourceNext147Test.php
