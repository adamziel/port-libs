...
WordPress smoke:
- `php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cost-current-source-next271.php --self-test`
- Result: `wordpress-json-table-generated-path-rowid-cost-current-source-next271 self-test passed`
