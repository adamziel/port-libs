...
```bash
php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cost-current-source-next173.php --self-test
```

Result:

```text
wordpress-json-table-generated-path-rowid-cost-current-source-next173 self-test passed
```
