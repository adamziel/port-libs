...
- Scope: adds a focused UTF-16LE/UTF-16BE `LIKE 'plugin%'` NOCASE current-source/next-source planner for copied WordPress `wp_options.option_name` rows.
...
php lanes/libsqlite/examples/wordpress-utf16-nocase-like-current-source-next126.php
...
php -l lanes/libsqlite/examples/wordpress-utf16-nocase-like-current-source-next126.php
