...
```text
php lanes/libsqlite/examples/wordpress-utf16-nocase-like-rtrim-current-source-next172.php --self-test
wordpress-utf16-nocase-like-rtrim-current-source-next172 self-test passed
```
