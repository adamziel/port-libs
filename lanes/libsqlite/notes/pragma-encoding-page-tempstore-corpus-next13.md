...
- `php lanes/libsqlite/examples/wordpress-pragma-encoding-page-tempstore.php`: printed copied `wp_options` pragma preflight JSON with UTF-16le encoding, 8192-byte page size, 18 pages, MEMORY temp_store, and dependency tags.
...
- `php -l lanes/libsqlite/examples/wordpress-pragma-encoding-page-tempstore.php`: no syntax errors.
