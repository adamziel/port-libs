...
- WordPress smoke: `lanes/libsqlite/examples/wordpress-utf16-nocase-like-rtrim-nul-current-source-next.php` covers copied `wp_options.option_name` rows where plugin option names contain embedded NULs and must not be truncated before import/diff scans.
- Focused verification:
  ...
  - `php lanes/libsqlite/examples/wordpress-utf16-nocase-like-rtrim-nul-current-source-next.php --self-test`
  - Result: `wordpress-utf16-nocase-like-rtrim-nul-current-source-next self-test passed`
