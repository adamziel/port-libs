...
- `php -l lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-union-tail-boundary.php` -> no syntax errors.
- `php -l lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-comma-boundary.php` -> no syntax errors.
- `php -l lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-negative-boundary.php` -> no syntax errors.
...
- `php lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-union-tail-boundary.php --self-test` -> passed.
- `php lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-comma-boundary.php --self-test` -> passed.
- `php lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-negative-boundary.php --self-test` -> passed.
