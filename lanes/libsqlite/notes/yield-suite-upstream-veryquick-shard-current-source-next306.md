# Upstream veryquick shard current-source next306
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext306()`,
...
classification, and focused PHP PASS-line output all match the next306
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext306Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext306Test.php
...
runner106/jsonvt104 rebase work, accepted batch109-113 behavior surfaces, and
