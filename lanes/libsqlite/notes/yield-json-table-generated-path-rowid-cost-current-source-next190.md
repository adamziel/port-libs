...
WordPress smoke: `wordpress-json-table-generated-path-rowid-cost-current-source-next190.php` covers copied `wp_options` plugin-rule diagnostics where a `json_tree()` generated-path/rowid yield may emit the current xColumn row only while the current source and snapshot fingerprint still match.
...
- `php -l lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cost-current-source-next190.php`
  - `No syntax errors detected in lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cost-current-source-next190.php`
...
- `php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-cost-current-source-next190.php --self-test`
  - `wordpress-json-table-generated-path-rowid-cost-current-source-next190 self-test passed`
