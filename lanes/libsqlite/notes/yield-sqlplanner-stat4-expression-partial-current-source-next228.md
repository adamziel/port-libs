...
Application-style `wp_options` cursor can keep using the partial expression
index.
...
- `php -l lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-source-next228.php`
...
- `php lanes/libsqlite/examples/application-sqlplanner-stat4-expression-partial-current-source-next228.php --self-test`
  - Result: `stat4-expression-partial-current-source-next228-ready`

Application path: the example models an autoloaded plugin-option scan over copied
