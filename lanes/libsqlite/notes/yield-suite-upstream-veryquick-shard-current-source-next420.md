# Upstream veryquick shard current-source next420
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext420()`,
...
classification, and focused PHP PASS-line output all match the next420
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext420Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext420Test.php
...
batch109-113 and batch227 suite surfaces, and live B-tree/JSON/VFS/WAL/
