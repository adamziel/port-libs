...
- Non-overlap: avoids accepted next164/next161/next159/next157/next155 veryquick shard evidence, next148 exact-shard evidence, runner106/jsonvt104 queued rebase work, and all accepted SQL, JSON, WAL, VFS, B-tree, PRAGMA, planner, encoding, trigger/FK, and WordPress runtime behavior clusters.
