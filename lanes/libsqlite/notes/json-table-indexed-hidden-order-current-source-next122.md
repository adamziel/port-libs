...
This slice adds `SQLiteJsonTablePlan::currentSourceIndexedHiddenOrderNext122()`
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableIndexedHiddenOrderCurrentSourceNext122Test.php`
  - `1 test files, 54 assertions, 0 failures`
  - 54 PASS lines
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableIndexedConstraintCostCurrentSourceNext119Test.php lanes/libsqlite/tests/SQLiteJsonTableIndexedHiddenOrderCurrentSourceNext122Test.php`
  - focused regression pair for accepted next119 plus next122
- `php -l lanes/libsqlite/src/SQLiteJsonTablePlan.php`
- `php -l lanes/libsqlite/tests/SQLiteJsonTableIndexedHiddenOrderCurrentSourceNext122Test.php`
- `php -l lanes/libsqlite/examples/wordpress-json-table-indexed-hidden-order-current-source-next122.php`
- `php lanes/libsqlite/examples/wordpress-json-table-indexed-hidden-order-current-source-next122.php --self-test`
