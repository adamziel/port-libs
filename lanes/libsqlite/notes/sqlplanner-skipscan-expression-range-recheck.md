...
- Smoke evidence: `php lanes/libsqlite/examples/wordpress-skipscan-expression-range-recheck.php` reports `requires-current-source-range-recheck`, accepted rowids `[1,2]`, rejected rowid `[3]`, and `RecheckExpressionRange`.
