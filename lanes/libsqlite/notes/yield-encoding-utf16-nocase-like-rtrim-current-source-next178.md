...
```text
php lanes/libsqlite/examples/wordpress-utf16-nocase-like-rtrim-current-source-next178.php
wordpress-utf16-nocase-like-rtrim-current-source-next178 self-test passed
```
