...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-reader-frame-fence.php` passes and models a copied plugin import recovering a hot journal before checkpointing the savepoint-visible pages.
