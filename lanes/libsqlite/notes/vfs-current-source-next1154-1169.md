...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next1154-1169.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next1154-1169.php --self-test`
