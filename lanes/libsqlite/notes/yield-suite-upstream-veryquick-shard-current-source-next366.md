# Upstream veryquick shard current-source next366
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext366()`,
...
classification, and focused PHP PASS-line output all match the next366
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext366Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext366Test.php
