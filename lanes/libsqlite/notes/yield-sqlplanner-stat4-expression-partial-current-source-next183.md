...
WordPress path: copied `wp_options` plugin preload queries such as
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next183.php --self-test`
  - `wordpress-sqlplanner-stat4-expression-partial-current-source-next183 self-test passed`
