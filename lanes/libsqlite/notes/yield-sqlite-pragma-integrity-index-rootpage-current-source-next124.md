...
Slice: `pragma-integrity-index-rootpage-current-source-next124`.

This adds `SQLitePragmaIntegrityIndexRootpageCurrentSourceNext124`, a focused
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIntegrityIndexRootpageCurrentSourceNext124Test.php`
  - `1 test files, 81 assertions, 0 failures`
- `php lanes/libsqlite/examples/wordpress-pragma-integrity-index-rootpage-current-source-next124.php --self-test`
  - `wordpress-pragma-integrity-index-rootpage-current-source-next124 self-test passed`
