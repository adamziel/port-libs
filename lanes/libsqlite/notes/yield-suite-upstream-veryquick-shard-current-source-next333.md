# Upstream veryquick shard current-source next333
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext333()`,
...
classification, and focused PHP PASS-line output all match the next333
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext333Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext333Test.php
