# Upstream veryquick shard current-source next334
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext334()`,
...
classification, and focused PHP PASS-line output all match the next334
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext334Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext334Test.php
