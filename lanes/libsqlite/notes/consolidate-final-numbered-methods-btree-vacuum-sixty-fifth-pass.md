...
- Renamed the two direct tests and Application examples to descriptive
...
- `php -l lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-publication.php`
- `php -l lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-receipt-publication.php`
...
- `php lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-publication.php`
- `php lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-receipt-publication.php`
