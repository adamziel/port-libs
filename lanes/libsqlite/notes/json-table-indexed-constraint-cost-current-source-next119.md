...
- `php -l lanes/libsqlite/tests/SQLiteJsonTableIndexedConstraintCostCurrentSourceNext119Test.php`
- `php -l lanes/libsqlite/examples/wordpress-json-table-indexed-constraint-cost-current-source-next119.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableIndexedConstraintCostCurrentSourceNext119Test.php`
- Result: `1 test files, 52 assertions, 0 failures`
- Focused PASS-line delta: `+52`
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-json-table-indexed-constraint-cost-current-source-next119.php --self-test`
- Smoke result: `wordpress-json-table-indexed-constraint-cost-current-source-next119 self-test passed`
