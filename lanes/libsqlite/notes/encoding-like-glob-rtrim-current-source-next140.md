...
- `php lanes/libsqlite/examples/wordpress-option-name-rtrim-like-glob-current-source-next140.php --self-test`
  - `wordpress-option-name-rtrim-like-glob-current-source-next140 self-test passed`
