...
Application smoke: `application-wal-hot-journal-savepoint-checkpoint-current-source-next225.php` covers a copied `wp_options` import that recovers a hot journal, finalizes plugin savepoints, checkpoints WAL frames, and admits the database header only after all three header receipt regions match the checkpoint cookies.
...
php -l lanes/libsqlite/examples/application-wal-hot-journal-savepoint-checkpoint-current-source-next225.php
...
No syntax errors detected in lanes/libsqlite/examples/application-wal-hot-journal-savepoint-checkpoint-current-source-next225.php
...
php lanes/libsqlite/examples/application-wal-hot-journal-savepoint-checkpoint-current-source-next225.php
