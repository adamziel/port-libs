...
- Migrated the direct focused test and WordPress example from numbered filenames to unsuffixed descriptive filenames.

## Evidence

- `php -l lanes/libsqlite/src/SQLitePlannerStat4ExpressionPartialCurrentSourceNextPlan.php`
- `php -l lanes/libsqlite/tests/SQLitePlannerStat4ExpressionPartialRangeCurrentSourceTest.php`
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-range-current-source.php`
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-range-current-source.php --self-test`
