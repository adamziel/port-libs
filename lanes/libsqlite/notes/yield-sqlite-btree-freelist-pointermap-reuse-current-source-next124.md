...
- Application smoke: `examples/application-btree-freelist-pointermap-reuse-current-source-next124.php` models copied `wp_options` cleanup freeing a page while the freelist trunk is full, followed by immediate reuse for a replacement table leaf.
...
- `php -l lanes/libsqlite/examples/application-btree-freelist-pointermap-reuse-current-source-next124.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteBTreeFreelistPointerMapReuseCurrentSourceNext124Test.php`
  ...
  - 80 PASS lines
- `php lanes/libsqlite/examples/application-btree-freelist-pointermap-reuse-current-source-next124.php`
