...
Direct tests, Application examples, notes, dependency markers, and scenario names
...
- `php -l lanes/libsqlite/examples/application-json-table-rowid-hidden-path-current-source.php`
- `php -l lanes/libsqlite/examples/application-json-table-hidden-rowid-path-current-source.php`
