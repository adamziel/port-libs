...
- `php -l lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next273-276-after-current.php`
...
- `php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next273-276-after-current.php --self-test`
- `git diff --check`
