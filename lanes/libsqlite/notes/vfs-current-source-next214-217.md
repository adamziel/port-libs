...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next214-217.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNextTest.php`
- `php lanes/libsqlite/examples/application-vfs-current-source-next214-217.php --self-test`
- `git diff --check`
