...
Adds `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan`, a focused follow-up to next224 current-source cursor sequencing. The new plan builds resumable source-window receipts over the vacuum pointer-map/freeblock rows and validates that:
