...
WordPress option names. It focuses on the upstream behavior that index scan
...
- Example smoke: `php lanes/libsqlite/examples/wordpress-utf16-nocase-like-rtrim-current-source-next171.php --self-test`
