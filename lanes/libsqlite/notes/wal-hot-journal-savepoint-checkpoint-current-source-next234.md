...
- `php lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next234.php --self-test`
  - `wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next234 self-test passed`
