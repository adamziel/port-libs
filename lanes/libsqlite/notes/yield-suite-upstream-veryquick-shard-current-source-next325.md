# Upstream veryquick shard current-source next325
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext325()`,
...
classification, and focused PHP PASS-line output all match the next325
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext325Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext325Test.php
...
behavior surfaces, batch223 suite rows, and live B-tree/JSON/VFS/WAL/planner/
