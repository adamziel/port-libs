...
WordPress smoke away from the old `current-next64` file names. Production now
...
- `php -l lanes/libsqlite/examples/wordpress-pager-savepoint-wal-retry.php`
...
- `php lanes/libsqlite/examples/wordpress-pager-savepoint-wal-retry.php --self-test`
