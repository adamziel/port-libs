# Upstream veryquick shard current-source next412
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext412()`,
...
classification, and focused PHP PASS-line output all match the next412
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext412Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext412Test.php
