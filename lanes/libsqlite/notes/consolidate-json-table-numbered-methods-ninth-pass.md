...
- `php lanes/libsqlite/examples/application-json-table-lateral-planner-current-source-next100.php --self-test` passed.
- `php lanes/libsqlite/examples/application-json-table-hidden-constraint-source-current-source-next102.php --self-test` passed.
- `php lanes/libsqlite/examples/application-json-table-lateral-hidden-constraint-current-source-next103.php --self-test` exited 0 with the expected JSON smoke payload.
- `php lanes/libsqlite/examples/application-json-table-lateral-rowid-hidden-current-source-next105.php --self-test` passed.
