...
```text
php lanes/libsqlite/examples/wordpress-utf16-nocase-like-rtrim-current-source-next157.php
```
...
No new support component is needed. The slice reuses native UTF-16 decode validation, existing LIKE prefix planning, the existing NOCASE/RTRIM current-source cursor plan, and lane-local WordPress smoke coverage.
