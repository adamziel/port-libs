...
php lanes/libsqlite/examples/application-subquery-covering-partial-current-source-next115.php
...
php -l lanes/libsqlite/examples/application-subquery-covering-partial-current-source-next115.php
