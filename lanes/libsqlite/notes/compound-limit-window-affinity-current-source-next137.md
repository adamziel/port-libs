...
```sh
php lanes/libsqlite/examples/wordpress-compound-limit-window-affinity-current-source-next137.php --self-test
# wordpress-compound-limit-window-affinity-current-source-next137 self-test passed
```
...
# No syntax errors detected in lanes/libsqlite/examples/wordpress-compound-limit-window-affinity-current-source-next137.php
...
between current and next WordPress option sources.
