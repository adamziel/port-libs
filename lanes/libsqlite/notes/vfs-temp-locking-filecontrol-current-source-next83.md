...
- Added a WordPress smoke for copied `wp_options` temp statement-journal
...
# wordpress-vfs-temp-locking-filecontrol-current-source-next83 self-test passed
...
php -l lanes/libsqlite/examples/wordpress-vfs-temp-locking-filecontrol-current-source-next83.php
