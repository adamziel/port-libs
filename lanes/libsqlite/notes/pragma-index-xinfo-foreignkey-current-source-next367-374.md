...
php -l lanes/libsqlite/examples/wordpress-pragma-index-xinfo-foreignkey-current-source-next367-374.php
...
php lanes/libsqlite/examples/wordpress-pragma-index-xinfo-foreignkey-current-source-next367-374.php --self-test
git diff --check
```
...
```text
wordpress-pragma-index-xinfo-foreignkey-current-source-next367-374 self-test passed
```
