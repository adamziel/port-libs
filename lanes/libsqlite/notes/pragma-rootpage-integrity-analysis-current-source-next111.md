# pragma-rootpage-integrity-analysis-current-source-next111

This slice adds `SQLitePragmaRootpageIntegrityAnalysisCurrentSourceNext111`, a
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaRootpageIntegrityAnalysisCurrentSourceNext111Test.php
...
```text
$ php lanes/libsqlite/examples/wordpress-pragma-rootpage-integrity-analysis-current-source-next111.php
```
