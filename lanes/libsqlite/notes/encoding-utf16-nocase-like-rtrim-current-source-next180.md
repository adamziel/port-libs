...
Application path: `application-utf16-nocase-like-rtrim-current-source-next180.php` models copied `wp_options.option_name` plugin keys with localized non-ASCII prefixes during a current/next source transition.
...
- `php -l lanes/libsqlite/examples/application-utf16-nocase-like-rtrim-current-source-next180.php`
  - `No syntax errors detected in lanes/libsqlite/examples/application-utf16-nocase-like-rtrim-current-source-next180.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext180Test.php`
  ...
  - `56` PASS lines
- `php lanes/libsqlite/examples/application-utf16-nocase-like-rtrim-current-source-next180.php --self-test`
  - `application-utf16-nocase-like-rtrim-current-source-next180 self-test passed`
