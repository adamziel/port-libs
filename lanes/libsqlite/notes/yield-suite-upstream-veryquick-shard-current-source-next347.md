# Upstream veryquick shard current-source next347
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext347()`,
...
classification, and focused PHP PASS-line output all match the next347
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext347Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext347Test.php
...
file, exact `96` TestRunner PASS lines, `1285` assertions, no failures, and a
focused admission delta of `96` PASS lines.
...
VDBE work. It also makes no release/all parity claim.
