...
- Migrated direct b-tree delete-overflow tests and the Application smoke to stable file/class names.
...
- `php lanes/libsqlite/examples/application-btree-delete-overflow.php`: passed.
- `php lanes/libsqlite/examples/application-btree-overflow-delete-pointermap-current-source-next86.php`: passed.
