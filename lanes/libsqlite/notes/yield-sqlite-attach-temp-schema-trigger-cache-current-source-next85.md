# attach-temp-schema-trigger-cache-current-source-next85
...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLiteAttachTempSchemaTriggerCacheCurrentSourceNext85Test.php
```
...
```text
php lanes/libsqlite/examples/wordpress-attach-temp-schema-trigger-cache-current-source-next85.php --self-test
```

## Non-Overlap

This does not repeat accepted ATTACH WAL/temp rollback routing, temp WAL schema
cache, view-cache current-source next82, or view/trigger route plans. The new
