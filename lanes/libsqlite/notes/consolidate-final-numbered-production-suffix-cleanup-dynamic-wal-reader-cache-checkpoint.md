...
- `php -l lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-reader-admission.php`
...
- `php lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-reader-admission.php`
