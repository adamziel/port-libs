...
- Added WordPress smoke `wordpress-select-planner-join-fences.php` for copied `wp_posts` / `wp_postmeta` and `wp_options` diagnostics.
...
- `php -l lanes/libsqlite/src/SQLiteJoinOrderPlan.php && php -l lanes/libsqlite/tests/SQLiteSelectPlannerJoinFencesCurrentTest.php && php -l lanes/libsqlite/examples/wordpress-select-planner-join-fences.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteSelectPlannerJoinFencesCurrentTest.php`
- `php lanes/libsqlite/examples/wordpress-select-planner-join-fences.php`
