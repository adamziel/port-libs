...
- Adds WordPress smoke `wordpress-btree-vacuum-pointermap-freeblock-current-source-next250.php` for copied `wp_options` transient cleanup after vacuumed overflow pages.
- Verification:
  ...
  - `php -l lanes/libsqlite/examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next250.php`
  ...
  - `php lanes/libsqlite/examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next250.php` -> self-test passed.
