...
- Tests:
  - `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext354369Plan.php`
  - `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext354369Test.php`
  - `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next354-369.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext354369Test.php`
