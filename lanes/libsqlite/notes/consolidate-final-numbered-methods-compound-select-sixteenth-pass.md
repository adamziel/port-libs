...
- The direct focused test and Application example were renamed to unsuffixed files and migrated to the canonical method.
...
- `php lanes/libsqlite/examples/application-compound-except-order-affinity-current-source-next.php --self-test`
