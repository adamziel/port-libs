# Upstream veryquick shard current-source next305
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext305()`,
...
classification, and focused PHP PASS-line output all match the next305
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext305Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext305Test.php
