...
- `php lanes/libsqlite/examples/wordpress-planner-stat4-partial-index-current-source-next88.php --self-test`
  - `wordpress-planner-stat4-partial-index-current-source-next88 self-test passed`
