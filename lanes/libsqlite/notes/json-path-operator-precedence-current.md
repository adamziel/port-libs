...
- Preserved explicit-parentheses composition for Application-style copied `wp_options` JSON diagnostics.
- Added a Application smoke for JSON path operator precedence and dynamic RHS path construction.

## Evidence

- `php -l lanes/libsqlite/src/SQLiteSelectSql.php`
- `php -l lanes/libsqlite/tests/SQLiteJsonbPathOperatorIndexCurrentNext15Test.php`
- `php -l lanes/libsqlite/examples/application-json-path-operator-precedence.php`
...
- `php lanes/libsqlite/examples/application-json-path-operator-precedence.php --self-test`
  - `application-json-path-operator-precedence self-test passed`
