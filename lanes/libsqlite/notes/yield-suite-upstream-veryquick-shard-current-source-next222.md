# Upstream veryquick shard current-source next222
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext222()`,
...
focused PHP PASS-line output all match the next222 evidence record.

Focused upstream denominator impact: `UPSTREAM_TEST_MANIFEST.json` mapped count
moves from `624` to `625`. The slice records focused current-source veryquick
...
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext222Test.php
...
file and exact `96` TestRunner PASS lines. The admitted focused runner-output
delta is exactly `96` PASS lines.
...
172/173/174/175/176/177/178/181/184/187/190/194/200/202/209/212/213 veryquick
...
accepted batch197 behavior surfaces, accepted batch107/108 and batch109-113
