...
Application relevance: copied `wp_termmeta` or import staging tables may have
...
- `php lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next205.php --self-test`
