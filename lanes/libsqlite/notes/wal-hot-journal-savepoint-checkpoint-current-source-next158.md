...
- Scope: WAL/pager/VFS durability behavior for a copied WordPress SQLite database after an interrupted import leaves both a hot rollback journal and failed savepoint WAL tail frames.
...
- WordPress smoke:
  - `php lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next158.php --self-test`
  - Result: `wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next158 self-test passed`.
