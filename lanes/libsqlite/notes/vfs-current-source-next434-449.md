...
- Tests:
  - `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext434449Plan.php`
  - `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext434449Test.php`
  - `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next434-449.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext434449Test.php`
  - `php lanes/libsqlite/examples/wordpress-vfs-current-source-next434-449.php --self-test`
