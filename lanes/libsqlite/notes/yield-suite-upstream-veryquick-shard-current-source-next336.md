# Upstream veryquick shard current-source next336
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext336()`,
...
classification, and focused PHP PASS-line output all match the next336
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext336Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext336Test.php
