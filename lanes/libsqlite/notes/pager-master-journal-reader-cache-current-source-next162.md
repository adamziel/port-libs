...
WordPress smoke: `wordpress-pager-master-journal-reader-cache-current-source-next162.php` models a copied `wp_options` database after master-journal recovery. It reuses a schema reader cache hit, reloads a stale options-root page from the recovered current source, and forces a speculative plugin reader to reopen on the current source.
...
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next162.php`
...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next162.php`
