...
php -l lanes/libsqlite/examples/wordpress-hot-journal-statement-cache-current-source-next104.php
php tools/run-tests.php lanes/libsqlite/tests/SQLitePagerHotJournalStatementCacheCurrentSourceNext104Test.php
php lanes/libsqlite/examples/wordpress-hot-journal-statement-cache-current-source-next104.php --self-test
git diff --check -- lanes/libsqlite
```

Focused result: `1 test files, 74 assertions, 0 failures` with 74 PASS lines.

WordPress smoke: `wordpress-hot-journal-statement-cache-current-source-next104 self-test passed`.
