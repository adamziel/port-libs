...
This slice adds `SQLiteUtf16NocaseLikeRtrimCurrentSourceNext208Plan`, covering
...
```sh
php -l lanes/libsqlite/src/SQLiteUtf16NocaseLikeRtrimCurrentSourceNext208Plan.php
