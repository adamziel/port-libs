# pragma-integrity-quickcheck-partial-index-current-source-next126
...
- `php -l lanes/libsqlite/src/SQLitePragmaIntegrityPartialIndexCurrentSourceNext126.php`
- `php -l lanes/libsqlite/tests/SQLitePragmaIntegrityPartialIndexCurrentSourceNext126Test.php`
- `php -l lanes/libsqlite/examples/wordpress-pragma-integrity-partial-index-current-source-next126.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIntegrityPartialIndexCurrentSourceNext126Test.php`
- `php lanes/libsqlite/examples/wordpress-pragma-integrity-partial-index-current-source-next126.php --self-test`
