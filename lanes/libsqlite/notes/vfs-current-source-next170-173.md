...
php -l lanes/libsqlite/examples/application-vfs-current-source-next170-173.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNextTest.php
php lanes/libsqlite/examples/application-vfs-current-source-next170-173.php --self-test
git diff --check
```
