# pragma-rootpage-pointermap-fk-current-source-next122

This slice adds `SQLitePragmaRootpagePointerMapForeignKeyCurrentSourceNext122`, a
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaRootpagePointerMapForeignKeyCurrentSourceNext122Test.php`
  - `Focused test run: 1 selected test files (root lock skipped)`
  - `1 test files, 68 assertions, 0 failures`
  - `57` PASS lines
- `php lanes/libsqlite/examples/wordpress-pragma-rootpage-pointermap-fk-current-source-next122.php`
...
`SQLitePragmaRootpageIntegrityAnalysisCurrentSourceNext111`,
