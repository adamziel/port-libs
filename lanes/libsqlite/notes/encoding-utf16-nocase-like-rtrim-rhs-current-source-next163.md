...
- `php lanes/libsqlite/examples/wordpress-utf16-nocase-like-rtrim-rhs-current-source-next163.php --self-test`
  - `wordpress-utf16-nocase-like-rtrim-rhs-current-source-next163 self-test passed`
