...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next244.php --self-test`
  - `wordpress sqlplanner stat4 expression partial current-source next244: stat4-expression-partial-current-source-next244-ready window=30,50,20,21,22 signature=0a91136be211`
