...
- WordPress path: copied `wp_options` imports through recursive INSTEAD OF view triggers can hold a changed next view/trigger source until current RETURNING rows have been consumed by the importer cursor.
