...
Direct JSON-table tests and WordPress examples were renamed away from the
...
- `php -l lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-anchor-remap.php`
- `php -l lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-range-constraint.php`
...
- `php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-anchor-remap.php --self-test`
- `php lanes/libsqlite/examples/wordpress-json-table-generated-path-rowid-range-constraint.php --self-test`
