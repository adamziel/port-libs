...
- Example self-test: `application-rowvalue-returning-window-current-source-next702-717.php`
...
php -l lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next702-717.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext702717Test.php
php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next702-717.php --self-test
git diff --check
```
