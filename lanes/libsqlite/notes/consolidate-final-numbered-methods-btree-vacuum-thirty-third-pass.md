...
Direct B-tree vacuum callers, focused tests, and WordPress examples were migrated to the stable descriptive methods and filenames. No production compatibility shim with the numbered method names remains for these wrappers.
...
- `php lanes/libsqlite/examples/wordpress-btree-pointermap-vacuum-freeblock-current-source-extended.php --self-test`: passed.
- `php lanes/libsqlite/examples/wordpress-btree-overflow-freeblock-pointermap-current-source-base.php --self-test`: passed.
- `php lanes/libsqlite/examples/wordpress-btree-overflow-freeblock-pointermap-current-source-extended.php --self-test`: passed.
