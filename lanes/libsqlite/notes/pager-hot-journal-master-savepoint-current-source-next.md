...
php -l lanes/libsqlite/examples/application-pager-hot-journal-master-savepoint-current-source-next134.php
php tools/run-tests.php lanes/libsqlite/tests/SQLitePagerHotJournalMasterSavepointCurrentSourceNext134Test.php
php lanes/libsqlite/examples/application-pager-hot-journal-master-savepoint-current-source-next134.php --self-test
