...
- Updated the direct test and WordPress smoke to call the canonical method instead of `variantNext862()`.
...
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next847-862.php`
...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next847-862.php --self-test`
