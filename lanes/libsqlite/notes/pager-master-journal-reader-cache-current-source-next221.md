...
- `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-pager-header-ticket-fence.php --self-test`
  - `application-pager-master-journal-reader-cache-current-source-next221 self-test passed`
