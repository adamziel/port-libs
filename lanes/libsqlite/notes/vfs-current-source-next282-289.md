...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next282-289.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next282-289.php --self-test`
- `git diff --check`
