...
- Tests:
  - `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext322337Plan.php`
  - `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext322337Test.php`
  - `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next322-337.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext322337Test.php`
  - `php lanes/libsqlite/examples/wordpress-vfs-current-source-next322-337.php --self-test`
