# libsqlite suite upstream veryquick shard current-source next459

## Scope

- Removes one focused upstream runner/countability blocker by admitting the
  current-source next459 veryquick shard row.
...
```text
$ php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext459Test.php
Focused test run: 1 selected test files (root lock skipped)
...
1 test files, 1405 assertions, 0 failures
```
