...
The timing summary is included in the current/next source hash, per-side counts, decorated parent-index admission rows, and decorated `foreign_key_check` rows. This keeps copied Application `wp_options` import diagnostics from treating commit-deferred violations as statement-immediate blockers when the FK DDL changed between current and next sources.

Verification:

- `php -l lanes/libsqlite/src/SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext.php`
- `php -l lanes/libsqlite/tests/SQLitePragmaIndexXinfoForeignKeyCurrentSourceNextTest.php`
- `php -l lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next171.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIndexXinfoForeignKeyCurrentSourceNextTest.php`
- `php lanes/libsqlite/examples/application-pragma-index-xinfo-foreignkey-current-source-next171.php --self-test`
