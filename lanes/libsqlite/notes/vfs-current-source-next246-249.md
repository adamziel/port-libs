...
- `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext246249Plan.php`
- `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext246249Test.php`
- `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next246-249.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext206209Test.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext246249Test.php`
