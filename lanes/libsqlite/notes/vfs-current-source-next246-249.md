...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next246-249.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next246-249.php --self-test`
- `git diff --check`
