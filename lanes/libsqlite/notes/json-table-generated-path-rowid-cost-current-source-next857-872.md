...
- WordPress example: copied `wp_options` JSON rule rows continue to pin rowid point-cost admission for the current source and reprepare the next reader when the generated path/source generation changes.
