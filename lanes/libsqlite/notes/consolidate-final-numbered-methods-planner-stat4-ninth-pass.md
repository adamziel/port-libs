...
- Removed the matching `Next136` suffixes from the file's private production helpers and migrated the direct focused test and Application smoke to stable unsuffixed paths.
...
- Verification:
  ...
  - `php -l lanes/libsqlite/examples/application-planner-partial-range-covering-current-source.php`
  ...
  - `php lanes/libsqlite/examples/application-planner-partial-range-covering-current-source.php --self-test`
