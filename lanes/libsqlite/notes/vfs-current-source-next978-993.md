...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next962-977.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next962-977.php --self-test`
