...
- WordPress smoke: `lanes/libsqlite/examples/wordpress-option-name-encoding-source-current-next82.php` scans copied `wp_options.option_name` source bytes across UTF-8 and UTF-16 encodings for escaped literal-percent LIKE predicates, emoji prefixes, and GLOB prefixes without requiring `ext/sqlite`.
...
$ php -l lanes/libsqlite/examples/wordpress-option-name-encoding-source-current-next82.php
No syntax errors detected in lanes/libsqlite/examples/wordpress-option-name-encoding-source-current-next82.php
...
$ php lanes/libsqlite/examples/wordpress-option-name-encoding-source-current-next82.php --self-test
wordpress-option-name-encoding-source-current-next82 self-test passed
```
