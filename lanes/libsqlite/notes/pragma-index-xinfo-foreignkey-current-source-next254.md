...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext254Test.php | tee /tmp/pragma254.out; printf 'PASS_LINES='; rg -c '^PASS ' /tmp/pragma254.out
