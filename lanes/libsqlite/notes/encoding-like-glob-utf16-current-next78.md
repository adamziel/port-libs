...
```sh
php lanes/libsqlite/examples/wordpress-option-name-utf16-glob-current-next78.php --self-test
```
...
WordPress `wp_options.option_name` keys originate from UTF-16 database text
records.
