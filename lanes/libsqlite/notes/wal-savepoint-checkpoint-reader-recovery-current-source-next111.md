...
```text
php lanes/libsqlite/examples/application-wal-savepoint-checkpoint-reader-recovery-current-source-next111.php --self-test
application-wal-savepoint-checkpoint-reader-recovery-current-source-next111 self-test passed
```
