...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next182.php` -> emits ordered replay pages `[1,3,105,106,107,108]`, pointer-map replay page `[105]`, replacement overflow pages `[106,107,108]`, truncate pages `[109,110]`, and the self-test pass line.
