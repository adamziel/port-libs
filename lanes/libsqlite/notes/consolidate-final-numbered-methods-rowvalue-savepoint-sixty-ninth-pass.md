...
savepoint, error, test, and Application smoke names while preserving the existing
...
- `php -l lanes/libsqlite/examples/application-rowvalue-update-delete-returning-savepoint-current-source.php` -> no syntax errors.
...
- `php lanes/libsqlite/examples/application-rowvalue-update-delete-returning-savepoint-current-source.php --self-test` -> self-test passed.
