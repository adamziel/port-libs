...
- Application smoke: `examples/application-sqlplanner-stat4-expression-partial-current-source-next177.php` previews copied `wp_options` plugin option scans after ANALYZE/stat4 changes without requiring ext/sqlite.
