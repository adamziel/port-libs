...
- Adds a WordPress-oriented smoke for copied `wp_options` rows whose option values include NUL-bearing plugin cache keys.
...
- `php -l lanes/libsqlite/examples/wordpress-embedded-nul-like-current-source-next242.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteEncodingCollationAffinityLikeCurrentSourceNext242Test.php`
- `php lanes/libsqlite/examples/wordpress-embedded-nul-like-current-source-next242.php`
