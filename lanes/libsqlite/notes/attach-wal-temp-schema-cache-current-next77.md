...
```text
php lanes/libsqlite/examples/wordpress-attach-wal-temp-schema-cache-current-next77.php --self-test
wordpress-attach-wal-temp-schema-cache-current-next77 self-test passed
```
