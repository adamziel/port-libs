...
- Updated focused tests for ranges `1007-1134` to call `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextPlan::tableLeafFromDeleteResultForCurrentSourceFreelistHandoff($sliceNumber, ...)`.
