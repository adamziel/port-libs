...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next238-241.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next238-241.php --self-test`
- `git diff --check`
