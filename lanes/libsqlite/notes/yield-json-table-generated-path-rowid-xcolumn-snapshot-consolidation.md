...
- Renamed the direct test and Application smoke from numbered `CurrentSourceNext181` / `current-source-next181` names to descriptive xColumn snapshot names.
...
- `php -l lanes/libsqlite/examples/application-json-table-generated-path-rowid-xcolumn-snapshot.php`
...
- `php lanes/libsqlite/examples/application-json-table-generated-path-rowid-xcolumn-snapshot.php --self-test`
  - `application-json-table-generated-path-rowid-xcolumn-snapshot self-test passed`
