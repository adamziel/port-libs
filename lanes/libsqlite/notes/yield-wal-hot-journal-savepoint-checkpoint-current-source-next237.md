...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next237.php --self-test` passes and models a copied WordPress plugin import reusing a durable WAL sidecar after hot-journal/savepoint checkpoint recovery.
