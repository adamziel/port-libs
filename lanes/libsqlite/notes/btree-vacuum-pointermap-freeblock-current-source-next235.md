...
- `examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next235.php`
...
- `php -l lanes/libsqlite/examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next235.php`
...
- PASS-line delta: `144`
- `php lanes/libsqlite/examples/wordpress-btree-vacuum-pointermap-freeblock-current-source-next235.php`
- Result: `wordpress-btree-vacuum-pointermap-freeblock-current-source-next235 self-test passed`
