...
- Scope: adds `SQLitePlannerSkipScanExpressionRangeCurrentSourceNext149Plan`, composing the accepted next143 expression skip-scan range fence and adding a current-source residual `RecheckExpressionRange` audit before yielding cursor rows.
