...
Direct tests and WordPress examples for those tail handoff windows were renamed to stable descriptive filenames and migrated to the canonical method names. Serialized payload keys and assertions are preserved so this is a surface consolidation, not a behavior change.
