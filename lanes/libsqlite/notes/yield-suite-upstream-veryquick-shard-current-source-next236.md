# Upstream veryquick shard current-source next236
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext236()`,
...
focused PHP PASS-line output all match the next236 evidence record.

Focused upstream denominator impact: `UPSTREAM_TEST_MANIFEST.json` mapped count
moves from `637` to `638`. The slice records focused current-source veryquick
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext236Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext236Test.php
...
220/222/224/225/226/227/228/229/230/231/232/233 veryquick evidence, exact-shard next148,
queued runner106/jsonvt104 rebase work, accepted batch107/108,
batch202, and batch201 behavior surfaces, and live B-tree/JSON/VFS/WAL/
