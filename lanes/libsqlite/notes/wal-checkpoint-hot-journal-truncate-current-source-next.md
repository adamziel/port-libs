...
- `php -l lanes/libsqlite/examples/wordpress-wal-checkpoint-hot-journal-truncate-current-source-next.php`
- `php lanes/libsqlite/examples/wordpress-wal-checkpoint-hot-journal-truncate-current-source-next.php --self-test`
