...
- `php lanes/libsqlite/examples/application-rowvalue-order-limit-savepoint-current-source-next213.php --self-test`: pass.
- `php lanes/libsqlite/examples/application-rowvalue-subquery-limit-savepoint-retry.php --self-test`: pass.
- `php lanes/libsqlite/examples/application-rowvalue-distinct-subquery-savepoint-current-source-next216.php --self-test`: pass.
