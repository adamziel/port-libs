...
- Application smoke: `lanes/libsqlite/examples/application-option-name-glob-cursor.php` reports plugin option-name prefix and Unicode class GLOB rowids without requiring `ext/sqlite`.
