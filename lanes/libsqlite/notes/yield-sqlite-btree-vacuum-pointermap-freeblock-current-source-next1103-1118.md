...
This slice extends `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourcePlan` without adding a numbered duplicate class. The next1103-1118 entrypoints reuse `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNextFreelistCurrentSourceVariant`, continuing the next1087-1102 current-source handoff receipt pattern over the existing freelist splice rows.
...
- `php -l lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-freelist-handoff-batch-seven.php`
...
- `php lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-freelist-handoff-batch-seven.php`
- `git diff --check`
