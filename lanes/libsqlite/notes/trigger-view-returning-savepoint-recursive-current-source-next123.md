...
```text
$ php lanes/libsqlite/examples/wordpress-trigger-view-returning-savepoint-recursive-current-source-next123.php --self-test
wordpress-trigger-view-returning-savepoint-recursive-current-source-next123 self-test passed
```
