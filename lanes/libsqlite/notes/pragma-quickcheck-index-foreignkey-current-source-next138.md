# pragma-quickcheck-index-foreignkey-current-source-next138

Slice: `pragma-quickcheck-index-foreignkey-current-source-next138`.

Behavior: adds `SQLitePragmaQuickcheckIndexForeignKeyCurrentSourceNext138`, a
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaQuickcheckIndexForeignKeyCurrentSourceNext138Test.php`
  - `1 test files, 84 assertions, 0 failures`
- `php lanes/libsqlite/examples/wordpress-pragma-quickcheck-index-foreignkey-current-source-next138.php --self-test`
  - `wordpress-pragma-quickcheck-index-foreignkey-current-source-next138 self-test passed`
