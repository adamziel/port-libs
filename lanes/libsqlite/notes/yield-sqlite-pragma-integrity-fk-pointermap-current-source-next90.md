...
- WordPress smoke: `php lanes/libsqlite/examples/wordpress-pragma-integrity-fk-pointermap-current-source-next90.php --self-test` passes and covers copied `wp_options` archive diagnostics.
