...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next234-237.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next234-237.php --self-test`
- `git diff --check`
