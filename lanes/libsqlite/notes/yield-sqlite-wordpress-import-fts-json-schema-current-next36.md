# yield-sqlite-wordpress-import-fts-json-schema-current-next36

## Scope

Added bounded FTS5 schema import materialization for WordPress migration tooling:
...
- The plan now exports a JSON metadata shape for WordPress import diagnostics.
...
php -l lanes/libsqlite/examples/wordpress-fts5-json-schema-current-next36.php
No syntax errors detected in lanes/libsqlite/examples/wordpress-fts5-json-schema-current-next36.php
...
php lanes/libsqlite/examples/wordpress-fts5-json-schema-current-next36.php
...
No new support component is required. This reuses the existing lane-local FTS5 schema parser and bounded WordPress smoke path; no external SQLite extension, upstream binary, or shared support library is needed.
