...
- WordPress path: copied `wp_options` readers can retain a shared schema page, refresh an `active_plugins` page, and reopen a stale roles reader when an attached users journal is newly present in the master journal.
