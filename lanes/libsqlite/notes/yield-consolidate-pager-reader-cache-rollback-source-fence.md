...
- Migrated the direct focused test to `SQLitePagerMasterJournalReaderCacheRollbackJournalSourceFenceTest.php` and the Application smoke to `application-pager-master-journal-reader-cache-rollback-source-fence.php`.
- Removed the four numbered direct test files and four numbered Application smoke files for the duplicate wrapper family.
- Focused verification:
  ...
  - `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-rollback-source-fence.php --self-test`
  - `application-pager-master-journal-reader-cache-current-source-rollback-source-fence self-test passed`
