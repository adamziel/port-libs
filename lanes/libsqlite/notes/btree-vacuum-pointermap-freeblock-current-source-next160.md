...
- Behavior: adds `SQLiteBTreeVacuumPointerMapFreeblockCurrentSourceNext160Plan`, which composes the current-source delete/vacuum/freeblock replacement path and verifies a multi-page replacement overflow chain allocated from surviving post-vacuum free pages.
