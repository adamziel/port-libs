...
across broader page-allocation contexts, including reserved bytes and free-list
reuse. Keep it paired with a focused upstream runner and a WordPress fixture
that the native reader can parse back from generated bytes.
