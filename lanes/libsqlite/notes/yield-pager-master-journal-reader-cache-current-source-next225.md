...
WordPress smoke: `examples/wordpress-pager-master-journal-reader-cache-current-source-next225.php` models a copied WordPress import with attached user data. Schema/root pages remain reusable when validity counters match the recovered current source, while `active_plugins` reopens when its reader-cache ticket carries the pre-recovery change-counter/version-valid-for tuple.
...
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next225.php`
...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next225.php`
  - `wordpress-pager-master-journal-reader-cache-current-source-next225 self-test passed`
