...
- Example self-test: `application-rowvalue-returning-window-current-source-next718-733.php`
...
php -l lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next718-733.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext718733Test.php
php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next718-733.php --self-test
git diff --check
```
