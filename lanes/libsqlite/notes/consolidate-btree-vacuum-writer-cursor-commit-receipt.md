...
Direct tests and Application examples were renamed to the same descriptive
...
- `php -l` for the 5 renamed focused tests and 5 renamed Application examples
...
- `php` for each renamed Application example; all emitted self-test passed output.
