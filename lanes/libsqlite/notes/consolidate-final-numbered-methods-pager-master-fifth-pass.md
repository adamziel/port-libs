...
Direct pager-master callers in the focused test and WordPress smoke now call the descriptive canonical method instead of the numbered production method. The behavior, status markers, dependency strings, and ordinal fence evidence remain unchanged for compatibility with accepted assertions.
...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next943-958.php --self-test`
