...
This slice adds `SQLiteJsonTablePlan::currentSourceHiddenPathOrderByNext128()`
...
- `lanes/libsqlite/examples/wordpress-json-table-hidden-path-orderby-current-source-next128.php`
...
- `php -l lanes/libsqlite/tests/SQLiteJsonTableHiddenPathOrderByCurrentSourceNext128Test.php`
- `php -l lanes/libsqlite/examples/wordpress-json-table-hidden-path-orderby-current-source-next128.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableHiddenPathOrderByCurrentSourceNext128Test.php`
- `php lanes/libsqlite/examples/wordpress-json-table-hidden-path-orderby-current-source-next128.php`
