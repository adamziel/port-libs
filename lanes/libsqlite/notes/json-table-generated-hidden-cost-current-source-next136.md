...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableGeneratedHiddenCostCurrentSourceNext136Test.php`
  - `1 test files, 64 assertions, 0 failures`
  - 64 PASS lines
- `php lanes/libsqlite/examples/wordpress-json-table-generated-hidden-cost-current-source-next136.php`
