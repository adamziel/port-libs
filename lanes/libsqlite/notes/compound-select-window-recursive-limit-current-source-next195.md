...
- WordPress path: copied `wp_options` autoload rows model option-import current vs next source changes where transient cleanup rows are excluded before final pagination.
...
php -l lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-current-source-next195.php
No syntax errors detected in lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-current-source-next195.php

php lanes/libsqlite/examples/wordpress-compound-select-window-recursive-limit-current-source-next195.php --self-test
wordpress-compound-select-window-recursive-limit-current-source-next195 self-test passed
