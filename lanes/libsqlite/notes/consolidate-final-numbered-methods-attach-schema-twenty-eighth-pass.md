...
Direct tests and WordPress example self-tests were migrated to the stable marker names. No production numbered class/file/helper shim was added.
...
- `php lanes/libsqlite/examples/wordpress-attach-schema-cache-ddl-current-source-next107.php --self-test`: pass
- `php lanes/libsqlite/examples/wordpress-attach-temp-trigger-view-invalidation-current-source-next.php --self-test`: pass
