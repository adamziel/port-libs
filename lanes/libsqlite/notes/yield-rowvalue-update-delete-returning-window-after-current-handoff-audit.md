...
- Application smoke: `examples/application-rowvalue-returning-window-after-current-handoff-audit.php` models copied `wp_options` retry publication metadata.
...
- `php -l lanes/libsqlite/examples/application-rowvalue-returning-window-after-current-handoff-audit.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteRowValueUpdateDeleteReturningWindowAfterCurrentHandoffAuditTest.php`
- `php lanes/libsqlite/examples/application-rowvalue-returning-window-after-current-handoff-audit.php --self-test`
- `git diff --check`
