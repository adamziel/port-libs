...
- `SQLiteJsonTablePlan::currentSourcePathConstraintPushdownNext123()` wraps the accepted current-source indexed-constraint path and adds path-specific transition evidence.
...
- Adds WordPress smoke `wordpress-json-table-path-constraint-current-source-next123.php`.

Verification:

- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTablePathConstraintPushdownCurrentSourceNext123Test.php`
  - `1 test files, 57 assertions, 0 failures`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableConstraintCostOrderCurrentSourceNext113Test.php lanes/libsqlite/tests/SQLiteJsonTableIndexedConstraintCostCurrentSourceNext119Test.php lanes/libsqlite/tests/SQLiteJsonTablePathConstraintPushdownCurrentSourceNext123Test.php`
