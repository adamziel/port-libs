...
- Direct tests/examples: migrated the two focused tests and two WordPress examples to unsuffixed filenames and stable entry methods.
...
- Example smoke: both migrated WordPress examples passed locally.
