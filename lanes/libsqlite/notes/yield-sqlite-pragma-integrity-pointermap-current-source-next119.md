...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIntegrityPointerMapCurrentSourceNext119Test.php`
- `php lanes/libsqlite/examples/wordpress-pragma-integrity-pointermap-current-source-next119.php`
- `php -l lanes/libsqlite/src/SQLitePragmaIntegrityPointerMapCurrentSourceNext119.php`
- `php -l lanes/libsqlite/tests/SQLitePragmaIntegrityPointerMapCurrentSourceNext119Test.php`
- `php -l lanes/libsqlite/examples/wordpress-pragma-integrity-pointermap-current-source-next119.php`
