...
- Application path: `examples/application-wal-hot-journal-savepoint-checkpoint-current-source-next251.php` models a copied Application database import that can retire a hot-journal checkpoint WAL sidecar only after schema/options/terms readers release.
