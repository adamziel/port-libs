# PRAGMA Foreign Key Recursive Current-Source Next106

## Behavior

- Adds `SQLiteAttachedSchemaCatalog::foreignKeyListCurrentSourceNext106()` for table-valued `pragma_foreign_key_list(...)` current/next schema catalog snapshots.
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaForeignKeyRecursiveCurrentSourceNext106Test.php`
  - `1 test files, 64 assertions, 0 failures`
  - `41` PASS lines.
- `php lanes/libsqlite/examples/wordpress-pragma-fkey-recursive-current-source-next106.php --self-test`
  - `wordpress-pragma-fkey-recursive-current-source-next106 self-test passed`
