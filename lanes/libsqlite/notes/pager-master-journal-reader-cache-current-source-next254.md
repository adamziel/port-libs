# pager-master-journal-reader-cache-current-source-next254

## Behavior

Adds `SQLitePagerMasterJournalReaderCacheCurrentSourceNext254Plan`, a current-source reader-cache fence for completed master-journal recovery receipts.
...
```text
php tools/run-tests.php lanes/libsqlite/tests/SQLitePagerMasterJournalReaderCacheCurrentSourceNext254Test.php
...
```text
php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-next254.php
{
