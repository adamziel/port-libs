...
- Example self-test: `wordpress-rowvalue-returning-window-current-source-next686-701.php`
...
php -l lanes/libsqlite/examples/wordpress-rowvalue-returning-window-current-source-next686-701.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNext686701Test.php
php lanes/libsqlite/examples/wordpress-rowvalue-returning-window-current-source-next686-701.php --self-test
git diff --check
```
