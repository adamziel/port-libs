...
WordPress smoke: `wordpress-pager-master-journal-reader-cache-current-source-next259.php` models copied `wp_options` recovery where stale page-1 schema and `active_plugins` readers reopen before plugin import resumes.
...
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next259.php`
...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next259.php`
  - `wordpress-pager-master-journal-reader-cache-current-source-next259 self-test passed`
