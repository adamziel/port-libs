...
```text
php lanes/libsqlite/examples/application-pager-super-journal-hot-rollback-current-source.php --self-test
application-pager-super-journal-hot-rollback-current-source self-test passed
```
