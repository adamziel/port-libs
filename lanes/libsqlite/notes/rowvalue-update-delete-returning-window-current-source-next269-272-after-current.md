...
Application smoke: `application-rowvalue-returning-window-current-source-next269-272-after-current.php` models copied `wp_options` yield, rollback, retry, and mixed UPDATE/DELETE RETURNING rows using the next268 fixture.

Validation:

- `php -l lanes/libsqlite/src/SQLiteRowValueUpdateDeleteReturningWindowCurrentSourceNextPlan.php`
- `php -l lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next269-272-after-current.php`
...
- `php lanes/libsqlite/examples/application-rowvalue-returning-window-current-source-next269-272-after-current.php --self-test`
- `git diff --check`
