...
- Application smoke: `php lanes/libsqlite/examples/application-pragma-foreignkey-index-integrity-current-source-next.php` reports the copied `wp_options` parent-key admission blocker and the resumable source id.
