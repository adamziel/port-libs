...
- `php -l lanes/libsqlite/examples/application-pager-savepoint-master-journal-hot-current-source-next140.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePagerSavepointMasterJournalHotCurrentSourceNext140Test.php`
- `php lanes/libsqlite/examples/application-pager-savepoint-master-journal-hot-current-source-next140.php --self-test`
