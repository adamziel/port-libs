...
Renamed the direct attach/TEMP/WAL schema-cache publication-window test and Application smoke away from their generated numbered suffix. The covered behavior still calls the canonical `SQLiteAttachWalTempSchemaCachePlan::schemaCacheConsolidatedPlan()` production entry point; no numbered production compatibility shim was added.

Verification:

- `php -l lanes/libsqlite/tests/SQLiteAttachTempWalSchemaCacheConsolidatedPublicationWindowTest.php`
- `php -l lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-consolidated-publication-window.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteAttachTempWalSchemaCacheConsolidatedPublicationWindowTest.php`
- `php lanes/libsqlite/examples/application-attach-temp-wal-schema-cache-consolidated-publication-window.php --self-test`
