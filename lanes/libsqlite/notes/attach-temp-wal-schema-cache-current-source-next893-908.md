...
php -l lanes/libsqlite/examples/wordpress-attach-temp-wal-schema-cache-archive-window.php
...
php lanes/libsqlite/examples/wordpress-attach-temp-wal-schema-cache-archive-window.php --self-test
git diff --check
```
