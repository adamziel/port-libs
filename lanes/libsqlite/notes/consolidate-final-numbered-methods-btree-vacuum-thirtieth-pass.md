...
test and Application smoke away from removed generated method dispatch. Coverage now
...
- `php lanes/libsqlite/examples/application-btree-vacuum-pointermap-freeblock-current-source-handoff.php`
