...
- Tests:
  - `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext450465Plan.php`
  - `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext450465Test.php`
  - `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next450-465.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext450465Test.php`
  - `php lanes/libsqlite/examples/wordpress-vfs-current-source-next450-465.php --self-test`
