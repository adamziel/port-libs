...
- Adds `SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext169`, layered on the accepted next165 current/next PRAGMA page.
...
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePragmaIndexXinfoForeignKeyCurrentSourceNext169Test.php`
