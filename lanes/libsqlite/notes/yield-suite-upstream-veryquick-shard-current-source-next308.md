# Upstream veryquick shard current-source next308
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSource(..., 'next308-veryquick-shard')`,
...
classification, and focused PHP PASS-line output all match the next308
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext308Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext308Test.php
