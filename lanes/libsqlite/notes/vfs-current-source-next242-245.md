...
- `php -l lanes/libsqlite/examples/application-vfs-current-source-next242-245.php`
...
- `php lanes/libsqlite/examples/application-vfs-current-source-next242-245.php --self-test`
- `git diff --check`
