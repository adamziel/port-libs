...
- Adds `SQLiteEncodingCollationAffinityLikeCurrentSourceNext249Plan` for a Application `wp_options.option_name COLLATE RTRIM LIKE ? ESCAPE ?` cursor over mixed UTF-8, UTF-16LE, and UTF-16BE source rows.
...
- Application smoke: `examples/application-option-name-rtrim-like-current-source-next249.php`.
...
- Example smoke command: `php lanes/libsqlite/examples/application-option-name-rtrim-like-current-source-next249.php`
