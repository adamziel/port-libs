...
- WordPress smoke command: `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next218.php`
- Result: `wordpress-pager-master-journal-reader-cache-current-source-next218 self-test passed`.
