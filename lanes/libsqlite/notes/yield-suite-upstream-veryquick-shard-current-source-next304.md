# Upstream veryquick shard current-source next304
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext304()`,
...
classification, and focused PHP PASS-line output all match the next304
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext304Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext304Test.php
