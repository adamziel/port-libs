...
- `SQLiteWalHotJournalSavepointCheckpointCurrentSourceNext516531Test.php` chains next516 through next531 from next515.
...
- `wordpress-wal-hot-journal-savepoint-checkpoint-current-source-next531.php` provides a WordPress-shaped example for the final seal.
