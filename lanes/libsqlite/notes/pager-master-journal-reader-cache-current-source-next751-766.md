...
- Matching example: `wordpress-pager-master-journal-reader-cache-current-source-next751-766.php`
...
php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next751-766.php
