...
- Tests:
  ...
  - `php -l lanes/libsqlite/examples/application-vfs-current-source-next338-353.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNextTest.php`
  - `php lanes/libsqlite/examples/application-vfs-current-source-next338-353.php --self-test`
