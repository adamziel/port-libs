...
- Tests:
  - `php -l lanes/libsqlite/src/SQLiteVfsCurrentSourceNext338353Plan.php`
  - `php -l lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext338353Test.php`
  - `php -l lanes/libsqlite/examples/wordpress-vfs-current-source-next338-353.php`
  - `php tools/run-tests.php lanes/libsqlite/tests/SQLiteVfsCurrentSourceNext338353Test.php`
