...
- Adds `SQLiteJsonTablePlan::currentSourceGeneratedPathCostNext134()` for current/next-source JSON table planning when a copied WordPress host row carries a generated JSON path column.
...
- Focused test: `php tools/run-tests.php lanes/libsqlite/tests/SQLiteJsonTableGeneratedPathCostCurrentSourceNext134Test.php`
