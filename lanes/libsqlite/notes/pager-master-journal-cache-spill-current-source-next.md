...
- `php -l lanes/libsqlite/examples/application-pager-master-journal-cache-spill-current-source-next132.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePagerMasterJournalCacheSpillCurrentSourceNext132Test.php`
- `php lanes/libsqlite/examples/application-pager-master-journal-cache-spill-current-source-next132.php --self-test`
