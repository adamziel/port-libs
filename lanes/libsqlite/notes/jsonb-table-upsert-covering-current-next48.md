...
- Added `wordpress-jsonb-table-upsert-covering-current-next48.php`, a copied `wp_options` smoke for JSONB `option_value` imports feeding covering generated/path indexes.
...
```text
$ php lanes/libsqlite/examples/wordpress-jsonb-table-upsert-covering-current-next48.php
{
