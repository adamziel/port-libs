...
- Migrated the direct focused test and Application smoke caller to the canonical unsuffixed entrypoint.
...
- `php -l lanes/libsqlite/examples/application-expression-covering-range-current-source-next146.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePlannerExpressionCoveringRangeCurrentSourceNext146Test.php`
- `php lanes/libsqlite/examples/application-expression-covering-range-current-source-next146.php --self-test`
