...
- Adds `SQLitePlannerStat4ExpressionPartialCurrentSourceNext187Plan`, a bounded current-source planner that composes the accepted next175 STAT4 LIKE-prefix partial expression scan with retained residual `NOT LIKE` filters.
...
- `php -l lanes/libsqlite/src/SQLitePlannerStat4ExpressionPartialCurrentSourceNext187Plan.php`
