...
imports with `RETURNING` across a savepoint boundary. It covers the WordPress
...
- `php lanes/libsqlite/examples/wordpress-trigger-savepoint-returning-view-current-source-next146.php`
...
- No new support component is needed. The slice reuses existing lane-local
  ...
  behavior plus a WordPress smoke.
