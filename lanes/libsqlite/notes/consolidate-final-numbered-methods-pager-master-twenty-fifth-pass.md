...
- Updated the direct focused test and WordPress smoke to call the canonical descriptive entrypoint instead of the numbered production method.
...
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next863-878.php`
...
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-current-source-next863-878.php --self-test`
