...
The direct tests and WordPress examples were renamed to stable unsuffixed
...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-distinct-subquery-savepoint.php`
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-distinct-tuple-savepoint.php`
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-distinct-subquery-savepoint.php --self-test`
- `php lanes/libsqlite/examples/wordpress-rowvalue-distinct-tuple-savepoint.php --self-test`
