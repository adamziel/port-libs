...
Direct focused tests and the Application smoke now call the stable method name.
...
- `php lanes/libsqlite/examples/application-rowvalue-release-followup-read-savepoint.php --self-test`
