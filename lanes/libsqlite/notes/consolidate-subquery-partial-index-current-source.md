...
- Migrated the direct focused test and Application smoke to stable unsuffixed
...
- Focused verification:
  ...
  - `php -l lanes/libsqlite/examples/application-planner-subquery-partial-index-current-source.php`
  ...
  - `php lanes/libsqlite/examples/application-planner-subquery-partial-index-current-source.php --self-test`
    passed.
