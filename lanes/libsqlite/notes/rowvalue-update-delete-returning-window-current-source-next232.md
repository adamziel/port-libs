...
- Adds a WordPress smoke at `examples/wordpress-rowvalue-window-current-source-next232.php`.
...
- `php -l lanes/libsqlite/examples/wordpress-rowvalue-window-current-source-next232.php`
  - `No syntax errors detected in lanes/libsqlite/examples/wordpress-rowvalue-window-current-source-next232.php`
...
- `php lanes/libsqlite/examples/wordpress-rowvalue-window-current-source-next232.php`
