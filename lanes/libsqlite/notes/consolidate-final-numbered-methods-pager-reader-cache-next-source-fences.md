...
The direct focused tests and Application examples were renamed to match the
...
- `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-next-source-fence.php`
- `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-source-digest-fence.php`
- `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-attached-master-member-fence.php`
- `php lanes/libsqlite/examples/application-pager-master-journal-reader-cache-rollback-journal-source-fence.php`
