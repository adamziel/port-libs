...
- `php -l lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-member-generation.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLitePagerMasterJournalReaderCacheMemberGenerationPlanTest.php`
- `php lanes/libsqlite/examples/wordpress-pager-master-journal-reader-cache-member-generation.php`
