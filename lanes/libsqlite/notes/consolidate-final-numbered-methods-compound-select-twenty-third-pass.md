...
- Migrated the direct focused tests and WordPress examples to the stable entrypoints.
...
- `php -l lanes/libsqlite/examples/wordpress-compound-window-except-limit-current-source-next141.php`
...
- `php lanes/libsqlite/examples/wordpress-compound-window-except-limit-current-source-next141.php --self-test`
