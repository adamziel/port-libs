# Upstream veryquick shard current-source next372
...
`SQLiteUpstreamSuiteEvidence::upstreamVeryquickShardCurrentSourceNext372()`,
...
classification, and focused PHP PASS-line output all match the next372
evidence record.
...
php -l lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext372Test.php
php tools/run-tests.php lanes/libsqlite/tests/SQLiteUpstreamVeryquickShardCurrentSourceNext372Test.php
...
exact-shard next148, queued runner106/jsonvt104 rebase work, queued suite327,
suite330, and suite340+ rows, accepted batch225 behavior surfaces, and live
