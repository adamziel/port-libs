...
- Updated the direct focused test and Application smoke to call the canonical descriptive entrypoint instead of numbered production methods.
...
- `php -l lanes/libsqlite/examples/application-wal-hot-journal-savepoint-checkpoint-current-source-next1171.php`
...
- `php lanes/libsqlite/examples/application-wal-hot-journal-savepoint-checkpoint-current-source-next1171.php --self-test`
