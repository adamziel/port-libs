...
- `php -l lanes/libsqlite/examples/wordpress-schema-generated-index-view-reparse-current-source-next132.php`
- `php tools/run-tests.php lanes/libsqlite/tests/SQLiteSchemaGeneratedIndexViewReparseCurrentSourceNext132Test.php`
  - `1 test files, 62 assertions, 0 failures`
- `php lanes/libsqlite/examples/wordpress-schema-generated-index-view-reparse-current-source-next132.php --self-test`
  - `wordpress-schema-generated-index-view-reparse-current-source-next132 self-test passed`
