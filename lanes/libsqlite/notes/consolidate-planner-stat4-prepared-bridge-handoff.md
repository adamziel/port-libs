...
- `php -l lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-prepared-bridge-handoff.php`
...
- `php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-prepared-bridge-handoff.php --self-test`
