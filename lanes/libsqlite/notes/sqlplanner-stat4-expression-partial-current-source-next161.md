# sqlplanner-stat4-expression-partial-current-source-next161
...
```sh
php tools/run-tests.php lanes/libsqlite/tests/SQLitePlannerStat4ExpressionPartialCurrentSourceNext161Test.php
```
...
```sh
php lanes/libsqlite/examples/wordpress-sqlplanner-stat4-expression-partial-current-source-next161.php --self-test
```

Result:

```text
wordpress-sqlplanner-stat4-expression-partial-current-source-next161 self-test passed
```
