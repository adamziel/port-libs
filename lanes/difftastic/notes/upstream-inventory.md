...
The focused PHP lane test now passes 245 tests and 1421 assertions, including the existing mapped upstream display/parser/file-decoding slices plus the JavaScript variable.builtin `this`/`super` highlight boundary. The current syntax-highlight coverage includes parser-specific tag/CSS keyword highlighting in ANSI and JSON output, TypeScript constructor/custom-type highlighting, JavaScript uppercase constructor/type and all-caps constant priority, JavaScript variable.builtin priority for window/document/console/module/arguments/this/super, Python constructor/decorator and keyword/builtin boundaries, Ruby keyword/constant/operator/constructor highlighting with function-method builtins left normal, keyword-ish boolean/constant/operator highlighting, normal attribute/property/function/function.builtin boundaries, command display/control/resource-limit parsing, and the TOML table/key plus inline-table/array-table slices.
