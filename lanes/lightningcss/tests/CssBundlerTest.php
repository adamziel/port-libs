...
CSS,
    ...
    'css bundler offsets upstream inline source maps after earlier bundled imports' => static function (TestRunner $t): void {
        $inputMap = 'data:application/json;base64,' . base64_encode(json_encode([
            'version' => 3,
            'mappings' => 'AAAA',
        ...
        $result = (new CssBundler())->bundleWithSourceMap('/theme/entry.css', [
            '/theme/entry.css' => '@import "blocks/base.css"; @import "blocks/generated-card.css"; .entry { color: red }',
            '/theme/blocks/base.css' => '.base { color: blue }',
        ...
        $t->same('.base{color:#00f}.card{color:green}.entry{color:red}', $result['code']);
        $t->same(['entry.css', 'blocks/base.css', 'blocks/generated-card.scss'], $data['sources']);
        $t->same([
            '@import "blocks/base.css"; @import "blocks/generated-card.css"; .entry { color: red }',
            '.base { color: blue }',
            '.card { color: $theme-green }',
        ], $data['sourcesContent']);
...
CSS,
    ...
    'css bundler replaces literal null import source bytes before resolver traversal' => static function (TestRunner $t) use ($bundle): void {
        $replacement = "\xEF\xBF\xBD";
        $null = "\0";
        $resolved = [];
        ...
        $t->same(
            '.card{color:green}.icon{color:#00f}.entry{color:red}',
            $bundle([
                '/entry.css' => '@import "pkg:' . $null . '.css"; @import url(pkg:icon' . $null . '.css); .entry { color: red }',
                '/vendor/replacement.css' => '.card { color: green }',
                '/vendor/icon.css' => '.icon { color: blue }',
            ], '/entry.css', static function (string $specifier, string $originatingFile) use (&$resolved, $replacement): string {
                $resolved[] = [$specifier, $originatingFile, bin2hex($specifier)];
        ...
        $t->same([
            ['pkg:' . $replacement . '.css', '/entry.css', '706b673aefbfbd2e637373'],
            ['pkg:icon' . $replacement . '.css', '/entry.css', '706b673a69636f6eefbfbd2e637373'],
        ], $resolved);
    },
    'css bundler rejects upstream bad unquoted url import sources before resolution' => static function (TestRunner $t): void {
        $assertBadUrlImport = static function (string $css, string $message) use ($t): void {
            ...
            try {
                ...
                $t->same('/entry.css', $exception->sourceFile);
                $t->same(1, $exception->sourceLine);
                $t->same(8, $exception->sourceColumn);
                $t->same(['/entry.css'], $reads);
    ...
    'css bundler validates quoted url import source token boundaries like upstream' => static function (TestRunner $t) use ($bundle): void {
        ...
        $t->same(
            ...
            $bundle([
                '/entry.css' => <<<'CSS'
@import url( "pkg:card.css" ) screen;
...
CSS,
        ...
        $assertInvalidQuotedUrlImport = static function (string $css, string $message) use ($t): void {
            $reads = [];
            try {
                (new CssBundler())->bundleWithReader('/entry.css', static function (string $file) use (&$reads, $css): string {
                    $reads[] = $file;
        ...
        $assertInvalidQuotedUrlImport(
            '@import url("blocks/card.css" extra); .entry { color: red }',
            'Unexpected token Ident("extra")'
        );
        $assertInvalidQuotedUrlImport(
            '@import url("blocks/card.css" "theme.css"); .entry { color: red }',
            'Unexpected token String("theme.css")'
        );
        $assertInvalidQuotedUrlImport(
            '@import url("blocks/card.css", screen); .entry { color: red }',
        ...
        $assertBadUrlImport = static function (string $css, string $message) use ($t): void {
            ...
            throw new RuntimeException('Expected commented @import url() source BadUrl exception');
        };

        $assertBadUrlImport(
            '@import url(/*a*/ "pkg:card.css" /*b*/); .entry { color: red }',
            'Unexpected token BadUrl("/*a*/ \"pkg:card.css\" /*b*/")'
        );
    },
    'css bundler preserves raw url tokens and rejects token-invalid comment-shaped sources like upstream' => static function (TestRunner $t) use ($bundle): void {
        $t->same(
            '@media screen{.card{color:green}}.entry{color:red}',
            $bundle([
                '/entry.css' => '@import url( blocks/card.css ) screen; .entry { color: red }',
                '/blocks/card.css' => '.card { color: green }',
            ], '/entry.css')
        );
        ...
        $t->same(
            ...
            $bundle([
                '/entry.css' => '@import url( pkg:tokens.css ) layer(theme.tokens) supports(display: grid); .entry { color: red }',
                '/vendor/tokens.css' => ':root { --gap: 1rem }',
            ], '/entry.css', static function (string $specifier, string $originatingFile) use (&$resolved): string {
                $resolved[] = [$specifier, $originatingFile];
        ...
        $t->same(
            '.card{color:green}.entry{color:red}',
            $bundle([
                '/entry.css' => '@import url(/*x*/blocks/card.css); .entry { color: red }',
                '/vendor/card.css' => '.card { color: green }',
            ], '/entry.css', static function (string $specifier, string $originatingFile) use (&$resolved): string {
                $resolved[] = [$specifier, $originatingFile];
        ...
        $assertBadUrlImport(
            '@import url(/* generated by a loader */ blocks/card.css); .entry { color: red }',
            'Unexpected token BadUrl("/* generated by a loader */ blocks/card.css")'
        );
        $assertBadUrlImport(
            '@import url(blocks/card.css /* trailing build note */); .entry { color: red }',
            'Unexpected token BadUrl("blocks/card.css /* trailing build note */")'
        );
        $assertBadUrlImport(
            '@import url(blocks/card/* stale loader split */hero.css); .entry { color: red }',
            'Unexpected token BadUrl("blocks/card/* stale loader split */hero.css")'
        );
    },
