...
CSS
    ...
    'css minifier maps upstream hsl relative color sRGB origins' => static function (TestRunner $t): void {
        ...
        $cases = [
            ...
            'hsl(from rgb(20%, 40%, 60%, 80%) 25 s l / alpha)' => '#995e33cc',
            'hsl(from rgb(20%, 40%, 60%, 80%) 25deg s l / alpha)' => '#995e33cc',
            'hsl(from rgb(20%, 40%, 60%, 80%) h 20% l / alpha)' => '#52667acc',
            'hsl(from rgb(20%, 40%, 60%, 80%) h s 20% / alpha)' => '#19334dcc',
            'hsl(from rgb(20%, 40%, 60%, 80%) h s l / .2)' => '#3693',
            ...
            'hsl(from rgb(20%, 40%, 60%, 80%) h l s)' => '#4d80b3',
            'hsl(from rgb(20%, 40%, 60%, 80%) h calc(alpha * 100) l / calc(s / 100))' => '#1466b880',
            'hsl(from rgb(20%, 40%, 60%, 80%) h l l / calc(l / 100))' => '#3d668f66',
            'hsl(from rgb(20%, 40%, 60%, 80%) h calc(alpha * 100) calc(alpha * 100) / alpha)' => '#a3ccf5cc',
            ...
            'hsl(from hsl(120deg 20% 50% / .5) h s l / none)' => '#6960',
            ...
            'hsl(from hsl(120deg 20% 50% / none) h s l / alpha)' => '#6960',
    ...
    'css minifier maps upstream hwb relative color sRGB origins' => static function (TestRunner $t): void {
        ...
        $cases = [
            ...
            'hwb(from rgb(20%, 40%, 60%, 80%) 25 w b / alpha)' => '#995e33cc',
            'hwb(from rgb(20%, 40%, 60%, 80%) 25deg w b / alpha)' => '#995e33cc',
            'hwb(from rgb(20%, 40%, 60%, 80%) h 20% b / alpha)' => '#369c',
            'hwb(from rgb(20%, 40%, 60%, 80%) h w 20% / alpha)' => '#3380cccc',
            'hwb(from rgb(20%, 40%, 60%, 80%) h w b / .2)' => '#3693',
            ...
            'hwb(from rgb(20%, 40%, 60%, 80%) h calc(alpha * 100) w / calc(b / 100))' => '#ccc6',
            'hwb(from rgb(20%, 40%, 60%, 80%) h w w / calc(w / 100))' => '#3380cc33',
            'hwb(from rgb(20%, 40%, 60%, 80%) h calc(alpha * 100) calc(alpha * 100) / alpha)' => '#808080cc',
            ...
            'hwb(from hwb(none none none / none) h w b / alpha)' => '#f000',
            'hwb(from hwb(120deg none 50% / .5) h w b)' => '#008000',
            'hwb(from hwb(120deg 20% 50% / none) h w b / alpha)' => '#33803300',
    ...
    'css minifier maps upstream lab and oklab color-mix value normalization' => static function (TestRunner $t): void {
        ...
        $cases = [
            ...
            'color-mix(in %1$s, 25%% %1$s(10%% 20 30 / .4), %1$s(50%% 60 70 / .8))' => '%1$s(44.2857%% 54.2857 64.2857/.7)',
            'color-mix(in %1$s, %1$s(10%% 20 30 / .4), %1$s(50%% 60 70 / .8) 25%%)' => '%1$s(26%% 36 46/.5)',
            'color-mix(in %1$s, %1$s(10%% 20 30 / .4) 25%%, %1$s(50%% 60 70 / .8) 75%%)' => '%1$s(44.2857%% 54.2857 64.2857/.7)',
            'color-mix(in %1$s, %1$s(10%% 20 30 / .4) 30%%, %1$s(50%% 60 70 / .8) 90%%)' => '%1$s(44.2857%% 54.2857 64.2857/.7)',
            'color-mix(in %1$s, %1$s(10%% 20 30 / .4) 12.5%%, %1$s(50%% 60 70 / .8) 37.5%%)' => '%1$s(44.2857%% 54.2857 64.2857/.35)',
            'color-mix(in %1$s, %1$s(10%% 20 30 / .4) 0%%, %1$s(50%% 60 70 / .8))' => '%1$s(50%% 60 70/.8)',
            ...
            'color-mix(in %1$s, %1$s(10%% 20 30), %1$s(none none none))' => '%1$s(10%% 20 30)',
            'color-mix(in %1$s, %1$s(10%% 20 none), %1$s(50%% 60 70))' => '%1$s(30%% 40 70)',
            'color-mix(in %1$s, %1$s(10%% 20 30), %1$s(50%% 60 none))' => '%1$s(30%% 40 30)',
            'color-mix(in %1$s, %1$s(none 20 30), %1$s(50%% none 70))' => '%1$s(50%% 20 50)',
            'color-mix(in %1$s, %1$s(10%% 20 30 / none), %1$s(50%% 60 70))' => '%1$s(30%% 40 50)',
    ...
    'css minifier maps upstream lch and oklch color-mix value normalization' => static function (TestRunner $t): void {
        ...
        $cases = [
            ...
            'color-mix(in %1$s, %1$s(10%% 20 30deg), %1$s(50%% 60 70deg) 25%%)' => '%1$s(20%% 30 40)',
            'color-mix(in %1$s, %1$s(10%% 20 30deg) 25%%, %1$s(50%% 60 70deg) 75%%)' => '%1$s(40%% 50 60)',
            ...
            'color-mix(in %1$s, 25%% %1$s(10%% 20 30deg / .4), %1$s(50%% 60 70deg / .8))' => '%1$s(44.2857%% 54.2857 60/.7)',
            'color-mix(in %1$s, %1$s(10%% 20 30deg / .4), 25%% %1$s(50%% 60 70deg / .8))' => '%1$s(26%% 36 40/.5)',
            'color-mix(in %1$s, %1$s(10%% 20 30deg / .4), %1$s(50%% 60 70deg / .8) 25%%)' => '%1$s(26%% 36 40/.5)',
            'color-mix(in %1$s, %1$s(10%% 20 30deg / .4) 25%%, %1$s(50%% 60 70deg / .8) 75%%)' => '%1$s(44.2857%% 54.2857 60/.7)',
            'color-mix(in %1$s, %1$s(10%% 20 30deg / .4) 30%%, %1$s(50%% 60 70deg / .8) 90%%)' => '%1$s(44.2857%% 54.2857 60/.7)',
            ...
            'color-mix(in %1$s, %1$s(10%% 20 30deg / none), %1$s(50%% 60 70deg))' => '%1$s(30%% 40 50)',
            'color-mix(in %1$s, %1$s(10%% 20 30deg / none), %1$s(50%% 60 70deg / 0.5))' => '%1$s(30%% 40 50/.5)',
    ...
    'css minifier maps upstream lch and oklch color-mix hue interpolation modes' => static function (TestRunner $t): void {
        $minifier = new CssMinifier();
        $cases = [
            'color-mix(in %1$s, %1$s(100%% 0 40deg), %1$s(100%% 0 60deg))' => '%1$s(100%% 0 50)',
            'color-mix(in %1$s, %1$s(100%% 0 60deg), %1$s(100%% 0 40deg))' => '%1$s(100%% 0 50)',
            'color-mix(in %1$s, %1$s(100%% 0 50deg), %1$s(100%% 0 330deg))' => '%1$s(100%% 0 10)',
            'color-mix(in %1$s, %1$s(100%% 0 330deg), %1$s(100%% 0 50deg))' => '%1$s(100%% 0 10)',
            'color-mix(in %1$s, %1$s(100%% 0 20deg), %1$s(100%% 0 320deg))' => '%1$s(100%% 0 350)',
            'color-mix(in %1$s, %1$s(100%% 0 320deg), %1$s(100%% 0 20deg))' => '%1$s(100%% 0 350)',
            'color-mix(in %1$s shorter hue, %1$s(100%% 0 40deg), %1$s(100%% 0 60deg))' => '%1$s(100%% 0 50)',
            'color-mix(in %1$s shorter hue, %1$s(100%% 0 60deg), %1$s(100%% 0 40deg))' => '%1$s(100%% 0 50)',
            'color-mix(in %1$s shorter hue, %1$s(100%% 0 50deg), %1$s(100%% 0 330deg))' => '%1$s(100%% 0 10)',
            'color-mix(in %1$s shorter hue, %1$s(100%% 0 330deg), %1$s(100%% 0 50deg))' => '%1$s(100%% 0 10)',
            'color-mix(in %1$s shorter hue, %1$s(100%% 0 20deg), %1$s(100%% 0 320deg))' => '%1$s(100%% 0 350)',
            'color-mix(in %1$s shorter hue, %1$s(100%% 0 320deg), %1$s(100%% 0 20deg))' => '%1$s(100%% 0 350)',
            'color-mix(in %1$s longer hue, %1$s(100%% 0 40deg), %1$s(100%% 0 60deg))' => '%1$s(100%% 0 230)',
            'color-mix(in %1$s longer hue, %1$s(100%% 0 60deg), %1$s(100%% 0 40deg))' => '%1$s(100%% 0 230)',
            'color-mix(in %1$s longer hue, %1$s(100%% 0 50deg), %1$s(100%% 0 330deg))' => '%1$s(100%% 0 190)',
            'color-mix(in %1$s longer hue, %1$s(100%% 0 330deg), %1$s(100%% 0 50deg))' => '%1$s(100%% 0 190)',
            'color-mix(in %1$s longer hue, %1$s(100%% 0 20deg), %1$s(100%% 0 320deg))' => '%1$s(100%% 0 170)',
            'color-mix(in %1$s longer hue, %1$s(100%% 0 320deg), %1$s(100%% 0 20deg))' => '%1$s(100%% 0 170)',
            'color-mix(in %1$s increasing hue, %1$s(100%% 0 40deg), %1$s(100%% 0 60deg))' => '%1$s(100%% 0 50)',
            'color-mix(in %1$s increasing hue, %1$s(100%% 0 60deg), %1$s(100%% 0 40deg))' => '%1$s(100%% 0 230)',
            'color-mix(in %1$s increasing hue, %1$s(100%% 0 50deg), %1$s(100%% 0 330deg))' => '%1$s(100%% 0 190)',
            'color-mix(in %1$s increasing hue, %1$s(100%% 0 330deg), %1$s(100%% 0 50deg))' => '%1$s(100%% 0 10)',
            'color-mix(in %1$s increasing hue, %1$s(100%% 0 20deg), %1$s(100%% 0 320deg))' => '%1$s(100%% 0 170)',
            'color-mix(in %1$s increasing hue, %1$s(100%% 0 320deg), %1$s(100%% 0 20deg))' => '%1$s(100%% 0 350)',
            'color-mix(in %1$s decreasing hue, %1$s(100%% 0 40deg), %1$s(100%% 0 60deg))' => '%1$s(100%% 0 230)',
            'color-mix(in %1$s decreasing hue, %1$s(100%% 0 60deg), %1$s(100%% 0 40deg))' => '%1$s(100%% 0 50)',
            'color-mix(in %1$s decreasing hue, %1$s(100%% 0 50deg), %1$s(100%% 0 330deg))' => '%1$s(100%% 0 10)',
            'color-mix(in %1$s decreasing hue, %1$s(100%% 0 330deg), %1$s(100%% 0 50deg))' => '%1$s(100%% 0 190)',
            'color-mix(in %1$s decreasing hue, %1$s(100%% 0 20deg), %1$s(100%% 0 320deg))' => '%1$s(100%% 0 350)',
            'color-mix(in %1$s decreasing hue, %1$s(100%% 0 320deg), %1$s(100%% 0 20deg))' => '%1$s(100%% 0 170)',
            'color-mix(in %1$s specified hue, %1$s(100%% 0 40deg), %1$s(100%% 0 60deg))' => '%1$s(100%% 0 50)',
            'color-mix(in %1$s specified hue, %1$s(100%% 0 60deg), %1$s(100%% 0 40deg))' => '%1$s(100%% 0 50)',
            'color-mix(in %1$s specified hue, %1$s(100%% 0 50deg), %1$s(100%% 0 330deg))' => '%1$s(100%% 0 190)',
            'color-mix(in %1$s specified hue, %1$s(100%% 0 330deg), %1$s(100%% 0 50deg))' => '%1$s(100%% 0 190)',
            'color-mix(in %1$s specified hue, %1$s(100%% 0 20deg), %1$s(100%% 0 320deg))' => '%1$s(100%% 0 170)',
            'color-mix(in %1$s specified hue, %1$s(100%% 0 320deg), %1$s(100%% 0 20deg))' => '%1$s(100%% 0 170)',
        ];
    ...
    'css minifier maps upstream hsl color-mix remaining hue and none variants' => static function (TestRunner $t): void {
        $minifier = new CssMinifier();
        $cases = [
            'color-mix(in hsl, hsl(60deg 50% 50%), hsl(40deg 50% 50%))' => '#bfaa40',
            'color-mix(in hsl, hsl(330deg 50% 50%), hsl(50deg 50% 50%))' => '#bf5540',
            'color-mix(in hsl, hsl(20deg 50% 50%), hsl(320deg 50% 50%))' => '#bf4055',
            'color-mix(in hsl, hsl(320deg 50% 50%), hsl(20deg 50% 50%))' => '#bf4055',
            'color-mix(in hsl shorter hue, hsl(40deg 50% 50%), hsl(60deg 50% 50%))' => '#bfaa40',
            'color-mix(in hsl shorter hue, hsl(60deg 50% 50%), hsl(40deg 50% 50%))' => '#bfaa40',
            'color-mix(in hsl shorter hue, hsl(50deg 50% 50%), hsl(330deg 50% 50%))' => '#bf5540',
            'color-mix(in hsl shorter hue, hsl(330deg 50% 50%), hsl(50deg 50% 50%))' => '#bf5540',
            'color-mix(in hsl shorter hue, hsl(320deg 50% 50%), hsl(20deg 50% 50%))' => '#bf4055',
            'color-mix(in hsl longer hue, hsl(60deg 50% 50%), hsl(40deg 50% 50%))' => '#4055bf',
            'color-mix(in hsl longer hue, hsl(50deg 50% 50%), hsl(330deg 50% 50%))' => '#40aabf',
            'color-mix(in hsl longer hue, hsl(330deg 50% 50%), hsl(50deg 50% 50%))' => '#40aabf',
            'color-mix(in hsl increasing hue, hsl(40deg 50% 50%), hsl(60deg 50% 50%))' => '#bfaa40',
            'color-mix(in hsl increasing hue, hsl(50deg 50% 50%), hsl(330deg 50% 50%))' => '#40aabf',
            'color-mix(in hsl increasing hue, hsl(330deg 50% 50%), hsl(50deg 50% 50%))' => '#bf5540',
            'color-mix(in hsl decreasing hue, hsl(60deg 50% 50%), hsl(40deg 50% 50%))' => '#bfaa40',
            'color-mix(in hsl decreasing hue, hsl(50deg 50% 50%), hsl(330deg 50% 50%))' => '#bf5540',
            'color-mix(in hsl decreasing hue, hsl(330deg 50% 50%), hsl(50deg 50% 50%))' => '#40aabf',
            'color-mix(in hsl decreasing hue, hsl(20deg 50% 50%), hsl(320deg 50% 50%))' => '#bf4055',
            'color-mix(in hsl specified hue, hsl(40deg 50% 50%), hsl(60deg 50% 50%))' => '#bfaa40',
            'color-mix(in hsl specified hue, hsl(60deg 50% 50%), hsl(40deg 50% 50%))' => '#bfaa40',
            'color-mix(in hsl specified hue, hsl(330deg 50% 50%), hsl(50deg 50% 50%))' => '#40aabf',
            'color-mix(in hsl, hsl(none none none), hsl(none none none))' => '#000',
            'color-mix(in hsl, hsl(none none none), hsl(30deg 40% 80%))' => '#e0ccb8',
            'color-mix(in hsl, hsl(120deg 20% 40%), hsl(none none none))' => '#527a52',
            'color-mix(in hsl, hsl(120deg 20% none), hsl(30deg 40% 60%))' => '#a8b87a',
            'color-mix(in hsl, hsl(120deg 20% 40%), hsl(30deg 20% none))' => '#707a52',
            'color-mix(in hsl, hsl(none 20% 40%), hsl(30deg none 80%))' => '#ad9985',
        ];
    ...
    'css minifier maps upstream color function color-mix value normalization' => static function (TestRunner $t): void {
        ...
        foreach ($spaces as $inputSpace => $outputSpace) {
            $cases = [
                ...
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3) 25%, color({$inputSpace} .5 .6 .7) 75%)" => "color({$outputSpace} .4 .5 .6)",
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3) 30%, color({$inputSpace} .5 .6 .7) 90%)" => "color({$outputSpace} .4 .5 .6)",
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3) 0%, color({$inputSpace} .5 .6 .7))" => "color({$outputSpace} .5 .6 .7)",
                ...
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3 / .4), color({$inputSpace} .5 .6 .7 / .8) 25%)" => "color({$outputSpace} .26 .36 .46/.5)",
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3 / .4), 25% color({$inputSpace} .5 .6 .7 / .8))" => "color({$outputSpace} .26 .36 .46/.5)",
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3 / .4) 25%, color({$inputSpace} .5 .6 .7 / .8) 75%)" => "color({$outputSpace} .442857 .542857 .642857/.7)",
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3 / .4) 30%, color({$inputSpace} .5 .6 .7 / .8) 90%)" => "color({$outputSpace} .442857 .542857 .642857/.7)",
                ...
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3 / .4) 0%, color({$inputSpace} .5 .6 .7 / .8))" => "color({$outputSpace} .5 .6 .7/.8)",
                ...
                "color-mix(in {$inputSpace}, color({$inputSpace} none none none), color({$inputSpace} none none none))" => "color({$outputSpace} none none none)",
                "color-mix(in {$inputSpace}, color({$inputSpace} none none none), color({$inputSpace} .5 .6 .7))" => "color({$outputSpace} .5 .6 .7)",
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3), color({$inputSpace} none none none))" => "color({$outputSpace} .1 .2 .3)",
                ...
                "color-mix(in {$inputSpace}, color({$inputSpace} .1 .2 .3 / none), color({$inputSpace} .5 .6 .7))" => "color({$outputSpace} .3 .4 .5)",
    ...
    'css minifier maps upstream oblique default angle font values' => static function (TestRunner $t): void {
        ...
        $t->same('.foo{font-style:oblique 14deg}', $minifier->minify('.foo { font-style: oblique 0.24434609527920614rad; }'));
        $t->same('.foo{font-style:oblique .038889turn}', $minifier->minify('.foo { font-style: oblique 0.03888888888888889turn; }'));
        ...
        $t->same('@font-face{font-family:Inter;font-style:oblique 0deg 0deg}', $minifier->minify('@font-face { font-family: Inter; font-style: oblique 0deg -0rad; }'));
        $t->same('@font-face{font-family:Inter;font-style:oblique 14deg}', $minifier->minify('@font-face { font-family: Inter; font-style: oblique 0.24434609527920614rad 0.24434609527920614rad; }'));
        ...
        $t->same('.foo{font:oblique 14deg 22px Helvetica}', $minifier->minify('.foo { font: oblique 0.24434609527920614rad 22px Helvetica; }'));
    },
