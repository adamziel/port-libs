...
@import url(./blocks/query-card.css) /* wp block layer, old alias: (--wp-tablet) ) */ layer(theme.blocks) supports((display: grid)) screen and (min-width: 480px /* old floor ) */) and (--wp-wide);

@media (min-width: 480px /* old floor ) */) and /* old alias: (--wp-legacy-mobile) */ (--wp-mobile) and (--wp-motion) {
