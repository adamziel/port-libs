...
@import url(./blocks/query-card.css) /* wp block layer, stale layer(old) supports((display:flex)) old alias: (--wp-tablet), ) */ layer(theme.blocks) supports((display: grid)) screen and (min-width: 480px /* old floor, ) */) and (--wp-wide), print and (--wp-motion);
