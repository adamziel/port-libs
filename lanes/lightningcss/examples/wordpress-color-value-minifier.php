...
.wp-block-cover.has-named-overlay {
  color: yellow;
}
...
.wp-block-cover.has-perceptual-mixed-overlay {
  ...
  border-color: color-mix(in lab, 25% lab(10% 20 30 / .4), lab(50% 60 70 / .8));
  text-decoration-color: color-mix(in oklab, oklab(10% 20 30), oklab(none none none));
}
