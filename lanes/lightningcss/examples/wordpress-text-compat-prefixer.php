...
$expected = [
    ...
    'ios4_1_hyphen_boundary' => '.wp-site-root{hyphens:manual;tab-size:4}',
    'ios4_2_hyphen_boundary' => '.wp-site-root{-webkit-hyphens:manual;hyphens:manual;tab-size:4}',
    'opera10_5_tab_boundary' => '.wp-site-root{hyphens:manual;tab-size:4}',
    'opera10_6_tab_boundary' => '.wp-site-root{hyphens:manual;-o-tab-size:4;tab-size:4}',
];
