...
$actual = [
    ...
    'legacy_android_42' => $prefixer->prefixForTargets($css, ['android' => '4.2']),
    'modern_android_43' => $prefixer->prefixForTargets($css, ['android' => '4.3']),
...
$expected = [
    ...
    'legacy_android_42' => '.wp-block-button.is-style-legacy-reveal .wp-block-button__link{-webkit-transition:opacity .2s ease-in-out .1s;transition:opacity .2s ease-in-out .1s}',
    'modern_android_43' => '.wp-block-button.is-style-legacy-reveal .wp-block-button__link{transition:opacity .2s ease-in-out .1s}',
