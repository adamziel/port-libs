...
$actual = [
    'minifiedResolutionXUnit' => $minifier->minify(
        '@import "blocks/density.css" layer(theme.blocks) (min-resolution: 2dppx); @layer theme.blocks { @media (2dppx <= resolution <= 3dppx) { .wp-block-query.is-density-window { color: yellow; } } }'
    ),
    ...
    'layerStatementBeforeMediaRangeFallback' => $prefixer->prefixForTargets(
        '@layer reset, theme.blocks; @media (width >= 240px) { @layer theme.blocks { .wp-block-query.is-layer-statement-range { color: yellow; } } }',
        ['firefox' => 60]
    ),
    'layerStatementBeforeMediaIntervalFallback' => $prefixer->prefixForTargets(
        '@layer reset, theme.blocks; @media (100px <= width <= 200px) { @layer theme.blocks { .wp-block-query.is-layer-statement-window { color: yellow; } } }',
        ['firefox' => 85]
    ),
    'layerStatementBeforeResolutionPrefix' => $prefixer->prefixForTargets(
        '@layer reset, theme.blocks; @media (resolution >= 2dppx) { @layer theme.blocks { .wp-block-query.is-layer-statement-density { color: yellow; } } }',
        ['safari' => 15, 'firefox' => 10]
    ),
...
@layer theme.blocks {
  ...
  @media (width >= sign(calc(1em + 2px))) {
    .wp-block-query.is-fluid-sign-wide {
      color: yellow;
    }
  }

  @media (theme-breakpoint >= sign(max(1em, 2px))) {
    .wp-block-query.is-fluid-sign-theme {
      color: yellow;
    }
  }
}
...
CSS,
    ...
    'trigFunctionRangeFallback' => $prefixer->prefixForTargets(
        <<<'CSS'
@layer theme.blocks {
  @media (width >= sin(90deg)) {
    .wp-block-query.is-trig-sine-breakpoint {
      color: yellow;
    }
  }

  @media (width >= max(sin(1rad), 4px)) {
    .wp-block-query.is-trig-nested-breakpoint {
      color: yellow;
    }
  }

  @media (theme-breakpoint >= cos(0deg)) {
    .wp-block-query.is-trig-theme-breakpoint {
      color: yellow;
    }
  }
}
...
try {
    $prefixer->prefixForTargets(
        '@layer theme.blocks { @media (width >= sign(var(--theme-breakpoint))) { .wp-block-query { color: chartreuse; } } }',
        ['firefox' => 60]
    );
    $actual['invalidUnresolvedSignFunctionGuard'] = 'missing';
} catch (InvalidArgumentException) {
    $actual['invalidUnresolvedSignFunctionGuard'] = 'invalid-media-query';
}
...
try {
    $prefixer->prefixForTargets(
        '@layer theme.blocks { @media (width >= sin(1px)) { .wp-block-query { color: chartreuse; } } }',
        ['firefox' => 60]
    );
    $actual['invalidTrigFunctionGuard'] = 'missing';
} catch (InvalidArgumentException) {
    $actual['invalidTrigFunctionGuard'] = 'invalid-media-query';
}
...
$expected = [
    ...
    'layerStatementBeforeMediaIntervalFallback' => '@layer reset,theme.blocks;@media (min-width:100px) and (max-width:200px){@layer theme.blocks{.wp-block-query.is-layer-statement-window{color:#ff0}}}',
    'layerStatementBeforeResolutionPrefix' => '@layer reset,theme.blocks;@media (-webkit-min-device-pixel-ratio:2),(min--moz-device-pixel-ratio:2),(min-resolution:2dppx){@layer theme.blocks{.wp-block-query.is-layer-statement-density{color:#ff0}}}',
    ...
    'trigFunctionRangeFallback' => '@layer theme.blocks{@media (min-width:1){.wp-block-query.is-trig-sine-breakpoint{color:#ff0}}@media (min-width:max(.841471,4px)){.wp-block-query.is-trig-nested-breakpoint{color:#ff0}}@media (min-theme-breakpoint:1){.wp-block-query.is-trig-theme-breakpoint{color:#ff0}}}',
    ...
    'invalidTrigFunctionGuard' => 'invalid-media-query',
