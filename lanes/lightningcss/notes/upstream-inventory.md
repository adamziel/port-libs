...
Current PHP lane evidence: 7 LightningCSS test files, 267 assertions, 0 failures. The required root `php tools/run-tests.php` rerun on 2026-05-22 passes with 106 test files, 7,467 assertions, and 0 failures.
