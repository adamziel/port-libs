...
Broaden the bounded two-trial upstream-MT19937 sync-fuzz slice into the full upstream 500-trial proof-fragment sync fuzz, including persisted LMDB-style branch node-id parity.
