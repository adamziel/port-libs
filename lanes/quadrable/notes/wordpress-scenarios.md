...
Wire persisted tracked-node snapshots into the upstream-shaped sync-fuzz loop so the full-fuzzer evidence also covers restored named heads and branch node-id continuity.
