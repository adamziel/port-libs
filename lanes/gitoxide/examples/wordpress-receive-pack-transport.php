...
return [
    ...
    'sshBareIpv6Target' => $fixture['sshBareIpv6Target'],
    'sshBareIpv6Arguments' => $fixture['sshBareIpv6Context']['sshArguments'],
    'sshBareIpv6CredentialContext' => $fixture['sshBareIpv6Context']['redactedCredentialContext'],
    'sshBareIpv6NumericTailTarget' => $fixture['sshBareIpv6NumericTailTarget'],
    'sshBareIpv6NumericTailArguments' => $fixture['sshBareIpv6NumericTailContext']['sshArguments'],
    ...
    'smartHttpSha256DeleteResponseSuccessful' => $fixture['smartHttpSha256DeleteBoundary']['responseSuccessful'],
    ...
    'sshNormalizedDnsHostTarget' => $fixture['sshNormalizedDnsHostTarget'],
    'sshNormalizedDnsHostArguments' => $fixture['sshNormalizedDnsHostContext']['sshArguments'],
    'sshNormalizedDnsHostCredentialContext' => $fixture['sshNormalizedDnsHostContext']['credentialContext']->storageBytes(),
    ...
    'unsafeSshDecodedQuestionHostRejected' => $fixture['unsafeSshDecodedQuestionHostRejected'],
