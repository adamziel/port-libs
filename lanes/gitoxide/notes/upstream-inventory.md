...
- Gitoxide-only PHP verification after this slice passes 25 test files, 1,585 assertions, and 0 failures.
- Latest root PHP verification is green: `php tools/run-tests.php` passes 103 test files, 7,052 assertions, and 0 failures in the current dirty worktree.
