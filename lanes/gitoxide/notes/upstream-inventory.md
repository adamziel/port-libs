...
- Gitoxide-only PHP verification after this slice passes 27 test files, 1,877 assertions, and 0 failures.
- Latest root PHP verification is green: `php tools/run-tests.php` passes 116 test files, 8,826 assertions, and 0 failures in the current dirty worktree.
