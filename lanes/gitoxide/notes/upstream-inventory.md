...
- Gitoxide-only PHP verification after this slice passes 26 test files, 1,797 assertions, and 0 failures.
- Latest root PHP verification is green: `php tools/run-tests.php` passes 111 test files, 8,142 assertions, and 0 failures in the current dirty worktree.
