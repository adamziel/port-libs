...
- Gitoxide-only PHP verification after this slice passes 26 test files, 1,851 assertions, and 0 failures.
- Latest root PHP verification is green: `php tools/run-tests.php` passes 115 test files, 8,684 assertions, and 0 failures in the current dirty worktree.
