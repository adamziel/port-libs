...
- Gitoxide-only PHP verification after this slice passes 27 test files, 1,884 assertions, and 0 failures.
- Latest root PHP verification is green: `php tools/run-tests.php` passes 117 test files, 9,034 assertions, and 0 failures in the current dirty worktree.
