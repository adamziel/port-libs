...
Map another focused `gix-merge` tree fixture, broaden protocol/transport runner evidence with a controlled focused crate probe, or map smaller `text-baseline.tar` cases beyond the current zealous hunk-contraction slice.
