...
Broaden annotated tag write/ref-iterator parity, broaden commit trailer edge cases from upstream fixtures, add broader directory rename conflict cases, broaden proxy credential persistence, or try a controlled crate-level upstream runner probe.
