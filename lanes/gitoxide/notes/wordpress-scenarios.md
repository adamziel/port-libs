...
Map another focused `gix-merge` tree fixture, broaden protocol/transport runner evidence with a controlled focused crate probe, or map another smaller `gix-merge` text-baseline/regression case beyond the current marker-newline slice.
