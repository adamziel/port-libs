...
Add bounded delta reuse/search heuristics, map another focused `gix-merge` fixture, or broaden protocol/transport runner evidence with a controlled focused crate probe.
