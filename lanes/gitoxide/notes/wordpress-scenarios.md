...
Map another focused `gix-merge` tree fixture, broaden protocol/transport runner evidence with a controlled focused crate probe, or add zealous-diff3/text-baseline hunk contraction beyond the current text auto-resolution slice.
