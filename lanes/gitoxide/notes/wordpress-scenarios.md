...
Map merge-base and tree three-way merge primitives, or add concrete git-daemon/SSH/HTTP receive-pack URL adapters if transport work stays highest priority.
