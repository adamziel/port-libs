...
Add peeled-tag object lookup for packed update modes and log-only/deref transaction split reporting, or run another controlled `gix-object` message/tag integration subset.
