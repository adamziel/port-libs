...
return [
    ...
    'legacySshRemoteUrl' => 'git+ssh://Deploy.User@[::1]:/~wp-content/site.git',
    'expectedLegacySshRemoteUrl' => 'ssh://Deploy.User@::1/~wp-content/site.git',
    'expectedLegacySshRemoteScheme' => 'ssh',
    'expectedLegacySshRemoteUser' => 'Deploy.User',
    'expectedLegacySshRemoteHost' => '::1',
    'expectedLegacySshRemotePort' => null,
    'expectedLegacySshRemotePath' => '~wp-content/site.git',
    ...
    'pushMatchRefspecs' => [
        ...
        '^refs/heads/private',
        'refs/tags/v6.0:refs/tags/v6.0',
        'refs/heads/wp-content',
        str_repeat('A', 40) . ':refs/heads/wp-content-object',
        ':refs/heads/stale-preview',
        ':',
    ],
    'localPushRefs' => [
        ['name' => 'refs/heads/wp-content', 'target' => str_repeat('1', 40)],
        ['name' => 'refs/heads/wp-theme', 'target' => str_repeat('2', 40)],
        ['name' => 'refs/heads/private', 'target' => str_repeat('3', 40)],
        ['name' => 'refs/heads/feature/import', 'target' => str_repeat('4', 40)],
        ['name' => 'refs/tags/v6.0', 'target' => str_repeat('5', 40)],
    ],
    'expectedMatchedPushLocals' => [
        'refs/heads/wp-content',
        'refs/heads/wp-theme',
        'refs/heads/feature/import',
        'refs/tags/v6.0',
        'refs/heads/wp-content',
        str_repeat('a', 40),
    ],
    'expectedMatchedPushRemotes' => [
        'refs/deploy/wp-content',
        'refs/deploy/wp-theme',
        'refs/deploy/feature/import',
        'refs/tags/v6.0',
        'refs/heads/wp-content',
        'refs/heads/wp-content-object',
    ],
    'expectedMatchedPushForce' => [
        true,
        true,
        true,
        false,
