...
echo '<!-- markerpdf:pdf-type3-charprocs-resource-comment-currentbase ' . htmlspecialchars(json_encode([
    'source' => 'native-pdf-type3-charprocs-resource-comment-boundary',
    'visible_fallback_content_preserved' => $plainText === 'Visible fallback content',
    'direct_charproc_payload_excluded' => !str_contains($plainText, 'comment-split charproc text leak'),
    'top_level_type3_resource_form_excluded' => !str_contains($plainText, 'top comment-split Type3 resource leak'),
    'stream_type3_resource_form_excluded' => !str_contains($plainText, 'stream comment-split Type3 resource leak'),
    'nested_type3_resource_form_excluded' => !str_contains($plainText, 'nested comment-split Type3 resource leak'),
