...
echo '<!-- markerpdf:pdf-type3-charprocs-comment-reference-boundary-currentbase ' . htmlspecialchars(json_encode([
    'source' => 'native-pdf-type3-charprocs-comment-reference-boundary',
    'font_width_sources' => [
        'comment-split Type3 /CharProcs dictionary reference',
        'comment-split glyph CharProc stream reference',
        'Type3 CharProc d0/d1 width operators',
    ],
    'comment_split_charprocs_reference_resolved' => $lines === ['WideBlock', 'Thin Text'],
    ...
    'charproc_payload_visible_text_excluded' => !str_contains($plainText, 'comment reference charproc text leak'),
