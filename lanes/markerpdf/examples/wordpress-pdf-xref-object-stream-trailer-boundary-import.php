...
if (!is_string($compressedObjectStream)) {
    throw new RuntimeException('Unable to compress stale object-stream smoke fixture.');
}
...
echo '<!-- markerpdf-xref-object-stream-trailer-boundary-smoke ' . htmlspecialchars(json_encode([
    'executes_python_or_models' => false,
    'executes_external_pdf_tools' => false,
    'native_boundary' => 'latest trailer/xref-selected object-stream rows bound compressed member repair before Gutenberg paragraph rendering',
    'uses_current_trailer_boundary_page' => str_contains($plainText, 'Current trailer boundary page'),
    'repairs_direct_page_tree' => str_contains($plainText, 'Direct page tree repaired'),
    'excluded_unselected_object_stream_page' => !str_contains($plainText, 'Stale unselected object stream page'),
    'excluded_unselected_page_tree_overwrite' => !str_contains($plainText, 'unselected page tree overwrite'),
