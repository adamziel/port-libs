...
if ($labels !== ['1', 'Body 5', 'Chapter 9', 'Chapter 10']) {
    throw new RuntimeException('Expected inherited PageLabels limits to reject stale child number-tree keys.');
}
...
echo '<!-- markerpdf-page-labels-inherited-limits-boundary-smoke ' . htmlspecialchars(json_encode([
    'executes_python_or_models' => false,
    'executes_external_pdf_tools' => false,
    'native_boundary' => 'catalog /PageLabels parent /Limits constrain indirect kid /Nums before WordPress page-break metadata',
    'page_labels' => $labels,
    'stale_front_label_excluded' => !in_array('stale-front-vi', $labels, true),
