...
$content = 'BT /Fcid 12 Tf 1 0 0 1 72 720 Tm <0001000200030004> Tj 1 0 0 1 118 720 Tm <00050006000700080009> Tj '
    . 'T* 1 0 0 1 72 704 Tm <0014001500160017> Tj 1 0 0 1 96 704 Tm <00180019001A001B> Tj ET';
$pdf = "%PDF-1.4\n"
...
echo '<!-- markerpdf:pdf-cidfont-widths ' . htmlspecialchars(json_encode([
    'source' => 'native-pdf-cidfont-w-widths-advance-boundary',
    'font_width_sources' => ['/W', '/DW'],
