...
echo '<!-- markerpdf:pdf-cidfont-vertical-metrics ' . htmlspecialchars(json_encode([
    'source' => 'native-pdf-cidfont-wmode-w2-dw2-advance-boundary',
    'font_width_sources' => ['/WMode', '/DW2', '/W2'],
