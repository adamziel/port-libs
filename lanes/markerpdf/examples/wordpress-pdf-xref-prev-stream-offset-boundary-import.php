...
echo '<!-- markerpdf-xref-prev-stream-offset-boundary-smoke ' . htmlspecialchars(json_encode([
    'executes_python_or_models' => false,
    'executes_external_pdf_tools' => false,
    'native_boundary' => 'PDF xref-stream /Prev chain rejects invalid explicit type-1 offsets before stale generation fallback',
    'uses_current_valid_xref_offset_page' => str_contains($plainText, 'Current valid xref offset page'),
    'rejects_invalid_explicit_xref_offset' => true,
    'excluded_stale_prev_generation_content' => !str_contains($plainText, 'Stale invalid offset resurrection'),
