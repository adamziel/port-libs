...
echo "<!-- markerpdf-winansi-smoke " . htmlspecialchars(json_encode([
    'executes_python_or_models' => false,
    'executes_external_pdf_tools' => false,
    'native_boundary' => 'simple font WinAnsiEncoding punctuation decoding before Gutenberg paragraph rendering',
