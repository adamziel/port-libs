...
if (
    ...
    || ($stroke['pattern_bboxes'] ?? null) !== [[-1.0, -1.0, 21.0, 11.0]]
    || ($stroke['pattern_path_bboxes'] ?? null) !== [[0.0, 0.0, 20.0, 10.0]]
    || ($stroke['pattern_visible_bboxes'] ?? null) !== [[-1.0, -1.0, 21.0, 11.0]]
    || ($stroke['pattern_paint_kinds'] ?? null) !== ['stroking']
    || ($stroke['pattern_stroke_widths'] ?? null) !== [[2.0]]
    ...
    || ($stroke['invocation_clip_bboxes'] ?? null) !== [[4.0, 5.0, 21.0, 11.0]]
