...
echo '<!-- markerpdf:pdf-type0-cmap-width-priority ' . htmlspecialchars(json_encode([
    'source' => 'native-pdf-type0-encoding-cmap-cid-width-priority',
    'font_width_sources' => ['Type0 /Encoding CMap begincidrange', 'Descendant CIDFont /W', 'raw source-code width fallback'],
    'uses_encoding_cmap_cid_priority' => str_contains($plainText, 'WideBlock') && str_contains($plainText, 'Thin Text'),
    'raw_source_width_fallback_not_used_when_cid_is_mapped' => !str_contains($plainText, 'Wide Block') && !str_contains($plainText, 'ThinText'),
