...
$reviewEntries = array_column($review['entries'], null, 'object_number');
...
echo 'prev_type2_review_entries=' . (string) $review['inherited_type2_entry_count'] . "\n";
echo 'skipped_unselected_prev_carrier_count=' . (string) $review['skipped_unselected_carrier_count'] . "\n";
echo 'preserved_prev_type2_count=' . (string) $review['preserved_type2_entry_count'] . "\n";
echo 'page_member_owner_policy=' . (string) ($reviewEntries[4]['owner_policy'] ?? 'missing') . "\n";
echo 'carrier_member_owner_policy=' . (string) ($reviewEntries[6]['owner_policy'] ?? 'missing') . "\n";
