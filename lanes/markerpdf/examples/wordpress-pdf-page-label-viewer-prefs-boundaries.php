...
$pdf = "%PDF-1.7\n"
    . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R /PageLabels 20 0 R /PageLayout /TwoPageRight /PageMode /UseOutlines /ViewerPreferences 7 0 R >>\nendobj\n"
...
echo '<!-- markerpdf-page-label-viewer-prefs-boundaries-smoke ' . htmlspecialchars(json_encode([
    ...
    'native_boundary' => 'catalog /PageLabels number-tree /Limits plus indirect /ViewerPreferences review metadata',
