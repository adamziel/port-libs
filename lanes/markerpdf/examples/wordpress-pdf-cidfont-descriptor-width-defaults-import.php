...
echo '<!-- markerpdf:pdf-cidfont-descriptor-width-defaults ' . htmlspecialchars(json_encode([
    'source' => 'native-pdf-cidfont-descriptor-default-dw-advance-boundary',
    'font_width_sources' => ['CIDFont default /DW 1000', '/FontDescriptor present without /CIDSet'],
