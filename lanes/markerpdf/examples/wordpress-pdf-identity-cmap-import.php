...
echo "<!-- markerpdf-identity-cmap-smoke " . htmlspecialchars(json_encode([
    'executes_python_or_models' => false,
    'executes_external_pdf_tools' => false,
    'native_boundary' => 'Type0 Identity-H font CMap source-width fallback before Gutenberg paragraph rendering',
