...
echo '<!-- markerpdf-font-cid-type3-tounicode-spacing-width-currentbase-smoke ' . htmlspecialchars(json_encode([
    'scenario' => 'wordpress-pdf-font-cid-type3-tounicode-spacing-width-currentbase',
    'source' => 'native-pdf-cid-type3-cmap-tounicode-source-spacing-width-boundary',
    'font_width_sources' => [
        'Type0 /Encoding CMap source-to-CID rows',
        'Descendant CIDFont /W widths',
        'Type3 CMap source-to-CID rows',
        'Type3 /Widths array',
    ],
    'type0_cid32_word_spacing_applied' => str_contains($plainText, "A\u{2060}BC") && !str_contains($plainText, 'B C'),
    'type3_cid32_word_spacing_preserved' => str_contains($plainText, "D\u{2060}EF") && !str_contains($plainText, 'E F'),
    'tounicode_word_joiner_preserved' => str_contains($plainText, "\u{2060}"),
    'raw_source_codes_excluded' => !str_contains($plainText, 'F020') && !str_contains($plainText, 'E020'),
