...
$safeText = 'WP Array End Safe Import';
$leakingText = 'WP Array End CMap Leak';
$cMapName = 'WPArrayEndOperatorBoundary-H';
...
$cMap = "/CIDInit /ProcSet findresource begin\n"
    ...
    . "endcodespacerange\n"
    . "1 beginbfrange\n"
    . "<0001> <0001> [ endcmap <" . $utf16beHex($leakingText) . "> ]\n"
    . "endbfrange\n"
    . "1 beginbfchar\n"
...
if (!is_string($compressedCMap)) {
    throw new RuntimeException('Unable to compress WordPress array end-operator CMap fixture.');
}
...
$pdf = "%PDF-1.5\n"
    ...
    . "4 0 obj\n<< /Type /Font /Subtype /Type0 /BaseFont /WPArrayEndOperatorBoundary /Encoding /Identity-H /ToUnicode 6 0 R >>\nendobj\n"
...
$flags = [
    'source' => 'native-pdf-malformed-cmap-array-end-operator-boundary',
    'support_component' => 'pdf-text-dictionary-core',
    'native_boundary' => 'endcmap tokens inside filtered ToUnicode CMap arrays are data before parser program bounding',
    'safe_text_imported' => $lines === [$safeText],
    'array_end_operator_decoy_excluded' => !str_contains($plainText, $leakingText)
...
if (
    ...
    throw new RuntimeException('Expected malformed CMap array end-operator smoke flags to pass: ' . json_encode($flags, JSON_UNESCAPED_SLASHES));
}

if (in_array('--self-test', $argv, true)) {
    echo "OK markerpdf-malformed-cmap-array-end-operator-currentbase\n";
}

echo '<!-- markerpdf-malformed-cmap-array-end-operator-currentbase ' . htmlspecialchars(json_encode($flags, JSON_UNESCAPED_SLASHES), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') . " -->\n";
