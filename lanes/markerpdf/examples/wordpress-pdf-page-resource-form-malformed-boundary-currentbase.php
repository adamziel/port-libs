...
$brokenLiteralForm = 'BT /F1 12 Tf 12 24 Td (Malformed form literal text leak) Tj ET';
$privateForm = 'BT /F1 12 Tf 12 24 Td (Private malformed form resource leak) Tj ET';

$pdf = "%PDF-1.7\n"
    . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
    . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 >>\nendobj\n"
    . "3 0 obj\n<< /Type /Page /Parent 2 0 R /Resources << /Font << /F1 7 0 R >> /XObject << /BrokenForm 5 0 R /BrokenLiteralForm 11 0 R >> >> /Contents 4 0 R >>\nendobj\n"
    ...
    . "11 0 obj\n<< /Type /XObject /Subtype /Form /BBox [0 0 220 80] /Resources 99 0 R /Length " . strlen($brokenLiteralForm) . " >>\nstream\n{$brokenLiteralForm}\nendstream\nendobj\n"
    . "%%EOF";
...
if (
    $lines !== $expected
    || str_contains($plainText, 'Private malformed form resource leak')
    || str_contains($plainText, 'Malformed form literal text leak')
) {
    throw new RuntimeException('Expected malformed Form XObject /Resources to block decoy private resources and literal text.');
}
...
echo '<!-- markerpdf-page-resource-form-malformed-boundary ' . htmlspecialchars(json_encode([
    ...
    'literal_form_text_promoted' => str_contains($plainText, 'Malformed form literal text leak'),
