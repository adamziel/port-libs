...
if (!is_string($currentXrefStream)) {
    throw new RuntimeException('Unable to compress linearized Prev hint current xref smoke fixture.');
}
...
echo '<!-- markerpdf-xref-linearized-prev-hint-startxref-currentbase ' . htmlspecialchars(json_encode([
    'executes_python_or_models' => false,
    'executes_external_pdf_tools' => false,
    'native_boundary' => 'linearized PDF /H byte ranges block /Prev and embedded startxref candidates before current-base text import',
    'uses_current_startxref_linearized_page' => str_contains($plainText, 'Current startxref linearized page'),
    'skips_prev_hint_range' => str_contains($plainText, 'Prev hint range skipped'),
    'excludes_linearized_prev_hint_stale_page' => !str_contains($plainText, 'Linearized Prev hint stale page'),
