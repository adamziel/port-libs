...
echo '<!-- markerpdf:pdf-type3-charprocs-generation-boundary-currentbase ' . htmlspecialchars(json_encode([
    'source' => 'native-pdf-type3-charproc-exact-generation-boundary',
    'font_width_sources' => [
        'Type3 /CharProcs 3 0 R d0 wide glyph stream',
        'Type3 /CharProcs 3 1 R d1 thin glyph stream',
    ],
    'wide_generation_width_preserved' => str_contains($plainText, 'WideBlock') && !str_contains($plainText, 'Wide Block'),
    'thin_generation_width_preserved' => str_contains($plainText, 'Thin Text') && !str_contains($plainText, 'ThinText'),
    'charproc_payload_visible_text_excluded' => !str_contains($plainText, 'generation text leak'),
