...
$wideCharProc = "1000 0 d0\nBT /Fghost 9 Tf (wide glyph-tail charproc text leak) Tj ET\n";
...
$charProcs = '<< /B.tail 3 0 R 99 0 R /a.tail 3 0 R /d.tail 3 0 R '
    . '/P.tail 3 0 R /t.tail 3 0 R /h.tail 3 0 R >>';
$fallbackWidths = implode(' ', array_fill(0, 7, 250));

$pagePdf = "%PDF-1.4\n"
    . "1 0 obj\n<< /Type /Page /Resources << /Font << /Ft3 2 0 R >> >> /Contents 20 0 R >>\nendobj\n"
    . "2 0 obj\n<< /Type /Font /Subtype /Type3 /Name /T3CharProcsGlyphTail /BaseFont /T3CharProcsGlyphTail "
    ...
    . "6 0 obj\n<< /Type /FontDescriptor /FontName /T3CharProcsGlyphTail /Flags 4 /MissingWidth 250 >>\nendobj\n"
    . "20 0 obj\n<< /Length " . strlen($content) . " >>\nstream\n{$content}\nendstream\nendobj\n%%EOF";

$glyphProgram = "650 0 d0\nBT /Fghost 9 Tf (GLYPH TAIL PROGRAM LEAK) Tj ET\n";
$visibleFallback = 'BT /F1 12 Tf 72 720 Td (Visible fallback content) Tj ET';
$fallbackCharProcs = '<< /A 3 0 R 99 0 R /B 3 0 R /C 3 0 R /D 3 0 R '
    . '/G 3 0 R /H 3 0 R /I 3 0 R /L 3 0 R /M 3 0 R /N 3 0 R '
    . '/O 3 0 R /P 3 0 R /S 3 0 R /T 3 0 R /V 3 0 R >>';
$fallbackPdf = "%PDF-1.4\n"
    . "2 0 obj\n<< /Type /Font /Subtype /Type3 /Name /Ft3 /BaseFont /T3GlyphTailFallback "
    . "/FontBBox [0 0 1000 700] /FontMatrix [0.001 0 0 0.001 0 0] "
...
$review = [
    'source' => 'native-pdf-type3-charprocs-glyph-entry-tail-boundary',
    'font_width_sources' => [
        'malformed CharProcs glyph entry has a valid stream reference followed by a non-name tail operand',
        'invalid CharProcs glyph dictionary entries are rejected for Type3 advance metrics',
        'glyph streams named by the malformed dictionary remain font-private in stream fallback',
    ],
    'charprocs_glyph_entry_tail_rejected' => $plainText === 'Bad Path',
    'fallback_widths_preserve_word_gap' => str_contains($plainText, 'Bad Path') && !str_contains($plainText, 'BadPath'),
    'charproc_payload_visible_text_excluded' => !str_contains($plainText, 'glyph-tail charproc text leak'),
    'fallback_content_preserved' => $fallbackPlainText === 'Visible fallback content',
    'malformed_dictionary_glyph_payload_excluded' => !str_contains($fallbackPlainText, 'GLYPH TAIL PROGRAM LEAK'),
    'executes_python_or_models' => false,
    'executes_external_pdf_tools' => false,
];

foreach ([
    'charprocs_glyph_entry_tail_rejected',
    ...
    if ($review[$requiredFlag] !== true) {
        throw new RuntimeException("Type3 CharProcs glyph-entry tail boundary failed: {$requiredFlag}");
    }
}

echo '<!-- markerpdf:pdf-type3-charprocs-glyph-tail-currentbase ' . htmlspecialchars(json_encode($review, JSON_UNESCAPED_SLASHES), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') . " -->\n";
