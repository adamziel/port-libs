...
$buildPdf = static function (): string {
    ...
    if (!is_string($compressedEncodingCMap)) {
        throw new RuntimeException('Unable to compress WordPress procedure directive CMap fixture.');
    }
    ...
    return "%PDF-1.4\n"
        ...
        . "4 0 obj\n<< /Type /Font /Subtype /Type0 /BaseFont /WPProcedureDirectiveCIDSubset /Encoding 5 0 R /DescendantFonts [7 0 R] /ToUnicode 8 0 R >>\nendobj\n"
        . "5 0 obj\n<< /Type /CMap /CMapName /WPProcedureDirectiveBoundary-H /Filter /FlateDecode /Length " . strlen($compressedEncodingCMap) . " >>\nstream\n{$compressedEncodingCMap}\nendstream\nendobj\n"
        . "6 0 obj\n<< /Length " . strlen($content) . " >>\nstream\n{$content}\nendstream\nendobj\n"
        . "7 0 obj\n<< /Type /Font /Subtype /CIDFontType2 /BaseFont /WPProcedureDirectiveCIDSubset /CIDSystemInfo << /Registry (Adobe) /Ordering (Identity) /Supplement 0 >> /DW 500 /W [40 [500 500 500 500 500 500 500 500 500 500] 60 [500 500 500 500 500 500 500 500]] /DW2 [880 -1000] /W2 [40 49 -500 500 880 60 67 -250 500 880] >>\nendobj\n"
...
$evidence = [
    'scenario' => 'wordpress_pdf_malformed_cmap_procedure_directive_currentbase',
    'safe_lines' => $lines,
    'plain_text' => $text,
    ...
    'procedure_wmode_decoy_ignored' => $lines === ['Vert', 'Import', 'Data', 'Flow']
...
echo "<!-- wp:comment {\"markerpdf_malformed_cmap_procedure_directive\":"
