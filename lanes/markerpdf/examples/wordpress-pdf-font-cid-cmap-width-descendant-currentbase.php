...
echo '<!-- markerpdf-font-cid-cmap-width-descendant-currentbase-smoke ' . htmlspecialchars(json_encode([
    'scenario' => 'wordpress-pdf-font-cid-cmap-width-descendant-currentbase',
    'source' => 'native-pdf-type0-cmap-descendant-cidfont-w2-indirect-operands',
    'font_width_sources' => [
        'Type0 /Encoding CMap source-to-CID rows',
        'CMap /UseCMap vertical writing mode',
        'Descendant CIDFont /W2 range operands via indirect objects',
        'Descendant CIDFont /DW2 default operands via indirect objects',
    ],
    'encoding_cmap_cids_selected' => $plainText === "VertImport\nDataFlow",
    'indirect_descendant_w2_operands_resolved' => !str_contains($plainText, 'Data Flow'),
    'indirect_descendant_dw2_operands_resolved' => !str_contains($plainText, 'Vert Import'),
    'runs' => $runs,
