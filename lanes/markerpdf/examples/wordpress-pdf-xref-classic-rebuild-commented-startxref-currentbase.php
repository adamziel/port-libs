...
$currentXmp = $xmpPacket('Current Commented Startxref Title');
$decoyXmp = $xmpPacket('Commented Startxref Decoy Title');
...
echo '<!-- markerpdf-xref-classic-rebuild-commented-startxref-currentbase-smoke ' . htmlspecialchars(json_encode([
    'scenario' => 'wordpress-pdf-xref-classic-rebuild-commented-startxref-currentbase',
    'native_boundary' => 'classic xref rebuild ignores commented startxref tokens before text, metadata, and EmbeddedFiles selection',
    'current_xref_before_commented_startxref' => $currentXrefOffset < $decoyXrefOffset,
    'uses_current_classic_trailer_root' => str_contains($plainText, 'Current commented startxref page'),
    'keeps_current_metadata_root' => ($metadata['title'] ?? null) === 'Current Commented Startxref Title',
    'keeps_current_info_root' => ($metadata['info']['Title'] ?? null) === 'Current Commented Startxref Info Title',
    'imports_current_attachment' => ($files[0]['name'] ?? null) === 'current-commented-startxref.xml',
    'current_attachment_checksum_matches' => ($files[0]['checksum_matches'] ?? null) === true,
    'excludes_commented_startxref_page' => !str_contains($plainText, 'Commented startxref decoy page'),
    'excludes_commented_startxref_metadata' => !str_contains($encodedMetadata, 'Commented Startxref Decoy'),
    'excludes_commented_startxref_attachment' => !str_contains($encodedFiles, 'decoy-commented-startxref'),
