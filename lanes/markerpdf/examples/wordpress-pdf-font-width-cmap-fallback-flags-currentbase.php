...
echo '<!-- markerpdf:pdf-font-width-cmap-fallback-flags-currentbase ' . htmlspecialchars(json_encode([
    'source' => 'native-pdf-indirect-predefined-vertical-cmap-width-flags-boundary',
    'font_width_sources' => ['indirect /Encoding /UniJIS-UCS2-V', 'predefined -V writing mode', '/W2', '/DW2', '/CIDSet', '/FontDescriptor /Flags'],
    'indirect_predefined_cmap_name_resolved' => true,
