...
final class PdfSecurityPreflight
{
    ...
    private function permissionPreflight(bool $encrypted, ?array $encryption, array $cryptFilterContentReview): array
    {
        ...
        return [
            ...
            'public_key_crypt_filter_role_fail_closed_role_names' => is_array($publicKeyRecipientReview['crypt_filter_role_fail_closed_role_names'] ?? null)
                ...
                : [],
            'public_key_crypt_filter_role_fail_closed_pdf_names' => is_array($publicKeyRecipientReview['crypt_filter_role_fail_closed_pdf_names'] ?? null)
                ? $publicKeyRecipientReview['crypt_filter_role_fail_closed_pdf_names']
                : [],
            ...
            'public_key_recipient_declaration_statuses' => is_array($publicKeyRecipientReview['recipient_declaration_statuses'] ?? null)
                ...
                : [],
            'public_key_recipient_trailing_operand_shapes' => is_array($publicKeyRecipientReview['recipient_trailing_operand_shapes'] ?? null)
                ? $publicKeyRecipientReview['recipient_trailing_operand_shapes']
                : [],
            'public_key_recipient_trailing_operand_previews' => is_array($publicKeyRecipientReview['recipient_trailing_operand_previews'] ?? null)
                ? $publicKeyRecipientReview['recipient_trailing_operand_previews']
                : [],
            ...
            'standard_security_handler_malformed_parameter_names' => is_array($standardParameterReview['malformed_parameter_names'] ?? null)
            ...
            'security_handler_standard_subfilter_incompatible' => (bool) ($securityHandlerSubfilterDeclarationReview['standard_handler_incompatible'] ?? false),
    ...
    private function standardPermissionOperationRow(array $bit, array $permissionAuthenticationTrustReview): array
    {
        ...
        return [
            ...
            'required_permission_bit_set' => is_bool($bit['required_permission_bit_set'] ?? null)
                ...
                : null,
            'alternative_permission_name' => is_string($bit['alternative_permission_name'] ?? null)
                ? $bit['alternative_permission_name']
                : null,
            'alternative_permission_allowed' => is_bool($bit['alternative_permission_allowed'] ?? null)
                ? $bit['alternative_permission_allowed']
                : null,
            'alternative_permission_bit_set' => is_bool($bit['alternative_permission_bit_set'] ?? null)
                ? $bit['alternative_permission_bit_set']
                : null,
            'granted_by_permission_name' => is_string($bit['granted_by_permission_name'] ?? null)
                ? $bit['granted_by_permission_name']
                : null,
            'granted_by_permission_bit_set' => is_bool($bit['granted_by_permission_bit_set'] ?? null)
                ? $bit['granted_by_permission_bit_set']
                : null,
    ...
    private function encryptionReview(?array $encryption): array
    {
        ...
        $permissionBitsReliable = $standardHandler
            && $permissions !== []
            && !$securityHandlerDeclarationFailClosed
            && !$securityHandlerSubfilterDeclarationFailClosed
            && !$standardParametersMalformed
            && $permissionWellFormed === true
        ...
        return [
            ...
            'public_key_recipient_permission_decode_status' => $publicKeyRecipientReview['permission_decode_status'] ?? null,
            'public_key_recipient_declaration_fail_closed' => (bool) ($publicKeyRecipientReview['recipient_declaration_fail_closed'] ?? false),
            'public_key_recipient_duplicate_entries' => (bool) ($publicKeyRecipientReview['recipient_duplicate_entries'] ?? false),
            'public_key_recipient_malformed_entries' => (bool) ($publicKeyRecipientReview['recipient_malformed_entries'] ?? false),
            'public_key_recipient_declared_entry_count' => (int) ($publicKeyRecipientReview['recipient_declared_entry_count'] ?? 0),
            'public_key_recipient_trailing_operand_count' => (int) ($publicKeyRecipientReview['recipient_trailing_operand_count'] ?? 0),
        ...
        if ($encrypted) {
            ...
            if ($permissionPolicy === 'copy_extract_allowed_after_decryption') {
                ...
                if (($permissionPreflight['security_handler_declaration_fail_closed'] ?? false) === true) {
                    ...
                    if (($permissionPreflight['security_handler_standard_subfilter_incompatible'] ?? false) === true) {
                        $reasons[] = 'standard_security_handler_subfilter_incompatible';
                    }
                } elseif (($permissionPreflight['public_key_recipient_declaration_fail_closed'] ?? false) === true) {
                    $reasons[] = 'public_key_recipient_declaration_malformed';
                    if (($permissionPreflight['public_key_recipient_duplicate_entries'] ?? false) === true) {
                        $reasons[] = 'duplicate_public_key_recipient_entries';
                    }
                    if (($permissionPreflight['public_key_recipient_malformed_entries'] ?? false) === true) {
                        $reasons[] = 'malformed_public_key_recipient_entries';
                    }
                    if ((int) ($permissionPreflight['public_key_recipient_trailing_operand_count'] ?? 0) > 0) {
                        $reasons[] = 'public_key_recipient_trailing_operand';
                    }
                } elseif (($permissionPreflight['public_key_crypt_filter_role_declaration_fail_closed'] ?? false) === true) {
                    $reasons[] = 'public_key_crypt_filter_role_declaration_malformed';
                    $reasons[] = 'malformed_public_key_crypt_filter_roles';
                    ...
                    if (in_array('malformed_standard_security_handler_parameter_entries', $parameterViolations, true)) {
                        $reasons[] = 'standard_security_handler_parameter_operands_malformed';
                    }
                    ...
                    } elseif (in_array('permission_word_stream_operand_review', $entryStatuses, true)) {
                        $reasons[] = 'permission_word_stream_operand';
