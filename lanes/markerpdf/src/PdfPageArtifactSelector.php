...
final class PdfPageArtifactSelector
{
    ...
    private const PAGE_MARKER_FIELD_GROUPS = [
        ...
        ['pnum', 'pnums', 'page', 'page_id', 'page_ids', 'pdftext_page', 'pdftext_pages', 'pdftext_page_id', 'pdftext_page_ids', 'source_page', 'source_pages', 'source_page_id', 'source_page_ids', 'document_page', 'document_pages', 'document_page_id', 'document_page_ids', 'doc_page_id', 'doc_page_ids'],
    ...
    private function pageMarkers(array $artifact): array
    {
        ...
        $pages = $this->integerFieldsFromSources($sources, ['pnum', 'pnums', 'page', 'page_id', 'page_ids', 'pdftext_page', 'pdftext_pages', 'pdftext_page_id', 'pdftext_page_ids', 'source_page', 'source_pages', 'source_page_id', 'source_page_ids', 'document_page', 'document_pages', 'document_page_id', 'document_page_ids', 'doc_page_id', 'doc_page_ids']);
        if ($pages !== []) {
            $markers['pages'] = $pages;
        }
