...
- Cleaner/postprocessor/source utilities inspected: 7 cleaner modules with 17 functions under `marker/cleaners/`, 8 functions in `marker/postprocessors/markdown.py`, `marker/layout/order.py`, and `marker/pdf/utils.py`.
...
The lane manifest counts 29 inspected benchmark/test/cleanup/layout-order artifacts for dashboard purposes: 1 CI workflow, 1 benchmark runner, 2 benchmark scoring modules, 1 verifier, 6 benchmark documents, 8 committed reference-like markdown outputs, 7 cleaner modules, 1 Markdown postprocessor, 1 layout ordering module, and 1 PDF utility module. This is a static inventory, not upstream pass parity.
