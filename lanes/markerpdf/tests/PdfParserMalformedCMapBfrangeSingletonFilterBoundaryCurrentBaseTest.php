...
$parserMalformedCMapBfrangeSingletonFilterBoundaryPdf = static function (): array {
    ...
    $safeText = 'AB';
    $cMapName = 'BfrangeSingletonFilterBoundary-H';
    ...
    if (!is_string($compressedCMap)) {
        throw new RuntimeException('Unable to compress bfrange singleton CMap fixture.');
    }
    ...
    $pdf = "%PDF-1.5\n"
        ...
        . "4 0 obj\n<< /Type /Font /Subtype /Type0 /BaseFont /BfrangeSingletonFilterBoundary /Encoding /Identity-H /DescendantFonts [7 0 R] /ToUnicode 6 0 R >>\nendobj\n"
        . "5 0 obj\n<< /Length " . strlen($content) . " >>\nstream\n{$content}\nendstream\nendobj\n"
        . "6 0 obj\n<< /Type /CMap /CMapName /{$cMapName} /Filter /FlateDecode /Length " . strlen($compressedCMap) . " >>\nstream\n{$compressedCMap}\nendstream\nendobj\n"
        . "7 0 obj\n<< /Type /Font /Subtype /CIDFontType2 /BaseFont /BfrangeSingletonFilterBoundary /CIDSystemInfo << /Registry (Adobe) /Ordering (Identity) /Supplement 0 >> /DW 500 /W [1 2 1000] >>\nendobj\n"
        . "%%EOF";
...
return [
    'recovers valid filtered ToUnicode bfrange rows after malformed singleton rows before Type0 fallback' => static function (
        TestRunner $t
    ) use ($parserMalformedCMapBfrangeSingletonFilterBoundaryPdf): void {
        [$pdf, $safeText, $cMapName] = $parserMalformedCMapBfrangeSingletonFilterBoundaryPdf();
