...
$markupPdf = static function (): string {
    return "%PDF-1.7\n"
        ...
        . "5 0 obj\n<< /Length 0 >>\nstream\n\nendstream\nendobj\n"
        . "6 0 obj\n<< /Length 0 >>\nstream\n\nendstream\nendobj\n"
        . "7 0 obj\n<< /Type /Annot /Subtype /Highlight /Rect [260 718 72 700] /QuadPoints [72 718 160 718 72 700 160 700 170 718 250 718 170 700 250 700] /Contents (Needs plugin review) /T (Editor) /Subj (Highlight) /M (D:20260602033700Z) /NM <686967682D31> /C [1 0.92 0] /CA 0.45 /F 4 >>\nendobj\n"
        ...
        . "9 0 obj\n<< /Type /Annot /Subtype /StrikeOut /Rect [72 676 148 696] /QuadPoints [72 696 148 696 72 676 148 676] /Contents <FEFF005200650064006100630074> /T (Reviewer Two) /C [1 0 0] >>\nendobj\n"
        . "10 0 obj\n[ << /Type /Annot /Subtype /Underline /Rect [72 640 220 658] /QuadPoints [72 658 220 658 72 640 220 640] /Contents (import later) /T (QA) /Subj (Underline) >> << /Type /Annot /Subtype /Highlight /Rect [72 612 220 628] /Contents (missing quads) >> ]\nendobj\n"
        . "%%EOF";
};
