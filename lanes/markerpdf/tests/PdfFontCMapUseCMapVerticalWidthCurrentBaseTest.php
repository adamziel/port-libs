...
$fontCMapUseCMapVerticalWidthCurrentBasePdf = static function (): string {
...
return [
    'inherits CMap dictionary UseCMap vertical writing mode before CIDFont W2 width grouping on current base' => static function (TestRunner $t) use ($fontCMapUseCMapVerticalWidthCurrentBasePdf): void {
        $extractor = new PdfTextExtractor();
        $pdf = $fontCMapUseCMapVerticalWidthCurrentBasePdf();
