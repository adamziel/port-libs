...
return [
    ...
    'keeps XMP and DocInfo metadata distinct from catalog destination names' => static function (TestRunner $t): void {
        ...
        $t->same(3, $destinations['count']);
        $t->same(2, $destinations['page_count']);
        $t->same(['Chapter One', 'Review Deck', 'LegacyAppendix'], $destinations['names']);
        ...
        $t->same('Review Deck', $destinations['destinations'][1]['name']);
        ...
        $t->same('legacy_dests', $destinations['destinations'][2]['source']);
        $t->same('Fit', $destinations['destinations'][2]['view_mode']);
        $t->same('Destination Metadata Body', $plainText);
        $t->true(is_string($encoded) && !str_contains($encoded, 'Indirect Dest'));
