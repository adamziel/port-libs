...
$parserMalformedCMapUnderdeclaredCodespaceFilterUtf16beHex = static function (string $ascii): string {
    $hex = '';
...
$parserMalformedCMapUnderdeclaredCodespaceFilterPdf = static function () use (
    $parserMalformedCMapUnderdeclaredCodespaceFilterUtf16beHex
): array {
    $safeText = 'Underdeclared Codespace Safe Import';
    $leakingText = 'Underdeclared Codespace CMap Leak';
    $safeHex = $parserMalformedCMapUnderdeclaredCodespaceFilterUtf16beHex($safeText);
    $sourceCode = substr($safeHex, 0, 4);
    $cMapName = 'UnderdeclaredCodespaceBoundary-H';
    ...
    $cMap = "/CIDInit /ProcSet findresource begin\n"
        ...
        . "endcodespacerange\n"
        . "1 beginbfchar\n"
        . "<{$sourceCode}> <" . $parserMalformedCMapUnderdeclaredCodespaceFilterUtf16beHex($leakingText) . ">\n"
        . "endbfchar\n"
        . "endcmap\n"
    ...
    if (!is_string($compressedCMap)) {
        throw new RuntimeException('Unable to compress underdeclared CMap codespace fixture.');
    }
    ...
    $pdf = "%PDF-1.5\n"
        ...
        . "4 0 obj\n<< /Type /Font /Subtype /Type0 /BaseFont /UnderdeclaredCodespaceBoundary /Encoding /Identity-H /ToUnicode 6 0 R >>\nendobj\n"
...
return [
    'fails closed on filtered ToUnicode codespace blocks with fewer rows than the declared count' => static function (
        TestRunner $t
    ) use ($parserMalformedCMapUnderdeclaredCodespaceFilterPdf): void {
        [$pdf, $safeText, $leakingText, $cMapName] = $parserMalformedCMapUnderdeclaredCodespaceFilterPdf();
