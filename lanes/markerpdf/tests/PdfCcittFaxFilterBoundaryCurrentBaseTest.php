...
return [
    ...
    'marks indirect CCITT Fax DecodeParms arrays with trailing operands fail closed' => static function (TestRunner $t): void {
        $renderer = new PdfImageRenderer();
        $decodeParmsObject = '[<< /K -1 /Columns 16 /Rows 1 /BlackIs1 true /EndOfBlock false >>] << /K /Bad /Columns 1 >>';
        $expectedMalformedDecodeParms = [
            'type' => 'CCITTFaxDecode',
            'k' => null,
            'columns' => null,
            'rows' => null,
        ...
        $rendererBoundary = $rendererPlan['ccitt_fax_decode_boundary'] ?? [];

        $t->same($expectedMalformedDecodeParms, $rendererPlan['image_filter_details'][0]['decode_parms'] ?? null);
        $t->same(true, $rendererBoundary['decode_parms_present'] ?? null);
        $t->same(true, $rendererBoundary['invalid_decode_parms'] ?? null);
        $t->same(['decode_parms_operand'], $rendererBoundary['invalid_decode_parms_fields'] ?? null);
        $t->same(false, $rendererPlan['ccitt_fax_filter_boundary']['native_raster_decode'] ?? null);

        $extractor = new PdfTextExtractor();
        $before = 'BT /F1 12 Tf 72 720 Td (Before indirect array tail CCITT DecodeParms) Tj ET';
        $after = 'BT /F1 12 Tf 72 680 Td (After indirect array tail CCITT DecodeParms) Tj ET';
        $faxPayload = 'BT /F1 12 Tf 72 700 Td (Indirect array tail CCITT DecodeParms Payload Noise) Tj ET';
        $pdf = "%PDF-1.4\n"
            . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
            . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 /Resources << /Font << /F1 10 0 R >> /XObject << /FaxTailParms 5 0 R >> >> >>\nendobj\n"
            . "3 0 obj\n<< /Type /Page /Parent 2 0 R /Contents [4 0 R 6 0 R] >>\nendobj\n"
            . "4 0 obj\n<< /Length " . strlen($before) . " >>\nstream\n{$before}\nendstream\nendobj\n"
            . "5 0 obj\n<< /Type /XObject /Subtype /Image /Width 16 /Height 1 /ImageMask true /BitsPerComponent 1 /Filter /CCF /DecodeParms 11 0 R /Length " . strlen($faxPayload) . " >>\nstream\n{$faxPayload}\nendstream\nendobj\n"
            . "6 0 obj\n<< /Length " . strlen($after) . " >>\nstream\n{$after}\nendstream\nendobj\n"
            . "10 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>\nendobj\n"
            . "11 0 obj\n{$decodeParmsObject}\nendobj\n%%EOF";
        ...
        $t->same(['Before indirect array tail CCITT DecodeParms', 'After indirect array tail CCITT DecodeParms'], $extractor->extractTextLines($pdf));
        $t->same("Before indirect array tail CCITT DecodeParms\nAfter indirect array tail CCITT DecodeParms", $plainText);
        $t->true(!str_contains($plainText, 'Indirect array tail CCITT DecodeParms Payload Noise'));
        $t->same('FaxTailParms', $entry['resource_name'] ?? null);
        $t->same(['CCF'], $entry['filters'] ?? null);
        $t->same(['CCF'], $entry['preview_only_filters'] ?? null);
        $t->same($expectedMalformedDecodeParms, $entry['filter_details'][0]['decode_parms'] ?? null);
        $t->same(true, $boundary['decode_parms_present'] ?? null);
        $t->same(true, $boundary['invalid_decode_parms'] ?? null);
        $t->same(['decode_parms_operand'], $boundary['invalid_decode_parms_fields'] ?? null);
        $t->same(false, $entry['decoded_with_current_filters'] ?? null);
    ...
    'uses current object boundary for unbounded EndOfBlock false CCITT streams' => static function (TestRunner $t): void {
        $extractor = new PdfTextExtractor();
        $before = 'BT /F1 12 Tf 72 720 Td (Before unbounded CCITT) Tj ET';
        $after = 'BT /F1 12 Tf 72 680 Td (After unbounded CCITT) Tj ET';
        $fakeObject = 'BT /F1 12 Tf 72 700 Td (Fake unbounded CCITT leak) Tj ET';
        $faxPayload = "\x01\x02\n"
            . "endstream\nendobj\n"
            . "9 0 obj\n<< /Length " . strlen($fakeObject) . " >>\nstream\n{$fakeObject}\nendstream\nendobj\n"
            . "\x03\x04\x05";
        $staleLength = strpos($faxPayload, "\nendstream\n");
        if ($staleLength === false) {
            throw new RuntimeException('Focused unbounded CCITT fixture must expose a stale stream terminator.');
        }

        $pdf = "%PDF-1.4\n"
            . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
            . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 /Resources << /Font << /F1 10 0 R >> /XObject << /FaxUnbounded 5 0 R >> >> >>\nendobj\n"
            . "3 0 obj\n<< /Type /Page /Parent 2 0 R /Contents [4 0 R 9 0 R 6 0 R] >>\nendobj\n"
            . "4 0 obj\n<< /Length " . strlen($before) . " >>\nstream\n{$before}\nendstream\nendobj\n"
            . "5 0 obj\n<< /Type /XObject /Subtype /Image /Width 16 /Height 2 /ImageMask true /BitsPerComponent 1 /Filter /CCITTFaxDecode /DecodeParms << /K -1 /Columns 16 /Rows 2 /EndOfBlock false /EndOfLine false >> /Length {$staleLength} >>\nstream\n{$faxPayload}\nendstream\nendobj\n"
            . "6 0 obj\n<< /Length " . strlen($after) . " >>\nstream\n{$after}\nendstream\nendobj\n"
            . "10 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>\nendobj\n%%EOF";
        ...
        $t->same(['Before unbounded CCITT', 'After unbounded CCITT'], $extractor->extractTextLines($pdf));
        $t->same("Before unbounded CCITT\nAfter unbounded CCITT", $plainText);
        $t->same("Before unbounded CCITT\nAfter unbounded CCITT\n", $extractor->naiveGetText($pdf));
        $t->true(!str_contains($plainText, 'Fake unbounded CCITT leak'));
        $t->true(!str_contains($plainText, 'endstream'));
        $t->same(['CCITTFaxDecode'], $entry['filters'] ?? null);
        $t->same(['CCITTFaxDecode'], $entry['preview_only_filters'] ?? null);
        $t->same(strlen($faxPayload), $entry['raw_length'] ?? null);
        ...
        $t->same(false, $entry['ccitt_fax_decode_boundary']['effective_decode_parms']['end_of_line'] ?? null);
        $t->same(false, $entry['ccitt_fax_decode_boundary']['effective_decode_parms']['end_of_block'] ?? null);
        ...
        $t->same(null, $entry['ccitt_fax_coding_boundary']['end_of_block_marker'] ?? null);
        $encodedReview = json_encode($review, JSON_UNESCAPED_SLASHES) ?: '';
        $t->true(!str_contains($encodedReview, 'Fake unbounded CCITT leak'));
        $t->true(!str_contains($encodedReview, $faxPayload));
    },
    ...
    'requires valid CCITT EncodedByteAlign before row EOL stream ownership' => static function (TestRunner $t): void {
        $extractor = new PdfTextExtractor();
        $before = 'BT /F1 12 Tf 72 720 Td (Before invalid-byte-align CCITT) Tj ET';
        $after = 'BT /F1 12 Tf 72 680 Td (After invalid-byte-align CCITT) Tj ET';
        $fakeObject = 'BT /F1 12 Tf 72 700 Td (Fake invalid-byte-align CCITT owner leak) Tj ET';
        $eol = "\x00\x10\x01";
        $rtc = $eol . $eol . $eol;
        $faxPayload = "\x01\x02{$eol}\n"
            . "endstream\nendobj\n"
        ...
        $staleLength = strpos($faxPayload, "\nendstream\n");
        if ($staleLength === false) {
            throw new RuntimeException('Focused invalid-byte-align CCITT fixture must expose a stale row-end terminator.');
        }

        $pdf = "%PDF-1.4\n"
            . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
            . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 /Resources << /Font << /F1 10 0 R >> /XObject << /FaxBadAlign 5 0 R >> >> >>\nendobj\n"
            . "3 0 obj\n<< /Type /Page /Parent 2 0 R /Contents [4 0 R 9 0 R 6 0 R] >>\nendobj\n"
            . "4 0 obj\n<< /Length " . strlen($before) . " >>\nstream\n{$before}\nendstream\nendobj\n"
            . "5 0 obj\n<< /Type /XObject /Subtype /Image /Width 16 /Height 1 /ImageMask true /BitsPerComponent 1 /Filter /CCITTFaxDecode /DecodeParms << /K 0 /Columns 16 /Rows 1 /EncodedByteAlign /Maybe /EndOfLine true /EndOfBlock false >> /Length {$staleLength} >>\nstream\n{$faxPayload}\nendstream\nendobj\n"
            . "6 0 obj\n<< /Length " . strlen($after) . " >>\nstream\n{$after}\nendstream\nendobj\n"
            . "10 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>\nendobj\n%%EOF";
        ...
        $t->same(['Before invalid-byte-align CCITT', 'After invalid-byte-align CCITT'], $extractor->extractTextLines($pdf));
        $t->same("Before invalid-byte-align CCITT\nAfter invalid-byte-align CCITT", $plainText);
        $t->true(!str_contains($plainText, 'Fake invalid-byte-align CCITT owner leak'));
        $t->true(!str_contains($plainText, 'endstream'));
        $t->same(['CCITTFaxDecode'], $entry['filters'] ?? null);
        $t->same(['CCITTFaxDecode'], $entry['preview_only_filters'] ?? null);
        $t->same(strlen($faxPayload), $entry['raw_length'] ?? null);
        ...
        $t->same(false, $entry['payload_in_visible_text'] ?? null);
        $t->same(false, $decodeParms['valid_decode_parms'] ?? null);
        $t->same(['encoded_byte_align'], $decodeParms['invalid_decode_parms_fields'] ?? null);
        $t->same('invalid_ccitt_decodeparms_fail_closed', $decodeParms['decode_parms_review'] ?? null);
        $t->same(true, $boundary['invalid_decode_parms'] ?? null);
        $t->same(['encoded_byte_align'], $boundary['invalid_decode_parms_fields'] ?? null);
        $t->same(false, $boundary['effective_decode_parms']['encoded_byte_align'] ?? null);
        $t->same(false, $boundary['effective_decode_parms']['end_of_block'] ?? null);
        $t->same('group3_one_dimensional', $entry['ccitt_fax_coding_boundary']['coding_mode'] ?? null);
        $t->same(null, $entry['ccitt_fax_coding_boundary']['end_of_block_marker'] ?? null);
        $encodedReview = json_encode($review, JSON_UNESCAPED_SLASHES) ?: '';
        $t->true(!str_contains($encodedReview, 'Fake invalid-byte-align CCITT owner leak'));
        $t->true(!str_contains($encodedReview, $faxPayload));

        $content = "BT /F1 12 Tf 72 720 Td (Before inline invalid-byte-align CCITT) Tj ET\n"
            . "BI /W 16 /H 1 /IM true /F /CCF /DP << /K 0 /Columns 16 /Rows 1 /EncodedByteAlign /Maybe /EndOfLine true /EndOfBlock false >> ID\n"
            . "\x01\x02{$eol}\nEI\n"
            . "BT /F1 12 Tf 72 700 Td (Inline invalid-byte-align CCITT leak) Tj ET\n"
            . "\x03\x04{$rtc}\nEI\n"
            . "BT /F1 12 Tf 72 680 Td (After inline invalid-byte-align CCITT) Tj ET";
        $inlinePdf = "%PDF-1.4\n"
            . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
            . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 >>\nendobj\n"
            . "3 0 obj\n<< /Type /Page /Parent 2 0 R /Resources << /Font << /F1 5 0 R >> >> /Contents 4 0 R >>\nendobj\n"
            ...
            . "5 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>\nendobj\n%%EOF";
        $expectedInline = [
            'Before inline invalid-byte-align CCITT',
            'After inline invalid-byte-align CCITT',
        ];
        $inlinePlainText = $extractor->extractPlainText($inlinePdf);
        ...
        $t->same(implode("\n", $expectedInline), $inlinePlainText);
        $t->same(implode("\n", $expectedInline) . "\n", $extractor->naiveGetText($inlinePdf));
        $t->true(!str_contains($inlinePlainText, 'Inline invalid-byte-align CCITT leak'));
        $t->true(!str_contains($inlinePlainText, 'CCITTFaxDecode'));
        $t->true(!str_contains($inlinePlainText, 'CCF'));
    },
    ...
    'requires valid image Height before omitted Rows can drive CCITT row EOL stream ownership' => static function (TestRunner $t): void {
        $extractor = new PdfTextExtractor();
        $before = 'BT /F1 12 Tf 72 720 Td (Before invalid-height CCITT rows) Tj ET';
        $after = 'BT /F1 12 Tf 72 680 Td (After invalid-height CCITT rows) Tj ET';
        $fakeObject = 'BT /F1 12 Tf 72 700 Td (Fake invalid-height CCITT owner leak) Tj ET';
        $eol = "\x00\x10\x01";
        $rtc = $eol . $eol . $eol;
        $faxPayload = "\x01\x02{$eol}\n"
            . "endstream\nendobj\n"
        ...
        $staleLength = strpos($faxPayload, "\nendstream\n");
        if ($staleLength === false) {
            throw new RuntimeException('Focused invalid-height CCITT fixture must expose a stale row-end terminator.');
        }
        ...
        $t->same(['Before invalid-height CCITT rows', 'After invalid-height CCITT rows'], $extractor->extractTextLines($pdf));
        $t->same("Before invalid-height CCITT rows\nAfter invalid-height CCITT rows", $plainText);
        $t->true(!str_contains($plainText, 'Fake invalid-height CCITT owner leak'));
        $t->true(!str_contains($plainText, 'endstream'));
        $t->same(['CCITTFaxDecode'], $entry['filters'] ?? null);
        $t->same(['CCITTFaxDecode'], $entry['preview_only_filters'] ?? null);
        $t->same(strlen($faxPayload), $entry['raw_length'] ?? null);
        ...
        $t->same(true, $boundary['effective_decode_parms']['end_of_line'] ?? null);
        $t->same(false, $boundary['effective_decode_parms']['end_of_block'] ?? null);
        $t->same(null, $boundary['dictionary_height'] ?? null);
        $t->same(null, $boundary['effective_height'] ?? null);
        $t->same('unbounded_rows', $boundary['height_source'] ?? null);
        $t->same('group3_one_dimensional', $entry['ccitt_fax_coding_boundary']['coding_mode'] ?? null);
        $t->same(false, $entry['ccitt_fax_coding_boundary']['end_of_block'] ?? null);
        $t->same(null, $entry['ccitt_fax_coding_boundary']['end_of_block_marker'] ?? null);
        $encodedReview = json_encode($review, JSON_UNESCAPED_SLASHES) ?: '';
        $t->true(!str_contains($encodedReview, 'Fake invalid-height CCITT owner leak'));
        $t->true(!str_contains($encodedReview, $faxPayload));

        $content = "BT /F1 12 Tf 72 720 Td (Before inline invalid-height CCITT) Tj ET\n"
            ...
            . "\x03\x04{$rtc}\nEI\n"
            . "BT /F1 12 Tf 72 680 Td (After inline invalid-height CCITT) Tj ET";
        $inlinePdf = "%PDF-1.4\n"
            . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
            . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 >>\nendobj\n"
            . "3 0 obj\n<< /Type /Page /Parent 2 0 R /Resources << /Font << /F1 5 0 R >> >> /Contents 4 0 R >>\nendobj\n"
            ...
            . "5 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>\nendobj\n%%EOF";
        $expectedInline = [
            'Before inline invalid-height CCITT',
            'After inline invalid-height CCITT',
        ];
        $inlinePlainText = $extractor->extractPlainText($inlinePdf);
        ...
        $t->same(implode("\n", $expectedInline), $inlinePlainText);
        $t->same(implode("\n", $expectedInline) . "\n", $extractor->naiveGetText($inlinePdf));
        $t->true(!str_contains($inlinePlainText, 'Inline invalid-height CCITT leak'));
        $t->true(!str_contains($inlinePlainText, 'CCITTFaxDecode'));
        $t->true(!str_contains($inlinePlainText, 'CCF'));
    },
    ...
    'marks duplicate top-level CCITT Fax DecodeParms declarations fail closed before image review' => static function (TestRunner $t): void {
        $renderer = new PdfImageRenderer();
        $expectedDecodeParms = [
            'type' => 'CCITTFaxDecode',
            'k' => null,
        ...
        $directPlan = $renderer->imageColorSpaceSoftMaskPlan(
            '<< /Subtype /Image /Width 16 /Height 1 /ImageMask true /BitsPerComponent 1 '
            . '/Filter /CCF '
            . '/DecodeParms << /K -1 /Columns 16 /Rows 1 /BlackIs1 true >> '
            . '/DecodeParms << /K /Bad /Columns 1 /Rows 1 /EndOfBlock false >> >>'
        );
        $directParms = $directPlan['image_filter_details'][0]['decode_parms'] ?? null;
        $directBoundary = $directPlan['ccitt_fax_decode_boundary'] ?? [];

        $t->same(['CCF'], $directPlan['image_filters']);
        $t->same($expectedDecodeParms, $directParms);
        $t->same(true, $directBoundary['decode_parms_present'] ?? null);
        $t->same(true, $directBoundary['invalid_decode_parms'] ?? null);
        $t->same(['decode_parms_declaration'], $directBoundary['invalid_decode_parms_fields'] ?? null);
        $t->same($expectedEffective, $directBoundary['effective_decode_parms'] ?? null);
        $t->same($expectedDefaults, $directBoundary['defaults_applied'] ?? null);
        $t->same(16, $directBoundary['dictionary_width'] ?? null);
        $t->same(1, $directBoundary['dictionary_height'] ?? null);
        $t->same(16, $directBoundary['effective_width'] ?? null);
        $t->same(1, $directBoundary['effective_height'] ?? null);
        $t->same('image_dictionary', $directBoundary['width_source'] ?? null);
        $t->same('image_dictionary', $directBoundary['height_source'] ?? null);
        $t->same(false, $directBoundary['columns_match_width'] ?? null);
        $t->same(null, $directBoundary['rows_match_height'] ?? null);
        $t->same(true, $directBoundary['dimension_mismatch'] ?? null);
        $t->contains('duplicate_ccitt_decodeparms_declaration_fail_closed', implode(',', $directPlan['notes']));
        ...
        $t->same(['CCITTFaxDecode'], $inlinePlan['image_filters']);
        $t->same($expectedDecodeParms, $inlineParms);
        $t->same(true, $inlineBoundary['decode_parms_present'] ?? null);
        $t->same(true, $inlineBoundary['invalid_decode_parms'] ?? null);
        $t->same(['decode_parms_declaration'], $inlineBoundary['invalid_decode_parms_fields'] ?? null);
        $t->same($expectedEffective, $inlineBoundary['effective_decode_parms'] ?? null);
        $t->same($expectedDefaults, $inlineBoundary['defaults_applied'] ?? null);
        $t->same(true, $inlinePlan['inline_image_review_only']);
        $t->same(false, $inlinePlan['inline_image']['native_raster_decode'] ?? null);
        $t->same(true, $inlinePlan['inline_image_payload_excluded_from_text']);
        $t->contains('duplicate_ccitt_decodeparms_declaration_fail_closed', implode(',', $inlinePlan['notes']));
        $t->true(!str_contains(json_encode($inlinePlan, JSON_UNESCAPED_SLASHES) ?: '', 'Inline duplicate declaration CCITT payload noise'));
        ...
        $faxPayload = 'BT /F1 12 Tf 72 700 Td (WordPress duplicate declaration CCITT leak) Tj ET';
        $pdf = "%PDF-1.4\n"
            . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
            . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 /Resources << /Font << /F1 10 0 R >> /XObject << /DuplicateDeclarationFax 5 0 R >> >> >>\nendobj\n"
            . "3 0 obj\n<< /Type /Page /Parent 2 0 R /Contents [4 0 R 6 0 R] >>\nendobj\n"
            . "4 0 obj\n<< /Length " . strlen($before) . " >>\nstream\n{$before}\nendstream\nendobj\n"
            . "5 0 obj\n<< /Type /XObject /Subtype /Image /Width 16 /Height 1 /ImageMask true /BitsPerComponent 1 /Filter /CCITTFaxDecode /DecodeParms << /K -1 /Columns 16 /Rows 1 /BlackIs1 true >> /DecodeParms << /K /Bad /Columns 1 /Rows 1 /EndOfBlock false >> /Length " . strlen($faxPayload) . " >>\nstream\n{$faxPayload}\nendstream\nendobj\n"
            . "6 0 obj\n<< /Length " . strlen($after) . " >>\nstream\n{$after}\nendstream\nendobj\n"
            . "10 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>\nendobj\n%%EOF";
        ...
        $t->same(['Before duplicate declaration CCITT', 'After duplicate declaration CCITT'], $extractor->extractTextLines($pdf));
        $t->same("Before duplicate declaration CCITT\nAfter duplicate declaration CCITT", $plainText);
        $t->true(!str_contains($plainText, 'WordPress duplicate declaration CCITT leak'));
        $t->same(['CCITTFaxDecode'], $entry['filters'] ?? null);
        $t->same(['CCITTFaxDecode'], $entry['preview_only_filters'] ?? null);
        $t->same($expectedDecodeParms, $decodeParms);
        $t->same(true, $boundary['decode_parms_present'] ?? null);
        $t->same(true, $boundary['invalid_decode_parms'] ?? null);
        $t->same(['decode_parms_declaration'], $boundary['invalid_decode_parms_fields'] ?? null);
        $t->same($expectedEffective, $boundary['effective_decode_parms'] ?? null);
        $t->same($expectedDefaults, $boundary['defaults_applied'] ?? null);
        $t->same(false, $entry['native_raster_decode'] ?? null);
        $t->same(false, $entry['decoded_with_current_filters'] ?? null);
        $t->same(false, $entry['payload_in_visible_text'] ?? null);
        $encodedReview = json_encode($review, JSON_UNESCAPED_SLASHES) ?: '';
    ...
    'preserves CCITT Fax DecodeParms after rejected scalar extra Filter operand' => static function (TestRunner $t): void {
        $payload = 'BT /F1 12 Tf 72 700 Td (Scalar extra CCITT filter payload leak) Tj ET';
        $imageDictionary = '<< /Type /XObject /Subtype /Image /Width 16 /Height 0 /ImageMask true /BitsPerComponent 1 '
            . '/Filter /CCITTFaxDecode /FlateDecode '
            . '/DecodeParms << /K -1 /Columns 16 /Rows 0 /BlackIs1 true /EndOfBlock true >> '
            . '/Decode [1 0] /Length ' . strlen($payload) . ' >>';
        $content = "BT /F1 12 Tf 72 720 Td (Before scalar extra CCITT filter) Tj ET\n"
            . "q 16 0 0 1 72 700 cm /ScalarExtra Do Q\n"
            . 'BT /F1 12 Tf 72 680 Td (After scalar extra CCITT filter) Tj ET';
        $pdf = "%PDF-1.4\n"
            . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
            . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 /Resources << /Font << /F1 10 0 R >> /XObject << /ScalarExtra 5 0 R >> >> >>\nendobj\n"
            . "3 0 obj\n<< /Type /Page /Parent 2 0 R /Contents 4 0 R >>\nendobj\n"
            . "4 0 obj\n<< /Length " . strlen($content) . " >>\nstream\n{$content}\nendstream\nendobj\n"
            . "5 0 obj\n{$imageDictionary}\nstream\n{$payload}\nendstream\nendobj\n"
            . "10 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>\nendobj\n%%EOF";
        ...
        $t->same([
            'Before scalar extra CCITT filter',
            'After scalar extra CCITT filter',
        ], $extractor->extractTextLines($pdf));
        $t->same(
            "Before scalar extra CCITT filter\nAfter scalar extra CCITT filter",
            $plainText
        );
        $t->true(!str_contains($plainText, 'Scalar extra CCITT filter payload leak'));
        $t->same(false, $entry['filters_resolved'] ?? null);
        $t->same(['MalformedFilterOperand', 'CCITTFaxDecode'], $entry['filters'] ?? null);
        ...
        $t->same(['MalformedFilterOperand', 'CCITTFaxDecode'], $plan['image_filters'] ?? null);
        ...
        ], $plan['image_filter_details'] ?? null);
        $t->same([
            'declared_filter' => 'CCITTFaxDecode',
            'canonical_filter' => 'CCITTFaxDecode',
            'alias_used' => false,
        ...
        $t->same(false, $plan['ccitt_fax_decode_boundary']['dimension_mismatch'] ?? null);
        $t->same('group4_two_dimensional', $plan['ccitt_fax_coding_boundary']['coding_mode'] ?? null);
        $t->contains('ccitt_fax_image_filter_review_only', implode(',', $plan['notes']));
        $t->contains('malformed_image_filter_operand_fail_closed', implode(',', $plan['notes']));
        $t->true(!str_contains(json_encode($plan, JSON_UNESCAPED_SLASHES) ?: '', 'Scalar extra CCITT filter payload leak'));
    },
];
