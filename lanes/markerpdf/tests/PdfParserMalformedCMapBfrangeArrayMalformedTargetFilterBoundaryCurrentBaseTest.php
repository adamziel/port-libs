...
$parserMalformedCMapBfrangeArrayMalformedTargetFilterBoundaryPdf = static function (): array {
    $safeText = 'AB';
    $cMapName = 'BfrangeArrayMalformedTargetFilterBoundary-H';
    ...
    if (!is_string($compressedCMap)) {
        throw new RuntimeException('Unable to compress focused malformed bfrange array target CMap fixture.');
    }
    ...
    $pdf = "%PDF-1.5\n"
        ...
        . "4 0 obj\n<< /Type /Font /Subtype /Type0 /BaseFont /BfrangeArrayMalformedTargetFilterBoundary /Encoding /Identity-H /DescendantFonts [7 0 R] /ToUnicode 6 0 R >>\nendobj\n"
        . "5 0 obj\n<< /Length " . strlen($content) . " >>\nstream\n{$content}\nendstream\nendobj\n"
        . "6 0 obj\n<< /Type /CMap /CMapName /{$cMapName} /Filter /FlateDecode /Length " . strlen($compressedCMap) . " >>\nstream\n{$compressedCMap}\nendstream\nendobj\n"
        . "7 0 obj\n<< /Type /Font /Subtype /CIDFontType2 /BaseFont /BfrangeArrayMalformedTargetFilterBoundary /CIDSystemInfo << /Registry (Adobe) /Ordering (Identity) /Supplement 0 >> /DW 500 /W [65 66 1000] >>\nendobj\n"
        . "%%EOF";
...
return [
    'rejects malformed filtered ToUnicode bfrange array hex targets before current-base text extraction' => static function (
        TestRunner $t
    ) use ($parserMalformedCMapBfrangeArrayMalformedTargetFilterBoundaryPdf): void {
        [$pdf, $safeText, $cMapName] = $parserMalformedCMapBfrangeArrayMalformedTargetFilterBoundaryPdf();
