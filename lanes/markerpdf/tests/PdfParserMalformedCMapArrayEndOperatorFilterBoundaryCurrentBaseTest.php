...
$parserMalformedCMapArrayEndOperatorUtf16beHex = static function (string $ascii): string {
    $hex = '';
...
$parserMalformedCMapArrayEndOperatorPdf = static function () use ($parserMalformedCMapArrayEndOperatorUtf16beHex): array {
    $safeText = 'Array End Safe Import';
    $leakingText = 'Array End CMap Leak';
    $cMapName = 'ArrayEndOperatorBoundary-H';
    $safeHex = '0001';
    ...
    $cMap = "/CIDInit /ProcSet findresource begin\n"
        ...
        . "endcodespacerange\n"
        . "1 beginbfrange\n"
        . "<0001> <0001> [ endcmap <" . $parserMalformedCMapArrayEndOperatorUtf16beHex($leakingText) . "> ]\n"
        . "endbfrange\n"
        . "1 beginbfchar\n"
        . "<0001> <" . $parserMalformedCMapArrayEndOperatorUtf16beHex($safeText) . ">\n"
        . "endbfchar\n"
        . "endcmap\n"
    ...
    if (!is_string($compressedCMap)) {
        throw new RuntimeException('Unable to compress focused array end-operator CMap fixture.');
    }
    ...
    $pdf = "%PDF-1.5\n"
        ...
        . "4 0 obj\n<< /Type /Font /Subtype /Type0 /BaseFont /ArrayEndOperatorBoundary /Encoding /Identity-H /ToUnicode 6 0 R >>\nendobj\n"
...
return [
    'ignores endcmap tokens inside filtered CMap arrays before current-base text extraction' => static function (
        TestRunner $t
    ) use ($parserMalformedCMapArrayEndOperatorPdf): void {
        [$pdf, $safeText, $leakingText, $cMapName] = $parserMalformedCMapArrayEndOperatorPdf();
        ...
        $t->true(!str_contains($plainText, 'endcmap'));
        ...
        $t->same($entry['post_endcmap_byte_count'] ?? null, $entry['parser_excluded_cmap_byte_count'] ?? null);
