...
$parserMalformedCMapProcedureEndOperatorUtf16beHex = static function (string $ascii): string {
    $hex = '';
...
$parserMalformedCMapProcedureEndOperatorPdf = static function () use ($parserMalformedCMapProcedureEndOperatorUtf16beHex): array {
    $safeText = 'Procedure End Safe Import';
    $leakingText = 'Procedure End CMap Leak';
    $cMapName = 'ProcedureEndOperatorBoundary-H';
    $safeHex = '0001';
    ...
    $cMap = "/CIDInit /ProcSet findresource begin\n"
        ...
        . "endcodespacerange\n"
        . "1 beginbfchar\n"
        . "<0001> <" . $parserMalformedCMapProcedureEndOperatorUtf16beHex($safeText) . ">\n"
        . "endbfchar\n"
        . "endcmap\n"
    ...
    if (!is_string($compressedCMap)) {
        throw new RuntimeException('Unable to compress focused procedure end-operator CMap fixture.');
    }
    ...
    $pdf = "%PDF-1.5\n"
        ...
        . "4 0 obj\n<< /Type /Font /Subtype /Type0 /BaseFont /ProcedureEndOperatorBoundary /Encoding /Identity-H /ToUnicode 6 0 R >>\nendobj\n"
...
return [
    'ignores endcmap tokens inside filtered CMap procedure bodies before current-base text extraction' => static function (
        TestRunner $t
    ) use ($parserMalformedCMapProcedureEndOperatorPdf): void {
        [$pdf, $safeText, $leakingText, $cMapName] = $parserMalformedCMapProcedureEndOperatorPdf();
