...
$fontEncodingDifferencesCMapWidthReviewCurrentBasePdf = static function (): string {
...
return [
    'resolves indirect Type3 Encoding Differences before ToUnicode CMap width grouping on current base' => static function (TestRunner $t) use ($fontEncodingDifferencesCMapWidthReviewCurrentBasePdf): void {
        $extractor = new PdfTextExtractor();
        $pdf = $fontEncodingDifferencesCMapWidthReviewCurrentBasePdf();
