...
$linkRectOperandBoundaryPdf = static function (): string {
    $content = 'BT /F1 12 Tf 72 720 Td (Clean rect Null rect Name rect Ref rect Tailed rect Indirect tail) Tj ET';

    return "%PDF-1.7\n"
        . "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n"
        . "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 >>\nendobj\n"
        . "3 0 obj\n<< /Type /Page /Parent 2 0 R /MediaBox [0 0 612 792] /Resources << /Font << /F1 5 0 R >> >> /Contents 4 0 R /Annots [7 0 R 8 0 R 9 0 R 10 0 R 11 0 R 12 0 R] >>\nendobj\n"
        ...
        . "11 0 obj\n<< /Type /Annot /Subtype /Link /Rect [460 700 560 718] 21 0 R /Contents (Tailed rect review) /A << /S /URI /URI (https://example.com/tailed-rect-decoy) >> >>\nendobj\n"
        . "12 0 obj\n<< /Type /Annot /Subtype /Link /Rect 22 0 R /Contents (Indirect tail rect review) /A << /S /URI /URI (https://example.com/indirect-tail-rect-decoy) >> >>\nendobj\n"
        . "20 0 obj\n(not a numeric coordinate)\nendobj\n"
        . "21 0 obj\n<< /S /JavaScript /JS (tailRectReview\\(\\)) >>\nendobj\n"
        . "22 0 obj\n[570 700 610 718] 23 0 R\nendobj\n"
        . "23 0 obj\n<< /S /JavaScript /JS (indirectTailRectReview\\(\\)) >>\nendobj\n"
        . "%%EOF";
};
        ...
        'blocks' => [[
            ...
            'lines' => [[
                ...
                'spans' => [
                    ...
                    ['text' => ' Tailed rect', 'bbox' => [460.0, 700.0, 560.0, 718.0], 'font' => 'Helvetica'],
                    ['text' => ' Indirect tail', 'bbox' => [570.0, 700.0, 610.0, 718.0], 'font' => 'Helvetica'],
                ],
            ]],
        ]],
    ]];
...
return [
    'rejects malformed Link annotation Rect operands before WordPress span promotion' => static function (
        ...
        $t->same([7, 8, 9, 10, 11, 12], array_column($annotationRows, 'annotation_object'));
        ...
        foreach ([8, 9, 10, 11, 12] as $malformedObject) {
            $t->same(
                null,
        ...
        foreach ([1, 2, 3, 4, 5] as $spanIndex) {
            $t->true(!isset($spans[$spanIndex]['link_uri']), 'Malformed /Rect operands must not promote a WordPress link.');
        }

        $blocks = (new MarkdownPostProcessor())->mergeBlocks((new MarkdownPostProcessor())->mergeSpans($pages));
        $t->same('[Clean rect](https://example.com/clean-rect) Null rect Name rect Ref rect Tailed rect Indirect tail', $blocks[0]['text']);
        ...
        foreach ([
            ...
            'ref-rect-decoy',
            'tailed-rect-decoy',
            'indirect-tail-rect-decoy',
            'tailRectReview',
            'indirectTailRectReview',
            'Null rect review',
            'Name rect review',
            'Reference rect review',
            'Tailed rect review',
            'Indirect tail rect review',
        ] as $reviewOnlyText) {
            $t->same(false, str_contains($encodedPages, $reviewOnlyText));
        }

        $plainText = (new PdfTextExtractor())->extractPlainText($pdf);
        $t->contains('Clean rect Null rect Name rect Ref rect Tailed rect Indirect tail', $plainText);
        foreach ([
            'clean-rect',
            'null-rect-decoy',
            'name-rect-decoy',
