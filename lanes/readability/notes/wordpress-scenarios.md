...
Broaden exact structural HTML parity for copied lazy-image fixtures, starting with wrapper/class cleanup around Mozilla `lazy-image-1` figures and then expanding to other image-heavy upstream pages.
