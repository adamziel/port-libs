...
- Native PHP lane tests: 51 passing, 0 failing, 444 assertions.
- Latest readability-local verification: direct `ArticleExtractorTest.php` run passes 51 tests, 444 assertions, and 0 failures.
- Latest required root verification: `php tools/run-tests.php` passes after this slice with 115 test files, 8569 assertions, and 0 failures.
