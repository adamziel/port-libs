...
- Readability-local PHP coverage: 107 behavior tests, 1049 assertions, 0 failures.
- Root `php tools/run-tests.php`: green with 183 test files, 18211 assertions, and 0 failures.
