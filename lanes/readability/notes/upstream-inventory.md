...
- Readability-local PHP coverage: 103 behavior tests, 965 assertions, 0 failures.
- Required root `php tools/run-tests.php`: green with 177 test files, 16922 assertions, and 0 failures.
