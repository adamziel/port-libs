...
- Readability-local PHP coverage: 105 behavior tests, 1007 assertions, 0 failures.
- Required root `php tools/run-tests.php`: green with 182 test files, 17632 assertions, and 0 failures.
