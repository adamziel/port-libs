...
- Native PHP lane tests: 152 passing, 0 failing, 1896 assertions.
- Latest readability-local verification: `php tools/run-tests.php lanes/readability/tests/ArticleExtractorTest.php` passes 1 selected test file, 1896 assertions, and 0 failures.
...
- Current work: captioned retained media wrappers now serialize as WordPress HTML review blocks when a div/section directly contains iframe/object/embed/video/audio media with only short caption text.
- Focused smoke: `php lanes/readability/examples/wordpress-captioned-embed-wrapper-import.php` reports `Captioned embed HTML blocks: 1`, `Embed wrapper retained: yes`, `Paragraph-wrapped embed wrapper: no`, and `Paragraph blocks: 2`.
