...
$source = (string) file_get_contents(__DIR__ . '/../fixtures/mozilla/medicalnewstoday/source.html');
...
echo 'Byline imported as block text: ' . (str_contains($blocks, 'Ana Sandoiu') ? 'yes' : 'no') . "\n";
echo 'Publisher ad chrome retained: ' . (str_contains($blocks, 'Thank you for supporting Medical News Today') ? 'yes' : 'no') . "\n";
