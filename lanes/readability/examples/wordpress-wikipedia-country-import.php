...
$source = (string) file_get_contents(__DIR__ . '/../fixtures/mozilla/wikipedia-2/source.html');
...
echo 'Tables retained in article HTML: ' . ($xpath->query('//table')?->length ?? 0) . "\n";
...
echo 'MediaWiki status/shell chrome retained: ' . (
    str_contains($blocks, 'This is a good article')
    || str_contains($blocks, 'Page semi-protected')
