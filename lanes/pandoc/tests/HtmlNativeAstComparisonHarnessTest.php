...
return [
    ...
    'checked-in html fixtures match native ast shape' => static function (TestRunner $t) use ($fixtureRoot): void {
        ...
        $t->same(60, $report['htmlFixtureCount']);
        ...
        $t->same(60, $report['htmlParsedCount']);
        ...
        $t->same(true, HtmlNativeAstComparisonHarness::hasRequiredMappedParity($report, 60));
        ...
        $t->same('HTML fixtures=60; native fixtures=60; same-basename pairs=60; HTML fixtures without native pairs=0', $report['orderedRemainingGaps'][1]['currentEvidence']);
        $t->same('The current checked-in gate covers 60 paired fixture(s) out of 60 HTML fixture(s).', $report['orderedRemainingGaps'][3]['currentEvidence']);
        $t->contains('fixtureInventory: html=60 native=60 paired=60 unpairedHtml=0 unpairedNative=0', $text);
        ...
        $t->same(0, $exitCode);
        $t->same(60, $decoded['htmlFixtureCount']);
