...
return [
    ...
    'checked-in html fixtures match native ast shape' => static function (TestRunner $t) use ($fixtureRoot): void {
        ...
        $t->same(75, $report['htmlFixtureCount']);
        $t->same(75, $report['nativeFixtureCount']);
        $t->same(75, $report['pairedFixtureCount']);
        ...
        $t->same(75, $report['totalPairCount']);
        $t->same(75, $report['comparedPairCount']);
        $t->same(75, $report['htmlParsedCount']);
        $t->same(75, $report['nativeParsedCount']);
        $t->same(75, $report['bothParsedCount']);
        $t->same(0, $report['parseFailureCount']);
        $t->same(75, $report['normalizedAstMatchCount']);
        ...
        $t->same(true, HtmlNativeAstComparisonHarness::hasRequiredMappedParity($report, 75));
        ...
        $t->same('e18014d3b0bb5bbc32cb97fd01e496e90435deb41e7d3c19c7aebb9f1af50a23', $signature['sha256'] ?? null);
        $t->same('e18014d3b0bb5bbc32cb97fd01e496e90435deb41e7d3c19c7aebb9f1af50a23', $signature['expectedSha256'] ?? null);
        $t->same(75, $signature['htmlFixtureCount'] ?? null);
        $t->same(75, $signature['nativeFixtureCount'] ?? null);
        $t->same(75, $signature['pairedFixtureCount'] ?? null);
        $t->same(150, $signature['recordCount'] ?? null);
        ...
        $t->same('HTML fixtures=75; native fixtures=75; same-basename pairs=75; HTML fixtures without native pairs=0', $report['orderedRemainingGaps'][1]['currentEvidence']);
        $t->same('The current checked-in gate covers 75 paired fixture(s) out of 75 HTML fixture(s).', $report['orderedRemainingGaps'][3]['currentEvidence']);
        $t->contains('fixtureInventory: html=75 native=75 paired=75 unpairedHtml=0 unpairedNative=0', $text);
        $t->contains('fixtureInventorySignature: status=valid-checked-in-html-fixture-inventory matchesExpected=yes sha256=e18014d3b0bb5bbc32cb97fd01e496e90435deb41e7d3c19c7aebb9f1af50a23', $text);
        $t->contains('pairs: total=75 compared=75 parsedBoth=75 parseFailures=0', $text);
        $t->contains('normalizedAst: matches=75 (100.00%) mismatches=0', $text);
        ...
        $t->same(0, $exitCode);
        $t->same(75, $decoded['htmlFixtureCount']);
        ...
        $t->same('e18014d3b0bb5bbc32cb97fd01e496e90435deb41e7d3c19c7aebb9f1af50a23', $decoded['checkedInFixtureInventorySignature']['sha256'] ?? null);
