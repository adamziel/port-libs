...
return [
    ...
    'checked-in html fixtures match native ast shape' => static function (TestRunner $t) use ($fixtureRoot): void {
        ...
        $t->same(74, $report['htmlFixtureCount']);
        $t->same(74, $report['nativeFixtureCount']);
        $t->same(74, $report['pairedFixtureCount']);
        ...
        $t->same(74, $report['totalPairCount']);
        $t->same(74, $report['comparedPairCount']);
        $t->same(74, $report['htmlParsedCount']);
        $t->same(74, $report['nativeParsedCount']);
        $t->same(74, $report['bothParsedCount']);
        $t->same(0, $report['parseFailureCount']);
        $t->same(74, $report['normalizedAstMatchCount']);
        ...
        $t->same(true, HtmlNativeAstComparisonHarness::hasRequiredMappedParity($report, 74));
        ...
        $t->same('210ff977f41b6b13d87da4a41696e7f7489d0ab7f840065b8316710e034bb2f1', $signature['sha256'] ?? null);
        $t->same('210ff977f41b6b13d87da4a41696e7f7489d0ab7f840065b8316710e034bb2f1', $signature['expectedSha256'] ?? null);
        $t->same(74, $signature['htmlFixtureCount'] ?? null);
        $t->same(74, $signature['nativeFixtureCount'] ?? null);
        $t->same(74, $signature['pairedFixtureCount'] ?? null);
        $t->same(148, $signature['recordCount'] ?? null);
        ...
        $t->same('HTML fixtures=74; native fixtures=74; same-basename pairs=74; HTML fixtures without native pairs=0', $report['orderedRemainingGaps'][1]['currentEvidence']);
        $t->same('The current checked-in gate covers 74 paired fixture(s) out of 74 HTML fixture(s).', $report['orderedRemainingGaps'][3]['currentEvidence']);
        $t->contains('fixtureInventory: html=74 native=74 paired=74 unpairedHtml=0 unpairedNative=0', $text);
        $t->contains('fixtureInventorySignature: status=valid-checked-in-html-fixture-inventory matchesExpected=yes sha256=210ff977f41b6b13d87da4a41696e7f7489d0ab7f840065b8316710e034bb2f1', $text);
        $t->contains('pairs: total=74 compared=74 parsedBoth=74 parseFailures=0', $text);
        $t->contains('normalizedAst: matches=74 (100.00%) mismatches=0', $text);
        ...
        $t->same(0, $exitCode);
        $t->same(74, $decoded['htmlFixtureCount']);
        ...
        $t->same('210ff977f41b6b13d87da4a41696e7f7489d0ab7f840065b8316710e034bb2f1', $decoded['checkedInFixtureInventorySignature']['sha256'] ?? null);
