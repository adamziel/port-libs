...
return [
    ...
    'checked-in html fixtures match native ast shape' => static function (TestRunner $t) use ($fixtureRoot): void {
        ...
        $t->same(59, $report['htmlFixtureCount']);
        ...
        $t->same(59, $report['htmlParsedCount']);
        ...
        $t->same(true, HtmlNativeAstComparisonHarness::hasRequiredMappedParity($report, 59));
        ...
        $t->same('HTML fixtures=59; native fixtures=59; same-basename pairs=59; HTML fixtures without native pairs=0', $report['orderedRemainingGaps'][1]['currentEvidence']);
        $t->same('The current checked-in gate covers 59 paired fixture(s) out of 59 HTML fixture(s).', $report['orderedRemainingGaps'][3]['currentEvidence']);
        $t->contains('fixtureInventory: html=59 native=59 paired=59 unpairedHtml=0 unpairedNative=0', $text);
        ...
        $t->same(0, $exitCode);
        $t->same(59, $decoded['htmlFixtureCount']);
