...
$cases = [
    'dash marker heading first child' => [
        ...
        'headingId' => 'tab-heading',
        'paragraphIndex' => 1,
        'paragraphText' => 'continuation',
        'wordpress' => '<ul><li><h1 id="tab-heading">Tab heading</h1>continuation</li></ul>',
    ],
    'ordered marker heading first child' => [
        ...
        'headingId' => 'ordered-tab-heading',
        'paragraphIndex' => 1,
        'paragraphText' => 'continuation',
        'wordpress' => '<ol><li><h1 id="ordered-tab-heading">Ordered tab heading</h1>continuation</li></ol>',
    ],
    'dash marker paragraph then heading' => [
        ...
        'headingId' => 'nested-tab-heading',
        'leadText' => 'lead',
        'wordpress' => '<ul><li>lead<h1 id="nested-tab-heading">Nested tab heading</h1></li></ul>',
    ],
    'ordered marker paragraph then heading' => [
        ...
        'headingId' => 'ordered-nested-tab-heading',
        'leadText' => 'lead',
        'wordpress' => '<ol><li>lead<h1 id="ordered-nested-tab-heading">Ordered nested tab heading</h1></li></ol>',
    ],
];
