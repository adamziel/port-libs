...
return [
    ...
    'tracks xml jats bits direct reader capabilities without parity claims' => static function (TestRunner $t): void {
        ...
        $t->contains('element and attribute namespace usage summaries', implode('; ', $packet['formats']['xml']['boundedDiagnostics']));
...
XML, 'registry XML namespace packet', preserveWhiteSpace: false);
        ...
        $t->same(8, $packet['namespacedAttributeUseCount']);
        ...
        $t->same(1, $packet['attributeNamespaceUsageSummaryCount']);
        $t->same(0, $packet['unboundNamespacePrefixUseCount']);
        $t->same(0, $packet['unusedNamespaceDeclarationCount']);
        $t->same(0, $packet['reservedNamespaceUseCount']);
