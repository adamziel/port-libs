...
return [
    'reports skipped markdown reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(72, $report['staticCurrentEvidence']['nativeExpectationEvidence']['presentFixtureCount']);
        ...
        $t->same(72, $report['nativeAstEvidence']['totalPairCount']);
        $t->same(72, $report['nativeAstEvidence']['normalizedAstMatchCount']);
        $t->same(0, $report['nativeAstEvidence']['unpairedMarkdownFixtureCount']);
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredSelectedFixtureCount($report, 72));
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredStaticCurrentEvidence($report));
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 72));
        ...
        $t->contains('Selected checked-in fixtures: 72', $text);
        $t->contains('Static current evidence: valid-checked-in-current-markdown-reader-evidence checkedInFixtures=72 nativeExpectations=72 nativeManifest=valid-checked-in-current-markdown-native-expectation-evidence', $text);
        $t->contains('Native AST mapped parity: 72/72 status=normalized-ast-equality-observed-not-runner-parity', $text);
    ...
    'reports checked-in current markdown fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(72, $evidence['nativeExpectationEvidence']['expectedFixtureCount']);
        $t->same(72, $evidence['nativeExpectationEvidence']['fixtureCount']);
        $t->same(72, $evidence['nativeExpectationEvidence']['presentFixtureCount']);
        ...
        $t->same('upstream-markdown-z-spaced-reference-link-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][62]['name']);
        $t->same('4906924b61eab938e6cf600c8eb43db0bd478eef2ee54686710cf944512f4f60', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][62]['sha256']);
        $t->same(186, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][62]['bytes']);
        $t->same('upstream-markdown-z-tex-math-double-backslash-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][63]['name']);
        $t->same('bdb87c856b1b2c4cca8ff3e9257860e5c83f937dd9e225160abdf2bef763868c', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][63]['sha256']);
        $t->same(189, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][63]['bytes']);
        $t->same('upstream-markdown-zz-east-asian-line-break-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][64]['name']);
        $t->same('e16865147801c4add46e54073ed512140c7e95bcd17924f663174993073750bc', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][64]['sha256']);
        $t->same(109, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][64]['bytes']);
        $t->same('upstream-markdown-zz-tex-math-single-backslash-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][65]['name']);
        ...
        $t->same('upstream-markdown-zzz-intraword-underscore-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][66]['name']);
        $t->same('4968e47692c43a71eb9ef11faa3a9ce045fd0125d52fe2d1f5fc6618a743090e', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][66]['sha256']);
        $t->same(171, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][66]['bytes']);
        $t->same('upstream-markdown-zzzz-angle-brackets-escapable-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][67]['name']);
        $t->same('204c50df7964fded0de512f7cefcb94bb730d22a88de4b33f27aa527f6ee4c00', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][67]['sha256']);
        $t->same(61, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][67]['bytes']);
        $t->same('upstream-markdown-zzzzz-wikilinks-title-after-pipe-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][68]['name']);
        $t->same('919aab37f5d3b7d0312eb46ec73321fa93a2876a963414742f48d08b2b0d155f', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][68]['sha256']);
        $t->same(205, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][68]['bytes']);
        $t->same('upstream-markdown-zzzzzzz-auto-identifiers-disabled-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][70]['name']);
        $t->same('83b7130b9f460c8b41e8f843bf6ab4a3bbc1baafe616db5e8b8753466d0ca964', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][70]['sha256']);
        $t->same(101, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][70]['bytes']);
        $t->same('upstream-markdown-zzzzzzzz-blank-before-header-disabled-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][71]['name']);
        $t->same('5cdca0df7423cb574a72c2d2cf3e916d37a51cdf0eb883bb9fb0ac4d71166fd8', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][71]['sha256']);
        $t->same(252, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][71]['bytes']);
        ...
        $t->same('upstream-markdown-z-short-subsuperscript-profile.md', $evidence['checkedInFixtures'][60]['name']);
        $t->same('749be67c41a587eefa87c24129d84369e3fa3a10d9cc299fb709e51d3818e33a', $evidence['checkedInFixtures'][60]['checkedInFile']['sha256']);
        $t->same(29, $evidence['checkedInFixtures'][60]['checkedInFile']['bytes']);
        $t->same('markdown+short_subsuperscripts short subscript/superscript profile', $evidence['checkedInFixtures'][60]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderShortSubsuperscriptProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][60]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderShortSubsuperscriptProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][60]['localTestReferences'], true));
        $t->same('upstream-markdown-z-spaced-reference-link-profile.md', $evidence['checkedInFixtures'][61]['name']);
        $t->same('1a8864629a497067a58f7e12bdb6a56005779f92f8219d705e9ef488e6bd9bab', $evidence['checkedInFixtures'][61]['checkedInFile']['sha256']);
        $t->same(127, $evidence['checkedInFixtures'][61]['checkedInFile']['bytes']);
        $t->same('markdown-shortcut_reference_links+spaced_reference_links spaced reference labels with shortcut links disabled', $evidence['checkedInFixtures'][61]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSpacedReferenceLinkProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][61]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSpacedReferenceLinkProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][61]['localTestReferences'], true));
        $t->same('upstream-markdown-z-tex-math-double-backslash-profile.md', $evidence['checkedInFixtures'][62]['name']);
        $t->same('9b0d34f3b6a66f40771940859a979cc06da95e3fc7deb439907edac34a2a484b', $evidence['checkedInFixtures'][62]['checkedInFile']['sha256']);
        $t->same(40, $evidence['checkedInFixtures'][62]['checkedInFile']['bytes']);
        $t->same('markdown+tex_math_double_backslash inline/display math delimiters', $evidence['checkedInFixtures'][62]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderDoubleBackslashMathProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][62]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderDoubleBackslashMathProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][62]['localTestReferences'], true));
        $t->same('upstream-markdown-zz-east-asian-line-break-profile.md', $evidence['checkedInFixtures'][63]['name']);
        $t->same('bfa1c21a376998bbdf364121bcaa093db875c9e415c0d40908a38182922f2871', $evidence['checkedInFixtures'][63]['checkedInFile']['sha256']);
        $t->same(20, $evidence['checkedInFixtures'][63]['checkedInFile']['bytes']);
        $t->same('markdown+east_asian_line_breaks joins East Asian soft line boundaries only', $evidence['checkedInFixtures'][63]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderEastAsianLineBreakProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][63]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderEastAsianLineBreakProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][63]['localTestReferences'], true));
        $t->same('upstream-markdown-zz-tex-math-single-backslash-profile.md', $evidence['checkedInFixtures'][64]['name']);
        $t->same('f02128f194b2d78319520340497fe7bc3f195a7f030bd59838091275769f918f', $evidence['checkedInFixtures'][64]['checkedInFile']['sha256']);
        $t->same(36, $evidence['checkedInFixtures'][64]['checkedInFile']['bytes']);
        $t->same('markdown+tex_math_single_backslash inline/display math delimiters', $evidence['checkedInFixtures'][64]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSingleBackslashMathProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][64]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSingleBackslashMathProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][64]['localTestReferences'], true));
        $t->same('upstream-markdown-zzz-intraword-underscore-profile.md', $evidence['checkedInFixtures'][65]['name']);
        $t->same('23bc30dbf0fb9813f0cf0addfd364c788ce80f56203bf1ca2f69f7f5752fec8d', $evidence['checkedInFixtures'][65]['checkedInFile']['sha256']);
        $t->same(30, $evidence['checkedInFixtures'][65]['checkedInFile']['bytes']);
        $t->same('markdown-intraword_underscores intraword emphasis/strong profile', $evidence['checkedInFixtures'][65]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderIntrawordUnderscoreProfileCompletionTest.php', $evidence['checkedInFixtures'][65]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderIntrawordUnderscoreProfileCompletionTest.php', $evidence['checkedInFixtures'][65]['localTestReferences'], true));
        $t->same('upstream-markdown-z-lists-without-preceding-blankline-profile.md', $evidence['checkedInFixtures'][66]['name']);
        $t->same('4de2a3ad30fc94cb41a4d00e9f004d07fde543dacd892f5c4559812afe118521', $evidence['checkedInFixtures'][66]['checkedInFile']['sha256']);
        $t->same(47, $evidence['checkedInFixtures'][66]['checkedInFile']['bytes']);
        $t->same('markdown+lists_without_preceding_blankline paragraph-interrupting bullet and non-one ordered list markers', $evidence['checkedInFixtures'][66]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderListsWithoutPrecedingBlanklineProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][66]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderListsWithoutPrecedingBlanklineProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][66]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzz-angle-brackets-escapable-profile.md', $evidence['checkedInFixtures'][67]['name']);
        $t->same('1693f0d6344c29946c29918167e5197d7631207e72cb1000f16b14d355904b6b', $evidence['checkedInFixtures'][67]['checkedInFile']['sha256']);
        $t->same(12, $evidence['checkedInFixtures'][67]['checkedInFile']['bytes']);
        $t->same('markdown-all_symbols_escapable+angle_brackets_escapable angle-only escape profile', $evidence['checkedInFixtures'][67]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAngleBracketEscapableProfileCompletionTest.php', $evidence['checkedInFixtures'][67]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAngleBracketEscapableProfileCompletionTest.php', $evidence['checkedInFixtures'][67]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzz-wikilinks-title-after-pipe-profile.md', $evidence['checkedInFixtures'][68]['name']);
        $t->same('57fd7294b0f6f88a4190b23b68771dc5a111d3b9bcc7aa6d000be987cce9fa52', $evidence['checkedInFixtures'][68]['checkedInFile']['sha256']);
        $t->same(45, $evidence['checkedInFixtures'][68]['checkedInFile']['bytes']);
        $t->same('markdown+wikilinks_title_after_pipe target-before-pipe/title-after-pipe wikilink profile', $evidence['checkedInFixtures'][68]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderWikiLinkDirectionCompletionTest.php', $evidence['checkedInFixtures'][68]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderWikiLinkDirectionCompletionTest.php', $evidence['checkedInFixtures'][68]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzz-ignore-line-breaks-profile.md', $evidence['checkedInFixtures'][69]['name']);
        $t->same('de6e28f373e2f47e1e603f8e9bf80abb7fa9d13fdfe210f9125bd4f052e4ebdc', $evidence['checkedInFixtures'][69]['checkedInFile']['sha256']);
        $t->same(30, $evidence['checkedInFixtures'][69]['checkedInFile']['bytes']);
        $t->same('markdown+ignore_line_breaks ordinary physical newlines ignored while explicit hard-break markers survive', $evidence['checkedInFixtures'][69]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderLineBreakProfileSurgeTest.php', $evidence['checkedInFixtures'][69]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderLineBreakProfileSurgeTest.php', $evidence['checkedInFixtures'][69]['localTestReferences'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownNativeAstComparisonHarnessTest.php', $evidence['checkedInFixtures'][69]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzzz-auto-identifiers-disabled-profile.md', $evidence['checkedInFixtures'][70]['name']);
        $t->same('d5699a975a6717d34a5ec0d06d4b852a3201be0726d90ac01b10e552754ed926', $evidence['checkedInFixtures'][70]['checkedInFile']['sha256']);
        $t->same(19, $evidence['checkedInFixtures'][70]['checkedInFile']['bytes']);
        $t->same('markdown-auto_identifiers generated heading IDs disabled while heading text remains parsed', $evidence['checkedInFixtures'][70]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAutoIdentifierProfileCompletionTest.php', $evidence['checkedInFixtures'][70]['coverageTests'], true));
        ...
        $t->same('upstream-markdown-zzzzzzzz-blank-before-header-disabled-profile.md', $evidence['checkedInFixtures'][71]['name']);
        $t->same('153bfcf8342792293c62211ee56b1af9f717e80dd74df85e634f4db18877a580', $evidence['checkedInFixtures'][71]['checkedInFile']['sha256']);
        $t->same(40, $evidence['checkedInFixtures'][71]['checkedInFile']['bytes']);
        $t->same('markdown-blank_before_header paragraph-interrupting ATX heading with implicit header reference', $evidence['checkedInFixtures'][71]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderBlankBeforeBlockBoundaryProfileTest.php', $evidence['checkedInFixtures'][71]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderBlankBeforeBlockBoundaryProfileTest.php', $evidence['checkedInFixtures'][71]['localTestReferences'], true));
    ...
    'cli gates checked-in current markdown fixture evidence through checked-in fixtures mode' => static function (TestRunner $t): void {
        ...
        $failingNativeCommand = str_replace('--require-native-mapped-parity=72', '--require-native-mapped-parity=73', $command) . ' 2>/dev/null';
        $failingNativeOutput = [];
    ...
    'workflow gates current markdown fixture denominator' => static function (TestRunner $t): void {
        ...
        $t->contains('--require-selected-fixture-count=72', $workflow);
        $t->contains('--require-native-mapped-parity=72', $workflow);
        $t->contains('--require-mapped-parity=72', $workflow);
