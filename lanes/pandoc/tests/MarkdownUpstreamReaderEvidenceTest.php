...
return [
    'reports skipped markdown reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(93, $report['staticCurrentEvidence']['nativeExpectationEvidence']['presentFixtureCount']);
        ...
        $t->same(93, $report['nativeAstEvidence']['totalPairCount']);
        $t->same(93, $report['nativeAstEvidence']['normalizedAstMatchCount']);
        $t->same(0, $report['nativeAstEvidence']['unpairedMarkdownFixtureCount']);
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredSelectedFixtureCount($report, 93));
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredStaticCurrentEvidence($report));
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 93));
        ...
        $t->contains('Selected checked-in fixtures: 93', $text);
        $t->contains('Static current evidence: valid-checked-in-current-markdown-reader-evidence checkedInFixtures=93 nativeExpectations=93 nativeManifest=valid-checked-in-current-markdown-native-expectation-evidence', $text);
        $t->contains('Native AST mapped parity: 93/93 status=normalized-ast-equality-observed-not-runner-parity', $text);
    ...
    'reports checked-in current markdown fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(93, $evidence['nativeExpectationEvidence']['expectedFixtureCount']);
        $t->same(93, $evidence['nativeExpectationEvidence']['fixtureCount']);
        $t->same(93, $evidence['nativeExpectationEvidence']['presentFixtureCount']);
        ...
        $t->same('upstream-markdown-strict-compact-heading.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][52]['name']);
        $t->same('dca4b0a1370fb86f4ea2ab8f19d1254313558ae57954679d1b3ca1fbaa2c8044', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][52]['sha256']);
        $t->same(43, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][52]['bytes']);
        $t->same('upstream-markdown-task-list.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][55]['name']);
        $t->same('80ead08088210467f4ce4ab35800a2be9e47b76a5c63fb92c3692ce3b49728df', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][55]['sha256']);
        $t->same(846, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][55]['bytes']);
        $t->same('upstream-markdown-unbalanced-brackets.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][56]['name']);
        $t->same('9179740322c07d3717a32cb023a504dafaf164a6f39e2b1cc2fd1f3d11b7e5d8', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][56]['sha256']);
        $t->same(34, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][56]['bytes']);
        $t->same('upstream-markdown-yaml-metadata.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][57]['name']);
        $t->same('7ef515f951844ff049c5f6a4c98f42094843aa311061f59eb20d2be6bca6d7b2', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][57]['sha256']);
        $t->same(75, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][57]['bytes']);
        $t->same('upstream-markdown-z-commonmark-x-grid-table-default.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][58]['name']);
        $t->same('566596459e8d3e3ab0ae5842fecc54764cad72c34c81a104ca9df16451e5143d', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][58]['sha256']);
        $t->same(389, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][58]['bytes']);
        $t->same('upstream-markdown-z-fancy-list-markers.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][59]['name']);
        $t->same('d355209d6e62f20b6c85859cac1100dae074c28c12fb7257e5760395a205fd4e', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][59]['sha256']);
        $t->same(374, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][59]['bytes']);
        $t->same('upstream-markdown-z-hard-line-break-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][60]['name']);
        $t->same('ee1a809fbe38b6925fdddb239c1dc67d63202ef0b5d76aa5199e81378547cc42', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][60]['sha256']);
        $t->same(100, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][60]['bytes']);
        $t->same('upstream-markdown-z-lists-without-preceding-blankline-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][61]['name']);
        $t->same('38ba85d714dd40976b5d6d337f2ec718fcbd1eeed971d411b3bee97bee0b804d', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][61]['sha256']);
        $t->same(237, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][61]['bytes']);
        $t->same('upstream-markdown-z-phpextra-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][62]['name']);
        $t->same('be3c3413188c1a207f164bf91440fe7905e791190969231477e6f0aa9e062af4', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][62]['sha256']);
        $t->same(404, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][62]['bytes']);
        $t->same('upstream-markdown-z-short-subsuperscript-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][63]['name']);
        $t->same('3d61d968b764b7cf70200e55a15b3526ef98c85242e2074500302492cd72afba', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][63]['sha256']);
        $t->same(295, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][63]['bytes']);
        $t->same('upstream-markdown-z-simple-table-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][64]['name']);
        $t->same('dbbb32b1d1baa0e7fc2115f459dc2edeaf4bd7967f5e33a5d37e239a74df631b', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][64]['sha256']);
        $t->same(1132, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][64]['bytes']);
        $t->same('upstream-markdown-z-spaced-reference-link-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][65]['name']);
        $t->same('4906924b61eab938e6cf600c8eb43db0bd478eef2ee54686710cf944512f4f60', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][65]['sha256']);
        $t->same(186, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][65]['bytes']);
        $t->same('upstream-markdown-z-tex-math-double-backslash-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][66]['name']);
        $t->same('bdb87c856b1b2c4cca8ff3e9257860e5c83f937dd9e225160abdf2bef763868c', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][66]['sha256']);
        $t->same(189, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][66]['bytes']);
        $t->same('upstream-markdown-zz-east-asian-line-break-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][67]['name']);
        $t->same('e16865147801c4add46e54073ed512140c7e95bcd17924f663174993073750bc', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][67]['sha256']);
        $t->same(109, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][67]['bytes']);
        $t->same('upstream-markdown-zz-tex-math-single-backslash-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][68]['name']);
        $t->same('bdb87c856b1b2c4cca8ff3e9257860e5c83f937dd9e225160abdf2bef763868c', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][68]['sha256']);
        $t->same(189, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][68]['bytes']);
        $t->same('upstream-markdown-zzz-intraword-underscore-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][69]['name']);
        $t->same('4968e47692c43a71eb9ef11faa3a9ce045fd0125d52fe2d1f5fc6618a743090e', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][69]['sha256']);
        $t->same(171, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][69]['bytes']);
        $t->same('upstream-markdown-zzzz-angle-brackets-escapable-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][70]['name']);
        $t->same('204c50df7964fded0de512f7cefcb94bb730d22a88de4b33f27aa527f6ee4c00', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][70]['sha256']);
        $t->same(61, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][70]['bytes']);
        $t->same('upstream-markdown-zzzzz-wikilinks-title-after-pipe-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][71]['name']);
        $t->same('919aab37f5d3b7d0312eb46ec73321fa93a2876a963414742f48d08b2b0d155f', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][71]['sha256']);
        $t->same(205, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][71]['bytes']);
        $t->same('upstream-markdown-zzzzzzz-auto-identifiers-disabled-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][73]['name']);
        $t->same('83b7130b9f460c8b41e8f843bf6ab4a3bbc1baafe616db5e8b8753466d0ca964', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][73]['sha256']);
        $t->same(101, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][73]['bytes']);
        $t->same('upstream-markdown-zzzzzzzz-blank-before-header-disabled-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][74]['name']);
        $t->same('5cdca0df7423cb574a72c2d2cf3e916d37a51cdf0eb883bb9fb0ac4d71166fd8', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][74]['sha256']);
        $t->same(252, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][74]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzz-citation-digit-key.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][75]['name']);
        $t->same('28f37bccb6a9a8a51e9885a388719fdfa7bd4e2e8a60fa171e684487a2415aaf', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][75]['sha256']);
        $t->same(320, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][75]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzz-bare-uri-bracket-encoding.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][76]['name']);
        $t->same('5a9aa259420310b288f764dd59a0fff5c14b4075f112f37c5c01a0364df52d25', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][76]['sha256']);
        $t->same(492, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][76]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzz-mmd-title-block-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][77]['name']);
        $t->same('b863b6fa6acf24ae00e309f4bb02c424af7b7d9fbbfbb686b1807a6dcee157bf', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][77]['sha256']);
        $t->same(46, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][77]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzz-gfm-auto-identifiers-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][78]['name']);
        $t->same('cb049f633fe66d7449130475064da0c16e9b0adf628ec902688467e0dbc5dfcc', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][78]['sha256']);
        $t->same(525, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][78]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzz-citation-link-boundaries.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][79]['name']);
        $t->same('34b46cf8f763cc2f46122f4a8e594888be5c8166a9d415432297fa35b43aa9cb', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][79]['sha256']);
        $t->same(2264, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][79]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzz-footnote-fenced-div-boundary.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][80]['name']);
        $t->same('1b74f20e722381136cc22f566c8f51457e5931440dfd9924d06ab007ea3100eb', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][80]['sha256']);
        $t->same(690, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][80]['bytes']);
        ...
        $t->same('upstream-markdown-raw-html-invalid-tag.md', $evidence['checkedInFixtures'][47]['name']);
        $t->same('c981cea993a23dc23358c1d17fdda03abc7ed9b95f0fdd721beb0629dcba891a', $evidence['checkedInFixtures'][47]['checkedInFile']['sha256']);
        $t->same(15, $evidence['checkedInFixtures'][47]['checkedInFile']['bytes']);
        $t->same('markdown raw_html invalid tag literal boundary', $evidence['checkedInFixtures'][47]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderRawHtmlInvalidTagBoundaryCompletionTest.php', $evidence['checkedInFixtures'][47]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderRawHtmlInvalidTagBoundaryCompletionTest.php', $evidence['checkedInFixtures'][47]['localTestReferences'], true));
        ...
        $t->same('upstream-markdown-z-hard-line-break-profile.md', $evidence['checkedInFixtures'][56]['name']);
        $t->same('4fdbc441ea7b546100e086ac1e4fc5ae6749b7314311c99db05be450eca12996', $evidence['checkedInFixtures'][56]['checkedInFile']['sha256']);
        $t->same(17, $evidence['checkedInFixtures'][56]['checkedInFile']['bytes']);
        $t->same('markdown+hard_line_breaks physical paragraph newlines as LineBreak constructors', $evidence['checkedInFixtures'][56]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderHardLineBreakProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][56]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderHardLineBreakProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][56]['localTestReferences'], true));
        $t->same('upstream-markdown-inline-math.md', $evidence['checkedInFixtures'][57]['name']);
        $t->same('364f852f91e3d11943ffa83ae6cd717f3b9ae38a2c61100fe135e95d4bf9180a', $evidence['checkedInFixtures'][57]['checkedInFile']['sha256']);
        $t->same(36, $evidence['checkedInFixtures'][57]['checkedInFile']['bytes']);
        $t->same('markdown tex_math_dollars inline math', $evidence['checkedInFixtures'][57]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderInlineMathFixtureCompletionTest.php', $evidence['checkedInFixtures'][57]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderInlineMathFixtureCompletionTest.php', $evidence['checkedInFixtures'][57]['localTestReferences'], true));
        $t->same('upstream-markdown-ascii-identifiers.md', $evidence['checkedInFixtures'][58]['name']);
        $t->same('37abcb0679639cce00173e8737b95b0c76da7a3f2b6bc3790bccbd2790abf232', $evidence['checkedInFixtures'][58]['checkedInFile']['sha256']);
        $t->same(156, $evidence['checkedInFixtures'][58]['checkedInFile']['bytes']);
        $t->same('markdown+ascii_identifiers', $evidence['checkedInFixtures'][58]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAsciiIdentifierProfileCompletionTest.php', $evidence['checkedInFixtures'][58]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownNativeAstComparisonHarnessTest.php', $evidence['checkedInFixtures'][58]['localTestReferences'], true));
        $t->same('upstream-markdown-z-phpextra-profile.md', $evidence['checkedInFixtures'][59]['name']);
        $t->same('83e7b30e00869c6ef685979df5fa075d3e4bb2bc988d0e615ea584b6374f5347', $evidence['checkedInFixtures'][59]['checkedInFile']['sha256']);
        $t->same(120, $evidence['checkedInFixtures'][59]['checkedInFile']['bytes']);
        $t->same('markdown_phpextra header_attributes/link_attributes/definition_lists/footnotes defaults', $evidence['checkedInFixtures'][59]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderPhpExtraProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][59]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownNativeAstComparisonHarnessTest.php', $evidence['checkedInFixtures'][59]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderPhpExtraProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][59]['localTestReferences'], true));
        $t->same('upstream-markdown-z-simple-table-profile.md', $evidence['checkedInFixtures'][60]['name']);
        $t->same('dead898102ace731504514d4a7babbc466ed7ed3e402ba0cba752a4c610689d9', $evidence['checkedInFixtures'][60]['checkedInFile']['sha256']);
        $t->same(39, $evidence['checkedInFixtures'][60]['checkedInFile']['bytes']);
        $t->same('markdown+simple_tables header/body table constructor profile', $evidence['checkedInFixtures'][60]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSimpleTableProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][60]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSimpleTableProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][60]['localTestReferences'], true));
        $t->same('upstream-markdown-z-short-subsuperscript-profile.md', $evidence['checkedInFixtures'][61]['name']);
        $t->same('749be67c41a587eefa87c24129d84369e3fa3a10d9cc299fb709e51d3818e33a', $evidence['checkedInFixtures'][61]['checkedInFile']['sha256']);
        $t->same(29, $evidence['checkedInFixtures'][61]['checkedInFile']['bytes']);
        $t->same('markdown+short_subsuperscripts short subscript/superscript profile', $evidence['checkedInFixtures'][61]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderShortSubsuperscriptProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][61]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderShortSubsuperscriptProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][61]['localTestReferences'], true));
        $t->same('upstream-markdown-z-spaced-reference-link-profile.md', $evidence['checkedInFixtures'][62]['name']);
        $t->same('1a8864629a497067a58f7e12bdb6a56005779f92f8219d705e9ef488e6bd9bab', $evidence['checkedInFixtures'][62]['checkedInFile']['sha256']);
        $t->same(127, $evidence['checkedInFixtures'][62]['checkedInFile']['bytes']);
        $t->same('markdown-shortcut_reference_links+spaced_reference_links spaced reference labels with shortcut links disabled', $evidence['checkedInFixtures'][62]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSpacedReferenceLinkProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][62]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSpacedReferenceLinkProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][62]['localTestReferences'], true));
        $t->same('upstream-markdown-z-tex-math-double-backslash-profile.md', $evidence['checkedInFixtures'][63]['name']);
        $t->same('9b0d34f3b6a66f40771940859a979cc06da95e3fc7deb439907edac34a2a484b', $evidence['checkedInFixtures'][63]['checkedInFile']['sha256']);
        $t->same(40, $evidence['checkedInFixtures'][63]['checkedInFile']['bytes']);
        $t->same('markdown+tex_math_double_backslash inline/display math delimiters', $evidence['checkedInFixtures'][63]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderDoubleBackslashMathProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][63]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderDoubleBackslashMathProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][63]['localTestReferences'], true));
        $t->same('upstream-markdown-zz-east-asian-line-break-profile.md', $evidence['checkedInFixtures'][64]['name']);
        $t->same('bfa1c21a376998bbdf364121bcaa093db875c9e415c0d40908a38182922f2871', $evidence['checkedInFixtures'][64]['checkedInFile']['sha256']);
        $t->same(20, $evidence['checkedInFixtures'][64]['checkedInFile']['bytes']);
        $t->same('markdown+east_asian_line_breaks joins East Asian soft line boundaries only', $evidence['checkedInFixtures'][64]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderEastAsianLineBreakProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][64]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownNativeAstComparisonHarnessTest.php', $evidence['checkedInFixtures'][64]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderEastAsianLineBreakProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][64]['localTestReferences'], true));
        $t->same('upstream-markdown-zz-tex-math-single-backslash-profile.md', $evidence['checkedInFixtures'][65]['name']);
        $t->same('f02128f194b2d78319520340497fe7bc3f195a7f030bd59838091275769f918f', $evidence['checkedInFixtures'][65]['checkedInFile']['sha256']);
        $t->same(36, $evidence['checkedInFixtures'][65]['checkedInFile']['bytes']);
        $t->same('markdown+tex_math_single_backslash inline/display math delimiters', $evidence['checkedInFixtures'][65]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSingleBackslashMathProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][65]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderSingleBackslashMathProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][65]['localTestReferences'], true));
        $t->same('upstream-markdown-zzz-intraword-underscore-profile.md', $evidence['checkedInFixtures'][66]['name']);
        $t->same('23bc30dbf0fb9813f0cf0addfd364c788ce80f56203bf1ca2f69f7f5752fec8d', $evidence['checkedInFixtures'][66]['checkedInFile']['sha256']);
        $t->same(30, $evidence['checkedInFixtures'][66]['checkedInFile']['bytes']);
        $t->same('markdown-intraword_underscores intraword emphasis/strong profile', $evidence['checkedInFixtures'][66]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderIntrawordUnderscoreProfileCompletionTest.php', $evidence['checkedInFixtures'][66]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderIntrawordUnderscoreProfileCompletionTest.php', $evidence['checkedInFixtures'][66]['localTestReferences'], true));
        $t->same('upstream-markdown-z-lists-without-preceding-blankline-profile.md', $evidence['checkedInFixtures'][67]['name']);
        $t->same('4de2a3ad30fc94cb41a4d00e9f004d07fde543dacd892f5c4559812afe118521', $evidence['checkedInFixtures'][67]['checkedInFile']['sha256']);
        $t->same(47, $evidence['checkedInFixtures'][67]['checkedInFile']['bytes']);
        $t->same('markdown+lists_without_preceding_blankline paragraph-interrupting bullet and non-one ordered list markers', $evidence['checkedInFixtures'][67]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderListsWithoutPrecedingBlanklineProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][67]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderListsWithoutPrecedingBlanklineProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][67]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzz-angle-brackets-escapable-profile.md', $evidence['checkedInFixtures'][68]['name']);
        $t->same('1693f0d6344c29946c29918167e5197d7631207e72cb1000f16b14d355904b6b', $evidence['checkedInFixtures'][68]['checkedInFile']['sha256']);
        $t->same(12, $evidence['checkedInFixtures'][68]['checkedInFile']['bytes']);
        $t->same('markdown-all_symbols_escapable+angle_brackets_escapable angle-only escape profile', $evidence['checkedInFixtures'][68]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAngleBracketEscapableProfileCompletionTest.php', $evidence['checkedInFixtures'][68]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAngleBracketEscapableProfileCompletionTest.php', $evidence['checkedInFixtures'][68]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzz-wikilinks-title-after-pipe-profile.md', $evidence['checkedInFixtures'][69]['name']);
        $t->same('57fd7294b0f6f88a4190b23b68771dc5a111d3b9bcc7aa6d000be987cce9fa52', $evidence['checkedInFixtures'][69]['checkedInFile']['sha256']);
        $t->same(45, $evidence['checkedInFixtures'][69]['checkedInFile']['bytes']);
        $t->same('markdown+wikilinks_title_after_pipe target-before-pipe/title-after-pipe wikilink profile', $evidence['checkedInFixtures'][69]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderWikiLinkDirectionCompletionTest.php', $evidence['checkedInFixtures'][69]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderWikiLinkDirectionCompletionTest.php', $evidence['checkedInFixtures'][69]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzz-ignore-line-breaks-profile.md', $evidence['checkedInFixtures'][70]['name']);
        $t->same('de6e28f373e2f47e1e603f8e9bf80abb7fa9d13fdfe210f9125bd4f052e4ebdc', $evidence['checkedInFixtures'][70]['checkedInFile']['sha256']);
        $t->same(30, $evidence['checkedInFixtures'][70]['checkedInFile']['bytes']);
        $t->same('markdown+ignore_line_breaks ordinary physical newlines ignored while explicit hard-break markers survive', $evidence['checkedInFixtures'][70]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderLineBreakProfileSurgeTest.php', $evidence['checkedInFixtures'][70]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderLineBreakProfileSurgeTest.php', $evidence['checkedInFixtures'][70]['localTestReferences'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownNativeAstComparisonHarnessTest.php', $evidence['checkedInFixtures'][70]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzzz-auto-identifiers-disabled-profile.md', $evidence['checkedInFixtures'][71]['name']);
        $t->same('d5699a975a6717d34a5ec0d06d4b852a3201be0726d90ac01b10e552754ed926', $evidence['checkedInFixtures'][71]['checkedInFile']['sha256']);
        $t->same(19, $evidence['checkedInFixtures'][71]['checkedInFile']['bytes']);
        $t->same('markdown-auto_identifiers generated heading IDs disabled while heading text remains parsed', $evidence['checkedInFixtures'][71]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAutoIdentifierProfileCompletionTest.php', $evidence['checkedInFixtures'][71]['coverageTests'], true));
        ...
        $t->same('upstream-markdown-zzzzzzzz-blank-before-header-disabled-profile.md', $evidence['checkedInFixtures'][72]['name']);
        $t->same('153bfcf8342792293c62211ee56b1af9f717e80dd74df85e634f4db18877a580', $evidence['checkedInFixtures'][72]['checkedInFile']['sha256']);
        $t->same(40, $evidence['checkedInFixtures'][72]['checkedInFile']['bytes']);
        $t->same('markdown-blank_before_header paragraph-interrupting ATX heading with implicit header reference', $evidence['checkedInFixtures'][72]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderBlankBeforeBlockBoundaryProfileTest.php', $evidence['checkedInFixtures'][72]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderBlankBeforeBlockBoundaryProfileTest.php', $evidence['checkedInFixtures'][72]['localTestReferences'], true));
        ...
        $t->same('upstream-markdown-zzzzzzzzz-citation-digit-key.md', $evidence['checkedInFixtures'][73]['name']);
        $t->same('ed4794c48dd0f70f0bb11a32c8b2148259ddc3366c5fafa72db9ed97c02b74a8', $evidence['checkedInFixtures'][73]['checkedInFile']['sha256']);
        $t->same(15, $evidence['checkedInFixtures'][73]['checkedInFile']['bytes']);
        $t->same('markdown citations digit-leading key', $evidence['checkedInFixtures'][73]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderCitationDigitKeyFixtureCompletionTest.php', $evidence['checkedInFixtures'][73]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderCitationDigitKeyFixtureCompletionTest.php', $evidence['checkedInFixtures'][73]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzzzzzz-bare-uri-bracket-encoding.md', $evidence['checkedInFixtures'][74]['name']);
        $t->same('bf3c3167f8df54bff120fe833bd61bbe0db2ed036a9f4e6befdbe178aaaf9702', $evidence['checkedInFixtures'][74]['checkedInFile']['sha256']);
        $t->same(113, $evidence['checkedInFixtures'][74]['checkedInFile']['bytes']);
        $t->same('markdown+autolink_bare_uris square and curly bracket target percent-encoding', $evidence['checkedInFixtures'][74]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderBareUriBracketEncodingFixtureCompletionTest.php', $evidence['checkedInFixtures'][74]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownNativeAstComparisonHarnessTest.php', $evidence['checkedInFixtures'][74]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderBareUriBracketEncodingFixtureCompletionTest.php', $evidence['checkedInFixtures'][74]['localTestReferences'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownNativeAstComparisonHarnessTest.php', $evidence['checkedInFixtures'][74]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzzzzzzz-mmd-title-block-profile.md', $evidence['checkedInFixtures'][75]['name']);
        $t->same('ae9b323e06416495765aa0a6f06a3b51c0892744cf842fe6bcdc4287bff41f5a', $evidence['checkedInFixtures'][75]['checkedInFile']['sha256']);
        $t->same(70, $evidence['checkedInFixtures'][75]['checkedInFile']['bytes']);
        $t->same('markdown_mmd mmd_title_block metadata removed from body', $evidence['checkedInFixtures'][75]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderMmdTitleBlockProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][75]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderMmdTitleBlockProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][75]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzzzzzzzz-gfm-auto-identifiers-profile.md', $evidence['checkedInFixtures'][76]['name']);
        $t->same('24fe9261edac6c433bd1add99f394033bda6ad3a8721798e28032ebf00187be8', $evidence['checkedInFixtures'][76]['checkedInFile']['sha256']);
        $t->same(91, $evidence['checkedInFixtures'][76]['checkedInFile']['bytes']);
        $t->same('commonmark+gfm_auto_identifiers+ascii_identifiers punctuation stripping, ASCII folding, dash fallback, and duplicate suffixing', $evidence['checkedInFixtures'][76]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderGfmAutoIdentifierProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][76]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderGfmAutoIdentifierProfileFixtureCompletionTest.php', $evidence['checkedInFixtures'][76]['localTestReferences'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownNativeAstComparisonHarnessTest.php', $evidence['checkedInFixtures'][76]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzzzzzzzzz-citation-link-boundaries.md', $evidence['checkedInFixtures'][77]['name']);
        $t->same('61c35e0cc522237de7afc0ceb3eedf50716dbab3b654c3bfef996196527a469c', $evidence['checkedInFixtures'][77]['checkedInFile']['sha256']);
        $t->same(178, $evidence['checkedInFixtures'][77]['checkedInFile']['bytes']);
        $t->same('markdown citations with following footnote, inline link, reference link, shortcut reference link, implicit header reference, and suffix boundary', $evidence['checkedInFixtures'][77]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderCitationLinkBoundaryFixtureCompletionTest.php', $evidence['checkedInFixtures'][77]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderCitationLinkBoundaryFixtureCompletionTest.php', $evidence['checkedInFixtures'][77]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzzzzzzzzzz-footnote-fenced-div-boundary.md', $evidence['checkedInFixtures'][78]['name']);
        $t->same('1899054fb7e7d232092d3a4b96b83d804f0a4c66ded8c370431f04ce46394775', $evidence['checkedInFixtures'][78]['checkedInFile']['sha256']);
        $t->same(153, $evidence['checkedInFixtures'][78]['checkedInFile']['bytes']);
        $t->same('markdown footnotes plus fenced_divs/native_divs same-line literal and indented Div boundary', $evidence['checkedInFixtures'][78]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderFootnoteFencedDivBoundaryCompletionTest.php', $evidence['checkedInFixtures'][78]['coverageTests'], true));
        ...
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderFootnoteFencedDivBoundaryCompletionTest.php', $evidence['checkedInFixtures'][78]['localTestReferences'], true));
        $t->same('upstream-markdown-zzzzzzzzzzzzzzz-raw-html-list-boundary.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][81]['name']);
        $t->same('4b48b2fc92cf096187d51ac38d4a1dc84877ab04548b052815c39aa7398f1c58', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][81]['sha256']);
        $t->same(690, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][81]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzzzz-gfm-nested-list-continuation.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][82]['name']);
        $t->same('1e086c90566b85f38519ace90e2e3663781ec3b52d3a9b0230cec7df42a67d1d', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][82]['sha256']);
        $t->same(156, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][82]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzzzzz-blank-before-blockquote-disabled-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][83]['name']);
        $t->same('f3126c89e72fbcf239aed32a07c8b00a03a70d760079cf8eb36154783df36bb0', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][83]['sha256']);
        $t->same(217, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][83]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzzzzzz-blank-before-header-blockquote-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][84]['name']);
        $t->same('df0075d199dace341f3a028955f7fa1737ef269dcea05aecad55aaa4fda00402', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][84]['sha256']);
        $t->same(291, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][84]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzzzzzzz-mark-extension-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][85]['name']);
        $t->same('a56a441f8c5cb97913566cf8d2b4b8aa253565c53f1c98723aa1bc0590389181', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][85]['sha256']);
        $t->same(180, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][85]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzzzzzzzz-angle-autolink-unicode-dash-boundary.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][86]['name']);
        $t->same('8726de6b08623d4e60c4f23d0f73f8beb0f96edecaf6b20c0f74ff4b15f8daf4', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][86]['sha256']);
        $t->same(143, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][86]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzzzzzzzzz-partial-autolink-boundary.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][87]['name']);
        $t->same('6ae0899513186d034cc3024bd35524fa7b2b4d5f09c9fcc11b2293e0dadff0ff', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][87]['sha256']);
        $t->same(74, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][87]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzzzzzzzzzzz-bare-uri-scheme-boundaries.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][89]['name']);
        $t->same('4f5d1e76db624e34416737c5072b4604712f2309469c8331f2bd6c106eea4b32', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][89]['sha256']);
        $t->same(652, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][89]['bytes']);
        $t->same('upstream-markdown-zzzzzzzzzzzzzzzzzzzzzzzzz-atx-heading-space-disabled-profile.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][91]['name']);
        $t->same('02ab8ce343121501a3f9d78b967ce95d4a9dad06e74fc4daaa59492079eac59f', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][91]['sha256']);
        $t->same(59, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][91]['bytes']);
    ...
    'cli gates checked-in current markdown fixture evidence through checked-in fixtures mode' => static function (TestRunner $t): void {
        ...
        $failingCommand = str_replace('--require-selected-fixture-count=93', '--require-selected-fixture-count=94', $command) . ' 2>/dev/null';
        $failingOutput = [];
        $failingExitCode = 0;
        ...
        $failingNativeCommand = str_replace('--require-native-mapped-parity=93', '--require-native-mapped-parity=94', $command) . ' 2>/dev/null';
        $failingNativeOutput = [];
    ...
    'workflow gates current markdown fixture denominator' => static function (TestRunner $t): void {
        ...
        $t->contains('--require-selected-fixture-count=93', $workflow);
        $t->contains('--require-native-mapped-parity=93', $workflow);
        $t->contains('--require-mapped-parity=93', $workflow);
