...
return [
    'reports skipped markdown reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(54, $report['staticCurrentEvidence']['nativeExpectationEvidence']['presentFixtureCount']);
        ...
        $t->same(54, $report['nativeAstEvidence']['totalPairCount']);
        $t->same(54, $report['nativeAstEvidence']['normalizedAstMatchCount']);
        $t->same(0, $report['nativeAstEvidence']['unpairedMarkdownFixtureCount']);
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredSelectedFixtureCount($report, 54));
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredStaticCurrentEvidence($report));
        $t->same(true, MarkdownUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 54));
        ...
        $t->contains('Selected checked-in fixtures: 54', $text);
        $t->contains('Static current evidence: valid-checked-in-current-markdown-reader-evidence checkedInFixtures=54 nativeExpectations=54 nativeManifest=valid-checked-in-current-markdown-native-expectation-evidence', $text);
        $t->contains('Native AST mapped parity: 54/54 status=normalized-ast-equality-observed-not-runner-parity', $text);
    ...
    'reports checked-in current markdown fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(54, $evidence['nativeExpectationEvidence']['expectedFixtureCount']);
        $t->same(54, $evidence['nativeExpectationEvidence']['fixtureCount']);
        $t->same(54, $evidence['nativeExpectationEvidence']['presentFixtureCount']);
        ...
        $t->same('upstream-markdown-autolink-attributes.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][7]['name']);
        $t->same('cd7de98dd3d21abdc5c0b501f7f0c92eda63f4f102449d58c8d0036ff9886726', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][7]['sha256']);
        $t->same(379, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][7]['bytes']);
        $t->same('upstream-markdown-definition-list-nested-list.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][15]['name']);
        $t->same('c22963e813336f323a81771346bf208a06d7cb1b0863aa6ec7073b80fed459e7', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][15]['sha256']);
        $t->same(110, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][15]['bytes']);
        $t->same('upstream-markdown-definition-list-tight-bodies.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][16]['name']);
        $t->same('79070528c9fff595351668c7a84bdba031bbbfbfe94ca511a58923559172c36b', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][16]['sha256']);
        $t->same(303, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][16]['bytes']);
        $t->same('upstream-markdown-inline-note-citations.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][33]['name']);
        $t->same('04ec5abd9d97dad4c60a9502fcda48ab6d596d22d8773742dfaa787593513ad0', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][33]['sha256']);
        $t->same(1115, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][33]['bytes']);
        $t->same('upstream-markdown-lhs-inverse-bird-html.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][34]['name']);
        $t->same('ded30bb9ec48394e6dd42c95ab504456b4f85ff37c1f1a68076bf603260c25d8', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][34]['sha256']);
        $t->same(129, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][34]['bytes']);
        $t->same('upstream-markdown-strict-compact-heading.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][47]['name']);
        $t->same('dca4b0a1370fb86f4ea2ab8f19d1254313558ae57954679d1b3ca1fbaa2c8044', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][47]['sha256']);
        $t->same(43, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][47]['bytes']);
        $t->same('upstream-markdown-task-list.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][50]['name']);
        $t->same('80ead08088210467f4ce4ab35800a2be9e47b76a5c63fb92c3692ce3b49728df', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][50]['sha256']);
        $t->same(846, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][50]['bytes']);
        $t->same('upstream-markdown-unbalanced-brackets.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][51]['name']);
        $t->same('9179740322c07d3717a32cb023a504dafaf164a6f39e2b1cc2fd1f3d11b7e5d8', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][51]['sha256']);
        $t->same(34, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][51]['bytes']);
        $t->same('upstream-markdown-yaml-metadata.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][52]['name']);
        $t->same('7ef515f951844ff049c5f6a4c98f42094843aa311061f59eb20d2be6bca6d7b2', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][52]['sha256']);
        $t->same(75, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][52]['bytes']);
        $t->same('upstream-markdown-z-commonmark-x-grid-table-default.native', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][53]['name']);
        $t->same('566596459e8d3e3ab0ae5842fecc54764cad72c34c81a104ca9df16451e5143d', $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][53]['sha256']);
        $t->same(389, $evidence['nativeExpectationEvidence']['checkedInNativeFixtures'][53]['bytes']);
        ...
        $t->same('upstream-markdown-yaml-metadata.md', $evidence['checkedInFixtures'][47]['name']);
        $t->same('5f69d57ef44116f63721edde6e0f164d3388f692e0fb9359bdc8ea35261e3376', $evidence['checkedInFixtures'][47]['checkedInFile']['sha256']);
        $t->same(142, $evidence['checkedInFixtures'][47]['checkedInFile']['bytes']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderYamlMetadataFixtureCompletionTest.php', $evidence['checkedInFixtures'][47]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderYamlMetadataFixtureCompletionTest.php', $evidence['checkedInFixtures'][47]['localTestReferences'], true));
        $t->same('upstream-markdown-definition-list-tight-bodies.md', $evidence['checkedInFixtures'][48]['name']);
        $t->same('58eb007d7f3dac48da8c992622e5a29defd68c7a84cdabb29b81ac4e218df924', $evidence['checkedInFixtures'][48]['checkedInFile']['sha256']);
        $t->same(62, $evidence['checkedInFixtures'][48]['checkedInFile']['bytes']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderDefinitionListFixtureCompletionTest.php', $evidence['checkedInFixtures'][48]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderDefinitionListFixtureCompletionTest.php', $evidence['checkedInFixtures'][48]['localTestReferences'], true));
        $t->same('upstream-markdown-lhs-inverse-bird-html.md', $evidence['checkedInFixtures'][49]['name']);
        $t->same('f08f6db28a623c0f60dbe069e68567e38f7ecbf71367f01eebfa52c2d6735ce0', $evidence['checkedInFixtures'][49]['checkedInFile']['sha256']);
        $t->same(16, $evidence['checkedInFixtures'][49]['checkedInFile']['bytes']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderLiterateHaskellFixtureCompletionTest.php', $evidence['checkedInFixtures'][49]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderLiterateHaskellFixtureCompletionTest.php', $evidence['checkedInFixtures'][49]['localTestReferences'], true));
        $t->same('upstream-markdown-alerts.md', $evidence['checkedInFixtures'][50]['name']);
        $t->same('d4f826212c99ace92b25f414db142d565fa7b737ff6c0cbabb4010d5cf1f7b29', $evidence['checkedInFixtures'][50]['checkedInFile']['sha256']);
        $t->same(107, $evidence['checkedInFixtures'][50]['checkedInFile']['bytes']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAlertProfileCompletionTest.php', $evidence['checkedInFixtures'][50]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAlertProfileCompletionTest.php', $evidence['checkedInFixtures'][50]['localTestReferences'], true));
        $t->same('upstream-markdown-strict-compact-heading.md', $evidence['checkedInFixtures'][51]['name']);
        $t->same('7631fb35c6f86b29590e5a339c7c14abc67cb65adc8557efffef6f69485eb0b4', $evidence['checkedInFixtures'][51]['checkedInFile']['sha256']);
        $t->same(4, $evidence['checkedInFixtures'][51]['checkedInFile']['bytes']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderStrictCompactHeadingFixtureCompletionTest.php', $evidence['checkedInFixtures'][51]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderStrictCompactHeadingFixtureCompletionTest.php', $evidence['checkedInFixtures'][51]['localTestReferences'], true));
        $t->same('upstream-markdown-z-commonmark-x-grid-table-default.md', $evidence['checkedInFixtures'][52]['name']);
        $t->same('412a732f5c23e980d34d1be6b014030f06ff723439ba06740804fe1d52a946a1', $evidence['checkedInFixtures'][52]['checkedInFile']['sha256']);
        $t->same(50, $evidence['checkedInFixtures'][52]['checkedInFile']['bytes']);
        $t->same('commonmark_x grid_tables disabled by default, pipe_tables still enabled', $evidence['checkedInFixtures'][52]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderTableProfileSurgeTest.php', $evidence['checkedInFixtures'][52]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderTableProfileSurgeTest.php', $evidence['checkedInFixtures'][52]['localTestReferences'], true));
        $t->same('upstream-markdown-autolink-attributes.md', $evidence['checkedInFixtures'][53]['name']);
        $t->same('1e53b4ffdeab43731a3909f53ffd8d4f44d2560d5355b7e490ef2f19376c2052', $evidence['checkedInFixtures'][53]['checkedInFile']['sha256']);
        $t->same(64, $evidence['checkedInFixtures'][53]['checkedInFile']['bytes']);
        $t->same('markdown angle autolink raw_attribute boundary', $evidence['checkedInFixtures'][53]['formatProfile']);
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAutolinkAttributeFixtureCompletionTest.php', $evidence['checkedInFixtures'][53]['coverageTests'], true));
        $t->true(in_array('lanes/pandoc/tests/MarkdownReaderAutolinkAttributeFixtureCompletionTest.php', $evidence['checkedInFixtures'][53]['localTestReferences'], true));
        ...
        $t->true(in_array('the fifty-four selected checked-in Markdown native expectation snapshots match the expected deterministic manifest hash', $evidence['claimBoundaries']['doesAssert'], true));
    ...
    'cli gates checked-in current markdown fixture evidence through checked-in fixtures mode' => static function (TestRunner $t): void {
        ...
        $failingNativeCommand = str_replace('--require-native-mapped-parity=54', '--require-native-mapped-parity=55', $command) . ' 2>/dev/null';
        $failingNativeOutput = [];
