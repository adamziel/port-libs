...
return [
    'summarizes iframe credentialless and csp policy provenance for reviewer handoff' => static function (TestRunner $t): void {
        ...
        $t->same('iframe-credentialless-storage-isolation-review', $isolated['iframeCredentiallessReviewPolicy']);
        ...
        $t->same('iframe-content-security-policy-attribute-review', $isolated['contentSecurityPolicyReviewPolicy']);
        $t->same('iframe-content-security-policy-attribute-review', $isolated['iframeCspReviewPolicy']);
        ...
        $t->same(['noncanonical-iframe-credentialless-boolean-value'], $noncanonical['iframeCredentiallessIssueCodes']);
        ...
        $t->same([
            'noncanonical-iframe-credentialless-boolean-value',
        ...
        $t->same(['missing-iframe-csp-content'], $empty['cspIssueCodes']);
