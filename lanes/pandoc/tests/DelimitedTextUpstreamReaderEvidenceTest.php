...
$writeDelimitedTextEvidenceTree = static function (string $upstreamRoot, string $repoRoot) use ($writeFile): void {
    ...
    $writeFile(
        $upstreamRoot,
        'test/command/8661.md',
        (string) file_get_contents($repoRoot . '/lanes/pandoc/fixtures/upstream-current-tsv-reader/8661.md')
    );
...
return [
    'reports skipped delimited text reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->contains(
            'Generated TSV native parity: '
                . DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT
                . '/'
                . DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT
                . ' status=generated-tsv-native-parity-observed-not-upstream-fixture',
            $text
        );
    ...
    'reports checked-in current csv command fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $evidence['readerDenominator']['tsvDirectFixtureCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_CURRENT_TSV_DIRECT_NATIVE_PAIR_COUNT, $evidence['readerDenominator']['currentTsvDirectNativePairCount']);
        ...
        $t->same([
            'test/command/8661.md',
        ], $evidence['readerDenominator']['tsvDirectFixtures']);
        $t->same([
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $evidence['checkedInTsvFixtureCount']);
        $t->same('8661.md', $evidence['checkedInTsvFixtures'][0]['name']);
        $t->same('test/command/8661.md', $evidence['checkedInTsvFixtures'][0]['upstreamPath']);
        $t->same('86ceedf9c34dff9b22b36220a7712a0fcd7d831f2f5d740eb44dce1d10ab8f72', $evidence['checkedInTsvFixtures'][0]['checkedInFile']['sha256']);
        $t->same(104, $evidence['checkedInTsvFixtures'][0]['checkedInFile']['bytes']);
        ...
        $t->same('literal-backslashes.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][88]['name']);
        $t->same('426d024bd9c67b127cedc72003f90a55b54e41cbe20961a05b23845a1e3f1f22', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][88]['checkedInFile']['sha256']);
        $t->same(92, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][88]['checkedInFile']['bytes']);
        $t->same('literal-backslashes.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][89]['name']);
        $t->same('408fedf50b4502884be9b0f8b1fa9e44c183e769ffc7f9f906a5ef466bdb4dc6', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][89]['checkedInFile']['sha256']);
        ...
        $t->same('interior-empty-header.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][92]['name']);
        $t->same('95252bfc868a3c78b6ba0690c43b6627228f3139242197d9bc9fa05eca0465cc', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][92]['checkedInFile']['sha256']);
        $t->same(41, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][92]['checkedInFile']['bytes']);
        $t->same('interior-empty-header.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][93]['name']);
        $t->same('b9a001598d1b933ad675d41970f1c8c25f7212a48ccadb846045fea433a4bb93', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][93]['checkedInFile']['sha256']);
        $t->same(2447, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][93]['checkedInFile']['bytes']);
        $t->same('interior-empty-header', $evidence['generatedCsvNativeStaticEvidence']['samples'][46]['name']);
        $t->same([], $evidence['generatedCsvNativeStaticEvidence']['samples'][46]['readerOptions']);
        $t->same('header-width-truncates-extra-fields.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][94]['name']);
        $t->same('d816429cc1d19aefb09df7dabad0470d59ffb0164db8c56122f3306571735a49', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][94]['checkedInFile']['sha256']);
        $t->same(12, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][94]['checkedInFile']['bytes']);
        $t->same('header-width-truncates-extra-fields.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][95]['name']);
        $t->same('365fea12f7cbf4904d4e15db99b416c4555a997646a8cd90ec693c33c076bb4e', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][95]['checkedInFile']['sha256']);
        $t->same(1447, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][95]['checkedInFile']['bytes']);
        $t->same('header-width-truncates-extra-fields', $evidence['generatedCsvNativeStaticEvidence']['samples'][47]['name']);
        $t->same([], $evidence['generatedCsvNativeStaticEvidence']['samples'][47]['readerOptions']);
        $t->same('quoted-edge-spaces.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][96]['name']);
        $t->same('abc9c092cd5343f3609e738a60ced32cc878e6aa6c20518e4218bce5de67e6d2', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][96]['checkedInFile']['sha256']);
        $t->same(79, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][96]['checkedInFile']['bytes']);
        $t->same('quoted-edge-spaces.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][97]['name']);
        $t->same('186662f425cf75dee71c2aaa88f204249922cf5a0fadb3020d4501dff983c052', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][97]['checkedInFile']['sha256']);
        $t->same(1588, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][97]['checkedInFile']['bytes']);
        $t->same('quoted-edge-spaces', $evidence['generatedCsvNativeStaticEvidence']['samples'][48]['name']);
        $t->same([], $evidence['generatedCsvNativeStaticEvidence']['samples'][48]['readerOptions']);
        $t->same('quoted-multiline-header.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][98]['name']);
        $t->same('6d34714c83cfeb46420fa58ad0cd2b53115a3ec267c19fa16abfd70c5f510941', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][98]['checkedInFile']['sha256']);
        $t->same(35, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][98]['checkedInFile']['bytes']);
        $t->same('quoted-multiline-header.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][99]['name']);
        $t->same('7261b85400dd1114d0de4629767fffe214637e59a8cf6df17f8c4ec5a76ce9bd', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][99]['checkedInFile']['sha256']);
        $t->same(1571, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][99]['checkedInFile']['bytes']);
        $t->same('quoted-multiline-header', $evidence['generatedCsvNativeStaticEvidence']['samples'][49]['name']);
        $t->same([], $evidence['generatedCsvNativeStaticEvidence']['samples'][49]['readerOptions']);
        $t->same('quoted-crlf-linebreak.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][106]['name']);
        $t->same('3f2469c5b1f5e4b354f235434cd2bed54061b6b2a285447ad29f6fb41b60a1ac', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][106]['checkedInFile']['sha256']);
        $t->same(51, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][106]['checkedInFile']['bytes']);
        $t->same('quoted-crlf-linebreak.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][107]['name']);
        $t->same('3956114302f624d1849536a2d452f85b0ce684fb25319e13db3708f41903e71d', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][107]['checkedInFile']['sha256']);
        $t->same(2135, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][107]['checkedInFile']['bytes']);
        $t->same('quoted-crlf-linebreak', $evidence['generatedCsvNativeStaticEvidence']['samples'][53]['name']);
        $t->same([], $evidence['generatedCsvNativeStaticEvidence']['samples'][53]['readerOptions']);
        $t->same('quoted-bare-cr-normalized.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][108]['name']);
        $t->same('a0ffe7593af38cbd60c634f672daafb274bc05c2995859c6eea4fa5b1e096a5f', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][108]['checkedInFile']['sha256']);
        $t->same(43, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][108]['checkedInFile']['bytes']);
        $t->same('quoted-bare-cr-normalized.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][109]['name']);
        $t->same('9b868b8f3d50b07608e490a0eee15529c6e476e58d0397f5cc236eaf927bf853', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][109]['checkedInFile']['sha256']);
        ...
        $t->same('delimiter-only-row.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][112]['name']);
        $t->same('9ea069dba8355db9b07e013bb2e27ae2293301cff67e96e40d4c6d9bc96fac1d', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][112]['checkedInFile']['sha256']);
        $t->same(43, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][112]['checkedInFile']['bytes']);
        $t->same('delimiter-only-row.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][113]['name']);
        $t->same('20e6be4a619b1e8f9961f222470fef988fe9664f56a9ce8ed691518e9f8c422a', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][113]['checkedInFile']['sha256']);
        ...
        $t->same('quoted-softbreak.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][116]['name']);
        $t->same('933f3c6150a9ebc91c5f7e20ed759cd4db485b60c09ad15acef99556db359fea', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][116]['checkedInFile']['sha256']);
        $t->same(56, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][116]['checkedInFile']['bytes']);
        $t->same('quoted-softbreak.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][117]['name']);
        $t->same('499dc8c7d9b0988ed79afc0ec6d533f0a749cdec8b3537cc8c4390d4f5b467a6', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][117]['checkedInFile']['sha256']);
        $t->same(1257, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][117]['checkedInFile']['bytes']);
        $t->same('quoted-softbreak', $evidence['generatedCsvNativeStaticEvidence']['samples'][58]['name']);
        $t->same(['cellLineBreak' => 'softbreak'], $evidence['generatedCsvNativeStaticEvidence']['samples'][58]['readerOptions']);
        $t->same('bang-escaped-csv-options.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][118]['name']);
        $t->same('519f8bd0e8185f2e01ee037c1c0ad7f4ce6d1ee6ca2167788bbdd9eafe84a0bc', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][118]['checkedInFile']['sha256']);
        $t->same(93, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][118]['checkedInFile']['bytes']);
        $t->same('bang-escaped-csv-options.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][119]['name']);
        $t->same('b83612bbf806265ad8219105375347e30721ffd1d93ae18b789f357ac99dc429', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][119]['checkedInFile']['sha256']);
        ...
        $t->same('keep-space-before-quote.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][122]['name']);
        $t->same('752a2af5360dfe6d457b209d72923b22d339ac44942f8c74850aff22beabb389', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][122]['checkedInFile']['sha256']);
        $t->same(59, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][122]['checkedInFile']['bytes']);
        $t->same('keep-space-before-quote.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][123]['name']);
        $t->same('f528d527b80b33f7e71db1355373d00ac3de4c509312fecd0cf688468d46c033', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][123]['checkedInFile']['sha256']);
        $t->same(1277, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][123]['checkedInFile']['bytes']);
        $t->same('keep-space-before-quote', $evidence['generatedCsvNativeStaticEvidence']['samples'][61]['name']);
        $t->same(['keepSpace' => true], $evidence['generatedCsvNativeStaticEvidence']['samples'][61]['readerOptions']);
        $t->same('quoted-trailing-empty-field.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][124]['name']);
        $t->same('23521624c9a238993d14490b3f282bdc0f2c1590a1376371924df9a254cdc5ba', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][124]['checkedInFile']['sha256']);
        $t->same(81, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][124]['checkedInFile']['bytes']);
        $t->same('quoted-trailing-empty-field.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][125]['name']);
        $t->same('48df01be83b5a077c286db9614763182fbaba277dbc184474a0d1e1d21dbb6e9', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][125]['checkedInFile']['sha256']);
        $t->same(1867, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][125]['checkedInFile']['bytes']);
        $t->same('quoted-trailing-empty-field', $evidence['generatedCsvNativeStaticEvidence']['samples'][62]['name']);
        $t->same([], $evidence['generatedCsvNativeStaticEvidence']['samples'][62]['readerOptions']);
        $t->same('quoted-unicode-doubled-quotes.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][126]['name']);
        $t->same('b1848c5b9322e05db0b79fc3079f973f485c1aef8d4a8797623ba67a71c63623', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][126]['checkedInFile']['sha256']);
        $t->same(127, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][126]['checkedInFile']['bytes']);
        $t->same('quoted-unicode-doubled-quotes.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][127]['name']);
        $t->same('497470323a734ce0b6344c5d0d5f8bb01a197c5fd6fdfd466d08957613649b42', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][127]['checkedInFile']['sha256']);
        $t->same(2773, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][127]['checkedInFile']['bytes']);
        $t->same('quoted-unicode-doubled-quotes', $evidence['generatedCsvNativeStaticEvidence']['samples'][63]['name']);
        $t->same([], $evidence['generatedCsvNativeStaticEvidence']['samples'][63]['readerOptions']);
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $evidence['generatedTsvNativeStaticEvidence']['tsvDirectFixtureDenominator']);
        ...
        $t->same('quoted-softbreak.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][60]['name']);
        $t->same('01d5ec9046ee9de78dbc8fdd589b7250fa5925a3d9077d3ff7c941cb1c2c97a1', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][60]['checkedInFile']['sha256']);
        $t->same(54, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][60]['checkedInFile']['bytes']);
        $t->same('quoted-softbreak.native', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][61]['name']);
        $t->same('db9489756eeaacaeb268e403036dddbf10fb9dc35872123331ff01ca1594a810', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][61]['checkedInFile']['sha256']);
        $t->same(1255, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][61]['checkedInFile']['bytes']);
        $t->same('post-delimiter-space.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][62]['name']);
        $t->same('e5367f8cd34b279f8f8fc0c5ec78ee042509bc00647c69ee698092d463374496', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][62]['checkedInFile']['sha256']);
        $t->same(22, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][62]['checkedInFile']['bytes']);
        $t->same('post-delimiter-space.native', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][63]['name']);
        $t->same('45407755e5d9da0a6d4656f255a9cf0f5b20f924116e4143b964577b56464b10', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][63]['checkedInFile']['sha256']);
        $t->same(1152, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][63]['checkedInFile']['bytes']);
        $t->same('delimiter-only-row.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][64]['name']);
        $t->same('3a6565c55c9edf509918a14410b2303017c4ba50cd6756d81c82f5b3c18e9a49', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][64]['checkedInFile']['sha256']);
        $t->same(33, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][64]['checkedInFile']['bytes']);
        ...
        $t->same('pipe-delimiter-quoted-field.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][70]['name']);
        $t->same('68ff56d2b21faa5fff4bb21e434af9e9436fb4fb8cc049b0555a1de1441b75b1', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][70]['checkedInFile']['sha256']);
        $t->same(95, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][70]['checkedInFile']['bytes']);
        $t->same('pipe-delimiter-quoted-field.native', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][71]['name']);
        $t->same('fe8cce799250bddd6e4c6b8459b393afc5fed657be5e9875705afd53d21c58c6', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][71]['checkedInFile']['sha256']);
        $t->same(1600, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][71]['checkedInFile']['bytes']);
        $t->same('cr-only-rows.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][72]['name']);
        $t->same('8deecde76e437a9a5d3f14ad235ba87a61f220e4098a109d8bf6f5907a90e8d9', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][72]['checkedInFile']['sha256']);
        $t->same(41, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][72]['checkedInFile']['bytes']);
        $t->same('cr-only-rows.native', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][73]['name']);
        $t->same('38ce86f6c3c6861529f67360319de7ea26d17dfe9a6d5129e2625b0b9768c32d', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][73]['checkedInFile']['sha256']);
        $t->same(1126, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][73]['checkedInFile']['bytes']);
        ...
        $t->same('formula-looking-literals.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][74]['name']);
        $t->same('4d7c559919b0d5ae6fb444f02400addda086cd7d2e0a2db7d1f135049962a5e3', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][74]['checkedInFile']['sha256']);
        $t->same(81, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][74]['checkedInFile']['bytes']);
        $t->same('formula-looking-literals.native', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][75]['name']);
        $t->same('cd5252c5c890122ababd2e5566f4ae9a02fcf1d23d6c718c6bf77cb72e42ffa5', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][75]['checkedInFile']['sha256']);
        $t->same(2185, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][75]['checkedInFile']['bytes']);
        $t->same('formula-looking-literals', $evidence['generatedTsvNativeStaticEvidence']['samples'][37]['name']);
        $t->same([], $evidence['generatedTsvNativeStaticEvidence']['samples'][37]['readerOptions']);
        $t->same('header-width-truncates-extra-fields.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][76]['name']);
        $t->same('ccb349be3f4f2f8e75e4b34ca3c93fc267bb7722f5f9500ad9bc8ed4675750fe', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][76]['checkedInFile']['sha256']);
        $t->same(12, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][76]['checkedInFile']['bytes']);
        $t->same('header-width-truncates-extra-fields.native', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][77]['name']);
        $t->same('365fea12f7cbf4904d4e15db99b416c4555a997646a8cd90ec693c33c076bb4e', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][77]['checkedInFile']['sha256']);
        $t->same(1447, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][77]['checkedInFile']['bytes']);
        $t->same('header-width-truncates-extra-fields', $evidence['generatedTsvNativeStaticEvidence']['samples'][38]['name']);
        $t->same([], $evidence['generatedTsvNativeStaticEvidence']['samples'][38]['readerOptions']);
        $t->same('numeric-looking-literals.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][78]['name']);
        $t->same('e325f72f9fcf4ef9d835392ec483f86e7b6938fb85fe5425aecfe4163e7e4f16', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][78]['checkedInFile']['sha256']);
        $t->same(85, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][78]['checkedInFile']['bytes']);
        $t->same('numeric-looking-literals.native', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][79]['name']);
        $t->same('d0b13fbe3429d44deb210a7c1f5f3f6723efae3110b837a2542692ffc48c94ae', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][79]['checkedInFile']['sha256']);
        $t->same(3265, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][79]['checkedInFile']['bytes']);
        $t->same('numeric-looking-literals', $evidence['generatedTsvNativeStaticEvidence']['samples'][39]['name']);
        $t->same([], $evidence['generatedTsvNativeStaticEvidence']['samples'][39]['readerOptions']);
        $t->same('literal-quote-space-boundaries.tsv', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][82]['name']);
        $t->same('435768f05720cc81f3bcca83538fa8d21cb3ac6d8f5b1db46301a5233e00e4c7', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][82]['checkedInFile']['sha256']);
        $t->same(121, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][82]['checkedInFile']['bytes']);
        $t->same('literal-quote-space-boundaries.native', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][83]['name']);
        $t->same('9ca78daf730e41c6ee96496bbf856d1f3dd95e486da8afef939551e756d1ded7', $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][83]['checkedInFile']['sha256']);
        $t->same(3345, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtures'][83]['checkedInFile']['bytes']);
        $t->same('literal-quote-space-boundaries', $evidence['generatedTsvNativeStaticEvidence']['samples'][41]['name']);
        $t->same([], $evidence['generatedTsvNativeStaticEvidence']['samples'][41]['readerOptions']);
        $t->same('quoted-final-space-whitespace.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][130]['name']);
        $t->same('d30d086405286d4569dcaac5f727e57861b98319788c5b950f1ee2f42d6c6507', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][130]['checkedInFile']['sha256']);
        $t->same(17, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][130]['checkedInFile']['bytes']);
        $t->same('quoted-final-space-whitespace.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][131]['name']);
        $t->same('e1aeed0b50260073654fdc92ec94b201f5d9678112837250f7f36d47692504e6', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][131]['checkedInFile']['sha256']);
        $t->same(1128, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][131]['checkedInFile']['bytes']);
        $t->same('quoted-final-space-whitespace', $evidence['generatedCsvNativeStaticEvidence']['samples'][65]['name']);
        $t->same([], $evidence['generatedCsvNativeStaticEvidence']['samples'][65]['readerOptions']);
        $t->same('quoted-doubled-linebreak-ragged.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][132]['name']);
        $t->same('34a72fa6c201f47bb4c5b41ee9d48a3052ae54d817a58cf28b5a0509486931e4', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][132]['checkedInFile']['sha256']);
        $t->same(88, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][132]['checkedInFile']['bytes']);
        $t->same('quoted-doubled-linebreak-ragged.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][133]['name']);
        $t->same('4515da292e71e03feb07e21c19d7d7a9966086ef0ce1bd0f8888e2041a87d04e', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][133]['checkedInFile']['sha256']);
        ...
        $t->same('backslash-escaped-escape.csv', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][136]['name']);
        $t->same('c329e8a7695787738350288ab268d4f56824923a6c47fc0746d59235dee37e13', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][136]['checkedInFile']['sha256']);
        $t->same(46, $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][136]['checkedInFile']['bytes']);
        $t->same('backslash-escaped-escape.native', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][137]['name']);
        $t->same('70c73e8c5d2241f187f718ee94420980edfd7c955bc06076c0166ead19ffd6e0', $evidence['generatedCsvNativeStaticEvidence']['checkedInFixtures'][137]['checkedInFile']['sha256']);
        ...
        $t->same('current-csv-direct-native-transcripts', $evidence['currentCsvDirectNativeStaticEvidence']['evidenceKind']);
        $t->same('csv', $evidence['currentCsvDirectNativeStaticEvidence']['reader']);
        $t->same(3, $evidence['currentCsvDirectNativeStaticEvidence']['csvDirectFixtureDenominator']);
        $t->same(2, $evidence['currentCsvDirectNativeStaticEvidence']['currentCsvDirectNativePairCount']);
        $t->same(2, $evidence['currentCsvDirectNativeStaticEvidence']['sampleCount']);
        $t->same(2, $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtureCount']);
        $t->same('csv-command-table', $evidence['currentCsvDirectNativeStaticEvidence']['samples'][0]['name']);
        $t->same('csv.md', $evidence['currentCsvDirectNativeStaticEvidence']['samples'][0]['fixtureName']);
        $t->same('lanes/pandoc/fixtures/upstream-current-csv-reader/csv.md', $evidence['currentCsvDirectNativeStaticEvidence']['samples'][0]['transcriptPath']);
        $t->same('csv-command-multiline-cell', $evidence['currentCsvDirectNativeStaticEvidence']['samples'][1]['name']);
        $t->same('9797.md', $evidence['currentCsvDirectNativeStaticEvidence']['samples'][1]['fixtureName']);
        $t->same('lanes/pandoc/fixtures/upstream-current-csv-reader/9797.md', $evidence['currentCsvDirectNativeStaticEvidence']['samples'][1]['transcriptPath']);
        $t->same('csv.md', $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtures'][0]['name']);
        $t->same('valid-current-csv-direct-native-transcript', $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtures'][0]['transcriptStatus']);
        $t->same('42a8bc56612d061388889a10d73b1d34fb870595785ee550ef43c6a065a77ad6', $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtures'][0]['checkedInFile']['sha256']);
        $t->same(2719, $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtures'][0]['checkedInFile']['bytes']);
        $t->same('9797.md', $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtures'][1]['name']);
        $t->same('valid-current-csv-direct-native-transcript', $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtures'][1]['transcriptStatus']);
        $t->same('5ef0f665c3f0f8eb0982c269d86cdaf9e8f0be4130bf767e2cb871a9102c6c40', $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtures'][1]['checkedInFile']['sha256']);
        $t->same(857, $evidence['currentCsvDirectNativeStaticEvidence']['checkedInFixtures'][1]['checkedInFile']['bytes']);
        $t->same(true, DelimitedTextUpstreamReaderEvidence::hasRequiredCurrentCsvDirectNativeStaticEvidence($evidence['currentCsvDirectNativeStaticEvidence']));
        $t->same('static-checked-in-current-tsv-direct-native-fixture-evidence', $evidence['currentTsvDirectNativeStaticEvidence']['kind']);
    ...
    'executes generated csv native parity evidence' => static function (TestRunner $t): void {
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $evidence['generatedNativeMatchCount']);
        $t->same(0, $evidence['generatedNativeMismatchCount']);
        $t->same(100.0, $evidence['generatedNativeMatchPercent']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $evidence['staticFixtureBindingValidCount']);
        $t->same(0, $evidence['staticFixtureBindingInvalidCount']);
        $t->same(array_fill(0, DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, 'valid-generated-csv-native-sample-static-binding'), array_column($evidence['samples'], 'staticFixtureBindingStatus'));
        ...
        $newest = $evidence['samples'][66];
        $t->same('matched', $newest['status']);
        $t->same('quoted-doubled-linebreak-ragged', $newest['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-doubled-linebreak-ragged.csv', $newest['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-doubled-linebreak-ragged.csv'], $newest['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $newest['staticFixtureBinding']['kind']);
        $t->same('quoted-doubled-linebreak-ragged', $newest['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $newest['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $newest['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-doubled-linebreak-ragged.csv', $newest['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-doubled-linebreak-ragged.native', $newest['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(4, $newest['rowCount']);
        $t->same(3, $newest['columnCount']);
        $escapedEscape = $evidence['samples'][68];
        $t->same('matched', $escapedEscape['status']);
        $t->same('backslash-escaped-escape', $escapedEscape['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/backslash-escaped-escape.csv', $escapedEscape['inputPath']);
        $t->same(['escape' => '\\', 'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/backslash-escaped-escape.csv'], $escapedEscape['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $escapedEscape['staticFixtureBinding']['kind']);
        $t->same('backslash-escaped-escape', $escapedEscape['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $escapedEscape['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $escapedEscape['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/backslash-escaped-escape.csv', $escapedEscape['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/backslash-escaped-escape.native', $escapedEscape['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(3, $escapedEscape['rowCount']);
        $t->same(2, $escapedEscape['columnCount']);
        ...
        $t->same('matched', $evidence['samples'][44]['status']);
        $t->same('literal-backslashes', $evidence['samples'][44]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/literal-backslashes.csv', $evidence['samples'][44]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/literal-backslashes.csv'], $evidence['samples'][44]['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $evidence['samples'][44]['staticFixtureBinding']['kind']);
        $t->same('literal-backslashes', $evidence['samples'][44]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][44]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][44]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/literal-backslashes.csv', $evidence['samples'][44]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/literal-backslashes.native', $evidence['samples'][44]['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(3, $evidence['samples'][44]['rowCount']);
        $t->same(3, $evidence['samples'][44]['columnCount']);
        $t->same('matched', $evidence['samples'][49]['status']);
        $t->same('quoted-multiline-header', $evidence['samples'][49]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-multiline-header.csv', $evidence['samples'][49]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-multiline-header.csv'], $evidence['samples'][49]['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $evidence['samples'][49]['staticFixtureBinding']['kind']);
        $t->same('quoted-multiline-header', $evidence['samples'][49]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][49]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][49]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-multiline-header.csv', $evidence['samples'][49]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        ...
        $t->same('matched', $evidence['samples'][53]['status']);
        $t->same('quoted-crlf-linebreak', $evidence['samples'][53]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-crlf-linebreak.csv', $evidence['samples'][53]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-crlf-linebreak.csv'], $evidence['samples'][53]['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $evidence['samples'][53]['staticFixtureBinding']['kind']);
        $t->same('quoted-crlf-linebreak', $evidence['samples'][53]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][53]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][53]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-crlf-linebreak.csv', $evidence['samples'][53]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-crlf-linebreak.native', $evidence['samples'][53]['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(3, $evidence['samples'][53]['rowCount']);
        $t->same(3, $evidence['samples'][53]['columnCount']);
        $t->same('matched', $evidence['samples'][54]['status']);
        $t->same('quoted-bare-cr-normalized', $evidence['samples'][54]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-bare-cr-normalized.csv', $evidence['samples'][54]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-bare-cr-normalized.csv'], $evidence['samples'][54]['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $evidence['samples'][54]['staticFixtureBinding']['kind']);
        $t->same('quoted-bare-cr-normalized', $evidence['samples'][54]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][54]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][54]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-bare-cr-normalized.csv', $evidence['samples'][54]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        ...
        $t->same('matched', $evidence['samples'][62]['status']);
        $t->same('quoted-trailing-empty-field', $evidence['samples'][62]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-trailing-empty-field.csv', $evidence['samples'][62]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-trailing-empty-field.csv'], $evidence['samples'][62]['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $evidence['samples'][62]['staticFixtureBinding']['kind']);
        $t->same('quoted-trailing-empty-field', $evidence['samples'][62]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][62]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][62]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-trailing-empty-field.csv', $evidence['samples'][62]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-trailing-empty-field.native', $evidence['samples'][62]['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(4, $evidence['samples'][62]['rowCount']);
        $t->same(4, $evidence['samples'][62]['columnCount']);
        $t->same('matched', $evidence['samples'][63]['status']);
        $t->same('quoted-unicode-doubled-quotes', $evidence['samples'][63]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-unicode-doubled-quotes.csv', $evidence['samples'][63]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-unicode-doubled-quotes.csv'], $evidence['samples'][63]['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $evidence['samples'][63]['staticFixtureBinding']['kind']);
        $t->same('quoted-unicode-doubled-quotes', $evidence['samples'][63]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][63]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][63]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-unicode-doubled-quotes.csv', $evidence['samples'][63]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-unicode-doubled-quotes.native', $evidence['samples'][63]['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(3, $evidence['samples'][63]['rowCount']);
        $t->same(3, $evidence['samples'][63]['columnCount']);
        $t->same('matched', $evidence['samples'][65]['status']);
        $t->same('quoted-final-space-whitespace', $evidence['samples'][65]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-final-space-whitespace.csv', $evidence['samples'][65]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-final-space-whitespace.csv'], $evidence['samples'][65]['readerOptions']);
        $t->same('generated-csv-native-sample-static-fixture-binding', $evidence['samples'][65]['staticFixtureBinding']['kind']);
        $t->same('quoted-final-space-whitespace', $evidence['samples'][65]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][65]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][65]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-csv-reader/quoted-final-space-whitespace.csv', $evidence['samples'][65]['staticFixtureBinding']['inputFixture']['checkedInPath']);
    ...
    'executes generated tsv native parity evidence' => static function (TestRunner $t): void {
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $evidence['sampleCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $evidence['comparedSampleCount']);
        $t->same(0, $evidence['parseFailureCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $evidence['generatedNativeMatchCount']);
        $t->same(0, $evidence['generatedNativeMismatchCount']);
        $t->same(100.0, $evidence['generatedNativeMatchPercent']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $evidence['staticFixtureBindingValidCount']);
        $t->same(0, $evidence['staticFixtureBindingInvalidCount']);
        $t->same(array_fill(0, DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, 'valid-generated-tsv-native-sample-static-binding'), array_column($evidence['samples'], 'staticFixtureBindingStatus'));
        ...
        $t->same(3, $evidence['samples'][3]['columnCount']);
        $t->same('matched', $evidence['samples'][37]['status']);
        $t->same('formula-looking-literals', $evidence['samples'][37]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/formula-looking-literals.tsv', $evidence['samples'][37]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/formula-looking-literals.tsv'], $evidence['samples'][37]['readerOptions']);
        $t->same('generated-tsv-native-sample-static-fixture-binding', $evidence['samples'][37]['staticFixtureBinding']['kind']);
        $t->same('formula-looking-literals', $evidence['samples'][37]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][37]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][37]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/formula-looking-literals.tsv', $evidence['samples'][37]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/formula-looking-literals.native', $evidence['samples'][37]['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(3, $evidence['samples'][37]['rowCount']);
        $t->same(3, $evidence['samples'][37]['columnCount']);
        $t->same('matched', $evidence['samples'][38]['status']);
        $t->same('header-width-truncates-extra-fields', $evidence['samples'][38]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/header-width-truncates-extra-fields.tsv', $evidence['samples'][38]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/header-width-truncates-extra-fields.tsv'], $evidence['samples'][38]['readerOptions']);
        $t->same('generated-tsv-native-sample-static-fixture-binding', $evidence['samples'][38]['staticFixtureBinding']['kind']);
        $t->same('header-width-truncates-extra-fields', $evidence['samples'][38]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][38]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][38]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/header-width-truncates-extra-fields.tsv', $evidence['samples'][38]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/header-width-truncates-extra-fields.native', $evidence['samples'][38]['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(3, $evidence['samples'][38]['rowCount']);
        $t->same(2, $evidence['samples'][38]['columnCount']);
        $t->same('matched', $evidence['samples'][39]['status']);
        $t->same('numeric-looking-literals', $evidence['samples'][39]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/numeric-looking-literals.tsv', $evidence['samples'][39]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/numeric-looking-literals.tsv'], $evidence['samples'][39]['readerOptions']);
        $t->same('generated-tsv-native-sample-static-fixture-binding', $evidence['samples'][39]['staticFixtureBinding']['kind']);
        $t->same('numeric-looking-literals', $evidence['samples'][39]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][39]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][39]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/numeric-looking-literals.tsv', $evidence['samples'][39]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/numeric-looking-literals.native', $evidence['samples'][39]['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(3, $evidence['samples'][39]['rowCount']);
        $t->same(5, $evidence['samples'][39]['columnCount']);
        $t->same('matched', $evidence['samples'][41]['status']);
        $t->same('literal-quote-space-boundaries', $evidence['samples'][41]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/literal-quote-space-boundaries.tsv', $evidence['samples'][41]['inputPath']);
        $t->same(['sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/literal-quote-space-boundaries.tsv'], $evidence['samples'][41]['readerOptions']);
        $t->same('generated-tsv-native-sample-static-fixture-binding', $evidence['samples'][41]['staticFixtureBinding']['kind']);
        $t->same('literal-quote-space-boundaries', $evidence['samples'][41]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][41]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][41]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/literal-quote-space-boundaries.tsv', $evidence['samples'][41]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/literal-quote-space-boundaries.native', $evidence['samples'][41]['staticFixtureBinding']['expectedNativeFixture']['checkedInPath']);
        $t->same(4, $evidence['samples'][41]['rowCount']);
        $t->same(3, $evidence['samples'][41]['columnCount']);
        $t->same('matched', $evidence['samples'][4]['status']);
        ...
        $t->same('matched', $evidence['samples'][30]['status']);
        $t->same('quoted-softbreak', $evidence['samples'][30]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/quoted-softbreak.tsv', $evidence['samples'][30]['inputPath']);
        $t->same([
            'quote' => '"',
            'cellLineBreak' => 'softbreak',
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/quoted-softbreak.tsv',
        ], $evidence['samples'][30]['readerOptions']);
        $t->same('generated-tsv-native-sample-static-fixture-binding', $evidence['samples'][30]['staticFixtureBinding']['kind']);
        $t->same('quoted-softbreak', $evidence['samples'][30]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][30]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][30]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/quoted-softbreak.tsv', $evidence['samples'][30]['staticFixtureBinding']['inputFixture']['checkedInPath']);
        ...
        $t->same('matched', $evidence['samples'][35]['status']);
        $t->same('pipe-delimiter-quoted-field', $evidence['samples'][35]['name']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/pipe-delimiter-quoted-field.tsv', $evidence['samples'][35]['inputPath']);
        $t->same([
            'delimiter' => 'pipe',
            'quote' => '"',
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/pipe-delimiter-quoted-field.tsv',
        ], $evidence['samples'][35]['readerOptions']);
        $t->same('generated-tsv-native-sample-static-fixture-binding', $evidence['samples'][35]['staticFixtureBinding']['kind']);
        $t->same('pipe-delimiter-quoted-field', $evidence['samples'][35]['staticFixtureBinding']['sample']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][35]['staticFixtureBinding']['inputFixture']['status']);
        $t->same('valid-static-fixture-snapshot', $evidence['samples'][35]['staticFixtureBinding']['expectedNativeFixture']['status']);
        $t->same('lanes/pandoc/fixtures/generated-current-tsv-reader/pipe-delimiter-quoted-field.tsv', $evidence['samples'][35]['staticFixtureBinding']['inputFixture']['checkedInPath']);
    ...
    'executes current csv direct native parity evidence' => static function (TestRunner $t): void {
        $repoRoot = dirname(__DIR__, 3);
        $evidence = DelimitedTextUpstreamReaderEvidence::currentCsvDirectNativeParityEvidence($repoRoot);

        $t->same('current-csv-direct-native-parity-evidence', $evidence['kind']);
        $t->same('current-csv-direct-native-parity', $evidence['evidenceKind']);
        $t->same('completed-current-csv-direct-native-parity-evidence', $evidence['status']);
        $t->same('csv', $evidence['reader']);
        $t->same(3, $evidence['csvDirectFixtureDenominator']);
        $t->same(2, $evidence['currentCsvDirectNativePairCount']);
        $t->same(2, $evidence['sampleCount']);
        $t->same(2, $evidence['comparedSampleCount']);
        $t->same(0, $evidence['parseFailureCount']);
        $t->same(2, $evidence['currentCsvDirectNativeMatchCount']);
        $t->same(0, $evidence['currentCsvDirectNativeMismatchCount']);
        $t->same(100.0, $evidence['currentCsvDirectNativeMatchPercent']);
        $t->same('current-csv-direct-native-parity-observed', $evidence['parityStatus']);
        $t->same('matched', $evidence['samples'][0]['status']);
        $t->same('csv-command-table', $evidence['samples'][0]['name']);
        $t->same('csv.md', $evidence['samples'][0]['fixtureName']);
        $t->same('lanes/pandoc/fixtures/upstream-current-csv-reader/csv.md', $evidence['samples'][0]['transcriptPath']);
        $t->same('test/command/csv.md', $evidence['samples'][0]['upstreamPath']);
        $t->same('% pandoc -f csv -t native', $evidence['samples'][0]['command']);
        $t->same('csv', $evidence['samples'][0]['reader']);
        $t->same(4, $evidence['samples'][0]['rowCount']);
        $t->same(3, $evidence['samples'][0]['columnCount']);
        $t->same('matched', $evidence['samples'][1]['status']);
        $t->same('csv-command-multiline-cell', $evidence['samples'][1]['name']);
        $t->same('9797.md', $evidence['samples'][1]['fixtureName']);
        $t->same('lanes/pandoc/fixtures/upstream-current-csv-reader/9797.md', $evidence['samples'][1]['transcriptPath']);
        $t->same('test/command/9797.md', $evidence['samples'][1]['upstreamPath']);
        $t->same('% pandoc -t native -f csv', $evidence['samples'][1]['command']);
        $t->same('csv', $evidence['samples'][1]['reader']);
        $t->same(1, $evidence['samples'][1]['rowCount']);
        $t->same(1, $evidence['samples'][1]['columnCount']);
        $t->same('valid-checked-in-current-csv-direct-native-transcript-evidence', $evidence['staticFixtureEvidence']['validation']['status']);
        $t->same(true, DelimitedTextUpstreamReaderEvidence::hasRequiredCurrentCsvDirectNativeParity($evidence));
        $t->true(in_array('that 01.csv contains an embedded native expectation', $evidence['claimBoundaries']['doesNotAssert'], true));
    },
    'executes current tsv direct native parity evidence' => static function (TestRunner $t): void {
        $repoRoot = dirname(__DIR__, 3);
        $evidence = DelimitedTextUpstreamReaderEvidence::currentTsvDirectNativeParityEvidence($repoRoot);

        $t->same('current-tsv-direct-native-parity-evidence', $evidence['kind']);
        $t->same('current-tsv-direct-native-parity', $evidence['evidenceKind']);
        ...
        $t->same('matched', $evidence['samples'][0]['status']);
        $t->same('direct-tsv-basic', $evidence['samples'][0]['name']);
        $t->same('lanes/pandoc/fixtures/current-tsv-reader/direct-tsv-basic.tsv', $evidence['samples'][0]['inputPath']);
        $t->same('lanes/pandoc/fixtures/current-tsv-reader/direct-tsv-basic.native', $evidence['samples'][0]['expectedNativePath']);
    ...
    'validates hydrated upstream delimited text reader fixture evidence' => static function (TestRunner $t) use ($makeTempDir, $removeTree, $writeDelimitedTextEvidenceTree): void {
        ...
        try {
            ...
            $t->same('test/command/8661.md', $report['denominator']['upstreamFixtures'][3]['path']);
            $t->same('86ceedf9c34dff9b22b36220a7712a0fcd7d831f2f5d740eb44dce1d10ab8f72', $report['denominator']['upstreamFixtures'][3]['sha256']);
    ...
    'executes generated csv and tsv pandoc executable native parity evidence' => static function (TestRunner $t): void {
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $csv['pandocExecutableNativeMatchCount']);
        $t->same(0, $csv['pandocExecutableNativeMismatchCount']);
        $t->same(100.0, $csv['pandocExecutableNativeMatchPercent']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $csv['staticFixtureBindingValidCount']);
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $tsv['tsvDirectFixtureDenominator']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $tsv['generatedNativeCorpusSampleCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $tsv['sampleCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $tsv['comparedSampleCount']);
        $t->same(0, $tsv['parseFailureCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $tsv['pandocExecutableNativeMatchCount']);
        $t->same(0, $tsv['pandocExecutableNativeMismatchCount']);
        $t->same(100.0, $tsv['pandocExecutableNativeMatchPercent']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $tsv['staticFixtureBindingValidCount']);
    ...
    'cli reports generated tsv native parity without changing tsv direct denominator' => static function (TestRunner $t): void {
        $repoRoot = dirname(__DIR__, 3);
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-current-csv-direct-native-parity=' . DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_CURRENT_CSV_DIRECT_NATIVE_PAIR_COUNT
            . ' --require-current-tsv-direct-native-parity=' . DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_CURRENT_TSV_DIRECT_NATIVE_PAIR_COUNT
            ...
            . ' --require-pandoc-executable-tsv-native-parity=' . DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT
        ...
        $t->same(0, $exitCode);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $decoded['tsv']['denominator']);
        $t->same(['test/command/8661.md'], $decoded['tsv']['directFixtures']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $decoded['tsv']['tsvDirectFixtureDenominator']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $decoded['generatedCsvNativeParity']['sampleCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $decoded['generatedCsvNativeParity']['generatedNativeMatchCount']);
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_CURRENT_CSV_DIRECT_NATIVE_PAIR_COUNT, $decoded['currentCsvDirectNativeParity']['sampleCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_CURRENT_CSV_DIRECT_NATIVE_PAIR_COUNT, $decoded['currentCsvDirectNativeParity']['currentCsvDirectNativeMatchCount']);
        $t->same('current-csv-direct-native-parity-observed', $decoded['currentCsvDirectNativeParity']['parityStatus']);
        $t->same(true, $decoded['validation']['currentCsvDirectNativeParity']);
        $t->same(true, DelimitedTextUpstreamReaderEvidence::hasRequiredCurrentCsvDirectNativeParity($decoded['currentCsvDirectNativeParity']));
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_CURRENT_TSV_DIRECT_NATIVE_PAIR_COUNT, $decoded['currentTsvDirectNativeParity']['sampleCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_CURRENT_TSV_DIRECT_NATIVE_PAIR_COUNT, $decoded['currentTsvDirectNativeParity']['currentTsvDirectNativeMatchCount']);
        $t->same('current-tsv-direct-native-parity-observed', $decoded['currentTsvDirectNativeParity']['parityStatus']);
        $t->same(true, $decoded['validation']['currentTsvDirectNativeParity']);
        $t->same(true, DelimitedTextUpstreamReaderEvidence::hasRequiredCurrentTsvDirectNativeParity($decoded['currentTsvDirectNativeParity']));
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $decoded['generatedCsvPandocExecutableNativeParity']['sampleCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $decoded['generatedCsvPandocExecutableNativeParity']['pandocExecutableNativeMatchCount']);
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $decoded['generatedTsvPandocExecutableNativeParity']['sampleCount']);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_PANDOC_EXECUTABLE_NATIVE_SAMPLE_COUNT, $decoded['generatedTsvPandocExecutableNativeParity']['pandocExecutableNativeMatchCount']);
        ...
        $t->same(true, $decoded['tsv']['runnerEvidence']['target']['tsvDirectFixtureAvailable']);
        $t->same('test/command/8661.md', $decoded['tsv']['runnerEvidence']['target']['tsvDirectCommandFixture']);
        $t->same('gfm', $decoded['tsv']['runnerEvidence']['target']['tsvDirectOutputFormat']);
    ...
    'cli gates generated csv native parity against explicit repo root' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        try {
            ...
            $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $decoded['generatedCsvNativeParity']['parseFailureCount']);
            $t->same(0, $decoded['generatedCsvNativeParity']['staticFixtureBindingValidCount']);
            $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $decoded['generatedCsvNativeParity']['staticFixtureBindingInvalidCount']);
            $t->same('blocked-by-generated-csv-native-fixture-validation', $decoded['generatedCsvNativeParity']['parityStatus']);
            $t->same(array_fill(0, DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, 'invalid-generated-csv-native-sample-static-binding'), array_column($decoded['generatedCsvNativeParity']['samples'], 'staticFixtureBindingStatus'));
    ...
    'cli gates generated tsv native parity against explicit repo root' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        try {
            ...
            $t->same(1, $exitCode);
            $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $decoded['generatedTsvNativeParity']['sampleCount']);
            $t->same(0, $decoded['generatedTsvNativeParity']['comparedSampleCount']);
            $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $decoded['generatedTsvNativeParity']['parseFailureCount']);
            $t->same(0, $decoded['generatedTsvNativeParity']['staticFixtureBindingValidCount']);
            $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $decoded['generatedTsvNativeParity']['staticFixtureBindingInvalidCount']);
            $t->same('blocked-by-generated-tsv-native-fixture-validation', $decoded['generatedTsvNativeParity']['parityStatus']);
            $t->same(array_fill(0, DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, 'invalid-generated-tsv-native-sample-static-binding'), array_column($decoded['generatedTsvNativeParity']['samples'], 'staticFixtureBindingStatus'));
