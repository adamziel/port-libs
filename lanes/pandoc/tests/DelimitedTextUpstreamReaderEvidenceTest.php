...
return [
    'reports skipped delimited text reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->contains('Generated TSV native parity: 29/29 status=generated-tsv-native-parity-observed-not-upstream-fixture', $text);
    ...
    'reports checked-in current csv command fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(29, $evidence['generatedTsvNativeStaticEvidence']['sampleCount']);
        $t->same(58, $evidence['generatedTsvNativeStaticEvidence']['checkedInFixtureCount']);
    ...
    'executes generated tsv native parity evidence' => static function (TestRunner $t): void {
        ...
        $t->same(29, $evidence['sampleCount']);
        $t->same(29, $evidence['comparedSampleCount']);
        $t->same(0, $evidence['parseFailureCount']);
        $t->same(29, $evidence['generatedNativeMatchCount']);
        $t->same(0, $evidence['generatedNativeMismatchCount']);
        $t->same(100.0, $evidence['generatedNativeMatchPercent']);
        $t->same(29, $evidence['staticFixtureBindingValidCount']);
        $t->same(0, $evidence['staticFixtureBindingInvalidCount']);
        $t->same(array_fill(0, 29, 'valid-generated-tsv-native-sample-static-binding'), array_column($evidence['samples'], 'staticFixtureBindingStatus'));
    ...
    'validates hydrated upstream delimited text reader fixture evidence' => static function (TestRunner $t) use ($makeTempDir, $removeTree, $writeDelimitedTextEvidenceTree): void {
        ...
        try {
            ...
            $t->same(29, $report['generatedTsvNativeParityEvidence']['generatedNativeMatchCount']);
    ...
    'executes generated csv and tsv pandoc executable native parity evidence' => static function (TestRunner $t): void {
        ...
        $t->same(29, $tsv['generatedNativeCorpusSampleCount']);
        $t->same(21, $tsv['sampleCount']);
        $t->same(21, $tsv['comparedSampleCount']);
        $t->same(0, $tsv['parseFailureCount']);
        $t->same(21, $tsv['pandocExecutableNativeMatchCount']);
        $t->same(0, $tsv['pandocExecutableNativeMismatchCount']);
        $t->same(100.0, $tsv['pandocExecutableNativeMatchPercent']);
        $t->same(21, $tsv['staticFixtureBindingValidCount']);
        ...
        $t->same(array_fill(0, 21, 'matched'), array_column($tsv['samples'], 'status'));
        $t->same(array_fill(0, 21, 'valid-generated-tsv-native-sample-static-binding'), array_column($tsv['samples'], 'staticFixtureBindingStatus'));
    ...
    'cli reports generated tsv native parity without changing tsv denominator' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-generated-tsv-native-parity=29'
            . ' --require-pandoc-executable-csv-native-parity=29'
            . ' --require-pandoc-executable-tsv-native-parity=21'
        ...
        $t->same(29, $decoded['tsv']['generatedNativeParitySampleCount']);
        $t->same(29, $decoded['generatedTsvNativeParity']['generatedNativeMatchCount']);
        ...
        $t->same(21, $decoded['generatedTsvPandocExecutableNativeParity']['sampleCount']);
        $t->same(21, $decoded['generatedTsvPandocExecutableNativeParity']['pandocExecutableNativeMatchCount']);
    ...
    'cli gates generated tsv native parity against explicit repo root' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        try {
            ...
            $t->same(1, $exitCode);
            $t->same(29, $decoded['generatedTsvNativeParity']['sampleCount']);
            $t->same(0, $decoded['generatedTsvNativeParity']['comparedSampleCount']);
            $t->same(29, $decoded['generatedTsvNativeParity']['parseFailureCount']);
            $t->same(0, $decoded['generatedTsvNativeParity']['staticFixtureBindingValidCount']);
            $t->same(29, $decoded['generatedTsvNativeParity']['staticFixtureBindingInvalidCount']);
            $t->same('blocked-by-generated-tsv-native-fixture-validation', $decoded['generatedTsvNativeParity']['parityStatus']);
            $t->same(array_fill(0, 29, 'invalid-generated-tsv-native-sample-static-binding'), array_column($decoded['generatedTsvNativeParity']['samples'], 'staticFixtureBindingStatus'));
