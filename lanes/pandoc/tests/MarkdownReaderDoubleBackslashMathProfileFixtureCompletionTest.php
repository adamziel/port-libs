...
$fixture = (string) file_get_contents(
    dirname(__DIR__) . '/fixtures/upstream-markdown-z-tex-math-double-backslash-profile.md'
);
...
return [
    'maps pandoc markdown double backslash math profile fixture' =>
        static function (TestRunner $t) use ($fixture, $inlineText): void {
            $document = (new MarkdownReader(['format' => 'markdown+tex_math_double_backslash']))->read($fixture);
    ...
    'keeps pandoc markdown double backslash math profile fixture literal by default' =>
        static function (TestRunner $t) use ($fixture, $inlineText): void {
