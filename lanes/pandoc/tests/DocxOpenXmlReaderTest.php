...
XML;
        ...
        $t->same('word/glossary/document.xml', $docx['glossaryPart']);
        $t->same('word/glossary/_rels/document.xml.rels', $docx['glossaryRelationshipsPart']);
        $t->same('rGlossary', $docx['glossaryRelationship']['id']);
        $t->same('glossary/document.xml?slot=review#building-blocks', $docx['glossaryRelationship']['target']);
        $t->same('word/glossary/document.xml?slot=review#building-blocks', $docx['glossaryRelationship']['resolvedTarget']);
        $t->same('word/glossary/document.xml', $docx['glossaryRelationship']['targetPart']);
        $t->same('slot=review', $docx['glossaryRelationship']['targetQuery']);
        $t->same('building-blocks', $docx['glossaryRelationship']['targetFragment']);
        $t->same('?slot=review#building-blocks', $docx['glossaryRelationship']['targetReferenceSuffix']);
        ...
        $t->same(1, $package['summary']['glossaryRelationshipCount']);
        $t->same(0, $package['summary']['glossaryIssueCount']);
        $t->same('glossaryDocument', $package['relationshipTypes'][$relationshipType]['label']);
        $t->same(['word/glossary/document.xml'], $package['relationshipTypes'][$relationshipType]['targetParts']);
