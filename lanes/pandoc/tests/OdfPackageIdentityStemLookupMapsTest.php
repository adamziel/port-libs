...
<office:document-content
  ...
  <office:body>
    <office:text>
      <text:p>Package identity stem lookup maps.</text:p>
    </office:text>
  </office:body>
</office:document-content>
XML;
...
<office:document-meta
  ...
  <office:meta>
    <dc:title>Package Identity Stem Lookup Maps</dc:title>
  </office:meta>
</office:document-meta>
XML;
...
$buildPackage = static fn (): ZipPackage => ZipPackage::fromParts([
    ...
    ['name' => 'Objects/Pictures.assets/readme.txt', 'data' => 'readme', 'compressionMethod' => 0],
    ['name' => 'Objects/pictures/', 'data' => '', 'compressionMethod' => 0],
    ['name' => 'Objects/pictures/icon.png', 'data' => 'icon', 'compressionMethod' => 0],
], 'odt package identity stem lookup maps');

return [
    'carries ODT package directory base-name stem lookup maps through compact and rich identities' => static function (TestRunner $t) use ($buildPackage): void {
        ...
        foreach ([$compactIdentity, $richIdentity, $documentIdentity] as $identity) {
            $t->same(
                ...
                $identity['entryNamesByPackageDirectoryBaseNameStem']['Pictures']
            );
            $t->same(
                [
                ...
                $identity['entryNamesByPackageCaseFoldDirectoryBaseNameStem']['pictures']
            );
        }
    },
];
