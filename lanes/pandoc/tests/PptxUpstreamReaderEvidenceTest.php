...
return [
    ...
    'reports checked-in current upstream pptx static evidence gate' => static function (TestRunner $t): void {
        ...
        $t->same(84, $static['checkedInFixturePairCount']);
        ...
        $t->same(84, $nativeParity['requiredPairCount']);
        $t->same(84, $nativeParity['totalPairCount']);
        $t->same(84, $nativeParity['comparedPairCount']);
        $t->same(84, $nativeParity['pptxParsedCount']);
        $t->same(84, $nativeParity['nativeParsedCount']);
        $t->same(84, $nativeParity['bothParsedCount']);
        $t->same(0, $nativeParity['parseFailureCount']);
        $t->same(84, $nativeParity['normalizedAstMatchCount']);
        $t->same(0, $nativeParity['normalizedAstMismatchCount']);
        $t->same(84, count($nativeParity['fixtureComparisons']));
        ...
        $t->same(84, $executableParity['requiredPptxCount']);
        ...
        $t->same('a48a3f7059f63a7fe436223cdd731a094ea87eae153cd8640a341c71fc4338dd', $executableParity['snapshotFile']['sha256']);
        $t->same(36654, $executableParity['snapshotFile']['bytes']);
        ...
        $t->same(84, $executableParity['totalPptxCount']);
        $t->same(84, $executableParity['comparedPptxCount']);
        $t->same(84, $executableParity['localParsedCount']);
        $t->same(84, $executableParity['pandocParsedCount']);
        $t->same(84, $executableParity['nativeFixtureParsedCount']);
        $t->same(84, $executableParity['bothParsedCount']);
        $t->same(0, $executableParity['parseFailureCount']);
        $t->same(84, $executableParity['normalizedAstMatchCount']);
        $t->same(0, $executableParity['normalizedAstMismatchCount']);
        $t->same(84, $executableParity['pandocNativeFixtureComparedCount']);
        $t->same(84, $executableParity['pandocNativeFixtureMatchCount']);
        ...
        $t->true(in_array('local PHP PPTX reader output matches all 84 checked-in current PPTX/native pairs by normalized AST shape', $static['claimBoundaries']['doesAssert'], true));
        $t->true(in_array('checked-in executable native AST evidence shows pandoc 3.10, local PHP output, and paired .native fixtures match all 84 checked-in current PPTX fixtures by normalized AST shape', $static['claimBoundaries']['doesAssert'], true));
        ...
        $t->contains('Static current evidence: valid-checked-in-current-pptx-reader-evidence comparisons=1 checkedInPairs=84', $text);
        $t->contains('Static native AST mapped parity: normalized-ast-equality-observed-not-runner-parity matches=84 mismatches=0 required=84', $text);
        $t->contains('Static executable native AST parity: normalized-ast-equality-observed-against-pandoc-executable matches=84 mismatches=0 required=84', $text);
        $t->contains('Runner status: not-run', $text);
        $t->contains('Runner plan: planned-not-run', $text);
    },
...
HS);
    ...
    'cli gates checked-in current pptx static evidence without upstream runner claim' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        $t->same(84, $summary['staticCurrentEvidence']['checkedInFixturePairCount']);
        $t->same(84, $summary['staticCurrentEvidence']['nativeAstMappedParity']['normalizedAstMatchCount']);
        $t->same(0, $summary['staticCurrentEvidence']['nativeAstMappedParity']['normalizedAstMismatchCount']);
        $t->same(84, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['normalizedAstMatchCount']);
        $t->same(0, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['normalizedAstMismatchCount']);
        $t->same(84, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['pandocNativeFixtureMatchCount']);
