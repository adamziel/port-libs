...
return [
    ...
    'reports checked-in current upstream pptx static evidence gate' => static function (TestRunner $t): void {
        ...
        $t->same(85, $static['checkedInFixturePairCount']);
        ...
        $t->same(85, $nativeParity['requiredPairCount']);
        $t->same(85, $nativeParity['totalPairCount']);
        $t->same(85, $nativeParity['comparedPairCount']);
        $t->same(85, $nativeParity['pptxParsedCount']);
        $t->same(85, $nativeParity['nativeParsedCount']);
        $t->same(85, $nativeParity['bothParsedCount']);
        $t->same(0, $nativeParity['parseFailureCount']);
        $t->same(85, $nativeParity['normalizedAstMatchCount']);
        $t->same(0, $nativeParity['normalizedAstMismatchCount']);
        $t->same(85, count($nativeParity['fixtureComparisons']));
        ...
        $t->same(85, $executableParity['requiredPptxCount']);
        ...
        $t->same('2f3d2d8ea9a98451d37f775569fea0160387ac23b4dbe1e2e1f0895557d72a5d', $executableParity['snapshotFile']['sha256']);
        $t->same(37041, $executableParity['snapshotFile']['bytes']);
        ...
        $t->same(85, $executableParity['totalPptxCount']);
        $t->same(85, $executableParity['comparedPptxCount']);
        $t->same(85, $executableParity['localParsedCount']);
        $t->same(85, $executableParity['pandocParsedCount']);
        $t->same(85, $executableParity['nativeFixtureParsedCount']);
        $t->same(85, $executableParity['bothParsedCount']);
        $t->same(0, $executableParity['parseFailureCount']);
        $t->same(85, $executableParity['normalizedAstMatchCount']);
        $t->same(0, $executableParity['normalizedAstMismatchCount']);
        $t->same(85, $executableParity['pandocNativeFixtureComparedCount']);
        $t->same(85, $executableParity['pandocNativeFixtureMatchCount']);
        ...
        $t->true(in_array('local PHP PPTX reader output matches all 85 checked-in current PPTX/native pairs by normalized AST shape', $static['claimBoundaries']['doesAssert'], true));
        $t->true(in_array('checked-in executable native AST evidence shows pandoc 3.10, local PHP output, and paired .native fixtures match all 85 checked-in current PPTX fixtures by normalized AST shape', $static['claimBoundaries']['doesAssert'], true));
        ...
        $t->contains('Static current evidence: valid-checked-in-current-pptx-reader-evidence comparisons=1 checkedInPairs=85', $text);
        $t->contains('Static native AST mapped parity: normalized-ast-equality-observed-not-runner-parity matches=85 mismatches=0 required=85', $text);
        $t->contains('Static executable native AST parity: normalized-ast-equality-observed-against-pandoc-executable matches=85 mismatches=0 required=85', $text);
        $t->contains('Runner status: not-run', $text);
        $t->contains('Runner plan: planned-not-run', $text);
    },
...
HS);
    ...
    'cli gates checked-in current pptx static evidence without upstream runner claim' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        $t->same(85, $summary['staticCurrentEvidence']['checkedInFixturePairCount']);
        $t->same(85, $summary['staticCurrentEvidence']['nativeAstMappedParity']['normalizedAstMatchCount']);
        $t->same(0, $summary['staticCurrentEvidence']['nativeAstMappedParity']['normalizedAstMismatchCount']);
        $t->same(85, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['normalizedAstMatchCount']);
        $t->same(0, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['normalizedAstMismatchCount']);
        $t->same(85, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['pandocNativeFixtureMatchCount']);
