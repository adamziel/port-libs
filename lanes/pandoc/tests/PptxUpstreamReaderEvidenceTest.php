...
return [
    ...
    'reports checked-in current upstream pptx static evidence gate' => static function (TestRunner $t): void {
        ...
        $headerOnlyTablePair = $pairsByStem['header-only-table'];
        ...
        $pictureBulletPlainPair = $pairsByStem['picture-bullet-plain'];
        ...
        $fieldTitlePair = $pairsByStem['field-title'];
        $firstTableCellTextBodyPair = $pairsByStem['first-table-cell-text-body'];
        ...
        $raggedBodyRowTablePair = $pairsByStem['ragged-body-row-table'];
        $relPrefixImageSkipPair = $pairsByStem['rel-prefix-image-skip'];
        $relationshipRootAliasPair = $pairsByStem['relationship-root-alias'];
        ...
        $unqualifiedRelationshipAttributesPair = $pairsByStem['unqualified-relationship-attributes'];
        ...
        $t->same(108, $static['checkedInFixturePairCount']);
        ...
        $t->same(108, $nativeParity['requiredPairCount']);
        $t->same(108, $nativeParity['totalPairCount']);
        $t->same(108, $nativeParity['comparedPairCount']);
        $t->same(108, $nativeParity['pptxParsedCount']);
        $t->same(108, $nativeParity['nativeParsedCount']);
        $t->same(108, $nativeParity['bothParsedCount']);
        ...
        $t->same(108, $nativeParity['normalizedAstMatchCount']);
        $t->same(0, $nativeParity['normalizedAstMismatchCount']);
        $t->same(108, count($nativeParity['fixtureComparisons']));
        ...
        $t->same(108, $executableParity['requiredPptxCount']);
        ...
        $t->same('1c53e6af2ebd64c631b9e56a4e6c993d710cf83be0cdf76007b7c1421da9bc5a', $executableParity['snapshotFile']['sha256']);
        $t->same(46588, $executableParity['snapshotFile']['bytes']);
        ...
        $t->same(108, $executableParity['totalPptxCount']);
        $t->same(108, $executableParity['comparedPptxCount']);
        $t->same(108, $executableParity['localParsedCount']);
        $t->same(108, $executableParity['pandocParsedCount']);
        $t->same(108, $executableParity['nativeFixtureParsedCount']);
        $t->same(108, $executableParity['bothParsedCount']);
        $t->same(0, $executableParity['parseFailureCount']);
        $t->same(108, $executableParity['normalizedAstMatchCount']);
        $t->same(0, $executableParity['normalizedAstMismatchCount']);
        $t->same(108, $executableParity['pandocNativeFixtureComparedCount']);
        $t->same(108, $executableParity['pandocNativeFixtureMatchCount']);
        ...
        $t->same('field-title', $fieldTitlePair['stem']);
        $t->same('generated field-backed title placeholder parity', $fieldTitlePair['name']);
        $t->same('pptx-reader/field-title.pptx|pptx-reader/field-title.native', $fieldTitlePair['pairKey']);
        $t->same('3f7ed6cd3d9f6088310c5b92652bab7f382d4ec3f128c2d92caf4408fae374cf', $fieldTitlePair['checkedInPptx']['sha256']);
        $t->same('125290aa28897bd5dd8bb81472ac61216d200bb8ef6b2358b7992438ea071568', $fieldTitlePair['checkedInNative']['sha256']);
        $t->same(1545, $fieldTitlePair['checkedInPptx']['bytes']);
        $t->same(116, $fieldTitlePair['checkedInNative']['bytes']);
        ...
        $t->same('first-table-cell-text-body', $firstTableCellTextBodyPair['stem']);
        $t->same('generated first table cell text body parity', $firstTableCellTextBodyPair['name']);
        $t->same('pptx-reader/first-table-cell-text-body.pptx|pptx-reader/first-table-cell-text-body.native', $firstTableCellTextBodyPair['pairKey']);
        $t->same('3c922321649bbabb5a9676f354ca2ef62abcefb0c7006501ae1c2010edc3e629', $firstTableCellTextBodyPair['checkedInPptx']['sha256']);
        $t->same('7813fdec7fde0ca32e37328577f91cfc0b0518a72d9a2c6084e2fb3e41e4e7e3', $firstTableCellTextBodyPair['checkedInNative']['sha256']);
        $t->same(1510, $firstTableCellTextBodyPair['checkedInPptx']['bytes']);
        $t->same(1229, $firstTableCellTextBodyPair['checkedInNative']['bytes']);
        ...
        $t->same('header-only-table', $headerOnlyTablePair['stem']);
        $t->same('generated header-only table parity', $headerOnlyTablePair['name']);
        $t->same('pptx-reader/header-only-table.pptx|pptx-reader/header-only-table.native', $headerOnlyTablePair['pairKey']);
        $t->same('0f6885aa81b40ece6baf0594b96671288e2e34443955e8d05faef3a70c84c27b', $headerOnlyTablePair['checkedInPptx']['sha256']);
        $t->same('24386bb8660fccadb33699ccc98bebee91dec39a667bc0e9f0b56ab5a16c32ab', $headerOnlyTablePair['checkedInNative']['sha256']);
        $t->same(1747, $headerOnlyTablePair['checkedInPptx']['bytes']);
        $t->same(757, $headerOnlyTablePair['checkedInNative']['bytes']);
        ...
        $t->same('picture-bullet-plain', $pictureBulletPlainPair['stem']);
        $t->same('generated picture bullet marker stays plain parity', $pictureBulletPlainPair['name']);
        $t->same('pptx-reader/picture-bullet-plain.pptx|pptx-reader/picture-bullet-plain.native', $pictureBulletPlainPair['pairKey']);
        $t->same('bdead04f7e3e5f820e45f3a377dc8e8532e14d6a206690cfe3359472825d645d', $pictureBulletPlainPair['checkedInPptx']['sha256']);
        $t->same('6364a606bfa373aae9fd8ac687ea9bb0859a0bd718cd3149af16a0d76a5daf2f', $pictureBulletPlainPair['checkedInNative']['sha256']);
        $t->same(2177, $pictureBulletPlainPair['checkedInPptx']['bytes']);
        $t->same(159, $pictureBulletPlainPair['checkedInNative']['bytes']);
        ...
        $t->same('ragged-body-row-table', $raggedBodyRowTablePair['stem']);
        $t->same('generated ragged body row table parity', $raggedBodyRowTablePair['name']);
        $t->same('pptx-reader/ragged-body-row-table.pptx|pptx-reader/ragged-body-row-table.native', $raggedBodyRowTablePair['pairKey']);
        $t->same('1e88d253ef7c8cc42179427fb2cb5097f74fa0cda88bdfba44caaf3d244c6583', $raggedBodyRowTablePair['checkedInPptx']['sha256']);
        $t->same('3b3d5b70017c80bf39d4cc6d3f77139c2694216030fa481c8d6710d6b4807991', $raggedBodyRowTablePair['checkedInNative']['sha256']);
        $t->same(1475, $raggedBodyRowTablePair['checkedInPptx']['bytes']);
        $t->same(1636, $raggedBodyRowTablePair['checkedInNative']['bytes']);
        ...
        $t->same('relationship-root-alias', $relationshipRootAliasPair['stem']);
        $t->same('generated relationship root alias parity', $relationshipRootAliasPair['name']);
        $t->same('pptx-reader/relationship-root-alias.pptx|pptx-reader/relationship-root-alias.native', $relationshipRootAliasPair['pairKey']);
        $t->same('b5e36f9e43595a72fa9c07a5ddcfaf1761263336313da07d698bbb1656052d8a', $relationshipRootAliasPair['checkedInPptx']['sha256']);
        $t->same('2b98f648ad9ddf52271c4d333091a599b5d43a9a28396b64952677f658f26641', $relationshipRootAliasPair['checkedInNative']['sha256']);
        $t->same(2182, $relationshipRootAliasPair['checkedInPptx']['bytes']);
        $t->same(249, $relationshipRootAliasPair['checkedInNative']['bytes']);
        ...
        $t->same('unqualified-relationship-attributes', $unqualifiedRelationshipAttributesPair['stem']);
        $t->same('generated unqualified relationship attribute parity', $unqualifiedRelationshipAttributesPair['name']);
        $t->same('pptx-reader/unqualified-relationship-attributes.pptx|pptx-reader/unqualified-relationship-attributes.native', $unqualifiedRelationshipAttributesPair['pairKey']);
        $t->same('4cbabcf0bac36cd9c06d688b82173633062c89121296ecceff0b5ecbd2206449', $unqualifiedRelationshipAttributesPair['checkedInPptx']['sha256']);
        $t->same('1d8281f7e359f99a495b4f9ccb2012dd67309f8fe5df83c6e22a52227c9d79c6', $unqualifiedRelationshipAttributesPair['checkedInNative']['sha256']);
        $t->same(2099, $unqualifiedRelationshipAttributesPair['checkedInPptx']['bytes']);
        $t->same(302, $unqualifiedRelationshipAttributesPair['checkedInNative']['bytes']);
        ...
        $t->true(in_array('local PHP PPTX reader output matches all 108 checked-in current PPTX/native pairs by normalized AST shape', $static['claimBoundaries']['doesAssert'], true));
        $t->true(in_array('checked-in executable native AST evidence shows pandoc 3.10, local PHP output, and paired .native fixtures match all 108 checked-in current PPTX fixtures by normalized AST shape', $static['claimBoundaries']['doesAssert'], true));
        $t->true(in_array('additional PPTX fixture discovery outside the checked-in 108-pair corpus', $static['claimBoundaries']['doesNotAssert'], true));
        ...
        $t->true(in_array('that field-title.pptx/field-title.native is an upstream Tests.Readers.Pptx fixture', $static['claimBoundaries']['doesNotAssert'], true));
        ...
        $t->true(in_array('that header-only-table.pptx/header-only-table.native is an upstream Tests.Readers.Pptx fixture', $static['claimBoundaries']['doesNotAssert'], true));
        ...
        $t->true(in_array('that picture-bullet-plain.pptx/picture-bullet-plain.native is an upstream Tests.Readers.Pptx fixture', $static['claimBoundaries']['doesNotAssert'], true));
        ...
        $t->true(in_array('that ragged-body-row-table.pptx/ragged-body-row-table.native is an upstream Tests.Readers.Pptx fixture', $static['claimBoundaries']['doesNotAssert'], true));
        ...
        $t->true(in_array('that relationship-root-alias.pptx/relationship-root-alias.native is an upstream Tests.Readers.Pptx fixture', $static['claimBoundaries']['doesNotAssert'], true));
        ...
        $t->true(in_array('that unqualified-relationship-attributes.pptx/unqualified-relationship-attributes.native is an upstream Tests.Readers.Pptx fixture', $static['claimBoundaries']['doesNotAssert'], true));
        ...
        $t->contains('Static current evidence: valid-checked-in-current-pptx-reader-evidence comparisons=1 checkedInPairs=108', $text);
        $t->contains('Static native AST mapped parity: normalized-ast-equality-observed-not-runner-parity matches=108 mismatches=0 required=108', $text);
        $t->contains('Static executable native AST parity: normalized-ast-equality-observed-against-pandoc-executable matches=108 mismatches=0 required=108', $text);
...
HS);
    ...
    'cli gates checked-in current pptx static evidence without upstream runner claim' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-fixture-pair-count=108'
        ...
        $t->same(true, PptxUpstreamReaderEvidence::hasRequiredCheckedInFixturePairCount($decoded, 108));
        ...
        $t->same(108, $summary['staticCurrentEvidence']['checkedInFixturePairCount']);
        $t->same(108, $summary['staticCurrentEvidence']['nativeAstMappedParity']['normalizedAstMatchCount']);
        $t->same(0, $summary['staticCurrentEvidence']['nativeAstMappedParity']['normalizedAstMismatchCount']);
        $t->same(108, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['normalizedAstMatchCount']);
        $t->same(0, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['normalizedAstMismatchCount']);
        $t->same(108, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['pandocNativeFixtureMatchCount']);
        ...
        $wrongCountCommand = str_replace('--require-fixture-pair-count=108', '--require-fixture-pair-count=92', $command) . ' 2>/dev/null';
        $wrongCountOutput = [];
    ...
    'workflow gates checked-in pptx native and executable parity corpora' => static function (TestRunner $t): void {
        ...
        $t->contains('--require-executable-parity=108', $workflow);
