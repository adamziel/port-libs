...
return [
    ...
    'reports checked-in current upstream pptx static evidence gate' => static function (TestRunner $t): void {
        ...
        $t->same(83, $static['checkedInFixturePairCount']);
        ...
        $t->same(83, $nativeParity['requiredPairCount']);
        $t->same(83, $nativeParity['totalPairCount']);
        $t->same(83, $nativeParity['comparedPairCount']);
        $t->same(83, $nativeParity['pptxParsedCount']);
        $t->same(83, $nativeParity['nativeParsedCount']);
        $t->same(83, $nativeParity['bothParsedCount']);
        $t->same(0, $nativeParity['parseFailureCount']);
        $t->same(83, $nativeParity['normalizedAstMatchCount']);
        $t->same(0, $nativeParity['normalizedAstMismatchCount']);
        $t->same(83, count($nativeParity['fixtureComparisons']));
        ...
        $t->same(83, $executableParity['requiredPptxCount']);
        ...
        $t->same('676e35d59e7f772edc734da16521d5632e5b29578e650de60cf89b76e117124b', $executableParity['snapshotFile']['sha256']);
        $t->same(36251, $executableParity['snapshotFile']['bytes']);
        ...
        $t->same(83, $executableParity['totalPptxCount']);
        $t->same(83, $executableParity['comparedPptxCount']);
        $t->same(83, $executableParity['localParsedCount']);
        $t->same(83, $executableParity['pandocParsedCount']);
        $t->same(83, $executableParity['nativeFixtureParsedCount']);
        $t->same(83, $executableParity['bothParsedCount']);
        $t->same(0, $executableParity['parseFailureCount']);
        $t->same(83, $executableParity['normalizedAstMatchCount']);
        $t->same(0, $executableParity['normalizedAstMismatchCount']);
        $t->same(83, $executableParity['pandocNativeFixtureComparedCount']);
        $t->same(83, $executableParity['pandocNativeFixtureMatchCount']);
        ...
        $t->true(in_array('local PHP PPTX reader output matches all 83 checked-in current PPTX/native pairs by normalized AST shape', $static['claimBoundaries']['doesAssert'], true));
        $t->true(in_array('checked-in executable native AST evidence shows pandoc 3.10, local PHP output, and paired .native fixtures match all 83 checked-in current PPTX fixtures by normalized AST shape', $static['claimBoundaries']['doesAssert'], true));
        ...
        $t->contains('Static current evidence: valid-checked-in-current-pptx-reader-evidence comparisons=1 checkedInPairs=83', $text);
        $t->contains('Static native AST mapped parity: normalized-ast-equality-observed-not-runner-parity matches=83 mismatches=0 required=83', $text);
        $t->contains('Static executable native AST parity: normalized-ast-equality-observed-against-pandoc-executable matches=83 mismatches=0 required=83', $text);
        $t->contains('Runner status: not-run', $text);
        $t->contains('Runner plan: planned-not-run', $text);
    },
...
HS);
    ...
    'cli gates checked-in current pptx static evidence without upstream runner claim' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        $t->same(83, $summary['staticCurrentEvidence']['checkedInFixturePairCount']);
        $t->same(83, $summary['staticCurrentEvidence']['nativeAstMappedParity']['normalizedAstMatchCount']);
        $t->same(0, $summary['staticCurrentEvidence']['nativeAstMappedParity']['normalizedAstMismatchCount']);
        $t->same(83, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['normalizedAstMatchCount']);
        $t->same(0, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['normalizedAstMismatchCount']);
        $t->same(83, $summary['staticCurrentEvidence']['executableNativeAstMappedParity']['pandocNativeFixtureMatchCount']);
