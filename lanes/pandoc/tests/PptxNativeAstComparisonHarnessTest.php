...
return [
    ...
    'matches checked-in current upstream pptx reader golden pair through normalized ast harness' => static function (TestRunner $t): void {
        ...
        $t->same(1, $report['pptxParsedCount']);
