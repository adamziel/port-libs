...
$upstreamTsvGfmCommandFixture = static function (): array {
    $fixture = (string) file_get_contents(dirname(__DIR__) . '/fixtures/upstream-current-tsv-reader/8661.md');
    if (preg_match('/% pandoc -f tsv -t gfm\n(?P<input>.*?)\n\^D\n(?P<gfm>\|.*?)\n```/s', $fixture, $matches) !== 1) {
        throw new RuntimeException('Unable to parse checked-in upstream TSV GFM command fixture');
    }
...
return [
    ...
    'matches upstream csv header width when body rows are wider or shorter' => static function (TestRunner $t): void {
        ...
        $t->same('pandoc-first-row-width', $packet['rowRepairSummary']['policy'] ?? null);
...
NATIVE;
    ...
    'matches generated csv no header ragged native parity fixture without inflating csv denominator' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        ...
        $t->same('93abe5e561c358a1aa13563f0e20c3eff64cbe334425714a66da87d6b4057798', $generatedEvidence['checkedInFixtures'][9]['checkedInFile']['sha256'] ?? null);
        ...
        $t->same('', $table->children[1]->children[1]->children[2]->attr('text'));
        $t->same('done', $table->children[1]->children[2]->children[2]->attr('text'));
    ...
    'matches generated csv bang escaped options native parity fixture without inflating csv denominator' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('bang-escaped-csv-options');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/bang-escaped-csv-options.csv',
            'escape' => '!',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('bang-escaped-csv-options.csv', $generatedEvidence['checkedInFixtures'][118]['name'] ?? null);
        $t->same('519f8bd0e8185f2e01ee037c1c0ad7f4ce6d1ee6ca2167788bbdd9eafe84a0bc', $generatedEvidence['checkedInFixtures'][118]['checkedInFile']['sha256'] ?? null);
        $t->same('bang-escaped-csv-options.native', $generatedEvidence['checkedInFixtures'][119]['name'] ?? null);
        $t->same('b83612bbf806265ad8219105375347e30721ffd1d93ae18b789f357ac99dc429', $generatedEvidence['checkedInFixtures'][119]['checkedInFile']['sha256'] ?? null);
        $t->same('bang-escaped-csv-options', $generatedEvidence['samples'][59]['name'] ?? null);
        $t->same(['escape' => '!'], $generatedEvidence['samples'][59]['readerOptions'] ?? null);
        $t->same(['id', 'note', 'status'], $table->attr('columnNames'));
        $t->same(4, $packet['rowCount'] ?? null);
        $t->same(3, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        ...
        $t->same(0, $packet['doubledQuoteEscapeCount'] ?? null);
        $t->same(0, $packet['diagnosticCount'] ?? null);
        $t->same('bang , delimiter', $table->children[1]->children[0]->children[1]->attr('text'));
        $t->same('quote " inside', $table->children[1]->children[1]->children[1]->attr('text'));
        $t->same('escape ! marker', $table->children[1]->children[2]->children[1]->attr('text'));
        $t->contains('Plain [ Str "bang" , Space , Str "," , Space , Str "delimiter" ]', $native);
        $t->contains('Plain [ Str "quote" , Space , Str "\\"" , Space , Str "inside" ]', $native);
        $t->contains('Plain [ Str "escape" , Space , Str "!" , Space , Str "marker" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    'matches generated csv single quote double quote literal native parity fixture without inflating csv denominator' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('single-quote-double-quote-literal');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/single-quote-double-quote-literal.csv',
            'quote' => '\'',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('single-quote-double-quote-literal.csv', $generatedEvidence['checkedInFixtures'][120]['name'] ?? null);
        $t->same('b16ed04a1bc02dcefc0e0e8201af1524c3a974ae634ac58a637f2cc328967f65', $generatedEvidence['checkedInFixtures'][120]['checkedInFile']['sha256'] ?? null);
        $t->same('single-quote-double-quote-literal.native', $generatedEvidence['checkedInFixtures'][121]['name'] ?? null);
        $t->same('d5dcb94684914780bbb4145fd721770595a39d55019968f5d3a26ceb2e200be7', $generatedEvidence['checkedInFixtures'][121]['checkedInFile']['sha256'] ?? null);
        $t->same('single-quote-double-quote-literal', $generatedEvidence['samples'][60]['name'] ?? null);
        $t->same(['quote' => '\''], $generatedEvidence['samples'][60]['readerOptions'] ?? null);
        $t->same(['id', 'title', 'note'], $table->attr('columnNames'));
        $t->same(4, $packet['rowCount'] ?? null);
        $t->same(3, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        ...
        $t->same(0, $packet['diagnosticCount'] ?? null);
        $t->same('Alpha, Beta', $table->children[1]->children[0]->children[1]->attr('text'));
        $t->same('"double quotes stay literal"', $table->children[1]->children[0]->children[2]->attr('text'));
        $t->same('"plain ""double"" text"', $table->children[1]->children[1]->children[1]->attr('text'));
        $t->same('single quote keeps comma, too', $table->children[1]->children[1]->children[2]->attr('text'));
        $t->same('owner\'s value', $table->children[1]->children[2]->children[1]->attr('text'));
        $t->same('"bare ""quote"" text"', $table->children[1]->children[2]->children[2]->attr('text'));
        $t->contains('Plain [ Str "\"double" , Space , Str "quotes" , Space , Str "stay" , Space , Str "literal\"" ]', $native);
        $t->contains('Plain [ Str "\"plain" , Space , Str "\"\"double\"\"" , Space , Str "text\"" ]', $native);
        $t->contains('Plain [ Str "owner\'s" , Space , Str "value" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    'matches generated csv keep space before quote native parity fixture without inflating csv denominator' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('keep-space-before-quote');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/keep-space-before-quote.csv',
            'keepSpace' => true,
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('keep-space-before-quote.csv', $generatedEvidence['checkedInFixtures'][122]['name'] ?? null);
        $t->same('752a2af5360dfe6d457b209d72923b22d339ac44942f8c74850aff22beabb389', $generatedEvidence['checkedInFixtures'][122]['checkedInFile']['sha256'] ?? null);
        $t->same('keep-space-before-quote.native', $generatedEvidence['checkedInFixtures'][123]['name'] ?? null);
        $t->same('f528d527b80b33f7e71db1355373d00ac3de4c509312fecd0cf688468d46c033', $generatedEvidence['checkedInFixtures'][123]['checkedInFile']['sha256'] ?? null);
        $t->same('keep-space-before-quote', $generatedEvidence['samples'][61]['name'] ?? null);
        $t->same(['keepSpace' => true], $generatedEvidence['samples'][61]['readerOptions'] ?? null);
        $t->same(['id', 'note', 'status'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        ...
        $t->same(' "literal quote"', $table->children[1]->children[0]->children[1]->attr('text'));
        $t->same('  "alpha beta"', $table->children[1]->children[1]->children[1]->attr('text'));
        $t->contains('Plain [ Space , Str "\"literal" , Space , Str "quote\"" ]', $native);
        $t->contains('Plain [ Space , Str "\"alpha" , Space , Str "beta\"" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    ...
    'matches generated csv quoted multiline header native parity fixture without inflating csv denominator' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('quoted-multiline-header');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-multiline-header.csv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $native = PandocConverter::write($document, 'native');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('quoted-multiline-header.csv', $generatedEvidence['checkedInFixtures'][98]['name'] ?? null);
        $t->same('6d34714c83cfeb46420fa58ad0cd2b53115a3ec267c19fa16abfd70c5f510941', $generatedEvidence['checkedInFixtures'][98]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-multiline-header.native', $generatedEvidence['checkedInFixtures'][99]['name'] ?? null);
        $t->same('7261b85400dd1114d0de4629767fffe214637e59a8cf6df17f8c4ec5a76ce9bd', $generatedEvidence['checkedInFixtures'][99]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-multiline-header', $generatedEvidence['samples'][49]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][49]['readerOptions'] ?? null);
        $t->same(["group\nlabel", 'status'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(2, $packet['columnCount'] ?? null);
        $t->same(6, $packet['fieldCount'] ?? null);
        ...
        $t->same(1, $packet['quotedLineBreakCount'] ?? null);
        $t->same(1, $packet['multilineFieldCount'] ?? null);
        $t->same([0], $packet['multilineQuotedRows'] ?? null);
        $t->same(1, $packet['diagnosticCount'] ?? null);
        $t->same('delimited-text-multiline-quoted-field', $packet['diagnostics'][0]['code'] ?? null);
        $t->same("group\nlabel", $table->children[0]->children[0]->children[0]->attr('text'));
        $t->same('status', $table->children[0]->children[0]->children[1]->attr('text'));
        $t->same('A', $table->children[1]->children[0]->children[0]->attr('text'));
        $t->same('open', $table->children[1]->children[0]->children[1]->attr('text'));
    ...
    'matches generated csv post delimiter empty quoted native parity fixture without inflating csv denominator' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('post-delimiter-empty-quoted');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/post-delimiter-empty-quoted.csv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $native = PandocConverter::write($document, 'native');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('post-delimiter-empty-quoted.csv', $generatedEvidence['checkedInFixtures'][102]['name'] ?? null);
        $t->same('5b70ee2360cfdc191ae8af628897cf94d1fb3228a5c557f0952dab5f3cd97c29', $generatedEvidence['checkedInFixtures'][102]['checkedInFile']['sha256'] ?? null);
        $t->same('post-delimiter-empty-quoted.native', $generatedEvidence['checkedInFixtures'][103]['name'] ?? null);
        $t->same('a06f9b9a2bb80ec4faf40ce9fea4522eaf76d0a3ceb54ec039c0140e98f61b61', $generatedEvidence['checkedInFixtures'][103]['checkedInFile']['sha256'] ?? null);
        $t->same('post-delimiter-empty-quoted', $generatedEvidence['samples'][51]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][51]['readerOptions'] ?? null);
        $t->same(['id', 'empty', 'note'], $table->attr('columnNames'));
        $t->same(4, $packet['rowCount'] ?? null);
        $t->same(3, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        $t->same(12, $packet['fieldCount'] ?? null);
        ...
        $t->same([], $body->children[2]->children[1]->children);
        $t->same('space skipped', $body->children[0]->children[2]->attr('text'));
        $t->same('tab skipped', $body->children[1]->children[2]->attr('text'));
        $t->same('spaces skipped', $body->children[2]->children[2]->attr('text'));
        $t->contains('Plain [ Str "space" , Space , Str "skipped" ]', $native);
        $t->contains('Plain [ Str "tab" , Space , Str "skipped" ]', $native);
    ...
    'matches generated csv quoted crlf linebreak native parity fixture without inflating csv denominator' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('quoted-crlf-linebreak');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-crlf-linebreak.csv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $native = PandocConverter::write($document, 'native');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('quoted-crlf-linebreak.csv', $generatedEvidence['checkedInFixtures'][106]['name'] ?? null);
        $t->same('3f2469c5b1f5e4b354f235434cd2bed54061b6b2a285447ad29f6fb41b60a1ac', $generatedEvidence['checkedInFixtures'][106]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-crlf-linebreak.native', $generatedEvidence['checkedInFixtures'][107]['name'] ?? null);
        $t->same('3956114302f624d1849536a2d452f85b0ce684fb25319e13db3708f41903e71d', $generatedEvidence['checkedInFixtures'][107]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-crlf-linebreak', $generatedEvidence['samples'][53]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][53]['readerOptions'] ?? null);
        $t->same(['id', 'note', 'status'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        ...
        $t->same(1, $packet['multilineFieldCount'] ?? null);
        $t->same([1], $packet['multilineQuotedRows'] ?? null);
        $t->same(4, $packet['inputPrefix']['carriageReturnNormalization']['removedCount'] ?? null);
        $t->same(1, $packet['diagnosticCount'] ?? null);
        $t->same('delimited-text-multiline-quoted-field', $packet['diagnostics'][0]['code'] ?? null);
    ...
    'matches generated csv quoted bare cr normalization native parity fixture without inflating csv denominator' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('quoted-bare-cr-normalized');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-bare-cr-normalized.csv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $native = PandocConverter::write($document, 'native');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('quoted-bare-cr-normalized.csv', $generatedEvidence['checkedInFixtures'][108]['name'] ?? null);
        $t->same('a0ffe7593af38cbd60c634f672daafb274bc05c2995859c6eea4fa5b1e096a5f', $generatedEvidence['checkedInFixtures'][108]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-bare-cr-normalized.native', $generatedEvidence['checkedInFixtures'][109]['name'] ?? null);
        $t->same('9b868b8f3d50b07608e490a0eee15529c6e476e58d0397f5cc236eaf927bf853', $generatedEvidence['checkedInFixtures'][109]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-bare-cr-normalized', $generatedEvidence['samples'][54]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][54]['readerOptions'] ?? null);
        $t->same(['id', 'note', 'flag'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        $t->same(9, $packet['fieldCount'] ?? null);
        ...
        $t->same(1, $packet['inputPrefix']['carriageReturnNormalization']['removedCount'] ?? null);
        $t->same(0, $packet['diagnosticCount'] ?? null);
        $t->same('alphabeta', $body->children[0]->children[1]->attr('text'));
        $t->same('tail', $body->children[1]->children[1]->attr('text'));
        $t->contains('Plain [ Str "alphabeta" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    'matches generated csv quoted delimiter blank line short row native parity fixture' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('quoted-delimiter-blank-short-row');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-delimiter-blank-short-row.csv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $native = PandocConverter::write($document, 'native');
        $generatedEvidence = $packet['upstreamEvidence']['generatedNativeParityEvidence'] ?? [];
        $body = $table->children[1];
        $quotedCell = $body->children[0]->children[1];
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('quoted-delimiter-blank-short-row.csv', $generatedEvidence['checkedInFixtures'][110]['name'] ?? null);
        $t->same('522b8a1e6bfa91cafc8d3b96b90724fe05b1947b6aa24775302eeac1c2b29e28', $generatedEvidence['checkedInFixtures'][110]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-delimiter-blank-short-row.native', $generatedEvidence['checkedInFixtures'][111]['name'] ?? null);
        $t->same('1be02b724aa36c655dae9ff39d52086244d5f586ff8c1c8b3fa63513d9d150cb', $generatedEvidence['checkedInFixtures'][111]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-delimiter-blank-short-row', $generatedEvidence['samples'][55]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][55]['readerOptions'] ?? null);
        $t->same(['id', 'note', 'status'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        $t->same(8, $packet['fieldCount'] ?? null);
        $t->same(2, $packet['minFieldCount'] ?? null);
        $t->same(3, $packet['maxFieldCount'] ?? null);
        $t->same(1, $packet['raggedRowCount'] ?? null);
        ...
        $t->same("alpha, beta\n\ngamma, delta", $quotedCell->attr('text'));
        $t->same(
            ['text', 'linebreak', 'linebreak', 'text'],
            array_map(static fn (AstNode $node): string => $node->type, $quotedCell->children[0]->children)
        );
        $t->same('alpha, beta', $quotedCell->children[0]->children[0]->attr('text'));
        $t->same('gamma, delta', $quotedCell->children[0]->children[3]->attr('text'));
        $t->same('short', $body->children[1]->children[1]->attr('text'));
        $t->same('', $body->children[1]->children[2]->attr('text'));
        $t->same('padded', $body->children[1]->children[2]->attr('sourceFieldStatus'));
    ...
    'matches generated csv quoted trailing empty field native parity fixture' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('quoted-trailing-empty-field');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-trailing-empty-field.csv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $native = PandocConverter::write($document, 'native');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('quoted-trailing-empty-field.csv', $generatedEvidence['checkedInFixtures'][124]['name'] ?? null);
        $t->same('23521624c9a238993d14490b3f282bdc0f2c1590a1376371924df9a254cdc5ba', $generatedEvidence['checkedInFixtures'][124]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-trailing-empty-field.native', $generatedEvidence['checkedInFixtures'][125]['name'] ?? null);
        $t->same('48df01be83b5a077c286db9614763182fbaba277dbc184474a0d1e1d21dbb6e9', $generatedEvidence['checkedInFixtures'][125]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-trailing-empty-field', $generatedEvidence['samples'][62]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][62]['readerOptions'] ?? null);
        $t->same(['id', 'note', 'status', ''], $table->attr('columnNames'));
        $t->same(4, $packet['rowCount'] ?? null);
        $t->same(3, $packet['bodyRowCount'] ?? null);
        $t->same(4, $packet['columnCount'] ?? null);
        $t->same(16, $packet['fieldCount'] ?? null);
        $t->same(4, $packet['trailingDelimiterRowCount'] ?? null);
        $t->same([0, 1, 2, 3], $packet['trailingDelimiterRows'] ?? null);
        $t->same(3, $packet['quotedFieldCount'] ?? null);
        $t->same(2, $packet['doubledQuoteEscapeCount'] ?? null);
        $t->same(0, $packet['raggedRowCount'] ?? null);
        $t->same(2, $packet['diagnosticCount'] ?? null);
        ...
        $t->same('ends with quote', $body->children[0]->children[1]->attr('text'));
        $t->same('', $body->children[0]->children[3]->attr('text'));
        $t->same('', $body->children[1]->children[2]->attr('text'));
        $t->same('', $body->children[1]->children[3]->attr('text'));
        $t->same('"quoted"', $body->children[2]->children[1]->attr('text'));
        $t->same('', $body->children[2]->children[3]->attr('text'));
        $t->contains('Plain [ Str "comma," , Space , Str "inside" ]', $native);
    ...
    'matches generated csv quoted tab cell native parity fixture with pandoc executable backing' => static function (TestRunner $t) use ($generatedCsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedCsvNativeFixture('quoted-tab-cell');
        $document = (new DelimitedTextReader())->readCsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-csv-reader/quoted-tab-cell.csv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $native = PandocConverter::write($document, 'native');
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_CSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('quoted-tab-cell.csv', $generatedEvidence['checkedInFixtures'][134]['name'] ?? null);
        $t->same('a38d027bb7d8a6ccd8007f09bb6e4ea2fe891a654c99d2ae94340b425815be3e', $generatedEvidence['checkedInFixtures'][134]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-tab-cell.native', $generatedEvidence['checkedInFixtures'][135]['name'] ?? null);
        $t->same('8b44069d6379ccbb9ca71d673127f56b9f40f5853a6773efa82dffde5a6ffa34', $generatedEvidence['checkedInFixtures'][135]['checkedInFile']['sha256'] ?? null);
        $t->same('quoted-tab-cell', $generatedEvidence['samples'][67]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][67]['readerOptions'] ?? null);
        $t->same(['id', 'note', 'status'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        ...
        $t->same(0, $packet['raggedRowCount'] ?? null);
        $t->same(0, $packet['diagnosticCount'] ?? null);
        $t->same("alpha\tomega", $body->children[0]->children[1]->attr('text'));
        $t->same("two\ttabs", $body->children[1]->children[1]->attr('text'));
        $t->same('done', $body->children[1]->children[2]->attr('text'));
        $t->contains('Plain [ Str "alpha" , Space , Str "omega" ]', $native);
        $t->contains('Plain [ Str "two" , Space , Str "tabs" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    ...
    'matches generated tsv bare cr rows native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedTsvNativeFixture('cr-only-rows');
        $document = (new DelimitedTextReader())->readTsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/cr-only-rows.tsv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $native = PandocConverter::write($document, 'native');
        ...
        $t->same('valid-checked-in-generated-tsv-native-parity-evidence', $generatedEvidence['validation']['status'] ?? null);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(['id', 'name', 'status1', 'Alpha', 'ready2', 'Beta', 'done'], $table->attr('columnNames'));
        $t->same(1, $packet['rowCount'] ?? null);
        $t->same(0, $packet['bodyRowCount'] ?? null);
        $t->same(7, $packet['columnCount'] ?? null);
        $t->same(7, $packet['fieldCount'] ?? null);
        ...
        $t->same(0, $packet['controlCharacters']['totalCount'] ?? null);
        $t->same([], $table->children[1]->children);
        $t->contains('Plain [ Str "status1" ]', $native);
        $t->contains('Plain [ Str "ready2" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    'matches generated tsv quote trailing native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv unicode safe native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv ragged blank fields native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv no header native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv bom leading whitespace native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv blank row literal punctuation native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv comment looking data native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv no header edge delimiters native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
        ...
        $t->same('ac289ede527edd0ce9fda8d797a316a12191a81a9a681a1de56af52448bb12f2', $generatedEvidence['checkedInFixtures'][17]['checkedInFile']['sha256'] ?? null);
        ...
        $t->same(12, $packet['fieldCount'] ?? null);
        $t->same(2, $packet['raggedRowCount'] ?? null);
        $t->same([1, 3], $packet['raggedRows'] ?? null);
        $t->same([], $packet['trailingDelimiterRows'] ?? null);
        ...
        $t->same('', $table->children[1]->children[3]->children[2]->attr('text'));
        $t->true(!str_contains($native, 'Str "last"'));
        $t->contains('Plain [ Str "alpha" ]', $native);
        $t->contains('Plain [ Str "trailing" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    'matches generated tsv csv quoted literal native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv keep space after tab native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv crlf rows native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv quoted tabs and newlines native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv blank leading header native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv basic status native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv header only native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv no header internal trailing empty native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv blank input native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv duplicate header labels native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv escaped quote dialect native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv literal quote tab split native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv literal quote newline split native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv leading blank whitespace native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv unquoted final form feed native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv leading empty fields native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv trailing empty fields native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv literal quote header native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv markdown syntax literal native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv interior empty header native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv trailing empty header native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv quoted softbreak native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv post delimiter space native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv delimiter only row native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedTsvNativeFixture('delimiter-only-row');
        $document = (new DelimitedTextReader())->readTsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/delimiter-only-row.tsv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $body = $table->children[1];
        ...
        $t->same('valid-checked-in-generated-tsv-native-parity-evidence', $generatedEvidence['validation']['status'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('delimiter-only-row.tsv', $generatedEvidence['checkedInFixtures'][64]['name'] ?? null);
        $t->same('3a6565c55c9edf509918a14410b2303017c4ba50cd6756d81c82f5b3c18e9a49', $generatedEvidence['checkedInFixtures'][64]['checkedInFile']['sha256'] ?? null);
        $t->same('delimiter-only-row.native', $generatedEvidence['checkedInFixtures'][65]['name'] ?? null);
        $t->same('7c35f383cedcdfe02af9e39232a63e94fce26b62c3750624110a5475cb9caddd', $generatedEvidence['checkedInFixtures'][65]['checkedInFile']['sha256'] ?? null);
        $t->same('delimiter-only-row', $generatedEvidence['samples'][32]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][32]['readerOptions'] ?? null);
        $t->same(['left', 'right'], $table->attr('columnNames'));
        $t->same(4, $packet['rowCount'] ?? null);
        $t->same(3, $packet['bodyRowCount'] ?? null);
        $t->same(2, $packet['columnCount'] ?? null);
        $t->same(8, $packet['fieldCount'] ?? null);
        $t->same(2, $packet['diagnosticCount'] ?? null);
        $t->same([2], $packet['trailingDelimiterRows'] ?? null);
        $t->same(0, $packet['rowRepairSummary']['changedRowCount'] ?? null);
        $t->same(['alpha', 'beta'], array_map(static fn (AstNode $cell): string => $cell->attr('text'), $body->children[0]->children));
        $t->same(['', ''], array_map(static fn (AstNode $cell): string => $cell->attr('text'), $body->children[1]->children));
        $t->same(['tail', 'end'], array_map(static fn (AstNode $cell): string => $cell->attr('text'), $body->children[2]->children));
        $t->same([], $body->children[1]->children[0]->children);
        $t->same([], $body->children[1]->children[1]->children);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    'matches generated tsv single quote dialect native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv escaped tab dialect native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedTsvNativeFixture('escaped-tab-dialect');
        $document = (new DelimitedTextReader())->readTsv($fixture['input'], [
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('escaped-tab-dialect.tsv', $generatedEvidence['checkedInFixtures'][68]['name'] ?? null);
        $t->same('045876667fbdafbdc984fb54e11ab05837d7fe3bc7c39469fae774b909452eb3', $generatedEvidence['checkedInFixtures'][68]['checkedInFile']['sha256'] ?? null);
        $t->same('escaped-tab-dialect.native', $generatedEvidence['checkedInFixtures'][69]['name'] ?? null);
        $t->same('68b50ae72ee5b99702e8dd6aafa1a2e909775e17e3954b5967c94b2e7b0c0404', $generatedEvidence['checkedInFixtures'][69]['checkedInFile']['sha256'] ?? null);
        $t->same('escaped-tab-dialect', $generatedEvidence['samples'][34]['name'] ?? null);
        $t->same(['quote' => '"', 'escape' => '\\'], $generatedEvidence['samples'][34]['readerOptions'] ?? null);
        $t->same(['id', 'payload', 'note'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        ...
        $t->same(0, $packet['diagnosticCount'] ?? null);
        $t->same(0, $packet['raggedRowCount'] ?? null);
        $t->same('escaped' . "\t" . 'separator', $body->children[0]->children[1]->attr('text'));
        $t->same('escaped\\slash', $body->children[1]->children[1]->attr('text'));
        $t->contains('Plain [ Str "escaped" , Space , Str "separator" ]', $native);
        $t->contains('Plain [ Str "escaped\\\\slash" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    'matches generated tsv pipe delimiter quoted field native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
    ...
    'matches generated tsv pre tab space native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedTsvNativeFixture('pre-tab-space');
        $document = (new DelimitedTextReader())->readTsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/pre-tab-space.tsv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $body = $table->children[1];
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('pre-tab-space.tsv', $generatedEvidence['checkedInFixtures'][80]['name'] ?? null);
        $t->same('7f2dfb3c381f25391f874dd0595c868c8d9cb62877063f96e10067349e062cea', $generatedEvidence['checkedInFixtures'][80]['checkedInFile']['sha256'] ?? null);
        $t->same('pre-tab-space.native', $generatedEvidence['checkedInFixtures'][81]['name'] ?? null);
        $t->same('81161ab475209b25b9ce6848c52f17752e3972e62acfd60e160d85d5ee8aff19', $generatedEvidence['checkedInFixtures'][81]['checkedInFile']['sha256'] ?? null);
        $t->same('pre-tab-space', $generatedEvidence['samples'][40]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][40]['readerOptions'] ?? null);
        $t->same(['field ', 'tab_gap ', 'note'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(3, $packet['columnCount'] ?? null);
        $t->same(9, $packet['fieldCount'] ?? null);
        ...
        $t->same(0, $packet['blankRowCount'] ?? null);
        $t->same(0, $packet['diagnosticCount'] ?? null);
        $t->same('A1 ', $body->children[0]->children[0]->attr('text'));
        $t->same('left tab space ', $body->children[0]->children[1]->attr('text'));
        $t->same('keeps trailing spaces before tab', $body->children[0]->children[2]->attr('text'));
        $t->same('B2 ', $body->children[1]->children[0]->attr('text'));
        $t->same('edge ', $body->children[1]->children[1]->attr('text'));
        $t->same('done', $body->children[1]->children[2]->attr('text'));
        $t->contains('Plain [ Str "field" , Space ]', $native);
        $t->contains('Plain [ Str "left" , Space , Str "tab" , Space , Str "space" , Space ]', $native);
        $t->contains('Plain [ Str "B2" , Space ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    'matches generated tsv literal quote space boundary native parity fixture without inflating upstream tsv direct denominator' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedTsvNativeFixture('literal-quote-space-boundaries');
        $document = (new DelimitedTextReader())->readTsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/literal-quote-space-boundaries.tsv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $body = $table->children[1];
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('literal-quote-space-boundaries.tsv', $generatedEvidence['checkedInFixtures'][82]['name'] ?? null);
        $t->same('435768f05720cc81f3bcca83538fa8d21cb3ac6d8f5b1db46301a5233e00e4c7', $generatedEvidence['checkedInFixtures'][82]['checkedInFile']['sha256'] ?? null);
        $t->same('literal-quote-space-boundaries.native', $generatedEvidence['checkedInFixtures'][83]['name'] ?? null);
        $t->same('9ca78daf730e41c6ee96496bbf856d1f3dd95e486da8afef939551e756d1ded7', $generatedEvidence['checkedInFixtures'][83]['checkedInFile']['sha256'] ?? null);
        $t->same('literal-quote-space-boundaries', $generatedEvidence['samples'][41]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][41]['readerOptions'] ?? null);
        $t->same(['id', 'payload', 'note'], $table->attr('columnNames'));
        $t->same(4, $packet['rowCount'] ?? null);
        $t->same(3, $packet['bodyRowCount'] ?? null);
        ...
        $t->same('"alpha"', $body->children[0]->children[1]->attr('text'));
        $t->same('"beta"  ', $body->children[1]->children[1]->attr('text'));
        $t->same('"gamma"  ', $body->children[2]->children[1]->attr('text'));
        $t->same('leading space before quote', $body->children[0]->children[2]->attr('text'));
        $t->same('spaces before delimiter', $body->children[1]->children[2]->attr('text'));
        $t->same('both sides literal', $body->children[2]->children[2]->attr('text'));
        $t->contains('Plain [ Str "\"alpha\"" ]', $native);
        $t->contains('Plain [ Str "\"beta\"" , Space ]', $native);
    ...
    'matches generated tsv consecutive tab empty field native parity fixture with pandoc executable backing' => static function (TestRunner $t) use ($generatedTsvNativeFixture, $nativeTokenStream): void {
        $fixture = $generatedTsvNativeFixture('consecutive-tab-empty-field');
        $document = (new DelimitedTextReader())->readTsv($fixture['input'], [
            'sourcePath' => 'lanes/pandoc/fixtures/generated-current-tsv-reader/consecutive-tab-empty-field.tsv',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $body = $table->children[1];
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['sampleCount'] ?? null);
        $t->same(2 * DelimitedTextUpstreamReaderEvidence::EXPECTED_GENERATED_TSV_NATIVE_SAMPLE_COUNT, $generatedEvidence['checkedInFixtureCount'] ?? null);
        $t->same('consecutive-tab-empty-field.tsv', $generatedEvidence['checkedInFixtures'][86]['name'] ?? null);
        $t->same('9d017e09daf50ea87f98311daa05e5e27b6175262d731732ae384a96dbe3b5ac', $generatedEvidence['checkedInFixtures'][86]['checkedInFile']['sha256'] ?? null);
        $t->same('consecutive-tab-empty-field.native', $generatedEvidence['checkedInFixtures'][87]['name'] ?? null);
        $t->same('d038f31032b5c3870f5912fc99686f7372595f30412ff45f7a4827ef6de70902', $generatedEvidence['checkedInFixtures'][87]['checkedInFile']['sha256'] ?? null);
        $t->same('consecutive-tab-empty-field', $generatedEvidence['samples'][43]['name'] ?? null);
        $t->same([], $generatedEvidence['samples'][43]['readerOptions'] ?? null);
        $t->same(['id', 'note', 'status', 'flag'], $table->attr('columnNames'));
        $t->same(3, $packet['rowCount'] ?? null);
        $t->same(2, $packet['bodyRowCount'] ?? null);
        $t->same(4, $packet['columnCount'] ?? null);
        $t->same(12, $packet['fieldCount'] ?? null);
        ...
        $t->same('', $body->children[0]->children[1]->attr('text'));
        $t->same([], $body->children[0]->children[1]->children);
        $t->same('alpha', $body->children[0]->children[2]->attr('text'));
        $t->same('ok', $body->children[0]->children[3]->attr('text'));
        $t->same('2', $body->children[1]->children[0]->attr('text'));
        $t->same('beta', $body->children[1]->children[1]->attr('text'));
        $t->same('done', $body->children[1]->children[2]->attr('text'));
        $t->same('yes', $body->children[1]->children[3]->attr('text'));
        $t->contains('Cell ( "" , [  ] , [  ] ) AlignDefault (RowSpan 1) (ColSpan 1) []', $native);
        $t->contains('Plain [ Str "beta" ]', $native);
        $t->same($nativeTokenStream($fixture['native']), $nativeTokenStream($native));
    },
    ...
    'records csv and tsv upstream evidence boundaries separately' => static function (TestRunner $t): void {
        ...
        $t->same('quoted-crlf-linebreak', $csvEvidence['generatedNativeParityEvidence']['samples'][53]['name'] ?? null);
        $t->same([], $csvEvidence['generatedNativeParityEvidence']['samples'][53]['readerOptions'] ?? null);
        $t->same('quoted-bare-cr-normalized', $csvEvidence['generatedNativeParityEvidence']['samples'][54]['name'] ?? null);
        $t->same([], $csvEvidence['generatedNativeParityEvidence']['samples'][54]['readerOptions'] ?? null);
        $t->same('single-quote-double-quote-literal', $csvEvidence['generatedNativeParityEvidence']['samples'][60]['name'] ?? null);
        $t->same(['quote' => '\''], $csvEvidence['generatedNativeParityEvidence']['samples'][60]['readerOptions'] ?? null);
        $t->same('keep-space-before-quote', $csvEvidence['generatedNativeParityEvidence']['samples'][61]['name'] ?? null);
        ...
        $t->same(true, $csvEvidence['runnerEvidence']['target']['tsvDirectFixtureAvailable'] ?? null);
        $t->same('test/command/8661.md', $csvEvidence['runnerEvidence']['target']['tsvDirectCommandFixture'] ?? null);
        $t->same('gfm', $csvEvidence['runnerEvidence']['target']['tsvDirectOutputFormat'] ?? null);
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $csvStatic['readerDenominator']['tsvDirectFixtureCount'] ?? null);
        $t->same(['test/command/8661.md'], $csvStatic['readerDenominator']['tsvDirectFixtures'] ?? null);
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $csvStatic['generatedTsvNativeStaticEvidence']['tsvDirectFixtureDenominator'] ?? null);
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $tsvEvidence['denominator'] ?? null);
        $t->same('direct-reader-fixtures', $tsvEvidence['denominatorScope'] ?? null);
        $t->same(['test/command/8661.md'], $tsvEvidence['fixtures'] ?? null);
        $t->same('tsv', $tsvEvidence['selectedDirectFixtureFormat'] ?? null);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $tsvEvidence['directFixtureDenominator'] ?? null);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $tsvEvidence['directFixtureCount'] ?? null);
        $t->same(['test/command/8661.md'], $tsvEvidence['directFixtures'] ?? null);
        ...
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $tsvEvidence['tsvDirectFixtureDenominator'] ?? null);
        ...
        $t->same('delimiter-only-row', $tsvEvidence['generatedNativeParityEvidence']['samples'][32]['name'] ?? null);
        $t->same([], $tsvEvidence['generatedNativeParityEvidence']['samples'][32]['readerOptions'] ?? null);
        $t->same('single-quote-dialect', $tsvEvidence['generatedNativeParityEvidence']['samples'][33]['name'] ?? null);
        ...
        $t->true(in_array('direct-tsv-command-reader', $tsvEvidence['closedGaps'] ?? [], true));
        $t->true(in_array('generated-tsv-native-parity-sample', $tsvEvidence['closedGaps'] ?? [], true));
        $t->true(in_array('tsv-gfm-pipe-table-writer-output-not-claimed', $tsvEvidence['openGaps'] ?? [], true));
        ...
        $t->same(true, $tsvEvidence['runnerEvidence']['target']['tsvDirectFixtureAvailable'] ?? null);
        $t->same('test/command/8661.md', $tsvEvidence['runnerEvidence']['target']['tsvDirectCommandFixture'] ?? null);
        $t->same('gfm', $tsvEvidence['runnerEvidence']['target']['tsvDirectOutputFormat'] ?? null);
        ...
        $t->true(in_array('TSV direct command evidence includes test/command/8661.md from the pinned upstream corpus.', $tsvEvidence['claimBoundaries'] ?? [], true));
        $t->same($csvEvidence['staticCurrentEvidence'] ?? null, $tsvEvidence['staticCurrentEvidence'] ?? null);
    },
    'matches upstream tsv command fixture reader ast without claiming gfm writer output' => static function (TestRunner $t) use ($upstreamTsvGfmCommandFixture): void {
        $fixture = $upstreamTsvGfmCommandFixture();
        $document = (new DelimitedTextReader())->readTsv($fixture['input'], [
            'sourcePath' => 'test/command/8661.md',
        ]);
        $table = $document->children[0];
        $packet = $table->attr('delimitedText');
        $body = $table->children[1];
        ...
        $t->same('tsv', $document->attr('sourceFormat'));
        $t->same('table', $table->type);
        $t->same(['a', 'b', 'c'], $table->attr('columnNames'));
        $t->same(['a', 'b', 'c'], $packet['columnNames'] ?? null);
        $t->same('tsv', $packet['format'] ?? null);
        $t->same('tab', $packet['delimiter'] ?? null);
        $t->same(2, $packet['rowCount'] ?? null);
        $t->same(1, $packet['bodyRowCount'] ?? null);
        ...
        $t->same(0, $packet['diagnosticCount'] ?? null);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $packet['upstreamEvidence']['denominator'] ?? null);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $packet['upstreamEvidence']['directFixtureCount'] ?? null);
        $t->same(DelimitedTextUpstreamReaderEvidence::EXPECTED_STATIC_TSV_DIRECT_FIXTURE_COUNT, $packet['upstreamEvidence']['tsvDirectFixtureDenominator'] ?? null);
        $t->same(['test/command/8661.md'], $packet['upstreamEvidence']['directFixtures'] ?? null);
        $t->same(['test/command/8661.md'], $packet['upstreamEvidence']['fixtures'] ?? null);
        $t->true(in_array('direct-tsv-command-reader', $packet['upstreamEvidence']['closedGaps'] ?? [], true));
        $t->true(in_array('tsv-gfm-pipe-table-writer-output-not-claimed', $packet['upstreamEvidence']['openGaps'] ?? [], true));
        $t->contains('|     |     | 6   |', $fixture['gfm']);
        $t->same('', $body->children[0]->children[0]->attr('text'));
        $t->same('', $body->children[0]->children[1]->attr('text'));
        $t->same('6', $body->children[0]->children[2]->attr('text'));
        $t->same([], $body->children[0]->children[0]->children);
        $t->same([], $body->children[0]->children[1]->children);
        $t->same('plain', $body->children[0]->children[2]->children[0]->type ?? null);
        $t->same('text', $body->children[0]->children[2]->children[0]->children[0]->type ?? null);
        $t->same('6', $body->children[0]->children[2]->children[0]->children[0]->attr('text') ?? null);
    },
    ...
    'records csv and tsv control character row repair interaction summaries' => static function (TestRunner $t): void {
        ...
        $t->same('pandoc-first-row-width', $csvRepair['policy'] ?? null);
        ...
        $t->same('annotate-controls-after-pandoc-row-normalization', $csvControlRepair['policy'] ?? null);
        ...
        $t->same('pandoc-first-row-width', $tsvRepair['policy'] ?? null);
    ...
    'records csv header row width repair provenance without widening table output' => static function (TestRunner $t): void {
        ...
        $t->same('pandoc-first-row-width', $repairSummary['policy'] ?? null);
        ...
        $t->same('pandoc-first-row-width', $relaxedDiagnostic['policy'] ?? null);
