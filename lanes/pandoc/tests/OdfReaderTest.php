...
XML;
        ...
        $t->same(['package-signature', 'manifest-declared'], $provenanceParts['META-INF/packagesignatures.xml']['roles']);
        $t->same(['package-signature', 'undeclared-package-entry'], $provenanceParts['META-INF/orphan-signatures.xml']['roles']);
