...
$spanCases = [
    ...
    'underline text decoration line style' => [
        ...
        'type' => 'span',
        'text' => 'under',
        'attributes' => ['style' => 'text-decoration-line: underline'],
    ],
    ...
    'strikeout style with id and data' => [
        ...
        'text' => 'deleted',
        'id' => 'strike-id',
        'attributes' => ['case' => 'strike', 'style' => 'text-decoration: line-through'],
    ],
