...
return [
    ...
    'preflights deterministic zip package manifest for shared package ingestion' => static function (TestRunner $t) use ($buildZipPackage, $crc32, $pathSegmentPositionReviews): void {
        ...
        $expectedHash = hash('sha256', json_encode([
            ...
            'dosAttributeProvenanceVersion' => $manifest['dosAttributeProvenanceVersion'],
            'dosAttributeEntryCount' => $manifest['dosAttributeEntryCount'],
            'hasDosAttributeEntries' => $manifest['hasDosAttributeEntries'],
            'hiddenSystemOrVolumeLabelEntryCount' => $manifest['hiddenSystemOrVolumeLabelEntryCount'],
            'hasHiddenSystemOrVolumeLabelEntries' => $manifest['hasHiddenSystemOrVolumeLabelEntries'],
            'dosAttributeNames' => $manifest['dosAttributeNames'],
            'dosAttributeNameCounts' => $manifest['dosAttributeNameCounts'],
            'entryNamesByDosAttributeName' => $manifest['entryNamesByDosAttributeName'],
            'dosAttributeIssueCounts' => $manifest['dosAttributeIssueCounts'],
            'entryNamesByDosAttributeIssue' => $manifest['entryNamesByDosAttributeIssue'],
            'dosAttributeSummaryCount' => $manifest['dosAttributeSummaryCount'],
            'dosAttributeSummaries' => $manifest['dosAttributeSummaries'],
            'internalAttributeProvenanceVersion' => $manifest['internalAttributeProvenanceVersion'],
            'internalAttributeEntryCount' => $manifest['internalAttributeEntryCount'],
            'hasInternalAttributeEntries' => $manifest['hasInternalAttributeEntries'],
            ...
            'internalAttributeNames' => $manifest['internalAttributeNames'],
            'internalAttributeNameCounts' => $manifest['internalAttributeNameCounts'],
            'entryNamesByInternalAttributeName' => $manifest['entryNamesByInternalAttributeName'],
            'internalAttributeIssueCounts' => $manifest['internalAttributeIssueCounts'],
            'entryNamesByInternalAttributeIssue' => $manifest['entryNamesByInternalAttributeIssue'],
