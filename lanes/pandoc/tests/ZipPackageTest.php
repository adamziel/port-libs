...
return [
    ...
    'preflights deterministic zip package manifest for shared package ingestion' => static function (TestRunner $t) use ($buildZipPackage, $crc32, $pathSegmentPositionReviews): void {
        ...
        $expectedHash = hash('sha256', json_encode([
            ...
            'hasPackagePrefix' => $manifest['hasPackagePrefix'],
            'packagePrefixOffset' => $manifest['packagePrefixOffset'],
            'packagePrefixBytes' => $manifest['packagePrefixBytes'],
            'packagePrefixSha256' => $manifest['packagePrefixSha256'],
            'packagePrefixPreviewHex' => $manifest['packagePrefixPreviewHex'],
            'packagePrefixPreviewByteCount' => $manifest['packagePrefixPreviewByteCount'],
            'packagePrefixSignature' => $manifest['packagePrefixSignature'],
            'hasExecutableStubPackagePrefix' => $manifest['hasExecutableStubPackagePrefix'],
            'firstLocalHeaderOffset' => $manifest['firstLocalHeaderOffset'],
            'centralDirectoryOffsetAfterPackagePrefix' => $manifest['centralDirectoryOffsetAfterPackagePrefix'],
            'endOfCentralDirectoryOffsetAfterPackagePrefix' => $manifest['endOfCentralDirectoryOffsetAfterPackagePrefix'],
            'packagePrefixByteExposurePolicy' => $manifest['packagePrefixByteExposurePolicy'],
            'canExposePackagePrefixBytes' => $manifest['canExposePackagePrefixBytes'],
            'packagePrefixIssueCount' => $manifest['packagePrefixIssueCount'],
            'packagePrefixIssues' => $manifest['packagePrefixIssues'],
            'packageLayoutWithoutPrefixSupported' => $manifest['packageLayoutWithoutPrefixSupported'],
