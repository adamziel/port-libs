...
<office:document-styles
  ...
  <office:styles>
    ...
    <style:style style:name="SafeText" style:family="text"/>
  </office:styles>
</office:document-styles>
XML);
        $zip->addFromString('content.xml', <<<'XML'
...
<office:document-content
  ...
  <office:body>
    <office:text>
      <text:p><text:span text:style-name="CycleA">Cyclic style</text:span> and <text:span text:style-name="SafeText">safe style</text:span>.</text:p>
    </office:text>
  </office:body>
</office:document-content>
XML);
        ...
        $t->same('text', $diagnostic['family']);
        $t->same('paragraph', $document->children[0]->type);
        $t->same('Cyclic style and safe style.', $document->children[0]->attr('text'));
    },
