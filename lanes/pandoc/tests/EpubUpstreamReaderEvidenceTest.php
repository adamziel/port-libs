...
return [
    'reports skipped epub reader evidence when upstream root is absent' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        try {
            ...
            $t->contains('Native/package parity: package=0/58 nativeAst=0/58 status=not-evaluated-source-directory-unavailable', $text);
            $t->contains('Executable/native parity: localPandoc=0/58 checkedNative=0/58 status=not-evaluated-not-requested version=not-evaluated', $text);
    ...
    'validates checked-in current epub reader evidence through fixture base' => static function (TestRunner $t) use ($repoRoot, $checkedInFixtureRoot, $expectedCurrentReaderStaticSignatureSha256, $expectedReferencedFixtureIdentity): void {
        ...
        $t->same(58, $nativePackageParity['requiredEpubCount']);
        $t->same(58, $nativePackageParity['requiredPairCount']);
        $t->same(58, $nativePackageParity['totalEpubCount']);
        $t->same(58, $nativePackageParity['comparedEpubCount']);
        $t->same(58, $nativePackageParity['packageParsedCount']);
        $t->same(58, $nativePackageParity['readerParsedCount']);
        ...
        $t->same(58, $nativePackageParity['totalPairCount']);
        $t->same(58, $nativePackageParity['comparedPairCount']);
        $t->same(58, $nativePackageParity['bothParsedCount']);
        $t->same(0, $nativePackageParity['astParseFailureCount']);
        $t->same(0, $nativePackageParity['nativeParseFailureCount']);
        $t->same(58, $nativePackageParity['normalizedAstMatchCount']);
        ...
        $t->contains('Native/package parity: package=58/58 nativeAst=58/58 status=normalized-ast-equality-observed-not-runner-parity', $text);
        $t->same('not-evaluated', $report['executableNativeAstParity']['status']);
        $t->same('not-requested', $report['executableNativeAstParity']['reason']);
        $t->same(false, EpubUpstreamReaderEvidence::hasRequiredExecutableNativeAstParity($report));
        $t->same(true, EpubUpstreamReaderEvidence::hasNoValidationIssues($report));
    ...
    'validates checked-in current epub executable native ast parity with supplied pandoc' => static function (TestRunner $t) use ($makeTempDir, $removeTree, $repoRoot, $checkedInFixtureRoot, $writeFakePandoc): void {
        ...
        try {
            ...
            $t->same(58, $executableParity['requiredEpubCount']);
            $t->same(58, $executableParity['totalEpubCount']);
            $t->same(58, $executableParity['comparedEpubCount']);
            $t->same(58, $executableParity['localParsedCount']);
            $t->same(58, $executableParity['pandocParsedCount']);
            $t->same(58, $executableParity['nativeFixtureParsedCount']);
            $t->same(58, $executableParity['bothParsedCount']);
            $t->same(0, $executableParity['parseFailureCount']);
            $t->same(58, $executableParity['normalizedAstMatchCount']);
            $t->same(0, $executableParity['normalizedAstMismatchCount']);
            $t->same(58, $executableParity['pandocNativeFixtureComparedCount']);
            $t->same(58, $executableParity['pandocNativeFixtureMatchCount']);
            $t->same(0, $executableParity['pandocNativeFixtureMismatchCount']);
            $t->same(58, $executableParity['pandocNativeFixtureByteComparedCount']);
            $t->same(58, $executableParity['pandocNativeFixtureByteMatchCount']);
            ...
            $t->contains('Executable/native parity: localPandoc=58/58 checkedNative=58/58 status=normalized-ast-equality-observed-against-pandoc-executable version=pandoc fake 3.10', $text);
...
HS);
    ...
    'cli gates checked-in current epub reader evidence through checked-in fixtures mode' => static function (TestRunner $t) use ($makeTempDir, $removeTree, $repoRoot, $checkedInFixtureRoot, $expectedCurrentReaderStaticSignatureSha256, $expectedReferencedFixtureIdentity, $writeFakePandoc): void {
        ...
        try {
            ...
            $t->same(58, $decoded['nativeAstPackageParity']['normalizedAstMatchCount']);
            ...
            $t->same(58, $decoded['executableNativeAstParity']['normalizedAstMatchCount']);
            $t->same(58, $decoded['executableNativeAstParity']['pandocNativeFixtureMatchCount']);
