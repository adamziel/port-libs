...
return [
    'reports skipped epub reader evidence when upstream root is absent' => static function (TestRunner $t) use ($makeTempDir, $removeTree): void {
        ...
        try {
            ...
            $t->contains('Native/package parity: package=0/63 nativeAst=0/63 status=not-evaluated-source-directory-unavailable', $text);
            $t->contains('Executable/native parity: localPandoc=0/63 checkedNative=0/63 status=not-evaluated-not-requested version=not-evaluated', $text);
    ...
    'validates checked-in current epub reader evidence through fixture base' => static function (TestRunner $t) use ($repoRoot, $checkedInFixtureRoot, $expectedCurrentReaderStaticSignatureSha256, $expectedReferencedFixtureIdentity): void {
        ...
        $t->same(63, $nativePackageParity['requiredEpubCount']);
        $t->same(63, $nativePackageParity['requiredPairCount']);
        $t->same(63, $nativePackageParity['totalEpubCount']);
        $t->same(63, $nativePackageParity['comparedEpubCount']);
        $t->same(63, $nativePackageParity['packageParsedCount']);
        $t->same(63, $nativePackageParity['readerParsedCount']);
        ...
        $t->same(63, $nativePackageParity['totalPairCount']);
        $t->same(63, $nativePackageParity['comparedPairCount']);
        $t->same(63, $nativePackageParity['bothParsedCount']);
        $t->same(0, $nativePackageParity['astParseFailureCount']);
        $t->same(0, $nativePackageParity['nativeParseFailureCount']);
        $t->same(63, $nativePackageParity['normalizedAstMatchCount']);
        ...
        $t->contains('Native/package parity: package=63/63 nativeAst=63/63 status=normalized-ast-equality-observed-not-runner-parity', $text);
        $t->same('not-evaluated', $report['executableNativeAstParity']['status']);
        $t->same('not-requested', $report['executableNativeAstParity']['reason']);
        $t->same(false, EpubUpstreamReaderEvidence::hasRequiredExecutableNativeAstParity($report));
        $t->same(true, EpubUpstreamReaderEvidence::hasNoValidationIssues($report));
    ...
    'validates checked-in current epub executable native ast parity with supplied pandoc' => static function (TestRunner $t) use ($makeTempDir, $removeTree, $repoRoot, $checkedInFixtureRoot, $writeFakePandoc): void {
        ...
        try {
            ...
            $t->same(63, $executableParity['requiredEpubCount']);
            $t->same(63, $executableParity['totalEpubCount']);
            $t->same(63, $executableParity['comparedEpubCount']);
            $t->same(63, $executableParity['localParsedCount']);
            $t->same(63, $executableParity['pandocParsedCount']);
            $t->same(63, $executableParity['nativeFixtureParsedCount']);
            $t->same(63, $executableParity['bothParsedCount']);
            $t->same(0, $executableParity['parseFailureCount']);
            $t->same(63, $executableParity['normalizedAstMatchCount']);
            $t->same(0, $executableParity['normalizedAstMismatchCount']);
            $t->same(63, $executableParity['pandocNativeFixtureComparedCount']);
            $t->same(63, $executableParity['pandocNativeFixtureMatchCount']);
            $t->same(0, $executableParity['pandocNativeFixtureMismatchCount']);
            $t->same(63, $executableParity['pandocNativeFixtureByteComparedCount']);
            $t->same(63, $executableParity['pandocNativeFixtureByteMatchCount']);
            ...
            $t->contains('Executable/native parity: localPandoc=63/63 checkedNative=63/63 status=normalized-ast-equality-observed-against-pandoc-executable version=pandoc fake 3.10', $text);
...
HS);
    ...
    'cli gates checked-in current epub reader evidence through checked-in fixtures mode' => static function (TestRunner $t) use ($makeTempDir, $removeTree, $repoRoot, $checkedInFixtureRoot, $expectedCurrentReaderStaticSignatureSha256, $expectedReferencedFixtureIdentity, $writeFakePandoc): void {
        ...
        try {
            ...
            $t->same(63, $decoded['nativeAstPackageParity']['normalizedAstMatchCount']);
            ...
            $t->same(63, $decoded['executableNativeAstParity']['normalizedAstMatchCount']);
            $t->same(63, $decoded['executableNativeAstParity']['pandocNativeFixtureMatchCount']);
