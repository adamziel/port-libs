...
XML;
    ...
    'summarizes compact ODT manifest suffix references without marking stripped parts undeclared' => static function (TestRunner $t) use ($buildOdtPackage, $manifestXml, $contentXml): void {
        ...
        $t->same(['image' => 1, 'xml' => 2], $review['manifestPartReferenceSuffixMediaFamilyCounts']);
        $t->same(['missing-package-part' => 1, 'package-bytes-exposable' => 2], $review['manifestPartReferenceSuffixByteExposurePolicyCounts']);
