...
XML;
        ...
        $t->same(['odf-settings', 'manifest-declared'], $inventory['settings.xml']['roles']);
        $t->same('settings.xml', $inventory['settings.xml']['manifestPath']);
        $t->same('text/xml', $inventory['settings.xml']['manifestMediaType']);
        $t->same(true, $inventory['settings.xml']['declaredInManifest']);
        $t->same(false, $inventory['settings.xml']['undeclared']);
