...
XML;
    ...
    'reports compact ODT embedded object package provenance without media byte exposure' => static function (TestRunner $t) use ($buildOdtPackage, $manifestXml): void {
        ...
        $t->same(4, $objects['containedMediaTypeSummary']['partCount']);
        $t->same(3, $objects['containedMediaTypeSummary']['declaredPartCount']);
        ...
        $t->same(strlen($chartContent) + strlen($chartPreview) + strlen($chartRdf) + strlen($oleBytes), $objects['containedMediaTypeSummary']['byteLength']);
        $t->same(['Object Chart/content.xml'], $objects['containedMediaTypeSummary']['byMediaTypeBase']['text/xml']['parts']);
        ...
        $t->same(3, $chart['containedMediaTypeSummary']['partCount']);
        $t->same(2, $chart['containedMediaTypeSummary']['declaredPartCount']);
        $t->same(1, $chart['containedMediaTypeSummary']['undeclaredPartCount']);
        $t->same(['Object Chart/content.xml'], $chart['containedMediaTypeSummary']['byMediaTypeBase']['text/xml']['parts']);
...
XML;
    ...
    'surfaces compact ODT ZIP package comments as metadata-only provenance' => static function (TestRunner $t) use ($manifestXml, $contentXml, $stylesXml, $metaXml): void {
        ...
        $t->same($packageManifest, $inventory['zipPackageManifest']);
        $t->same($packageManifest['manifestSha256'], $inventory['zipPackageManifestSha256']);
        $t->same($packageManifest['packageSource'], $inventory['packageSource']);
        $t->same($packageManifest['archiveSha256'], $inventory['archiveSha256']);
        $t->same($packageManifest['centralDirectorySha256'], $inventory['centralDirectorySha256']);
        $t->same($packageManifest['endOfCentralDirectorySha256'], $inventory['endOfCentralDirectorySha256']);
        $t->same($packageManifest['packageCommentSha256'], $inventory['packageCommentSha256']);
        $t->same($localHeaderMetadata['entryCount'], $inventory['localHeaderMetadataEntryCount']);
        $t->same($localHeaderMetadata['totalEntryCount'], $inventory['localHeaderMetadataTotalEntryCount']);
        $t->same($localHeaderMetadata['centralDirectoryOffset'], $inventory['localHeaderMetadataCentralDirectoryOffset']);
        $t->same($localHeaderMetadata['centralDirectorySize'], $inventory['localHeaderMetadataCentralDirectoryBytes']);
        $t->same(true, $inventory['localHeaderMetadataIsSupportedByBoundedReader']);
        $t->same([], $inventory['localHeaderMetadataIssueCodes']);
        $t->same(0, $inventory['localHeaderMetadataMismatchEntryCount']);
        $t->same([], $inventory['localHeaderMetadataMismatchedEntries']);
        $t->same(strlen('odt package review'), $inventory['packageCommentBytes']);
        $t->same(false, $inventory['hasCentralDirectorySignature']);
        ...
        $t->same($inventory['localHeaderMetadataEntryCount'], $identity['localHeaderMetadataEntryCount']);
        $t->same($inventory['localHeaderMetadataIsSupportedByBoundedReader'], $identity['localHeaderMetadataIsSupportedByBoundedReader']);
        $t->same($inventory['localHeaderMetadataIssueCodes'], $identity['localHeaderMetadataIssueCodes']);
        $t->same($inventory['localHeaderMetadataMismatchEntryCount'], $identity['localHeaderMetadataMismatchEntryCount']);
        $t->same($inventory['localHeaderMetadataMismatchedEntries'], $identity['localHeaderMetadataMismatchedEntries']);
    ...
    'surfaces compact ODT central directory signatures as metadata-only provenance' => static function (TestRunner $t) use ($manifestXml, $contentXml, $stylesXml, $metaXml, $addCentralDirectorySignatureRecord): void {
        ...
        $t->same($packageManifest['centralDirectoryToEocdGapBytes'], $inventory['centralDirectoryToEocdGapBytes']);
        $t->same($packageManifest['centralDirectoryToEocdGapSha256'], $inventory['centralDirectoryToEocdGapSha256']);
        $t->same($inventory['centralDirectoryToEocdGapBytes'], $identity['centralDirectoryToEocdGapBytes']);
        $t->same($inventory['centralDirectoryToEocdGapSha256'], $identity['centralDirectoryToEocdGapSha256']);
