...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 33));
        ...
        $t->contains('Native AST mapped parity: 33/33', $text);
        $t->contains('Native AST fixture inventory: html=48 native=33 paired=33 unpairedHtml=15 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(33, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=33'
        ...
        $t->same(33, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
