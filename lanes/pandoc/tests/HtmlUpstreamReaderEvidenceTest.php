...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 29));
        ...
        $t->contains('Native AST mapped parity: 29/29', $text);
        $t->contains('Native AST fixture inventory: html=48 native=29 paired=29 unpairedHtml=19 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(29, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=29'
        ...
        $t->same(29, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
