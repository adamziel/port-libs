...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 47));
        ...
        $t->contains('Native AST mapped parity: 47/47', $text);
        $t->contains('Native AST fixture inventory: html=48 native=47 paired=47 unpairedHtml=1 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(47, $evidence['readerDenominator']['nativeMappedPairCount']);
