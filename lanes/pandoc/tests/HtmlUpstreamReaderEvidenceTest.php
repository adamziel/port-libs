...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 45));
        ...
        $t->contains('Native AST mapped parity: 45/45', $text);
        $t->contains('Native AST fixture inventory: html=48 native=45 paired=45 unpairedHtml=3 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(45, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=45'
        ...
        $t->same(45, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
