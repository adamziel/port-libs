...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 32));
        ...
        $t->contains('Native AST mapped parity: 32/32', $text);
        $t->contains('Native AST fixture inventory: html=48 native=32 paired=32 unpairedHtml=16 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(32, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=32'
        ...
        $t->same(32, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
