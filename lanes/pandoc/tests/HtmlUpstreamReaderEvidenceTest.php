...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 35));
        ...
        $t->contains('Native AST mapped parity: 35/35', $text);
        $t->contains('Native AST fixture inventory: html=48 native=35 paired=35 unpairedHtml=13 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(35, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=35'
        ...
        $t->same(35, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
