...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 34));
        ...
        $t->contains('Native AST mapped parity: 34/34', $text);
        $t->contains('Native AST fixture inventory: html=48 native=34 paired=34 unpairedHtml=14 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(34, $evidence['readerDenominator']['nativeMappedPairCount']);
