...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredSelectedFixtureCount($report, 133));
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredStaticCurrentEvidence($report));
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 133));
        ...
        $t->contains('Static current evidence: valid-checked-in-current-html-reader-evidence checkedInFixtures=133 nativePairs=133', $text);
        $t->contains('Native AST mapped parity: 133/133', $text);
        $t->contains('Native AST fixture inventory: html=133 native=133 paired=133 unpairedHtml=0 unpairedNative=0', $text);
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(133, $evidence['readerDenominator']['selectedFixtureCount']);
        ...
        $t->same(133, $evidence['readerDenominator']['nativeMappedPairCount']);
        ...
        $t->same(133, $evidence['checkedInFixtureCount']);
        $t->same(133, $evidence['checkedInNativePairCount']);
        ...
        $t->same('upstream-html-standalone-b-i-inline.html', $evidence['checkedInFixtures'][118]['name']);
        $t->same('504912dd740ea221ec0741dfb400072f587ff206f87cea26d4226600ab63a24f', $evidence['checkedInFixtures'][118]['checkedInFile']['sha256']);
        $t->same(26, $evidence['checkedInFixtures'][118]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][118]['sourceKind']);
        $t->same('standalone-inline-html', $evidence['readerDenominator']['selectedFixtures'][118]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-standalone-b-i-inline.native', $evidence['checkedInFixtures'][118]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][118]['checkedInNativePairFile']['present']);
        $t->same('8be3690acb0b9dd993f06c96a25a4a73b43b4d0fc927e90bfcf47794db356867', $evidence['checkedInFixtures'][118]['checkedInNativePairFile']['sha256']);
        $t->same(61, $evidence['checkedInFixtures'][118]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][118]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-pre-code-class-precedence.html', $evidence['checkedInFixtures'][119]['name']);
        $t->same('5a80c115dc5d4ed5883e0c1d6e67f9f6d77bdbbdfc0ed3683633086777dac57c', $evidence['checkedInFixtures'][119]['checkedInFile']['sha256']);
        $t->same(212, $evidence['checkedInFixtures'][119]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][119]['sourceKind']);
        $t->same('inline-and-metadata', $evidence['readerDenominator']['selectedFixtures'][119]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-pre-code-class-precedence.native', $evidence['checkedInFixtures'][119]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][119]['checkedInNativePairFile']['present']);
        $t->same('034d2b03275c6a040831ccebdb7a6101b9e59d478cda306b9a02549e4e09bf9e', $evidence['checkedInFixtures'][119]['checkedInNativePairFile']['sha256']);
        $t->same(141, $evidence['checkedInFixtures'][119]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][119]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-paragraph-definition-list-tree-construction.html', $evidence['checkedInFixtures'][120]['name']);
        $t->same('3307984364ad9d3d7cbfd5d3f09f6f0578f7320a00cfff1cf5117c7089b14684', $evidence['checkedInFixtures'][120]['checkedInFile']['sha256']);
        $t->same(108, $evidence['checkedInFixtures'][120]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][120]['sourceKind']);
        $t->same('block-structure', $evidence['readerDenominator']['selectedFixtures'][120]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-paragraph-definition-list-tree-construction.native', $evidence['checkedInFixtures'][120]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][120]['checkedInNativePairFile']['present']);
        $t->same('2853e5a88333005071643a9cabe1d7c55421f08762748fe47a821922a502d04e', $evidence['checkedInFixtures'][120]['checkedInNativePairFile']['sha256']);
        $t->same(209, $evidence['checkedInFixtures'][120]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][120]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-base-fragment-link.html', $evidence['checkedInFixtures'][121]['name']);
        $t->same('1841247f84acfab6aef873b7f7354d0fe12c55dff00100d0e6f8a08597cc86e7', $evidence['checkedInFixtures'][121]['checkedInFile']['sha256']);
        $t->same(231, $evidence['checkedInFixtures'][121]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][121]['sourceKind']);
        $t->same('inline-and-metadata', $evidence['readerDenominator']['selectedFixtures'][121]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-base-fragment-link.native', $evidence['checkedInFixtures'][121]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][121]['checkedInNativePairFile']['present']);
        $t->same('5ac35a824641609f8af534ca999611e7ed63394ec59f118dc5ea8f6dcec51fed', $evidence['checkedInFixtures'][121]['checkedInNativePairFile']['sha256']);
        $t->same(244, $evidence['checkedInFixtures'][121]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][121]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-nested-paragraph-tree-construction.html', $evidence['checkedInFixtures'][122]['name']);
        $t->same('75f4f8fca0a2c26bf6b202836d621182306f36fe5e837bb3b4c29c7ab604a71b', $evidence['checkedInFixtures'][122]['checkedInFile']['sha256']);
        $t->same(63, $evidence['checkedInFixtures'][122]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][122]['sourceKind']);
        $t->same('block-structure', $evidence['readerDenominator']['selectedFixtures'][122]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-nested-paragraph-tree-construction.native', $evidence['checkedInFixtures'][122]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][122]['checkedInNativePairFile']['present']);
        $t->same('f051b411ddffd107c15e40450fd146482d588496c6e9ef5891edd226c21ea848', $evidence['checkedInFixtures'][122]['checkedInNativePairFile']['sha256']);
        $t->same(67, $evidence['checkedInFixtures'][122]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][122]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-paragraph-fieldset-tree-construction.html', $evidence['checkedInFixtures'][123]['name']);
        $t->same('0a8c5c9ce5293e52d0590a34538154e7b027306b9be42add4264f6c1835df764', $evidence['checkedInFixtures'][123]['checkedInFile']['sha256']);
        $t->same(111, $evidence['checkedInFixtures'][123]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][123]['sourceKind']);
        $t->same('block-structure', $evidence['readerDenominator']['selectedFixtures'][123]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-paragraph-fieldset-tree-construction.native', $evidence['checkedInFixtures'][123]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][123]['checkedInNativePairFile']['present']);
        $t->same('ee38a58410ce34eeefb4bab37b98da7f531ffd6a14ea3dd4e72aebf1d5ce160f', $evidence['checkedInFixtures'][123]['checkedInNativePairFile']['sha256']);
        $t->same(91, $evidence['checkedInFixtures'][123]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][123]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-paragraph-heading-tree-construction.html', $evidence['checkedInFixtures'][124]['name']);
        $t->same('c8dce6817bef81e8ccd40b1579afd71d3415ffbf53382250b157f85021c388e9', $evidence['checkedInFixtures'][124]['checkedInFile']['sha256']);
        $t->same(33, $evidence['checkedInFixtures'][124]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][124]['sourceKind']);
        $t->same('block-structure', $evidence['readerDenominator']['selectedFixtures'][124]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-paragraph-heading-tree-construction.native', $evidence['checkedInFixtures'][124]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][124]['checkedInNativePairFile']['present']);
        $t->same('6eeedaac014513033de3ab83dd3f4cb9926972f3379cc20458b2a00707451470', $evidence['checkedInFixtures'][124]['checkedInNativePairFile']['sha256']);
        $t->same(98, $evidence['checkedInFixtures'][124]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][124]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-xmp-rawtext-fallback.html', $evidence['checkedInFixtures'][125]['name']);
        $t->same('6b128bbb68c2168a47c87b18e8973d144af051be321c01867cc97b47fa244b19', $evidence['checkedInFixtures'][125]['checkedInFile']['sha256']);
        $t->same(282, $evidence['checkedInFixtures'][125]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][125]['sourceKind']);
        $t->same('raw-html-boundary', $evidence['readerDenominator']['selectedFixtures'][125]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-xmp-rawtext-fallback.native', $evidence['checkedInFixtures'][125]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][125]['checkedInNativePairFile']['present']);
        $t->same('f4b24f1967e9e7ac6aa2a368b3c5c71cca29311c747c190041d07a0e64429202', $evidence['checkedInFixtures'][125]['checkedInNativePairFile']['sha256']);
        $t->same(431, $evidence['checkedInFixtures'][125]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][125]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-titlepage-skip.html', $evidence['checkedInFixtures'][126]['name']);
        $t->same('228fb56876f317f173d333088e460dc7866b90fb8a4d2b63ca0d5451216cac9a', $evidence['checkedInFixtures'][126]['checkedInFile']['sha256']);
        $t->same(294, $evidence['checkedInFixtures'][126]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][126]['sourceKind']);
        $t->same('block-structure', $evidence['readerDenominator']['selectedFixtures'][126]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-titlepage-skip.native', $evidence['checkedInFixtures'][126]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][126]['checkedInNativePairFile']['present']);
        $t->same('1425cf376abc9f38b82b3adbf302406dcc5277615af71fe1639c736fcc92db42', $evidence['checkedInFixtures'][126]['checkedInNativePairFile']['sha256']);
        $t->same(46, $evidence['checkedInFixtures'][126]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][126]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-menu-item-tree-construction.html', $evidence['checkedInFixtures'][127]['name']);
        $t->same('16ceabed68b6ba331b60f655916df7c583e5f57c00fb5e41022ed486418c1a6f', $evidence['checkedInFixtures'][127]['checkedInFile']['sha256']);
        $t->same(127, $evidence['checkedInFixtures'][127]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][127]['sourceKind']);
        $t->same('block-structure', $evidence['readerDenominator']['selectedFixtures'][127]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-menu-item-tree-construction.native', $evidence['checkedInFixtures'][127]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][127]['checkedInNativePairFile']['present']);
        $t->same('3690b8d7679fcdbeb567adb930163e764b9de1d26805b09fd0e996c223b41623', $evidence['checkedInFixtures'][127]['checkedInNativePairFile']['sha256']);
        $t->same(154, $evidence['checkedInFixtures'][127]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][127]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-rawtext-fallback-containers.html', $evidence['checkedInFixtures'][128]['name']);
        $t->same('7c8c30fc78501bd3e2656b4e346bf9bd48f82a64576df289a2039548932320d8', $evidence['checkedInFixtures'][128]['checkedInFile']['sha256']);
        $t->same(270, $evidence['checkedInFixtures'][128]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][128]['sourceKind']);
        $t->same('raw-html-boundary', $evidence['readerDenominator']['selectedFixtures'][128]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-rawtext-fallback-containers.native', $evidence['checkedInFixtures'][128]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][128]['checkedInNativePairFile']['present']);
        $t->same('03fc80c204f07d1790408c740c96c7d51ee9a4c32d68878610312373564fa916', $evidence['checkedInFixtures'][128]['checkedInNativePairFile']['sha256']);
        $t->same(337, $evidence['checkedInFixtures'][128]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][128]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-button-inline-fallback.html', $evidence['checkedInFixtures'][129]['name']);
        $t->same('3b5ea1b7ef017fef2371761b760cc270f5a9532c6ccd9a13fcfc9c0b7a8607ff', $evidence['checkedInFixtures'][129]['checkedInFile']['sha256']);
        $t->same(95, $evidence['checkedInFixtures'][129]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][129]['sourceKind']);
        $t->same('inline-and-metadata', $evidence['readerDenominator']['selectedFixtures'][129]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-button-inline-fallback.native', $evidence['checkedInFixtures'][129]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][129]['checkedInNativePairFile']['present']);
        $t->same('944a4b0e52393c2ba28a2adcbb43bddbea45ebf14a92c4ba65d573b1a2fdf16f', $evidence['checkedInFixtures'][129]['checkedInNativePairFile']['sha256']);
        $t->same(99, $evidence['checkedInFixtures'][129]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][129]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-fallback-content-containers.html', $evidence['checkedInFixtures'][130]['name']);
        $t->same('e01d947db29c0be9fac65ddab7502e63f429d4d29d6de6afc3d62d1846bec219', $evidence['checkedInFixtures'][130]['checkedInFile']['sha256']);
        $t->same(275, $evidence['checkedInFixtures'][130]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][130]['sourceKind']);
        $t->same('block-structure', $evidence['readerDenominator']['selectedFixtures'][130]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-fallback-content-containers.native', $evidence['checkedInFixtures'][130]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][130]['checkedInNativePairFile']['present']);
        $t->same('1044ab06e5b81c2b94ce76841bd3dadb4fdddc334c292387610b1cbffcd403a6', $evidence['checkedInFixtures'][130]['checkedInNativePairFile']['sha256']);
        $t->same(373, $evidence['checkedInFixtures'][130]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][130]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-inline-fallback-content-containers.html', $evidence['checkedInFixtures'][131]['name']);
        $t->same('02d354aaff14ee364d44f6dc5df9c102c0d2f10dc50cecebc47bc9161ac10e6b', $evidence['checkedInFixtures'][131]['checkedInFile']['sha256']);
        $t->same(297, $evidence['checkedInFixtures'][131]['checkedInFile']['bytes']);
        $t->same('direct-pandoc-3.10-native-probe', $evidence['readerDenominator']['selectedFixtures'][131]['sourceKind']);
        $t->same('inline-and-metadata', $evidence['readerDenominator']['selectedFixtures'][131]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-inline-fallback-content-containers.native', $evidence['checkedInFixtures'][131]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][131]['checkedInNativePairFile']['present']);
        $t->same('927f76f729d1be983a511c8f03ed7317789c62505a34fdb4639406d93fa56558', $evidence['checkedInFixtures'][131]['checkedInNativePairFile']['sha256']);
        $t->same(369, $evidence['checkedInFixtures'][131]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][131]['localTestReferenceCount'] >= 1);
        $t->same('upstream-html-reader-full-golden.html', $evidence['checkedInFixtures'][132]['name']);
        $t->same('a0ede6d299a88152efa6e776e4d3d6ecbdb2303e2efc195a7cb1d56820d71d25', $evidence['checkedInFixtures'][132]['checkedInFile']['sha256']);
        $t->same(17314, $evidence['checkedInFixtures'][132]['checkedInFile']['bytes']);
        $t->same('selected-upstream-html-reader-fixture', $evidence['readerDenominator']['selectedFixtures'][132]['sourceKind']);
        $t->same('inline-and-metadata', $evidence['readerDenominator']['selectedFixtures'][132]['category']);
        $t->same('lanes/pandoc/fixtures/upstream-html-reader-full-golden.native', $evidence['checkedInFixtures'][132]['checkedInNativePairFile']['path']);
        $t->same(true, $evidence['checkedInFixtures'][132]['checkedInNativePairFile']['present']);
        $t->same('22df52c5b5e5d9e06922c626e5283656fc5f82814a7352a4e183552c53d1bdaf', $evidence['checkedInFixtures'][132]['checkedInNativePairFile']['sha256']);
        $t->same(81634, $evidence['checkedInFixtures'][132]['checkedInNativePairFile']['bytes']);
        $t->true($evidence['checkedInFixtures'][132]['localTestReferenceCount'] >= 1);
        ...
        $t->true(in_array('the current checked-in HTML/native mapped gate observes 133/133 normalized AST matches through the TagSoup-backed Pandoc HTML reader port when included in the report', $evidence['claimBoundaries']['doesAssert'], true));
    ...
    'rejects hydrated upstream html reader source evidence without pinned git head' => static function (TestRunner $t) use ($makeTempDir, $removeTree, $writeHtmlEvidenceTree): void {
        ...
        try {
            ...
            $t->same(133, $report['denominator']['selectedFixtureCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --checked-in-fixtures'
            . ' --json'
            . ' --require-selected-fixture-count=133'
            . ' --require-static-current-evidence'
            . ' --require-native-mapped-parity=133'
        ...
        $t->same(133, $decoded['staticCurrentEvidence']['readerDenominator']['selectedFixtureCount']);
        $t->same('valid-checked-in-current-html-reader-evidence', $decoded['staticCurrentEvidence']['validation']['status']);
        $t->same(133, $decoded['staticCurrentEvidence']['checkedInNativePairCount']);
        $t->same(133, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
        ...
        $failingCommand = str_replace('--require-selected-fixture-count=133', '--require-selected-fixture-count=85', $command) . ' 2>/dev/null';
        $failingOutput = [];
        $failingExitCode = 0;
    ...
    'workflow gate keeps html fixture denominator wiring' => static function (TestRunner $t): void {
        ...
        $t->contains('--require-selected-fixture-count=133', $workflow);
        $t->contains('--require-native-mapped-parity=133', $workflow);
        $t->contains('--require-mapped-parity=133', $workflow);
        $flags = [
            '--require-selected-fixture-count=',
            '--require-native-mapped-parity=',
            '--require-mapped-parity=',
        ];
        foreach ([129, 128, 127, 125, 124, 123, 122, 121, 120, 119, 118, 114, 112, 107, 103, 102, 88, 62] as $staleCount) {
