...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 27));
        ...
        $t->contains('Native AST mapped parity: 27/27', $text);
        $t->contains('Native AST fixture inventory: html=48 native=27 paired=27 unpairedHtml=21 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(27, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=27'
        ...
        $t->same(27, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
