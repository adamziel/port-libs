...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 24));
        ...
        $t->contains('Native AST mapped parity: 24/24', $text);
        $t->contains('Native AST fixture inventory: html=48 native=24 paired=24 unpairedHtml=24 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(24, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=24'
        ...
        $t->same(24, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
