...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 46));
        ...
        $t->contains('Native AST mapped parity: 46/46', $text);
        $t->contains('Native AST fixture inventory: html=48 native=46 paired=46 unpairedHtml=2 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(46, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=46'
        ...
        $t->same(46, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
