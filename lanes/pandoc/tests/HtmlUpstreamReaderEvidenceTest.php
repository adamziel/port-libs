...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 40));
        ...
        $t->contains('Native AST mapped parity: 40/40', $text);
        $t->contains('Native AST fixture inventory: html=48 native=40 paired=40 unpairedHtml=8 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(40, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=40'
        ...
        $t->same(40, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
