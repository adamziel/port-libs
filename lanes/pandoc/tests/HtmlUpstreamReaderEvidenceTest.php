...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 23));
        ...
        $t->contains('Native AST mapped parity: 23/23', $text);
        $t->contains('Native AST fixture inventory: html=48 native=23 paired=23 unpairedHtml=25 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(23, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=23'
        ...
        $t->same(23, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
