...
return [
    'reports skipped html reader evidence when upstream root is absent' => static function (TestRunner $t): void {
        ...
        $t->same(true, HtmlUpstreamReaderEvidence::hasRequiredNativeMappedParity($report, 25));
        ...
        $t->contains('Native AST mapped parity: 25/25', $text);
        $t->contains('Native AST fixture inventory: html=48 native=25 paired=25 unpairedHtml=23 unpairedNative=0', $text);
    },
    ...
    'reports checked-in current html fixture static evidence' => static function (TestRunner $t): void {
        ...
        $t->same(25, $evidence['readerDenominator']['nativeMappedPairCount']);
    ...
    'cli gates checked-in current html fixture evidence without hydrated upstream cache' => static function (TestRunner $t): void {
        ...
        $command = escapeshellarg(PHP_BINARY)
            ...
            . ' --require-native-mapped-parity=25'
        ...
        $t->same(25, $decoded['nativeAstEvidence']['normalizedAstMatchCount']);
