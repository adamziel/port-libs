...
return [
    'keeps DOCX parity evidence bounded to defensible coverage' => static function (TestRunner $t) use ($repoRoot, $readJson, $readText, $countTrackedFiles): void {
        ...
        $t->same(38, $manifestAudit['writerGoldenPackageComparison']['mismatchedPackageCount'] ?? null);
        ...
        $t->contains('generated writer-golden comparison currently covers 38/38 packages but matches 0/38', (string) ($status['blocker'] ?? ''));
        ...
        $t->contains('stable package semantics still mismatched all 38', $pandocStatus);
