...
return [
    ...
    'checked-in markdown fixtures match native ast shape for paired seed corpus' => static function (TestRunner $t) use ($fixtureRoot): void {
        ...
        $t->same(true, MarkdownNativeAstComparisonHarness::hasRequiredMappedParity($report, 34));
        ...
        $t->same('Markdown fixtures=47; native fixtures=34; same-basename pairs=34; Markdown fixtures without native pairs=13', $report['orderedRemainingGaps'][1]['currentEvidence']);
        $t->same('The current checked-in gate covers 34 paired fixture(s) out of 47 selected Markdown fixture(s).', $report['orderedRemainingGaps'][3]['currentEvidence']);
        $t->contains('fixtureInventory: markdown=47 native=34 paired=34 unpairedMarkdown=13 unpairedNative=0', $text);
        ...
        $t->same(13, $decoded['unpairedMarkdownFixtureCount']);
