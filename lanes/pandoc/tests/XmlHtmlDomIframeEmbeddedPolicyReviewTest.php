...
return [
    'summarizes iframe credentialless and embedded csp provenance for reviewer handoff' => static function (TestRunner $t): void {
        ...
        $t->same('iframe-credentialless-boolean-attribute-review', $trusted['iframeCredentiallessReviewPolicy']);
        ...
        $t->same('iframe-embedded-csp-policy-review', $trusted['iframeCspReviewPolicy']);
