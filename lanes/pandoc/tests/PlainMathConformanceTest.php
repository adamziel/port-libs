...
return [
    ...
    'documents non-runtime plainmath conformance gaps in fixture metadata' => static function (TestRunner $t) use ($corpus): void {
        ...
        $t->true(!in_array('macro-environments', array_column($corpus['knownGaps'], 'id'), true), 'PlainMath gap metadata should not retain the fixed custom environment macro blocker.');
