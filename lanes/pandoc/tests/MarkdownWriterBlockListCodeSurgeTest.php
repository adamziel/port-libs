...
$textNode = static fn (string $value): AstNode => new AstNode('text', ['text' => $value]);
$paragraphDocument = static fn (string $value): AstNode => new AstNode('document', [], [
    new AstNode('paragraph', [], [$textNode($value)]),
]);
