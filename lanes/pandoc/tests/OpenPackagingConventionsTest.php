...
XML;
    ...
    'normalizes OPC package paths without allowing traversal or URI components' => static function (TestRunner $t): void {
        ...
        $t->same(['word', 'media', 'review-image.PNG'], OpcPackagePath::partNameSegments('/word/media/review-image.PNG'));
        $t->same('/word/media', OpcPackagePath::partNameDirectory('/word/media/review-image.PNG'));
        $t->same(2, OpcPackagePath::partNameDirectoryDepth('/word/media/review-image.PNG'));
        $t->same('word', OpcPackagePath::partNameTopLevelSegment('/word/media/review-image.PNG'));
        $t->same('review-image.PNG', OpcPackagePath::partNameBaseName('/word/media/review-image.PNG'));
        $t->same('png', OpcPackagePath::partNameExtension('/word/media/review-image.PNG'));
        $t->same('PNG', OpcPackagePath::partNameRawExtension('/word/media/review-image.PNG'));
        $t->same('/', OpcPackagePath::partNameDirectory('/[Content_Types].xml'));
        $t->same(0, OpcPackagePath::partNameDirectoryDepth('/[Content_Types].xml'));
        $t->same('[Content_Types].xml', OpcPackagePath::partNameTopLevelSegment('/[Content_Types].xml'));
        $t->same('[Content_Types].xml', OpcPackagePath::partNameBaseName('/[Content_Types].xml'));
        $t->same('xml', OpcPackagePath::partNameExtension('/[Content_Types].xml'));
        $t->same('.rels', OpcPackagePath::partNameBaseName('/_rels/.rels'));
        $t->same('rels', OpcPackagePath::partNameExtension('/_rels/.rels'));
        $t->same([], OpcPackagePath::partNameSegments('/', true));
        ...
        $t->throws(\InvalidArgumentException::class, static fn (): array => OpcPackagePath::partNameSegments('/'));
        $t->throws(\InvalidArgumentException::class, static fn (): string => OpcPackagePath::partNameDirectory('/'));
        $t->throws(\InvalidArgumentException::class, static fn (): string => OpcPackagePath::partNameExtension('/word/document.xml#frag') ?? '');
        $t->throws(\InvalidArgumentException::class, static fn (): string => OpcPackagePath::canonicalPartName('word/..'));
