...
final class BibtexCslParser
{
    ...
    private static function entryToCslItem(string $type, string $key, array $fields): array
    {
        ...
        $item = [
            ...
            'original-number-of-volumes' => self::firstField($fields, ['origvolumes', 'orig-volumes', 'originalvolumes', 'original-volumes', 'originalnumberofvolumes', 'original-number-of-volumes']),
            'original-number' => self::firstField($fields, ['orignumber', 'orig-number', 'originalnumber', 'original-number']),
            'original-page' => self::normalizePages(self::firstField($fields, ['origpages', 'origpage', 'orig-pages', 'orig-page', 'originalpages', 'originalpage', 'original-pages', 'original-page'])),
            'original-pagination' => self::firstField($fields, ['origpagination', 'orig-pagination', 'originalpagination', 'original-pagination']),
            'original-number-of-pages' => self::firstField($fields, ['origpagetotal', 'orig-pagetotal', 'origpage-total', 'orignumpages', 'orig-numpages', 'originalpagetotal', 'original-page-total', 'originalnumpages', 'original-numpages', 'originalnumberofpages', 'original-number-of-pages']),
