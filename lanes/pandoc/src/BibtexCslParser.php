...
final class BibtexCslParser
{
    ...
    private static function entryToCslItem(string $type, string $key, array $fields): array
    {
        ...
        $item = [
            ...
            'PMID' => self::firstField($fields, ['pmid', 'pmid-id', 'pmid_id', 'pubmed', 'pubmedid', 'pubmed-id', 'pubmed_id']),
            'PMCID' => self::firstField($fields, ['pmcid', 'pmcid-id', 'pmcid_id', 'pmc', 'pmc-id', 'pmc_id']),
