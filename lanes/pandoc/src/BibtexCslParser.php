...
final class BibtexCslParser
{
    ...
    private static function entryToCslItem(string $type, string $key, array $fields): array
    {
        ...
        $item = [
            ...
            'JSTOR' => self::firstField($fields, ['jstor']),
            'HDL' => self::firstField($fields, ['hdl', 'handle']),
            'LCCN' => self::firstField($fields, ['lccn']),
            'OCLC' => self::firstField($fields, ['oclc']),
            ...
            'original-collection-title' => self::firstField($fields, ['origseries', 'orig-series', 'originalseries', 'original-series', 'originalcollection', 'original-collection']),
            'original-collection-number' => self::firstField($fields, ['origseriesnumber', 'orig-series-number', 'originalseriesnumber', 'original-series-number', 'originalcollectionnumber', 'original-collection-number']),
