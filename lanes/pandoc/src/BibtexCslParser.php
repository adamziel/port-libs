...
final class BibtexCslParser
{
    ...
    private static function entryToCslItem(string $type, string $key, array $fields): array
    {
        ...
        $item = [
            ...
            'short-title' => self::firstField($fields, ['shorttitle', 'short-title', 'title-short', 'titleshort']),
            ...
            'container-title-short' => self::firstField($fields, ['shortjournal', 'shortjournaltitle', 'shortjournal-title', 'journaltitle-short', 'container-title-short', 'containertitleshort', 'journalabbreviation', 'journal-abbreviation']),
            'journalAbbreviation' => self::firstField($fields, ['shortjournal', 'shortjournaltitle', 'shortjournal-title', 'journaltitle-short', 'container-title-short', 'containertitleshort', 'journalabbreviation', 'journal-abbreviation']),
