...
final class BibtexCslParser
{
    ...
    private static function entryToCslItem(string $type, string $key, array $fields): array
    {
        ...
        $item = [
            ...
            'part-title' => self::composedTitle($fields, ['parttitle', 'part-title'], ['partsubtitle', 'part-subtitle']),
            ...
            'collection-title' => self::firstField($fields, ['series', 'series-title', 'seriestitle', 'series-title-text', 'seriestitletext', 'collection-title', 'collectiontitle']),
