...
final class BibtexCslParser
{
    ...
    private static function entryToCslItem(string $type, string $key, array $fields): array
    {
        ...
        $item = [
            ...
            'status' => self::firstField($fields, ['status', 'publication-status', 'publicationstatus', 'pubstate', 'pub-state']),
            ...
            'medium' => self::firstField($fields, ['howpublished', 'how-published', 'medium']),
