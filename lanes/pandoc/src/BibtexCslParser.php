...
final class BibtexCslParser
{
    ...
    private static function entryToCslItem(string $type, string $key, array $fields): array
    {
        ...
        $item = [
            ...
            'number-of-volumes' => self::firstField($fields, ['volumes', 'number-of-volumes', 'numberofvolumes', 'volume-count', 'volumecount', 'num-volumes', 'numvolumes']),
            'number-of-pages' => self::firstField($fields, ['pagetotal', 'numpages', 'numberofpages', 'number-of-pages', 'page-total', 'num-pages', 'total-pages', 'totalpages']),
            'chapter-number' => self::firstField($fields, ['chapter', 'chapter-number', 'chapternumber']),
