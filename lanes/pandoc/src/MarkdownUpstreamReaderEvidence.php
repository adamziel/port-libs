...
final class MarkdownUpstreamReaderEvidence
{
    ...
    public static function checkedInCurrentEvidence(string $repoRoot): array
    {
        ...
        return [
            ...
            'claimBoundaries' => [
                'doesAssert' => [
                    'the forty-five selected checked-in Markdown fixture snapshots match the expected SHA-256 hashes and byte counts',
    ...
    private static function claimBoundaries(): array
    {
        return [
            'doesAssert' => [
                'the identity and count of forty-five selected checked-in upstream-derived Markdown fixtures',
