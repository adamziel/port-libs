...
final class MarkdownUpstreamReaderEvidence
{
    ...
    public const EXPECTED_NATIVE_EXPECTATION_MANIFEST_SHA256 = 'a7dee87cd44ad4d401ceb2c558b24dcb627a1f1ca9a8f0c5708b748c027869b2';
    ...
    private static function claimBoundaries(): array
    {
        return [
            'doesAssert' => [
                'the identity and count of fifty-one selected checked-in upstream-derived Markdown fixtures',
                'that focused local tests cover those selected fixture files',
                'that fifty-one checked-in Markdown/native fixture pairs have normalized AST equality through the local PHP reader harness',
