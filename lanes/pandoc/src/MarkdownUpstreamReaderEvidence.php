...
final class MarkdownUpstreamReaderEvidence
{
    ...
    public const EXPECTED_NATIVE_EXPECTATION_MANIFEST_SHA256 = 'b65226f6d0f80ec798dd8684856e212b499f14e2bdcc15687cd6bb2f1ce2b583';
    ...
    public static function checkedInCurrentEvidence(string $repoRoot): array
    {
        ...
        return [
            ...
            'claimBoundaries' => [
                'doesAssert' => [
                    'the fifty-seven selected checked-in Markdown fixture snapshots match the expected SHA-256 hashes and byte counts',
                    'the fifty-seven selected checked-in Markdown native expectation snapshots match the expected deterministic manifest hash',
    ...
    private static function claimBoundaries(): array
    {
        return [
            'doesAssert' => [
                'the identity and count of fifty-seven selected checked-in upstream-derived Markdown fixtures',
                'that focused local tests cover those selected fixture files',
                'that fifty-seven checked-in Markdown/native fixture pairs have normalized AST equality through the local PHP reader harness',
