...
final class MarkdownReader
{
    ...
    private function isKnownRawHtmlInlineTagName(string $name): bool
    {
        return in_array(strtolower($name), [
            'a', 'abbr', 'acronym', 'address', 'animate', 'annotation',
            'area', 'article', 'aside', 'audio', 'b', 'base', 'basefont',
            'bdi', 'bdo', 'big', 'blockquote', 'body', 'br', 'button',
            'canvas', 'caption', 'center', 'circle', 'cite', 'clippath',
            'code', 'col', 'colgroup', 'data', 'datalist', 'dd', 'defs',
            'del', 'desc', 'details', 'dfn', 'dialog', 'dir', 'div', 'dl',
            'dt', 'ellipse', 'em', 'embed', 'feblend', 'fecolormatrix',
            'fecomposite', 'fedisplacementmap', 'fedropshadow', 'feflood',
            'fegaussianblur', 'femerge', 'femergenode', 'feoffset',
            'fieldset', 'figcaption', 'figure', 'filter', 'font', 'footer',
            'foreignobject', 'form', 'frame', 'frameset', 'g', 'h1', 'h2',
            'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hgroup', 'hr', 'html',
            'i', 'iframe', 'image', 'img',
            'input', 'ins', 'kbd', 'label', 'legend', 'li', 'line', 'link',
            'lineargradient', 'maction', 'main', 'maligngroup', 'malignmark',
            'map', 'marker', 'mark', 'mask', 'math', 'menu', 'menuitem',
            'meta', 'metadata', 'meter', 'merror', 'mfenced', 'mfrac',
            'mglyph', 'mi', 'mlongdiv', 'mmultiscripts', 'mn', 'mo', 'mover',
            'mpadded', 'mprescripts', 'mroot', 'mrow', 'ms', 'mscarries',
            'mscarry', 'msgroup', 'msline', 'mspace', 'msqrt', 'msrow',
            'mstack', 'mstyle', 'msub', 'msubsup', 'msup', 'mtable', 'mtd',
            'mtext', 'mtr', 'munder', 'munderover', 'nav', 'noframes', 'none',
            'object', 'ol', 'optgroup', 'option', 'output', 'p', 'param',
            'path', 'pattern', 'picture', 'polygon', 'polyline', 'pre',
            'progress', 'q', 'radialgradient', 'rect', 'rp', 'rt', 'ruby',
            's', 'samp', 'script', 'search', 'section', 'select', 'semantics',
            'set', 'slot', 'small', 'source', 'span', 'stop', 'strike',
            'strong', 'style', 'sub', 'summary', 'sup', 'svg', 'switch',
            'symbol', 'table', 'tbody', 'td', 'template', 'text', 'textarea',
            'textpath', 'tfoot', 'th', 'thead', 'time', 'title', 'tr', 'track',
            'tspan', 'tt', 'u', 'ul', 'use', 'var', 'video', 'view', 'wbr',
        ], true);
    }
