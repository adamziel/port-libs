...
final class MarkdownReader
{
    ...
    private function parseHtmlInlineNode(\DOMNode $node): array
    {
        ...
        if (in_array($name, ['abbr', 'address', 'animate', 'animatemotion', 'animatetransform', 'annotation', 'annotation-xml', 'area', 'audio', 'base', 'bdi', 'bdo', 'button', 'canvas', 'circle', 'cite', 'clippath', 'data', 'datalist', 'defs', 'desc', 'details', 'dfn', 'dialog', 'ellipse', 'embed', 'fedropshadow', 'feflood', 'fegaussianblur', 'feoffset', 'fieldset', 'filter', 'foreignobject', 'form', 'g', 'hgroup', 'iframe', 'image', 'input', 'label', 'legend', 'line', 'lineargradient', 'link', 'map', 'marker', 'mark', 'mask', 'math', 'metadata', 'menu', 'meta', 'meter', 'mfrac', 'mi', 'mn', 'mo', 'mover', 'mpath', 'mroot', 'mrow', 'msqrt', 'msub', 'msubsup', 'msup', 'mtext', 'munder', 'munderover', 'object', 'optgroup', 'option', 'output', 'param', 'path', 'pattern', 'picture', 'polygon', 'polyline', 'progress', 'radialgradient', 'rect', 'rp', 'rt', 'ruby', 'search', 'select', 'semantics', 'set', 'slot', 'small', 'source', 'stop', 'summary', 'svg', 'switch', 'symbol', 'template', 'text', 'textarea', 'textpath', 'time', 'track', 'tspan', 'use', 'var', 'video', 'view', 'wbr'], true)) {
