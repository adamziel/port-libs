...
final class PandocFormatRegistry
{
    ...
    private const PHP_OUTPUT_SUPPORT = [
        ...
        'pptx' => [
            ...
            'notes' => 'Bounded PPTX output emits a deterministic PresentationML OPC ZIP package with content types, root/presentation/slide relationships, core and extended properties, a slide master/layout/theme, table styles, title/content slides, bullet and ordered list paragraphs, DrawingML tables, hyperlink relationships, local image media parts, horizontal-rule slide splits, speaker-note notesSlides/notesMaster parts from upstream-style notes Divs and metadata notes, and raw OpenXML inline/block passthrough. Full upstream PowerPoint writer template/layout/media parity remains open.',
        ],
    ];
