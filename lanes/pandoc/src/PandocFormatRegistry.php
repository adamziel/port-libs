...
final class PandocFormatRegistry
{
    ...
    private const PHP_INPUT_SUPPORT = [
        ...
        'markdown' => [
            'status' => 'partial',
            'implementation' => MarkdownReader::class,
            'notes' => 'Primary native PHP reader with broad Pandoc Markdown behavior slices and a bounded checked-in Markdown/native AST equality gate for thirty-three selected fixtures. Full dialect parity remains open.',
        ],
        'markdown_github' => [
            'status' => 'partial',
            'implementation' => MarkdownReader::class,
