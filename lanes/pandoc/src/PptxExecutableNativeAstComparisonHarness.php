...
final class PptxExecutableNativeAstComparisonHarness
{
    ...
    private const CLAIM = 'Compares local PHP PPTX reader output, native output generated by a local pandoc executable, and paired upstream .native golden fixtures using the shared PPTX normalized AST policy; this is executable golden-fixture evidence and does not assert that the upstream Haskell/Tasty process itself was run.';
    ...
    private static function orderedRemainingGaps(
        ...
        return [
            [
                ...
                'evidenceRequired' => 'Run local PHP PPTX reader, a pandoc executable, and paired upstream .native fixtures against the same PPTX files, keeping parse failures and normalized AST mismatches at zero.',
            ],
            [
                'rank' => 2,
