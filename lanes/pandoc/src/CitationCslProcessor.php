...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        return [
            ...
            'numberOfVolumes' => self::firstStringField($item, ['number-of-volumes', 'numberOfVolumes', 'numberofvolumes']),
            'numberOfPages' => self::firstStringField($item, ['number-of-pages', 'numberOfPages', 'numberofpages']),
            'chapterNumber' => self::firstStringField($item, ['chapter-number', 'chapterNumber', 'chapternumber']),
