...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        return [
            ...
            'shortTitle' => self::firstStringField($item, ['short-title', 'title-short', 'shortTitle', 'titleShort', 'shorttitle', 'titleshort']),
            ...
            'collectionNumber' => self::firstStringField($item, ['collection-number', 'collectionNumber', 'collectionnumber']),
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'title' => (string) $item['title'],
            'short-title', 'title-short', 'shorttitle', 'titleshort' => (string) $item['shortTitle'],
            ...
            'container-title', 'containertitle' => (string) $item['containerTitle'],
            'container-title-short', 'containertitleshort' => (string) $item['containerTitleShort'],
            'journalabbreviation', 'journal-abbreviation' => (string) $item['journalAbbreviation'],
            'container-title-addon', 'containertitleaddon' => (string) $item['containerTitleAddon'],
            'main-title', 'maintitle' => (string) $item['mainTitle'],
            ...
            'edition' => (string) $item['edition'],
            'collection-title', 'collectiontitle' => (string) $item['collectionTitle'],
            'collection-title-short', 'collectiontitleshort' => (string) ($item['collectionTitleShort'] ?? ''),
            'collection-number', 'collectionnumber' => (string) $item['collectionNumber'],
    ...
    private function renderTextVariableValue(array $item, string $variable, string $form, string $scope, ?AstNode $citation = null): string
    {
        ...
        $directShort = match ($normalizedVariable) {
            'title', 'short-title', 'title-short', 'shorttitle', 'titleshort' => (string) ($item['shortTitle'] ?? ''),
            'container-title', 'containertitle' => (string) ($item['containerTitleShort'] ?? ''),
            'collection-title', 'collectiontitle' => (string) ($item['collectionTitleShort'] ?? ''),
            'volume-title', 'volumetitle' => (string) ($item['volumeTitleShort'] ?? ''),
            default => '',
        };
        if ($directShort !== '') {
            return $directShort;
