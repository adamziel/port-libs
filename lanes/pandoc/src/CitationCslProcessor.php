...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        return [
            ...
            'collectionTitle' => self::firstStringField($item, ['collection-title', 'collectionTitle', 'collectiontitle', 'series', 'series-title', 'seriesTitle', 'seriestitle']),
    ...
    private function sortValue(array $item, array $key, string $fallback, string $scope): string
    {
        ...
        return match ($variable) {
            ...
            'collection-title', 'series', 'series-title', 'seriestitle' => $this->normalizeSortText((string) ($item['collectionTitle'] ?? '')),
            ...
            'page', 'page-first', 'number', 'edition', 'volume', 'issue', 'issue-number', 'issuenumber', 'chapter-number', 'number-of-pages',
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'edition' => (string) $item['edition'],
            'collection-title', 'series', 'series-title', 'seriestitle' => (string) $item['collectionTitle'],
            'collection-title-short', 'series-short', 'seriesshort', 'series-title-short', 'seriestitleshort' => (string) ($item['collectionTitleShort'] ?? ''),
    ...
    private function renderTextVariableValue(array $item, string $variable, string $form, string $scope, ?AstNode $citation = null): string
    {
        ...
        $directShort = match ($normalizedVariable) {
            ...
            'collection-title', 'series', 'series-title', 'seriestitle' => (string) ($item['collectionTitleShort'] ?? ''),
