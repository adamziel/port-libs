...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        $containerTitleShort = self::firstStringField($item, [
            ...
            'containertitleabbreviation',
            'publicationTitleShort',
            'publication-title-short',
            'publicationtitleshort',
            'publicationTitleAbbreviation',
            ...
            'booktitleabbreviation',
            'proceedingsTitleShort',
            'proceedings-title-short',
            'proceedingstitleshort',
            'proceedingsTitleAbbreviation',
            'proceedings-title-abbreviation',
            'proceedingstitleabbreviation',
            'journalAbbreviation',
        ...
        return [
            ...
            'containerTitle' => self::firstStringField($item, [
                'container-title',
                'containerTitle',
                'containertitle',
                'publicationTitle',
    ...
    private function sortValue(array $item, array $key, string $fallback, string $scope): string
    {
        ...
        return match ($variable) {
            ...
            'container-title', 'publication-title', 'publicationtitle', 'journal-title', 'journaltitle',
            'book-title', 'booktitle', 'proceedings-title', 'proceedingstitle' => $this->normalizeSortText((string) $item['containerTitle']),
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'container-title', 'publication-title', 'publicationtitle', 'journal-title', 'journaltitle',
            'book-title', 'booktitle', 'proceedings-title', 'proceedingstitle' => (string) $item['containerTitle'],
            'container-title-short', 'containertitleshort', 'container-title-abbreviation', 'containertitleabbreviation',
            'publication-title-short', 'publicationtitleshort', 'publication-title-abbreviation', 'publicationtitleabbreviation',
            'journal-title-abbreviation', 'journaltitleabbreviation',
            'book-title-short', 'booktitleshort', 'book-title-abbreviation', 'booktitleabbreviation',
            'proceedings-title-short', 'proceedingstitleshort', 'proceedings-title-abbreviation', 'proceedingstitleabbreviation' => (string) $item['containerTitleShort'],
    ...
    private function renderTextVariableValue(array $item, string $variable, string $form, string $scope, ?AstNode $citation = null): string
    {
        ...
        $directShort = match ($normalizedVariable) {
            ...
            'container-title', 'publication-title', 'publicationtitle', 'journal-title', 'journaltitle',
            'book-title', 'booktitle', 'proceedings-title', 'proceedingstitle' => (string) ($item['containerTitleShort'] ?? ''),
