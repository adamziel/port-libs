...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        return [
            ...
            'collectionTitleShort' => self::firstStringField($item, ['collection-title-short', 'collectionTitleShort', 'collectiontitleshort', 'short-collection', 'shortCollection', 'shortcollection', 'shortseries', 'short-series', 'series-short']),
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'collection-title-short', 'collectiontitleshort', 'short-collection', 'shortcollection', 'shortseries', 'short-series', 'series-short' => (string) ($item['collectionTitleShort'] ?? ''),
