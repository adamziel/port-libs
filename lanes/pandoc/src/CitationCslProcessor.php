...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        return [
            ...
            'containerAuthors' => self::names($item['container-author'] ?? $item['containerAuthor'] ?? $item['containerAuthors'] ?? [], $id, 'container-author'),
            'collectionEditors' => self::names($item['collection-editor'] ?? $item['collectionEditor'] ?? $item['collectionEditors'] ?? [], $id, 'collection-editor'),
            'composers' => self::names($item['composer'] ?? [], $id, 'composer'),
            'contributors' => self::names($item['contributor'] ?? [], $id, 'contributor'),
            'editorTranslators' => self::names($item['editor-translator'] ?? $item['editorTranslator'] ?? $item['editorTranslators'] ?? [], $id, 'editor-translator'),
            'executiveProducers' => self::names($item['executive-producer'] ?? $item['executiveProducer'] ?? $item['executiveProducers'] ?? [], $id, 'executive-producer'),
            'eventOrganizers' => self::names($item['event-organizer'] ?? $item['eventOrganizer'] ?? $item['eventOrganizers'] ?? [], $id, 'event-organizer'),
            'guests' => self::names($item['guest'] ?? [], $id, 'guest'),
            'hosts' => self::names($item['host'] ?? [], $id, 'host'),
            'narrators' => self::names($item['narrator'] ?? [], $id, 'narrator'),
            'originalAuthors' => self::names($item['original-author'] ?? $item['originalAuthor'] ?? $item['originalAuthors'] ?? [], $id, 'original-author'),
            ...
            'scriptWriters' => self::names($item['script-writer'] ?? $item['scriptWriter'] ?? $item['scriptWriters'] ?? [], $id, 'script-writer'),
            ...
            'editorialDirectors' => self::names($item['editorial-director'] ?? $item['editorialDirector'] ?? $item['editorialDirectors'] ?? [], $id, 'editorial-director'),
            'illustrators' => self::names($item['illustrator'] ?? [], $id, 'illustrator'),
            'interviewers' => self::names($item['interviewer'] ?? [], $id, 'interviewer'),
            'reviewedAuthors' => self::names($item['reviewed-author'] ?? $item['reviewedAuthor'] ?? $item['reviewedAuthors'] ?? [], $id, 'reviewed-author'),
            'redactors' => self::names($item['redactor'] ?? [], $id, 'redactor'),
            'founders' => self::names($item['founder'] ?? $item['founders'] ?? [], $id, 'founder'),
            'continuators' => self::names($item['continuator'] ?? $item['continuators'] ?? [], $id, 'continuator'),
            'revisers' => self::names($item['reviser'] ?? $item['revisers'] ?? [], $id, 'reviser'),
            'collaborators' => self::names($item['collaborator'] ?? $item['collaborators'] ?? [], $id, 'collaborator'),
            'commentators' => self::names($item['commentator'] ?? $item['commentators'] ?? [], $id, 'commentator'),
            'annotators' => self::names($item['annotator'] ?? $item['annotators'] ?? [], $id, 'annotator'),
            'introductionAuthors' => self::names($item['introduction'] ?? $item['introductionAuthor'] ?? $item['introductionAuthors'] ?? [], $id, 'introduction'),
            'forewordAuthors' => self::names($item['foreword'] ?? $item['forewordAuthor'] ?? $item['forewordAuthors'] ?? [], $id, 'foreword'),
            'afterwordAuthors' => self::names($item['afterword'] ?? $item['afterwordAuthor'] ?? $item['afterwordAuthors'] ?? [], $id, 'afterword'),
