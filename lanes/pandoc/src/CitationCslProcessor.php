...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        return [
            ...
            'volumeTitleShort' => self::firstStringField($item, ['volume-title-short', 'volumeTitleShort', 'volumetitleshort', 'short-volume-title', 'shortVolumeTitle', 'shortvolumetitle']),
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'volume-title-short', 'volumetitleshort', 'short-volume-title', 'shortvolumetitle' => (string) ($item['volumeTitleShort'] ?? ''),
