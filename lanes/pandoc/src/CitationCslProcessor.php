...
final class CitationCslProcessor
{
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'isrn' => (string) ($item['isrn'] ?? ''),
            'iswc' => (string) ($item['iswc'] ?? ''),
            'pmid', 'pubmed', 'pubmed-id', 'pubmedid', 'pubmed-identifier', 'pubmedidentifier' => (string) ($item['pmid'] ?? ''),
            'pmcid', 'pmc', 'pmc-id', 'pubmed-central', 'pubmedcentral', 'pubmed-central-id', 'pubmedcentralid', 'pubmed-central-identifier', 'pubmedcentralidentifier' => (string) ($item['pmcid'] ?? ''),
