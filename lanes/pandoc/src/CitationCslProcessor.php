...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        $publisher = self::firstStringField($item, [
            'publisher',
            'institution',
            'institution-name',
            'institutionName',
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'container-title', 'containertitle', 'book-title', 'booktitle', 'journal-title', 'journaltitle', 'journal', 'publication-title', 'publicationtitle' => (string) $item['containerTitle'],
            ...
            'publisher' => (string) $item['publisher'],
            'institution', 'institution-name', 'institutionname', 'organization', 'organization-name', 'organizationname', 'organisation', 'organisation-name', 'organisationname', 'school', 'university', 'sponsor' => (string) $item['publisher'],
            ...
            'institution-list', 'institutionlist', 'organization-list', 'organizationlist', 'organisation-list', 'organisationlist', 'school-list', 'schoollist', 'university-list', 'universitylist', 'sponsor-list', 'sponsorlist' => implode('; ', is_array($item['publisherList'] ?? null) ? $item['publisherList'] : []),
    ...
    private function renderTextVariableValue(array $item, string $variable, string $form, string $scope, ?AstNode $citation = null): string
    {
        ...
        $directShort = match ($normalizedVariable) {
            ...
            'container-title', 'containertitle', 'book-title', 'booktitle', 'journal-title', 'journaltitle', 'journal', 'publication-title', 'publicationtitle' => (string) ($item['containerTitleShort'] ?? ''),
    ...
    private function abbreviationCategoriesForVariable(string $variable): array
    {
        ...
        return match ($variable) {
            ...
            'publisher', 'institution', 'institution-name', 'institutionname', 'organization', 'organization-name', 'organizationname', 'organisation', 'organisation-name', 'organisationname', 'school', 'university', 'sponsor' => [$variable, 'publisher', 'institution'],
            'original-publisher', 'authority' => [$variable, 'institution'],
            default => [$variable],
        };
    }
