...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        return [
            ...
            'collectionTitle' => self::firstStringField($item, ['collection-title', 'collectionTitle', 'collectiontitle', 'series-title', 'seriesTitle', 'seriestitle']),
            'collectionTitleShort' => self::firstStringField($item, ['collection-title-short', 'collectionTitleShort', 'collectiontitleshort', 'series-title-short', 'seriesTitleShort', 'seriestitleshort', 'shortseries', 'short-series', 'series-short']),
            'collectionNumber' => self::firstStringField($item, ['collection-number', 'collectionNumber', 'collectionnumber', 'series-number', 'seriesNumber', 'seriesnumber']),
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'edition' => (string) $item['edition'],
            'collection-title', 'series-title', 'seriestitle' => (string) $item['collectionTitle'],
            'collection-title-short', 'series-title-short', 'seriestitleshort', 'series-short' => (string) ($item['collectionTitleShort'] ?? ''),
    ...
    private function renderTextVariableValue(array $item, string $variable, string $form, string $scope, ?AstNode $citation = null): string
    {
        ...
        $directShort = match ($normalizedVariable) {
            ...
            'collection-title', 'series-title' => (string) ($item['collectionTitleShort'] ?? ''),
