...
final class CitationCslProcessor
{
    ...
    private static function normalizeItem(array $item, int $index): array
    {
        ...
        return [
            ...
            'mrNumber' => self::firstStringField($item, ['MRNumber', 'mrNumber', 'mrnumber', 'mr-number', 'mr', 'mathscinet', 'mathscinetId', 'mathscinet-id', 'mathscinetid', 'mathSciNet', 'mathSciNetId']),
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'mrnumber', 'mr-number', 'mathscinet', 'mathscinet-id', 'mathscinetid' => (string) ($item['mrNumber'] ?? ''),
