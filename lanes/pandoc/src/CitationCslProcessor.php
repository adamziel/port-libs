...
final class CitationCslProcessor
{
    ...
    private function renderVariableValue(array $item, string $variable, string $scope, ?AstNode $citation = null): string
    {
        ...
        return match ($normalized) {
            ...
            'category', 'categories', 'category-list', 'categorylist' => implode(', ', is_array($item['categories'] ?? null) ? $item['categories'] : []),
            'category-summary', 'categories-summary', 'category-list-summary', 'categorylist-summary', 'categorylistsummary' => (string) ($item['categorySummary'] ?? ''),
            ...
            'keyword', 'keywords', 'keyword-list', 'keywordlist' => implode(', ', is_array($item['keywords'] ?? null) ? $item['keywords'] : []),
            'keyword-summary', 'keywords-summary', 'keyword-list-summary', 'keywordlist-summary', 'keywordlistsummary' => (string) ($item['keywordSummary'] ?? ''),
