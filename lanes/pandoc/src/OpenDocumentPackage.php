    ...
    private function packageIdentity(array $packageInventory, array $manifestMediaTypeSummary): array
    {
        ...
        foreach ($packageInventory['parts'] ?? [] as $part) {
            ...
            $packageEntries[] = self::withoutEmptyValues([
                ...
                'xmlCdataSectionCount' => $part['xmlCdataSectionCount'] ?? 0,
                'xmlCdataSectionByteLength' => $part['xmlCdataSectionByteLength'] ?? 0,
                'xmlCdataSections' => $part['xmlCdataSections'] ?? [],
                'xmlCdataSectionsTruncated' => ($part['xmlCdataSectionsTruncated'] ?? false) === true,
                'xmlCommentCount' => $part['xmlCommentCount'] ?? 0,
                'xmlCommentByteLength' => $part['xmlCommentByteLength'] ?? 0,
                'xmlCommentParentDepthCounts' => $part['xmlCommentParentDepthCounts'] ?? [],
                'xmlComments' => $part['xmlComments'] ?? [],
                'xmlCommentsTruncated' => ($part['xmlCommentsTruncated'] ?? false) === true,
                'xmlProcessingInstructionCount' => $part['xmlProcessingInstructionCount'] ?? 0,
                'xmlProcessingInstructionDataByteLength' => $part['xmlProcessingInstructionDataByteLength'] ?? 0,
                'xmlProcessingInstructionTargets' => $part['xmlProcessingInstructionTargets'] ?? [],
                'xmlProcessingInstructions' => $part['xmlProcessingInstructions'] ?? [],
                'xmlProcessingInstructionsTruncated' => ($part['xmlProcessingInstructionsTruncated'] ?? false) === true,
        ...
        $payload = [
            ...
            'packagePartXmlCdataSectionPartCount' => $packageInventory['packagePartXmlCdataSectionPartCount'] ?? 0,
            'packagePartXmlCdataSectionCount' => $packageInventory['packagePartXmlCdataSectionCount'] ?? 0,
            'packagePartXmlCdataSectionByteLength' => $packageInventory['packagePartXmlCdataSectionByteLength'] ?? 0,
            'packagePartXmlCdataSectionPartNames' => $packageInventory['packagePartXmlCdataSectionPartNames'] ?? [],
            'packagePartXmlCdataSections' => $packageInventory['packagePartXmlCdataSections'] ?? [],
            'packagePartXmlCdataSectionsTruncated' => ($packageInventory['packagePartXmlCdataSectionsTruncated'] ?? false) === true,
            'packagePartXmlCommentPartCount' => $packageInventory['packagePartXmlCommentPartCount'] ?? 0,
            'packagePartXmlCommentCount' => $packageInventory['packagePartXmlCommentCount'] ?? 0,
            'packagePartXmlCommentByteLength' => $packageInventory['packagePartXmlCommentByteLength'] ?? 0,
            'packagePartXmlCommentParentDepthCounts' => $packageInventory['packagePartXmlCommentParentDepthCounts'] ?? [],
            'packagePartXmlCommentPartNames' => $packageInventory['packagePartXmlCommentPartNames'] ?? [],
            'packagePartXmlComments' => $packageInventory['packagePartXmlComments'] ?? [],
            'packagePartXmlCommentsTruncated' => ($packageInventory['packagePartXmlCommentsTruncated'] ?? false) === true,
            'packagePartXmlProcessingInstructionPartCount' => $packageInventory['packagePartXmlProcessingInstructionPartCount'] ?? 0,
            'packagePartXmlProcessingInstructionCount' => $packageInventory['packagePartXmlProcessingInstructionCount'] ?? 0,
            'packagePartXmlProcessingInstructionDataByteLength' => $packageInventory['packagePartXmlProcessingInstructionDataByteLength'] ?? 0,
            'packagePartXmlProcessingInstructionTargets' => $packageInventory['packagePartXmlProcessingInstructionTargets'] ?? [],
            'packagePartXmlProcessingInstructionPartNames' => $packageInventory['packagePartXmlProcessingInstructionPartNames'] ?? [],
            'packagePartXmlProcessingInstructions' => $packageInventory['packagePartXmlProcessingInstructions'] ?? [],
            'packagePartXmlProcessingInstructionsTruncated' => ($packageInventory['packagePartXmlProcessingInstructionsTruncated'] ?? false) === true,
