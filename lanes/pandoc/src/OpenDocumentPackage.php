...
final class OpenDocumentPackage
{
    ...
    private static function zipPackageManifestAggregateProvenance(array $manifest): array
    {
        return [
            ...
            'zipPackageManifestCrc32SummaryCount' => $manifest['crc32SummaryCount'] ?? 0,
            'zipPackageManifestCrc32Summaries' => is_array($manifest['crc32Summaries'] ?? null) ? $manifest['crc32Summaries'] : [],
            'zipPackageManifestDuplicateCrc32HexCount' => $manifest['duplicateCrc32HexCount'] ?? 0,
            'zipPackageManifestDuplicateCrc32EntryCount' => $manifest['duplicateCrc32EntryCount'] ?? 0,
            'zipPackageManifestHasDuplicateCrc32Entries' => ($manifest['hasDuplicateCrc32Entries'] ?? false) === true,
            'zipPackageManifestDuplicateCrc32Hexes' => is_array($manifest['duplicateCrc32Hexes'] ?? null) ? $manifest['duplicateCrc32Hexes'] : [],
            'zipPackageManifestDuplicateCrc32Summaries' => is_array($manifest['duplicateCrc32Summaries'] ?? null) ? $manifest['duplicateCrc32Summaries'] : [],
