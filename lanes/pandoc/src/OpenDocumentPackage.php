...
final class OpenDocumentPackage
{
    ...
    private function packageInventory(): array
    {
        ...
        return [
            ...
            'zipPackageManifestCrc32SummaryCount' => $packageManifest['crc32SummaryCount'] ?? 0,
            'zipPackageManifestCrc32Summaries' => is_array($packageManifest['crc32Summaries'] ?? null) ? $packageManifest['crc32Summaries'] : [],
            'zipPackageManifestDuplicateCrc32HexCount' => $packageManifest['duplicateCrc32HexCount'] ?? 0,
            'zipPackageManifestDuplicateCrc32EntryCount' => $packageManifest['duplicateCrc32EntryCount'] ?? 0,
            'zipPackageManifestHasDuplicateCrc32Entries' => ($packageManifest['hasDuplicateCrc32Entries'] ?? false) === true,
            'zipPackageManifestDuplicateCrc32Hexes' => is_array($packageManifest['duplicateCrc32Hexes'] ?? null) ? $packageManifest['duplicateCrc32Hexes'] : [],
            'zipPackageManifestDuplicateCrc32Summaries' => is_array($packageManifest['duplicateCrc32Summaries'] ?? null) ? $packageManifest['duplicateCrc32Summaries'] : [],
    ...
    private function packageIdentity(array $packageInventory, array $packageCoreParts): array
    {
        ...
        $payload = [
            ...
            'zipPackageManifestCrc32SummaryCount' => $packageInventory['zipPackageManifestCrc32SummaryCount'] ?? 0,
            'zipPackageManifestCrc32Summaries' => $packageInventory['zipPackageManifestCrc32Summaries'] ?? [],
            'zipPackageManifestDuplicateCrc32HexCount' => $packageInventory['zipPackageManifestDuplicateCrc32HexCount'] ?? 0,
            'zipPackageManifestDuplicateCrc32EntryCount' => $packageInventory['zipPackageManifestDuplicateCrc32EntryCount'] ?? 0,
            'zipPackageManifestHasDuplicateCrc32Entries' => ($packageInventory['zipPackageManifestHasDuplicateCrc32Entries'] ?? false) === true,
            'zipPackageManifestDuplicateCrc32Hexes' => $packageInventory['zipPackageManifestDuplicateCrc32Hexes'] ?? [],
            'zipPackageManifestDuplicateCrc32Summaries' => $packageInventory['zipPackageManifestDuplicateCrc32Summaries'] ?? [],
