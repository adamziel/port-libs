...
final class OpenDocumentPackage
{
    ...
    private function packageIdentity(array $packageInventory, array $packageCoreParts): array
    {
        ...
        $payload = [
            ...
            'packageZipSourceRecordPackagePartRawExtensionCount' => $packageInventory['packageZipSourceRecordPackagePartRawExtensionCount'] ?? 0,
            'packageZipSourceRecordPackagePartRawExtensionCounts' => $packageInventory['packageZipSourceRecordPackagePartRawExtensionCounts'] ?? [],
            'packageZipSourceRecordPackagePartRawExtensionBytes' => $packageInventory['packageZipSourceRecordPackagePartRawExtensionBytes'] ?? [],
            'packageZipSourceRecordRawExtensionlessPackagePartCount' => $packageInventory['packageZipSourceRecordRawExtensionlessPackagePartCount'] ?? 0,
            'packageZipSourceRecordPackagePartRawExtensionUppercasePartCount' => $packageInventory['packageZipSourceRecordPackagePartRawExtensionUppercasePartCount'] ?? 0,
            'packageZipSourceRecordPackagePartRawExtensionNormalizedPartCount' => $packageInventory['packageZipSourceRecordPackagePartRawExtensionNormalizedPartCount'] ?? 0,
            'packageZipSourceRecordPackagePartRawExtensionDataDescriptorEntryCount' => $packageInventory['packageZipSourceRecordPackagePartRawExtensionDataDescriptorEntryCount'] ?? 0,
            'packageZipSourceRecordPackagePartRawExtensionIssueEntryCount' => $packageInventory['packageZipSourceRecordPackagePartRawExtensionIssueEntryCount'] ?? 0,
            'packageZipSourceRecordPackagePartRawExtensions' => $packageInventory['packageZipSourceRecordPackagePartRawExtensions'] ?? [],
    ...
    private static function packageZipSourceRecordPackagePartRawExtensionInventory(array $parts): array
    {
        ...
        foreach ($parts as $name => $part) {
            ...
            $entryDirectoryRoot = is_string($part['directoryRoot'] ?? null) && $part['directoryRoot'] !== ''
                ? $part['directoryRoot']
                : self::packagePathDirectoryRoot($entryName);
