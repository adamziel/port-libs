...
final class OpenDocumentPackage
{
    ...
    private static function zipPackageManifestAggregateProvenance(array $manifest): array
    {
        return [
            ...
            'zipPackageManifestSourceRecordByteLengthBucketSummaryCount' => $manifest['sourceRecordByteLengthBucketSummaryCount'] ?? 0,
            'zipPackageManifestSourceRecordByteLengthBuckets' => is_array($manifest['sourceRecordByteLengthBuckets'] ?? null) ? $manifest['sourceRecordByteLengthBuckets'] : [],
            'zipPackageManifestSourceRecordByteLengthBucketSummaries' => is_array($manifest['sourceRecordByteLengthBucketSummaries'] ?? null) ? $manifest['sourceRecordByteLengthBucketSummaries'] : [],
