...
final class OpenDocumentPackage
{
    ...
    private function packageInventory(): array
    {
        ...
        return [
            ...
            'creatorHostSystemSummaryCount' => count($creatorHostSystems['hostSystems']),
            'creatorHostSystemSummaries' => $creatorHostSystems['hostSystems'],
            ...
            'creatorVersionBelowNeededKnownHostEntryCount' => $creatorHostSystems['creatorVersionBelowNeededKnownHostEntryCount'],
            'creatorVersionBelowNeededUnknownHostEntryCount' => $creatorHostSystems['creatorVersionBelowNeededUnknownHostEntryCount'],
    ...
    private function packageIdentity(array $packageInventory, array $packageCoreParts): array
    {
        ...
        $payload = [
            ...
            'creatorHostSystemSummaryCount' => $packageInventory['creatorHostSystemSummaryCount'] ?? 0,
            'creatorHostSystemSummaries' => $packageInventory['creatorHostSystemSummaries'] ?? [],
            'creatorVersionMeetsNeededEntryCount' => $packageInventory['creatorVersionMeetsNeededEntryCount'] ?? 0,
            'creatorVersionBelowNeededEntryCount' => $packageInventory['creatorVersionBelowNeededEntryCount'] ?? 0,
            'creatorVersionEqualNeededEntryCount' => $packageInventory['creatorVersionEqualNeededEntryCount'] ?? 0,
            'creatorVersionAboveNeededEntryCount' => $packageInventory['creatorVersionAboveNeededEntryCount'] ?? 0,
            'creatorVersionBelowNeededKnownHostEntryCount' => $packageInventory['creatorVersionBelowNeededKnownHostEntryCount'] ?? 0,
            'creatorVersionBelowNeededUnknownHostEntryCount' => $packageInventory['creatorVersionBelowNeededUnknownHostEntryCount'] ?? 0,
            'creatorVersionComparisonCounts' => $packageInventory['creatorVersionComparisonCounts'] ?? [],
            'unknownCreatorHostSystemEntries' => $packageInventory['unknownCreatorHostSystemEntries'] ?? [],
            'creatorVersionBelowNeededEntries' => $packageInventory['creatorVersionBelowNeededEntries'] ?? [],
