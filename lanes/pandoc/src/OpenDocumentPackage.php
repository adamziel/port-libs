...
final class OpenDocumentPackage
{
    ...
    private function packageIdentity(array $packageInventory, array $manifestMediaTypeSummary): array
    {
        ...
        foreach ($packageInventory['parts'] ?? [] as $part) {
            ...
            $packageEntries[] = self::withoutEmptyValues([
                ...
                'packagePathCharacterFlags' => $part['packagePathCharacterFlags'] ?? [],
                'packagePathHasUppercase' => ($part['packagePathHasUppercase'] ?? false) === true,
                'packagePathHasWhitespace' => ($part['packagePathHasWhitespace'] ?? false) === true,
                'packagePathHasPercentEncodedOctet' => ($part['packagePathHasPercentEncodedOctet'] ?? false) === true,
                'packagePathHasNonAscii' => ($part['packagePathHasNonAscii'] ?? false) === true,
        ...
        $payload = [
            ...
            'packagePathCharacterReviewEntryCount' => $packageInventory['packagePathCharacterReviewEntryCount'] ?? 0,
            'packagePathCharacterFlagCount' => $packageInventory['packagePathCharacterFlagCount'] ?? 0,
            'packagePathCharacterFlagEntryCounts' => $packageInventory['packagePathCharacterFlagEntryCounts'] ?? [],
            'entryNamesByPackagePathCharacterFlag' => $packageInventory['entryNamesByPackagePathCharacterFlag'] ?? [],
            'packagePathUppercaseEntryCount' => $packageInventory['packagePathUppercaseEntryCount'] ?? 0,
            'packagePathWhitespaceEntryCount' => $packageInventory['packagePathWhitespaceEntryCount'] ?? 0,
            'packagePathPercentEncodedOctetEntryCount' => $packageInventory['packagePathPercentEncodedOctetEntryCount'] ?? 0,
            'packagePathNonAsciiEntryCount' => $packageInventory['packagePathNonAsciiEntryCount'] ?? 0,
            'packagePathCharacterReviewEntries' => $packageInventory['packagePathCharacterReviewEntries'] ?? [],
            'packagePathCharacterByteExposurePolicy' => $packageInventory['packagePathCharacterByteExposurePolicy'] ?? 'odf-package-path-character-metadata-only',
            'packagePathCharacterCanExposeBytes' => ($packageInventory['packagePathCharacterCanExposeBytes'] ?? false) === true,
    ...
    private static function packagePathCharacterInventory(array $parts): array
    {
        ...
        foreach ($parts as $fallbackName => $part) {
            ...
            $reviewEntries[] = self::withoutEmptyValues([
                'entryName' => $entryName,
                'flags' => $flags,
