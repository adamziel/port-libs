...
final class OpenDocumentPackage
{
    ...
    private function packageIdentity(array $packageInventory, array $manifestMediaTypeSummary): array
    {
        ...
        foreach ($packageInventory['parts'] ?? [] as $part) {
            ...
            $packageEntries[] = self::withoutEmptyValues([
                ...
                'zipPackageManifestEntryNameBytes' => $part['zipPackageManifestEntryNameBytes'] ?? null,
                'zipPackageManifestEntryNameLengthBucket' => $part['zipPackageManifestEntryNameLengthBucket'] ?? null,
    ...
    private static function zipPackageManifestEntrySourceProvenance(?array $entry): array
    {
        ...
        return [
            ...
            'zipPackageManifestEntryNameBytes' => $entry['entryNameBytes'] ?? null,
            'zipPackageManifestEntryNameLengthBucket' => $entry['entryNameLengthBucket'] ?? null,
    ...
    private static function zipPackageManifestAggregateProvenance(array $manifest): array
    {
        return [
            ...
            'zipPackageManifestNameLengthBucketSummaryCount' => $manifest['nameLengthBucketSummaryCount'] ?? 0,
            'zipPackageManifestNameLengthBuckets' => is_array($manifest['nameLengthBuckets'] ?? null) ? $manifest['nameLengthBuckets'] : [],
            'zipPackageManifestNameLengthBucketSummaries' => is_array($manifest['nameLengthBucketSummaries'] ?? null) ? $manifest['nameLengthBucketSummaries'] : [],
