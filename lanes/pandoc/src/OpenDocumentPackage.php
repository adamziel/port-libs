...
final class OpenDocumentPackage
{
    ...
    private function packageInventory(): array
    {
        ...
        $packageByteSha256s = OdfPackageByteSha256Inventory::summarize($parts);
        ...
        return [
            ...
            'packageByteSha256EntryCount' => $packageByteSha256s['packageByteSha256EntryCount'],
            'packageByteSha256Count' => $packageByteSha256s['packageByteSha256Count'],
            'packageDuplicateByteSha256Count' => $packageByteSha256s['packageDuplicateByteSha256Count'],
            'packageDuplicateByteSha256EntryCount' => $packageByteSha256s['packageDuplicateByteSha256EntryCount'],
            'packageByteSha256Counts' => $packageByteSha256s['packageByteSha256Counts'],
            'packageByteSha256ByteLengths' => $packageByteSha256s['packageByteSha256ByteLengths'],
            'packageByteSha256CompressedByteLengths' => $packageByteSha256s['packageByteSha256CompressedByteLengths'],
            'packageByteSha256SourceRecordBytes' => $packageByteSha256s['packageByteSha256SourceRecordBytes'],
            'entryNamesByPackageByteSha256' => $packageByteSha256s['entryNamesByPackageByteSha256'],
            'packageByteSha256Summaries' => $packageByteSha256s['packageByteSha256Summaries'],
            'packageDuplicateByteSha256Summaries' => $packageByteSha256s['packageDuplicateByteSha256Summaries'],
    ...
    private function packageIdentity(array $packageInventory, array $manifestMediaTypeSummary): array
    {
        ...
        $payload = [
            ...
            'packageByteSha256EntryCount' => $packageInventory['packageByteSha256EntryCount'] ?? 0,
            'packageByteSha256Count' => $packageInventory['packageByteSha256Count'] ?? 0,
            'packageDuplicateByteSha256Count' => $packageInventory['packageDuplicateByteSha256Count'] ?? 0,
            'packageDuplicateByteSha256EntryCount' => $packageInventory['packageDuplicateByteSha256EntryCount'] ?? 0,
            'packageByteSha256Counts' => $packageInventory['packageByteSha256Counts'] ?? [],
            'packageByteSha256ByteLengths' => $packageInventory['packageByteSha256ByteLengths'] ?? [],
            'packageByteSha256CompressedByteLengths' => $packageInventory['packageByteSha256CompressedByteLengths'] ?? [],
            'packageByteSha256SourceRecordBytes' => $packageInventory['packageByteSha256SourceRecordBytes'] ?? [],
            'entryNamesByPackageByteSha256' => $packageInventory['entryNamesByPackageByteSha256'] ?? [],
            'packageByteSha256Summaries' => $packageInventory['packageByteSha256Summaries'] ?? [],
            'packageDuplicateByteSha256Summaries' => $packageInventory['packageDuplicateByteSha256Summaries'] ?? [],
