...
final class OpenDocumentPackage
{
    ...
    private function packageInventory(): array
    {
        ...
        foreach ($this->package->entries() as $centralDirectoryIndex => $entry) {
            ...
            $pathSegmentNameCharacters = self::packagePathSegmentNameCharacterReview($pathShape);
    ...
    private function packageIdentity(array $packageInventory, array $manifestMediaTypeSummary): array
    {
        ...
        foreach ($packageInventory['parts'] ?? [] as $part) {
            ...
            $packageEntries[] = self::withoutEmptyValues([
                ...
                'packagePathSegmentNameCharacterFlags' => $part['packagePathSegmentNameCharacterFlags'] ?? [],
                'packagePathSegmentNameHasUppercase' => ($part['packagePathSegmentNameHasUppercase'] ?? false) === true,
                'packagePathSegmentNameHasWhitespace' => ($part['packagePathSegmentNameHasWhitespace'] ?? false) === true,
                'packagePathSegmentNameHasPercentEncodedOctet' => ($part['packagePathSegmentNameHasPercentEncodedOctet'] ?? false) === true,
                'packagePathSegmentNameHasNonAscii' => ($part['packagePathSegmentNameHasNonAscii'] ?? false) === true,
                'packagePathSegmentNameCharacterReviews' => $part['packagePathSegmentNameCharacterReviews'] ?? [],
                'roles' => $part['roles'] ?? [],
        ...
        $payload = [
            ...
            'packagePathSegmentNameCharacterReviewPartCount' => $packageInventory['packagePathSegmentNameCharacterReviewPartCount'] ?? 0,
            ...
            'packagePathSegmentNameUppercasePartCount' => $packageInventory['packagePathSegmentNameUppercasePartCount'] ?? 0,
            'packagePathSegmentNameWhitespacePartCount' => $packageInventory['packagePathSegmentNameWhitespacePartCount'] ?? 0,
            'packagePathSegmentNamePercentEncodedOctetPartCount' => $packageInventory['packagePathSegmentNamePercentEncodedOctetPartCount'] ?? 0,
            'packagePathSegmentNameNonAsciiPartCount' => $packageInventory['packagePathSegmentNameNonAsciiPartCount'] ?? 0,
            'packagePathSegmentNameCharacterFlagOccurrenceCounts' => $packageInventory['packagePathSegmentNameCharacterFlagOccurrenceCounts'] ?? [],
            'packagePathSegmentNameCharacterFlagPartCounts' => $packageInventory['packagePathSegmentNameCharacterFlagPartCounts'] ?? [],
            'packagePathSegmentNameCharacterFlagSegments' => $packageInventory['packagePathSegmentNameCharacterFlagSegments'] ?? [],
            'packagePathSegmentNameCharacterFlagPartNames' => $packageInventory['packagePathSegmentNameCharacterFlagPartNames'] ?? [],
