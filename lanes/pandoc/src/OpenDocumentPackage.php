...
final class OpenDocumentPackage
{
    ...
    private static function zipPackageManifestAggregateProvenance(array $manifest): array
    {
        return [
            ...
            'zipPackageManifestHasEntryComments' => ($manifest['hasEntryComments'] ?? false) === true,
            'zipPackageManifestCommentedEntryNames' => is_array($manifest['commentedEntryNames'] ?? null) ? $manifest['commentedEntryNames'] : [],
            'zipPackageManifestEntryCommentSummaryCount' => $manifest['entryCommentSummaryCount'] ?? 0,
            'zipPackageManifestEntryCommentSourceRecordBytes' => $manifest['entryCommentSourceRecordBytes'] ?? 0,
            'zipPackageManifestEntryCommentSummaries' => is_array($manifest['entryCommentSummaries'] ?? null) ? $manifest['entryCommentSummaries'] : [],
