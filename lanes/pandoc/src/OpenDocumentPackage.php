...
final class OpenDocumentPackage
{
    ...
    private function packageIdentity(array $packageInventory, array $packageCoreParts): array
    {
        ...
        $payload = [
            ...
            'byteExposurePolicyItemCount' => $packageInventory['byteExposurePolicyItemCount'] ?? 0,
            'byteExposurePolicyItems' => $packageInventory['byteExposurePolicyItems'] ?? [],
            'byteExposurePolicyByteLengths' => $packageInventory['byteExposurePolicyByteLengths'] ?? [],
            'byteExposurePolicyCompressedByteLengths' => $packageInventory['byteExposurePolicyCompressedByteLengths'] ?? [],
