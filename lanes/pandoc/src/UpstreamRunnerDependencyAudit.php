...
CABAL,
     ...
     *   cabalPlanCommands:array<string, array{program:string, arguments:list<string>, targets:list<string>, component:string, workingDirectory:string, executionPolicy:string, outputCapture:list<string>}>,
