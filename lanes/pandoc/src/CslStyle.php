...
final class CslStyle
{
    ...
    private const DEFAULT_TERMS = [
        ...
        'open-inner-quote|long' => ['single' => "\u{2018}", 'multiple' => "\u{2018}"],
        'close-inner-quote|long' => ['single' => "\u{2019}", 'multiple' => "\u{2019}"],
    ...
    public function summary(): array
    {
        return [
            ...
            'terms' => [
                ...
                'openQuote' => $this->term('open-quote'),
                'closeQuote' => $this->term('close-quote'),
                'openInnerQuote' => $this->term('open-inner-quote'),
                'closeInnerQuote' => $this->term('close-inner-quote'),
