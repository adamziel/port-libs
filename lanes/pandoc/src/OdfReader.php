    ...
    private function packageProvenance(
        ...
        foreach ($package->entries() as $centralDirectoryIndex => $entry) {
            ...
            $parts[$entry->name] = [
                ...
                'manifestVersion' => is_array($manifestItem) ? $manifestItem['version'] ?? null : null,
                'manifestPreferredViewMode' => is_array($manifestItem) ? $manifestItem['preferredViewMode'] ?? null : null,
