...
final class OdfReader
{
     ...
     * @return array<string, mixed>
     */
    private function zipNamePolicyProvenance(ZipPackage $package): array
    {
    ...
    private function packageIdentityProvenance(array $provenance): array
    {
        ...
        foreach ($provenance['parts'] ?? [] as $item) {
            ...
            $packageEntries[] = self::withoutEmpty([
                ...
                'zipPackageManifestCompressionMethodName' => $item['zipPackageManifestCompressionMethodName'] ?? null,
                'zipPackageManifestCrc32Hex' => $item['zipPackageManifestCrc32Hex'] ?? null,
                ...
                'zipPackageManifestMadeByVersion' => $item['zipPackageManifestMadeByVersion'] ?? null,
                'zipPackageManifestVersionNeededToExtract' => $item['zipPackageManifestVersionNeededToExtract'] ?? null,
                'zipPackageManifestCreatorVersionMeetsNeeded' => $item['zipPackageManifestCreatorVersionMeetsNeeded'] ?? null,
                'zipPackageManifestCreatorVersionComparison' => $item['zipPackageManifestCreatorVersionComparison'] ?? null,
                'zipPackageManifestCreatorVersionDelta' => $item['zipPackageManifestCreatorVersionDelta'] ?? null,
                'zipPackageManifestCreatorHostSystemIsKnown' => $item['zipPackageManifestCreatorHostSystemIsKnown'] ?? null,
                'zipPackageManifestCreatorHostSystemIssues' => $item['zipPackageManifestCreatorHostSystemIssues'] ?? [],
                ...
                'zipPackageManifestPathSegmentPositionReviews' => $item['zipPackageManifestPathSegmentPositionReviews'] ?? [],
                'zipPackageManifestDirectoryDepth' => $item['zipPackageManifestDirectoryDepth'] ?? null,
                'zipPackageManifestPackagePartExtension' => $item['zipPackageManifestPackagePartExtension'] ?? null,
                'zipPackageManifestPackagePartExtensionKey' => $item['zipPackageManifestPackagePartExtensionKey'] ?? null,
                'zipPackageManifestExtensionlessPackagePart' => ($item['zipPackageManifestExtensionlessPackagePart'] ?? false) === true,
                'zipPackageManifestCentralDirectoryIndex' => $item['zipPackageManifestCentralDirectoryIndex'] ?? null,
                'zipPackageManifestLocalHeaderOrder' => $item['zipPackageManifestLocalHeaderOrder'] ?? null,
                'zipLocalHeaderOffset' => $item['zipLocalHeaderOffset'] ?? null,
                'zipLocalHeaderBytes' => $item['zipLocalHeaderBytes'] ?? null,
                'zipLocalHeaderSha256' => $item['zipLocalHeaderSha256'] ?? null,
                'zipLocalHeaderFixedHeaderBytes' => $item['zipLocalHeaderFixedHeaderBytes'] ?? null,
                'zipLocalHeaderVariableFieldOffset' => $item['zipLocalHeaderVariableFieldOffset'] ?? null,
                'zipLocalHeaderVariableFieldBytes' => $item['zipLocalHeaderVariableFieldBytes'] ?? null,
                'zipLocalHeaderVariableFieldSha256' => $item['zipLocalHeaderVariableFieldSha256'] ?? null,
                'zipLocalHeaderRawNameOffset' => $item['zipLocalHeaderRawNameOffset'] ?? null,
                'zipLocalHeaderRawNameBytes' => $item['zipLocalHeaderRawNameBytes'] ?? null,
                'zipLocalHeaderRawNameSha256' => $item['zipLocalHeaderRawNameSha256'] ?? null,
                'zipLocalHeaderExtraFieldOffset' => $item['zipLocalHeaderExtraFieldOffset'] ?? null,
                'zipLocalHeaderExtraFieldBytes' => $item['zipLocalHeaderExtraFieldBytes'] ?? null,
                'zipLocalHeaderExtraFieldSha256' => $item['zipLocalHeaderExtraFieldSha256'] ?? null,
                'zipLocalHeaderReviewFieldBytes' => $item['zipLocalHeaderReviewFieldBytes'] ?? null,
                'zipLocalRecordOffset' => $item['zipLocalRecordOffset'] ?? null,
                'zipLocalRecordBytes' => $item['zipLocalRecordBytes'] ?? null,
                ...
                'zipDataDescriptorOffset' => $item['zipDataDescriptorOffset'] ?? null,
                'zipDataDescriptorBytes' => $item['zipDataDescriptorBytes'] ?? 0,
                'zipDataDescriptorEnd' => $item['zipDataDescriptorEnd'] ?? null,
                'zipDataDescriptorSha256' => $item['zipDataDescriptorSha256'] ?? null,
                'zipCentralDirectoryRecordOffset' => $item['zipCentralDirectoryRecordOffset'] ?? null,
                'zipCentralDirectoryRecordEnd' => $item['zipCentralDirectoryRecordEnd'] ?? null,
                'zipCentralDirectoryRecordBytes' => $item['zipCentralDirectoryRecordBytes'] ?? null,
                'zipCentralDirectoryRecordSha256' => $item['zipCentralDirectoryRecordSha256'] ?? null,
                'zipCentralDirectoryFixedHeaderBytes' => $item['zipCentralDirectoryFixedHeaderBytes'] ?? null,
                'zipCentralDirectoryVariableFieldOffset' => $item['zipCentralDirectoryVariableFieldOffset'] ?? null,
                'zipCentralDirectoryVariableFieldBytes' => $item['zipCentralDirectoryVariableFieldBytes'] ?? null,
                'zipCentralDirectoryVariableFieldSha256' => $item['zipCentralDirectoryVariableFieldSha256'] ?? null,
                'zipCentralDirectoryRawNameOffset' => $item['zipCentralDirectoryRawNameOffset'] ?? null,
                'zipCentralDirectoryRawNameBytes' => $item['zipCentralDirectoryRawNameBytes'] ?? null,
                'zipCentralDirectoryRawNameSha256' => $item['zipCentralDirectoryRawNameSha256'] ?? null,
                'zipCentralDirectoryExtraFieldOffset' => $item['zipCentralDirectoryExtraFieldOffset'] ?? null,
                'zipCentralDirectoryExtraFieldBytes' => $item['zipCentralDirectoryExtraFieldBytes'] ?? null,
                'zipCentralDirectoryExtraFieldSha256' => $item['zipCentralDirectoryExtraFieldSha256'] ?? null,
                'zipCentralDirectoryRawCommentOffset' => $item['zipCentralDirectoryRawCommentOffset'] ?? null,
                'zipCentralDirectoryRawCommentBytes' => $item['zipCentralDirectoryRawCommentBytes'] ?? null,
                'zipCentralDirectoryRawCommentSha256' => $item['zipCentralDirectoryRawCommentSha256'] ?? null,
        ...
        $payload = [
            ...
            'entryNamesByPackageCaseFoldDirectoryBaseName' => $provenance['entryNamesByPackageCaseFoldDirectoryBaseName'] ?? [],
            ...
            'packageDirectoryBaseNameStemCount' => $provenance['packageDirectoryBaseNameStemCount'] ?? 0,
            'packageDirectoryBaseNameStemCounts' => $provenance['packageDirectoryBaseNameStemCounts'] ?? [],
            'entryNamesByPackageDirectoryBaseNameStem' => $provenance['entryNamesByPackageDirectoryBaseNameStem'] ?? [],
            'packageCaseFoldDirectoryBaseNameStemCount' => $provenance['packageCaseFoldDirectoryBaseNameStemCount'] ?? 0,
            'packageCaseFoldDirectoryBaseNameStemCounts' => $provenance['packageCaseFoldDirectoryBaseNameStemCounts'] ?? [],
            'entryNamesByPackageCaseFoldDirectoryBaseNameStem' => $provenance['entryNamesByPackageCaseFoldDirectoryBaseNameStem'] ?? [],
            'duplicatePackageDirectoryBaseNameStemCount' => $provenance['duplicatePackageDirectoryBaseNameStemCount'] ?? 0,
            'duplicatePackageDirectoryBaseNameStems' => $provenance['duplicatePackageDirectoryBaseNameStems'] ?? [],
            'packageDirectoryBaseNameStems' => $provenance['packageDirectoryBaseNameStems'] ?? [],
            'duplicatePackageCaseFoldDirectoryBaseNameStemCount' => $provenance['duplicatePackageCaseFoldDirectoryBaseNameStemCount'] ?? 0,
            'duplicatePackageCaseFoldDirectoryBaseNameStems' => $provenance['duplicatePackageCaseFoldDirectoryBaseNameStems'] ?? [],
            'packageCaseFoldDirectoryBaseNameStems' => $provenance['packageCaseFoldDirectoryBaseNameStems'] ?? [],
            'packageZipSourceRecordDirectoryRootCount' => $provenance['packageZipSourceRecordDirectoryRootCount'] ?? 0,
            'packageZipSourceRecordDirectoryRootCounts' => $provenance['packageZipSourceRecordDirectoryRootCounts'] ?? [],
            'packageZipSourceRecordDirectoryRootBytes' => $provenance['packageZipSourceRecordDirectoryRootBytes'] ?? [],
            'packageZipSourceRecordEntryCount' => $provenance['packageZipSourceRecordEntryCount'] ?? 0,
            ...
            'zipPathHierarchyCollisionEntryCount' => $provenance['zipPathHierarchyCollisionEntryCount'] ?? 0,
            'zipCaseInsensitiveNameCollisionGroupCount' => $provenance['zipCaseInsensitiveNameCollisionGroupCount'] ?? 0,
            'zipCaseInsensitiveNameCollisionEntryCount' => $provenance['zipCaseInsensitiveNameCollisionEntryCount'] ?? 0,
            'zipRawNameCollisionGroupCount' => $provenance['zipRawNameCollisionGroupCount'] ?? 0,
            'zipRawNameCollisionEntryCount' => $provenance['zipRawNameCollisionEntryCount'] ?? 0,
            'zipRawNameProvenanceEntryCount' => $provenance['zipRawNameProvenanceEntryCount'] ?? 0,
            'zipNameHygieneReviewEntryCount' => $provenance['zipNameHygieneReviewEntryCount'] ?? 0,
            'zipNameHygieneLeadingOrTrailingWhitespaceEntryCount' => $provenance['zipNameHygieneLeadingOrTrailingWhitespaceEntryCount'] ?? 0,
            'zipNameHygieneTrailingDotSegmentEntryCount' => $provenance['zipNameHygieneTrailingDotSegmentEntryCount'] ?? 0,
            'zipNameHygieneWindowsReservedNameEntryCount' => $provenance['zipNameHygieneWindowsReservedNameEntryCount'] ?? 0,
            ...
            'mismatchedExtraFieldEntryCount' => $provenance['mismatchedExtraFieldEntryCount'] ?? 0,
            'mismatchedExtraFieldValueEntryCount' => $provenance['mismatchedExtraFieldValueEntryCount'] ?? 0,
            'extraFieldIdCount' => $provenance['extraFieldIdCount'] ?? 0,
            'centralExtraFieldIdCount' => $provenance['centralExtraFieldIdCount'] ?? 0,
            'localExtraFieldIdCount' => $provenance['localExtraFieldIdCount'] ?? 0,
            'sharedExtraFieldIdCount' => $provenance['sharedExtraFieldIdCount'] ?? 0,
            ...
            'corePackagePartCount' => $provenance['corePackagePartCount'] ?? 0,
            'mediaResourcePartCount' => $provenance['mediaResourcePartCount'] ?? 0,
            ...
            'embeddedObjectContainedPartCount' => $provenance['embeddedObjectContainedPartCount'] ?? 0,
            ...
            ...$zipPackageManifestSummary,
            'packageSource' => $provenance['packageSource'] ?? [],
            'archiveLength' => $provenance['archiveLength'] ?? 0,
            'archiveSha256' => $provenance['archiveSha256'] ?? null,
            'centralDirectoryOffset' => $provenance['centralDirectoryOffset'] ?? null,
            'centralDirectoryBytes' => $provenance['centralDirectoryBytes'] ?? null,
            'centralDirectoryEnd' => $provenance['centralDirectoryEnd'] ?? null,
            'centralDirectorySha256' => $provenance['centralDirectorySha256'] ?? null,
            'centralDirectoryToEocdGapOffset' => $provenance['centralDirectoryToEocdGapOffset'] ?? null,
            'centralDirectoryToEocdGapBytes' => $provenance['centralDirectoryToEocdGapBytes'] ?? 0,
            'centralDirectoryToEocdGapSha256' => $provenance['centralDirectoryToEocdGapSha256'] ?? null,
            'endOfCentralDirectoryOffset' => $provenance['endOfCentralDirectoryOffset'] ?? null,
            'endOfCentralDirectoryBytes' => $provenance['endOfCentralDirectoryBytes'] ?? null,
            'endOfCentralDirectoryEnd' => $provenance['endOfCentralDirectoryEnd'] ?? null,
            'endOfCentralDirectorySha256' => $provenance['endOfCentralDirectorySha256'] ?? null,
            'packageCommentOffset' => $provenance['packageCommentOffset'] ?? null,
            'packageCommentBytes' => $provenance['packageCommentBytes'] ?? 0,
            'packageCommentSha256' => $provenance['packageCommentSha256'] ?? null,
            'hasCentralDirectorySignature' => ($provenance['hasCentralDirectorySignature'] ?? false) === true,
            'centralDirectorySignatureOffset' => $provenance['centralDirectorySignatureOffset'] ?? null,
            'centralDirectorySignatureDataOffset' => $provenance['centralDirectorySignatureDataOffset'] ?? null,
            'centralDirectorySignatureEnd' => $provenance['centralDirectorySignatureEnd'] ?? null,
            'centralDirectorySignatureBytes' => $provenance['centralDirectorySignatureBytes'] ?? 0,
            'centralDirectorySignatureRecordBytes' => $provenance['centralDirectorySignatureRecordBytes'] ?? 0,
            'centralDirectorySignaturePreviewHex' => $provenance['centralDirectorySignaturePreviewHex'] ?? '',
            'centralDirectorySignaturePreviewByteCount' => $provenance['centralDirectorySignaturePreviewByteCount'] ?? 0,
            'centralDirectorySignatureSha256' => $provenance['centralDirectorySignatureSha256'] ?? null,
            'centralDirectorySignatureLocation' => $provenance['centralDirectorySignatureLocation'] ?? null,
            'centralDirectorySignatureVerification' => $provenance['centralDirectorySignatureVerification'] ?? 'not-present',
            'centralDirectorySignatureByteExposurePolicy' => $provenance['centralDirectorySignatureByteExposurePolicy'] ?? 'not-present',
            'centralDirectorySignatureCanExposeBytes' => ($provenance['centralDirectorySignatureCanExposeBytes'] ?? false) === true,
        ];
    ...
    private static function packagePartBasenameInventory(array $parts): array
    {
        ...
        foreach ($parts as $name => $part) {
            ...
            $basename = is_string($part['packageBasename'] ?? null) ? $part['packageBasename'] : null;
            if ($basename === null && is_string($pathShape['basename'] ?? null)) {
                $basename = $pathShape['basename'];
            }
    ...
    /**
     * @param list<array<string, mixed>> $manifestFileEntryOrder
     * @param array<string, array<string, mixed>> $packageParts
     * @param list<array<string, mixed>> $undeclaredPackageEntries
     * @return array<string, mixed>
     */
    private static function manifestPackageCoverageProvenance(array $manifestFileEntryOrder, array $packageParts, array $undeclaredPackageEntries): array
    {
        $manifestReferences = [];
        ...
        foreach ($undeclaredPackageEntries as $entry) {
            $path = $entry['part'] ?? null;
            if (is_string($path) && $path !== '') {
                $undeclaredZipEntryPaths[] = $path;
            }
        }

        foreach ($manifestFileEntryOrder as $entry) {
            $packagePath = $entry['part'] ?? null;
            if (!is_string($packagePath) || $packagePath === '') {
                continue;
            }

            $manifestPath = is_string($entry['fullPath'] ?? null) ? $entry['fullPath'] : $packagePath;
    ...
    private function missingManifestDeclaredRoles(array $manifestItem, array $objectPackageRootParts): array
    {
        ...
        if (($manifestItem['metaInfSidecarPackagePart'] ?? false) === true || $this->isMetaInfSidecarPackagePartName($part)) {
            $roles[] = 'meta-inf-sidecar';
        }
    ...
    private function packageThumbnailMetadata(ZipPackage $package, array $manifest, array $undeclaredEntries): array
    {
        ...
        foreach ($candidatesByPart as $part => $item) {
            ...
            $items[] = [
                ...
                'declaredSizeMismatch' => ($item['declaredSizeMismatch'] ?? false) === true,
                'canExposeAsDocumentMedia' => false,
                'byteExposurePolicy' => $item['byteExposurePolicy'] ?? 'package-thumbnail-bytes-blocked',
    ...
    private function manifestUndeclaredPackageEntries(ZipPackage $package, array $manifest): array
    {
        ...
        foreach ($package->entries() as $entry) {
            ...
            $embeddedObjectPackage = $this->embeddedObjectPackageMembership($entry->name, $objectPackageRootParts);
            $byteExposurePolicy = $this->undeclaredPackageEntryByteExposurePolicy($entry->name, $embeddedObjectPackage);
            $entries[] = [
                'part' => $entry->name,
     ...
     */
    private function undeclaredPackageEntryByteExposurePolicy(string $part, ?array $embeddedObjectPackage = null): string
    {
