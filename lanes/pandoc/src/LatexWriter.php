...
final class LatexWriter
{
    ...
    /**
     * @param array{topLevelDivision?: string, writerTopLevelDivision?: string, highlightMethod?: string|bool, writerHighlightMethod?: string|bool, groupEndnotes?: bool} $options
     */
    ...
    public function write(AstNode $document): string
    {
        ...
        $previousNoteUsedAnchors = $this->noteUsedAnchors;
        $previousNoteNumber = $this->noteNumber;
        $previousNoteAnchorDiagnostics = $this->noteAnchorDiagnostics;
        $previousRenderedGroupedEndnotes = $this->renderedGroupedEndnotes;
        ...
        try {
            ...
            $this->noteUsedAnchors = $previousNoteUsedAnchors;
            $this->noteNumber = $previousNoteNumber;
            $this->noteAnchorDiagnostics = $previousNoteAnchorDiagnostics;
            $this->renderedGroupedEndnotes = $previousRenderedGroupedEndnotes;
        }
    }
