...
final class HtmlUpstreamReaderEvidence
{
    ...
    public const EXPECTED_NATIVE_MAPPED_PAIR_COUNT = 46;
        ...
        return [
            ...
            'claimBoundaries' => [
                'doesAssert' => [
                    ...
                    'the existing HTML/native AST comparator still observes 46 same-basename native-pair matches when included in the report',
                ],
                'doesNotAssert' => [
    ...
    private static function claimBoundaries(): array
    {
        return [
            'doesAssert' => [
                ...
                'that the existing native AST gate observes 46 checked-in same-basename HTML/native matches',
