...
final class HtmlUpstreamReaderEvidence
{
    ...
    public static function checkedInCurrentEvidence(string $repoRoot): array
    {
        ...
        return [
            ...
            'claimBoundaries' => [
                'doesAssert' => [
                    'the checked-in HTML reader fixture corpus has 108 pinned fixture snapshots',
                    ...
                    'the existing HTML/native AST comparator still observes 108 same-basename native-pair matches when included in the report',
                ],
                'doesNotAssert' => [
    ...
    private static function claimBoundaries(): array
    {
        return [
            'doesAssert' => [
                'the identity and count of 108 selected checked-in upstream-derived and generated-current HTML fixtures',
                ...
                'that the existing native AST gate observes 108 checked-in same-basename HTML/native matches',
