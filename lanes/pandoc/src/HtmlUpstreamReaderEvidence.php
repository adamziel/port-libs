...
final class HtmlUpstreamReaderEvidence
{
    ...
    public static function checkedInCurrentEvidence(string $repoRoot): array
    {
        ...
        return [
            ...
            'claimBoundaries' => [
                'doesAssert' => [
                    'the checked-in HTML reader fixture corpus has 130 pinned fixture snapshots',
                    ...
                    'the existing HTML/native AST comparator observes 130 HTMLDocument-backed same-basename native-pair matches when included in the report',
                ],
                'doesNotAssert' => [
    ...
    private static function claimBoundaries(): array
    {
        return [
            'doesAssert' => [
                'the identity and count of 130 selected checked-in upstream-derived and generated-current HTML fixtures',
                ...
                'that the existing native AST gate observes 130 HTMLDocument-backed checked-in same-basename HTML/native matches',
