...
final class HtmlUpstreamReaderEvidence
{
    ...
    public const EXPECTED_NATIVE_MAPPED_PAIR_COUNT = 18;
        ...
        return [
            ...
            'claimBoundaries' => [
                'doesAssert' => [
                    ...
                    'the existing HTML/native AST comparator still observes 18 same-basename native-pair matches when included in the report',
                ],
                'doesNotAssert' => [
    ...
    private static function claimBoundaries(): array
    {
        return [
            'doesAssert' => [
                ...
                'that the existing native AST gate observes 18 checked-in same-basename HTML/native matches',
