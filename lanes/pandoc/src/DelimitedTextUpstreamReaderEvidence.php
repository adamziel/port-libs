    ...
    private static function claimBoundaries(): array
    {
        return [
            'doesAssert' => [
                ...
                'thirty generated TSV-to-native local samples when generatedTsvNativeParityEvidence is valid',
