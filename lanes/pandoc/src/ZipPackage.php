...
final class ZipPackage
{
    ...
    private static function dataDescriptorIntegritySummaryFromBytes(
        ...
        if (
            ...
            $boundaryIssue = self::dataDescriptorBoundaryIssue($descriptorSpan, 12, $nextOffset, $centralDirectoryOffset);
        ...
        if ($signedMatches) {
            ...
            $boundaryIssue = self::dataDescriptorBoundaryIssue($descriptorSpan, $expectedLength, $nextOffset, $centralDirectoryOffset);
            if ($boundaryIssue !== null) {
                $issues[] = $boundaryIssue;
            }
