...
final class XmlHtmlDom
{
    ...
    public static function summarizeJatsFrontMatter(\DOMDocument $dom, string $format = 'jats'): array
    {
        ...
        return [
            ...
            'unsupportedDirectReaderReason' => 'front-matter-review-packet-only',
            'unsupportedDirectReaderDetail' => 'Bounded XML metadata review is available, but full Pandoc direct reader parity is not implemented.',
            'rootName' => $rootName,
