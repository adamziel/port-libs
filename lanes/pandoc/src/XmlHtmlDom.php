...
final class XmlHtmlDom
{
    ...
    private static function globalHtmlAttributeSummary(\DOMElement $element): array
    {
        ...
        if (array_key_exists('accesskey', $attributes)) {
            ...
            $summary['accessKeys'] = self::spaceSeparatedTokens($attributes['accesskey']);
        }
        ...
        if (array_key_exists('popover', $attributes)) {
            ...
            $summary['popoverState'] = self::popoverState($attributes['popover']);
        }
        ...
        if (array_key_exists('popovertarget', $attributes) || array_key_exists('popovertargetaction', $attributes)) {
            $popoverActionRaw = $attributes['popovertargetaction'] ?? null;
            $summary['popoverTargetActionRaw'] = $popoverActionRaw;
            $summary['popoverTargetAction'] = self::popoverTargetAction($popoverActionRaw);
        }
