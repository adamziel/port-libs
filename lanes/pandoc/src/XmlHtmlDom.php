...
final class XmlHtmlDom
{
    ...
    private static function xmlNamespaceDiagnostics(array $collisionSummary, array $declarations): array
    {
        ...
        foreach ($declarations as $declaration) {
            ...
            if ($prefix === 'xml' && $uri !== self::XML_NAMESPACE_URI) {
                $diagnostics[] = self::xmlNamespaceDiagnostic(
            ...
            if ($prefix === null && $uri === self::XML_NAMESPACE_URI) {
                $diagnostics[] = self::xmlNamespaceDiagnostic(
            ...
            } elseif ($prefix !== 'xml' && $uri === self::XML_NAMESPACE_URI) {
                $diagnostics[] = self::xmlNamespaceDiagnostic(
            ...
            if ($uri === self::XMLNS_NAMESPACE_URI) {
                $diagnostics[] = self::xmlNamespaceDiagnostic(
