...
- 43 EPUB package inputs in `lanes/pandoc/fixtures/upstream-current-epub-reader/epub`
- 43 same-directory `.native` goldens for every checked-in EPUB package input
