...
- `php tools/run-tests.php lanes/pandoc/tests/DocxOpenXmlReaderTest.php` passed: 1 file, 917 assertions, 0 failures.
- `php tools/run-tests.php lanes/pandoc/tests` passed: 44 files, 66122 assertions, 0 failures.
