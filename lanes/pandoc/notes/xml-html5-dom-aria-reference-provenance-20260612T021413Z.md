...
Verification on current main `99391dcd46`:

- `php -l lanes/pandoc/src/XmlHtmlDom.php`
- `php -l lanes/pandoc/tests/XmlHtmlDomTest.php`
- `php tools/run-tests.php lanes/pandoc/tests/XmlHtmlDomTest.php` - 1 file, 1263 assertions, 0 failures
- `php tools/run-tests.php lanes/pandoc/tests` - 44 files, 69724 assertions, 0 failures

Lane status:

- Added one focused `XmlHtmlDomTest` PASS case with 22 assertions.
- `phpPass` moved from 3179 to 3180.
- `phpFail` remains 0.
