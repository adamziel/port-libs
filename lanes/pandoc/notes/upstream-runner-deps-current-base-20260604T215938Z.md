...
Micro-slice: `pandoc-upstream-runner-deps-current-base-20260604T215938Z`.

Accepted base: `b0c5497210a93bba00e8d20d212e5fa445b9011f`.
...
- This isolated worktree is at accepted base
  `b0c5497210a93bba00e8d20d212e5fa445b9011f` with no pre-existing dirty Pandoc
  lane changes before this audit.
- The accepted Pandoc lane state records 2,276 upstream test/data/benchmark
  artifacts inspected, 839 focused Markdown/HTML/WordPress/package/CSL/YAML/
  OPC/doctemplate/DOCX/ODF/EPUB3/table-geometry/archive-compression/math/
  legacy-DOC-CFB/charset-Unicode checks mapped, and 382 focused PHP PASS lines
  with 0 failures.
...
EPUB3, table geometry, math/TeX, PDF handoff planning, archive compression
streams, charset/Unicode support, doctemplates, or legacy DOC/CFB.
...
- `php tools/run-tests.php lanes/pandoc/tests` passed: 13 test files, 3,631
