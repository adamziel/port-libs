...
Micro-slice: `pandoc-upstream-runner-deps-current-base-20260604T222957Z`.
...
- This isolated worktree is at accepted base
  `229db65917c88ede5fb968cbc6030180ac381585` with no pre-existing dirty Pandoc
  lane changes before this audit.
- The accepted Pandoc lane state records 2,276 upstream test/data/benchmark
  artifacts inspected, 841 focused Markdown/HTML/WordPress/package/CSL/
  BibTeX/YAML/OPC/doctemplate/DOCX/ODF/EPUB3/table-geometry/
  archive-compression/math/legacy-DOC-CFB/charset-Unicode checks mapped, and
  384 focused PHP PASS lines with 0 failures.
...
native PHP conversion slices for Markdown/HTML, ZIP/OPC, YAML, CSL/BibTeX,
DOCX/ODT, EPUB3 package handoff, table geometry, math/TeX, PDF handoff
planning, archive compression streams, charset/Unicode support, doctemplates,
or legacy DOC/CFB.
...
- `php tools/run-tests.php lanes/pandoc/tests` passed: 13 test files, 3,669
