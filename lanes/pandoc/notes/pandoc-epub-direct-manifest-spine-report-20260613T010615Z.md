...
| Pandoc lane totals | 3,305 PHP passes / 0 failures and 3,265 mapped upstream cases over the 2,276-row static Pandoc denominator after rebasing onto current main `4c296642da`. | Green, still not global ship-ready. |
...
Full lane result: `lanes/pandoc/tests` passed 44 files, 74194 assertions, 0
failures after rebasing onto current main `4c296642da`.
