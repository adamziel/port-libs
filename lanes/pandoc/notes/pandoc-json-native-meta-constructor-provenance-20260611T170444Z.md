...
- `php tools/run-tests.php lanes/pandoc/tests/PandocJsonNativeAstTest.php`: 1 test file, 1817 assertions, 0 failures.
- `php tools/run-tests.php lanes/pandoc/tests`: 44 test files, 73220 assertions, 0 failures.

Accounting:
- Adds 1 mapped JSON/native metadata constructor provenance case.
- Adds 39 focused assertions.
- Moves Pandoc lane `phpPass` from 3269 to 3270.
- Moves mapped denominator from 3246 to 3247.
