...
Micro-slice: `pandoc-upstream-runner-deps-current-base-20260604T055734Z`.
...
- The accepted Pandoc lane state records 2,276 upstream test/data/benchmark
  ...
  OPC/doctemplate/DOCX checks mapped, and 301 focused PHP PASS lines with
  0 failures.
- The current accepted source includes native ZIP/OPC/YAML/doctemplate/CSL,
  minimal DOCX body/core-property/style/numbering parsing, bounded math/TeX
  handoff, and the shared ZIP extra-field/timestamp implementation accepted
  before this audit.
