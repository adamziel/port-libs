...
`bits` while preserving unsupported input status and no registered direct
...
- Focused XML/registry run passed: 2 files, 3348 assertions, 0 failures.
- Full Pandoc PHP run passed: 45 files, 75376 assertions, 0 failures.
