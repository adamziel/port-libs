...
Micro-slice: `pandoc-upstream-runner-deps-current-base-20260604T012247Z`.
...
- The current accepted source includes native ZIP/OPC/YAML/doctemplate/CSL,
  bounded math/TeX handoff, shared ZIP package extra-field handling, and
  minimal DOCX body/core-property/style/numbering parsing into the shared AST.
- `/home/claude/port-libs/.upstream-cache/pandoc` is absent.
- Local cache and current-worktree searches found no `pandoc.cabal`,
