...
- `php tools/run-tests.php lanes/pandoc/tests/CitationCslProcessorTest.php`: 1 test file, 4730 assertions, 0 failures.
- `php tools/run-tests.php lanes/pandoc/tests`: 44 test files, 65428 assertions, 0 failures.
