...
Issue: `plib-t44tm`
Rebased base: `4487923aa2`

## Verdict

Not shippable yet.

The native PHP lane now has `276 / 29` local XML/HTML/JATS/DocBook DOM evidence cases against the accepted upstream XML/HTML/JATS/DocBook format-related denominator, or `951.7%` as an evidence ratio. This remains evidence accounting only; it is not upstream runner parity.
