...
- `php tools/run-tests.php lanes/pandoc/tests/MarkdownReaderTest.php`
  passed: 1 file, 6,643 assertions, 0 failures.
- `php tools/run-tests.php lanes/pandoc/tests`
  passed: 45 files, 74,231 assertions, 0 failures.

Counters move `phpPass` 3,310 -> 3,311, `phpFail` remains 0, and mapped
upstream evidence moves 3,270 -> 3,271 with
