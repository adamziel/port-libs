...
Slice: `pandoc-opc-closure-stop-provenance-current-base-20260611T1604Z`, rebased on current main `2cea4fa78`.
...
- `php tools/run-tests.php lanes/pandoc/tests/OpenPackagingConventionsTest.php`
  - Result: `1 test files, 4112 assertions, 0 failures`
- `php tools/run-tests.php lanes/pandoc/tests`
  - Result: `44 test files, 64405 assertions, 0 failures`
...
- Focused OPC assertions: `4112` in `OpenPackagingConventionsTest.php`.
- Added one focused PHP PASS case.
- Lane status `phpPass` moves `3082 -> 3083`; `phpFail` remains `0`.
