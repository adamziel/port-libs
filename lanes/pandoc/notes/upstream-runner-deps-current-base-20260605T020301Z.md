...
Micro-slice: `pandoc-upstream-runner-deps-current-base-20260605T020301Z`.

Accepted base: `473b94d8a943d636a9d530eae1b68fce26f375be`.
...
- This isolated worktree is at accepted base
  `473b94d8a943d636a9d530eae1b68fce26f375be` with no pre-existing dirty Pandoc
  lane changes before this audit.
- Current Pandoc lane counters are 2,276 upstream test/data/benchmark artifacts
  inspected, 997 mapped native PHP checks, and 522 focused PHP PASS lines with
  0 failures.
...
- `php tools/run-tests.php lanes/pandoc/tests` passed: 19 test files, 5,523
