...
Slice: `pandoc-odf-reader-metadata-only-sidecar-byte-policy`, based on current main `5cdf8aebd8`.
...
- `php tools/run-tests.php lanes/pandoc/tests` (44 files, 73132 assertions, 0 failures)
