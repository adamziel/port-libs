...
Micro-slice: `pandoc-upstream-runner-deps-current-base-20260605T023523Z`.

Accepted base: `e9802384b8f60cb6c622eaa238aa0dc23f4d6e07`.
...
- This isolated worktree was clean before this audit.
- Current Pandoc lane counters are 2,276 upstream test/data/benchmark artifacts
  inspected, 1,020 mapped native PHP checks in
  `UPSTREAM_TEST_MANIFEST.json`, and 543 focused PHP PASS lines with 0
...
hydrated Pandoc checkout and its `cabal.project`, `pandoc.cabal`, and
...
- `php tools/run-tests.php lanes/pandoc/tests` passed: 19 test files, 5,805
