...
- `php tools/run-tests.php lanes/pandoc/tests/BibtexCslProcessorTest.php`
  - 1 test file, 966 assertions, 0 failures
- `php tools/run-tests.php lanes/pandoc/tests/CitationCslProcessorTest.php`
  - 1 test file, 6153 assertions, 0 failures
- `git diff --check -- lanes/pandoc`
- `rg -n "^(<<<<<<<|=======|>>>>>>>)$" lanes/pandoc`

Earlier broader lane check before the final main rebase:

- `php tools/run-tests.php lanes/pandoc/tests`
  - 445 test files, 136157 assertions, 9026 failures
  - Failures were in unrelated Markdown reader/native/surge fixtures, not the touched citation/BibTeX files.
