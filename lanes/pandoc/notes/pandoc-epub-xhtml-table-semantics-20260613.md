...
Slice: bounded EPUB3 spine XHTML table structure review metadata on accepted base `3a4bf759`.
...
The accepted EPUB upstream denominator remains 9 static upstream inventory rows. Local EPUB mapped evidence moves from 59 to 60 cases, or 666.7% of the coarse upstream denominator. `phpPass` moves from 3311 to 3312 while `phpFail` remains 0.
...
- `php tools/run-tests.php lanes/pandoc/tests` -> 45 files, 74278 assertions, 0 failures
