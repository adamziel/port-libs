...
Micro-slice: `pandoc-upstream-runner-deps-current-base-20260604T001103Z`.
...
- The current accepted source includes native Markdown/HTML reader and writer
  evidence, YAML metadata placement, bounded CSL citation output, ZIP/OPC
  package primitives including extra-field metadata, doctemplate support,
  minimal DOCX/OpenXML body/style/numbering parsing, and bounded math/TeX
  conversion.
...
- The isolated worktree contains no Pandoc Cabal package/project files.
