...
- `php tools/run-tests.php lanes/pandoc/tests`
  - Result: `44 test files, 71096 assertions, 0 failures`

Status delta after rebase: `phpPass` moves `3208 -> 3209`; added `mappedXmlHtmlDomDefinitionListCases: 1` and `xmlHtmlDomDefinitionListAssertions: 32`.
