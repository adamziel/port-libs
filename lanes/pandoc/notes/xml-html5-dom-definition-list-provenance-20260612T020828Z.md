...
- `php tools/run-tests.php lanes/pandoc/tests`
  - Result: `44 test files, 68954 assertions, 0 failures`

Status delta after rebase: `phpPass` moves `3170 -> 3171`; added `mappedXmlHtmlDomDefinitionListCases: 1` and `xmlHtmlDomDefinitionListAssertions: 32`.
