...
Micro-slice: `pandoc-upstream-runner-deps-current-base-20260604T063055Z`.
...
- The current accepted source includes native ZIP/OPC/YAML/doctemplate/CSL
  support, minimal DOCX body/core-property/style/numbering parsing, bounded
  math/TeX conversion, and shared ZIP package extra-field metadata handling.
...
- No hydrated Pandoc upstream checkout directory was found under
  `/home/claude/port-libs/.upstream-cache` at the checked search depth.
...
plan/build for command fixtures, readers, writers, HUnit, QuickCheck/golden
tests, and Lua-engine coverage.
