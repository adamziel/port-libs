...
- `php tools/run-tests.php lanes/pandoc/tests/XmlHtmlDomTest.php` passed 1 test files, 1004 assertions, 0 failures
- `php tools/run-tests.php lanes/pandoc/tests` passed 44 test files, 67888 assertions, 0 failures
