...
- Baseline before this slice: focused `PandocJsonNativeAstTest.php` passed with
  `1` file, `2097` assertions, `0` failures.
...
- Final focused run after rebase onto `4487923aa2`: `php tools/run-tests.php lanes/pandoc/tests/PandocJsonNativeAstTest.php`
  passed with `1` file, `2137` assertions, `0` failures.
- Full lane run after rebase onto `4487923aa2`: `php tools/run-tests.php lanes/pandoc/tests` passed with `45`
  files, `74512` assertions, `0` failures.
