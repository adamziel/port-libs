...
- Previous local numerator on current main `3a4bf7596e`: 3,311 PHP passes / 0
  failures and 3,271 mapped upstream cases.
- New local numerator after adding this follow-up: 3,313 PHP passes / 0 failures
  and 3,273 mapped upstream cases.
...
- `php tools/run-tests.php lanes/pandoc/tests/DelimitedTextReaderTest.php lanes/pandoc/tests/PandocFormatRegistryTest.php`
  passed: 2 files, 1082 assertions, 0 failures.
- `php tools/run-tests.php lanes/pandoc/tests`
  passed: 45 files, 74253 assertions, 0 failures.
