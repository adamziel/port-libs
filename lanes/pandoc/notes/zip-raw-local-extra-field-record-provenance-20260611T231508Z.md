...
Target: current main `9e53a22c9b`.
...
Focused post-rebase verification passed `1 test files, 3635 assertions, 0 failures`.
Full post-rebase Pandoc lane verification passed `44 test files, 67168 assertions, 0 failures`.
