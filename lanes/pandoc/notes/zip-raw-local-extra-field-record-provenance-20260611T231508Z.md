...
Focused post-rebase verification passed `1 test files, 3606 assertions, 0 failures`.
Full post-rebase Pandoc lane verification passed `44 test files, 67018 assertions, 0 failures`.
