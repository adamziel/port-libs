...
- Result: `1 test files, 6071 assertions, 6 failures`
- The large aggregate remains baseline-red in unrelated WordPress sanitizer,
  raw-alias markdown suppression, and citation handoff areas; the new focused
  mixed-caption Native writer regression is isolated and green.
