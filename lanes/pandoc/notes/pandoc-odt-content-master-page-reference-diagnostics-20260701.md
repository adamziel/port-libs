...
- `php tools/run-tests.php lanes/pandoc/tests/OdfReaderContentMasterPageReferenceDiagnosticsTest.php lanes/pandoc/tests/OdfReaderTest.php`
  - 2 test files, 5326 assertions, 0 failures
...
- The mapped denominator moves from 2883 to 2884 with one focused ODT content
