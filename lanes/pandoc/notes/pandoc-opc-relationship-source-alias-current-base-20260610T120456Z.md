...
- Focused verification after the fix: `php tools/run-tests.php lanes/pandoc/tests/OpenPackagingConventionsTest.php` passed 1 file / 3722 assertions / 0 failures.
- Full post-rebase lane verification: `php tools/run-tests.php lanes/pandoc/tests` passed 44 files / 59856 assertions / 0 failures.
...
- Focused `OpenPackagingConventionsTest` assertions: 3718 -> 3722.
