...
- `php tools/run-tests.php lanes/pandoc/tests`
  - Result: 45 test files, 74360 assertions, 0 failures.

Status delta: `phpPass` moves from `3314` to `3315`; `phpFail` remains `0`.
`UPSTREAM_TEST_MANIFEST.json` mapped denominator moves from `3273` to `3274`.
