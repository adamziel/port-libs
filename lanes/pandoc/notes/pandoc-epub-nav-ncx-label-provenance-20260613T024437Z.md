...
- `php tools/run-tests.php lanes/pandoc/tests/EpubPackageReaderTest.php`: 1 file, 209 assertions, 0 failures.
- `php tools/run-tests.php lanes/pandoc/tests`: 45 files, 74494 assertions, 0 failures.
...
- Moved `phpPass` from 3318 to 3319 after rebasing on the direct manifest/spine diagnostics slice; `phpFail` remains 0.
- Moved mapped upstream cases from 3277 to 3278.
