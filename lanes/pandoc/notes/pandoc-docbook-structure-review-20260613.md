...
- PHP pass numerator: 3,316 -> 3,317
- PHP fail: 0
- Mapped upstream cases: 3,275 -> 3,276
...
- `php tools/run-tests.php lanes/pandoc/tests/XmlHtmlDomTest.php`: 1 file, 1,884 assertions, 0 failures
- `php tools/run-tests.php lanes/pandoc/tests`: 45 files, 74,405 assertions, 0 failures
