...
Base: current `origin/main` `d504ad4468896e00171eab4c5e5cd6aab84a69bc`
...
- `php tools/run-tests.php lanes/pandoc/tests`
  - 44 test files, 67225 assertions, 0 failures
...
- `phpPass` moves from 3143 to 3144; `phpFail` remains 0.
