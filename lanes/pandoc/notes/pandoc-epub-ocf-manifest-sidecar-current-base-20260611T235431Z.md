...
Base: current `origin/main` `6d8eba6ee7c2f0c7ef5a79743df203e5654926d0`
...
- `php tools/run-tests.php lanes/pandoc/tests`
  - 44 test files, 67580 assertions, 0 failures

## Accounting

- Accounts one focused `EpubPackageTest.php` PASS case with 54 assertions.
- `phpPass` remains 3149 on the rebased lane head; `phpFail` remains 0.
