...
- DOCX/OpenXML local passing evidence: 93 / 35 static upstream DOCX rows.
- Pandoc lane: 3,312 PHP passes / 0 failures.
- Mapped upstream cases: 3,272 / 2,276.
...
- `php tools/run-tests.php lanes/pandoc/tests/DocxOpenXmlReaderTest.php`
  - 1 test file, 2,413 assertions, 0 failures
- `php tools/run-tests.php lanes/pandoc/tests`
  - 45 test files, 74,297 assertions, 0 failures
