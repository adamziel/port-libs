...
- Full `lanes/pandoc/tests`: 45 files, 74485 assertions, 0 failures after
  rebase onto current main `4487923aa2`.
...
- `phpPass` moves from 3318 to 3319.
- `phpFail` remains 0.
- `UPSTREAM_TEST_MANIFEST.json` mapped count moves from 3277 to 3278.
