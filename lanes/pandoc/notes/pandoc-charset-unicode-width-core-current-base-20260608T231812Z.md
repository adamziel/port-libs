# Pandoc Charset/Unicode Width Core - IBM864/CP864 DOS Arabic Source Bytes

Slice: `pandoc-charset-unicode-width-core-current-base-20260608T231812Z`
Base accepted HEAD: `c2add54cd754c7dc4d03da25c95616285192e050`

## Behavior

- Added bounded native IBM864/CP864/DOS864/OEM864/CSIBM864 label recognition to `UnicodeText`.
- Decodes the official CP864 DOS Arabic high-byte table for legacy Markdown imports, including Arabic presentation forms, Arabic-Indic digits, lam-alef forms, Arabic punctuation, box drawing, soft hyphen, and undefined-byte repair diagnostics.
- Preserves canonical `ibm864` source encoding metadata and narrow/wide display-width audit rows through `MarkdownReader` and `WordPressBlockWriter`.

## Source Truth

- Official Unicode CP864 mapping: `https://www.unicode.org/Public/MAPPINGS/VENDORS/MICSFT/PC/CP864.TXT`.
...
- Prior checked-in lane status before this slice recorded `UnicodeTextTest.php` at `1 test files, 1122 assertions, 0 failures`.
- Final focused verification:
  `php tools/run-tests.php lanes/pandoc/tests/UnicodeTextTest.php`
  passed with `1 test files, 1138 assertions, 0 failures`.
- WordPress smoke:
...
IBM864/CP864 DOS Arabic source-byte decoder plus WordPress charset audit
coverage.

## Next

Choose a non-overlapping charset or Unicode layout gap such as IBM855 Cyrillic,
Mac Hebrew/Arabic, or additional Unicode line-break metadata.
