...
2026-06-11 UTC slice `plib-mbmyt` maps one compact ODT package ingestion case for `OpenDocumentPackage` after refresh onto `origin/main` `1241c13487d21f10c115991e6c38750223117c52`.
...
- `php tools/run-tests.php lanes/pandoc/tests`: 44 files, 61747 assertions, 0 failures.
