...
2026-06-10 UTC slice `plib-mbmyt` maps one compact ODT package ingestion case for `OpenDocumentPackage`.
...
- `php tools/run-tests.php lanes/pandoc/tests/OpenDocumentPackageTest.php`: 1 file, 135 assertions, 0 failures.
- `php tools/run-tests.php lanes/pandoc/tests`: 44 files, 61100 assertions, 0 failures.

## Accounting

- `phpPass`: 2999 -> 3000.
- mapped denominator: 3155 -> 3156.
