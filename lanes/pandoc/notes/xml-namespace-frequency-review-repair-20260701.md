...
The full `php tools/run-tests.php lanes/pandoc/tests` gate remains baseline-red on current `main` with unrelated DocBook, LaTeX, and Markdown surge failures visible before this slice's tests; the focused XML namespace repair and XML/registry gates pass.
