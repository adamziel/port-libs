...
- `php tools/run-tests.php lanes/pandoc/tests/OdfZipCreatorHostVersionIdentityTest.php lanes/pandoc/tests/OdfReaderPackageIdentityTest.php lanes/pandoc/tests/OpenDocumentPackageTest.php` with 3 files, 2,635 assertions, 0 failures
- `php tools/run-tests.php lanes/pandoc/tests/OdfOdtShipReadinessStatusTest.php` with 1 file, 24 assertions, 0 failures
- `php tools/run-tests.php lanes/pandoc/tests/Odf*Test.php lanes/pandoc/tests/OpenDocument*Test.php lanes/pandoc/tests/OdtReaderTest.php` was attempted with 56 files, 12,450 assertions, and 1 existing non-slice failure in `OpenDocumentReaderTest.php` for Markdown emphasis rendering (`***summary***` vs `**_summary_**`)
