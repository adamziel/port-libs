...
- `php tools/run-tests.php lanes/pandoc/tests/OpenDocumentPackageTest.php` passed with 2,053 assertions and 0 failures.
- `php tools/run-tests.php lanes/pandoc/tests/OdfReaderTest.php` passed with 5,113 assertions and 0 failures.
