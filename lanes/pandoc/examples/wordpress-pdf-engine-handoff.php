...
$fakePdfBytes = implode("\n", [
    ...
    'endobj',
    'trailer',
    '<< /Size 16 /Root 1 0 R /Info 12 0 R /ID [<00112233445566778899aabbccddeeff> <00112233445566778899aabbccddeeff>] >>',
    'startxref',
    '512',
    '%%EOF',
    '16 0 obj',
