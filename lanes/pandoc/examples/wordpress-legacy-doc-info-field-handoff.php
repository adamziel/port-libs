...
if (($argv[1] ?? '') === '--self-test') {
    foreach ([
        'data-legacy-doc-field="docproperty"',
        'data-legacy-doc-data-field-type="document-property"',
        'data-legacy-doc-data-field-name="Source System"',
    ...
    echo "legacy doc info-field handoff self-test ok\n";
    return;
}
