...
Display audit:
$$\sum_{i=1}^{n} \operatorname{migrate}(p_i) + \frac{a_1}{\sqrt{b^2}} + \widehat{\operatorname{quality}} + \vec{v}_i + \alpha \times \omega$$
MARKDOWN;
...
if (($argv[1] ?? '') === '--self-test') {
    foreach ([
        ...
        '<span class="math display">\\[\\sum_{i=1}^{n} \\operatorname{migrate}(p_i) + \\frac{a_1}{\\sqrt{b^2}} + \\widehat{\\operatorname{quality}} + \\vec{v}_i + \\alpha \\times \\omega\\]</span>',
        '<mo>⟨</mo>',
        '<mo>⟩</mo>',
