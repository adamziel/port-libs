...
if (($argv[1] ?? '') === '--self-test') {
    ...
    if (!str_contains($blocks, '<span class="odf-field odf-field-sequence-ref" data-odf-field-type="sequence-ref" data-odf-field-ref-name="source-hero-seq" data-odf-field-reference-format="category-and-value">Figure 1</span>')) {
    ...
    if (($result['importReport']['content']['fieldCount'] ?? 0) !== 32) {
