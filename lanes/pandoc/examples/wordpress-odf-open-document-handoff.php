...
if (($argv[1] ?? '') === '--self-test') {
    ...
    if (($result['importReport']['content']['fieldCount'] ?? 0) !== 7) {
        throw new RuntimeException('Expected ODT variable, user, and source metadata fields to be counted in the import report');
    }
