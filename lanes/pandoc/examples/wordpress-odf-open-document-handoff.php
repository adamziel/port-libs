...
if (($argv[1] ?? '') === '--self-test') {
    ...
    if (($result['importReport']['content']['fieldCount'] ?? 0) !== 9) {
        throw new RuntimeException('Expected ODT variable, conditional, hidden, user, and source metadata fields to be counted in the import report');
    }
