...
<office:document-content
  ...
  <office:body>
    <office:text>
      ...
      <text:p>Source metadata fields <text:title>WordPress ODT source packet</text:title> by <text:author-name text:style-name="ReviewerField" text:fixed="true">Migration Desk</text:author-name> created <text:creation-date text:date-value="2026-06-05">June 5, 2026</text:creation-date>.</text:p>
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    if (($result['importReport']['content']['fieldCount'] ?? 0) !== 19) {
        throw new RuntimeException('Expected ODT variable, input, dropdown, conditional, hidden, hidden paragraph, user, source metadata, page variable, chapter, filename, and statistic fields to be counted in the import report');
    }
