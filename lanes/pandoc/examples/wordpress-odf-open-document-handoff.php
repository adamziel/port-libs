...
if (($argv[1] ?? '') === '--self-test') {
    ...
    if (($result['importReport']['content']['fieldCount'] ?? 0) !== 17) {
        throw new RuntimeException('Expected ODT variable, input, conditional, hidden, user, source metadata, page variable, chapter, filename, and statistic fields to be counted in the import report');
    }
