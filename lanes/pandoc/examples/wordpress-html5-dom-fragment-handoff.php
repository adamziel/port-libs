...
<article id="legacy-post-42" data-source="html-export" data-pandoc-link-rel="source-spoof" data-pandoc-meta-name="source-spoof" xmlns="http://www.w3.org/1999/xhtml" itemscope itemtype="https://schema.org/Article ./schema/LegacyPost" itemid="./post-42.html#article" itemref="imported-headline legacy-author">
  ...
  <p>Metric <data value=" SKU-42 " data-pandoc-data-value="source-spoof">Legacy SKU</data>; import quality <meter value="0.75" min="0" max="1" low=".25" high=".9" optimum="1" data-pandoc-meter-value="source-spoof">Quality</meter>; progress <progress value=".5" max="1">half done</progress>; bad metric <progress value="-1" max="0">invalid metric</progress>.</p>
  ...
  <figure align="right" aria-describedby="cover-caption" data-pandoc-figure-caption="source-spoof"><img src=" cover.png&#13;" srcset=" h&#9;ttps://cdn.example.test/cover.png?x=1&amp;y=2 01.00x, cover.png 1x, ../media/cover@2x.png 2x, javascript:alert(1) 3x" alt="Cover"><figcaption id="cover-caption">Cover image</figcaption></figure>
...
if (($argv[1] ?? '') === '--self-test') {
    foreach (['Language: en-US', 'Direction: ltr', 'Base target: _blank', 'Template fallback note', 'Title: Legacy post title & review packet', 'Charset: windows-1252', 'Charset: shift_jis', 'Description: Legacy import packet for reviewer handoff', 'Author: Migration Desk', 'Keywords: wordpress, html import', 'Generator: Legacy CMS', 'Application name: Legacy CMS Import', 'Theme color: #0a84ff', 'Color scheme: light dark only', 'Content security policy: default-src \'self\'; img-src https: data:; script-src \'none\'', 'Referrer policy: strict-origin-when-cross-origin', 'Open Graph title: Legacy social title', 'Open Graph description: Legacy social description', 'Article published time: 2026-06-06T10:00:00Z', 'Twitter title: Reviewer social card', 'Open Graph image', 'Canonical source', 'Spanish source', 'Shortlink', 'Author source', 'Reuse terms', 'Help source', 'Chapter anchor', 'Refresh target', 'Imported source packet', 'AT&T <review> text', 'source note', 'Editable migration note', 'Focusable source', 'Bad focus', 'Localized migration note', 'ARIA migration note', 'Custom gallery', 'Custom paragraph', 'Published', 'June 8, 2026', 'two hours', 'legacy date', 'Metric', 'Legacy SKU', 'Quality', 'half done', 'invalid metric', 'Revision', 'added reviewer note', 'removed unsafe note', 'Imported pull quote', 'inline source', 'unsafe source', 'Ruby note', '漢(Kan ji)Hancharacter', 'Shadow root: open', 'fallback slot', 'shadow source', 'Collapsed migration notes', 'Hidden packet', 'details source', 'Open import note', 'Visible disclosure text', 'Hidden migration note', 'hidden source', 'Search reveal import note', 'Popover migration note', 'popover source', 'Popover control source', 'Embedded srcdoc packet', 'frame note', 'Embedded frame source', 'Cover image', 'Mapped lead', 'Import settings', 'Form group note', 'Save settings', 'Send review', 'Preview packet', 'Image submit'] as $textSnippet) {
    ...
    foreach ([
        ...
        '<p>Metric <data data-pandoc-data-value="SKU-42">Legacy SKU</data>; import quality <meter data-pandoc-meter-value="0.75" data-pandoc-meter-min="0" data-pandoc-meter-max="1" data-pandoc-meter-low="0.25" data-pandoc-meter-high="0.9" data-pandoc-meter-optimum="1">Quality</meter>; progress <progress data-pandoc-progress-value="0.5" data-pandoc-progress-max="1">half done</progress>; bad metric <progress>invalid metric</progress>.</p>',
    ...
    foreach (['<html', '<body', '<base', '<title', '<link', '<meta', '<iframe', '<map', '<area', '<template', '<slot', '<legacy-', 'srcdoc=', '<script', '<input', ' style=', 'background-image', 'target=', 'download=', 'rel="opener"', ' popover=', 'popovertarget=', 'popovertargetaction=', ' contenteditable=', ' spellcheck=', ' draggable=', ' tabindex=', ' accesskey=', ' autofocus', ' translate=', ' lang=', ' xml:lang=', ' dir=', ' role=', ' aria-label=', ' aria-describedby=', ' aria-expanded=', ' aria-current=', ' aria-busy=', ' is=', ' part=', ' exportparts=', ' align=', ' cite=', ' datetime=', ' value=', ' min=', ' max=', ' low=', ' high=', ' optimum=', ' shadowrootmode=', ' shadowrootdelegatesfocus', ' shadowrootclonable', ' shadowrootserializable', ' disabled name=', ' name=" import-settings "', ' form="legacy-form"', 'javascript:', 'ja/**/vascript', 'report-uri', 'tracker.example.test', 'bad policy', 'inactive.example', 'legacy.css', 'active-author.html', 'Active author', 'Bad license', 'preload-cover.png', 'mailto:bad@example.test', 'data:text/html', 'data:image/svg+xml', '(max-width: 47em)', '<![CDATA[', '--->', 'Hidden draft', 'Bad frame', 'Bad map region', 'bad-role', 'source-spoof', ' hidden=', ' inert', 'http://www.w3.org/1999/xhtml', ' itemscope', ' itemtype=', ' itemid=', ' itemref=', ' itemprop=', ' property=', ' typeof=', ' about=', ' resource=', ' vocab=', ' prefix='] as $blocked) {
