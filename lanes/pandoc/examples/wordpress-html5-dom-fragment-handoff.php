...
if (($argv[1] ?? '') === '--self-test') {
    ...
    foreach ([
        ...
        '<p>Send reviewPreview packetImage submit<span data-pandoc-button-type="submit" data-pandoc-button-name="publish" data-pandoc-button-value="yes" data-pandoc-button-formaction="https://source.example.test/import/posts/forms/publish?packet=42" data-pandoc-button-formmethod="post" data-pandoc-button-formtarget="review-frame" data-pandoc-button-formnovalidate="true">Publish now</span><span data-pandoc-button-type="reset" data-pandoc-button-value="clear" data-pandoc-button-disabled="true">Clear draft</span><span data-pandoc-button-type="submit">Bad button</span></p>',
        '<!--review- -->',
        '<!-- wp:html -->',
    ] as $expected) {
