...
<article id="legacy-post-42" data-source="html-export" data-pandoc-link-rel="source-spoof" data-pandoc-meta-name="source-spoof" xmlns="http://www.w3.org/1999/xhtml" itemscope itemtype="https://schema.org/Article ./schema/LegacyPost" itemid="./post-42.html#article" itemref="imported-headline legacy-author">
  ...
  <form method="post" action="./forms/review?packet=42" target="review-frame" autocomplete="off" name="comment-form" data-pandoc-form-name="source-spoof"><p><input type="submit" value="Send review"><input type="button" value="Preview packet"><input type="image" src="javascript:alert(1)" alt="Image submit"><input type="text" value="Hidden draft"></p></form>
</article>
</html>
HTML;
