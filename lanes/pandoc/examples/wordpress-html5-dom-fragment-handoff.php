...
<article id="legacy-post-42" data-source="html-export">
  ...
  <svg><defs><clipPath id="review-clip"><path d="M0 0"></path></clipPath></defs><g clip-path=" url( #review-clip ) " filter="url(javascript:alert(1))" mask="url(./masks/review.svg#mask)"><path d="M0 0" fill="url(#paint)" stroke="url( java&#10;script:alert(1) )"></path></g></svg>
...
if (($argv[1] ?? '') === '--self-test') {
    ...
    foreach ([
        ...
        '<svg><defs><clipPath id="review-clip"><path d="M0 0"></path></clipPath></defs><g clip-path="url(#review-clip)" mask="url(https://source.example.test/import/posts/masks/review.svg#mask)"><path d="M0 0" fill="url(#paint)"></path></g></svg>',
    ...
    if (count($normalizedUrlDiagnostics) !== 4) {
        throw new RuntimeException('HTML5 DOM fragment self-test expected four normalized URL diagnostics');
    }
