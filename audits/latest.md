...
Observed output at both audit samples: no rows.

No duplicate root harness was active, but the tree was still not stable enough
for accepted aggregate evidence because active repo worker/status processes and
a broad dirty tree remained present.
