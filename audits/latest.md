...
3. **High - `progress.md` still presents stale per-lane estimates and next tasks.**
   ...
   - Evidence: the Active Lanes table still shows old estimates/tasks such as Gitoxide `66%`, LightningCSS `14%`, markerPDF `10%`, libsqlite `12%`, Quadrable `8%`, Dolt `5%`, and esbuild `8%`. Current manifests/status files describe much broader mapped slices, including LightningCSS `337 / 3532`, markerPDF `78 / 78`, Pandoc `153 / 2028`, Quadrable `55 / 55`, Dolt `97 / 613`, Syncthing `124 / 264`, rclone `143 / 327`, Readability `569 / 1984`, libsqlite `81 / 1454`, and esbuild `95 / 2,567`.
