...
- The upstream OPML reader fixture is covered structurally. The pinned upstream `testsuite.native` to `writer.opml` writer fixture with `columns => 80` is byte-for-byte exact.
